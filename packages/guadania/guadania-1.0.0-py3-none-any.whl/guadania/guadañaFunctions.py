...
def cloud_org_accounts(prismasession, cloud_type: str, id: str, json = False):
    """
...
def account_groups(prismasession, detailed=True, json = False):
    """
...
def compliance_summary(prismasession: PrismaSession, standards: list[str], json = False):
    """
...
def compliance_requirements_summary(prismasession: PrismaSession, standard:str, json = False):
    """
...
def resource_compliance(prismasession, complianceStandard, json = False):
    """
...
def compliance_standards(prismasession, json = False):
    """
...
def standard_requirements(prismasession, complianceStandard, json=False):
    """
...
def standards_sections(prismasession, complianceStandard, requirement_name, json=False):
    """
...
def list_policies(prismaSession, complianceStandard, json=False):
    """
...
def query(prismasession: prisma.PrismaSession, query: str = None, timerange = None, json=False):
    """
