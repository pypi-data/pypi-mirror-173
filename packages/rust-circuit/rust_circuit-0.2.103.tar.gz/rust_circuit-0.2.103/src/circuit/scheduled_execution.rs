...
use crate::circuit::schedule_send::ScheduleToSend;
use crate::lru_cache::TensorCacheRrfs;
use crate::py_types::{scalar_to_tensor, tensor_scale, un_flat_concat, PY_UTILS};
...
impl Schedule {
    pub fn deserialize(
        ...
        let sent: ScheduleToSend = json::from_str(&string)
            .map_err(|e| CircuitConstructionError::ParsingFail { string: string })?;
