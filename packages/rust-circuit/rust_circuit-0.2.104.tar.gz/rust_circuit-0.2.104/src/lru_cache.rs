use crate::all_imports::TorchDeviceDtype;
use crate::py_types::Tensor;
use crate::pyo3_prelude::*;
use crate::rrfs::tensor_from_hash_prefix;
...
impl TensorCacheRrfs {
    ...
    pub fn get_tensor(&mut self, prefix: String) -> Result<Tensor, PyErr> {
        self.small
            .get(&prefix)
