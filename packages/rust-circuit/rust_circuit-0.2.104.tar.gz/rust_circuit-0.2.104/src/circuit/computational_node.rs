...
use crate::{
    ...
    util::dict_to_list,
    util::{hashmap_collect_except_duplicates, AxisInt},
};
...
impl Einsum {
    ...
    pub fn shape_map(&self) -> Result<HashMap<AxisInt, usize>, CircuitConstructionError> {
...
impl Rearrange {
    ...
    pub fn conform_to_input_shape(&self, coerce: bool) -> Result<Self, CircuitConstructionError> {
