...
impl RearrangeSpec {
    ...
    pub fn canonicalize(&self, special_case_ones: bool) -> Self {
        ...
        let mut map: HashMap<AxisInt, AxisInt> = HashMap::new();
...
impl RearrangeSpec {
    ...
    pub fn fuse(inner: &Self, outer: &Self) -> Result<Self, RewriteError> {
        ...
        let mut inner_replaces: HashMap<AxisInt, Vec<AxisInt>> = HashMap::new();
        let mut outer_replaces: HashMap<AxisInt, Vec<AxisInt>> = HashMap::new();
        let mut in_to_out: HashMap<AxisInt, AxisInt> = HashMap::new();
