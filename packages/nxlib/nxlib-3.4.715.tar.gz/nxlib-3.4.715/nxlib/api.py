...
# Count the number of library initializations to stop NxLibCommand from erasing
# temporary nodes created during another library initialization.
_initialize_count = 0
