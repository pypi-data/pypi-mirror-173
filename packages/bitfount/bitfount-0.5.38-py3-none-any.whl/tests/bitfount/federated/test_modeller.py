...
class TestModeller:
    ...
    def test_modeller_run_secure_aggregation_params(
        ...
        assert (
            modeller.protocol.algorithm.model.param_clipping  # type: ignore[attr-defined] # Reason: algorithm defined with model # noqa: B950
            == {
                "prime_q": 2**61 - 1,
                "precision": 10**10,
                "num_workers": 2,
    ...
    def test_modeller_run_secure_aggregation_params_steps(
        ...
        assert modeller.protocol.algorithm.model.param_clipping is None  # type: ignore[attr-defined] # Reason: algorithm defined with model # noqa: B950
