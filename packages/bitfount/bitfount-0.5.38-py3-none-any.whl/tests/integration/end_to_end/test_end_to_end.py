...
class TestCensusIncomeEndToEnd:
    ...
    @pytest.mark.skip("[BIT-1669] Fix e2e tests")
    async def test_local_vs_pod(
        ...
        try:
            ...
            hyperparameters = census_income_modeller_config.task.model.hyperparameters
            model_name = census_income_modeller_config.task.model.name
            if model_name:
