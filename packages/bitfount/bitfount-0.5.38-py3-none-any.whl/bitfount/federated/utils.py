...
def _keys_exist(element: Dict, *keys: str) -> bool:
    """Check if *keys (nested) exists in `element` (dict).

    Args:
        element: The dictionary on which the search is done.
        *keys: Strings that represent the keys to the nested dictionary.
    """
