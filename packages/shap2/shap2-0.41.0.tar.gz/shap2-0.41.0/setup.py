...
def run_setup(with_binary, test_xgboost, test_lightgbm, test_catboost, test_spark, test_pyod,
    ...
    if with_binary:
        ...
        ext_modules.append(
            Extension('shap2._cext', sources=['shap2/cext/_cext.cc'],
    ...
    if with_cuda:
        try:
            ...
            ext_modules.append(
                Extension('shap2._cext_gpu', sources=['shap2/cext/_cext_gpu.cc'],
                          extra_compile_args=compile_args,
                          library_dirs=[lib_dir, cudart_path],
                          libraries=[lib, 'cudart'],
                          depends=['shap2/cext/_cext_gpu.cu', 'shap2/cext/gpu_treeshap.h','setup.py'])
            )
    ...
    setup(
        name='shap2',
        version=find_version("shap2", "__init__.py"),
        ...
        license='MIT',
        packages=[
            'shap2', 'shap2.explainers', 'shap2.explainers.other', 'shap2.explainers._deep',
            'shap2.plots', 'shap2.plots.colors', 'shap2.benchmark', 'shap2.maskers', 'shap2.utils',
            'shap2.actions', 'shap2.models'
        ],
        package_data={'shap2': ['plots/resources/*', 'cext/tree_shap.h']},
