...
packages = \
['py_open_dsse',
 'py_open_dsse.DSSE_algorithms',
 'py_open_dsse.DSSE_algorithms.Symb_Eqn']

package_data = \
{'': ['*'],
 'py_open_dsse': ['examples/13NodeIEEE/MEAS_files/Init_Bus_i.json',
