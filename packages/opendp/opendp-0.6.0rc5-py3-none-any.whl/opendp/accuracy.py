...
def accuracy_to_discrete_gaussian_scale(
    ...
    [accuracy_to_discrete_gaussian_scale in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/accuracy/fn.accuracy_to_discrete_gaussian_scale.html)
    
    **Proof Definition:**
    
    [(Proof Document)](https://docs.opendp.org/en/0.6.0-rc.5/proofs/rust/src/accuracy/accuracy_to_discrete_gaussian_scale.pdf)
...
def accuracy_to_discrete_laplacian_scale(
    ...
    [accuracy_to_discrete_laplacian_scale in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/accuracy/fn.accuracy_to_discrete_laplacian_scale.html)
    
    **Proof Definition:**
    
    [(Proof Document)](https://docs.opendp.org/en/0.6.0-rc.5/proofs/rust/src/accuracy/accuracy_to_discrete_laplacian_scale.pdf)
...
def accuracy_to_gaussian_scale(
    ...
    [accuracy_to_gaussian_scale in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/accuracy/fn.accuracy_to_gaussian_scale.html)
...
def accuracy_to_laplacian_scale(
    ...
    [accuracy_to_laplacian_scale in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/accuracy/fn.accuracy_to_laplacian_scale.html)
...
def discrete_gaussian_scale_to_accuracy(
    ...
    [discrete_gaussian_scale_to_accuracy in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/accuracy/fn.discrete_gaussian_scale_to_accuracy.html)
    
    **Proof Definition:**
    
    [(Proof Document)](https://docs.opendp.org/en/0.6.0-rc.5/proofs/rust/src/accuracy/discrete_gaussian_scale_to_accuracy.pdf)
...
def discrete_laplacian_scale_to_accuracy(
    ...
    [discrete_laplacian_scale_to_accuracy in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/accuracy/fn.discrete_laplacian_scale_to_accuracy.html)
    
    **Proof Definition:**
    
    [(Proof Document)](https://docs.opendp.org/en/0.6.0-rc.5/proofs/rust/src/accuracy/discrete_laplacian_scale_to_accuracy.pdf)
...
def gaussian_scale_to_accuracy(
    ...
    [gaussian_scale_to_accuracy in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/accuracy/fn.gaussian_scale_to_accuracy.html)
...
def laplacian_scale_to_accuracy(
    ...
    [laplacian_scale_to_accuracy in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/accuracy/fn.laplacian_scale_to_accuracy.html)
