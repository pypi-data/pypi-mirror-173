...
def bool_free(
    ...
    [bool_free in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/data/fn.bool_free.html)
...
def ffislice_of_anyobjectptrs(
    ...
    [ffislice_of_anyobjectptrs in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/data/fn.ffislice_of_anyobjectptrs.html)
...
def object_as_slice(
    ...
    [object_as_slice in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/data/fn.object_as_slice.html)
...
def object_free(
    ...
    [object_free in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/data/fn.object_free.html)
...
def object_type(
    ...
    [object_type in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/data/fn.object_type.html)
...
def slice_as_object(
    ...
    [slice_as_object in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/data/fn.slice_as_object.html)
...
def slice_free(
    ...
    [slice_free in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/data/fn.slice_free.html)
...
def smd_curve_epsilon(
    ...
    [smd_curve_epsilon in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/data/fn.smd_curve_epsilon.html)
...
def str_free(
    ...
    [str_free in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/data/fn.str_free.html)
...
def to_string(
    ...
    [to_string in Rust documentation.](https://docs.rs/opendp/0.6.0-rc.5/opendp/data/fn.to_string.html)
