...
class TestMibYang(unittest.TestCase):
    ...
    def test_get_image_version(self, popen_mock):
        ...
        self.assertEqual(
            mibyang_path.get_values_to_oids_from_device(
                'mock cmd',
                '.mock.oid'
            )[0],
            {'Cisco': '.mib-2.system.sysDescr.0'}
        )
    ...
    def test_load_walk_file_negative_match(self, get_readable_mock):
        ...
        self.assertIsNone(values_to_oids)
        self.assertEqual(
            walk_file,
            os.path.join(
                PosixPath(__file__).parent.resolve(),
    ...
    @mock.patch('subprocess.Popen')
    def test_get_values_to_oids_valid_snmpwalk(self, popen_mock):
            ...
            def communicate(self):
                ...
                return (
                    '''
                        ...
                        .1.3.4.5.4.9.9.9.720.1.1.22.0 = ""
                        .1.3.4.5.4.122.9.9.720.1.1.23.0 = ""
        ...
        self.assertEqual(
            mibyang_path.get_values_to_oids_from_device(
                ...
                '1': '.1.3.4.5.4.2.9.9.715.1.1.5.0',
                '120': '.1.3.4.5.4.5.9.9.720.1.1.18.0',
                '2887515926': '.1.3.4.5.4.4.9.9.720.1.1.17.0',
                '90': '.1.3.4.5.4.6.9.9.720.1.1.19.0',
                '180': '.1.3.4.5.4.7.9.9.720.1.1.20.0',
                '6': '.1.3.4.5.4.8.9.9.720.1.1.21.0',
                '2': '.1.3.4.5.4.933.9.9.730.1.1.1.0'
            }
        )
