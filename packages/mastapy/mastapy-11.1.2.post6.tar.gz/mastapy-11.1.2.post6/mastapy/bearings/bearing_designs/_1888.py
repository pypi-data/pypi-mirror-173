...
class BearingDesign(_0.APIBase):
    ...
    @property
    def mass_properties_of_elements_from_geometry(self) -> '_1325.MassProperties':
    ...
    @property
    def mass_properties_of_inner_ring_from_geometry(self) -> '_1325.MassProperties':
    ...
    @property
    def mass_properties_of_outer_ring_from_geometry(self) -> '_1325.MassProperties':
    ...
    @property
    def total_mass_properties(self) -> '_1325.MassProperties':
