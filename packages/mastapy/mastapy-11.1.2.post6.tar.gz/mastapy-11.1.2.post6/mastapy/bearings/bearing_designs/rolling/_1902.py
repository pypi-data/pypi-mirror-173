...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_1903.BearingProtectionLevel':
        ...
        return constructor.new_from_mastapy_type(_1903.BearingProtectionLevel)(value) if value is not None else None
    ...
    @property
    def new_protection_level(self) -> '_1903.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_1903.BearingProtectionLevel'):
