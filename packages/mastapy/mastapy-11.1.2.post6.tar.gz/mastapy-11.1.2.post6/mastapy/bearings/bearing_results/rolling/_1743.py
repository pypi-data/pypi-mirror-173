...
from mastapy.bearings.bearing_results.rolling import _1740
...
class LoadedAngularContactThrustBallBearingElement(_1740.LoadedAngularContactBallBearingElement):
    """LoadedAngularContactThrustBallBearingElement
