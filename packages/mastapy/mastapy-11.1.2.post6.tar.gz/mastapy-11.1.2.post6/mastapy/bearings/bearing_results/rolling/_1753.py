...
from mastapy.bearings.bearing_results.rolling import _1752, _1755, _1783
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1783.LoadedNonBarrelRollerBearingRow):
    """LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1752.LoadedAxialThrustCylindricalRollerBearingResults':
