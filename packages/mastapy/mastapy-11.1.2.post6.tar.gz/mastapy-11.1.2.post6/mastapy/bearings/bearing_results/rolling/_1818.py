...
from mastapy.bearings.bearing_results.rolling import _1800
...
class LoadedToroidalRollerBearingStripLoadResults(_1800.LoadedSphericalRollerRadialBearingStripLoadResults):
    """LoadedToroidalRollerBearingStripLoadResults
