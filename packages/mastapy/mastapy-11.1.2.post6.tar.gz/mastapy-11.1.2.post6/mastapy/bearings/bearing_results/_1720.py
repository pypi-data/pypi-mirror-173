...
class LoadedNonLinearBearingResults(_1712.LoadedBearingResults):
    """LoadedNonLinearBearingResults
    ...
    @property
    def power_loss(self) -> '_276.PowerLoss':
        ...
        if _276.PowerLoss.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_loss_of_type_independent_power_loss(self) -> '_269.IndependentPowerLoss':
        ...
        if _269.IndependentPowerLoss.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def power_loss_of_type_load_and_speed_combined_power_loss(self) -> '_271.LoadAndSpeedCombinedPowerLoss':
        ...
        if _271.LoadAndSpeedCombinedPowerLoss.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def resistive_torque(self) -> '_277.ResistiveTorque':
        ...
        if _277.ResistiveTorque.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def resistive_torque_of_type_combined_resistive_torque(self) -> '_267.CombinedResistiveTorque':
        ...
        if _267.CombinedResistiveTorque.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def resistive_torque_of_type_independent_resistive_torque(self) -> '_270.IndependentResistiveTorque':
        ...
        if _270.IndependentResistiveTorque.TYPE not in temp.__class__.__mro__:
