...
from mastapy.math_utility.optimisation import _1352
...
class OptimisationHistory(_0.APIBase):
    ...
    @property
    def input_history(self) -> 'List[_1352.OptimizationVariable]':
    ...
    @property
    def target_history(self) -> 'List[_1352.OptimizationVariable]':
    ...
    def add_input_history(self, value: '_1352.OptimizationVariable'):
    ...
    def add_target_history(self, value: '_1352.OptimizationVariable'):
