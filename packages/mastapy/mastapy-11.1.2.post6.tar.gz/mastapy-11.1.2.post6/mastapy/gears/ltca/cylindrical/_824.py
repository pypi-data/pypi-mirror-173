...
from mastapy.gears.ltca import _809
...
class CylindricalGearMeshLoadedContactLine(_809.GearMeshLoadedContactLine):
    """CylindricalGearMeshLoadedContactLine
    ...
    @property
    def loaded_contact_strip_end_points(self) -> 'List[_825.CylindricalGearMeshLoadedContactPoint]':
