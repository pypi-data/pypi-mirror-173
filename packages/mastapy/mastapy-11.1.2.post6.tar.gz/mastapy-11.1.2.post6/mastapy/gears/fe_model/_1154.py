...
from mastapy.gears.fe_model import _1151, _1152
...
class GearSetFEModel(_1183.GearSetImplementationDetail):
    """GearSetFEModel
    ...
    @property
    def gear_fe_models(self) -> 'List[_1151.GearFEModel]':
    ...
    @property
    def mesh_fe_models(self) -> 'List[_1152.GearMeshFEModel]':
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_7285.TaskProgress'):
        """ 'CalculateStiffnessFromFE' is the original name of this method.
