...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _628, _632
...
class HobbingProcessProfileCalculation(_632.HobbingProcessCalculation):
    """HobbingProcessProfileCalculation
