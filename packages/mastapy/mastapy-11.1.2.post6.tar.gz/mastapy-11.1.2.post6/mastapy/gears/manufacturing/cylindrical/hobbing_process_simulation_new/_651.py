...
class ProcessSimulationInput(_0.APIBase):
    ...
    @property
    def analysis_setting(self) -> '_625.AnalysisMethod':
        ...
        return constructor.new_from_mastapy_type(_625.AnalysisMethod)(value) if value is not None else None

    @analysis_setting.setter
    def analysis_setting(self, value: '_625.AnalysisMethod'):
    ...
    @property
    def centre_distance_offset_specification_method(self) -> '_629.CentreDistanceOffsetMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_629.CentreDistanceOffsetMethod)(value) if value is not None else None

    @centre_distance_offset_specification_method.setter
    def centre_distance_offset_specification_method(self, value: '_629.CentreDistanceOffsetMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def user_specified_center_distance_offset_relative_to_cutter_height(self) -> '_1341.Vector2DListAccessor':
    ...
    def user_specified_center_distance_offset_relative_to_cutter_height(self, value: '_1341.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.UserSpecifiedCenterDistanceOffsetRelativeToCutterHeight = value

    @property
    def cutter_head_slide_error(self) -> '_630.CutterHeadSlideError':
    ...
    @property
    def cutter_mounting_error(self) -> '_656.RackMountingError':
    ...
    @property
    def gear_mounting_error(self) -> '_631.GearMountingError':
