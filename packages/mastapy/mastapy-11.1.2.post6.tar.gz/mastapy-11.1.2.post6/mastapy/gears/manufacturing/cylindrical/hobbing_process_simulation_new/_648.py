...
class ProcessLeadCalculation(_0.APIBase):
    ...
    @property
    def left_flank_accuracy_calculation(self) -> '_626.CalculateLeadDeviationAccuracy':
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_626.CalculateLeadDeviationAccuracy':
