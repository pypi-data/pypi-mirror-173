...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _611, _612, _619
...
class PlungeShaverInputsAndMicroGeometry(_0.APIBase):
    ...
    @property
    def points_of_interest_left_flank(self) -> 'List[_619.PointOfInterest]':
    ...
    @property
    def points_of_interest_right_flank(self) -> 'List[_619.PointOfInterest]':
