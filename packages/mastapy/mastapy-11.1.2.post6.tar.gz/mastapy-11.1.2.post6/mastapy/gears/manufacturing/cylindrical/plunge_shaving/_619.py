...
from mastapy.gears.manufacturing.cylindrical import _593
...
class PointOfInterest(_0.APIBase):
    ...
    def flank(self) -> '_593.Flank':
        ...
        return constructor.new_from_mastapy_type(_593.Flank)(value) if value is not None else None

    @flank.setter
    def flank(self, value: '_593.Flank'):
