...
class ProcessPitchCalculation(_0.APIBase):
    ...
    @property
    def left_flank_accuracy_calculation(self) -> '_627.CalculatePitchDeviationAccuracy':
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_627.CalculatePitchDeviationAccuracy':
