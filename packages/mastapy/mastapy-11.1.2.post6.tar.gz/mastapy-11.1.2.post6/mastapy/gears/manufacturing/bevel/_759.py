...
class ConicalSetMicroGeometryConfigBase(_1183.GearSetImplementationDetail):
    """ConicalSetMicroGeometryConfigBase
    ...
    def deflection_from_bending_option(self) -> '_297.DeflectionFromBendingOption':
        ...
        return constructor.new_from_mastapy_type(_297.DeflectionFromBendingOption)(value) if value is not None else None
