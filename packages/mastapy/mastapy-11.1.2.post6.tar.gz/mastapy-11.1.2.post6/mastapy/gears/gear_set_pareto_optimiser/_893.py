...
from mastapy.gears.gear_set_pareto_optimiser import _895
...
class ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase(_895.ParetoFaceRatingOptimisationStrategyDatabase):
    """ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase
