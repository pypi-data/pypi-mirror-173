...
class CylindricalGearLeadModificationAtProfilePosition(_1055.CylindricalGearLeadModification):
    """CylindricalGearLeadModificationAtProfilePosition
    ...
    @property
    def profile_measurement(self) -> '_987.CylindricalGearProfileMeasurement':
