...
from mastapy.gears.gear_designs.cylindrical import _1003, _1004
...
class DIN3967SystemOfGearFits(_0.APIBase):
    ...
    @property
    def tooth_thickness_reduction_allowance(self) -> '_1003.DIN3967AllowanceSeries':
        ...
        return constructor.new_from_mastapy_type(_1003.DIN3967AllowanceSeries)(value) if value is not None else None

    @tooth_thickness_reduction_allowance.setter
    def tooth_thickness_reduction_allowance(self, value: '_1003.DIN3967AllowanceSeries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ToothThicknessReductionAllowance = value

    @property
    def tooth_thickness_tolerance(self) -> '_1004.DIN3967ToleranceSeries':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1004.DIN3967ToleranceSeries)(value) if value is not None else None

    @tooth_thickness_tolerance.setter
    def tooth_thickness_tolerance(self, value: '_1004.DIN3967ToleranceSeries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
