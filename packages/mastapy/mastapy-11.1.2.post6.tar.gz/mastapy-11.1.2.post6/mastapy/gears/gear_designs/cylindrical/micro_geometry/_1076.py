...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1087, _1081
...
class MeshedCylindricalGearFlankMicroGeometry(_0.APIBase):
    ...
    @property
    def involute_inspection_points(self) -> 'List[_1087.TotalProfileReliefWithDeviation]':
    ...
    @property
    def profile_form_relief_points(self) -> 'List[_1081.ProfileFormReliefWithDeviation]':
