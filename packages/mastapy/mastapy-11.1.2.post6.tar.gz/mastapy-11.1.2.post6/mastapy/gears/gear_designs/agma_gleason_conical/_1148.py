...
from mastapy.gears.gear_designs.conical import _1123, _1109
...
class AGMAGleasonConicalGearMeshDesign(_1109.ConicalGearMeshDesign):
    """AGMAGleasonConicalGearMeshDesign
    ...
    @property
    def iso10300_gear_set_finishing_methods(self) -> '_393.Iso10300FinishingMethods':
        ...
        return constructor.new_from_mastapy_type(_393.Iso10300FinishingMethods)(value) if value is not None else None

    @iso10300_gear_set_finishing_methods.setter
    def iso10300_gear_set_finishing_methods(self, value: '_393.Iso10300FinishingMethods'):
    ...
    @property
    def mounting_conditions_of_pinion_and_wheel(self) -> '_406.MountingConditionsOfPinionAndWheel':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_406.MountingConditionsOfPinionAndWheel)(value) if value is not None else None

    @mounting_conditions_of_pinion_and_wheel.setter
    def mounting_conditions_of_pinion_and_wheel(self, value: '_406.MountingConditionsOfPinionAndWheel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def profile_crowning_setting(self) -> '_408.ProfileCrowningSetting':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_408.ProfileCrowningSetting)(value) if value is not None else None

    @profile_crowning_setting.setter
    def profile_crowning_setting(self, value: '_408.ProfileCrowningSetting'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def verification_of_contact_pattern(self) -> '_409.VerificationOfContactPattern':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_409.VerificationOfContactPattern)(value) if value is not None else None

    @verification_of_contact_pattern.setter
    def verification_of_contact_pattern(self, value: '_409.VerificationOfContactPattern'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
