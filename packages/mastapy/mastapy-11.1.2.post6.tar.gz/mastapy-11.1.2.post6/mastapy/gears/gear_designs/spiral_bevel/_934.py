...
from mastapy.gears.gear_designs.spiral_bevel import _932, _933
...
class SpiralBevelGearSetDesign(_1136.BevelGearSetDesign):
    """SpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_932.SpiralBevelGearDesign]':
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_932.SpiralBevelGearDesign]':
    ...
    @property
    def spiral_bevel_meshes(self) -> 'List[_933.SpiralBevelGearMeshDesign]':
