...
class CylindricalGearSetRatingOptimisationHelper(_0.APIBase):
    ...
    @property
    def helix_angle_optimisation_results(self) -> '_469.OptimisationResultsPair[_472.SafetyFactorOptimisationStepResultAngle]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_472.SafetyFactorOptimisationStepResultAngle](temp) if temp is not None else None

    @property
    def normal_module_optimisation_results(self) -> '_469.OptimisationResultsPair[_474.SafetyFactorOptimisationStepResultShortLength]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_474.SafetyFactorOptimisationStepResultShortLength](temp) if temp is not None else None

    @property
    def pressure_angle_optimisation_results(self) -> '_469.OptimisationResultsPair[_472.SafetyFactorOptimisationStepResultAngle]':
    ...
    @property
    def profile_shift_coefficient_optimisation_results(self) -> '_469.OptimisationResultsPair[_473.SafetyFactorOptimisationStepResultNumber]':
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_473.SafetyFactorOptimisationStepResultNumber](temp) if temp is not None else None

    @property
    def all_helix_angle_optimisation_results(self) -> 'List[_470.SafetyFactorOptimisationResults[_472.SafetyFactorOptimisationStepResultAngle]]':
    ...
    @property
    def all_normal_module_optimisation_results(self) -> 'List[_470.SafetyFactorOptimisationResults[_474.SafetyFactorOptimisationStepResultShortLength]]':
    ...
    @property
    def all_normal_pressure_angle_optimisation_results(self) -> 'List[_470.SafetyFactorOptimisationResults[_472.SafetyFactorOptimisationStepResultAngle]]':
    ...
    @property
    def all_profile_shift_optimisation_results(self) -> 'List[_470.SafetyFactorOptimisationResults[_473.SafetyFactorOptimisationStepResultNumber]]':
    ...
    @property
    def helix_angle_and_normal_pressure_angle_optimisation_results(self) -> 'List[_470.SafetyFactorOptimisationResults[_472.SafetyFactorOptimisationStepResultAngle]]':
