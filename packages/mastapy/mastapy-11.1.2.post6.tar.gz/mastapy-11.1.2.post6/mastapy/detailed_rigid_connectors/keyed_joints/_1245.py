...
from mastapy.detailed_rigid_connectors.keyed_joints import _1246, _1248
...
class KeyedJointDesign(_1253.InterferenceFitDesign):
    """KeyedJointDesign
    ...
    @property
    def geometry_type(self) -> '_1246.KeyTypes':
        ...
        return constructor.new_from_mastapy_type(_1246.KeyTypes)(value) if value is not None else None

    @geometry_type.setter
    def geometry_type(self, value: '_1246.KeyTypes'):
    ...
    @property
    def number_of_keys(self) -> '_1248.NumberOfKeys':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1248.NumberOfKeys)(value) if value is not None else None

    @number_of_keys.setter
    def number_of_keys(self, value: '_1248.NumberOfKeys'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
