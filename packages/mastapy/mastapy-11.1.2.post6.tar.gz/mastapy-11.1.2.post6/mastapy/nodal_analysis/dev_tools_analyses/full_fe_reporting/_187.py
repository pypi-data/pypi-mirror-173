...
from mastapy.fe_tools.enums import _1193
...
class ElementPropertiesBase(_0.APIBase):
    ...
    @property
    def class_(self) -> '_1193.ElementPropertyClass':
        ...
        return constructor.new_from_mastapy_type(_1193.ElementPropertyClass)(value) if value is not None else None
