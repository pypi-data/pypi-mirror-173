...
class EigenvalueOptions(_0.APIBase):
    ...
    @property
    def mass_matrix_type(self) -> '_178.MassMatrixType':
        ...
        return constructor.new_from_mastapy_type(_178.MassMatrixType)(value) if value is not None else None

    @mass_matrix_type.setter
    def mass_matrix_type(self, value: '_178.MassMatrixType'):
