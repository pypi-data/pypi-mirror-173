...
from mastapy.nodal_analysis import _77, _78
...
class AnalysisSettingsObjects(_1605.NamedDatabaseItem):
    """AnalysisSettingsObjects
    ...
    @property
    def rating_type_for_bearing_reliability(self) -> '_77.RatingTypeForBearingReliability':
        ...
        return constructor.new_from_mastapy_type(_77.RatingTypeForBearingReliability)(value) if value is not None else None

    @rating_type_for_bearing_reliability.setter
    def rating_type_for_bearing_reliability(self, value: '_77.RatingTypeForBearingReliability'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RatingTypeForBearingReliability = value

    @property
    def rating_type_for_shaft_reliability(self) -> '_78.RatingTypeForShaftReliability':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_78.RatingTypeForShaftReliability)(value) if value is not None else None

    @rating_type_for_shaft_reliability.setter
    def rating_type_for_shaft_reliability(self, value: '_78.RatingTypeForShaftReliability'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
