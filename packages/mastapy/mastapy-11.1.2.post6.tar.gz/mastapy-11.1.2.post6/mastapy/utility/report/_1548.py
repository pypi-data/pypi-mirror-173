...
from mastapy.utility.report import _1549, _1552
...
TItem = TypeVar('TItem', bound='_1552.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1549.CustomReportMultiPropertyItemBase, Generic[TItem]):
    """CustomReportMultiPropertyItem
