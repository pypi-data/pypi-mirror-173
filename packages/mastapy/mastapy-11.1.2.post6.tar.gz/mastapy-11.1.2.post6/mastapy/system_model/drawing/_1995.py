...
from mastapy.system_model.drawing import _2007
...
class ConcentricPartGroupCombinationSystemDeflectionShaftResults(_0.APIBase):
    ...
    @property
    def shaft_system_deflection(self) -> '_2548.ShaftSystemDeflection':
    ...
    @property
    def node_results(self) -> 'List[_2007.ShaftDeflectionDrawingNodeItem]':
