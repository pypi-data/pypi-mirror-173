...
from mastapy.utility.enums import _1596
...
class ScalingDrawStyle(_0.APIBase):
    ...
    @property
    def bearing_force_arrows(self) -> '_1596.BearingForceArrowOption':
        ...
        return constructor.new_from_mastapy_type(_1596.BearingForceArrowOption)(value) if value is not None else None

    @bearing_force_arrows.setter
    def bearing_force_arrows(self, value: '_1596.BearingForceArrowOption'):
