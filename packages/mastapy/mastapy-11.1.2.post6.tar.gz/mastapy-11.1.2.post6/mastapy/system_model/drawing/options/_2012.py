...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6737, _6738
...
class AdvancedTimeSteppingAnalysisForModulationModeViewOptions(_0.APIBase):
    ...
    @property
    def excitations_type(self) -> '_6737.AtsamExcitationsOrOthers':
        ...
        return constructor.new_from_mastapy_type(_6737.AtsamExcitationsOrOthers)(value) if value is not None else None

    @excitations_type.setter
    def excitations_type(self, value: '_6737.AtsamExcitationsOrOthers'):
    ...
    @property
    def mode_view_options(self) -> '_6738.AtsamNaturalFrequencyViewOption':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_6738.AtsamNaturalFrequencyViewOption)(value) if value is not None else None

    @mode_view_options.setter
    def mode_view_options(self, value: '_6738.AtsamNaturalFrequencyViewOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
