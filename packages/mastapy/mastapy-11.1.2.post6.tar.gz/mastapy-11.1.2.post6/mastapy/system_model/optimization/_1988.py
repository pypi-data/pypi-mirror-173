...
from mastapy.system_model.optimization import _1987
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_1987.MicroGeometryOptimisationTarget':
        ...
        return constructor.new_from_mastapy_type(_1987.MicroGeometryOptimisationTarget)(value) if value is not None else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_1987.MicroGeometryOptimisationTarget'):
