...
from mastapy.utility.report import _1533
...
from mastapy.utility.model_validation import _1573, _1572
...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def active_report_as_text(self) -> '_1533.CustomReport':
    ...
    @property
    def component_design(self) -> '_1960.DesignEntity':
    ...
    @property
    def component_design_of_type_connection(self) -> '_2023.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2218.Part':
    ...
    @property
    def safety_factors(self) -> '_253.SafetyFactorGroup':
    ...
    @property
    def all_status_errors(self) -> 'List[_1573.StatusItem]':
