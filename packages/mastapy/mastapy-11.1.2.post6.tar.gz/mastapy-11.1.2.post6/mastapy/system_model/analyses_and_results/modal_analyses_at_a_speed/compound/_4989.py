...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4860
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import (
    _4990, _4992, _4995, _5002,
    _5001, _5023, _5003, _5008,
    _5013, _5025, _5027, _5031,
    _5038, _5037, _5039, _5046,
    _5053, _5056, _5057, _5058,
    _5060, _5062, _5067, _5068,
    _5069, _5071, _5073, _5078,
    _5077, _5083, _5084, _5089,
    _5092, _5095, _5099, _5103,
    _5107, _5110, _4982
)
...
class AssemblyCompoundModalAnalysisAtASpeed(_4982.AbstractAssemblyCompoundModalAnalysisAtASpeed):
    """AssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4860.AssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def bearings(self) -> 'List[_4990.BearingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_4992.BeltDriveCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4995.BevelDifferentialGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5002.BoltedJointCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_5001.BoltCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_5023.CVTCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_5003.ClutchCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5008.ConceptCouplingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5013.ConceptGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5025.CycloidalAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5027.CycloidalDiscCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5031.CylindricalGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_5038.FEPartCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5037.FaceGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5039.FlexiblePinAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5046.HypoidGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5053.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5056.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_5057.MassDiscCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_5058.MeasurementComponentCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_5060.OilSealCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5062.PartToPartShearCouplingCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5067.PlanetCarrierCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_5068.PointLoadCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_5069.PowerLoadCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_5071.RingPinsCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5073.RollingRingAssemblyCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5078.ShaftHubConnectionCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_5077.ShaftCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5083.SpiralBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5084.SpringDamperCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5089.StraightBevelDiffGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5092.StraightBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_5095.SynchroniserCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_5099.TorqueConverterCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5103.UnbalancedMassCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5107.WormGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5110.ZerolBevelGearSetCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4860.AssemblyModalAnalysisAtASpeed]':
