...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4981
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5108, _5109, _5000
...
class ZerolBevelGearSetCompoundModalAnalysisAtASpeed(_5000.BevelGearSetCompoundModalAnalysisAtASpeed):
    """ZerolBevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4981.ZerolBevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5108.ZerolBevelGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5109.ZerolBevelGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4981.ZerolBevelGearSetModalAnalysisAtASpeed]':
