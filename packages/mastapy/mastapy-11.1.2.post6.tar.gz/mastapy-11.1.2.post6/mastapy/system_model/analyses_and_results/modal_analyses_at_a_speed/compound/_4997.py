...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4868
...
class BevelDifferentialSunGearCompoundModalAnalysisAtASpeed(_4993.BevelDifferentialGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialSunGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4868.BevelDifferentialSunGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4868.BevelDifferentialSunGearModalAnalysisAtASpeed]':
