...
class BearingCompoundModalAnalysisAtASpeed(_5018.ConnectorCompoundModalAnalysisAtASpeed):
    """BearingCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4861.BearingModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4861.BearingModalAnalysisAtASpeed]':
