...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4875
...
class ClutchHalfCompoundModalAnalysisAtASpeed(_5021.CouplingHalfCompoundModalAnalysisAtASpeed):
    """ClutchHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4875.ClutchHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4875.ClutchHalfModalAnalysisAtASpeed]':
