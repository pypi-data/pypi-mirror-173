...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4973
...
class TorqueConverterTurbineCompoundModalAnalysisAtASpeed(_5021.CouplingHalfCompoundModalAnalysisAtASpeed):
    """TorqueConverterTurbineCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4973.TorqueConverterTurbineModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4973.TorqueConverterTurbineModalAnalysisAtASpeed]':
