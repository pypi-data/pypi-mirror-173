...
class ConnectionCompoundModalAnalysisAtASpeed(_7265.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4888.ConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4888.ConnectionModalAnalysisAtASpeed]':
