...
class BoltedJointCompoundModalAnalysisAtASpeed(_5080.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """BoltedJointCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4872.BoltedJointModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4872.BoltedJointModalAnalysisAtASpeed]':
