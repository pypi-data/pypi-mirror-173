...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4871
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4988
...
class BevelGearSetCompoundModalAnalysisAtASpeed(_4988.AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed):
    """BevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4871.BevelGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4871.BevelGearSetModalAnalysisAtASpeed]':
