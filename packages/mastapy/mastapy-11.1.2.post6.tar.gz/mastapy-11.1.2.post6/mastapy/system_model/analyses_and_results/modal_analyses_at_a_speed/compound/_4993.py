...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4865
...
class BevelDifferentialGearCompoundModalAnalysisAtASpeed(_4998.BevelGearCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4865.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4865.BevelDifferentialGearModalAnalysisAtASpeed]':
