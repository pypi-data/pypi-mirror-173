...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4853
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5061
...
class AbstractAssemblyCompoundModalAnalysisAtASpeed(_5061.PartCompoundModalAnalysisAtASpeed):
    """AbstractAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4853.AbstractAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4853.AbstractAssemblyModalAnalysisAtASpeed]':
