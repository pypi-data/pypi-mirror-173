...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4931
...
class OilSealCompoundModalAnalysisAtASpeed(_5018.ConnectorCompoundModalAnalysisAtASpeed):
    """OilSealCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4931.OilSealModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4931.OilSealModalAnalysisAtASpeed]':
