...
class DatumCompoundModalAnalysisAtASpeed(_5007.ComponentCompoundModalAnalysisAtASpeed):
    """DatumCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4904.DatumModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4904.DatumModalAnalysisAtASpeed]':
