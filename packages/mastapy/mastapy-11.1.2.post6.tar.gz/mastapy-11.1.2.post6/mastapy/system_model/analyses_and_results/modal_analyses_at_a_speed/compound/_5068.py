...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4939
...
class PointLoadCompoundModalAnalysisAtASpeed(_5104.VirtualComponentCompoundModalAnalysisAtASpeed):
    """PointLoadCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4939.PointLoadModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4939.PointLoadModalAnalysisAtASpeed]':
