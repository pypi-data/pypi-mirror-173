...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4916, _4915, _4859
...
class HypoidGearSetModalAnalysisAtASpeed(_4859.AGMAGleasonConicalGearSetModalAnalysisAtASpeed):
    """HypoidGearSetModalAnalysisAtASpeed
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_speed(self) -> 'List[_4916.HypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_meshes_modal_analysis_at_a_speed(self) -> 'List[_4915.HypoidGearMeshModalAnalysisAtASpeed]':
