...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5312
...
class PlanetaryGearSetCompoundMultibodyDynamicsAnalysis(_5312.CylindricalGearSetCompoundMultibodyDynamicsAnalysis):
    """PlanetaryGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5206.PlanetaryGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5206.PlanetaryGearSetMultibodyDynamicsAnalysis]':
