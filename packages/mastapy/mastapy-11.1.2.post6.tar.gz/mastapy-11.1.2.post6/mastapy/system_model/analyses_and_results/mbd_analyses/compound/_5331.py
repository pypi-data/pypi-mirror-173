...
class KlingelnbergCycloPalloidConicalGearSetCompoundMultibodyDynamicsAnalysis(_5297.ConicalGearSetCompoundMultibodyDynamicsAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5187.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5187.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis]':
