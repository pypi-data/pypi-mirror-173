...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import (
    _5271, _5273, _5276, _5283,
    _5282, _5304, _5284, _5289,
    _5294, _5306, _5308, _5312,
    _5319, _5318, _5320, _5327,
    _5334, _5337, _5338, _5339,
    _5341, _5343, _5348, _5349,
    _5350, _5352, _5354, _5359,
    _5358, _5364, _5365, _5370,
    _5373, _5376, _5380, _5384,
    _5388, _5391, _5263
)
...
class AssemblyCompoundMultibodyDynamicsAnalysis(_5263.AbstractAssemblyCompoundMultibodyDynamicsAnalysis):
    """AssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5119.AssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_5271.BearingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5273.BeltDriveCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5276.BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5283.BoltedJointCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5282.BoltCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5304.CVTCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5284.ClutchCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5289.ConceptCouplingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5294.ConceptGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5306.CycloidalAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5308.CycloidalDiscCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5312.CylindricalGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5319.FEPartCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5318.FaceGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5320.FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5327.HypoidGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5334.KlingelnbergCycloPalloidHypoidGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5337.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5338.MassDiscCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5339.MeasurementComponentCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5341.OilSealCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5343.PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5348.PlanetCarrierCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5349.PointLoadCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5350.PowerLoadCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5352.RingPinsCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5354.RollingRingAssemblyCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5359.ShaftHubConnectionCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5358.ShaftCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5364.SpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5365.SpringDamperCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5370.StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5373.StraightBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5376.SynchroniserCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5380.TorqueConverterCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5384.UnbalancedMassCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5388.WormGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5391.ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5119.AssemblyMultibodyDynamicsAnalysis]':
