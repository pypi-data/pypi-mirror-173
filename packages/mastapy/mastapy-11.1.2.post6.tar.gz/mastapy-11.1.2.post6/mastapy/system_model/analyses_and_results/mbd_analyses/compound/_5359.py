...
class ShaftHubConnectionCompoundMultibodyDynamicsAnalysis(_5299.ConnectorCompoundMultibodyDynamicsAnalysis):
    """ShaftHubConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5219.ShaftHubConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5219.ShaftHubConnectionMultibodyDynamicsAnalysis]':
