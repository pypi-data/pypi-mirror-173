...
class BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis(_5274.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5127.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5127.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
