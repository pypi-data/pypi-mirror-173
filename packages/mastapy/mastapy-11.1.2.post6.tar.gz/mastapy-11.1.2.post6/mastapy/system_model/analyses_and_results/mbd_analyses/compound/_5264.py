...
class AbstractShaftCompoundMultibodyDynamicsAnalysis(_5265.AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis):
    """AbstractShaftCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5112.AbstractShaftMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5112.AbstractShaftMultibodyDynamicsAnalysis]':
