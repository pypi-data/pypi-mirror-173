...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5210, _5223
...
class BeltDriveMultibodyDynamicsAnalysis(_5223.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    """BeltDriveMultibodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5210.PulleyMultibodyDynamicsAnalysis]':
