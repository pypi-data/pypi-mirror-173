...
class BevelDifferentialGearCompoundMultibodyDynamicsAnalysis(_5279.BevelGearCompoundMultibodyDynamicsAnalysis):
    """BevelDifferentialGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5125.BevelDifferentialGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5125.BevelDifferentialGearMultibodyDynamicsAnalysis]':
