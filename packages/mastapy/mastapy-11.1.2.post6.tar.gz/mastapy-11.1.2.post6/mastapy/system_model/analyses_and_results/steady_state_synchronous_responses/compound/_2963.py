...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2830
...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponse(_2898.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    """SpringDamperConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2830.SpringDamperConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2830.SpringDamperConnectionSteadyStateSynchronousResponse]':
