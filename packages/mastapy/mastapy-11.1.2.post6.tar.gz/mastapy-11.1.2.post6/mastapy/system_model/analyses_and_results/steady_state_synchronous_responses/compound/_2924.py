...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2791
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _2922, _2923, _2866
...
class HypoidGearSetCompoundSteadyStateSynchronousResponse(_2866.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse):
    """HypoidGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2791.HypoidGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_gears_compound_steady_state_synchronous_response(self) -> 'List[_2922.HypoidGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def hypoid_meshes_compound_steady_state_synchronous_response(self) -> 'List[_2923.HypoidGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2791.HypoidGearSetSteadyStateSynchronousResponse]':
