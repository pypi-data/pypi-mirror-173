...
class ConnectionSteadyStateSynchronousResponse(_7267.ConnectionStaticLoadAnalysisCase):
    """ConnectionSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_2833.SteadyStateSynchronousResponse':
