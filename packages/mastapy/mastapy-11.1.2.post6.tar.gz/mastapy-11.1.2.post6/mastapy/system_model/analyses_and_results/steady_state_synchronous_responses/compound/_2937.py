...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2805
...
class MountableComponentCompoundSteadyStateSynchronousResponse(_2885.ComponentCompoundSteadyStateSynchronousResponse):
    """MountableComponentCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2805.MountableComponentSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2805.MountableComponentSteadyStateSynchronousResponse]':
