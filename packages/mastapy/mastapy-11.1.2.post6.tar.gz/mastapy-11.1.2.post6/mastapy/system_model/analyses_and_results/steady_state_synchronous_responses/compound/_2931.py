...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2798
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _2929, _2930, _2928
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponse(_2928.KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2798.KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_steady_state_synchronous_response(self) -> 'List[_2929.KlingelnbergCycloPalloidHypoidGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_steady_state_synchronous_response(self) -> 'List[_2930.KlingelnbergCycloPalloidHypoidGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2798.KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse]':
