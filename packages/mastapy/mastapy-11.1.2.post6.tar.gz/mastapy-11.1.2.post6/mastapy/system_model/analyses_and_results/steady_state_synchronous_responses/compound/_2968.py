...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2841
...
class StraightBevelGearCompoundSteadyStateSynchronousResponse(_2876.BevelGearCompoundSteadyStateSynchronousResponse):
    """StraightBevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2841.StraightBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2841.StraightBevelGearSteadyStateSynchronousResponse]':
