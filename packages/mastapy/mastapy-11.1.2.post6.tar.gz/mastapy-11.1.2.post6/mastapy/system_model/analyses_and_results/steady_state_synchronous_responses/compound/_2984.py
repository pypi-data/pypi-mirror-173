...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2854
...
class WormGearMeshCompoundSteadyStateSynchronousResponse(_2919.GearMeshCompoundSteadyStateSynchronousResponse):
    """WormGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2854.WormGearMeshSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2854.WormGearMeshSteadyStateSynchronousResponse]':
