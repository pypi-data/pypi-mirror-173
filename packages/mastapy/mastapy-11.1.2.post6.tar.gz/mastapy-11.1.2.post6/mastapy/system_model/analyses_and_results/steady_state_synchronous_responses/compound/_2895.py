...
class ConnectionCompoundSteadyStateSynchronousResponse(_7265.ConnectionCompoundAnalysis):
    """ConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2762.ConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2762.ConnectionSteadyStateSynchronousResponse]':
