...
class CouplingHalfCompoundSteadyStateSynchronousResponse(_2937.MountableComponentCompoundSteadyStateSynchronousResponse):
    """CouplingHalfCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2765.CouplingHalfSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2765.CouplingHalfSteadyStateSynchronousResponse]':
