...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2799, _2797, _2795
...
class KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse(_2795.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse):
    """KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponse
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_steady_state_synchronous_response(self) -> 'List[_2799.KlingelnbergCycloPalloidHypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_steady_state_synchronous_response(self) -> 'List[_2797.KlingelnbergCycloPalloidHypoidGearMeshSteadyStateSynchronousResponse]':
