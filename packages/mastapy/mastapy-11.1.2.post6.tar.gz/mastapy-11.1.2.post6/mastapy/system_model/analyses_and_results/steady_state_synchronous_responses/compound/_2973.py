...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2847
...
class SynchroniserCompoundSteadyStateSynchronousResponse(_2958.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    """SynchroniserCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2847.SynchroniserSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2847.SynchroniserSteadyStateSynchronousResponse]':
