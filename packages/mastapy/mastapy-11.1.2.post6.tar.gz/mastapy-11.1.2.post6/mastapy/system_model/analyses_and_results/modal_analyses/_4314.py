...
class AbstractShaftOrHousingModalAnalysis(_4337.ComponentModalAnalysis):
    """AbstractShaftOrHousingModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2435.AbstractShaftOrHousingSystemDeflection':
