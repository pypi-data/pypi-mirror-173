...
from mastapy.system_model.analyses_and_results.modal_analyses import _4378
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4527, _4528, _4471
...
class HypoidGearSetCompoundModalAnalysis(_4471.AGMAGleasonConicalGearSetCompoundModalAnalysis):
    """HypoidGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4378.HypoidGearSetModalAnalysis]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis(self) -> 'List[_4527.HypoidGearCompoundModalAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis(self) -> 'List[_4528.HypoidGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4378.HypoidGearSetModalAnalysis]':
