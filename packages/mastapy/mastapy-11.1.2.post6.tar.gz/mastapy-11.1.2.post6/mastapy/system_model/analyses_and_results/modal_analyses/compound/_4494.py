...
from mastapy.system_model.analyses_and_results.modal_analyses import _4342
...
class ConceptGearCompoundModalAnalysis(_4523.GearCompoundModalAnalysis):
    """ConceptGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4342.ConceptGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4342.ConceptGearModalAnalysis]':
