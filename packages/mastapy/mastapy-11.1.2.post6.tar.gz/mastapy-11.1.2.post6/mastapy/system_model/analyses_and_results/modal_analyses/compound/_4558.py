...
from mastapy.system_model.analyses_and_results.modal_analyses import _4410
...
class RollingRingConnectionCompoundModalAnalysis(_4530.InterMountableComponentConnectionCompoundModalAnalysis):
    """RollingRingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4410.RollingRingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4410.RollingRingConnectionModalAnalysis]':
