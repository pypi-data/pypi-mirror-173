...
from mastapy.system_model.analyses_and_results.modal_analyses import _4338
...
class ConceptCouplingConnectionCompoundModalAnalysis(_4503.CouplingConnectionCompoundModalAnalysis):
    """ConceptCouplingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4338.ConceptCouplingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4338.ConceptCouplingConnectionModalAnalysis]':
