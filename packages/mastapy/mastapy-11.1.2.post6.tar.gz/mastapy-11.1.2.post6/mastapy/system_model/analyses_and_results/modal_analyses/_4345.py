...
from mastapy.system_model.analyses_and_results.modal_analyses import _4373
...
class ConicalGearModalAnalysis(_4373.GearModalAnalysis):
    """ConicalGearModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2470.ConicalGearSystemDeflection':
