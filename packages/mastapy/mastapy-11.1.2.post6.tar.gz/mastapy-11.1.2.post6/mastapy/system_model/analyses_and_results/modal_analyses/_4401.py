...
class PlanetaryConnectionModalAnalysis(_4416.ShaftToMountableComponentConnectionModalAnalysis):
    """PlanetaryConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2533.PlanetaryConnectionSystemDeflection':
