...
class PerModeResultsReport(_1535.CustomReportChart):
    """PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1597.TableAndChartOptions':
    ...
    def display_option(self, value: '_1597.TableAndChartOptions'):
