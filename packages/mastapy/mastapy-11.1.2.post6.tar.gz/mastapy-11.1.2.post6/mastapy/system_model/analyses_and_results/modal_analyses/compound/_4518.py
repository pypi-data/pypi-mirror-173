...
class FaceGearCompoundModalAnalysis(_4523.GearCompoundModalAnalysis):
    """FaceGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4367.FaceGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4367.FaceGearModalAnalysis]':
