...
from mastapy.system_model.analyses_and_results.modal_analyses import _4357
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4489
...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysis(_4489.CoaxialConnectionCompoundModalAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4357.CycloidalDiscCentralBearingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4357.CycloidalDiscCentralBearingConnectionModalAnalysis]':
