...
from mastapy.system_model.analyses_and_results.modal_analyses import _4413
...
class ShaftHubConnectionCompoundModalAnalysis(_4501.ConnectorCompoundModalAnalysis):
    """ShaftHubConnectionCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4413.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4413.ShaftHubConnectionModalAnalysis]':
