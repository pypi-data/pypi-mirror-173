...
from mastapy.system_model.analyses_and_results.modal_analyses import _4426
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4570, _4571, _4483
...
class StraightBevelDiffGearSetCompoundModalAnalysis(_4483.BevelGearSetCompoundModalAnalysis):
    """StraightBevelDiffGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4426.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_modal_analysis(self) -> 'List[_4570.StraightBevelDiffGearCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_modal_analysis(self) -> 'List[_4571.StraightBevelDiffGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4426.StraightBevelDiffGearSetModalAnalysis]':
