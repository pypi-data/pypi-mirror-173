...
class ClutchConnectionCompoundModalAnalysis(_4503.CouplingConnectionCompoundModalAnalysis):
    """ClutchConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4333.ClutchConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4333.ClutchConnectionModalAnalysis]':
