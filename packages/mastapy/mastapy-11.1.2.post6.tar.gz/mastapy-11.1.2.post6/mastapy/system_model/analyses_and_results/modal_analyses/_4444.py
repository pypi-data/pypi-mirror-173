...
from mastapy.system_model.analyses_and_results.modal_analyses import _4445
...
TMeasurement = TypeVar('TMeasurement', bound='_1406.MeasurementBase')


class WhineWaterfallReferenceValues(_4445.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    """WhineWaterfallReferenceValues
