...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4320, _4322, _4325, _4331,
    _4332, _4354, _4335, _4340,
    _4343, _4356, _4358, _4362,
    _4369, _4368, _4370, _4378,
    _4385, _4388, _4389, _4390,
    _4395, _4400, _4403, _4404,
    _4405, _4407, _4409, _4413,
    _4414, _4420, _4423, _4426,
    _4429, _4433, _4437, _4440,
    _4449, _4452, _4312
)
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4453
...
class AssemblyModalAnalysis(_4312.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def bearings(self) -> 'List[_4320.BearingModalAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_4322.BeltDriveModalAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4325.BevelDifferentialGearSetModalAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4331.BoltedJointModalAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_4332.BoltModalAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_4354.CVTModalAnalysis]':
    ...
    @property
    def calculate_full_fe_results_by_mode(self) -> 'List[_4453.CalculateFullFEResultsForMode]':
    ...
    @property
    def clutches(self) -> 'List[_4335.ClutchModalAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4340.ConceptCouplingModalAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4343.ConceptGearSetModalAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4356.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4358.CycloidalDiscModalAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4362.CylindricalGearSetModalAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_4369.FEPartModalAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4368.FaceGearSetModalAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4370.FlexiblePinAssemblyModalAnalysis]':
    ...
    @property
    def full_fe_meshes_for_calculating_modes(self) -> 'List[_4369.FEPartModalAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4378.HypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4385.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4388.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_4389.MassDiscModalAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_4390.MeasurementComponentModalAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_4395.OilSealModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4400.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4403.PlanetCarrierModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4404.PointLoadModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4405.PowerLoadModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4407.RingPinsModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4409.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4413.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4414.ShaftModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4420.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4423.SpringDamperModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4426.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4429.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4433.SynchroniserModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4437.TorqueConverterModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4440.UnbalancedMassModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4449.WormGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4452.ZerolBevelGearSetModalAnalysis]':
