...
class GearSetCompoundModalAnalysis(_4563.SpecialisedAssemblyCompoundModalAnalysis):
    """GearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4374.GearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4374.GearSetModalAnalysis]':
