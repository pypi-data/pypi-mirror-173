...
from mastapy.system_model.analyses_and_results.modal_analyses import _4335
...
class ClutchCompoundModalAnalysis(_4502.CouplingCompoundModalAnalysis):
    """ClutchCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4335.ClutchModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4335.ClutchModalAnalysis]':
