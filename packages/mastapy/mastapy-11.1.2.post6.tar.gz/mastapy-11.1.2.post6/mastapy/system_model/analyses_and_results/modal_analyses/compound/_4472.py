...
from mastapy.system_model.analyses_and_results.modal_analyses import _4319
from mastapy.system_model.analyses_and_results.modal_analyses.compound import (
    _4473, _4475, _4478, _4485,
    _4484, _4506, _4486, _4491,
    _4496, _4508, _4510, _4514,
    _4521, _4520, _4522, _4529,
    _4536, _4539, _4540, _4541,
    _4543, _4545, _4550, _4551,
    _4552, _4554, _4556, _4561,
    _4560, _4566, _4567, _4572,
    _4575, _4578, _4582, _4586,
    _4590, _4593, _4465
)
...
class AssemblyCompoundModalAnalysis(_4465.AbstractAssemblyCompoundModalAnalysis):
    """AssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4319.AssemblyModalAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_4473.BearingCompoundModalAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_4475.BeltDriveCompoundModalAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4478.BevelDifferentialGearSetCompoundModalAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4485.BoltedJointCompoundModalAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_4484.BoltCompoundModalAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_4506.CVTCompoundModalAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_4486.ClutchCompoundModalAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4491.ConceptCouplingCompoundModalAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4496.ConceptGearSetCompoundModalAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4508.CycloidalAssemblyCompoundModalAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4510.CycloidalDiscCompoundModalAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4514.CylindricalGearSetCompoundModalAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_4521.FEPartCompoundModalAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4520.FaceGearSetCompoundModalAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4522.FlexiblePinAssemblyCompoundModalAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4529.HypoidGearSetCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4536.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4539.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_4540.MassDiscCompoundModalAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_4541.MeasurementComponentCompoundModalAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_4543.OilSealCompoundModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4545.PartToPartShearCouplingCompoundModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4550.PlanetCarrierCompoundModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4551.PointLoadCompoundModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4552.PowerLoadCompoundModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4554.RingPinsCompoundModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4556.RollingRingAssemblyCompoundModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4561.ShaftHubConnectionCompoundModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4560.ShaftCompoundModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4566.SpiralBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4567.SpringDamperCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4572.StraightBevelDiffGearSetCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4575.StraightBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4578.SynchroniserCompoundModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4582.TorqueConverterCompoundModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4586.UnbalancedMassCompoundModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4590.WormGearSetCompoundModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4593.ZerolBevelGearSetCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4319.AssemblyModalAnalysis]':
