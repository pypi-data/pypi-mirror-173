...
from mastapy.system_model.analyses_and_results.modal_analyses import _4376
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4470
...
class HypoidGearMeshCompoundModalAnalysis(_4470.AGMAGleasonConicalGearMeshCompoundModalAnalysis):
    """HypoidGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4376.HypoidGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4376.HypoidGearMeshModalAnalysis]':
