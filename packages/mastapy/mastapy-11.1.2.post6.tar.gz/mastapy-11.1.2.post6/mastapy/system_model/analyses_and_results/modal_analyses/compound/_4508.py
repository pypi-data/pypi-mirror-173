...
from mastapy.system_model.analyses_and_results.modal_analyses import _4356
...
class CycloidalAssemblyCompoundModalAnalysis(_4563.SpecialisedAssemblyCompoundModalAnalysis):
    """CycloidalAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4356.CycloidalAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4356.CycloidalAssemblyModalAnalysis]':
