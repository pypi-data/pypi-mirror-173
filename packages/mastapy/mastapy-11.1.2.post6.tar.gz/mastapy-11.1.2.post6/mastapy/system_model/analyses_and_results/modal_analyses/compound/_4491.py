...
from mastapy.system_model.analyses_and_results.modal_analyses import _4340
...
class ConceptCouplingCompoundModalAnalysis(_4502.CouplingCompoundModalAnalysis):
    """ConceptCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4340.ConceptCouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4340.ConceptCouplingModalAnalysis]':
