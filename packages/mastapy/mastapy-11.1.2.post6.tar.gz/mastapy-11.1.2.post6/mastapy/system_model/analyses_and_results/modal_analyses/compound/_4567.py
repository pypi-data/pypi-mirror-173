...
from mastapy.system_model.analyses_and_results.modal_analyses import _4423
...
class SpringDamperCompoundModalAnalysis(_4502.CouplingCompoundModalAnalysis):
    """SpringDamperCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4423.SpringDamperModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4423.SpringDamperModalAnalysis]':
