...
from mastapy.system_model.analyses_and_results.modal_analyses import _4421
...
class SpringDamperConnectionCompoundModalAnalysis(_4503.CouplingConnectionCompoundModalAnalysis):
    """SpringDamperConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4421.SpringDamperConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4421.SpringDamperConnectionModalAnalysis]':
