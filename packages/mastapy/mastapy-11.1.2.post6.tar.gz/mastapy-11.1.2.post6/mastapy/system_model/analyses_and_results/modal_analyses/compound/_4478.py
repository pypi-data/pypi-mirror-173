...
from mastapy.system_model.analyses_and_results.modal_analyses import _4325
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4476, _4477, _4483
...
class BevelDifferentialGearSetCompoundModalAnalysis(_4483.BevelGearSetCompoundModalAnalysis):
    """BevelDifferentialGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4325.BevelDifferentialGearSetModalAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis(self) -> 'List[_4476.BevelDifferentialGearCompoundModalAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis(self) -> 'List[_4477.BevelDifferentialGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4325.BevelDifferentialGearSetModalAnalysis]':
