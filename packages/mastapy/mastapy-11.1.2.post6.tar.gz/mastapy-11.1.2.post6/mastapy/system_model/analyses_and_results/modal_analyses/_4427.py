...
class StraightBevelGearMeshModalAnalysis(_4328.BevelGearMeshModalAnalysis):
    """StraightBevelGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2560.StraightBevelGearMeshSystemDeflection':
