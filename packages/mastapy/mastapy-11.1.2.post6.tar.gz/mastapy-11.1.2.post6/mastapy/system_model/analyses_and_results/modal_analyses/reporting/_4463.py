...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4459, _4456
...
class SingleExcitationResultsModalAnalysis(_4456.DesignEntityModalAnalysisGroupResults):
    """SingleExcitationResultsModalAnalysis
    ...
    @property
    def all_rigidly_connected_groups(self) -> 'List[_4459.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]':
    ...
    @property
    def rigidly_connected_groups_with_significant_energy(self) -> 'List[_4459.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]':
    ...
    @property
    def rigidly_connected_groups_with_significant_kinetic_energy(self) -> 'List[_4459.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]':
    ...
    @property
    def rigidly_connected_groups_with_significant_strain_energy(self) -> 'List[_4459.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]':
