...
from mastapy.system_model.analyses_and_results.modal_analyses import _4397
...
class PartCompoundModalAnalysis(_7272.PartCompoundAnalysis):
    """PartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4397.PartModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4397.PartModalAnalysis]':
