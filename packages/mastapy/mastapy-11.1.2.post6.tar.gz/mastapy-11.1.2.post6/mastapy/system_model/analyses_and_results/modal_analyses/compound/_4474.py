...
from mastapy.system_model.analyses_and_results.modal_analyses import _4321
...
class BeltConnectionCompoundModalAnalysis(_4530.InterMountableComponentConnectionCompoundModalAnalysis):
    """BeltConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4321.BeltConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4321.BeltConnectionModalAnalysis]':
