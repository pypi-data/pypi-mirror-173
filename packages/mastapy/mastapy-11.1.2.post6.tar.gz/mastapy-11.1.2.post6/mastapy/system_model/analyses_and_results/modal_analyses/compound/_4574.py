...
from mastapy.system_model.analyses_and_results.modal_analyses import _4427
...
class StraightBevelGearMeshCompoundModalAnalysis(_4482.BevelGearMeshCompoundModalAnalysis):
    """StraightBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4427.StraightBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4427.StraightBevelGearMeshModalAnalysis]':
