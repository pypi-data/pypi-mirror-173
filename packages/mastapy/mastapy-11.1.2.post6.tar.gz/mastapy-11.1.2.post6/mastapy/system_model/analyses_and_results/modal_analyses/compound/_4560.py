...
class ShaftCompoundModalAnalysis(_4466.AbstractShaftCompoundModalAnalysis):
    """ShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4414.ShaftModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4414.ShaftModalAnalysis]':
