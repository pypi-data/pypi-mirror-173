...
from mastapy.system_model.analyses_and_results.modal_analyses import _4383
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4532
...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis(_4532.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis):
    """KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4383.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4383.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]':
