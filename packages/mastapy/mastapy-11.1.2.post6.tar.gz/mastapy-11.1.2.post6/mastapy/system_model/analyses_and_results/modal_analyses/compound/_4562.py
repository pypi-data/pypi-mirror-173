...
from mastapy.system_model.analyses_and_results.modal_analyses import _4416
...
class ShaftToMountableComponentConnectionCompoundModalAnalysis(_4468.AbstractShaftToMountableComponentConnectionCompoundModalAnalysis):
    """ShaftToMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4416.ShaftToMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4416.ShaftToMountableComponentConnectionModalAnalysis]':
