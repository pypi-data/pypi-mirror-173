...
class BevelDifferentialGearMeshModalAnalysis(_4328.BevelGearMeshModalAnalysis):
    """BevelDifferentialGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2445.BevelDifferentialGearMeshSystemDeflection':
