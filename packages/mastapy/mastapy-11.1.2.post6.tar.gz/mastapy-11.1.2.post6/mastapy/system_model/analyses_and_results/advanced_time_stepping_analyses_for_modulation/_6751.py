...
class BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6748.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2266.BevelDifferentialPlanetGear':
    ...
    @property
    def system_deflection_results(self) -> '_2448.BevelDifferentialPlanetGearSystemDeflection':
