...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6855
...
class TorqueConverterCompoundAdvancedTimeSteppingAnalysisForModulation(_6904.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6855.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6855.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]':
