...
class BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation(_6748.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialSunGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2267.BevelDifferentialSunGear':
    ...
    @property
    def system_deflection_results(self) -> '_2449.BevelDifferentialSunGearSystemDeflection':
