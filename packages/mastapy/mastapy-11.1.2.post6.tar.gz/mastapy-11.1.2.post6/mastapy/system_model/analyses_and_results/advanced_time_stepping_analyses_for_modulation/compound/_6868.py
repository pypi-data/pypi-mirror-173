...
class AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation(_6869.AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6734.AbstractShaftAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6734.AbstractShaftAdvancedTimeSteppingAnalysisForModulation]':
