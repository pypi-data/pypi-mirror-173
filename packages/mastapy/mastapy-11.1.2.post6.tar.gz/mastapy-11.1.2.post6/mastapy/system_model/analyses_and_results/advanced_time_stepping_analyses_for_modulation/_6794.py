...
class FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation(_6836.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2502.FlexiblePinAssemblySystemDeflection':
