...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6843, _6844, _6755
...
class StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation(_6755.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def straight_bevel_diff_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6843.StraightBevelDiffGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_diff_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6844.StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation]':
