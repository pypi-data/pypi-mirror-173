...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6853
...
class SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation(_6853.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6698.SynchroniserSleeveLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2567.SynchroniserSleeveSystemDeflection':
