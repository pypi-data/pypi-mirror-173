...
from mastapy.system_model.analyses_and_results.static_loads import _6545, _6578
from mastapy.system_model.analyses_and_results.system_deflections import _2444, _2478
...
class BeltDriveAdvancedTimeSteppingAnalysisForModulation(_6836.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    """BeltDriveAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6545.BeltDriveLoadCase':
        ...
        if _6545.BeltDriveLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2444.BeltDriveSystemDeflection':
