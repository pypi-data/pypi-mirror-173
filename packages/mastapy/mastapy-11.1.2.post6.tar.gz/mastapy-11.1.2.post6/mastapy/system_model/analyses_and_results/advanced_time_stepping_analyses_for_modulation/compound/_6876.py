...
class BeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_6932.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """BeltConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6746.BeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6746.BeltConnectionAdvancedTimeSteppingAnalysisForModulation]':
