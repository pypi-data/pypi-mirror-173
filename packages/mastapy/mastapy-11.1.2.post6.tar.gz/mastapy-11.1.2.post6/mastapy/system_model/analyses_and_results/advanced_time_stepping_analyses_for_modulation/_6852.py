...
class SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation(_6853.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    """SynchroniserHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6695.SynchroniserHalfLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2565.SynchroniserHalfSystemDeflection':
