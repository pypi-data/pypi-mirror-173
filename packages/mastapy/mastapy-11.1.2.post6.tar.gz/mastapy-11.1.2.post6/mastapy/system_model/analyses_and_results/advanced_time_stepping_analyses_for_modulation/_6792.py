...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6790, _6791, _6797
...
class FaceGearSetAdvancedTimeSteppingAnalysisForModulation(_6797.GearSetAdvancedTimeSteppingAnalysisForModulation):
    """FaceGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2499.FaceGearSetSystemDeflection':
    ...
    @property
    def face_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6790.FaceGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def face_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6791.FaceGearMeshAdvancedTimeSteppingAnalysisForModulation]':
