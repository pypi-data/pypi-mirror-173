...
class SpringDamperConnectionCompoundSystemDeflection(_2633.CouplingConnectionCompoundSystemDeflection):
    """SpringDamperConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2554.SpringDamperConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2554.SpringDamperConnectionSystemDeflection]':
