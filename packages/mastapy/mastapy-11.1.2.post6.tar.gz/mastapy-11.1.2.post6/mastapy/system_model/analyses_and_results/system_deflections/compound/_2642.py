...
class CylindricalGearCompoundSystemDeflection(_2654.GearCompoundSystemDeflection):
    """CylindricalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_424.CylindricalGearDutyCycleRating':
    ...
    @property
    def cylindrical_duty_cycle_rating(self) -> '_424.CylindricalGearDutyCycleRating':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2491.CylindricalGearSystemDeflectionWithLTCAResults]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2491.CylindricalGearSystemDeflectionWithLTCAResults]':
