...
class ZerolBevelGearMeshCompoundSystemDeflection(_2612.BevelGearMeshCompoundSystemDeflection):
    """ZerolBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2583.ZerolBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2583.ZerolBevelGearMeshSystemDeflection]':
