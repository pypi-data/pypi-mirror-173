...
class BevelGearMeshCompoundSystemDeflection(_2600.AGMAGleasonConicalGearMeshCompoundSystemDeflection):
    """BevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2450.BevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2450.BevelGearMeshSystemDeflection]':
