...
class AGMAGleasonConicalGearMeshSystemDeflection(_2468.ConicalGearMeshSystemDeflection):
    """AGMAGleasonConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3778.AGMAGleasonConicalGearMeshPowerFlow':
