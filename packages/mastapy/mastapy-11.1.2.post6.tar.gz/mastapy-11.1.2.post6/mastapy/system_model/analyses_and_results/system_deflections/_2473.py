...
class CouplingConnectionSystemDeflection(_2511.InterMountableComponentConnectionSystemDeflection):
    """CouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3811.CouplingConnectionPowerFlow':
