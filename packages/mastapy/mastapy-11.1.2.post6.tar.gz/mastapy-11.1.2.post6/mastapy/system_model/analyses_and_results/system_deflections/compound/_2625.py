...
class ConceptGearMeshCompoundSystemDeflection(_2655.GearMeshCompoundSystemDeflection):
    """ConceptGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2464.ConceptGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2464.ConceptGearMeshSystemDeflection]':
