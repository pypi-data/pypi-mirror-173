...
class PartToPartShearCouplingHalfCompoundSystemDeflection(_2634.CouplingHalfCompoundSystemDeflection):
    """PartToPartShearCouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2531.PartToPartShearCouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2531.PartToPartShearCouplingHalfSystemDeflection]':
