...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2624, _2625, _2656
...
class ConceptGearSetCompoundSystemDeflection(_2656.GearSetCompoundSystemDeflection):
    """ConceptGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2465.ConceptGearSetSystemDeflection]':
    ...
    @property
    def concept_gears_compound_system_deflection(self) -> 'List[_2624.ConceptGearCompoundSystemDeflection]':
    ...
    @property
    def concept_meshes_compound_system_deflection(self) -> 'List[_2625.ConceptGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2465.ConceptGearSetSystemDeflection]':
