...
class TorqueConverterConnectionSystemDeflection(_2473.CouplingConnectionSystemDeflection):
    """TorqueConverterConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3895.TorqueConverterConnectionPowerFlow':
