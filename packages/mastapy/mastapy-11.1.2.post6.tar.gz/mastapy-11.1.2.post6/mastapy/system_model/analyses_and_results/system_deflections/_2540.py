...
class RingPinToDiscContactReporting(_0.APIBase):
    ...
    @property
    def contact(self) -> '_2594.SplineFlankContactReporting':
    ...
    @property
    def information_at_ring_pin_to_disc_contact_point_from_geometry(self) -> '_6635.InformationAtRingPinToDiscContactPointFromGeometry':
    ...
    @property
    def information_for_contact_points_along_face_width(self) -> 'List[_2510.InformationForContactAtPointAlongFaceWidth]':
