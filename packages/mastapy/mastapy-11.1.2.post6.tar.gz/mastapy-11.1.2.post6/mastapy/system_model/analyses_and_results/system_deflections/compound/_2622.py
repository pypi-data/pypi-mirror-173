...
class ConceptCouplingConnectionCompoundSystemDeflection(_2633.CouplingConnectionCompoundSystemDeflection):
    """ConceptCouplingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2461.ConceptCouplingConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2461.ConceptCouplingConnectionSystemDeflection]':
