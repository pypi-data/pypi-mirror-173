...
class PartCompoundSystemDeflection(_7272.PartCompoundAnalysis):
    """PartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2529.PartSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2529.PartSystemDeflection]':
