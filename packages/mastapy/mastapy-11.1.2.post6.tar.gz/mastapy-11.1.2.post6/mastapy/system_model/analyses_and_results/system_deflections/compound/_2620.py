...
class ComponentCompoundSystemDeflection(_2675.PartCompoundSystemDeflection):
    """ComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2459.ComponentSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2459.ComponentSystemDeflection]':
