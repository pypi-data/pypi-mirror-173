...
class StraightBevelDiffGearCompoundSystemDeflection(_2611.BevelGearCompoundSystemDeflection):
    """StraightBevelDiffGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2559.StraightBevelDiffGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2559.StraightBevelDiffGearSystemDeflection]':
