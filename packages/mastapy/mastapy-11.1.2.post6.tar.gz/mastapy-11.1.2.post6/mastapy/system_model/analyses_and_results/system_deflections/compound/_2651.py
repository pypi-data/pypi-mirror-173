...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2649, _2650, _2656
...
class FaceGearSetCompoundSystemDeflection(_2656.GearSetCompoundSystemDeflection):
    """FaceGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2499.FaceGearSetSystemDeflection]':
    ...
    @property
    def face_gears_compound_system_deflection(self) -> 'List[_2649.FaceGearCompoundSystemDeflection]':
    ...
    @property
    def face_meshes_compound_system_deflection(self) -> 'List[_2650.FaceGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2499.FaceGearSetSystemDeflection]':
