...
class StraightBevelPlanetGearSystemDeflection(_2559.StraightBevelDiffGearSystemDeflection):
    """StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3888.StraightBevelPlanetGearPowerFlow':
