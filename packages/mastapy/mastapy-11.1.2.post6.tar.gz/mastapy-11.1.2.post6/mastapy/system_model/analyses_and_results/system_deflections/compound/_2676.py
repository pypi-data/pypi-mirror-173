...
class PartToPartShearCouplingCompoundSystemDeflection(_2632.CouplingCompoundSystemDeflection):
    """PartToPartShearCouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2532.PartToPartShearCouplingSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2532.PartToPartShearCouplingSystemDeflection]':
