...
class CylindricalGearSystemDeflectionWithLTCAResults(_2489.CylindricalGearSystemDeflection):
    """CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_822.CylindricalGearLoadDistributionAnalysis':
