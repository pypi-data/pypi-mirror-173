...
class RootAssemblySystemDeflection(_2441.AssemblySystemDeflection):
    """RootAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3871.RootAssemblyPowerFlow':
    ...
    @property
    def system_deflection_inputs(self) -> '_2569.SystemDeflection':
        ...
        if _2569.SystemDeflection.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def shaft_deflection_results(self) -> 'List[_2460.ConcentricPartGroupCombinationSystemDeflectionResults]':
