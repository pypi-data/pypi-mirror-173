...
class ConnectionCompoundSystemDeflection(_7265.ConnectionCompoundAnalysis):
    """ConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2471.ConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2471.ConnectionSystemDeflection]':
