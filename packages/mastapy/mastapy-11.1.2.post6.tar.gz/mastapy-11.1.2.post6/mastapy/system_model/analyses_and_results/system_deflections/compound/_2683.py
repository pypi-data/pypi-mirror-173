...
class PowerLoadCompoundSystemDeflection(_2719.VirtualComponentCompoundSystemDeflection):
    """PowerLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2536.PowerLoadSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2536.PowerLoadSystemDeflection]':
