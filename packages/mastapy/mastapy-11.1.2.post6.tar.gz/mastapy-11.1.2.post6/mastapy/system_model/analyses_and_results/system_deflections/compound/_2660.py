...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2658, _2659, _2601
...
class HypoidGearSetCompoundSystemDeflection(_2601.AGMAGleasonConicalGearSetCompoundSystemDeflection):
    """HypoidGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2508.HypoidGearSetSystemDeflection]':
    ...
    @property
    def hypoid_gears_compound_system_deflection(self) -> 'List[_2658.HypoidGearCompoundSystemDeflection]':
    ...
    @property
    def hypoid_meshes_compound_system_deflection(self) -> 'List[_2659.HypoidGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2508.HypoidGearSetSystemDeflection]':
