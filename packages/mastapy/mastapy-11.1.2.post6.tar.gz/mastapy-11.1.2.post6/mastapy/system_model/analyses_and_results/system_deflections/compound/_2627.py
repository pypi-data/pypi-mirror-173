...
class ConicalGearCompoundSystemDeflection(_2654.GearCompoundSystemDeflection):
    """ConicalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_504.ConicalGearDutyCycleRating':
    ...
    @property
    def conical_duty_cycle_rating(self) -> '_504.ConicalGearDutyCycleRating':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2470.ConicalGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2470.ConicalGearSystemDeflection]':
