...
class SpringDamperConnectionSystemDeflection(_2473.CouplingConnectionSystemDeflection):
    """SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3879.SpringDamperConnectionPowerFlow':
