...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2665, _2666, _2664
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection(_2664.KlingelnbergCycloPalloidConicalGearSetCompoundSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2516.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_system_deflection(self) -> 'List[_2665.KlingelnbergCycloPalloidHypoidGearCompoundSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_system_deflection(self) -> 'List[_2666.KlingelnbergCycloPalloidHypoidGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2516.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]':
