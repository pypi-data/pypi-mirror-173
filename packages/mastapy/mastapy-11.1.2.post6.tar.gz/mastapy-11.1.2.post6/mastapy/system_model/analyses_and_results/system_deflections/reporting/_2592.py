...
class RigidlyConnectedComponentGroupSystemDeflection(_2401.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self) -> '_1325.MassProperties':
    ...
    @property
    def components(self) -> 'List[_2459.ComponentSystemDeflection]':
