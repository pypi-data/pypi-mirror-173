...
class UnbalancedMassCompoundSystemDeflection(_2719.VirtualComponentCompoundSystemDeflection):
    """UnbalancedMassCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2578.UnbalancedMassSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2578.UnbalancedMassSystemDeflection]':
