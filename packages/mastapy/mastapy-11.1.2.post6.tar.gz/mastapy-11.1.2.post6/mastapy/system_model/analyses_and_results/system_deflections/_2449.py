...
class BevelDifferentialSunGearSystemDeflection(_2447.BevelDifferentialGearSystemDeflection):
    """BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3789.BevelDifferentialSunGearPowerFlow':
