...
class BoltCompoundSystemDeflection(_2620.ComponentCompoundSystemDeflection):
    """BoltCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2454.BoltSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2454.BoltSystemDeflection]':
