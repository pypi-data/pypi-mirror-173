...
class StraightBevelGearMeshCompoundSystemDeflection(_2612.BevelGearMeshCompoundSystemDeflection):
    """StraightBevelGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2560.StraightBevelGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2560.StraightBevelGearMeshSystemDeflection]':
