...
class ShaftSectionSystemDeflection(_122.Bar):
    """ShaftSectionSystemDeflection
    ...
    @property
    def left_end(self) -> '_2546.ShaftSectionEndResultsSystemDeflection':
    ...
    @property
    def right_end(self) -> '_2546.ShaftSectionEndResultsSystemDeflection':
