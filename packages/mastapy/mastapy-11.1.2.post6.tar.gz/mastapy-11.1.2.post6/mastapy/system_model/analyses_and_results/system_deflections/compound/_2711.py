...
class SynchroniserHalfCompoundSystemDeflection(_2712.SynchroniserPartCompoundSystemDeflection):
    """SynchroniserHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2565.SynchroniserHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2565.SynchroniserHalfSystemDeflection]':
