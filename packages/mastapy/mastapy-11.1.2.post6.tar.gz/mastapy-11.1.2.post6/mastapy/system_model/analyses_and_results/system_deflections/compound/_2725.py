...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2723, _2724, _2613
...
class ZerolBevelGearSetCompoundSystemDeflection(_2613.BevelGearSetCompoundSystemDeflection):
    """ZerolBevelGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2584.ZerolBevelGearSetSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_compound_system_deflection(self) -> 'List[_2723.ZerolBevelGearCompoundSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_compound_system_deflection(self) -> 'List[_2724.ZerolBevelGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2584.ZerolBevelGearSetSystemDeflection]':
