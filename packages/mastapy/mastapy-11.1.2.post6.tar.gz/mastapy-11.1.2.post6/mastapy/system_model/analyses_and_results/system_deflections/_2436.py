...
from mastapy.system_model.analyses_and_results.power_flows import _3776, _3820, _3873
...
class AbstractShaftSystemDeflection(_2435.AbstractShaftOrHousingSystemDeflection):
    """AbstractShaftSystemDeflection
    ...
    @property
    def component_design(self) -> '_2187.AbstractShaft':
    ...
    @property
    def power_flow_results(self) -> '_3776.AbstractShaftPowerFlow':
