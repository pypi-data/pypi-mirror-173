...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4648
...
class FaceGearMeshCompoundModalAnalysisAtAStiffness(_4783.GearMeshCompoundModalAnalysisAtAStiffness):
    """FaceGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4648.FaceGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4648.FaceGearMeshModalAnalysisAtAStiffness]':
