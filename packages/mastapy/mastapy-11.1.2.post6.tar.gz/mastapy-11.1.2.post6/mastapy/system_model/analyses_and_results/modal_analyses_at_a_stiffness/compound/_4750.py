...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4622
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4761
...
class ConceptCouplingCompoundModalAnalysisAtAStiffness(_4761.CouplingCompoundModalAnalysisAtAStiffness):
    """ConceptCouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4622.ConceptCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4622.ConceptCouplingModalAnalysisAtAStiffness]':
