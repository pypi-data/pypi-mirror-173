...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4656
...
class GuideDxfModelCompoundModalAnalysisAtAStiffness(_4749.ComponentCompoundModalAnalysisAtAStiffness):
    """GuideDxfModelCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4656.GuideDxfModelModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4656.GuideDxfModelModalAnalysisAtAStiffness]':
