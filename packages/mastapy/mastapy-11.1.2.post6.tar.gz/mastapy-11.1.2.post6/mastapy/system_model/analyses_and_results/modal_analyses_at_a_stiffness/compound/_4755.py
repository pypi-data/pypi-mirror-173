...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4753, _4754, _4784
...
class ConceptGearSetCompoundModalAnalysisAtAStiffness(_4784.GearSetCompoundModalAnalysisAtAStiffness):
    """ConceptGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4625.ConceptGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4753.ConceptGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4754.ConceptGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4625.ConceptGearSetModalAnalysisAtAStiffness]':
