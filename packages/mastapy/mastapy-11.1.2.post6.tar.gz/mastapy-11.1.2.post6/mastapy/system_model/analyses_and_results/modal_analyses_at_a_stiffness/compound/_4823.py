...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4695
...
class SpiralBevelGearCompoundModalAnalysisAtAStiffness(_4740.BevelGearCompoundModalAnalysisAtAStiffness):
    """SpiralBevelGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4695.SpiralBevelGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4695.SpiralBevelGearModalAnalysisAtAStiffness]':
