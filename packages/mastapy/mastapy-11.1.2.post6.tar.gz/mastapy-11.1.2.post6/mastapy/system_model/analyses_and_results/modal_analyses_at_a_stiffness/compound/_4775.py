...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4645
...
class DatumCompoundModalAnalysisAtAStiffness(_4749.ComponentCompoundModalAnalysisAtAStiffness):
    """DatumCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4645.DatumModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4645.DatumModalAnalysisAtAStiffness]':
