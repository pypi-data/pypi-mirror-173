...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4642, _4641, _4655
...
class CylindricalGearSetModalAnalysisAtAStiffness(_4655.GearSetModalAnalysisAtAStiffness):
    """CylindricalGearSetModalAnalysisAtAStiffness
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4642.CylindricalGearModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4641.CylindricalGearMeshModalAnalysisAtAStiffness]':
