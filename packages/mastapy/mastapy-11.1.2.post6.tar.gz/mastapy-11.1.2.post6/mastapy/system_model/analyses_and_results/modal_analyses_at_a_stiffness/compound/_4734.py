...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4604
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4822
...
class BeltDriveCompoundModalAnalysisAtAStiffness(_4822.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """BeltDriveCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4604.BeltDriveModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4604.BeltDriveModalAnalysisAtAStiffness]':
