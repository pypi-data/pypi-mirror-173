...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4658
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4728
...
class HypoidGearCompoundModalAnalysisAtAStiffness(_4728.AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness):
    """HypoidGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4658.HypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4658.HypoidGearModalAnalysisAtAStiffness]':
