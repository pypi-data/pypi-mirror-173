...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4727
...
class CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtAStiffness(_4727.AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4640.CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4640.CycloidalDiscPlanetaryBearingConnectionModalAnalysisAtAStiffness]':
