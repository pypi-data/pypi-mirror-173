...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4705
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4832, _4833, _4742
...
class StraightBevelGearSetCompoundModalAnalysisAtAStiffness(_4742.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """StraightBevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4705.StraightBevelGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4832.StraightBevelGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4833.StraightBevelGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4705.StraightBevelGearSetModalAnalysisAtAStiffness]':
