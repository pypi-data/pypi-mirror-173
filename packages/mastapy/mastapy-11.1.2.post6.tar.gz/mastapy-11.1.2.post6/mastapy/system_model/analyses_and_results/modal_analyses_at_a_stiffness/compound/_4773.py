...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4643
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4771, _4772, _4784
...
class CylindricalGearSetCompoundModalAnalysisAtAStiffness(_4784.GearSetCompoundModalAnalysisAtAStiffness):
    """CylindricalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4643.CylindricalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4771.CylindricalGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4772.CylindricalGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4643.CylindricalGearSetModalAnalysisAtAStiffness]':
