...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4708
...
class SynchroniserHalfCompoundModalAnalysisAtAStiffness(_4839.SynchroniserPartCompoundModalAnalysisAtAStiffness):
    """SynchroniserHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4708.SynchroniserHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4708.SynchroniserHalfModalAnalysisAtAStiffness]':
