...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4688
...
class RollingRingCompoundModalAnalysisAtAStiffness(_4763.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """RollingRingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4688.RollingRingModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4688.RollingRingModalAnalysisAtAStiffness]':
