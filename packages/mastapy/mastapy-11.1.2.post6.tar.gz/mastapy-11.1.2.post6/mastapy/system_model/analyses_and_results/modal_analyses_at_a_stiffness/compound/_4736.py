...
class BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness(_4741.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4605.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4605.BevelDifferentialGearMeshModalAnalysisAtAStiffness]':
