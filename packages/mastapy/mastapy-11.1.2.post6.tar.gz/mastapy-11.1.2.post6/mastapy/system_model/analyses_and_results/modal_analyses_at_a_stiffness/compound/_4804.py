...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4677
...
class PartToPartShearCouplingCompoundModalAnalysisAtAStiffness(_4761.CouplingCompoundModalAnalysisAtAStiffness):
    """PartToPartShearCouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4677.PartToPartShearCouplingModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4677.PartToPartShearCouplingModalAnalysisAtAStiffness]':
