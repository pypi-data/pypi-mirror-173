...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4606
...
class BevelDifferentialGearCompoundModalAnalysisAtAStiffness(_4740.BevelGearCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4606.BevelDifferentialGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4606.BevelDifferentialGearModalAnalysisAtAStiffness]':
