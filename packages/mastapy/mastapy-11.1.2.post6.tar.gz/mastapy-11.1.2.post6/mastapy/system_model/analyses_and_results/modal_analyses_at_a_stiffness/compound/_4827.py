...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4697
...
class SpringDamperConnectionCompoundModalAnalysisAtAStiffness(_4762.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """SpringDamperConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4697.SpringDamperConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4697.SpringDamperConnectionModalAnalysisAtAStiffness]':
