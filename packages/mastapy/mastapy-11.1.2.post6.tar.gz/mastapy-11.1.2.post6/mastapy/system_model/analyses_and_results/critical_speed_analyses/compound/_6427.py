...
class ConceptGearCompoundCriticalSpeedAnalysis(_6456.GearCompoundCriticalSpeedAnalysis):
    """ConceptGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6296.ConceptGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6296.ConceptGearCriticalSpeedAnalysis]':
