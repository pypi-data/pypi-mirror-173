...
class ConceptCouplingConnectionCompoundCriticalSpeedAnalysis(_6436.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """ConceptCouplingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6293.ConceptCouplingConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6293.ConceptCouplingConnectionCriticalSpeedAnalysis]':
