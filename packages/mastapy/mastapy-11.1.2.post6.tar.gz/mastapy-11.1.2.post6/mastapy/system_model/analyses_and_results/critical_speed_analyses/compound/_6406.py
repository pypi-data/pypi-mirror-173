...
class BearingCompoundCriticalSpeedAnalysis(_6434.ConnectorCompoundCriticalSpeedAnalysis):
    """BearingCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6275.BearingCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6275.BearingCriticalSpeedAnalysis]':
