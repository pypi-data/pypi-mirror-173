...
class OilSealCompoundCriticalSpeedAnalysis(_6434.ConnectorCompoundCriticalSpeedAnalysis):
    """OilSealCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6347.OilSealCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6347.OilSealCriticalSpeedAnalysis]':
