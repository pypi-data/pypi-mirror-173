...
class MeasurementComponentCompoundCriticalSpeedAnalysis(_6520.VirtualComponentCompoundCriticalSpeedAnalysis):
    """MeasurementComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6345.MeasurementComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6345.MeasurementComponentCriticalSpeedAnalysis]':
