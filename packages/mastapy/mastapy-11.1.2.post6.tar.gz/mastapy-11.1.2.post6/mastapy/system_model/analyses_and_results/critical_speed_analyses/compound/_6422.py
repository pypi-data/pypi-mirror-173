...
class CoaxialConnectionCompoundCriticalSpeedAnalysis(_6495.ShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    """CoaxialConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6291.CoaxialConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6291.CoaxialConnectionCriticalSpeedAnalysis]':
