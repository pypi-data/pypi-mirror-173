...
class SynchroniserHalfCompoundCriticalSpeedAnalysis(_6513.SynchroniserPartCompoundCriticalSpeedAnalysis):
    """SynchroniserHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6383.SynchroniserHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6383.SynchroniserHalfCriticalSpeedAnalysis]':
