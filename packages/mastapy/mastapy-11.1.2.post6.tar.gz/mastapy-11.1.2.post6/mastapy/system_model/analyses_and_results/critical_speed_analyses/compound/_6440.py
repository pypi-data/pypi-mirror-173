...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6486
...
class CVTPulleyCompoundCriticalSpeedAnalysis(_6486.PulleyCompoundCriticalSpeedAnalysis):
    """CVTPulleyCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6311.CVTPulleyCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6311.CVTPulleyCriticalSpeedAnalysis]':
