...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6316, _6317, _6329
...
class CylindricalGearSetCriticalSpeedAnalysis(_6329.GearSetCriticalSpeedAnalysis):
    """CylindricalGearSetCriticalSpeedAnalysis
    ...
    @property
    def cylindrical_gears_critical_speed_analysis(self) -> 'List[_6316.CylindricalGearCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_meshes_critical_speed_analysis(self) -> 'List[_6317.CylindricalGearMeshCriticalSpeedAnalysis]':
