...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6521, _6522, _6458
...
class WormGearSetCompoundCriticalSpeedAnalysis(_6458.GearSetCompoundCriticalSpeedAnalysis):
    """WormGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6394.WormGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gears_compound_critical_speed_analysis(self) -> 'List[_6521.WormGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def worm_meshes_compound_critical_speed_analysis(self) -> 'List[_6522.WormGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6394.WormGearSetCriticalSpeedAnalysis]':
