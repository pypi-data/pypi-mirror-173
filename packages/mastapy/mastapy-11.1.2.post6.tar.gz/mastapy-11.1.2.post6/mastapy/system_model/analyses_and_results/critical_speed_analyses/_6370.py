...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6368, _6369, _6285
...
class SpiralBevelGearSetCriticalSpeedAnalysis(_6285.BevelGearSetCriticalSpeedAnalysis):
    """SpiralBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def spiral_bevel_gears_critical_speed_analysis(self) -> 'List[_6368.SpiralBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_critical_speed_analysis(self) -> 'List[_6369.SpiralBevelGearMeshCriticalSpeedAnalysis]':
