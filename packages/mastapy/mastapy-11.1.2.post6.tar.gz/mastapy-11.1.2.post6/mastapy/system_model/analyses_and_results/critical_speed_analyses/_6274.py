...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import (
    _6275, _6277, _6280, _6287,
    _6286, _6310, _6289, _6294,
    _6298, _6312, _6314, _6318,
    _6325, _6324, _6326, _6333,
    _6340, _6343, _6344, _6345,
    _6347, _6350, _6354, _6355,
    _6356, _6358, _6360, _6365,
    _6364, _6370, _6372, _6376,
    _6379, _6382, _6387, _6390,
    _6394, _6397, _6267
)
...
class AssemblyCriticalSpeedAnalysis(_6267.AbstractAssemblyCriticalSpeedAnalysis):
    """AssemblyCriticalSpeedAnalysis
    ...
    @property
    def bearings(self) -> 'List[_6275.BearingCriticalSpeedAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6277.BeltDriveCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6280.BevelDifferentialGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6287.BoltedJointCriticalSpeedAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6286.BoltCriticalSpeedAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6310.CVTCriticalSpeedAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6289.ClutchCriticalSpeedAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6294.ConceptCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6298.ConceptGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6312.CycloidalAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6314.CycloidalDiscCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6318.CylindricalGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6325.FEPartCriticalSpeedAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6324.FaceGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6326.FlexiblePinAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6333.HypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6340.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6343.KlingelnbergCycloPalloidSpiralBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6344.MassDiscCriticalSpeedAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6345.MeasurementComponentCriticalSpeedAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6347.OilSealCriticalSpeedAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6350.PartToPartShearCouplingCriticalSpeedAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6354.PlanetCarrierCriticalSpeedAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6355.PointLoadCriticalSpeedAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6356.PowerLoadCriticalSpeedAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6358.RingPinsCriticalSpeedAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6360.RollingRingAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6365.ShaftHubConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6364.ShaftCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6370.SpiralBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6372.SpringDamperCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6376.StraightBevelDiffGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6379.StraightBevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6382.SynchroniserCriticalSpeedAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6387.TorqueConverterCriticalSpeedAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6390.UnbalancedMassCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6394.WormGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6397.ZerolBevelGearSetCriticalSpeedAnalysis]':
