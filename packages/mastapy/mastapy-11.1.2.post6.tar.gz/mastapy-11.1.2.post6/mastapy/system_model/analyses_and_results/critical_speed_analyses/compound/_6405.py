...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import (
    _6406, _6408, _6411, _6418,
    _6417, _6439, _6419, _6424,
    _6429, _6441, _6443, _6447,
    _6454, _6453, _6455, _6462,
    _6469, _6472, _6473, _6474,
    _6476, _6478, _6483, _6484,
    _6485, _6487, _6489, _6494,
    _6493, _6499, _6500, _6505,
    _6508, _6511, _6515, _6519,
    _6523, _6526, _6398
)
...
class AssemblyCompoundCriticalSpeedAnalysis(_6398.AbstractAssemblyCompoundCriticalSpeedAnalysis):
    """AssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6274.AssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_6406.BearingCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_6408.BeltDriveCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6411.BevelDifferentialGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6418.BoltedJointCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_6417.BoltCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_6439.CVTCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_6419.ClutchCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6424.ConceptCouplingCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6429.ConceptGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6441.CycloidalAssemblyCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6443.CycloidalDiscCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6447.CylindricalGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_6454.FEPartCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6453.FaceGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6455.FlexiblePinAssemblyCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6462.HypoidGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6469.KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6472.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_6473.MassDiscCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_6474.MeasurementComponentCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_6476.OilSealCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6478.PartToPartShearCouplingCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6483.PlanetCarrierCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_6484.PointLoadCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_6485.PowerLoadCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_6487.RingPinsCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6489.RollingRingAssemblyCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6494.ShaftHubConnectionCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_6493.ShaftCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6499.SpiralBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6500.SpringDamperCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6505.StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6508.StraightBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_6511.SynchroniserCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_6515.TorqueConverterCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6519.UnbalancedMassCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6523.WormGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6526.ZerolBevelGearSetCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6274.AssemblyCriticalSpeedAnalysis]':
