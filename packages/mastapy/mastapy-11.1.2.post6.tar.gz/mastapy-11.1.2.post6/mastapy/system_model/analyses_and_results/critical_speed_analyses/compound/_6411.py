...
class BevelDifferentialGearSetCompoundCriticalSpeedAnalysis(_6416.BevelGearSetCompoundCriticalSpeedAnalysis):
    """BevelDifferentialGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6280.BevelDifferentialGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_critical_speed_analysis(self) -> 'List[_6409.BevelDifferentialGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_critical_speed_analysis(self) -> 'List[_6410.BevelDifferentialGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6280.BevelDifferentialGearSetCriticalSpeedAnalysis]':
