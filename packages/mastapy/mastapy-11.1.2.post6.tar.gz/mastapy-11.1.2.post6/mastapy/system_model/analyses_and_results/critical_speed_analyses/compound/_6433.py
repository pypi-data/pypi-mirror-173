...
class ConnectionCompoundCriticalSpeedAnalysis(_7265.ConnectionCompoundAnalysis):
    """ConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6302.ConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6302.ConnectionCriticalSpeedAnalysis]':
