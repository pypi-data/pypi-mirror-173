...
class ConnectorCompoundCriticalSpeedAnalysis(_6475.MountableComponentCompoundCriticalSpeedAnalysis):
    """ConnectorCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6303.ConnectorCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6303.ConnectorCriticalSpeedAnalysis]':
