...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5999, _5993
...
class FlexiblePinAnalysis(_5993.CombinationAnalysis):
    """FlexiblePinAnalysis
    ...
    @property
    def analysis_options(self) -> '_5999.FlexiblePinAnalysisOptions':
