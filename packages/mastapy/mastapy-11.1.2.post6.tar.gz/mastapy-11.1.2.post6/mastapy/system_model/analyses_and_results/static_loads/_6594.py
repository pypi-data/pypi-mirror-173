...
class ElectricMachineDetail(_1605.NamedDatabaseItem):
    """ElectricMachineDetail
    ...
    def default_effective_length(self) -> 'float':
        ...
        temp = self.wrapped.DefaultEffectiveLength
    ...
    def default_inner_diameter_of_stator_teeth(self) -> 'float':
        ...
        temp = self.wrapped.DefaultInnerDiameterOfStatorTeeth
    ...
    def default_number_of_slots(self) -> 'int':
        ...
        temp = self.wrapped.DefaultNumberOfSlots
