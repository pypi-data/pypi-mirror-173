...
from mastapy.system_model.analyses_and_results.static_loads import _6564, _6565, _6619
...
class ConceptGearSetLoadCase(_6619.GearSetLoadCase):
    """ConceptGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6564.ConceptGearLoadCase]':
    ...
    @property
    def concept_gears_load_case(self) -> 'List[_6564.ConceptGearLoadCase]':
    ...
    @property
    def concept_meshes_load_case(self) -> 'List[_6565.ConceptGearMeshLoadCase]':
