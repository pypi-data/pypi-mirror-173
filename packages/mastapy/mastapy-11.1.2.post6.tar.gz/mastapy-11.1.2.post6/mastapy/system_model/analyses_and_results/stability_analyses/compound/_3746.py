...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3744, _3745, _3657
...
class StraightBevelDiffGearSetCompoundStabilityAnalysis(_3657.BevelGearSetCompoundStabilityAnalysis):
    """StraightBevelDiffGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3616.StraightBevelDiffGearSetStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_stability_analysis(self) -> 'List[_3744.StraightBevelDiffGearCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_stability_analysis(self) -> 'List[_3745.StraightBevelDiffGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3616.StraightBevelDiffGearSetStabilityAnalysis]':
