...
class ZerolBevelGearMeshCompoundStabilityAnalysis(_3656.BevelGearMeshCompoundStabilityAnalysis):
    """ZerolBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3636.ZerolBevelGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3636.ZerolBevelGearMeshStabilityAnalysis]':
