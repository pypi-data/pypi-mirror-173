...
class DatumCompoundStabilityAnalysis(_3664.ComponentCompoundStabilityAnalysis):
    """DatumCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3559.DatumStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3559.DatumStabilityAnalysis]':
