...
class StraightBevelDiffGearMeshCompoundStabilityAnalysis(_3656.BevelGearMeshCompoundStabilityAnalysis):
    """StraightBevelDiffGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3615.StraightBevelDiffGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3615.StraightBevelDiffGearMeshStabilityAnalysis]':
