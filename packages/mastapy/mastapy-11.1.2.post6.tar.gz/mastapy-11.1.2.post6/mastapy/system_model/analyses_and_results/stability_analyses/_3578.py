...
from mastapy.system_model.analyses_and_results.stability_analyses import _3579, _3577, _3575
...
class KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis(_3575.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetStabilityAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_stability_analysis(self) -> 'List[_3579.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_stability_analysis(self) -> 'List[_3577.KlingelnbergCycloPalloidHypoidGearMeshStabilityAnalysis]':
