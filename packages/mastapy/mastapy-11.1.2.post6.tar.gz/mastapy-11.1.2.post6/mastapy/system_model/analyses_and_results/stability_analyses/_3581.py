...
from mastapy.system_model.analyses_and_results.stability_analyses import _3582, _3580, _3575
...
class KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis(_3575.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetStabilityAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_stability_analysis(self) -> 'List[_3582.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_stability_analysis(self) -> 'List[_3580.KlingelnbergCycloPalloidSpiralBevelGearMeshStabilityAnalysis]':
