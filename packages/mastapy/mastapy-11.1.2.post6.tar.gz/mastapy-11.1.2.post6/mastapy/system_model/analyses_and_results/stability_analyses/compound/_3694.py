...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3692, _3693, _3699
...
class FaceGearSetCompoundStabilityAnalysis(_3699.GearSetCompoundStabilityAnalysis):
    """FaceGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3562.FaceGearSetStabilityAnalysis]':
    ...
    @property
    def face_gears_compound_stability_analysis(self) -> 'List[_3692.FaceGearCompoundStabilityAnalysis]':
    ...
    @property
    def face_meshes_compound_stability_analysis(self) -> 'List[_3693.FaceGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3562.FaceGearSetStabilityAnalysis]':
