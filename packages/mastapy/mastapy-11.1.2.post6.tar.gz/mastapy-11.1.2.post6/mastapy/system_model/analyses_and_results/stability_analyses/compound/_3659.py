...
class BoltedJointCompoundStabilityAnalysis(_3737.SpecialisedAssemblyCompoundStabilityAnalysis):
    """BoltedJointCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3526.BoltedJointStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3526.BoltedJointStabilityAnalysis]':
