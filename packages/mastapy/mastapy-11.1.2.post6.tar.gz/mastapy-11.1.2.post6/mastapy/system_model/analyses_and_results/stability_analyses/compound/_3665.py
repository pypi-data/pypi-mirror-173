...
class ConceptCouplingCompoundStabilityAnalysis(_3676.CouplingCompoundStabilityAnalysis):
    """ConceptCouplingCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3535.ConceptCouplingStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3535.ConceptCouplingStabilityAnalysis]':
