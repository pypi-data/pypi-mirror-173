...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3716
...
class RingPinsCompoundStabilityAnalysis(_3716.MountableComponentCompoundStabilityAnalysis):
    """RingPinsCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3597.RingPinsStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3597.RingPinsStabilityAnalysis]':
