...
class CVTBeltConnectionCompoundStabilityAnalysis(_3648.BeltConnectionCompoundStabilityAnalysis):
    """CVTBeltConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3548.CVTBeltConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3548.CVTBeltConnectionStabilityAnalysis]':
