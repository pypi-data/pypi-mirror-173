...
class GuideDxfModelCompoundStabilityAnalysis(_3664.ComponentCompoundStabilityAnalysis):
    """GuideDxfModelCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3569.GuideDxfModelStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3569.GuideDxfModelStabilityAnalysis]':
