...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3686, _3687, _3699
...
class CylindricalGearSetCompoundStabilityAnalysis(_3699.GearSetCompoundStabilityAnalysis):
    """CylindricalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3556.CylindricalGearSetStabilityAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_stability_analysis(self) -> 'List[_3686.CylindricalGearCompoundStabilityAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_stability_analysis(self) -> 'List[_3687.CylindricalGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3556.CylindricalGearSetStabilityAnalysis]':
