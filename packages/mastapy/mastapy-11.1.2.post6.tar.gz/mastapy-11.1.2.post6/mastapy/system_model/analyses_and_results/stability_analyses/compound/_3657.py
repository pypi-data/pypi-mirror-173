...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3645
...
class BevelGearSetCompoundStabilityAnalysis(_3645.AGMAGleasonConicalGearSetCompoundStabilityAnalysis):
    """BevelGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3524.BevelGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3524.BevelGearSetStabilityAnalysis]':
