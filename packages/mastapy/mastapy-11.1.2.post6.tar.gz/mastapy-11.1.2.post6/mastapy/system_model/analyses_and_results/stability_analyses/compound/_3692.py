...
class FaceGearCompoundStabilityAnalysis(_3697.GearCompoundStabilityAnalysis):
    """FaceGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3563.FaceGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3563.FaceGearStabilityAnalysis]':
