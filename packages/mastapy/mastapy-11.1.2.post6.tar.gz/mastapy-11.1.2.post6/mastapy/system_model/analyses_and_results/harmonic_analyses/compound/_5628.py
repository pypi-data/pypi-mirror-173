...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5435
...
class ClutchHalfCompoundHarmonicAnalysis(_5644.CouplingHalfCompoundHarmonicAnalysis):
    """ClutchHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5435.ClutchHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5435.ClutchHalfHarmonicAnalysis]':
