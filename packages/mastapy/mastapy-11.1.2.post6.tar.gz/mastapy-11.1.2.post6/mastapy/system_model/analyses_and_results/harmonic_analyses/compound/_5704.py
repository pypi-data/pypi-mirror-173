...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5539
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5621
...
class SpiralBevelGearCompoundHarmonicAnalysis(_5621.BevelGearCompoundHarmonicAnalysis):
    """SpiralBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5539.SpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5539.SpiralBevelGearHarmonicAnalysis]':
