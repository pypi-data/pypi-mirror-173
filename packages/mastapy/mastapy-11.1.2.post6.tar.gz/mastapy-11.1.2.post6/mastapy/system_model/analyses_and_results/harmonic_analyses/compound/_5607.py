...
class AbstractShaftOrHousingCompoundHarmonicAnalysis(_5630.ComponentCompoundHarmonicAnalysis):
    """AbstractShaftOrHousingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5415.AbstractShaftOrHousingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5415.AbstractShaftOrHousingHarmonicAnalysis]':
