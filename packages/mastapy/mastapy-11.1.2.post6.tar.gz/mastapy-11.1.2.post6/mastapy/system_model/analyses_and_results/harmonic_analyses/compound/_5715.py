...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5550
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5713, _5714, _5623
...
class StraightBevelGearSetCompoundHarmonicAnalysis(_5623.BevelGearSetCompoundHarmonicAnalysis):
    """StraightBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5550.StraightBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5713.StraightBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5714.StraightBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5550.StraightBevelGearSetHarmonicAnalysis]':
