...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5514
...
class MountableComponentCompoundHarmonicAnalysis(_5630.ComponentCompoundHarmonicAnalysis):
    """MountableComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5514.MountableComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5514.MountableComponentHarmonicAnalysis]':
