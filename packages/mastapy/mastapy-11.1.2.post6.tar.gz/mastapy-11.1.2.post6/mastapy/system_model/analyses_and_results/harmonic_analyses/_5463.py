...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5461, _5462, _5490
...
class CylindricalGearSetHarmonicAnalysis(_5490.GearSetHarmonicAnalysis):
    """CylindricalGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5461.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gears_harmonic_analysis(self) -> 'List[_5461.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5462.CylindricalGearMeshHarmonicAnalysis]':
    ...
    @property
    def cylindrical_meshes_harmonic_analysis(self) -> 'List[_5462.CylindricalGearMeshHarmonicAnalysis]':
