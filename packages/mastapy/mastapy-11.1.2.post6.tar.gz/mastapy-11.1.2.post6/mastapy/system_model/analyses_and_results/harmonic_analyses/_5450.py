...
class ConnectorHarmonicAnalysis(_5514.MountableComponentHarmonicAnalysis):
    """ConnectorHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2472.ConnectorSystemDeflection':
