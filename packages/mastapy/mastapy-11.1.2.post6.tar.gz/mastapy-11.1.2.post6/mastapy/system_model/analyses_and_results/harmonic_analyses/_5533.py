...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5498, _5414
...
class ShaftHarmonicAnalysis(_5414.AbstractShaftHarmonicAnalysis):
    """ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4414.ShaftModalAnalysis':
    ...
    @property
    def export(self) -> '_5498.HarmonicAnalysisShaftExportOptions':
    ...
    @property
    def system_deflection_results(self) -> '_2548.ShaftSystemDeflection':
