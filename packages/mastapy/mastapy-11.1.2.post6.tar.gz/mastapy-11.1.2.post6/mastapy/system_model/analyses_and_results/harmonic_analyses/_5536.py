...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5520
...
class SingleNodePeriodicExcitationWithReferenceShaft(_5520.PeriodicExcitationWithReferenceShaft):
    """SingleNodePeriodicExcitationWithReferenceShaft
