...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5413
...
class PeriodicExcitationWithReferenceShaft(_5413.AbstractPeriodicExcitationDetail):
    """PeriodicExcitationWithReferenceShaft
