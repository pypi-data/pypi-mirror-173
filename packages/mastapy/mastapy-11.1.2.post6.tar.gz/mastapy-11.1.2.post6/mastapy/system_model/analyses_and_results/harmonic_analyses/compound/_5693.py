...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5526
...
class PulleyCompoundHarmonicAnalysis(_5644.CouplingHalfCompoundHarmonicAnalysis):
    """PulleyCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5526.PulleyHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5526.PulleyHarmonicAnalysis]':
