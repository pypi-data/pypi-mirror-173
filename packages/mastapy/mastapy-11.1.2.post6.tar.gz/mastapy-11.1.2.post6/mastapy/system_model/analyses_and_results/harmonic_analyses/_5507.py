...
class KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis(_5504.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2515.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection':
