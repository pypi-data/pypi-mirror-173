...
class CVTBeltConnectionHarmonicAnalysis(_5422.BeltConnectionHarmonicAnalysis):
    """CVTBeltConnectionHarmonicAnalysis
    ...
    @property
    def connection_design(self) -> '_2024.CVTBeltConnection':
    ...
    @property
    def system_deflection_results(self) -> '_2476.CVTBeltConnectionSystemDeflection':
