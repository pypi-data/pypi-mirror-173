...
class SynchroniserCompoundHarmonicAnalysis(_5703.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """SynchroniserCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5554.SynchroniserHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5554.SynchroniserHarmonicAnalysis]':
