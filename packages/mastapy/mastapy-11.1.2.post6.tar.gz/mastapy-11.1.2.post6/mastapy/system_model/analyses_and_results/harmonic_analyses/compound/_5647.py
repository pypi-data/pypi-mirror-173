...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5456
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5693
...
class CVTPulleyCompoundHarmonicAnalysis(_5693.PulleyCompoundHarmonicAnalysis):
    """CVTPulleyCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5456.CVTPulleyHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5456.CVTPulleyHarmonicAnalysis]':
