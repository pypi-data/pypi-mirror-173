...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5597, _5580
...
class SingleWhineAnalysisResultsPropertyAccessor(_5580.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    """SingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5597.ResultsForOrderIncludingNodes]':
