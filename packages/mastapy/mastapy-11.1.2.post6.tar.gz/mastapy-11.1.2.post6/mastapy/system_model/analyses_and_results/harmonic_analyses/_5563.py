...
class VirtualComponentHarmonicAnalysis(_5514.MountableComponentHarmonicAnalysis):
    """VirtualComponentHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2579.VirtualComponentSystemDeflection':
