...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5442
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5642
...
class ConceptCouplingCompoundHarmonicAnalysis(_5642.CouplingCompoundHarmonicAnalysis):
    """ConceptCouplingCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5442.ConceptCouplingHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5442.ConceptCouplingHarmonicAnalysis]':
