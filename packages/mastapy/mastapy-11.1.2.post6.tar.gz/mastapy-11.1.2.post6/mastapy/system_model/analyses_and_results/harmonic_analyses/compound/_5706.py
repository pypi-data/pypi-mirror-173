...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5541
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5704, _5705, _5623
...
class SpiralBevelGearSetCompoundHarmonicAnalysis(_5623.BevelGearSetCompoundHarmonicAnalysis):
    """SpiralBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5541.SpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5704.SpiralBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5705.SpiralBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5541.SpiralBevelGearSetHarmonicAnalysis]':
