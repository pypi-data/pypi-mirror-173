...
class BeltDriveCompoundHarmonicAnalysis(_5703.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """BeltDriveCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5423.BeltDriveHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5423.BeltDriveHarmonicAnalysis]':
