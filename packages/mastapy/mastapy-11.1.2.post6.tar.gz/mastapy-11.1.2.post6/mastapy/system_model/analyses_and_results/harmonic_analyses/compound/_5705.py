...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5540
...
class SpiralBevelGearMeshCompoundHarmonicAnalysis(_5622.BevelGearMeshCompoundHarmonicAnalysis):
    """SpiralBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5540.SpiralBevelGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5540.SpiralBevelGearMeshHarmonicAnalysis]':
