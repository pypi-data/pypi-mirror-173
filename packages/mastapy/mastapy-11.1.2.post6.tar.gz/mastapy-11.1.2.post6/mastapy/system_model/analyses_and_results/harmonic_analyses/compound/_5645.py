...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5454
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5614
...
class CVTBeltConnectionCompoundHarmonicAnalysis(_5614.BeltConnectionCompoundHarmonicAnalysis):
    """CVTBeltConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5454.CVTBeltConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5454.CVTBeltConnectionHarmonicAnalysis]':
