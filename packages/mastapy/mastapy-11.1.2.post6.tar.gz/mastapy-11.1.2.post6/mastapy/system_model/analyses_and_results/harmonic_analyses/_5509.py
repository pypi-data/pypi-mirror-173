...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5503
...
class KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis(_5503.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2520.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection':
