...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5545
...
class StraightBevelDiffGearCompoundHarmonicAnalysis(_5621.BevelGearCompoundHarmonicAnalysis):
    """StraightBevelDiffGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5545.StraightBevelDiffGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5545.StraightBevelDiffGearHarmonicAnalysis]':
