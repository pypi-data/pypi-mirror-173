...
class RollingRingConnectionHarmonicAnalysis(_5502.InterMountableComponentConnectionHarmonicAnalysis):
    """RollingRingConnectionHarmonicAnalysis
    ...
    @property
    def connection_load_case(self) -> '_6673.RollingRingConnectionLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2542.RollingRingConnectionSystemDeflection':
