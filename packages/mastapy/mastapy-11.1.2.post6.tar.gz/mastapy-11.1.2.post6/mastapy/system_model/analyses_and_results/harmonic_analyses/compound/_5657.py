...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5478
...
class ExternalCADModelCompoundHarmonicAnalysis(_5630.ComponentCompoundHarmonicAnalysis):
    """ExternalCADModelCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5478.ExternalCADModelHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5478.ExternalCADModelHarmonicAnalysis]':
