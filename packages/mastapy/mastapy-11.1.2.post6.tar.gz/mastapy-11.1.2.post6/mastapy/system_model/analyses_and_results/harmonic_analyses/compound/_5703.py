...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5605
...
class SpecialisedAssemblyCompoundHarmonicAnalysis(_5605.AbstractAssemblyCompoundHarmonicAnalysis):
    """SpecialisedAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5537.SpecialisedAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5537.SpecialisedAssemblyHarmonicAnalysis]':
