...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5528
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5670
...
class RingPinsToDiscConnectionCompoundHarmonicAnalysis(_5670.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    """RingPinsToDiscConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5528.RingPinsToDiscConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5528.RingPinsToDiscConnectionHarmonicAnalysis]':
