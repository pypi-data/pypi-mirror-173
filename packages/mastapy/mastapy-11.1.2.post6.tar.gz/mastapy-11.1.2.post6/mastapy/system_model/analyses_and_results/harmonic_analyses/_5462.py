...
from mastapy.system_model.analyses_and_results.system_deflections import _2483, _2484, _2485
...
class CylindricalGearMeshHarmonicAnalysis(_5487.GearMeshHarmonicAnalysis):
    """CylindricalGearMeshHarmonicAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_7048.CylindricalGearMeshAdvancedSystemDeflection':
    ...
    @property
    def system_deflection_results(self) -> '_2483.CylindricalGearMeshSystemDeflection':
