...
class ConceptCouplingHalfHarmonicAnalysis(_5452.CouplingHalfHarmonicAnalysis):
    """ConceptCouplingHalfHarmonicAnalysis
    ...
    @property
    def component_load_case(self) -> '_6562.ConceptCouplingHalfLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2462.ConceptCouplingHalfSystemDeflection':
