...
class AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis(_5640.ConnectionCompoundHarmonicAnalysis):
    """AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5416.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5416.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
