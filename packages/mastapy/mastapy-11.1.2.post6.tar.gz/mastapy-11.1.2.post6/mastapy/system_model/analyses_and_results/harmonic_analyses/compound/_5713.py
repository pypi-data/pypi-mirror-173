...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5548
...
class StraightBevelGearCompoundHarmonicAnalysis(_5621.BevelGearCompoundHarmonicAnalysis):
    """StraightBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5548.StraightBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5548.StraightBevelGearHarmonicAnalysis]':
