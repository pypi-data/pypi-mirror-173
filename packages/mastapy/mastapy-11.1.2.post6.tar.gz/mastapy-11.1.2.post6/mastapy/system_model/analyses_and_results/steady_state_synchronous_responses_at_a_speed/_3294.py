...
class CycloidalDiscSteadyStateSynchronousResponseAtASpeed(_3250.AbstractShaftSteadyStateSynchronousResponseAtASpeed):
    """CycloidalDiscSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_load_case(self) -> '_6582.CycloidalDiscLoadCase':
