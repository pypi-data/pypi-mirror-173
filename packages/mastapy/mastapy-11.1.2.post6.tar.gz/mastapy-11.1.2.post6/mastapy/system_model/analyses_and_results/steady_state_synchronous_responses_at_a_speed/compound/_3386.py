...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3256
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3414
...
class BearingCompoundSteadyStateSynchronousResponseAtASpeed(_3414.ConnectorCompoundSteadyStateSynchronousResponseAtASpeed):
    """BearingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3256.BearingSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3256.BearingSteadyStateSynchronousResponseAtASpeed]':
