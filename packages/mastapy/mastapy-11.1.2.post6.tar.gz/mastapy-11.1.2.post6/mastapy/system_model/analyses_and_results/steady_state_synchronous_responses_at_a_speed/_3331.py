...
class PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed(_3345.ShaftToMountableComponentConnectionSteadyStateSynchronousResponseAtASpeed):
    """PlanetaryConnectionSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_load_case(self) -> '_6659.PlanetaryConnectionLoadCase':
