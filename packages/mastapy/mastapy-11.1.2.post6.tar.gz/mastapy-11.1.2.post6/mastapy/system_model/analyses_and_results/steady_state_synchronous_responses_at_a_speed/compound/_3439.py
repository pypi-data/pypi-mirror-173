...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3309
...
class GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed(_3403.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """GuideDxfModelCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3309.GuideDxfModelSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3309.GuideDxfModelSteadyStateSynchronousResponseAtASpeed]':
