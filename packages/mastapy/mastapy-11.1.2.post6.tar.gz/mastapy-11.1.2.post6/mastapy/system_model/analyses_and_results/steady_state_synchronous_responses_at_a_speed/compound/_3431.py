...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3303
...
class FaceGearCompoundSteadyStateSynchronousResponseAtASpeed(_3436.GearCompoundSteadyStateSynchronousResponseAtASpeed):
    """FaceGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3303.FaceGearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3303.FaceGearSteadyStateSynchronousResponseAtASpeed]':
