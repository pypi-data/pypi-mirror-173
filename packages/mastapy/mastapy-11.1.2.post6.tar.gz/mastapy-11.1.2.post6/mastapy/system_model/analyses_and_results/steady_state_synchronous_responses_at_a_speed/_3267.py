...
class BoltedJointSteadyStateSynchronousResponseAtASpeed(_3346.SpecialisedAssemblySteadyStateSynchronousResponseAtASpeed):
    """BoltedJointSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_load_case(self) -> '_6554.BoltedJointLoadCase':
