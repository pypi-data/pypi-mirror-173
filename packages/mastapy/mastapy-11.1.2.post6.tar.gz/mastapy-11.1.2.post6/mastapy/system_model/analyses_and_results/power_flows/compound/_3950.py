...
class CycloidalAssemblyCompoundPowerFlow(_4005.SpecialisedAssemblyCompoundPowerFlow):
    """CycloidalAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3817.CycloidalAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3817.CycloidalAssemblyPowerFlow]':
