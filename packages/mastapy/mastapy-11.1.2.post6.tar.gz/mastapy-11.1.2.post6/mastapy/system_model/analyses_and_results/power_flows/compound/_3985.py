...
class OilSealCompoundPowerFlow(_3943.ConnectorCompoundPowerFlow):
    """OilSealCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3853.OilSealPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3853.OilSealPowerFlow]':
