...
class ConceptCouplingHalfCompoundPowerFlow(_3946.CouplingHalfCompoundPowerFlow):
    """ConceptCouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3801.ConceptCouplingHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3801.ConceptCouplingHalfPowerFlow]':
