...
class MountableComponentCompoundPowerFlow(_3932.ComponentCompoundPowerFlow):
    """MountableComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3852.MountableComponentPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3852.MountableComponentPowerFlow]':
