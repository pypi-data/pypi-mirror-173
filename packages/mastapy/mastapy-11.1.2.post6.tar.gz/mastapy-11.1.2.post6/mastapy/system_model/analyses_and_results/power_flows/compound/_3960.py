...
class FaceGearCompoundPowerFlow(_3965.GearCompoundPowerFlow):
    """FaceGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3829.FaceGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3829.FaceGearPowerFlow]':
