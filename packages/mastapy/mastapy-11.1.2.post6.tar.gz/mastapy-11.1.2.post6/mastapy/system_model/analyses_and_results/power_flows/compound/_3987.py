...
class PartToPartShearCouplingCompoundPowerFlow(_3944.CouplingCompoundPowerFlow):
    """PartToPartShearCouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3857.PartToPartShearCouplingPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3857.PartToPartShearCouplingPowerFlow]':
