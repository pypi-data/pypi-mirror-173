...
class PlanetCarrierCompoundPowerFlow(_3984.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3860.PlanetCarrierPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3860.PlanetCarrierPowerFlow]':
