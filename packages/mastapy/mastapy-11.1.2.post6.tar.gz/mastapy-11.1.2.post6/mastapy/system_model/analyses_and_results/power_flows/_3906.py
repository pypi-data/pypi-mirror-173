...
from mastapy.system_model.analyses_and_results.power_flows import _3905, _3904, _3792
...
class ZerolBevelGearSetPowerFlow(_3792.BevelGearSetPowerFlow):
    """ZerolBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3905.ZerolBevelGearPowerFlow]':
    ...
    @property
    def zerol_bevel_gears_power_flow(self) -> 'List[_3905.ZerolBevelGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3904.ZerolBevelGearMeshPowerFlow]':
    ...
    @property
    def zerol_bevel_meshes_power_flow(self) -> 'List[_3904.ZerolBevelGearMeshPowerFlow]':
