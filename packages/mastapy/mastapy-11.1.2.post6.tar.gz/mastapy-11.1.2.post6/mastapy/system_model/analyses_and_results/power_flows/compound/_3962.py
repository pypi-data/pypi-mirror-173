...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3960, _3961, _3967
...
class FaceGearSetCompoundPowerFlow(_3967.GearSetCompoundPowerFlow):
    """FaceGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3830.FaceGearSetPowerFlow]':
    ...
    @property
    def face_gears_compound_power_flow(self) -> 'List[_3960.FaceGearCompoundPowerFlow]':
    ...
    @property
    def face_meshes_compound_power_flow(self) -> 'List[_3961.FaceGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3830.FaceGearSetPowerFlow]':
