...
class BeltDriveCompoundPowerFlow(_4005.SpecialisedAssemblyCompoundPowerFlow):
    """BeltDriveCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3784.BeltDrivePowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3784.BeltDrivePowerFlow]':
