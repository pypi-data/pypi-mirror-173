...
class SpiralBevelGearMeshCompoundPowerFlow(_3924.BevelGearMeshCompoundPowerFlow):
    """SpiralBevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3876.SpiralBevelGearMeshPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3876.SpiralBevelGearMeshPowerFlow]':
