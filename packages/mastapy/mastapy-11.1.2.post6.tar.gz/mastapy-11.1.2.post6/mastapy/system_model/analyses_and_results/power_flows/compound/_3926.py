...
class BoltCompoundPowerFlow(_3932.ComponentCompoundPowerFlow):
    """BoltCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3794.BoltPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3794.BoltPowerFlow]':
