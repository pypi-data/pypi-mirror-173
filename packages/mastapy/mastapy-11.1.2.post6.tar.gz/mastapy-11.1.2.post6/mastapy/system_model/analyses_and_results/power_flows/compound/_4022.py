...
class SynchroniserPartCompoundPowerFlow(_3946.CouplingHalfCompoundPowerFlow):
    """SynchroniserPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3891.SynchroniserPartPowerFlow]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3891.SynchroniserPartPowerFlow]':
