...
class StraightBevelGearCompoundPowerFlow(_3923.BevelGearCompoundPowerFlow):
    """StraightBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3886.StraightBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3886.StraightBevelGearPowerFlow]':
