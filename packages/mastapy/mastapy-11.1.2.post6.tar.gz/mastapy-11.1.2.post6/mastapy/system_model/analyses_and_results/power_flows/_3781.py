...
from mastapy.system_model.analyses_and_results.power_flows import (
    _3782, _3784, _3787, _3793,
    _3794, _3815, _3797, _3802,
    _3805, _3817, _3820, _3824,
    _3831, _3830, _3832, _3839,
    _3846, _3849, _3835, _3850,
    _3851, _3853, _3857, _3860,
    _3861, _3864, _3866, _3868,
    _3872, _3873, _3878, _3881,
    _3884, _3887, _3892, _3896,
    _3899, _3903, _3906, _3774
)
...
class AssemblyPowerFlow(_3774.AbstractAssemblyPowerFlow):
    """AssemblyPowerFlow
    ...
    @property
    def bearings(self) -> 'List[_3782.BearingPowerFlow]':
    ...
    @property
    def belt_drives(self) -> 'List[_3784.BeltDrivePowerFlow]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3787.BevelDifferentialGearSetPowerFlow]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3793.BoltedJointPowerFlow]':
    ...
    @property
    def bolts(self) -> 'List[_3794.BoltPowerFlow]':
    ...
    @property
    def cv_ts(self) -> 'List[_3815.CVTPowerFlow]':
    ...
    @property
    def clutches(self) -> 'List[_3797.ClutchPowerFlow]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3802.ConceptCouplingPowerFlow]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3805.ConceptGearSetPowerFlow]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3817.CycloidalAssemblyPowerFlow]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3820.CycloidalDiscPowerFlow]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3824.CylindricalGearSetPowerFlow]':
    ...
    @property
    def fe_parts(self) -> 'List[_3831.FEPartPowerFlow]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3830.FaceGearSetPowerFlow]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3832.FlexiblePinAssemblyPowerFlow]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3839.HypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3846.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3849.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_3835.GearSetPowerFlow]':
    ...
    @property
    def mass_discs(self) -> 'List[_3850.MassDiscPowerFlow]':
    ...
    @property
    def measurement_components(self) -> 'List[_3851.MeasurementComponentPowerFlow]':
    ...
    @property
    def oil_seals(self) -> 'List[_3853.OilSealPowerFlow]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3857.PartToPartShearCouplingPowerFlow]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3860.PlanetCarrierPowerFlow]':
    ...
    @property
    def point_loads(self) -> 'List[_3861.PointLoadPowerFlow]':
    ...
    @property
    def power_loads(self) -> 'List[_3864.PowerLoadPowerFlow]':
    ...
    @property
    def ring_pins(self) -> 'List[_3866.RingPinsPowerFlow]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3868.RollingRingAssemblyPowerFlow]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3872.ShaftHubConnectionPowerFlow]':
    ...
    @property
    def shafts(self) -> 'List[_3873.ShaftPowerFlow]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3878.SpiralBevelGearSetPowerFlow]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3881.SpringDamperPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3884.StraightBevelDiffGearSetPowerFlow]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3887.StraightBevelGearSetPowerFlow]':
    ...
    @property
    def synchronisers(self) -> 'List[_3892.SynchroniserPowerFlow]':
    ...
    @property
    def torque_converters(self) -> 'List[_3896.TorqueConverterPowerFlow]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3899.UnbalancedMassPowerFlow]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3903.WormGearSetPowerFlow]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3906.ZerolBevelGearSetPowerFlow]':
