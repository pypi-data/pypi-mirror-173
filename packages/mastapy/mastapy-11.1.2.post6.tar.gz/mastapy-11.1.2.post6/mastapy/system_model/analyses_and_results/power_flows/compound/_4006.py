...
class SpiralBevelGearCompoundPowerFlow(_3923.BevelGearCompoundPowerFlow):
    """SpiralBevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3877.SpiralBevelGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3877.SpiralBevelGearPowerFlow]':
