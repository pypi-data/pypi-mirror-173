...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4012
...
class StraightBevelPlanetGearCompoundPowerFlow(_4012.StraightBevelDiffGearCompoundPowerFlow):
    """StraightBevelPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3888.StraightBevelPlanetGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3888.StraightBevelPlanetGearPowerFlow]':
