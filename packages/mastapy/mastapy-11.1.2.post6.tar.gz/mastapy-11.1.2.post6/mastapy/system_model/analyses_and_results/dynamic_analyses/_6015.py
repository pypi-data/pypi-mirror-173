...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6013, _6014, _6020
...
class BevelDifferentialGearSetDynamicAnalysis(_6020.BevelGearSetDynamicAnalysis):
    """BevelDifferentialGearSetDynamicAnalysis
    ...
    @property
    def bevel_differential_gears_dynamic_analysis(self) -> 'List[_6013.BevelDifferentialGearDynamicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_dynamic_analysis(self) -> 'List[_6014.BevelDifferentialGearMeshDynamicAnalysis]':
