...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6161, _6162, _6192
...
class ConceptGearSetCompoundDynamicAnalysis(_6192.GearSetCompoundDynamicAnalysis):
    """ConceptGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6033.ConceptGearSetDynamicAnalysis]':
    ...
    @property
    def concept_gears_compound_dynamic_analysis(self) -> 'List[_6161.ConceptGearCompoundDynamicAnalysis]':
    ...
    @property
    def concept_meshes_compound_dynamic_analysis(self) -> 'List[_6162.ConceptGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6033.ConceptGearSetDynamicAnalysis]':
