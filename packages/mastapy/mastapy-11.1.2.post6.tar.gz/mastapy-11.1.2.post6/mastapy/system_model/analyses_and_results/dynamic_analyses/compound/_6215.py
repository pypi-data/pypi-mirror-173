...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6229
...
class PlanetaryConnectionCompoundDynamicAnalysis(_6229.ShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """PlanetaryConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6086.PlanetaryConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6086.PlanetaryConnectionDynamicAnalysis]':
