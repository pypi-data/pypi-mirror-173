...
class InterMountableComponentConnectionCompoundDynamicAnalysis(_6167.ConnectionCompoundDynamicAnalysis):
    """InterMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6068.InterMountableComponentConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6068.InterMountableComponentConnectionDynamicAnalysis]':
