...
class ExternalCADModelCompoundDynamicAnalysis(_6157.ComponentCompoundDynamicAnalysis):
    """ExternalCADModelCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6055.ExternalCADModelDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6055.ExternalCADModelDynamicAnalysis]':
