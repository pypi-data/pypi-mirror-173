...
class BearingCompoundDynamicAnalysis(_6168.ConnectorCompoundDynamicAnalysis):
    """BearingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6010.BearingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6010.BearingDynamicAnalysis]':
