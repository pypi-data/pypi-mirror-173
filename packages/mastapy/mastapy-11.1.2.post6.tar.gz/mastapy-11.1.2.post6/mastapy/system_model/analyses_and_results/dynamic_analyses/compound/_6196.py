...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6194, _6195, _6138
...
class HypoidGearSetCompoundDynamicAnalysis(_6138.AGMAGleasonConicalGearSetCompoundDynamicAnalysis):
    """HypoidGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6067.HypoidGearSetDynamicAnalysis]':
    ...
    @property
    def hypoid_gears_compound_dynamic_analysis(self) -> 'List[_6194.HypoidGearCompoundDynamicAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_dynamic_analysis(self) -> 'List[_6195.HypoidGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6067.HypoidGearSetDynamicAnalysis]':
