...
class SpringDamperHalfCompoundDynamicAnalysis(_6171.CouplingHalfCompoundDynamicAnalysis):
    """SpringDamperHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6107.SpringDamperHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6107.SpringDamperHalfDynamicAnalysis]':
