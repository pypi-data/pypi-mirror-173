...
class CoaxialConnectionCompoundDynamicAnalysis(_6229.ShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """CoaxialConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6026.CoaxialConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6026.CoaxialConnectionDynamicAnalysis]':
