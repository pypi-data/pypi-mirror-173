...
class StraightBevelGearCompoundDynamicAnalysis(_6148.BevelGearCompoundDynamicAnalysis):
    """StraightBevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6111.StraightBevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6111.StraightBevelGearDynamicAnalysis]':
