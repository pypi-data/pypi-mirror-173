...
class GearCompoundDynamicAnalysis(_6209.MountableComponentCompoundDynamicAnalysis):
    """GearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6061.GearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6061.GearDynamicAnalysis]':
