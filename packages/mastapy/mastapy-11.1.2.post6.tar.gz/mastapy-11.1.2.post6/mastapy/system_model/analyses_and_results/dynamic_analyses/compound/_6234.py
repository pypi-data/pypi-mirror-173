...
class SpringDamperCompoundDynamicAnalysis(_6169.CouplingCompoundDynamicAnalysis):
    """SpringDamperCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6106.SpringDamperDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6106.SpringDamperDynamicAnalysis]':
