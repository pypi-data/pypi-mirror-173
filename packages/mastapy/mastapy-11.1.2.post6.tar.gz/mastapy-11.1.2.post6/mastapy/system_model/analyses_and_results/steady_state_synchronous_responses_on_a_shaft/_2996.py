...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import (
    _2997, _2999, _3001, _3008,
    _3009, _3031, _3012, _3017,
    _3019, _3032, _3035, _3037,
    _3045, _3043, _3046, _3052,
    _3059, _3062, _3064, _3065,
    _3067, _3071, _3074, _3075,
    _3076, _3078, _3080, _3084,
    _3085, _3089, _3093, _3096,
    _3099, _3106, _3109, _3111,
    _3114, _3117, _2989
)
...
class AssemblySteadyStateSynchronousResponseOnAShaft(_2989.AbstractAssemblySteadyStateSynchronousResponseOnAShaft):
    """AssemblySteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def bearings(self) -> 'List[_2997.BearingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def belt_drives(self) -> 'List[_2999.BeltDriveSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3001.BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3008.BoltedJointSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bolts(self) -> 'List[_3009.BoltSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cv_ts(self) -> 'List[_3031.CVTSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def clutches(self) -> 'List[_3012.ClutchSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3017.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3019.ConceptGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3032.CycloidalAssemblySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3035.CycloidalDiscSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3037.CylindricalGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def fe_parts(self) -> 'List[_3045.FEPartSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3043.FaceGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3046.FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3052.HypoidGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3059.KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3062.KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def mass_discs(self) -> 'List[_3064.MassDiscSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def measurement_components(self) -> 'List[_3065.MeasurementComponentSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def oil_seals(self) -> 'List[_3067.OilSealSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3071.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3074.PlanetCarrierSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def point_loads(self) -> 'List[_3075.PointLoadSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def power_loads(self) -> 'List[_3076.PowerLoadSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def ring_pins(self) -> 'List[_3078.RingPinsSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3080.RollingRingAssemblySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3084.ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def shafts(self) -> 'List[_3085.ShaftSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3089.SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3093.SpringDamperSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3096.StraightBevelDiffGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3099.StraightBevelGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def synchronisers(self) -> 'List[_3106.SynchroniserSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def torque_converters(self) -> 'List[_3109.TorqueConverterSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3111.UnbalancedMassSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3114.WormGearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3117.ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft]':
