...
class ShaftCompoundSteadyStateSynchronousResponseOnAShaft(_3120.AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft):
    """ShaftCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3085.ShaftSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3085.ShaftSteadyStateSynchronousResponseOnAShaft]':
