...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import (
    _3127, _3129, _3132, _3139,
    _3138, _3160, _3140, _3145,
    _3150, _3162, _3164, _3168,
    _3175, _3174, _3176, _3183,
    _3190, _3193, _3194, _3195,
    _3197, _3199, _3204, _3205,
    _3206, _3208, _3210, _3215,
    _3214, _3220, _3221, _3226,
    _3229, _3232, _3236, _3240,
    _3244, _3247, _3119
)
...
class AssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_3119.AbstractAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    """AssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2996.AssemblySteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bearings(self) -> 'List[_3127.BearingCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def belt_drives(self) -> 'List[_3129.BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3132.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3139.BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def bolts(self) -> 'List[_3138.BoltCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cv_ts(self) -> 'List[_3160.CVTCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def clutches(self) -> 'List[_3140.ClutchCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3145.ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3150.ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3162.CycloidalAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3164.CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3168.CylindricalGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def fe_parts(self) -> 'List[_3175.FEPartCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3174.FaceGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3176.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3183.HypoidGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3190.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3193.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def mass_discs(self) -> 'List[_3194.MassDiscCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def measurement_components(self) -> 'List[_3195.MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def oil_seals(self) -> 'List[_3197.OilSealCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3199.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3204.PlanetCarrierCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def point_loads(self) -> 'List[_3205.PointLoadCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def power_loads(self) -> 'List[_3206.PowerLoadCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def ring_pins(self) -> 'List[_3208.RingPinsCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3210.RollingRingAssemblyCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3215.ShaftHubConnectionCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def shafts(self) -> 'List[_3214.ShaftCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3220.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3221.SpringDamperCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3226.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3229.StraightBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def synchronisers(self) -> 'List[_3232.SynchroniserCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def torque_converters(self) -> 'List[_3236.TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3240.UnbalancedMassCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3244.WormGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3247.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2996.AssemblySteadyStateSynchronousResponseOnAShaft]':
