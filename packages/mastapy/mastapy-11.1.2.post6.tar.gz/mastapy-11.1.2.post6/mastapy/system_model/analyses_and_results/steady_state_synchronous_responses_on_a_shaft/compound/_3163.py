...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3033
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _3143
...
class CycloidalDiscCentralBearingConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_3143.CoaxialConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    """CycloidalDiscCentralBearingConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3033.CycloidalDiscCentralBearingConnectionSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3033.CycloidalDiscCentralBearingConnectionSteadyStateSynchronousResponseOnAShaft]':
