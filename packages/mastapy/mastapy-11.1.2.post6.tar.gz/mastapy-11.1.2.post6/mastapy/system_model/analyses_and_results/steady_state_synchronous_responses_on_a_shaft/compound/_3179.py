...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3048
...
class GearSetCompoundSteadyStateSynchronousResponseOnAShaft(_3217.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    """GearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3048.GearSetSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3048.GearSetSteadyStateSynchronousResponseOnAShaft]':
