...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6263, _6266, _6265
from mastapy.utility import _1400
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self) -> '_6263.ExcelFileDetails':
    ...
    @property
    def masta_file_details(self) -> '_6266.MASTAFileDetails':
    ...
    @property
    def working_folder(self) -> '_1400.SelectableFolder':
    ...
    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6265.ExcelSheetDesignStateSelector]':
