...
class BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation(_5880.BevelGearCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5745.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5745.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation]':
