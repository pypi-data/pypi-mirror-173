...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5826
...
class RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation(_5962.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_design(self) -> '_2346.RollingRingAssembly':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5826.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5826.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]':
