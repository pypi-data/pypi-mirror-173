...
class GearMeshCompoundHarmonicAnalysisOfSingleExcitation(_5929.InterMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    """GearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5793.GearMeshHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5793.GearMeshHarmonicAnalysisOfSingleExcitation]':
