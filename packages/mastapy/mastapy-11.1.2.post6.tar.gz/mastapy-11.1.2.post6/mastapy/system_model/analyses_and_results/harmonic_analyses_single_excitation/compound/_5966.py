...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5839
...
class SpringDamperCompoundHarmonicAnalysisOfSingleExcitation(_5901.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    """SpringDamperCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5839.SpringDamperHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5839.SpringDamperHarmonicAnalysisOfSingleExcitation]':
