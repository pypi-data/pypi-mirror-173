...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5741
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import (
    _5872, _5874, _5877, _5884,
    _5883, _5905, _5885, _5890,
    _5895, _5907, _5909, _5913,
    _5920, _5919, _5921, _5928,
    _5935, _5938, _5939, _5940,
    _5942, _5944, _5949, _5950,
    _5951, _5953, _5955, _5960,
    _5959, _5965, _5966, _5971,
    _5974, _5977, _5981, _5985,
    _5989, _5992, _5864
)
...
class AssemblyCompoundHarmonicAnalysisOfSingleExcitation(_5864.AbstractAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """AssemblyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5741.AssemblyHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bearings(self) -> 'List[_5872.BearingCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def belt_drives(self) -> 'List[_5874.BeltDriveCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5877.BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5884.BoltedJointCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def bolts(self) -> 'List[_5883.BoltCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cv_ts(self) -> 'List[_5905.CVTCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def clutches(self) -> 'List[_5885.ClutchCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5890.ConceptCouplingCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5895.ConceptGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5907.CycloidalAssemblyCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5909.CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5913.CylindricalGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def fe_parts(self) -> 'List[_5920.FEPartCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5919.FaceGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5921.FlexiblePinAssemblyCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5928.HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5935.KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5938.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def mass_discs(self) -> 'List[_5939.MassDiscCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def measurement_components(self) -> 'List[_5940.MeasurementComponentCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def oil_seals(self) -> 'List[_5942.OilSealCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5944.PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5949.PlanetCarrierCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def point_loads(self) -> 'List[_5950.PointLoadCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def power_loads(self) -> 'List[_5951.PowerLoadCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def ring_pins(self) -> 'List[_5953.RingPinsCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5955.RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5960.ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def shafts(self) -> 'List[_5959.ShaftCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5965.SpiralBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5966.SpringDamperCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5971.StraightBevelDiffGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5974.StraightBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def synchronisers(self) -> 'List[_5977.SynchroniserCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def torque_converters(self) -> 'List[_5981.TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5985.UnbalancedMassCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5989.WormGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5992.ZerolBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5741.AssemblyHarmonicAnalysisOfSingleExcitation]':
