...
class CycloidalDiscCompoundAdvancedSystemDeflection(_7133.AbstractShaftCompoundAdvancedSystemDeflection):
    """CycloidalDiscCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7044.CycloidalDiscAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7044.CycloidalDiscAdvancedSystemDeflection]':
