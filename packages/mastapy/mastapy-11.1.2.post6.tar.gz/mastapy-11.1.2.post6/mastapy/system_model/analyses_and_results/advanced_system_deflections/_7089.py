...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7123, _7125
...
class PowerLoadAdvancedSystemDeflection(_7125.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2536.PowerLoadSystemDeflection]':
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_7123.TransmissionErrorToOtherPowerLoad]':
