...
class RingPinsAdvancedSystemDeflection(_7079.MountableComponentAdvancedSystemDeflection):
    """RingPinsAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2538.RingPinsSystemDeflection]':
