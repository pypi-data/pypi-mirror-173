...
class ZerolBevelGearAdvancedSystemDeflection(_7015.BevelGearAdvancedSystemDeflection):
    """ZerolBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2585.ZerolBevelGearSystemDeflection]':
