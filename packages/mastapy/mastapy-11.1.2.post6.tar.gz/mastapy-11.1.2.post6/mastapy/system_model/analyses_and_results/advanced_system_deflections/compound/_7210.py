...
class OilSealCompoundAdvancedSystemDeflection(_7168.ConnectorCompoundAdvancedSystemDeflection):
    """OilSealCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7080.OilSealAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7080.OilSealAdvancedSystemDeflection]':
