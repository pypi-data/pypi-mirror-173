...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7170
...
class TorqueConverterConnectionCompoundAdvancedSystemDeflection(_7170.CouplingConnectionCompoundAdvancedSystemDeflection):
    """TorqueConverterConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7120.TorqueConverterConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7120.TorqueConverterConnectionAdvancedSystemDeflection]':
