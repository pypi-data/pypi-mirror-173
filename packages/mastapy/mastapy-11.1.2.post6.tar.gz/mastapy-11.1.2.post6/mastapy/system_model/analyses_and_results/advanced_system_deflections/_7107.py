...
class StraightBevelDiffGearAdvancedSystemDeflection(_7015.BevelGearAdvancedSystemDeflection):
    """StraightBevelDiffGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2559.StraightBevelDiffGearSystemDeflection]':
