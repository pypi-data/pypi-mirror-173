...
class BeltDriveAdvancedSystemDeflection(_7100.SpecialisedAssemblyAdvancedSystemDeflection):
    """BeltDriveAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2444.BeltDriveSystemDeflection]':
