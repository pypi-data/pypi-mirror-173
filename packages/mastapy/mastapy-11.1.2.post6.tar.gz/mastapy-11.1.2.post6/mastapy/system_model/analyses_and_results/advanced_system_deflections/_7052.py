...
class DatumAdvancedSystemDeflection(_7024.ComponentAdvancedSystemDeflection):
    """DatumAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2495.DatumSystemDeflection]':
