...
class UnbalancedMassAdvancedSystemDeflection(_7125.VirtualComponentAdvancedSystemDeflection):
    """UnbalancedMassAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2578.UnbalancedMassSystemDeflection]':
