...
class MountableComponentCompoundAdvancedSystemDeflection(_7157.ComponentCompoundAdvancedSystemDeflection):
    """MountableComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7079.MountableComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7079.MountableComponentAdvancedSystemDeflection]':
