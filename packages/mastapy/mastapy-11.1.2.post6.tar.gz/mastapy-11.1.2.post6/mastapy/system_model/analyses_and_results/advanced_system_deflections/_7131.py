...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7129, _7130, _7017
...
class ZerolBevelGearSetAdvancedSystemDeflection(_7017.BevelGearSetAdvancedSystemDeflection):
    """ZerolBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def rating(self) -> '_343.ZerolBevelGearSetRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_343.ZerolBevelGearSetRating':
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2584.ZerolBevelGearSetSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_advanced_system_deflection(self) -> 'List[_7129.ZerolBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_advanced_system_deflection(self) -> 'List[_7130.ZerolBevelGearMeshAdvancedSystemDeflection]':
