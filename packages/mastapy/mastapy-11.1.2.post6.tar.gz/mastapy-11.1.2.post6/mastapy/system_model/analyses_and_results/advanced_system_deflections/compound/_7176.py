...
class CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection(_7156.CoaxialConnectionCompoundAdvancedSystemDeflection):
    """CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7045.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7045.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection]':
