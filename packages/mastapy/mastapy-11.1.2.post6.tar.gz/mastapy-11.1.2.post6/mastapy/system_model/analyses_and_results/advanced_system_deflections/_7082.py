...
class PartToPartShearCouplingAdvancedSystemDeflection(_7037.CouplingAdvancedSystemDeflection):
    """PartToPartShearCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2532.PartToPartShearCouplingSystemDeflection]':
