...
class AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection(_7166.ConicalGearSetCompoundAdvancedSystemDeflection):
    """AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7005.AGMAGleasonConicalGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7005.AGMAGleasonConicalGearSetAdvancedSystemDeflection]':
