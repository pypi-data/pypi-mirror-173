...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7125
...
class MeasurementComponentAdvancedSystemDeflection(_7125.VirtualComponentAdvancedSystemDeflection):
    """MeasurementComponentAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6648.MeasurementComponentLoadCase':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2524.MeasurementComponentSystemDeflection]':
