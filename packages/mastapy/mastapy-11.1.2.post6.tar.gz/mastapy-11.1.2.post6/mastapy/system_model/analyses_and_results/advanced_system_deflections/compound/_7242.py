...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7240, _7241, _7150
...
class StraightBevelGearSetCompoundAdvancedSystemDeflection(_7150.BevelGearSetCompoundAdvancedSystemDeflection):
    """StraightBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7112.StraightBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7240.StraightBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7241.StraightBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7112.StraightBevelGearSetAdvancedSystemDeflection]':
