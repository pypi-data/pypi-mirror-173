...
class ConceptCouplingAdvancedSystemDeflection(_7037.CouplingAdvancedSystemDeflection):
    """ConceptCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2463.ConceptCouplingSystemDeflection]':
