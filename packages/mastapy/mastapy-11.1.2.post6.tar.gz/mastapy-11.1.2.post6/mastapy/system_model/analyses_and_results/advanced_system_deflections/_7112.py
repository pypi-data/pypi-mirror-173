...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7110, _7111, _7017
...
class StraightBevelGearSetAdvancedSystemDeflection(_7017.BevelGearSetAdvancedSystemDeflection):
    """StraightBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2561.StraightBevelGearSetSystemDeflection]':
    ...
    @property
    def straight_bevel_gears_advanced_system_deflection(self) -> 'List[_7110.StraightBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_meshes_advanced_system_deflection(self) -> 'List[_7111.StraightBevelGearMeshAdvancedSystemDeflection]':
