...
class PowerLoadCompoundAdvancedSystemDeflection(_7254.VirtualComponentCompoundAdvancedSystemDeflection):
    """PowerLoadCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7089.PowerLoadAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7089.PowerLoadAdvancedSystemDeflection]':
