...
class StraightBevelDiffGearCompoundAdvancedSystemDeflection(_7148.BevelGearCompoundAdvancedSystemDeflection):
    """StraightBevelDiffGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7107.StraightBevelDiffGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7107.StraightBevelDiffGearAdvancedSystemDeflection]':
