...
class PlanetaryGearSetCompoundAdvancedSystemDeflection(_7181.CylindricalGearSetCompoundAdvancedSystemDeflection):
    """PlanetaryGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7086.PlanetaryGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7086.PlanetaryGearSetAdvancedSystemDeflection]':
