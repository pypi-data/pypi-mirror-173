...
class FaceGearMeshAdvancedSystemDeflection(_7060.GearMeshAdvancedSystemDeflection):
    """FaceGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2498.FaceGearMeshSystemDeflection]':
