...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7127
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7191
...
class WormGearMeshCompoundAdvancedSystemDeflection(_7191.GearMeshCompoundAdvancedSystemDeflection):
    """WormGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7127.WormGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7127.WormGearMeshAdvancedSystemDeflection]':
