...
class HypoidGearAdvancedSystemDeflection(_7003.AGMAGleasonConicalGearAdvancedSystemDeflection):
    """HypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_411.HypoidGearRating':
    ...
    @property
    def component_load_case(self) -> '_6631.HypoidGearLoadCase':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2509.HypoidGearSystemDeflection]':
