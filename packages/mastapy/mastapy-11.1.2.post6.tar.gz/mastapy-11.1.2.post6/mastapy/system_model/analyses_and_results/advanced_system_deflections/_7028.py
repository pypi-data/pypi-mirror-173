...
class ConceptGearAdvancedSystemDeflection(_7059.GearAdvancedSystemDeflection):
    """ConceptGearAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2466.ConceptGearSystemDeflection]':
