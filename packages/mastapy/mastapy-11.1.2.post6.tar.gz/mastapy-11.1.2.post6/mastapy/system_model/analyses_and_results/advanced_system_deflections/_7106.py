...
class SpringDamperHalfAdvancedSystemDeflection(_7039.CouplingHalfAdvancedSystemDeflection):
    """SpringDamperHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2555.SpringDamperHalfSystemDeflection]':
