...
class CycloidalDiscAdvancedSystemDeflection(_6997.AbstractShaftAdvancedSystemDeflection):
    """CycloidalDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2482.CycloidalDiscSystemDeflection]':
