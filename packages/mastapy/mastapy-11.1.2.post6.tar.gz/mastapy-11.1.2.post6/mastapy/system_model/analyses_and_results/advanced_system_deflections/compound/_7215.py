...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7229
...
class PlanetaryConnectionCompoundAdvancedSystemDeflection(_7229.ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """PlanetaryConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7085.PlanetaryConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7085.PlanetaryConnectionAdvancedSystemDeflection]':
