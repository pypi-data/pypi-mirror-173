...
class PlanetCarrierCompoundAdvancedSystemDeflection(_7209.MountableComponentCompoundAdvancedSystemDeflection):
    """PlanetCarrierCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7087.PlanetCarrierAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7087.PlanetCarrierAdvancedSystemDeflection]':
