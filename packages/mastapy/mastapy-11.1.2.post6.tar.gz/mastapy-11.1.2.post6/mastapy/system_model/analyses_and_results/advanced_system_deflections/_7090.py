...
class PulleyAdvancedSystemDeflection(_7039.CouplingHalfAdvancedSystemDeflection):
    """PulleyAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2537.PulleySystemDeflection]':
