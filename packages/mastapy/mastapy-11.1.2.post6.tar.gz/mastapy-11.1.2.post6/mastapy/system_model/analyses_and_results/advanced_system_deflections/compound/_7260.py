...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7131
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7258, _7259, _7150
...
class ZerolBevelGearSetCompoundAdvancedSystemDeflection(_7150.BevelGearSetCompoundAdvancedSystemDeflection):
    """ZerolBevelGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7131.ZerolBevelGearSetAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_gears_compound_advanced_system_deflection(self) -> 'List[_7258.ZerolBevelGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def zerol_bevel_meshes_compound_advanced_system_deflection(self) -> 'List[_7259.ZerolBevelGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7131.ZerolBevelGearSetAdvancedSystemDeflection]':
