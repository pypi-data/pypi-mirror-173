...
class InterMountableComponentConnectionCompoundAdvancedSystemDeflection(_7167.ConnectionCompoundAdvancedSystemDeflection):
    """InterMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7066.InterMountableComponentConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7066.InterMountableComponentConnectionAdvancedSystemDeflection]':
