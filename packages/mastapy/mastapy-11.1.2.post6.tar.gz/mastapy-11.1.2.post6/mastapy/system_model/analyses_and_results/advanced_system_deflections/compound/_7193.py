...
class GuideDxfModelCompoundAdvancedSystemDeflection(_7157.ComponentCompoundAdvancedSystemDeflection):
    """GuideDxfModelCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7062.GuideDxfModelAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7062.GuideDxfModelAdvancedSystemDeflection]':
