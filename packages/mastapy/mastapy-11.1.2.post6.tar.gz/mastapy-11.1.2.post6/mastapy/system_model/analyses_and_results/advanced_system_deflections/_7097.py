...
class ShaftAdvancedSystemDeflection(_6997.AbstractShaftAdvancedSystemDeflection):
    """ShaftAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2548.ShaftSystemDeflection]':
