...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7237, _7238, _7150
...
class StraightBevelDiffGearSetCompoundAdvancedSystemDeflection(_7150.BevelGearSetCompoundAdvancedSystemDeflection):
    """StraightBevelDiffGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7109.StraightBevelDiffGearSetAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_gears_compound_advanced_system_deflection(self) -> 'List[_7237.StraightBevelDiffGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_advanced_system_deflection(self) -> 'List[_7238.StraightBevelDiffGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7109.StraightBevelDiffGearSetAdvancedSystemDeflection]':
