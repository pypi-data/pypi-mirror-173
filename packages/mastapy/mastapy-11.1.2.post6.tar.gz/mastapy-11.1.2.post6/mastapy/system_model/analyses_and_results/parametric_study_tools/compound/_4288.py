...
class StraightBevelDiffGearCompoundParametricStudyTool(_4199.BevelGearCompoundParametricStudyTool):
    """StraightBevelDiffGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4160.StraightBevelDiffGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4160.StraightBevelDiffGearParametricStudyTool]':
