...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4181, _4180, _4054
...
class ZerolBevelGearSetParametricStudyTool(_4054.BevelGearSetParametricStudyTool):
    """ZerolBevelGearSetParametricStudyTool
    ...
    @property
    def zerol_bevel_gears_parametric_study_tool(self) -> 'List[_4181.ZerolBevelGearParametricStudyTool]':
    ...
    @property
    def zerol_bevel_meshes_parametric_study_tool(self) -> 'List[_4180.ZerolBevelGearMeshParametricStudyTool]':
