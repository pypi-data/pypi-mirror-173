...
class PartToPartShearCouplingCompoundParametricStudyTool(_4220.CouplingCompoundParametricStudyTool):
    """PartToPartShearCouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4136.PartToPartShearCouplingParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4136.PartToPartShearCouplingParametricStudyTool]':
