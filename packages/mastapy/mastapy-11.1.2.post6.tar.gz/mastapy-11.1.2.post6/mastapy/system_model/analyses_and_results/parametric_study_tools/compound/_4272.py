...
class RingPinsCompoundParametricStudyTool(_4260.MountableComponentCompoundParametricStudyTool):
    """RingPinsCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4143.RingPinsParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4143.RingPinsParametricStudyTool]':
