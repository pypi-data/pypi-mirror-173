...
class CylindricalGearMeshCompoundParametricStudyTool(_4242.GearMeshCompoundParametricStudyTool):
    """CylindricalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4083.CylindricalGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4083.CylindricalGearMeshParametricStudyTool]':
