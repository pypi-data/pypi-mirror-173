...
class SpringDamperCompoundParametricStudyTool(_4220.CouplingCompoundParametricStudyTool):
    """SpringDamperCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4158.SpringDamperParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4158.SpringDamperParametricStudyTool]':
