...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4236, _4237, _4243
...
class FaceGearSetCompoundParametricStudyTool(_4243.GearSetCompoundParametricStudyTool):
    """FaceGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4098.FaceGearSetParametricStudyTool]':
    ...
    @property
    def face_gears_compound_parametric_study_tool(self) -> 'List[_4236.FaceGearCompoundParametricStudyTool]':
    ...
    @property
    def face_meshes_compound_parametric_study_tool(self) -> 'List[_4237.FaceGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4098.FaceGearSetParametricStudyTool]':
