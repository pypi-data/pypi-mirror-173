...
class CoaxialConnectionCompoundParametricStudyTool(_4280.ShaftToMountableComponentConnectionCompoundParametricStudyTool):
    """CoaxialConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4060.CoaxialConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4060.CoaxialConnectionParametricStudyTool]':
