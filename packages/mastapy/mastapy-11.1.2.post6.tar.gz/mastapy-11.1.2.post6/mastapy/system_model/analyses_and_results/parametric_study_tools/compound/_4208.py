...
class ComponentCompoundParametricStudyTool(_4262.PartCompoundParametricStudyTool):
    """ComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4061.ComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4061.ComponentParametricStudyTool]':
