...
class CVTBeltConnectionCompoundParametricStudyTool(_4192.BeltConnectionCompoundParametricStudyTool):
    """CVTBeltConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4076.CVTBeltConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4076.CVTBeltConnectionParametricStudyTool]':
