...
class GearMeshCompoundParametricStudyTool(_4248.InterMountableComponentConnectionCompoundParametricStudyTool):
    """GearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4101.GearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4101.GearMeshParametricStudyTool]':
