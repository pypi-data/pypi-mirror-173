...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4221
...
class TorqueConverterConnectionCompoundParametricStudyTool(_4221.CouplingConnectionCompoundParametricStudyTool):
    """TorqueConverterConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4171.TorqueConverterConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4171.TorqueConverterConnectionParametricStudyTool]':
