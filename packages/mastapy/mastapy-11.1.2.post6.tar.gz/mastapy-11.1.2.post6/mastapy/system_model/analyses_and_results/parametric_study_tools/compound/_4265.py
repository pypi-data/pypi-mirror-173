...
class PartToPartShearCouplingHalfCompoundParametricStudyTool(_4222.CouplingHalfCompoundParametricStudyTool):
    """PartToPartShearCouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4135.PartToPartShearCouplingHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4135.PartToPartShearCouplingHalfParametricStudyTool]':
