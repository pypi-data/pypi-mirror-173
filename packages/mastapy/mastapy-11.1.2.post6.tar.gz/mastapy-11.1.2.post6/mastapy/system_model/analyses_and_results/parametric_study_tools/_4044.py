...
class BearingParametricStudyTool(_4072.ConnectorParametricStudyTool):
    """BearingParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> 'List[_1711.LoadedBearingDutyCycle]':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2442.BearingSystemDeflection]':
