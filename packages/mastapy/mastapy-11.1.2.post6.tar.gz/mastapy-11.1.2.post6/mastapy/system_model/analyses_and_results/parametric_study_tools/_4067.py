...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4066, _4065, _4103
...
class ConceptGearSetParametricStudyTool(_4103.GearSetParametricStudyTool):
    """ConceptGearSetParametricStudyTool
    ...
    @property
    def concept_gears_parametric_study_tool(self) -> 'List[_4066.ConceptGearParametricStudyTool]':
    ...
    @property
    def concept_meshes_parametric_study_tool(self) -> 'List[_4065.ConceptGearMeshParametricStudyTool]':
