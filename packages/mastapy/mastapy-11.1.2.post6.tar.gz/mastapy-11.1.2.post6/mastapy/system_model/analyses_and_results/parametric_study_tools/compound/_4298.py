...
class SynchroniserPartCompoundParametricStudyTool(_4222.CouplingHalfCompoundParametricStudyTool):
    """SynchroniserPartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4169.SynchroniserPartParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4169.SynchroniserPartParametricStudyTool]':
