...
from mastapy.system_model.analyses_and_results.parametric_study_tools import (
    _4090, _4044, _4046, _4049,
    _4055, _4056, _4077, _4059,
    _4064, _4067, _4079, _4081,
    _4085, _4099, _4098, _4100,
    _4107, _4114, _4117, _4118,
    _4119, _4122, _4136, _4139,
    _4140, _4141, _4143, _4145,
    _4149, _4150, _4155, _4158,
    _4161, _4164, _4168, _4172,
    _4175, _4179, _4182, _4036
)
...
class AssemblyParametricStudyTool(_4036.AbstractAssemblyParametricStudyTool):
    """AssemblyParametricStudyTool
    ...
    @property
    def all_duty_cycle_results(self) -> 'List[_4090.DutyCycleResultsForAllComponents]':
    ...
    @property
    def bearings(self) -> 'List[_4044.BearingParametricStudyTool]':
    ...
    @property
    def belt_drives(self) -> 'List[_4046.BeltDriveParametricStudyTool]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4049.BevelDifferentialGearSetParametricStudyTool]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4055.BoltedJointParametricStudyTool]':
    ...
    @property
    def bolts(self) -> 'List[_4056.BoltParametricStudyTool]':
    ...
    @property
    def cv_ts(self) -> 'List[_4077.CVTParametricStudyTool]':
    ...
    @property
    def clutches(self) -> 'List[_4059.ClutchParametricStudyTool]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4064.ConceptCouplingParametricStudyTool]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4067.ConceptGearSetParametricStudyTool]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4079.CycloidalAssemblyParametricStudyTool]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4081.CycloidalDiscParametricStudyTool]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4085.CylindricalGearSetParametricStudyTool]':
    ...
    @property
    def fe_parts(self) -> 'List[_4099.FEPartParametricStudyTool]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4098.FaceGearSetParametricStudyTool]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4100.FlexiblePinAssemblyParametricStudyTool]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4107.HypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_4114.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_4117.KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def mass_discs(self) -> 'List[_4118.MassDiscParametricStudyTool]':
    ...
    @property
    def measurement_components(self) -> 'List[_4119.MeasurementComponentParametricStudyTool]':
    ...
    @property
    def oil_seals(self) -> 'List[_4122.OilSealParametricStudyTool]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4136.PartToPartShearCouplingParametricStudyTool]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4139.PlanetCarrierParametricStudyTool]':
    ...
    @property
    def point_loads(self) -> 'List[_4140.PointLoadParametricStudyTool]':
    ...
    @property
    def power_loads(self) -> 'List[_4141.PowerLoadParametricStudyTool]':
    ...
    @property
    def ring_pins(self) -> 'List[_4143.RingPinsParametricStudyTool]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4145.RollingRingAssemblyParametricStudyTool]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4149.ShaftHubConnectionParametricStudyTool]':
    ...
    @property
    def shafts(self) -> 'List[_4150.ShaftParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4155.SpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4158.SpringDamperParametricStudyTool]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4161.StraightBevelDiffGearSetParametricStudyTool]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4164.StraightBevelGearSetParametricStudyTool]':
    ...
    @property
    def synchronisers(self) -> 'List[_4168.SynchroniserParametricStudyTool]':
    ...
    @property
    def torque_converters(self) -> 'List[_4172.TorqueConverterParametricStudyTool]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4175.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4179.WormGearSetParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4182.ZerolBevelGearSetParametricStudyTool]':
