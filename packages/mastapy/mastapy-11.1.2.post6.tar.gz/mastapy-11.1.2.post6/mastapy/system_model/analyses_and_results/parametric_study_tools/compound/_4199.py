...
class BevelGearCompoundParametricStudyTool(_4187.AGMAGleasonConicalGearCompoundParametricStudyTool):
    """BevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4053.BevelGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4053.BevelGearParametricStudyTool]':
