...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4215
...
class KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool(_4215.ConicalGearCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4110.KlingelnbergCycloPalloidConicalGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4110.KlingelnbergCycloPalloidConicalGearParametricStudyTool]':
