...
class SynchroniserSleeveParametricStudyTool(_4169.SynchroniserPartParametricStudyTool):
    """SynchroniserSleeveParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2567.SynchroniserSleeveSystemDeflection]':
