...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4230, _4231, _4243
...
class CylindricalGearSetCompoundParametricStudyTool(_4243.GearSetCompoundParametricStudyTool):
    """CylindricalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4085.CylindricalGearSetParametricStudyTool]':
    ...
    @property
    def cylindrical_gears_compound_parametric_study_tool(self) -> 'List[_4230.CylindricalGearCompoundParametricStudyTool]':
    ...
    @property
    def cylindrical_meshes_compound_parametric_study_tool(self) -> 'List[_4231.CylindricalGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4085.CylindricalGearSetParametricStudyTool]':
