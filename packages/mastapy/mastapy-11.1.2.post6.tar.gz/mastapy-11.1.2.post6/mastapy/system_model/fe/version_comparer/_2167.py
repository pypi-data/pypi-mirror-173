...
from mastapy.math_utility.measured_vectors import _1371, _1369
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def displacement_change(self) -> '_1371.VectorWithLinearAndAngularComponents':
    ...
    @property
    def new_result(self) -> '_1369.NodeResults':
    ...
    @property
    def original_result(self) -> '_1369.NodeResults':
