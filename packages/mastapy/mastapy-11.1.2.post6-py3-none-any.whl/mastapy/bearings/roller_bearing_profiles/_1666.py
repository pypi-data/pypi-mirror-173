...
class RollerBearingUserSpecifiedProfile(_1665.RollerBearingProfile):
    ...
    def data_to_use(self) -> '_1656.ProfileDataToUse':
        ...
        return constructor.new(_1656.ProfileDataToUse)(value) if value is not None else None
    ...
    def profile_to_fit(self) -> '_1658.ProfileToFit':
        ...
        return constructor.new(_1658.ProfileToFit)(value) if value is not None else None
