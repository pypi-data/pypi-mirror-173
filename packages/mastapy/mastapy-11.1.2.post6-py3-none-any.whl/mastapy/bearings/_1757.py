...
from mastapy.bearings import (
    _1767, _1766, _1759, _1760
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.bearings.bearing_results.rolling.skf_module import _1964
...
class BearingSettings(_1489.PerMachineSettings):
    '''BearingSettings
    ...
    @property
    def failure_probability_for_rating_life_percent(self) -> '_1766.RatingLife':
        ...
        return constructor.new(_1766.RatingLife)(value) if value is not None else None

    @failure_probability_for_rating_life_percent.setter
    def failure_probability_for_rating_life_percent(self, value: '_1766.RatingLife'):
    ...
    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1759.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        return constructor.new(_1759.ExponentAndReductionFactorsInISO16281Calculation)(value) if value is not None else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1759.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def skf_authentication(self) -> '_1964.SKFAuthentication':
        ...
        return constructor.new(_1964.SKFAuthentication)(self.wrapped.SKFAuthentication) if self.wrapped.SKFAuthentication is not None else None
