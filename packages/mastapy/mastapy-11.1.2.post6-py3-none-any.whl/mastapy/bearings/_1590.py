...
from mastapy.bearings import (
    _1600, _1599, _1592, _1593
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.bearings.bearing_results.rolling.skf_module import _1794
...
class BearingSettings(_1351.PerMachineSettings):
    '''BearingSettings
    ...
    @property
    def failure_probability_for_rating_life_percent(self) -> '_1599.RatingLife':
        ...
        return constructor.new(_1599.RatingLife)(value) if value else None

    @failure_probability_for_rating_life_percent.setter
    def failure_probability_for_rating_life_percent(self, value: '_1599.RatingLife'):
    ...
    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1592.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        return constructor.new(_1592.ExponentAndReductionFactorsInISO16281Calculation)(value) if value else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1592.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def skf_credentials(self) -> '_1794.SKFCredentials':
        ...
        return constructor.new(_1794.SKFCredentials)(self.wrapped.SKFCredentials) if self.wrapped.SKFCredentials else None
