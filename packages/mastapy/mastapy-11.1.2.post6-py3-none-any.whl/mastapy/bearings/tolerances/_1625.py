...
from mastapy.bearings.tolerances import _1626, _1631, _1622
...
class RoundnessSpecification(_1346.IndependentReportablePropertiesBase['RoundnessSpecification']):
    '''RoundnessSpecification
    ...
    @property
    def specification_type(self) -> '_1626.RoundnessSpecificationType':
        ...
        return constructor.new(_1626.RoundnessSpecificationType)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1626.RoundnessSpecificationType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def type_of_fit(self) -> '_1631.TypeOfFit':
        '''TypeOfFit: 'TypeOfFit' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfFit)
        return constructor.new(_1631.TypeOfFit)(value) if value else None

    @type_of_fit.setter
    def type_of_fit(self, value: '_1631.TypeOfFit'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfFit = value

    @property
    def roundness_distribution(self) -> 'List[_1622.RaceRoundnessAtAngle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RoundnessDistribution, constructor.new(_1622.RaceRoundnessAtAngle))
        return value
