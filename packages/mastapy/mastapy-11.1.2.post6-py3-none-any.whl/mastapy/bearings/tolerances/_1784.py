...
from mastapy.bearings.tolerances import _1779, _1776
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy._internal.implicit import overridable
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings import _1764
...
class InterferenceTolerance(_1776.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1779.BearingToleranceDefinitionOptions':
        ...
        return constructor.new(_1779.BearingToleranceDefinitionOptions)(value) if value is not None else None

    @definition_option.setter
    def definition_option(self, value: '_1779.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1764.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1764.MountingPointSurfaceFinishes)(value) if value is not None else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1764.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
