...
from mastapy.bearings.tolerances import _1611, _1608
...
class InterferenceTolerance(_1608.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1611.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1611.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1597.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1597.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1597.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
