...
from mastapy.bearings.tolerances import _1623, _1615
...
class SupportDetail(_1615.InterferenceDetail):
    '''SupportDetail
    ...
    @property
    def radial_specification_method(self) -> '_1623.RadialSpecificationMethod':
        ...
        return constructor.new(_1623.RadialSpecificationMethod)(value) if value else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1623.RadialSpecificationMethod'):
