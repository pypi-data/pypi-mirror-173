...
from mastapy.bearings.tolerances import _1791, _1783
...
class SupportDetail(_1783.InterferenceDetail):
    '''SupportDetail
    ...
    @property
    def radial_specification_method(self) -> '_1791.RadialSpecificationMethod':
        ...
        return constructor.new(_1791.RadialSpecificationMethod)(value) if value is not None else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1791.RadialSpecificationMethod'):
