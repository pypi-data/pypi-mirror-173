...
from mastapy.bearings import (
    _1580, _1605, _1594, _1603
)
from mastapy.math_utility import _1253
from mastapy._internal.python_net import python_net_import
from mastapy.utility.databases import _1560
...
class RollingBearingDatabase(_1560.SQLDatabase['_1603.RollingBearingKey', '_1855.RollingBearing']):
    '''RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_1855.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_1855.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1580.BearingCatalog', type_: '_1605.RollingBearingType', bore_range: '_1253.Range', outer_diameter_range: '_1253.Range', width_range: '_1253.Range', dynamic_capacity_range: '_1253.Range', number_of_rows: 'int', material_type: '_1594.HybridSteelAll') -> 'List[_1855.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1580.BearingCatalog', type_: '_1605.RollingBearingType') -> 'List[_1855.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_STRING, _BEARING_CATALOG, _ROLLING_BEARING_TYPE](designation if designation else None, catalog, type_), constructor.new(_1855.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1580.BearingCatalog') -> '_1855.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1580.BearingCatalog') -> 'List[_1855.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_BEARING_CATALOG](catalog), constructor.new(_1855.RollingBearing))

    def create_bearing(self, type_: '_1605.RollingBearingType', designation: Optional['str'] = 'None') -> '_1855.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1855.RollingBearing':
        ''' 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1605.RollingBearingType', designation: Optional['str'] = 'None') -> '_1603.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1603.RollingBearingKey':
        ''' 'CreateKey' is the original name of this method.
