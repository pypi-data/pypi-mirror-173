...
from mastapy.bearings.bearing_designs.concept import _2062, _2064
...
class ConceptAxialClearanceBearing(_2064.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_2062.BearingNodePosition':
        ...
        return constructor.new(_2062.BearingNodePosition)(value) if value is not None else None

    @node_position.setter
    def node_position(self, value: '_2062.BearingNodePosition'):
