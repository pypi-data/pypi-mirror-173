...
from mastapy.bearings.bearing_designs.concept import _1885, _1887
...
class ConceptAxialClearanceBearing(_1887.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1885.BearingNodePosition':
        ...
        return constructor.new(_1885.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1885.BearingNodePosition'):
