...
from mastapy.bearings.bearing_designs.concept import _1911, _1913
...
class ConceptAxialClearanceBearing(_1913.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1911.BearingNodePosition':
        ...
        return constructor.new(_1911.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1911.BearingNodePosition'):
