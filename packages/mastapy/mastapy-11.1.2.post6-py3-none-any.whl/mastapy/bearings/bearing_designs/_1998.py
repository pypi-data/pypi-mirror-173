...
class BearingDesign(_0.APIBase):
    ...
    @property
    def total_mass_properties(self) -> '_1418.MassProperties':
        ...
        return constructor.new(_1418.MassProperties)(self.wrapped.TotalMassProperties) if self.wrapped.TotalMassProperties is not None else None

    @property
    def mass_properties_of_inner_ring_from_geometry(self) -> '_1418.MassProperties':
        ...
        return constructor.new(_1418.MassProperties)(self.wrapped.MassPropertiesOfInnerRingFromGeometry) if self.wrapped.MassPropertiesOfInnerRingFromGeometry is not None else None

    @property
    def mass_properties_of_outer_ring_from_geometry(self) -> '_1418.MassProperties':
        ...
        return constructor.new(_1418.MassProperties)(self.wrapped.MassPropertiesOfOuterRingFromGeometry) if self.wrapped.MassPropertiesOfOuterRingFromGeometry is not None else None

    @property
    def mass_properties_of_elements_from_geometry(self) -> '_1418.MassProperties':
        ...
        return constructor.new(_1418.MassProperties)(self.wrapped.MassPropertiesOfElementsFromGeometry) if self.wrapped.MassPropertiesOfElementsFromGeometry is not None else None
