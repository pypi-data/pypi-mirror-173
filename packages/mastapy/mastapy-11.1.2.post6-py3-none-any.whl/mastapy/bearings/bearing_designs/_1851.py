...
from mastapy.bearings import _1610
...
class LinearBearing(_1848.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1610.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1610.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1610.BearingStiffnessMatrixOption'):
