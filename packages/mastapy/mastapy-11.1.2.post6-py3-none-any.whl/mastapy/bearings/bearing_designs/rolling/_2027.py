...
from mastapy.bearings.bearing_designs.rolling import _2029, _2030, _2028
...
class NonBarrelRollerBearing(_2028.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_2029.RollerEndShape':
        ...
        return constructor.new(_2029.RollerEndShape)(value) if value is not None else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_2029.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_2030.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_2030.RollerRibDetail))
        return value
