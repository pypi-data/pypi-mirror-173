...
from mastapy.bearings.bearing_designs.rolling import _1837, _1855
...
class BallBearing(_1855.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1837.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1837.BallBearingShoulderDefinition))
        return value
