...
from mastapy.bearings import _1767
from mastapy.bearings.roller_bearing_profiles import _1802, _1812
...
class RollerBearing(_2031.RollingBearing):
    '''RollerBearing
    ...
    @property
    def roller_profile_set(self) -> '_1802.ProfileSet':
        ...
        return constructor.new(_1802.ProfileSet)(self.wrapped.RollerProfileSet) if self.wrapped.RollerProfileSet is not None else None

    @property
    def outer_race_profile_set(self) -> '_1802.ProfileSet':
        ...
        return constructor.new(_1802.ProfileSet)(self.wrapped.OuterRaceProfileSet) if self.wrapped.OuterRaceProfileSet is not None else None

    @property
    def inner_race_profile_set(self) -> '_1802.ProfileSet':
        ...
        return constructor.new(_1802.ProfileSet)(self.wrapped.InnerRaceProfileSet) if self.wrapped.InnerRaceProfileSet is not None else None

    @property
    def inner_race_and_roller_profiles(self) -> 'List[_1812.RollerRaceProfilePoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InnerRaceAndRollerProfiles, constructor.new(_1812.RollerRaceProfilePoint))
        return value

    @property
    def outer_race_and_roller_profiles(self) -> 'List[_1812.RollerRaceProfilePoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OuterRaceAndRollerProfiles, constructor.new(_1812.RollerRaceProfilePoint))
        return value

    @property
    def inner_race_and_roller_profiles_for_first_row(self) -> 'List[_1812.RollerRaceProfilePoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InnerRaceAndRollerProfilesForFirstRow, constructor.new(_1812.RollerRaceProfilePoint))
        return value

    @property
    def outer_race_and_roller_profiles_for_first_row(self) -> 'List[_1812.RollerRaceProfilePoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OuterRaceAndRollerProfilesForFirstRow, constructor.new(_1812.RollerRaceProfilePoint))
        return value

    @property
    def inner_race_and_roller_profiles_for_second_row(self) -> 'List[_1812.RollerRaceProfilePoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InnerRaceAndRollerProfilesForSecondRow, constructor.new(_1812.RollerRaceProfilePoint))
        return value

    @property
    def outer_race_and_roller_profiles_for_second_row(self) -> 'List[_1812.RollerRaceProfilePoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OuterRaceAndRollerProfilesForSecondRow, constructor.new(_1812.RollerRaceProfilePoint))
        return value
