...
from mastapy.bearings.bearing_designs.rolling import _1853, _1854, _1852
...
class NonBarrelRollerBearing(_1852.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1853.RollerEndShape':
        ...
        return constructor.new(_1853.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1853.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1854.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1854.RollerRibDetail))
        return value
