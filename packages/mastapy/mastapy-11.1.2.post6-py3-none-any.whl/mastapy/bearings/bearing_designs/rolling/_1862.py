...
class ThrustBallBearing(_1836.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1598.OuterRingMounting':
        ...
        return constructor.new(_1598.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1598.OuterRingMounting'):
