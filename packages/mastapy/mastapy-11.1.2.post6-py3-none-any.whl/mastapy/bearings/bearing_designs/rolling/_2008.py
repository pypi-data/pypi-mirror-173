...
from mastapy.bearings.bearing_designs.rolling import _2009, _2031
...
class BallBearing(_2031.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_2009.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_2009.BallBearingShoulderDefinition))
        return value
