...
class TaperRollerBearing(_1881.NonBarrelRollerBearing):
    ...
    def bearing_measurement_type(self) -> '_1609.BearingMeasurementType':
        ...
        return constructor.new(_1609.BearingMeasurementType)(value) if value is not None else None
    ...
    def major_rib_detail(self) -> '_1884.RollerRibDetail':
        ...
        return constructor.new(_1884.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail is not None else None
