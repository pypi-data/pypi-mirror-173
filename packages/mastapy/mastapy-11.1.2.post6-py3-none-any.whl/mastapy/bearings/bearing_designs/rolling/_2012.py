...
from mastapy.bearings.bearing_designs.rolling import _2013
...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_2013.BearingProtectionLevel':
        ...
        return constructor.new(_2013.BearingProtectionLevel)(value) if value is not None else None

    @property
    def new_protection_level(self) -> '_2013.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_2013.BearingProtectionLevel'):
