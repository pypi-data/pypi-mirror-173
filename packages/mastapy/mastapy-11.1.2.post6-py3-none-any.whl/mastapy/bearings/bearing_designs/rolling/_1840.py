...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_1841.BearingProtectionLevel':
        ...
        return constructor.new(_1841.BearingProtectionLevel)(value) if value else None

    @property
    def new_protection_level(self) -> '_1841.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_1841.BearingProtectionLevel'):
