...
from mastapy.bearings.bearing_designs.rolling import _1854, _1851
...
class TaperRollerBearing(_1851.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1587.BearingMeasurementType':
        ...
        return constructor.new(_1587.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1587.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1854.RollerRibDetail':
        ...
        return constructor.new(_1854.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
