...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1892, _1891
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1892.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1892.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1891.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1891.AbstractXmlVariableAssignment))
        return value
