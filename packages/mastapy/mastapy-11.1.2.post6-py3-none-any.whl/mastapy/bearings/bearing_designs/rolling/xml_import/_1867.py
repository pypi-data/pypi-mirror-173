...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1868
...
class RollingBearingImporter(_0.APIBase):
    ...
    @property
    def mappings(self) -> 'List[_1868.XmlBearingTypeMapping]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mappings, constructor.new(_1868.XmlBearingTypeMapping))
        return value
