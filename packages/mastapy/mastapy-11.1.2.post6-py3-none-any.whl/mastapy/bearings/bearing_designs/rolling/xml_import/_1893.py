...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1894
...
class RollingBearingImporter(_0.APIBase):
    ...
    @property
    def mappings(self) -> 'List[_1894.XmlBearingTypeMapping]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mappings, constructor.new(_1894.XmlBearingTypeMapping))
        return value
