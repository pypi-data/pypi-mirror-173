...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1866, _1865
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1866.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1866.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1865.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1865.AbstractXmlVariableAssignment))
        return value
