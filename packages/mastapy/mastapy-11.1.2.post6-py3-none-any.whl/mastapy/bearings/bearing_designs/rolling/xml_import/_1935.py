...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1933, _1932
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1933.BearingImportFile]':
    ...
    @property
    def variables(self) -> 'List[_1932.AbstractXmlVariableAssignment]':
