...
from mastapy.bearings.bearing_designs.rolling.xml_import import _2043, _2042
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_2043.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_2043.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_2042.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_2042.AbstractXmlVariableAssignment))
        return value
