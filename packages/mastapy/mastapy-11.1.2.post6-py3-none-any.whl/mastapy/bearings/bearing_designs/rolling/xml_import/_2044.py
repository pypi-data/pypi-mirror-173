...
from mastapy.bearings.bearing_designs.rolling.xml_import import _2045
...
class RollingBearingImporter(_0.APIBase):
    ...
    @property
    def mappings(self) -> 'List[_2045.XmlBearingTypeMapping]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mappings, constructor.new(_2045.XmlBearingTypeMapping))
        return value
