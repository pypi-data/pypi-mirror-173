...
from mastapy.bearings import (
    _1601, _1604, _1580, _1581,
    _1582, _1583
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_designs.rolling import (
    _1864, _1848, _1846, _1842,
    _1857, _1839
)
from mastapy._internal.python_net import python_net_import
from mastapy.utility import _1343
from mastapy.materials import _214
...
class RollingBearing(_1827.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1580.BearingCatalog':
        ...
        return constructor.new(_1580.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1842.BearingTypeExtraInformation':
        ...
        return constructor.new(_1842.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1583.BearingCageMaterial':
        ...
        return constructor.new(_1583.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1583.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1857.SleeveType':
        ...
        return constructor.new(_1857.SleeveType)(value) if value else None
    ...
    @property
    def history(self) -> '_1343.FileHistory':
        ...
        return constructor.new(_1343.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def protection(self) -> '_1839.BearingProtection':
        ...
        return constructor.new(_1839.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None

    @property
    def element_material(self) -> '_214.BearingMaterial':
        ...
        return constructor.new(_214.BearingMaterial)(self.wrapped.ElementMaterial) if self.wrapped.ElementMaterial else None

    @property
    def inner_ring_material(self) -> '_214.BearingMaterial':
        ...
        return constructor.new(_214.BearingMaterial)(self.wrapped.InnerRingMaterial) if self.wrapped.InnerRingMaterial else None

    @property
    def outer_ring_material(self) -> '_214.BearingMaterial':
        ...
        return constructor.new(_214.BearingMaterial)(self.wrapped.OuterRingMaterial) if self.wrapped.OuterRingMaterial else None
