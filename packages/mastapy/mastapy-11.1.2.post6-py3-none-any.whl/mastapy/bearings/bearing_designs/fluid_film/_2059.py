...
from mastapy.bearings import _1763
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy._internal.implicit import overridable
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_designs.fluid_film import (
    _2048, _2049, _2050, _2057
)
...
class PlainOilFedJournalBearing(_2057.PlainJournalBearing):
    '''PlainOilFedJournalBearing
    ...
    @property
    def feed_type(self) -> '_1763.JournalOilFeedType':
        '''JournalOilFeedType: 'FeedType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FeedType)
        return constructor.new(_1763.JournalOilFeedType)(value) if value is not None else None

    @feed_type.setter
    def feed_type(self, value: '_1763.JournalOilFeedType'):
    ...
    @property
    def axial_groove_oil_feed(self) -> '_2048.AxialGrooveJournalBearing':
        ...
        return constructor.new(_2048.AxialGrooveJournalBearing)(self.wrapped.AxialGrooveOilFeed) if self.wrapped.AxialGrooveOilFeed is not None else None

    @property
    def axial_hole_oil_feed(self) -> '_2049.AxialHoleJournalBearing':
        ...
        return constructor.new(_2049.AxialHoleJournalBearing)(self.wrapped.AxialHoleOilFeed) if self.wrapped.AxialHoleOilFeed is not None else None

    @property
    def circumferential_groove_oil_feed(self) -> '_2050.CircumferentialFeedJournalBearing':
        ...
        return constructor.new(_2050.CircumferentialFeedJournalBearing)(self.wrapped.CircumferentialGrooveOilFeed) if self.wrapped.CircumferentialGrooveOilFeed is not None else None
