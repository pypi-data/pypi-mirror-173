...
class PlainGreaseFilledJournalBearing(_2057.PlainJournalBearing):
    '''PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_2056.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new(_2056.PlainGreaseFilledJournalBearingHousingType)(value) if value is not None else None

    @housing_type.setter
    def housing_type(self, value: '_2056.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_2058.PlainJournalHousing':
        ...
        if _2058.PlainJournalHousing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_2051.CylindricalHousingJournalBearing':
        ...
        if _2051.CylindricalHousingJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_2052.MachineryEncasedJournalBearing':
        ...
        if _2052.MachineryEncasedJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_2054.PedestalJournalBearing':
        ...
        if _2054.PedestalJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
