...
class PlainJournalHousing(_0.APIBase):
    ...
    @property
    def heat_emitting_area_method(self) -> '_1648.DefaultOrUserInput':
        ...
        return constructor.new(_1648.DefaultOrUserInput)(value) if value else None

    @heat_emitting_area_method.setter
    def heat_emitting_area_method(self, value: '_1648.DefaultOrUserInput'):
