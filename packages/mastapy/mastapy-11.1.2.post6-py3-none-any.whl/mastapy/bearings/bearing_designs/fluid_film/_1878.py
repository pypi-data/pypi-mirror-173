...
class PlainGreaseFilledJournalBearing(_1880.PlainJournalBearing):
    '''PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_1879.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new(_1879.PlainGreaseFilledJournalBearingHousingType)(value) if value else None

    @housing_type.setter
    def housing_type(self, value: '_1879.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_1881.PlainJournalHousing':
        ...
        if _1881.PlainJournalHousing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_1874.CylindricalHousingJournalBearing':
        ...
        if _1874.CylindricalHousingJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_1875.MachineryEncasedJournalBearing':
        ...
        if _1875.MachineryEncasedJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_1877.PedestalJournalBearing':
        ...
        if _1877.PedestalJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
