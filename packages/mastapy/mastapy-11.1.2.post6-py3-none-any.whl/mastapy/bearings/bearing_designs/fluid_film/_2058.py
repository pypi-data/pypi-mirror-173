...
from mastapy.bearings.bearing_results import _1817
...
class PlainJournalHousing(_0.APIBase):
    ...
    @property
    def heat_emitting_area_method(self) -> '_1817.DefaultOrUserInput':
        ...
        return constructor.new(_1817.DefaultOrUserInput)(value) if value is not None else None

    @heat_emitting_area_method.setter
    def heat_emitting_area_method(self, value: '_1817.DefaultOrUserInput'):
