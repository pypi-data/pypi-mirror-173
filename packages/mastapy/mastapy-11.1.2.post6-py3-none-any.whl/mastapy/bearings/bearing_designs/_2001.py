...
from mastapy.bearings import _1758
...
class LinearBearing(_1998.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1758.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1758.BearingStiffnessMatrixOption)(value) if value is not None else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1758.BearingStiffnessMatrixOption'):
