...
class LoadedNonLinearBearingResults(_1822.LoadedBearingResults):
    '''LoadedNonLinearBearingResults
    ...
    @property
    def power_loss(self) -> '_273.PowerLoss':
        ...
        if _273.PowerLoss.TYPE not in self.wrapped.PowerLoss.__class__.__mro__:
    ...
    @property
    def power_loss_of_type_independent_power_loss(self) -> '_266.IndependentPowerLoss':
        ...
        if _266.IndependentPowerLoss.TYPE not in self.wrapped.PowerLoss.__class__.__mro__:
    ...
    @property
    def power_loss_of_type_load_and_speed_combined_power_loss(self) -> '_268.LoadAndSpeedCombinedPowerLoss':
        ...
        if _268.LoadAndSpeedCombinedPowerLoss.TYPE not in self.wrapped.PowerLoss.__class__.__mro__:
    ...
    @property
    def resistive_torque(self) -> '_274.ResistiveTorque':
        ...
        if _274.ResistiveTorque.TYPE not in self.wrapped.ResistiveTorque.__class__.__mro__:
    ...
    @property
    def resistive_torque_of_type_combined_resistive_torque(self) -> '_264.CombinedResistiveTorque':
        ...
        if _264.CombinedResistiveTorque.TYPE not in self.wrapped.ResistiveTorque.__class__.__mro__:
    ...
    @property
    def resistive_torque_of_type_independent_resistive_torque(self) -> '_267.IndependentResistiveTorque':
        ...
        if _267.IndependentResistiveTorque.TYPE not in self.wrapped.ResistiveTorque.__class__.__mro__:
