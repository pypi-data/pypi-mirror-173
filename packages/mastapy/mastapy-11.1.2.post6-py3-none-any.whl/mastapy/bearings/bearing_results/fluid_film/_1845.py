...
from mastapy.bearings.bearing_results.fluid_film import _1846, _1842
...
class LoadedPlainJournalBearingResults(_1842.LoadedFluidFilmBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1846.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1846.LoadedPlainJournalBearingRow))
        return value
