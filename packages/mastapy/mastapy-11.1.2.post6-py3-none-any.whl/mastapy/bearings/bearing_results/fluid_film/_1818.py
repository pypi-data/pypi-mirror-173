...
from mastapy.bearings.bearing_results.fluid_film import _1819, _1815
...
class LoadedPlainJournalBearingResults(_1815.LoadedFluidFilmBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1819.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1819.LoadedPlainJournalBearingRow))
        return value
