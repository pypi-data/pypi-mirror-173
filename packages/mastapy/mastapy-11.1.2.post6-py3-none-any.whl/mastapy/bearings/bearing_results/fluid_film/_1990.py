...
from mastapy.bearings.bearing_results.fluid_film import _1991, _1987
...
class LoadedPlainJournalBearingResults(_1987.LoadedFluidFilmBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1991.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1991.LoadedPlainJournalBearingRow))
        return value
