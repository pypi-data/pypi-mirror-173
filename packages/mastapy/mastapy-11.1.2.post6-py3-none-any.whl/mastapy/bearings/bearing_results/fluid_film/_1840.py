...
from mastapy.bearings.bearing_results.fluid_film import _1841, _1837
...
class LoadedPlainJournalBearingResults(_1837.LoadedFluidFilmBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1841.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1841.LoadedPlainJournalBearingRow))
        return value
