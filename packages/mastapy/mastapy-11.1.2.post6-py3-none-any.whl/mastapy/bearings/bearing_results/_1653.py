...
class LoadedBearingResults(_1586.BearingLoadCaseResultsLightweight):
    '''LoadedBearingResults
    ...
    @property
    def bearing(self) -> '_1826.BearingDesign':
        ...
        if _1826.BearingDesign.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_detailed_bearing(self) -> '_1827.DetailedBearing':
        ...
        if _1827.DetailedBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_dummy_rolling_bearing(self) -> '_1828.DummyRollingBearing':
        ...
        if _1828.DummyRollingBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_linear_bearing(self) -> '_1829.LinearBearing':
        ...
        if _1829.LinearBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
            raise CastException('Failed to cast bearing to LinearBearing. Expected: {}.'.format(self.wrapped.Bearing.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Bearing.__class__)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_non_linear_bearing(self) -> '_1830.NonLinearBearing':
        ...
        if _1830.NonLinearBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_angular_contact_ball_bearing(self) -> '_1831.AngularContactBallBearing':
        ...
        if _1831.AngularContactBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_angular_contact_thrust_ball_bearing(self) -> '_1832.AngularContactThrustBallBearing':
        ...
        if _1832.AngularContactThrustBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_asymmetric_spherical_roller_bearing(self) -> '_1833.AsymmetricSphericalRollerBearing':
        ...
        if _1833.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1834.AxialThrustCylindricalRollerBearing':
        ...
        if _1834.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_axial_thrust_needle_roller_bearing(self) -> '_1835.AxialThrustNeedleRollerBearing':
        ...
        if _1835.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_ball_bearing(self) -> '_1836.BallBearing':
        ...
        if _1836.BallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
            raise CastException('Failed to cast bearing to BallBearing. Expected: {}.'.format(self.wrapped.Bearing.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Bearing.__class__)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_barrel_roller_bearing(self) -> '_1838.BarrelRollerBearing':
        ...
        if _1838.BarrelRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_crossed_roller_bearing(self) -> '_1843.CrossedRollerBearing':
        ...
        if _1843.CrossedRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_cylindrical_roller_bearing(self) -> '_1844.CylindricalRollerBearing':
        ...
        if _1844.CylindricalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_deep_groove_ball_bearing(self) -> '_1845.DeepGrooveBallBearing':
        ...
        if _1845.DeepGrooveBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_four_point_contact_ball_bearing(self) -> '_1847.FourPointContactBallBearing':
        ...
        if _1847.FourPointContactBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_multi_point_contact_ball_bearing(self) -> '_1849.MultiPointContactBallBearing':
        ...
        if _1849.MultiPointContactBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_needle_roller_bearing(self) -> '_1850.NeedleRollerBearing':
        ...
        if _1850.NeedleRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_non_barrel_roller_bearing(self) -> '_1851.NonBarrelRollerBearing':
        ...
        if _1851.NonBarrelRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_roller_bearing(self) -> '_1852.RollerBearing':
        ...
        if _1852.RollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
            raise CastException('Failed to cast bearing to RollerBearing. Expected: {}.'.format(self.wrapped.Bearing.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Bearing.__class__)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_rolling_bearing(self) -> '_1855.RollingBearing':
        ...
        if _1855.RollingBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
            raise CastException('Failed to cast bearing to RollingBearing. Expected: {}.'.format(self.wrapped.Bearing.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Bearing.__class__)(self.wrapped.Bearing) if self.wrapped.Bearing else None

    @property
    def bearing_of_type_self_aligning_ball_bearing(self) -> '_1856.SelfAligningBallBearing':
        ...
        if _1856.SelfAligningBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_spherical_roller_bearing(self) -> '_1858.SphericalRollerBearing':
        ...
        if _1858.SphericalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_spherical_roller_thrust_bearing(self) -> '_1859.SphericalRollerThrustBearing':
        ...
        if _1859.SphericalRollerThrustBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_taper_roller_bearing(self) -> '_1860.TaperRollerBearing':
        ...
        if _1860.TaperRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_three_point_contact_ball_bearing(self) -> '_1861.ThreePointContactBallBearing':
        ...
        if _1861.ThreePointContactBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_thrust_ball_bearing(self) -> '_1862.ThrustBallBearing':
        ...
        if _1862.ThrustBallBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_toroidal_roller_bearing(self) -> '_1863.ToroidalRollerBearing':
        ...
        if _1863.ToroidalRollerBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_pad_fluid_film_bearing(self) -> '_1876.PadFluidFilmBearing':
        ...
        if _1876.PadFluidFilmBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_plain_grease_filled_journal_bearing(self) -> '_1878.PlainGreaseFilledJournalBearing':
        ...
        if _1878.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_plain_journal_bearing(self) -> '_1880.PlainJournalBearing':
        ...
        if _1880.PlainJournalBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_plain_oil_fed_journal_bearing(self) -> '_1882.PlainOilFedJournalBearing':
        ...
        if _1882.PlainOilFedJournalBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_tilting_pad_journal_bearing(self) -> '_1883.TiltingPadJournalBearing':
        ...
        if _1883.TiltingPadJournalBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_tilting_pad_thrust_bearing(self) -> '_1884.TiltingPadThrustBearing':
        ...
        if _1884.TiltingPadThrustBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_concept_axial_clearance_bearing(self) -> '_1886.ConceptAxialClearanceBearing':
        ...
        if _1886.ConceptAxialClearanceBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_concept_clearance_bearing(self) -> '_1887.ConceptClearanceBearing':
        ...
        if _1887.ConceptClearanceBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def bearing_of_type_concept_radial_clearance_bearing(self) -> '_1888.ConceptRadialClearanceBearing':
        ...
        if _1888.ConceptRadialClearanceBearing.TYPE not in self.wrapped.Bearing.__class__.__mro__:
    ...
    @property
    def ring_results(self) -> 'List[_1766.RingForceAndDisplacement]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingResults, constructor.new(_1766.RingForceAndDisplacement))
        return value
