...
from mastapy.bearings.bearing_results.rolling import _1765, _1712
...
class LoadedRollerBearingElement(_1712.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1765.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1765.ResultsAtRollerOffset))
        return value
