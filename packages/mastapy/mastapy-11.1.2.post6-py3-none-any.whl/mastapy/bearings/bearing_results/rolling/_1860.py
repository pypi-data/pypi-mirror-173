...
from mastapy.bearings.bearing_results.rolling import _1891
...
class LoadedAxialThrustCylindricalRollerBearingDutyCycle(_1891.LoadedNonBarrelRollerBearingDutyCycle):
    '''LoadedAxialThrustCylindricalRollerBearingDutyCycle
