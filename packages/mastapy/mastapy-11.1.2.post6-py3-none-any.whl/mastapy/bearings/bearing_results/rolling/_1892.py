...
from mastapy.bearings.bearing_results.rolling import _1941, _1897
...
class LoadedNonBarrelRollerBearingResults(_1897.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1941.SMTRibStressResults':
        ...
        return constructor.new(_1941.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress is not None else None
