...
from mastapy.bearings.bearing_results.rolling import _1849
...
class LoadedAsymmetricSphericalRollerBearingStripLoadResults(_1849.LoadedAbstractSphericalRollerBearingStripLoadResults):
    '''LoadedAsymmetricSphericalRollerBearingStripLoadResults
