...
from mastapy.bearings.bearing_results.rolling import _1908, _1898
...
class LoadedSphericalRollerRadialBearingRow(_1898.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1908.LoadedSphericalRollerRadialBearingResults':
        ...
        return constructor.new(_1908.LoadedSphericalRollerRadialBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
