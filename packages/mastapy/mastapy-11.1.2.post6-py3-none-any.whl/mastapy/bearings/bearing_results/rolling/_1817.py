...
from mastapy.bearings.bearing_results.rolling import _1816, _1788
...
class LoadedToroidalRollerBearingRow(_1788.LoadedRollerBearingRow):
    """LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1816.LoadedToroidalRollerBearingResults':
