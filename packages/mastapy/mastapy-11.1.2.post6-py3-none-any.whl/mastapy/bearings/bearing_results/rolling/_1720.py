...
from mastapy.bearings.bearing_results.rolling import _1719, _1708
...
class LoadedNeedleRollerBearingRow(_1708.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1719.LoadedNeedleRollerBearingResults':
        ...
        return constructor.new(_1719.LoadedNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
