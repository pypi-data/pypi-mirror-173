...
from mastapy.bearings.bearing_results.rolling import _1926, _1898
...
class LoadedToroidalRollerBearingRow(_1898.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1926.LoadedToroidalRollerBearingResults':
        ...
        return constructor.new(_1926.LoadedToroidalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
