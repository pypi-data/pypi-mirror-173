...
from mastapy.bearings.bearing_results.rolling import _1861
...
class LoadedAxialThrustNeedleRollerBearingElement(_1861.LoadedAxialThrustCylindricalRollerBearingElement):
    '''LoadedAxialThrustNeedleRollerBearingElement
