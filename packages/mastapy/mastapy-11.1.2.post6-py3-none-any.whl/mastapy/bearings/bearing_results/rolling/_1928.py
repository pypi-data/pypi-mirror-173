...
from mastapy.bearings.bearing_results.rolling import _1910
...
class LoadedToroidalRollerBearingStripLoadResults(_1910.LoadedSphericalRollerRadialBearingStripLoadResults):
    '''LoadedToroidalRollerBearingStripLoadResults
