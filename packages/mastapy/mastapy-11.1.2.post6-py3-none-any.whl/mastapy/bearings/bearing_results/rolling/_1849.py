...
from mastapy.bearings.bearing_results.rolling import _1899
...
class LoadedAbstractSphericalRollerBearingStripLoadResults(_1899.LoadedRollerStripLoadResults):
    '''LoadedAbstractSphericalRollerBearingStripLoadResults
