...
from mastapy.bearings.bearing_results.rolling import _1862, _1865, _1893
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1893.LoadedNonBarrelRollerBearingRow):
    '''LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1862.LoadedAxialThrustCylindricalRollerBearingResults':
