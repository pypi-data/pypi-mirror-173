...
from mastapy.bearings.bearing_results.rolling import _1695, _1693
...
class LoadedAxialThrustNeedleRollerBearingRow(_1693.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1695.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1695.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
