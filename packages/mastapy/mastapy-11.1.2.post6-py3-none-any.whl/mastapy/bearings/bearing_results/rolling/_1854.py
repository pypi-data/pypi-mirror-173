...
from mastapy.bearings.bearing_results.rolling import _1851
...
class LoadedAngularContactThrustBallBearingResults(_1851.LoadedAngularContactBallBearingResults):
    '''LoadedAngularContactThrustBallBearingResults
