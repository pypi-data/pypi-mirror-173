...
from mastapy.bearings.bearing_results.rolling import _1801, _1788
...
class LoadedSphericalRollerThrustBearingRow(_1788.LoadedRollerBearingRow):
    """LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1801.LoadedSphericalRollerThrustBearingResults':
