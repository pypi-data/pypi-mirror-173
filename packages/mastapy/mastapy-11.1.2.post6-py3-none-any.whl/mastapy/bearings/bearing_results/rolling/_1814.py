...
from mastapy.bearings.bearing_results.rolling import _1813, _1761
...
class LoadedThrustBallBearingRow(_1761.LoadedBallBearingRow):
    """LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1813.LoadedThrustBallBearingResults':
