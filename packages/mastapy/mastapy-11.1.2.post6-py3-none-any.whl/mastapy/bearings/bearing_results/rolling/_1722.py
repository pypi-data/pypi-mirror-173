...
from mastapy.bearings.bearing_results.rolling import _1770, _1727
...
class LoadedNonBarrelRollerBearingResults(_1727.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1770.SMTRibStressResults':
        ...
        return constructor.new(_1770.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress else None
