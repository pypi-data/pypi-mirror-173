...
from mastapy.bearings.bearing_results.rolling import _1887
...
class LoadedThreePointContactBallBearingElement(_1887.LoadedMultiPointContactBallBearingElement):
    '''LoadedThreePointContactBallBearingElement
