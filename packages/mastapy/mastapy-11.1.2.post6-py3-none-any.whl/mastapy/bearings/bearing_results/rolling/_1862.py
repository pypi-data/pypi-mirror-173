...
from mastapy.bearings.bearing_results.rolling import _1892
...
class LoadedAxialThrustCylindricalRollerBearingResults(_1892.LoadedNonBarrelRollerBearingResults):
    '''LoadedAxialThrustCylindricalRollerBearingResults
