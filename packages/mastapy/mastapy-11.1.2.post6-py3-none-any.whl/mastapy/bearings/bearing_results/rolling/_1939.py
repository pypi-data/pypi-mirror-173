...
from mastapy.bearings.bearing_results import _1818
...
class RollingBearingFrictionCoefficients(_1484.IndependentReportablePropertiesBase['RollingBearingFrictionCoefficients']):
    '''RollingBearingFrictionCoefficients
    ...
    @property
    def iso14179_static_equivalent_load_factors(self) -> '_1818.EquivalentLoadFactors':
        ...
        return constructor.new(_1818.EquivalentLoadFactors)(self.wrapped.ISO14179StaticEquivalentLoadFactors) if self.wrapped.ISO14179StaticEquivalentLoadFactors is not None else None

    @property
    def iso14179_dynamic_equivalent_load_factors(self) -> '_1818.EquivalentLoadFactors':
        ...
        return constructor.new(_1818.EquivalentLoadFactors)(self.wrapped.ISO14179DynamicEquivalentLoadFactors) if self.wrapped.ISO14179DynamicEquivalentLoadFactors is not None else None
