...
from mastapy.bearings.bearing_results.rolling import _1703, _1728
...
class LoadedCrossedRollerBearingRow(_1728.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1703.LoadedCrossedRollerBearingResults':
        ...
        return constructor.new(_1703.LoadedCrossedRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
