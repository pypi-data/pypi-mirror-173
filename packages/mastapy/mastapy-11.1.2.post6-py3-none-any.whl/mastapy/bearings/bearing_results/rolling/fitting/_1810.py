...
class RingFittingThermalResults(_0.APIBase):
    ...
    @property
    def interference_values(self) -> 'List[_1808.InterferenceComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InterferenceValues, constructor.new(_1808.InterferenceComponents))
        return value
