...
from mastapy.bearings.bearing_results.rolling.fitting import _1835
...
class RingFittingThermalResults(_0.APIBase):
    ...
    @property
    def interference_values(self) -> 'List[_1835.InterferenceComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InterferenceValues, constructor.new(_1835.InterferenceComponents))
        return value
