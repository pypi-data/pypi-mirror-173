...
class ForceAtLaminaGroupReportable(_0.APIBase):
    ...
    @property
    def forces_at_laminae(self) -> 'List[_1674.ForceAtLaminaReportable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForcesAtLaminae, constructor.new(_1674.ForceAtLaminaReportable))
        return value
