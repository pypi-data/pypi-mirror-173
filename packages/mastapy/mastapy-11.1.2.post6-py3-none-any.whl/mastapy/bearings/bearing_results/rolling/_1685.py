...
from mastapy.bearings.bearing_results.rolling import _1684, _1682
...
class LoadedAngularContactThrustBallBearingRow(_1682.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1684.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1684.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
