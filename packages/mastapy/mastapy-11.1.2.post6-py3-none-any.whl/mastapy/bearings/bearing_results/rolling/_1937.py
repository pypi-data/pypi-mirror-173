...
class RingForceAndDisplacement(_0.APIBase):
    ...
    @property
    def displacement(self) -> '_1465.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1465.VectorWithLinearAndAngularComponents)(self.wrapped.Displacement) if self.wrapped.Displacement is not None else None

    @property
    def force(self) -> '_1465.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1465.VectorWithLinearAndAngularComponents)(self.wrapped.Force) if self.wrapped.Force is not None else None
