...
from mastapy.bearings.bearing_results.rolling.skf_module import _1774, _1792
...
class AdjustedSpeed(_1792.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1774.AdjustmentFactors':
        ...
        return constructor.new(_1774.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
