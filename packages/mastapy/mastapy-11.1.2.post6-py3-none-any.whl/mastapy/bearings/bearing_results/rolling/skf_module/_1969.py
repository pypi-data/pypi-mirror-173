...
from mastapy.bearings.bearing_results.rolling.skf_module import _1961, _1965
...
class Viscosities(_1965.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1961.OperatingViscosity':
        ...
        return constructor.new(_1961.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity is not None else None
