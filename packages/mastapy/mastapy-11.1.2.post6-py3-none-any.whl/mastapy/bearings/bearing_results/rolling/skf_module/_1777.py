...
from mastapy.bearings.bearing_results.rolling.skf_module import _1788, _1793
...
class BearingRatingLife(_1793.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1788.LifeModel':
        ...
        return constructor.new(_1788.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
