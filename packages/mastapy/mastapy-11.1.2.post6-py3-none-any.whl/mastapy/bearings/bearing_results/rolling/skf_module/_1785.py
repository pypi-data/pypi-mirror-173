...
class GreaseLifeAndRelubricationInterval(_1793.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1784.Grease':
        ...
        return constructor.new(_1784.Grease)(self.wrapped.Grease) if self.wrapped.Grease else None

    @property
    def initial_fill(self) -> '_1787.InitialFill':
        ...
        return constructor.new(_1787.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill else None

    @property
    def grease_quantity(self) -> '_1786.GreaseQuantity':
        ...
        return constructor.new(_1786.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity else None
