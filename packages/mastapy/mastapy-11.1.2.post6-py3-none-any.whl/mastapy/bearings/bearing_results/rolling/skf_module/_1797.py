...
from mastapy.bearings.bearing_results.rolling.skf_module import _1790, _1793
...
class Viscosities(_1793.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1790.OperatingViscosity':
        ...
        return constructor.new(_1790.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
