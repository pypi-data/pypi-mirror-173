...
from mastapy.bearings.bearing_results.rolling.skf_module import _1775, _1793
...
class AdjustedSpeed(_1793.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1775.AdjustmentFactors':
        ...
        return constructor.new(_1775.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
