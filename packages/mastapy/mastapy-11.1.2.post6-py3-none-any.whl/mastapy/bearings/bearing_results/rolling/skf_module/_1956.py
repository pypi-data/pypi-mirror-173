...
class GreaseLifeAndRelubricationInterval(_1965.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1955.Grease':
        ...
        return constructor.new(_1955.Grease)(self.wrapped.Grease) if self.wrapped.Grease is not None else None

    @property
    def initial_fill(self) -> '_1958.InitialFill':
        ...
        return constructor.new(_1958.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill is not None else None

    @property
    def grease_quantity(self) -> '_1957.GreaseQuantity':
        ...
        return constructor.new(_1957.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity is not None else None
