...
from mastapy.bearings.bearing_results.rolling.skf_module import _1959, _1965
...
class BearingRatingLife(_1965.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1959.LifeModel':
        ...
        return constructor.new(_1959.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel is not None else None
