...
from mastapy.bearings.bearing_results.rolling.skf_module import _1962, _1965
...
class DynamicAxialLoadCarryingCapacity(_1965.SKFCalculationResult):
    '''DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self) -> '_1962.PermissibleAxialLoad':
        ...
        return constructor.new(_1962.PermissibleAxialLoad)(self.wrapped.PermissibleAxialLoad) if self.wrapped.PermissibleAxialLoad is not None else None
