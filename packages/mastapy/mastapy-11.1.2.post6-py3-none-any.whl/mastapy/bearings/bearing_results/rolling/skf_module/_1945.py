...
from mastapy.bearings.bearing_results.rolling.skf_module import _1946, _1965
...
class AdjustedSpeed(_1965.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1946.AdjustmentFactors':
        ...
        return constructor.new(_1946.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors is not None else None
