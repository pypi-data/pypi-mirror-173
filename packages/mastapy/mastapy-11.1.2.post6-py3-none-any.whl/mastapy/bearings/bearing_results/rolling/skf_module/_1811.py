...
class GreaseLifeAndRelubricationInterval(_1820.SKFCalculationResult):
    ...
    def grease(self) -> '_1810.Grease':
        ...
        return constructor.new(_1810.Grease)(self.wrapped.Grease) if self.wrapped.Grease is not None else None
    ...
    def initial_fill(self) -> '_1813.InitialFill':
        ...
        return constructor.new(_1813.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill is not None else None
    ...
    def grease_quantity(self) -> '_1812.GreaseQuantity':
        ...
        return constructor.new(_1812.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity is not None else None
