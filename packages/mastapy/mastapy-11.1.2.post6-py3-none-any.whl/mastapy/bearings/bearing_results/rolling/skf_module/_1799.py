...
from mastapy.bearings.bearing_results.rolling.skf_module import _1810, _1815
...
class BearingRatingLife(_1815.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1810.LifeModel':
        ...
        return constructor.new(_1810.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
