...
from mastapy.bearings.bearing_results.rolling import _1671, _1712
...
class LoadedBallBearingElement(_1712.LoadedElement):
    '''LoadedBallBearingElement
    ...
    @property
    def inner_race_contact_geometries(self) -> 'List[_1671.BallBearingRaceContactGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InnerRaceContactGeometries, constructor.new(_1671.BallBearingRaceContactGeometry))
        return value

    @property
    def outer_race_contact_geometries(self) -> 'List[_1671.BallBearingRaceContactGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OuterRaceContactGeometries, constructor.new(_1671.BallBearingRaceContactGeometry))
        return value
