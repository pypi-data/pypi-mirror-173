...
from mastapy.bearings.bearing_results.rolling import _1675, _1772, _1771
...
class LoadedElement(_0.APIBase):
    ...
    @property
    def operating_internal_clearance(self) -> '_1675.InternalClearance':
        ...
        if _1675.InternalClearance.TYPE not in self.wrapped.OperatingInternalClearance.__class__.__mro__:
    ...
    @property
    def subsurface_shear_stress_distribution_inner(self) -> 'List[_1771.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionInner, constructor.new(_1771.StressAtPosition))
        return value

    @property
    def subsurface_shear_stress_distribution_outer(self) -> 'List[_1771.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionOuter, constructor.new(_1771.StressAtPosition))
        return value
