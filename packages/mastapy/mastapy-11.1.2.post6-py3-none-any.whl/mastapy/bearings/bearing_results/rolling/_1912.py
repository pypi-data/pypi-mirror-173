...
from mastapy.bearings.bearing_results.rolling import _1911, _1898
...
class LoadedSphericalRollerThrustBearingRow(_1898.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1911.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1911.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
