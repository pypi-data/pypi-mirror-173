...
from mastapy.bearings.bearing_results.rolling import _1920, _1871
...
class LoadedThreePointContactBallBearingRow(_1871.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1920.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1920.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
