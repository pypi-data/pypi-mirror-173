...
from mastapy.bearings.bearing_results.rolling import _1851, _1854, _1871
...
class LoadedAngularContactBallBearingRow(_1871.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1851.LoadedAngularContactBallBearingResults':
