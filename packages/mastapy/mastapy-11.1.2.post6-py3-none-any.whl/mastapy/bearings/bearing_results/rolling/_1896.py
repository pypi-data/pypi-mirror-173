...
from mastapy.bearings.bearing_results.rolling import _1936, _1882
...
class LoadedRollerBearingElement(_1882.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1936.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1936.ResultsAtRollerOffset))
        return value
