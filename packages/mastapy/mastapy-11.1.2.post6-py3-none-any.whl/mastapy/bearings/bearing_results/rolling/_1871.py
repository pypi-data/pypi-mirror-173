...
from mastapy.bearings.bearing_results.rolling import (
    _1870, _1851, _1854, _1880,
    _1885, _1904, _1920, _1923,
    _1869, _1902
)
...
class LoadedBallBearingRow(_1902.LoadedRollingBearingRow):
    '''LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1870.LoadedBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1869.LoadedBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1869.LoadedBallBearingRaceResults))
        return value
