...
from mastapy.bearings.bearing_results.rolling import _1687, _1728
...
class LoadedAsymmetricSphericalRollerBearingRow(_1728.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1687.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1687.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
