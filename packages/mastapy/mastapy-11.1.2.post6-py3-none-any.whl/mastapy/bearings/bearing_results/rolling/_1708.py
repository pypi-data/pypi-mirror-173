...
from mastapy.bearings.bearing_results.rolling import _1707, _1719, _1723
...
class LoadedCylindricalRollerBearingRow(_1723.LoadedNonBarrelRollerBearingRow):
    '''LoadedCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1707.LoadedCylindricalRollerBearingResults':
