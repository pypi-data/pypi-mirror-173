...
class LoadedNonBarrelRollerBearingRow(_1788.LoadedRollerBearingRow):
    """LoadedNonBarrelRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1782.LoadedNonBarrelRollerBearingResults':
