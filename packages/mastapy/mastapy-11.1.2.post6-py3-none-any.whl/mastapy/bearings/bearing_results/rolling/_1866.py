...
from mastapy.bearings.bearing_results.rolling import _1865, _1863
...
class LoadedAxialThrustNeedleRollerBearingRow(_1863.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1865.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1865.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
