...
from mastapy.bearings.bearing_results.rolling import _1769, _1722
...
class LoadedCylindricalRollerBearingResults(_1722.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1769.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1769.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
