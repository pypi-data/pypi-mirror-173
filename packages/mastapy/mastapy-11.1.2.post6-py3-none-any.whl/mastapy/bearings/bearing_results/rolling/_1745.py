...
from mastapy.bearings.bearing_results.rolling import _1744, _1742
...
class LoadedAngularContactThrustBallBearingRow(_1742.LoadedAngularContactBallBearingRow):
    """LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1744.LoadedAngularContactThrustBallBearingResults':
