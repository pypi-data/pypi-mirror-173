...
from mastapy.bearings.bearing_results.rolling import _1917, _1893
...
class LoadedTaperRollerBearingRow(_1893.LoadedNonBarrelRollerBearingRow):
    '''LoadedTaperRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1917.LoadedTaperRollerBearingResults':
        ...
        return constructor.new(_1917.LoadedTaperRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
