...
from mastapy.bearings.bearing_results.rolling import _1877, _1889, _1893
...
class LoadedCylindricalRollerBearingRow(_1893.LoadedNonBarrelRollerBearingRow):
    '''LoadedCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1877.LoadedCylindricalRollerBearingResults':
