...
from mastapy.bearings.bearing_results.rolling import _1880, _1871
...
class LoadedDeepGrooveBallBearingRow(_1871.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1880.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1880.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
