...
from mastapy.bearings.bearing_results.rolling import _1692, _1695, _1723
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1723.LoadedNonBarrelRollerBearingRow):
    '''LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1692.LoadedAxialThrustCylindricalRollerBearingResults':
