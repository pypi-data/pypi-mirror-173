...
from mastapy.bearings.bearing_results.rolling import _1773, _1731
...
class LoadedBallBearingResults(_1731.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def track_truncation(self) -> '_1773.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1773.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation else None
