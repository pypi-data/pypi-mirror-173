...
from mastapy.bearings.bearing_results.rolling import _1850
...
class LoadedAngularContactThrustBallBearingElement(_1850.LoadedAngularContactBallBearingElement):
    '''LoadedAngularContactThrustBallBearingElement
