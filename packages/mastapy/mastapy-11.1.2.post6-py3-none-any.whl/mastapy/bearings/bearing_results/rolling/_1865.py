...
from mastapy.bearings.bearing_results.rolling import _1862
...
class LoadedAxialThrustNeedleRollerBearingResults(_1862.LoadedAxialThrustCylindricalRollerBearingResults):
    '''LoadedAxialThrustNeedleRollerBearingResults
