...
from mastapy.bearings.bearing_results.rolling import _1739
...
class LoadedAsymmetricSphericalRollerBearingStripLoadResults(_1739.LoadedAbstractSphericalRollerBearingStripLoadResults):
    """LoadedAsymmetricSphericalRollerBearingStripLoadResults
