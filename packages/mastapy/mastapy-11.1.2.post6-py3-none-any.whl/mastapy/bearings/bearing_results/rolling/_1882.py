...
from mastapy.bearings.bearing_results.rolling import _1845, _1943, _1942
...
class LoadedElement(_0.APIBase):
    ...
    @property
    def operating_internal_clearance(self) -> '_1845.InternalClearance':
        ...
        if _1845.InternalClearance.TYPE not in self.wrapped.OperatingInternalClearance.__class__.__mro__:
    ...
    @property
    def subsurface_shear_stress_distribution_inner(self) -> 'List[_1942.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionInner, constructor.new(_1942.StressAtPosition))
        return value

    @property
    def subsurface_shear_stress_distribution_outer(self) -> 'List[_1942.StressAtPosition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubsurfaceShearStressDistributionOuter, constructor.new(_1942.StressAtPosition))
        return value
