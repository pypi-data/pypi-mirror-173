...
from mastapy.bearings.bearing_results.rolling import _1857, _1898
...
class LoadedAsymmetricSphericalRollerBearingRow(_1898.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1857.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1857.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
