...
from mastapy.bearings.bearing_results.rolling import _1681, _1684, _1701
...
class LoadedAngularContactBallBearingRow(_1701.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1681.LoadedAngularContactBallBearingResults':
