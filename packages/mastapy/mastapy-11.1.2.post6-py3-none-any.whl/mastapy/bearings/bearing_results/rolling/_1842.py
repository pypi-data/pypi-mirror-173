...
from mastapy.bearings.bearing_results.rolling import _1843
...
class ForceAtLaminaGroupReportable(_0.APIBase):
    ...
    @property
    def forces_at_laminae(self) -> 'List[_1843.ForceAtLaminaReportable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForcesAtLaminae, constructor.new(_1843.ForceAtLaminaReportable))
        return value
