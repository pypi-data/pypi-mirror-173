...
class ISO14179SettingsPerBearingType(_1346.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    '''ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1605.RollingBearingType':
        ...
        return constructor.new(_1605.RollingBearingType)(value) if value else None
    ...
    @property
    def iso14179_settings(self) -> '_1676.ISO14179Settings':
        ...
        return constructor.new(_1676.ISO14179Settings)(self.wrapped.ISO14179Settings) if self.wrapped.ISO14179Settings else None
