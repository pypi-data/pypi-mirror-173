...
from mastapy.bearings.bearing_results.rolling import _1710, _1701
...
class LoadedDeepGrooveBallBearingRow(_1701.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1710.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1710.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
