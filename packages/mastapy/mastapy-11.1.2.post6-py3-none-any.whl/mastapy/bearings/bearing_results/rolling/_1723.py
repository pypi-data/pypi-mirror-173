...
class LoadedNonBarrelRollerBearingRow(_1728.LoadedRollerBearingRow):
    '''LoadedNonBarrelRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1722.LoadedNonBarrelRollerBearingResults':
