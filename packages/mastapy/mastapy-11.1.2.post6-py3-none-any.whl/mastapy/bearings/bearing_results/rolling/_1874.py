...
from mastapy.bearings.bearing_results.rolling import _1873, _1898
...
class LoadedCrossedRollerBearingRow(_1898.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1873.LoadedCrossedRollerBearingResults':
        ...
        return constructor.new(_1873.LoadedCrossedRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing is not None else None
