...
class LoadedNonLinearBearingResults(_1653.LoadedBearingResults):
    '''LoadedNonLinearBearingResults
    ...
    @property
    def resistive_torque(self) -> '_267.ResistiveTorque':
        ...
        if _267.ResistiveTorque.TYPE not in self.wrapped.ResistiveTorque.__class__.__mro__:
    ...
    @property
    def resistive_torque_of_type_combined_resistive_torque(self) -> '_258.CombinedResistiveTorque':
        ...
        if _258.CombinedResistiveTorque.TYPE not in self.wrapped.ResistiveTorque.__class__.__mro__:
    ...
    @property
    def resistive_torque_of_type_independent_resistive_torque(self) -> '_261.IndependentResistiveTorque':
        ...
        if _261.IndependentResistiveTorque.TYPE not in self.wrapped.ResistiveTorque.__class__.__mro__:
