...
from mastapy.bearings.bearing_results import _1838
...
class BearingStiffnessMatrixReporter(_0.APIBase):
    ...
    @property
    def rows(self) -> 'List[_1838.StiffnessRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1838.StiffnessRow))
        return value
