...
from mastapy.bearings.bearing_results import _1830
...
class LoadedDetailedBearingResults(_1830.LoadedNonLinearBearingResults):
    '''LoadedDetailedBearingResults
    ...
    @property
    def lubrication(self) -> '_240.LubricationDetail':
        ...
        return constructor.new(_240.LubricationDetail)(self.wrapped.Lubrication) if self.wrapped.Lubrication is not None else None
