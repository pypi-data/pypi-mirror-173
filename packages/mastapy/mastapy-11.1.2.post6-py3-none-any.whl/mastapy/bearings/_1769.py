...
from mastapy.bearings import (
    _1747, _1772, _1761, _1770
)
from mastapy.math_utility import _1388
from mastapy._internal.python_net import python_net_import
from mastapy.utility.databases import _1718
...
class RollingBearingDatabase(_1718.SQLDatabase['_1770.RollingBearingKey', '_2031.RollingBearing']):
    '''RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_2031.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_2031.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1747.BearingCatalog', type_: '_1772.RollingBearingType', bore_range: '_1388.Range', outer_diameter_range: '_1388.Range', width_range: '_1388.Range', dynamic_capacity_range: '_1388.Range', number_of_rows: 'int', material_type: '_1761.HybridSteelAll') -> 'List[_2031.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1747.BearingCatalog', type_: '_1772.RollingBearingType') -> 'List[_2031.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_STRING, _BEARING_CATALOG, _ROLLING_BEARING_TYPE](designation if designation else '', catalog, type_), constructor.new(_2031.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1747.BearingCatalog') -> '_2031.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1747.BearingCatalog') -> 'List[_2031.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_BEARING_CATALOG](catalog), constructor.new(_2031.RollingBearing))

    def create_bearing(self, type_: '_1772.RollingBearingType', designation: Optional['str'] = 'None') -> '_2031.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_2031.RollingBearing':
        ''' 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1772.RollingBearingType', designation: Optional['str'] = 'None') -> '_1770.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1770.RollingBearingKey':
        ''' 'CreateKey' is the original name of this method.
