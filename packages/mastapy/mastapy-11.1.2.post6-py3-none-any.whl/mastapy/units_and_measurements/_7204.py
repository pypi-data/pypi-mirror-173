...
class MeasurementTypeExtensions:
    ...
    @staticmethod
    def is_unmeasurable(measurement_type: '_7203.MeasurementType') -> 'bool':
    ...
    @staticmethod
    def is_valid(measurement_type: '_7203.MeasurementType') -> 'bool':
    ...
    @staticmethod
    def is_angle(measurement_type: '_7203.MeasurementType') -> 'bool':
