...
from mastapy.units_and_measurements import _7206
...
class MeasurementTypeExtensions:
    ...
    @staticmethod
    def is_unmeasurable(measurement_type: '_7206.MeasurementType') -> 'bool':
    ...
    @staticmethod
    def is_valid(measurement_type: '_7206.MeasurementType') -> 'bool':
    ...
    @staticmethod
    def is_angle(measurement_type: '_7206.MeasurementType') -> 'bool':
