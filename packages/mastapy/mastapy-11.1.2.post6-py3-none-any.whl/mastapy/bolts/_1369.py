...
from mastapy.bolts import _1384, _1365
...
class BoltMaterial(_1365.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1384.StrengthGrades':
        ...
        return constructor.new(_1384.StrengthGrades)(value) if value is not None else None

    @strength_grade.setter
    def strength_grade(self, value: '_1384.StrengthGrades'):
