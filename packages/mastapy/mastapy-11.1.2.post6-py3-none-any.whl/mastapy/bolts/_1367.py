...
class BoltGeometry(_1716.NamedDatabaseItem):
    '''BoltGeometry
    ...
    @property
    def standard_size(self) -> '_1383.StandardSizes':
        '''StandardSizes: 'StandardSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.StandardSize)
        return constructor.new(_1383.StandardSizes)(value) if value is not None else None

    @standard_size.setter
    def standard_size(self, value: '_1383.StandardSizes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.StandardSize = value

    @property
    def bolt_sections(self) -> 'List[_1371.BoltSection]':
        '''List[BoltSection]: 'BoltSections' is the original name of this property.'''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoltSections, constructor.new(_1371.BoltSection))
        return value

    @bolt_sections.setter
    def bolt_sections(self, value: 'List[_1371.BoltSection]'):
        value = value if value else None
    ...
    @property
    def bolt_shank_type(self) -> '_1372.BoltShankType':
        ...
        return constructor.new(_1372.BoltShankType)(value) if value is not None else None

    @bolt_shank_type.setter
    def bolt_shank_type(self, value: '_1372.BoltShankType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def type_of_head_cap(self) -> '_1378.HeadCapTypes':
        ...
        return constructor.new(_1378.HeadCapTypes)(value) if value is not None else None

    @type_of_head_cap.setter
    def type_of_head_cap(self, value: '_1378.HeadCapTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfHeadCap = value

    @property
    def type_of_thread(self) -> '_1385.ThreadTypes':
        '''ThreadTypes: 'TypeOfThread' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfThread)
        return constructor.new(_1385.ThreadTypes)(value) if value is not None else None

    @type_of_thread.setter
    def type_of_thread(self, value: '_1385.ThreadTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def type_of_bolted_joint(self) -> '_1373.BoltTypes':
        ...
        return constructor.new(_1373.BoltTypes)(value) if value is not None else None

    @type_of_bolted_joint.setter
    def type_of_bolted_joint(self, value: '_1373.BoltTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
