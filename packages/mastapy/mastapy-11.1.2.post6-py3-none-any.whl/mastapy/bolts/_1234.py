...
from mastapy.bolts import _1249, _1230
...
class BoltMaterial(_1230.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1249.StrengthGrades':
        ...
        return constructor.new(_1249.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1249.StrengthGrades'):
