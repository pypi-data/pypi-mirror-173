...
class LoadedBolt(_0.APIBase):
    ...
    @property
    def axial_load_type(self) -> '_1229.AxialLoadType':
        ...
        return constructor.new(_1229.AxialLoadType)(value) if value else None

    @axial_load_type.setter
    def axial_load_type(self, value: '_1229.AxialLoadType'):
    ...
    @property
    def joint_type(self) -> '_1245.JointTypes':
        '''JointTypes: 'JointType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.JointType)
        return constructor.new(_1245.JointTypes)(value) if value else None

    @joint_type.setter
    def joint_type(self, value: '_1245.JointTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tightening_technique(self) -> '_1251.TighteningTechniques':
        ...
        return constructor.new(_1251.TighteningTechniques)(value) if value else None

    @tightening_technique.setter
    def tightening_technique(self, value: '_1251.TighteningTechniques'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TighteningTechnique = value

    @property
    def bolt(self) -> '_1241.DetailedBoltDesign':
        ...
        return constructor.new(_1241.DetailedBoltDesign)(self.wrapped.Bolt) if self.wrapped.Bolt else None
