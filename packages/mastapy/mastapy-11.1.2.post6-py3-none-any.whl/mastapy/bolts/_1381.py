...
class LoadedBolt(_0.APIBase):
    ...
    @property
    def axial_load_type(self) -> '_1364.AxialLoadType':
        ...
        return constructor.new(_1364.AxialLoadType)(value) if value is not None else None

    @axial_load_type.setter
    def axial_load_type(self, value: '_1364.AxialLoadType'):
    ...
    @property
    def joint_type(self) -> '_1380.JointTypes':
        '''JointTypes: 'JointType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.JointType)
        return constructor.new(_1380.JointTypes)(value) if value is not None else None

    @joint_type.setter
    def joint_type(self, value: '_1380.JointTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tightening_technique(self) -> '_1386.TighteningTechniques':
        ...
        return constructor.new(_1386.TighteningTechniques)(value) if value is not None else None

    @tightening_technique.setter
    def tightening_technique(self, value: '_1386.TighteningTechniques'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TighteningTechnique = value

    @property
    def bolt(self) -> '_1376.DetailedBoltDesign':
        ...
        return constructor.new(_1376.DetailedBoltDesign)(self.wrapped.Bolt) if self.wrapped.Bolt is not None else None
