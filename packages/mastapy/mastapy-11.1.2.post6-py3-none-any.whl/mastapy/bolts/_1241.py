...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def rolled_before_or_after_heat_treatment(self) -> '_1247.RolledBeforeOrAfterHeatTreament':
        ...
        return constructor.new(_1247.RolledBeforeOrAfterHeatTreament)(value) if value else None

    @rolled_before_or_after_heat_treatment.setter
    def rolled_before_or_after_heat_treatment(self, value: '_1247.RolledBeforeOrAfterHeatTreament'):
    ...
    @property
    def joint_geometry(self) -> '_1244.JointGeometries':
        ...
        return constructor.new(_1244.JointGeometries)(value) if value else None

    @joint_geometry.setter
    def joint_geometry(self, value: '_1244.JointGeometries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clamped_parts(self) -> 'List[_1239.ClampedSection]':
        '''List[ClampedSection]: 'ClampedParts' is the original name of this property.'''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClampedParts, constructor.new(_1239.ClampedSection))
        return value

    @clamped_parts.setter
    def clamped_parts(self, value: 'List[_1239.ClampedSection]'):
        value = value if value else None
    ...
    @property
    def bolt_geometry(self) -> '_1232.BoltGeometry':
        ...
        return constructor.new(_1232.BoltGeometry)(self.wrapped.BoltGeometry) if self.wrapped.BoltGeometry else None
    ...
    @property
    def material_of_nut(self) -> '_1230.BoltedJointMaterial':
        ...
        if _1230.BoltedJointMaterial.TYPE not in self.wrapped.MaterialOfNut.__class__.__mro__:
    ...
    @property
    def material_of_bolt(self) -> '_1234.BoltMaterial':
        ...
        return constructor.new(_1234.BoltMaterial)(self.wrapped.MaterialOfBolt) if self.wrapped.MaterialOfBolt else None

    @property
    def material_of_tapped_thread(self) -> '_1230.BoltedJointMaterial':
        ...
        if _1230.BoltedJointMaterial.TYPE not in self.wrapped.MaterialOfTappedThread.__class__.__mro__:
    ...
    @property
    def clamped_sections(self) -> 'List[_1239.ClampedSection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClampedSections, constructor.new(_1239.ClampedSection))
        return value
