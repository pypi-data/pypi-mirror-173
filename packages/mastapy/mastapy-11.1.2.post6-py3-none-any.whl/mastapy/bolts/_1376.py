...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def rolled_before_or_after_heat_treatment(self) -> '_1382.RolledBeforeOrAfterHeatTreament':
        ...
        return constructor.new(_1382.RolledBeforeOrAfterHeatTreament)(value) if value is not None else None

    @rolled_before_or_after_heat_treatment.setter
    def rolled_before_or_after_heat_treatment(self, value: '_1382.RolledBeforeOrAfterHeatTreament'):
    ...
    @property
    def joint_geometry(self) -> '_1379.JointGeometries':
        ...
        return constructor.new(_1379.JointGeometries)(value) if value is not None else None

    @joint_geometry.setter
    def joint_geometry(self, value: '_1379.JointGeometries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clamped_parts(self) -> 'List[_1374.ClampedSection]':
        '''List[ClampedSection]: 'ClampedParts' is the original name of this property.'''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClampedParts, constructor.new(_1374.ClampedSection))
        return value

    @clamped_parts.setter
    def clamped_parts(self, value: 'List[_1374.ClampedSection]'):
        value = value if value else None
    ...
    @property
    def bolt_geometry(self) -> '_1367.BoltGeometry':
        ...
        return constructor.new(_1367.BoltGeometry)(self.wrapped.BoltGeometry) if self.wrapped.BoltGeometry is not None else None
    ...
    @property
    def material_of_nut(self) -> '_1365.BoltedJointMaterial':
        ...
        if _1365.BoltedJointMaterial.TYPE not in self.wrapped.MaterialOfNut.__class__.__mro__:
    ...
    @property
    def material_of_bolt(self) -> '_1369.BoltMaterial':
        ...
        return constructor.new(_1369.BoltMaterial)(self.wrapped.MaterialOfBolt) if self.wrapped.MaterialOfBolt is not None else None

    @property
    def material_of_tapped_thread(self) -> '_1365.BoltedJointMaterial':
        ...
        if _1365.BoltedJointMaterial.TYPE not in self.wrapped.MaterialOfTappedThread.__class__.__mro__:
    ...
    @property
    def clamped_sections(self) -> 'List[_1374.ClampedSection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClampedSections, constructor.new(_1374.ClampedSection))
        return value
