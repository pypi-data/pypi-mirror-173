...
with _DummyBaseClassImport():
    ...
    from ._26 import ShaftPointStress
    from ._27 import ShaftPointStressCycle
    from ._28 import ShaftPointStressCycleReporting
    from ._29 import ShaftProfile
    from ._30 import ShaftProfilePoint
    from ._31 import ShaftProfilePointCopy
    from ._32 import ShaftRadialHole
    from ._33 import ShaftRatingMethod
    from ._34 import ShaftSafetyFactorSettings
    from ._35 import ShaftSectionDamageResults
    from ._36 import ShaftSectionEndDamageResults
    from ._37 import ShaftSettings
    from ._38 import ShaftSurfaceFinishSection
    from ._39 import ShaftSurfaceRoughness
    from ._40 import SimpleShaftDefinition
    from ._41 import StressMeasurementShaftAxialBendingTorsionalComponentValues
    from ._42 import SurfaceFinishes
