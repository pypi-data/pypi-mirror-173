...
from mastapy.detailed_rigid_connectors.interference_fits import _1213
from mastapy.bearings.tolerances import _1628, _1614, _1620
...
class InterferenceFitHalfDesign(_1154.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1213.StressRegions':
        ...
        return constructor.new(_1213.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1628.SupportTolerance':
        ...
        if _1628.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1614.InnerSupportTolerance':
        ...
        if _1614.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1620.OuterSupportTolerance':
        ...
        if _1620.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
