...
class InterferenceFitDesign(_1171.DetailedRigidConnectorDesign):
    ...
    def calculation_method(self) -> '_1228.CalculationMethods':
        ...
        return constructor.new(_1228.CalculationMethods)(value) if value is not None else None
    ...
    def assembly_method(self) -> '_1227.AssemblyMethods':
        ...
        return constructor.new(_1227.AssemblyMethods)(value) if value is not None else None
