...
from mastapy.detailed_rigid_connectors.interference_fits import _1210, _1209, _1214
...
class InterferenceFitDesign(_1153.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1210.CalculationMethods':
        ...
        return constructor.new(_1210.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1210.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1209.AssemblyMethods':
        ...
        return constructor.new(_1209.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1209.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
