...
from mastapy.detailed_rigid_connectors.interference_fits import _1348
from mastapy.bearings.tolerances import _1796, _1782, _1788
...
class InterferenceFitHalfDesign(_1289.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1348.StressRegions':
        ...
        return constructor.new(_1348.StressRegions)(value) if value is not None else None
    ...
    @property
    def tolerance(self) -> '_1796.SupportTolerance':
        ...
        if _1796.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1782.InnerSupportTolerance':
        ...
        if _1782.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1788.OuterSupportTolerance':
        ...
        if _1788.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
