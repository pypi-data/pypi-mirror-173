...
from mastapy.detailed_rigid_connectors.interference_fits import _1345, _1344, _1349
...
class InterferenceFitDesign(_1288.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1345.CalculationMethods':
        ...
        return constructor.new(_1345.CalculationMethods)(value) if value is not None else None

    @calculation_method.setter
    def calculation_method(self, value: '_1345.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1344.AssemblyMethods':
        ...
        return constructor.new(_1344.AssemblyMethods)(value) if value is not None else None

    @assembly_method.setter
    def assembly_method(self, value: '_1344.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
