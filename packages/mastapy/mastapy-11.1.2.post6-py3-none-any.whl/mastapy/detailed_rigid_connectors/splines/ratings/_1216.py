...
from mastapy.detailed_rigid_connectors.splines.ratings import _1215
...
class SplineJointRating(_1220.ShaftHubConnectionRating):
    '''SplineJointRating
    ...
    @property
    def spline_half_ratings(self) -> 'List[_1215.SplineHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SplineHalfRatings, constructor.new(_1215.SplineHalfRating))
        return value
