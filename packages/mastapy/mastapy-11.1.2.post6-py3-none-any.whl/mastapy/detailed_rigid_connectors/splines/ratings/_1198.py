...
from mastapy.detailed_rigid_connectors.splines.ratings import _1197
from mastapy.detailed_rigid_connectors.rating import _1202
...
class SplineJointRating(_1202.ShaftHubConnectionRating):
    '''SplineJointRating
    ...
    @property
    def spline_half_ratings(self) -> 'List[_1197.SplineHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SplineHalfRatings, constructor.new(_1197.SplineHalfRating))
        return value
