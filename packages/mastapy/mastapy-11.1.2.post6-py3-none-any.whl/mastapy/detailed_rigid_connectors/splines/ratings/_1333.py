...
from mastapy.detailed_rigid_connectors.splines.ratings import _1332
...
class SplineJointRating(_1337.ShaftHubConnectionRating):
    '''SplineJointRating
    ...
    @property
    def spline_half_ratings(self) -> 'List[_1332.SplineHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SplineHalfRatings, constructor.new(_1332.SplineHalfRating))
        return value
