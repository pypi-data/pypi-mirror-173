...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1188
from mastapy.detailed_rigid_connectors.splines import _1185
...
class SAESplineHalfDesign(_1185.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1188.SAESplineTolerances':
        ...
        return constructor.new(_1188.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance else None
