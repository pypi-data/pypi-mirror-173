...
from mastapy.detailed_rigid_connectors.splines import _1161, _1186
...
class SAESplineJointDesign(_1186.StandardSplineJointDesign):
    '''SAESplineJointDesign
    ...
    @property
    def fit_type(self) -> '_1161.FitTypes':
        '''FitTypes: 'FitType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FitType)
        return constructor.new(_1161.FitTypes)(value) if value else None

    @fit_type.setter
    def fit_type(self, value: '_1161.FitTypes'):
