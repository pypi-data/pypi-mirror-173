...
from mastapy.detailed_rigid_connectors.splines import _1303, _1312, _1320
...
class DIN5480SplineHalfDesign(_1320.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_1303.ManufacturingTypes':
        ...
        return constructor.new(_1303.ManufacturingTypes)(value) if value is not None else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_1303.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_1312.FinishingMethods':
        ...
        return constructor.new(_1312.FinishingMethods)(value) if value is not None else None

    @finishing_method.setter
    def finishing_method(self, value: '_1312.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
