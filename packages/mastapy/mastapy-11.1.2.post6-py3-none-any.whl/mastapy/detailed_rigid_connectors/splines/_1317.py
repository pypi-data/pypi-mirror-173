...
from mastapy.detailed_rigid_connectors.splines import _1299
...
class SplineMaterial(_242.Material):
    '''SplineMaterial
    ...
    @property
    def heat_treatment_type(self) -> '_1299.HeatTreatmentTypes':
    ...
    def heat_treatment_type(self, value: '_1299.HeatTreatmentTypes'):
