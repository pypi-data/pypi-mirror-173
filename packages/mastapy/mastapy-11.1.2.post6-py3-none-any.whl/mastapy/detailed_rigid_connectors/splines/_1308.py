...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1323
from mastapy.detailed_rigid_connectors.splines import _1320
...
class SAESplineHalfDesign(_1320.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1323.SAESplineTolerances':
        ...
        return constructor.new(_1323.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance is not None else None
