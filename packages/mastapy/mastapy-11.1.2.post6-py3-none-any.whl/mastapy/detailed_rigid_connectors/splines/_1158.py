...
from mastapy.detailed_rigid_connectors.splines import _1168, _1177, _1185
...
class DIN5480SplineHalfDesign(_1185.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_1168.ManufacturingTypes':
        ...
        return constructor.new(_1168.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_1168.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_1177.FinishingMethods':
        ...
        return constructor.new(_1177.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1177.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
