...
from mastapy.detailed_rigid_connectors.splines import _1296, _1321
...
class SAESplineJointDesign(_1321.StandardSplineJointDesign):
    '''SAESplineJointDesign
    ...
    @property
    def fit_type(self) -> '_1296.FitTypes':
        '''FitTypes: 'FitType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FitType)
        return constructor.new(_1296.FitTypes)(value) if value is not None else None

    @fit_type.setter
    def fit_type(self, value: '_1296.FitTypes'):
