...
from mastapy.detailed_rigid_connectors.splines import (
    _1299, _1316, _1291, _1294,
    _1298, _1301, _1302, _1309,
    _1321
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1322
from mastapy.detailed_rigid_connectors import _1289
...
class SplineHalfDesign(_1289.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_1299.HeatTreatmentTypes':
        ...
        return constructor.new(_1299.HeatTreatmentTypes)(value) if value is not None else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_1299.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1322.FitAndTolerance':
        ...
        return constructor.new(_1322.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance is not None else None
