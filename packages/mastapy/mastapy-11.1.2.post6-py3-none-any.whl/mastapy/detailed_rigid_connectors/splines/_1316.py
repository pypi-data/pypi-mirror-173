...
from mastapy.detailed_rigid_connectors.splines import (
    _1295, _1306, _1318, _1310,
    _1307, _1314, _1315, _1290,
    _1293, _1297, _1300, _1308,
    _1320
)
...
class SplineJointDesign(_1288.DetailedRigidConnectorDesign):
    '''SplineJointDesign
    ...
    @property
    def root_type(self) -> '_1306.RootTypes':
        '''RootTypes: 'RootType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RootType)
        return constructor.new(_1306.RootTypes)(value) if value is not None else None

    @root_type.setter
    def root_type(self, value: '_1306.RootTypes'):
    ...
    @property
    def torque_cycles(self) -> '_1310.SAETorqueCycles':
        ...
        return constructor.new(_1310.SAETorqueCycles)(value) if value is not None else None

    @torque_cycles.setter
    def torque_cycles(self, value: '_1310.SAETorqueCycles'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TorqueCycles = value

    @property
    def fatigue_life_factor_type(self) -> '_1307.SAEFatigueLifeFactorTypes':
        ...
        return constructor.new(_1307.SAEFatigueLifeFactorTypes)(value) if value is not None else None

    @fatigue_life_factor_type.setter
    def fatigue_life_factor_type(self, value: '_1307.SAEFatigueLifeFactorTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FatigueLifeFactorType = value

    @property
    def spline_fixture_type(self) -> '_1314.SplineFixtureTypes':
        ...
        return constructor.new(_1314.SplineFixtureTypes)(value) if value is not None else None

    @spline_fixture_type.setter
    def spline_fixture_type(self, value: '_1314.SplineFixtureTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_half(self) -> '_1315.SplineHalfDesign':
        ...
        if _1315.SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_custom_spline_half_design(self) -> '_1290.CustomSplineHalfDesign':
        ...
        if _1290.CustomSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_din5480_spline_half_design(self) -> '_1293.DIN5480SplineHalfDesign':
        ...
        if _1293.DIN5480SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_gbt3478_spline_half_design(self) -> '_1297.GBT3478SplineHalfDesign':
        ...
        if _1297.GBT3478SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_iso4156_spline_half_design(self) -> '_1300.ISO4156SplineHalfDesign':
        ...
        if _1300.ISO4156SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_sae_spline_half_design(self) -> '_1308.SAESplineHalfDesign':
        ...
        if _1308.SAESplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_standard_spline_half_design(self) -> '_1320.StandardSplineHalfDesign':
        ...
        if _1320.StandardSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half(self) -> '_1315.SplineHalfDesign':
        ...
        if _1315.SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_custom_spline_half_design(self) -> '_1290.CustomSplineHalfDesign':
        ...
        if _1290.CustomSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_din5480_spline_half_design(self) -> '_1293.DIN5480SplineHalfDesign':
        ...
        if _1293.DIN5480SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_gbt3478_spline_half_design(self) -> '_1297.GBT3478SplineHalfDesign':
        ...
        if _1297.GBT3478SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_iso4156_spline_half_design(self) -> '_1300.ISO4156SplineHalfDesign':
        ...
        if _1300.ISO4156SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_sae_spline_half_design(self) -> '_1308.SAESplineHalfDesign':
        ...
        if _1308.SAESplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_standard_spline_half_design(self) -> '_1320.StandardSplineHalfDesign':
        ...
        if _1320.StandardSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
