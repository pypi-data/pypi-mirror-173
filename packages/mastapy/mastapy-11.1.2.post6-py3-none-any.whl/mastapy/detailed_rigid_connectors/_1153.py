...
class DetailedRigidConnectorDesign(_0.APIBase):
    ...
    @property
    def halves(self) -> 'List[_1154.DetailedRigidConnectorHalfDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_1154.DetailedRigidConnectorHalfDesign))
        return value
