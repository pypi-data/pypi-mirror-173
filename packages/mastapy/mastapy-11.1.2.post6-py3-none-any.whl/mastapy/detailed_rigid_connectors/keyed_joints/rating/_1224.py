...
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1223
...
class KeywayRating(_1231.InterferenceFitRating):
    '''KeywayRating
    ...
    @property
    def keyed_joint_design(self) -> '_1219.KeyedJointDesign':
        ...
        return constructor.new(_1219.KeyedJointDesign)(self.wrapped.KeyedJointDesign) if self.wrapped.KeyedJointDesign else None

    @property
    def keyway_half_ratings(self) -> 'List[_1223.KeywayHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KeywayHalfRatings, constructor.new(_1223.KeywayHalfRating))
        return value
