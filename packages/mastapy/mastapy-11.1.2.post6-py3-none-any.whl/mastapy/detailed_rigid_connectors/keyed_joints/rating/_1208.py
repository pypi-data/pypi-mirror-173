...
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1207
from mastapy.detailed_rigid_connectors.interference_fits.rating import _1215
...
class KeywayRating(_1215.InterferenceFitRating):
    '''KeywayRating
    ...
    @property
    def keyed_joint_design(self) -> '_1203.KeyedJointDesign':
        ...
        return constructor.new(_1203.KeyedJointDesign)(self.wrapped.KeyedJointDesign) if self.wrapped.KeyedJointDesign else None

    @property
    def keyway_half_ratings(self) -> 'List[_1207.KeywayHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KeywayHalfRatings, constructor.new(_1207.KeywayHalfRating))
        return value
