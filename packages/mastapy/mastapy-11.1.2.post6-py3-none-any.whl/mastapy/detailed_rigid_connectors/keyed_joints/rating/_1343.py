...
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1342
...
class KeywayRating(_1350.InterferenceFitRating):
    '''KeywayRating
    ...
    @property
    def keyed_joint_design(self) -> '_1338.KeyedJointDesign':
        ...
        return constructor.new(_1338.KeyedJointDesign)(self.wrapped.KeyedJointDesign) if self.wrapped.KeyedJointDesign is not None else None

    @property
    def keyway_half_ratings(self) -> 'List[_1342.KeywayHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KeywayHalfRatings, constructor.new(_1342.KeywayHalfRating))
        return value
