...
class KeyedJointDesign(_1229.InterferenceFitDesign):
    ...
    def number_of_keys(self) -> '_1224.NumberOfKeys':
        ...
        return constructor.new(_1224.NumberOfKeys)(value) if value is not None else None
    ...
    def geometry_type(self) -> '_1222.KeyTypes':
        ...
        return constructor.new(_1222.KeyTypes)(value) if value is not None else None
