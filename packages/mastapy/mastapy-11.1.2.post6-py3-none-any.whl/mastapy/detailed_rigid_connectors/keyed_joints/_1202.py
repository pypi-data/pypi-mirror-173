...
from mastapy.detailed_rigid_connectors.keyed_joints import _1205, _1203
...
class KeyedJointDesign(_1210.InterferenceFitDesign):
    '''KeyedJointDesign
