...
from mastapy.detailed_rigid_connectors.keyed_joints import _1341, _1339
...
class KeyedJointDesign(_1346.InterferenceFitDesign):
    '''KeyedJointDesign
    ...
    @property
    def number_of_keys(self) -> '_1341.NumberOfKeys':
        '''NumberOfKeys: 'NumberOfKeys' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.NumberOfKeys)
        return constructor.new(_1341.NumberOfKeys)(value) if value is not None else None

    @number_of_keys.setter
    def number_of_keys(self, value: '_1341.NumberOfKeys'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.NumberOfKeys = value

    @property
    def geometry_type(self) -> '_1339.KeyTypes':
        '''KeyTypes: 'GeometryType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.GeometryType)
        return constructor.new(_1339.KeyTypes)(value) if value is not None else None

    @geometry_type.setter
    def geometry_type(self, value: '_1339.KeyTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
