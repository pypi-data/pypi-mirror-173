...
from mastapy.detailed_rigid_connectors.keyed_joints import _1206, _1204
...
class KeyedJointDesign(_1211.InterferenceFitDesign):
    '''KeyedJointDesign
