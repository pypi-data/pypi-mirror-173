...
from mastapy.detailed_rigid_connectors.splines import (
    _1156, _1159, _1163, _1166,
    _1167, _1174, _1181, _1186
)
...
class ShaftHubConnectionRating(_0.APIBase):
    ...
    @property
    def joint_design(self) -> '_1153.DetailedRigidConnectorDesign':
        ...
        if _1153.DetailedRigidConnectorDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_custom_spline_joint_design(self) -> '_1156.CustomSplineJointDesign':
        ...
        if _1156.CustomSplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_din5480_spline_joint_design(self) -> '_1159.DIN5480SplineJointDesign':
        ...
        if _1159.DIN5480SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1163.GBT3478SplineJointDesign':
        ...
        if _1163.GBT3478SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_iso4156_spline_joint_design(self) -> '_1166.ISO4156SplineJointDesign':
        ...
        if _1166.ISO4156SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1167.JISB1603SplineJointDesign':
        ...
        if _1167.JISB1603SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_sae_spline_joint_design(self) -> '_1174.SAESplineJointDesign':
        ...
        if _1174.SAESplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_spline_joint_design(self) -> '_1181.SplineJointDesign':
        ...
        if _1181.SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_standard_spline_joint_design(self) -> '_1186.StandardSplineJointDesign':
        ...
        if _1186.StandardSplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_keyed_joint_design(self) -> '_1203.KeyedJointDesign':
        ...
        if _1203.KeyedJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_interference_fit_design(self) -> '_1211.InterferenceFitDesign':
        ...
        if _1211.InterferenceFitDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
