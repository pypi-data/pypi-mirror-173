...
from mastapy.detailed_rigid_connectors.splines import (
    _1172, _1175, _1179, _1182,
    _1183, _1190, _1197, _1202
)
...
class ShaftHubConnectionRating(_0.APIBase):
    ...
    @property
    def joint_design(self) -> '_1169.DetailedRigidConnectorDesign':
        ...
        if _1169.DetailedRigidConnectorDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_custom_spline_joint_design(self) -> '_1172.CustomSplineJointDesign':
        ...
        if _1172.CustomSplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_din5480_spline_joint_design(self) -> '_1175.DIN5480SplineJointDesign':
        ...
        if _1175.DIN5480SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1179.GBT3478SplineJointDesign':
        ...
        if _1179.GBT3478SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_iso4156_spline_joint_design(self) -> '_1182.ISO4156SplineJointDesign':
        ...
        if _1182.ISO4156SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1183.JISB1603SplineJointDesign':
        ...
        if _1183.JISB1603SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_sae_spline_joint_design(self) -> '_1190.SAESplineJointDesign':
        ...
        if _1190.SAESplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_spline_joint_design(self) -> '_1197.SplineJointDesign':
        ...
        if _1197.SplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_standard_spline_joint_design(self) -> '_1202.StandardSplineJointDesign':
        ...
        if _1202.StandardSplineJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_keyed_joint_design(self) -> '_1219.KeyedJointDesign':
        ...
        if _1219.KeyedJointDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
    ...
    @property
    def joint_design_of_type_interference_fit_design(self) -> '_1227.InterferenceFitDesign':
        ...
        if _1227.InterferenceFitDesign.TYPE not in self.wrapped.JointDesign.__class__.__mro__:
