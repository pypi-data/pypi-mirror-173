...
from mastapy.cycloidal import _1223
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def modifications_specification(self) -> '_1223.CycloidalDiscModificationsSpecification':
        ...
        return constructor.new(_1223.CycloidalDiscModificationsSpecification)(self.wrapped.ModificationsSpecification) if self.wrapped.ModificationsSpecification else None
