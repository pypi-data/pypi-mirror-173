...
class CycloidalDiscModificationsSpecification(_0.APIBase):
    ...
    def direction_of_measured_modifications(self) -> '_1242.DirectionOfMeasuredModifications':
        ...
        return constructor.new(_1242.DirectionOfMeasuredModifications)(value) if value is not None else None
    ...
    def measured_profile_modification(self) -> '_1317.Vector2DListAccessor':
        ...
        return constructor.new(_1317.Vector2DListAccessor)(self.wrapped.MeasuredProfileModification) if self.wrapped.MeasuredProfileModification is not None else None
    ...
    def crowning_specification_method(self) -> '_1236.CrowningSpecificationMethod':
        ...
        return constructor.new(_1236.CrowningSpecificationMethod)(value) if value is not None else None
