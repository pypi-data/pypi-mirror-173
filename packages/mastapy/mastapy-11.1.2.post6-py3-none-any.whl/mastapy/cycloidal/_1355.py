...
from mastapy.cycloidal import _1358
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def estimated_modifications_from_spline_fit(self) -> '_1745.TwoDChartDefinition':
        ...
        if _1745.TwoDChartDefinition.TYPE not in self.wrapped.EstimatedModificationsFromSplineFit.__class__.__mro__:
    ...
    @property
    def crowning_chart(self) -> '_1745.TwoDChartDefinition':
        ...
        if _1745.TwoDChartDefinition.TYPE not in self.wrapped.CrowningChart.__class__.__mro__:
    ...
    @property
    def modifications_specification(self) -> '_1358.CycloidalDiscModificationsSpecification':
        ...
        return constructor.new(_1358.CycloidalDiscModificationsSpecification)(self.wrapped.ModificationsSpecification) if self.wrapped.ModificationsSpecification is not None else None
