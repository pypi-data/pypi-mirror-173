...
from mastapy.cycloidal import _1361, _1355, _1360
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self) -> '_1361.RingPinsDesign':
        ...
        return constructor.new(_1361.RingPinsDesign)(self.wrapped.RingPins) if self.wrapped.RingPins is not None else None

    @property
    def discs(self) -> 'List[_1355.CycloidalDiscDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Discs, constructor.new(_1355.CycloidalDiscDesign))
        return value

    @property
    def disc_phases(self) -> 'List[_1360.NamedDiscPhase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DiscPhases, constructor.new(_1360.NamedDiscPhase))
        return value
