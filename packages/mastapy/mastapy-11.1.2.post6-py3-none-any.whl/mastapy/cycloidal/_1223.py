...
from mastapy.cycloidal import _1224, _1218
...
class CycloidalDiscModificationsSpecification(_0.APIBase):
    ...
    @property
    def direction_of_measured_modifications(self) -> '_1224.DirectionOfMeasuredModifications':
        ...
        return constructor.new(_1224.DirectionOfMeasuredModifications)(value) if value else None

    @direction_of_measured_modifications.setter
    def direction_of_measured_modifications(self, value: '_1224.DirectionOfMeasuredModifications'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DirectionOfMeasuredModifications = value

    @property
    def crowning_specification_method(self) -> '_1218.CrowningSpecificationMethod':
        ...
        return constructor.new(_1218.CrowningSpecificationMethod)(value) if value else None

    @crowning_specification_method.setter
    def crowning_specification_method(self, value: '_1218.CrowningSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
