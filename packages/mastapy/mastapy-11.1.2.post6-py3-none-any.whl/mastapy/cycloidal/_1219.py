...
from mastapy.cycloidal import _1226, _1220, _1225
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self) -> '_1226.RingPinsDesign':
        ...
        return constructor.new(_1226.RingPinsDesign)(self.wrapped.RingPins) if self.wrapped.RingPins else None

    @property
    def discs(self) -> 'List[_1220.CycloidalDiscDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Discs, constructor.new(_1220.CycloidalDiscDesign))
        return value

    @property
    def disc_phases(self) -> 'List[_1225.NamedDiscPhase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DiscPhases, constructor.new(_1225.NamedDiscPhase))
        return value
