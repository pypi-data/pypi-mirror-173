...
from mastapy.nodal_analysis.component_mode_synthesis import _199, _195
...
class CMSModel(_0.APIBase):
    ...
    @property
    def fe_model(self) -> '_157.FEModel':
        ...
        return constructor.new(_157.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel else None

    @property
    def reduction_options(self) -> '_199.CMSOptions':
        ...
        return constructor.new(_199.CMSOptions)(self.wrapped.ReductionOptions) if self.wrapped.ReductionOptions else None

    @property
    def element_face_groups(self) -> 'List[_195.CMSElementFaceGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_195.CMSElementFaceGroup))
        return value
