...
from mastapy.nodal_analysis import _55, _88, _59
...
class FEMeshingOptions(_0.APIBase):
    ...
    @property
    def element_shape(self) -> '_88.VolumeElementShape':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_88.VolumeElementShape)(value) if value is not None else None

    @element_shape.setter
    def element_shape(self, value: '_88.VolumeElementShape'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def meshing_problems(self) -> 'List[_59.FEMeshingProblem]':
