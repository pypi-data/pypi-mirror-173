...
class AbstractVaryingInputComponent(_0.APIBase):
    ...
    @property
    def value_vs_angle(self) -> '_1341.Vector2DListAccessor':
    ...
    def value_vs_angle(self, value: '_1341.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.ValueVsAngle = value

    @property
    def value_vs_angle_and_speed(self) -> '_1373.GriddedSurfaceAccessor':
    ...
    def value_vs_angle_and_speed(self, value: '_1373.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
        self.wrapped.ValueVsAngleAndSpeed = value

    @property
    def value_vs_position(self) -> '_1341.Vector2DListAccessor':
    ...
    def value_vs_position(self, value: '_1341.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.ValueVsPosition = value

    @property
    def value_vs_time(self) -> '_1341.Vector2DListAccessor':
    ...
    def value_vs_time(self, value: '_1341.Vector2DListAccessor'):
        value = value.wrapped if value else None
