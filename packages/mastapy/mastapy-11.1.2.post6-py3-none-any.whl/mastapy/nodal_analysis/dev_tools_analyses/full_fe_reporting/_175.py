...
from mastapy.fe_tools.vis_tools_visualisation.enums import _1142
...
class CoordinateSystemReporting(_0.APIBase):
    ...
    @property
    def type_(self) -> '_1142.CoordinateSystemType':
        ...
        return constructor.new(_1142.CoordinateSystemType)(value) if value else None
