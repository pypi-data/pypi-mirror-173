...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1146, _1145
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def reference_surface_type(self) -> '_1146.ContactPairReferenceSurfaceType':
        ...
        return constructor.new(_1146.ContactPairReferenceSurfaceType)(value) if value else None

    @property
    def constrained_surface_type(self) -> '_1145.ContactPairConstrainedSurfaceType':
        ...
        return constructor.new(_1145.ContactPairConstrainedSurfaceType)(value) if value else None
