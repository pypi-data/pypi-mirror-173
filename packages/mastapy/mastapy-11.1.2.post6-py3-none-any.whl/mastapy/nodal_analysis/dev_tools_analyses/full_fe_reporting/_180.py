...
from mastapy.fe_tools.vis_tools_visualisation.enums import _1181
...
class CoordinateSystemReporting(_0.APIBase):
    ...
    @property
    def type_(self) -> '_1181.CoordinateSystemType':
        ...
        return constructor.new(_1181.CoordinateSystemType)(value) if value is not None else None
