...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1145, _1144
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def reference_surface_type(self) -> '_1145.ContactPairReferenceSurfaceType':
        ...
        return constructor.new(_1145.ContactPairReferenceSurfaceType)(value) if value else None

    @property
    def constrained_surface_type(self) -> '_1144.ContactPairConstrainedSurfaceType':
        ...
        return constructor.new(_1144.ContactPairConstrainedSurfaceType)(value) if value else None
