...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1187, _1188
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def constrained_surface_type(self) -> '_1187.ContactPairConstrainedSurfaceType':
        ...
        return constructor.new_from_mastapy_type(_1187.ContactPairConstrainedSurfaceType)(value) if value is not None else None
    ...
    @property
    def reference_surface_type(self) -> '_1188.ContactPairReferenceSurfaceType':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1188.ContactPairReferenceSurfaceType)(value) if value is not None else None
