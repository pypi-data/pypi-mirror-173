...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1185, _1184
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def reference_surface_type(self) -> '_1185.ContactPairReferenceSurfaceType':
        ...
        return constructor.new(_1185.ContactPairReferenceSurfaceType)(value) if value is not None else None

    @property
    def constrained_surface_type(self) -> '_1184.ContactPairConstrainedSurfaceType':
        ...
        return constructor.new(_1184.ContactPairConstrainedSurfaceType)(value) if value is not None else None
