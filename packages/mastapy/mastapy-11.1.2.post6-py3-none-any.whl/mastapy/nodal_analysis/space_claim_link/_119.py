...
class SpaceClaimDimension(_0.APIBase):
    ...
    @property
    def type_(self) -> '_121.SpaceClaimDimensionType':
        '''SpaceClaimDimensionType: 'Type' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Type)
        return constructor.new(_121.SpaceClaimDimensionType)(value) if value else None

    @type_.setter
    def type_(self, value: '_121.SpaceClaimDimensionType'):
