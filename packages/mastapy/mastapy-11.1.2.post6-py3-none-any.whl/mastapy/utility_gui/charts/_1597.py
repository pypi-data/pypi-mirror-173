...
class CustomTableAndChart(_1534.CustomTable):
    '''CustomTableAndChart
    ...
    @property
    def primary_axis_range(self) -> '_1269.Range':
        ...
        if _1269.Range.TYPE not in self.wrapped.PrimaryAxisRange.__class__.__mro__:
