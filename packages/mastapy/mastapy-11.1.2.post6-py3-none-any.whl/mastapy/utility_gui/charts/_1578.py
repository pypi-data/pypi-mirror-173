...
class CustomTableAndChart(_1516.CustomTable):
    '''CustomTableAndChart
    ...
    @property
    def primary_axis_range(self) -> '_1253.Range':
        ...
        if _1253.Range.TYPE not in self.wrapped.PrimaryAxisRange.__class__.__mro__:
