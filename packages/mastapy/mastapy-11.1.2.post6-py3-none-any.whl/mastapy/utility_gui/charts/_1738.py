...
from mastapy.utility.report import _1672
...
class CustomTableAndChart(_1672.CustomTable):
    '''CustomTableAndChart
    ...
    @property
    def primary_axis_range(self) -> '_1388.Range':
        ...
        if _1388.Range.TYPE not in self.wrapped.PrimaryAxisRange.__class__.__mro__:
