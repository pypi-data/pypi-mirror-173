...
from mastapy.gears.gear_designs.creation_options import _1099
...
class CylindricalGearPairCreationOptions(_1099.GearSetCreationOptions['_989.CylindricalGearSetDesign']):
    '''CylindricalGearPairCreationOptions
