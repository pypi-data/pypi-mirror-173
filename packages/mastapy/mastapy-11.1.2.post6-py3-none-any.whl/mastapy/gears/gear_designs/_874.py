...
class DesignConstraint(_0.APIBase):
    ...
    @property
    def range(self) -> '_1252.Range':
        '''Range: 'Range' is the original name of this property.'''

        if _1252.Range.TYPE not in self.wrapped.Range.__class__.__mro__:
    ...
    @range.setter
    def range(self, value: '_1252.Range'):
        value = value.wrapped if value else None
        self.wrapped.Range = value

    @property
    def integer_range(self) -> '_1347.IntegerRange':
        '''IntegerRange: 'IntegerRange' is the original name of this property.'''

        return constructor.new(_1347.IntegerRange)(self.wrapped.IntegerRange) if self.wrapped.IntegerRange else None

    @integer_range.setter
    def integer_range(self, value: '_1347.IntegerRange'):
        value = value.wrapped if value else None
