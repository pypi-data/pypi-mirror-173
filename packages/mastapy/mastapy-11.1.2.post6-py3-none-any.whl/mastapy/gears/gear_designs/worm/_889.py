...
class WormGearMeshDesign(_880.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    @property
    def worm_gear_set(self) -> '_890.WormGearSetDesign':
        ...
        return constructor.new(_890.WormGearSetDesign)(self.wrapped.WormGearSet) if self.wrapped.WormGearSet else None

    @property
    def worm(self) -> '_887.WormDesign':
        ...
        return constructor.new(_887.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_891.WormWheelDesign':
        ...
        return constructor.new(_891.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None
