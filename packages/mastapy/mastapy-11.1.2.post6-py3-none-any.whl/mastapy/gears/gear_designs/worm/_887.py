...
class WormDesign(_888.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_312.WormAddendumFactor':
        ...
        return constructor.new(_312.WormAddendumFactor)(value) if value else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_312.WormAddendumFactor'):
