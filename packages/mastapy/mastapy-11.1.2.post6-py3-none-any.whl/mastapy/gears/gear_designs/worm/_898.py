...
class WormGearMeshDesign(_889.GearMeshDesign):
    ...
    def worm_gear_set(self) -> '_899.WormGearSetDesign':
        ...
        return constructor.new(_899.WormGearSetDesign)(self.wrapped.WormGearSet) if self.wrapped.WormGearSet is not None else None
    ...
    def worm(self) -> '_896.WormDesign':
        ...
        return constructor.new(_896.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm is not None else None
    ...
    def wheel(self) -> '_900.WormWheelDesign':
        ...
        return constructor.new(_900.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel is not None else None
