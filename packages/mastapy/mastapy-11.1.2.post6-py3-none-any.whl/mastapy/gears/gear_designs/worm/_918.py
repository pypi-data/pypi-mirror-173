...
from mastapy.gears.gear_designs.worm import _919
...
class WormDesign(_919.WormGearDesign):
    '''WormDesign
    ...
    @property
    def addendum_factor(self) -> '_321.WormAddendumFactor':
        ...
        return constructor.new(_321.WormAddendumFactor)(value) if value is not None else None

    @addendum_factor.setter
    def addendum_factor(self, value: '_321.WormAddendumFactor'):
