...
from mastapy.gears.gear_designs.worm import _888, _889
...
class WormGearSetDesign(_881.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def worm_type(self) -> '_313.WormType':
        '''WormType: 'WormType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.WormType)
        return constructor.new(_313.WormType)(value) if value else None

    @worm_type.setter
    def worm_type(self, value: '_313.WormType'):
    ...
    @property
    def gears(self) -> 'List[_888.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_888.WormGearDesign))
        return value

    @property
    def worm_gears(self) -> 'List[_888.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_888.WormGearDesign))
        return value

    @property
    def worm_meshes(self) -> 'List[_889.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_889.WormGearMeshDesign))
        return value
