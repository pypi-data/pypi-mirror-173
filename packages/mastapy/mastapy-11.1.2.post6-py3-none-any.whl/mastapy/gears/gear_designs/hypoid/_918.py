...
from mastapy.gears.gear_designs.hypoid import _916, _917
...
class HypoidGearSetDesign(_1108.AGMAGleasonConicalGearSetDesign):
    ...
    @property
    def gears(self) -> 'List[_916.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_916.HypoidGearDesign))
        return value
    ...
    @property
    def meshes(self) -> 'List[_917.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_917.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_917.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_917.HypoidGearMeshDesign))
        return value
