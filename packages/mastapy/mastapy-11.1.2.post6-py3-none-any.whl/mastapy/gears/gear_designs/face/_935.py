...
class FaceGearSetDesign(_890.GearSetDesign):
    ...
    def pinion(self) -> '_934.FaceGearPinionDesign':
        ...
        return constructor.new(_934.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion is not None else None
    ...
    def face_gear(self) -> '_937.FaceGearWheelDesign':
        ...
        return constructor.new(_937.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear is not None else None
    ...
    def cylindrical_gear_set_micro_geometry(self) -> '_936.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_936.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry is not None else None
