...
from mastapy.gears.gear_designs.face import _921, _920
...
class FaceGearWheelDesign(_920.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_921.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_921.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_921.FaceGearDiameterFaceWidthSpecificationMethod'):
