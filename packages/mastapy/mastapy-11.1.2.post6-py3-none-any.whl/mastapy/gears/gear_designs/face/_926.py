...
class FaceGearSetDesign(_881.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_925.FaceGearPinionDesign':
        ...
        return constructor.new(_925.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_928.FaceGearWheelDesign':
        ...
        return constructor.new(_928.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_927.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_927.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_920.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_920.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_920.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_920.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_922.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_922.FaceGearMeshDesign))
        return value
