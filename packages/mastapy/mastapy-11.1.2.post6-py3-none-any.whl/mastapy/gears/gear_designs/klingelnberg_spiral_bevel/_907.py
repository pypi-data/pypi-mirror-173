...
from mastapy.gears.gear_designs.klingelnberg_conical import _915
...
class KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign(_915.KlingelnbergConicalMeshedGearDesign):
    '''KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign
