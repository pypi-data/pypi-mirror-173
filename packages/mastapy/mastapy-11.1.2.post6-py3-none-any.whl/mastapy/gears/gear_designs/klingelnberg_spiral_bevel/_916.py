...
from mastapy.gears.gear_designs.klingelnberg_conical import _924
...
class KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign(_924.KlingelnbergConicalMeshedGearDesign):
    '''KlingelnbergCycloPalloidSpiralBevelMeshedGearDesign
