...
class KimosBevelHypoidSingleLoadCaseResultsData(_0.APIBase):
    ...
    @property
    def single_rotation_angle_results(self) -> 'List[_1080.KimosBevelHypoidSingleRotationAngleResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SingleRotationAngleResults, constructor.new(_1080.KimosBevelHypoidSingleRotationAngleResult))
        return value
