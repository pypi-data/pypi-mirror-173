...
from mastapy.gears.manufacturing.bevel import _744
...
class ConicalGearDesign(_878.GearDesign):
    '''ConicalGearDesign
    ...
    @property
    def flank_measurement_border(self) -> '_744.FlankMeasurementBorder':
        ...
        return constructor.new(_744.FlankMeasurementBorder)(self.wrapped.FlankMeasurementBorder) if self.wrapped.FlankMeasurementBorder else None
