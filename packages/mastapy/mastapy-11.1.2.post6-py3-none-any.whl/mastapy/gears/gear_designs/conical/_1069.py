...
class ConicalGearSetDesign(_881.GearSetDesign):
    '''ConicalGearSetDesign
    ...
    @property
    def conical_meshes(self) -> 'List[_1068.ConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_1068.ConicalGearMeshDesign))
        return value
