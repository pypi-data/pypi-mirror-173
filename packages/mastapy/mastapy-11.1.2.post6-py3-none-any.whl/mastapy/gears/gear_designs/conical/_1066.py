...
class ConicalGearCutter(_0.APIBase):
    ...
    @property
    def cutter_gauge_length(self) -> '_1075.CutterGaugeLengths':
        ...
        return constructor.new(_1075.CutterGaugeLengths)(value) if value else None

    @cutter_gauge_length.setter
    def cutter_gauge_length(self, value: '_1075.CutterGaugeLengths'):
    ...
    @property
    def cutter_blade_type(self) -> '_1074.CutterBladeType':
        ...
        return constructor.new(_1074.CutterBladeType)(value) if value else None

    @cutter_blade_type.setter
    def cutter_blade_type(self, value: '_1074.CutterBladeType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CutterBladeType = value

    @property
    def input_toprem_as(self) -> '_1083.TopremEntryType':
        ...
        return constructor.new(_1083.TopremEntryType)(value) if value else None

    @input_toprem_as.setter
    def input_toprem_as(self, value: '_1083.TopremEntryType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.InputTopremAs = value

    @property
    def outer_toprem_letter_concave(self) -> '_1084.TopremLetter':
        ...
        return constructor.new(_1084.TopremLetter)(value) if value else None

    @outer_toprem_letter_concave.setter
    def outer_toprem_letter_concave(self, value: '_1084.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OuterTopremLetterConcave = value

    @property
    def inner_toprem_letter_convex(self) -> '_1084.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_1084.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
