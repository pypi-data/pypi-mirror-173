...
from mastapy.gears.gear_designs.zerol_bevel import _883, _884
...
class ZerolBevelGearSetDesign(_1095.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def tooth_taper_zerol(self) -> '_314.ZerolBevelGleasonToothTaperOption':
        ...
        return constructor.new(_314.ZerolBevelGleasonToothTaperOption)(value) if value else None

    @tooth_taper_zerol.setter
    def tooth_taper_zerol(self, value: '_314.ZerolBevelGleasonToothTaperOption'):
    ...
    @property
    def gears(self) -> 'List[_883.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_883.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_gears(self) -> 'List[_883.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGears, constructor.new(_883.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_meshes(self) -> 'List[_884.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_884.ZerolBevelGearMeshDesign))
        return value
