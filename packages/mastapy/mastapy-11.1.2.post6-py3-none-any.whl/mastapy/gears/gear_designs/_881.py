...
class GearSetDesign(_879.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def transmission_properties_gears(self) -> '_290.GearSetDesignGroup':
        ...
        return constructor.new(_290.GearSetDesignGroup)(self.wrapped.TransmissionPropertiesGears) if self.wrapped.TransmissionPropertiesGears else None

    @property
    def active_ltcafe_model(self) -> '_1113.GearSetFEModel':
        ...
        if _1113.GearSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def active_ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1116.CylindricalGearSetFEModel':
        ...
        if _1116.CylindricalGearSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def active_ltcafe_model_of_type_conical_set_fe_model(self) -> '_1119.ConicalSetFEModel':
        ...
        if _1119.ConicalSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model(self) -> '_1113.GearSetFEModel':
        ...
        if _1113.GearSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1116.CylindricalGearSetFEModel':
        ...
        if _1116.CylindricalGearSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_set_fe_model(self) -> '_1119.ConicalSetFEModel':
        ...
        if _1119.ConicalSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def gears(self) -> 'List[_878.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_878.GearDesign))
        return value

    @property
    def ltcafe_models(self) -> 'List[_1113.GearSetFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LTCAFEModels, constructor.new(_1113.GearSetFEModel))
        return value
