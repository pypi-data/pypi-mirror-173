...
from mastapy.gears.gear_designs.concept import _1130, _1128
...
class ConceptGearMeshDesign(_911.GearMeshDesign):
    '''ConceptGearMeshDesign
    ...
    @property
    def concept_gear_set(self) -> '_1130.ConceptGearSetDesign':
        ...
        return constructor.new(_1130.ConceptGearSetDesign)(self.wrapped.ConceptGearSet) if self.wrapped.ConceptGearSet is not None else None

    @property
    def concept_gears(self) -> 'List[_1128.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_1128.ConceptGearDesign))
        return value
