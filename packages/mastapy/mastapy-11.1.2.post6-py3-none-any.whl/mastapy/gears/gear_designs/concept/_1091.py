...
from mastapy.gears.gear_designs.concept import _1089, _1090
...
class ConceptGearSetDesign(_881.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_1089.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_1089.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_1089.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_1089.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_1090.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1090.ConceptGearMeshDesign))
        return value
