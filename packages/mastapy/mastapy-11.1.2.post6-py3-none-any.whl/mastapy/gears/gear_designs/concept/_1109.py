...
from mastapy.gears.gear_designs.concept import _1107, _1108
...
class ConceptGearSetDesign(_890.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_1107.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_1107.ConceptGearDesign))
        return value
    ...
    @property
    def concept_meshes(self) -> 'List[_1108.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1108.ConceptGearMeshDesign))
        return value
