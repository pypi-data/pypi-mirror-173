...
class GearDesign(_879.GearDesignComponent):
    '''GearDesign
    ...
    @property
    def tifffe_model(self) -> '_1110.GearFEModel':
        ...
        if _1110.GearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_fe_model(self) -> '_1114.CylindricalGearFEModel':
        ...
        if _1114.CylindricalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_gear_fe_model(self) -> '_1117.ConicalGearFEModel':
        ...
        if _1117.ConicalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
