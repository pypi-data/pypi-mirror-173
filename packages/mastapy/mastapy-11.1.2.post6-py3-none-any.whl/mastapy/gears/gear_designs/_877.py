...
class DesignConstraintsCollection(_1558.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1564.DeletableCollectionMember[_875.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1564.DeletableCollectionMember)[_875.DesignConstraint])
        return value
