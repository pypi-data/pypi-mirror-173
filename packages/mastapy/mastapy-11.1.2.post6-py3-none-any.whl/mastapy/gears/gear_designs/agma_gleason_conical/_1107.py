...
from mastapy.gears.gear_designs.conical import _1082, _1068
...
class AGMAGleasonConicalGearMeshDesign(_1068.ConicalGearMeshDesign):
    '''AGMAGleasonConicalGearMeshDesign
    ...
    @property
    def profile_crowning_setting(self) -> '_398.ProfileCrowningSetting':
        ...
        return constructor.new(_398.ProfileCrowningSetting)(value) if value else None

    @profile_crowning_setting.setter
    def profile_crowning_setting(self, value: '_398.ProfileCrowningSetting'):
    ...
    @property
    def mounting_conditions_of_pinion_and_wheel(self) -> '_396.MountingConditionsOfPinionAndWheel':
        ...
        return constructor.new(_396.MountingConditionsOfPinionAndWheel)(value) if value else None

    @mounting_conditions_of_pinion_and_wheel.setter
    def mounting_conditions_of_pinion_and_wheel(self, value: '_396.MountingConditionsOfPinionAndWheel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MountingConditionsOfPinionAndWheel = value

    @property
    def verification_of_contact_pattern(self) -> '_399.VerificationOfContactPattern':
        ...
        return constructor.new(_399.VerificationOfContactPattern)(value) if value else None

    @verification_of_contact_pattern.setter
    def verification_of_contact_pattern(self, value: '_399.VerificationOfContactPattern'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.VerificationOfContactPattern = value

    @property
    def iso10300_gear_set_finishing_methods(self) -> '_383.Iso10300FinishingMethods':
        ...
        return constructor.new(_383.Iso10300FinishingMethods)(value) if value else None

    @iso10300_gear_set_finishing_methods.setter
    def iso10300_gear_set_finishing_methods(self, value: '_383.Iso10300FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
