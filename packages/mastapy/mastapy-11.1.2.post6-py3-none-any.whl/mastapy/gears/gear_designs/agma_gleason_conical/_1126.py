...
class AGMAGleasonConicalGearSetDesign(_1087.ConicalGearSetDesign):
    ...
    def tooth_taper(self) -> '_313.SpiralBevelToothTaper':
        ...
        return constructor.new(_313.SpiralBevelToothTaper)(value) if value is not None else None
    ...
    def reliability_requirement_gleason(self) -> '_1096.GleasonSafetyRequirements':
        ...
        return constructor.new(_1096.GleasonSafetyRequirements)(value) if value is not None else None
    ...
    def manufacturing_method(self) -> '_272.CutterMethod':
        ...
        return constructor.new(_272.CutterMethod)(value) if value is not None else None
