...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1065, _1069, _1074
...
class AGMAGleasonConicalGearDesign(_1083.ConicalGearDesign):
    ...
    @property
    def cutter(self) -> '_1082.ConicalGearCutter':
        ...
        if _1082.ConicalGearCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_pinion_finish_cutter(self) -> '_765.PinionFinishCutter':
        ...
        if _765.PinionFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_pinion_rough_cutter(self) -> '_766.PinionRoughCutter':
        ...
        if _766.PinionRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_wheel_finish_cutter(self) -> '_767.WheelFinishCutter':
        ...
        if _767.WheelFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_wheel_rough_cutter(self) -> '_768.WheelRoughCutter':
        ...
        if _768.WheelRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_cylindrical_accuracy_grades(self) -> '_1069.CylindricalAccuracyGrades':
    ...
    @property
    def accuracy_grades_of_type_agma_gleason_conical_accuracy_grades(self) -> '_1121.AGMAGleasonConicalAccuracyGrades':
        ...
        if _1121.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def bevel_gear_material(self) -> '_546.GearMaterial':
        ...
        if _546.GearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_agma_cylindrical_gear_material(self) -> '_535.AGMACylindricalGearMaterial':
        ...
        if _535.AGMACylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_bevel_gear_iso_material(self) -> '_537.BevelGearISOMaterial':
        ...
        if _537.BevelGearISOMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_bevel_gear_material(self) -> '_539.BevelGearMaterial':
        ...
        if _539.BevelGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_cylindrical_gear_material(self) -> '_543.CylindricalGearMaterial':
        ...
        if _543.CylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_iso_cylindrical_gear_material(self) -> '_549.ISOCylindricalGearMaterial':
        ...
        if _549.ISOCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_553.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        if _553.KlingelnbergCycloPalloidConicalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
    ...
    @property
    def bevel_gear_material_of_type_plastic_cylindrical_gear_material(self) -> '_555.PlasticCylindricalGearMaterial':
        ...
        if _555.PlasticCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
