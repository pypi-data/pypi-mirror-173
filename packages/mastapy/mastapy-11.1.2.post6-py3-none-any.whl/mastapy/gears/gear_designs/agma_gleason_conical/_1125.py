...
class AGMAGleasonConicalGearMeshDesign(_1086.ConicalGearMeshDesign):
    ...
    def profile_crowning_setting(self) -> '_401.ProfileCrowningSetting':
        ...
        return constructor.new(_401.ProfileCrowningSetting)(value) if value is not None else None
    ...
    def mounting_conditions_of_pinion_and_wheel(self) -> '_399.MountingConditionsOfPinionAndWheel':
        ...
        return constructor.new(_399.MountingConditionsOfPinionAndWheel)(value) if value is not None else None
    ...
    def verification_of_contact_pattern(self) -> '_402.VerificationOfContactPattern':
        ...
        return constructor.new(_402.VerificationOfContactPattern)(value) if value is not None else None
    ...
    def iso10300_gear_set_finishing_methods(self) -> '_386.Iso10300FinishingMethods':
        ...
        return constructor.new(_386.Iso10300FinishingMethods)(value) if value is not None else None
