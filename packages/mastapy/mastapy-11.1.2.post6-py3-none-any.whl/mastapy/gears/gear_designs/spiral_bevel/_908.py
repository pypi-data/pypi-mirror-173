...
from mastapy.gears.gear_designs.spiral_bevel import _909, _907, _910
...
class SpiralBevelGearMeshDesign(_1110.BevelGearMeshDesign):
    '''SpiralBevelGearMeshDesign
    ...
    @property
    def spiral_bevel_meshed_gears(self) -> 'List[_910.SpiralBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshedGears, constructor.new(_910.SpiralBevelMeshedGearDesign))
        return value
