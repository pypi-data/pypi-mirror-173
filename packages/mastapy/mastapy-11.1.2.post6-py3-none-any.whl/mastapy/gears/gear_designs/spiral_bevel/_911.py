...
from mastapy.gears.gear_designs.spiral_bevel import _909, _910
...
class SpiralBevelGearSetDesign(_1113.BevelGearSetDesign):
    '''SpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_909.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_909.SpiralBevelGearDesign))
        return value
    ...
    @property
    def spiral_bevel_meshes(self) -> 'List[_910.SpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshes, constructor.new(_910.SpiralBevelGearMeshDesign))
        return value
