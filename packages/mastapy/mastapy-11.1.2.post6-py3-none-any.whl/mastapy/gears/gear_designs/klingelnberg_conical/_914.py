...
from mastapy.gears.gear_designs.conical import _1081, _1069
...
class KlingelnbergConicalGearSetDesign(_1069.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_1081.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_1081.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_1081.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_913.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_913.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_913.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_913.KlingelnbergConicalGearMeshDesign))
        return value
