...
from mastapy.gears.materials import _566
...
class KlingelnbergConicalGearDesign(_1106.ConicalGearDesign):
    '''KlingelnbergConicalGearDesign
    ...
    @property
    def klingelnberg_cyclo_palloid_gear_material(self) -> '_566.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_566.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.KlingelnbergCycloPalloidGearMaterial) if self.wrapped.KlingelnbergCycloPalloidGearMaterial is not None else None
