...
class KlingelnbergConicalGearDesign(_1083.ConicalGearDesign):
    '''KlingelnbergConicalGearDesign
    ...
    @property
    def klingelnberg_cyclo_palloid_gear_material(self) -> '_553.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_553.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.KlingelnbergCycloPalloidGearMaterial) if self.wrapped.KlingelnbergCycloPalloidGearMaterial else None
