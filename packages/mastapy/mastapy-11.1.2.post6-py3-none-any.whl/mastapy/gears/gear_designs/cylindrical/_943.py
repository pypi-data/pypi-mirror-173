...
from mastapy.geometry.two_d import _274
from mastapy.gears import _295, _276
from mastapy._internal.python_net import python_net_import
from mastapy.gears.gear_designs.cylindrical import (
    _983, _982, _984, _985,
    _1005, _957, _968, _949,
    _932, _1007, _973, _1011,
    _994, _972, _941, _950
)
...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import (
    _1054, _1058, _1049, _1051,
    _1047, _1048, _1050, _1052,
    _1055, _1056, _1057, _1053
)
...
class CylindricalGearDesign(_878.GearDesign):
    '''CylindricalGearDesign
    ...
    @property
    def internal_external(self) -> '_274.InternalExternalType':
        ...
        return constructor.new(_274.InternalExternalType)(value) if value else None

    @internal_external.setter
    def internal_external(self, value: '_274.InternalExternalType'):
    ...
    @property
    def iso6336_geometry(self) -> '_983.ISO6336GeometryBase':
        ...
        if _983.ISO6336GeometryBase.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
    ...
    @property
    def iso6336_geometry_of_type_iso6336_geometry(self) -> '_982.ISO6336Geometry':
        ...
        if _982.ISO6336Geometry.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
    ...
    @property
    def iso6336_geometry_of_type_iso6336_geometry_for_shaped_gears(self) -> '_984.ISO6336GeometryForShapedGears':
        ...
        if _984.ISO6336GeometryForShapedGears.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
    ...
    @property
    def iso6336_geometry_of_type_iso6336_geometry_manufactured(self) -> '_985.ISO6336GeometryManufactured':
        ...
        if _985.ISO6336GeometryManufactured.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
    ...
    @property
    def surface_roughness(self) -> '_1005.SurfaceRoughness':
        ...
        return constructor.new(_1005.SurfaceRoughness)(self.wrapped.SurfaceRoughness) if self.wrapped.SurfaceRoughness else None

    @property
    def cylindrical_gear_set(self) -> '_957.CylindricalGearSetDesign':
        ...
        if _957.CylindricalGearSetDesign.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
    ...
    @property
    def left_flank(self) -> '_949.CylindricalGearFlankDesign':
        ...
        return constructor.new(_949.CylindricalGearFlankDesign)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_949.CylindricalGearFlankDesign':
        ...
        return constructor.new(_949.CylindricalGearFlankDesign)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None
    ...
    @property
    def cylindrical_gear_manufacturing_configuration(self) -> '_560.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_560.CylindricalGearManufacturingConfig)(self.wrapped.CylindricalGearManufacturingConfiguration) if self.wrapped.CylindricalGearManufacturingConfiguration else None

    @property
    def material(self) -> '_542.GearMaterial':
        ...
        if _542.GearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def material_of_type_agma_cylindrical_gear_material(self) -> '_531.AGMACylindricalGearMaterial':
        ...
        if _531.AGMACylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def material_of_type_bevel_gear_iso_material(self) -> '_533.BevelGearISOMaterial':
        ...
        if _533.BevelGearISOMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def material_of_type_bevel_gear_material(self) -> '_535.BevelGearMaterial':
        ...
        if _535.BevelGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def material_of_type_cylindrical_gear_material(self) -> '_539.CylindricalGearMaterial':
        ...
        if _539.CylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def material_of_type_iso_cylindrical_gear_material(self) -> '_545.ISOCylindricalGearMaterial':
        ...
        if _545.ISOCylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_549.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        if _549.KlingelnbergCycloPalloidConicalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def material_of_type_plastic_cylindrical_gear_material(self) -> '_551.PlasticCylindricalGearMaterial':
        ...
        if _551.PlasticCylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def system_of_gear_fits(self) -> '_1054.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_1054.DIN3967SystemOfGearFits)(self.wrapped.SystemOfGearFits) if self.wrapped.SystemOfGearFits else None
    ...
    @property
    def agma_accuracy_grade(self) -> '_1049.AGMA20151AccuracyGrades':
        ...
        return constructor.new(_1049.AGMA20151AccuracyGrades)(self.wrapped.AGMAAccuracyGrade) if self.wrapped.AGMAAccuracyGrade else None

    @property
    def accuracy_grade_allowances_and_tolerances(self) -> '_1051.CylindricalAccuracyGrader':
        ...
        if _1051.CylindricalAccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma2000_accuracy_grader(self) -> '_1047.AGMA2000AccuracyGrader':
        ...
        if _1047.AGMA2000AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma20151_accuracy_grader(self) -> '_1048.AGMA20151AccuracyGrader':
        ...
        if _1048.AGMA20151AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agmaiso13282013_accuracy_grader(self) -> '_1050.AGMAISO13282013AccuracyGrader':
        ...
        if _1050.AGMAISO13282013AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_cylindrical_accuracy_grader_with_profile_form_and_slope(self) -> '_1052.CylindricalAccuracyGraderWithProfileFormAndSlope':
        ...
        if _1052.CylindricalAccuracyGraderWithProfileFormAndSlope.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso13282013_accuracy_grader(self) -> '_1055.ISO13282013AccuracyGrader':
        ...
        if _1055.ISO13282013AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso1328_accuracy_grader(self) -> '_1056.ISO1328AccuracyGrader':
        ...
        if _1056.ISO1328AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso1328_accuracy_grader_common(self) -> '_1057.ISO1328AccuracyGraderCommon':
        ...
        if _1057.ISO1328AccuracyGraderCommon.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grades_specified_accuracy(self) -> '_276.AccuracyGrades':
        ...
        if _276.AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_agma20151_accuracy_grades(self) -> '_1049.AGMA20151AccuracyGrades':
        ...
        if _1049.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_cylindrical_accuracy_grades(self) -> '_1053.CylindricalAccuracyGrades':
        ...
        if _1053.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
    ...
    def accuracy_grades_specified_accuracy_of_type_iso1328_accuracy_grades(self) -> '_1058.ISO1328AccuracyGrades':
        ...
        if _1058.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_agma_gleason_conical_accuracy_grades(self) -> '_1105.AGMAGleasonConicalAccuracyGrades':
        ...
        if _1105.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
    ...
    @property
    def case_hardening_properties(self) -> '_932.CaseHardeningProperties':
        ...
        return constructor.new(_932.CaseHardeningProperties)(self.wrapped.CaseHardeningProperties) if self.wrapped.CaseHardeningProperties else None

    @property
    def tiff_analysis_settings(self) -> '_1007.TiffAnalysisSettings':
        ...
        return constructor.new(_1007.TiffAnalysisSettings)(self.wrapped.TIFFAnalysisSettings) if self.wrapped.TIFFAnalysisSettings else None

    @property
    def finished_tooth_thickness_specification(self) -> '_973.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_973.FinishToothThicknessDesignSpecification)(self.wrapped.FinishedToothThicknessSpecification) if self.wrapped.FinishedToothThicknessSpecification else None

    @property
    def rough_tooth_thickness_specification(self) -> '_1011.ToothThicknessSpecification':
        ...
        if _1011.ToothThicknessSpecification.TYPE not in self.wrapped.RoughToothThicknessSpecification.__class__.__mro__:
    ...
    @property
    def finish_stock_specification(self) -> '_972.FinishStockSpecification':
        ...
        return constructor.new(_972.FinishStockSpecification)(self.wrapped.FinishStockSpecification) if self.wrapped.FinishStockSpecification else None

    @property
    def cylindrical_gear_cutting_options(self) -> '_941.CylindricalGearCuttingOptions':
        ...
        return constructor.new(_941.CylindricalGearCuttingOptions)(self.wrapped.CylindricalGearCuttingOptions) if self.wrapped.CylindricalGearCuttingOptions else None

    @property
    def cylindrical_meshes(self) -> 'List[_950.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_950.CylindricalGearMeshDesign))
        return value

    @property
    def flanks(self) -> 'List[_949.CylindricalGearFlankDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_949.CylindricalGearFlankDesign))
        return value

    @property
    def both_flanks(self) -> '_949.CylindricalGearFlankDesign':
        ...
        return constructor.new(_949.CylindricalGearFlankDesign)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks else None

    @property
    def micro_geometries(self) -> 'List[_1024.CylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometries, constructor.new(_1024.CylindricalGearMicroGeometry))
        return value

    @property
    def manufacturing_configurations(self) -> 'List[_560.CylindricalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturingConfigurations, constructor.new(_560.CylindricalGearManufacturingConfig))
        return value
