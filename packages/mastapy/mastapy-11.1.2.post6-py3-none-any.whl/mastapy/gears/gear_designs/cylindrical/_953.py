...
from mastapy.gears.gear_designs.cylindrical import _952, _938
...
class CylindricalGearPinionTypeCutterFlank(_938.CylindricalGearAbstractRackFlank):
    '''CylindricalGearPinionTypeCutterFlank
    ...
    @property
    def cutter(self) -> '_952.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_952.CylindricalGearPinionTypeCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
