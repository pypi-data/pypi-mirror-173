...
class CylindricalMeshedGear(_0.APIBase):
    ...
    @property
    def left_flank(self) -> '_999.CylindricalMeshedGearFlank':
    ...
    @property
    def right_flank(self) -> '_999.CylindricalMeshedGearFlank':
    ...
    @property
    def flanks(self) -> 'List[_999.CylindricalMeshedGearFlank]':
    ...
    @property
    def both_flanks(self) -> '_999.CylindricalMeshedGearFlank':
