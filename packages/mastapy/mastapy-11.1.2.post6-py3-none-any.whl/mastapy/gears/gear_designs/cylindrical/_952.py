...
from mastapy.gears.gear_designs.cylindrical import _953, _937
...
class CylindricalGearPinionTypeCutter(_937.CylindricalGearAbstractRack):
    '''CylindricalGearPinionTypeCutter
    ...
    @property
    def left_flank(self) -> '_953.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_953.CylindricalGearPinionTypeCutterFlank)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_953.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_953.CylindricalGearPinionTypeCutterFlank)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None
