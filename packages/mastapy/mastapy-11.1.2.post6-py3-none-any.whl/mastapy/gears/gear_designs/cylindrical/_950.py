...
from mastapy.gears.gear_designs.cylindrical import (
    _956, _1013, _957, _968,
    _951, _930, _943, _965,
    _969
)
from mastapy._internal.implicit import enum_with_selected_value, overridable
from mastapy.gears import _297, _280
...
class CylindricalGearMeshDesign(_880.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self) -> '_956.CylindricalGearProfileModifications':
        ...
        return constructor.new(_956.CylindricalGearProfileModifications)(value) if value else None

    @profile_modification.setter
    def profile_modification(self, value: '_956.CylindricalGearProfileModifications'):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_1013.TypeOfMechanismHousing':
        ...
        return constructor.new(_1013.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_1013.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def centre_distance_change_method(self) -> '_280.CentreDistanceChangeMethod':
        ...
        return constructor.new(_280.CentreDistanceChangeMethod)(value) if value else None

    @centre_distance_change_method.setter
    def centre_distance_change_method(self, value: '_280.CentreDistanceChangeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def left_flank(self) -> '_951.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_951.CylindricalGearMeshFlankDesign)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_951.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_951.CylindricalGearMeshFlankDesign)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def backlash_specification(self) -> '_930.BacklashSpecification':
        ...
        return constructor.new(_930.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification else None
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_965.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_965.CylindricalMeshedGear))
        return value

    @property
    def flanks(self) -> 'List[_951.CylindricalGearMeshFlankDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_951.CylindricalGearMeshFlankDesign))
        return value

    @property
    def gear_a(self) -> '_943.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_943.CylindricalGearDesign':
    ...
    @property
    def both_flanks(self) -> '_951.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_951.CylindricalGearMeshFlankDesign)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks else None
