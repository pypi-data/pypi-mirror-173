...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    @property
    def cylindrical_gear_cutter(self) -> '_937.CylindricalGearAbstractRack':
        ...
        if _937.CylindricalGearAbstractRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_basic_rack(self) -> '_939.CylindricalGearBasicRack':
        ...
        if _939.CylindricalGearBasicRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_952.CylindricalGearPinionTypeCutter':
        ...
        if _952.CylindricalGearPinionTypeCutter.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_standard_rack(self) -> '_1003.StandardRack':
        ...
        if _1003.StandardRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_960.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_960.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection else None

    @property
    def manufacturing_configuration(self) -> '_560.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_560.CylindricalGearManufacturingConfig)(self.wrapped.ManufacturingConfiguration) if self.wrapped.ManufacturingConfiguration else None
