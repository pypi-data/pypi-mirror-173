...
from mastapy.utility.model_validation import _1528
...
class CylindricalGearDesignConstraint(_0.APIBase):
    ...
    @property
    def range(self) -> '_1253.Range':
        '''Range: 'Range' is the original name of this property.'''

        if _1253.Range.TYPE not in self.wrapped.Range.__class__.__mro__:
    ...
    @range.setter
    def range(self, value: '_1253.Range'):
        value = value.wrapped if value else None
        self.wrapped.Range = value

    @property
    def integer_range(self) -> '_1348.IntegerRange':
        '''IntegerRange: 'IntegerRange' is the original name of this property.'''

        return constructor.new(_1348.IntegerRange)(self.wrapped.IntegerRange) if self.wrapped.IntegerRange else None

    @integer_range.setter
    def integer_range(self, value: '_1348.IntegerRange'):
        value = value.wrapped if value else None
