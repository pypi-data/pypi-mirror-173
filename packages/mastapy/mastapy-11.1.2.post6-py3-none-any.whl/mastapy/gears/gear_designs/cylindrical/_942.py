...
class CylindricalGearDefaults(_1351.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    @property
    def finish_stock_type(self) -> '_1015.FinishStockType':
    ...
    def finish_stock_type(self, value: '_1015.FinishStockType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FinishStockType = value

    @property
    def system_of_fits_defaults(self) -> '_1054.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_1054.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults else None

    @property
    def rough_cutter_creation_settings(self) -> '_688.RoughCutterCreationSettings':
        ...
        return constructor.new(_688.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings else None
