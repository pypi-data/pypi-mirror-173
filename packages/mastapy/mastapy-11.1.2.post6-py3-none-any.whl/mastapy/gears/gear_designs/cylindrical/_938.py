...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    @property
    def cutter(self) -> '_937.CylindricalGearAbstractRack':
        ...
        if _937.CylindricalGearAbstractRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_cylindrical_gear_basic_rack(self) -> '_939.CylindricalGearBasicRack':
        ...
        if _939.CylindricalGearBasicRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_952.CylindricalGearPinionTypeCutter':
        ...
        if _952.CylindricalGearPinionTypeCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_standard_rack(self) -> '_1003.StandardRack':
        ...
        if _1003.StandardRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
