...
class CylindricalGearBasicRack(_937.CylindricalGearAbstractRack):
    '''CylindricalGearBasicRack
    ...
    @property
    def basic_rack_profile(self) -> '_931.BasicRackProfiles':
        ...
        return constructor.new(_931.BasicRackProfiles)(value) if value else None

    @basic_rack_profile.setter
    def basic_rack_profile(self, value: '_931.BasicRackProfiles'):
    ...
    @property
    def proportional_method_for_tip_clearance(self) -> '_1008.TipAlterationCoefficientMethod':
        ...
        return constructor.new(_1008.TipAlterationCoefficientMethod)(value) if value else None

    @proportional_method_for_tip_clearance.setter
    def proportional_method_for_tip_clearance(self, value: '_1008.TipAlterationCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def pinion_type_cutter_for_rating(self) -> '_952.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_952.CylindricalGearPinionTypeCutter)(self.wrapped.PinionTypeCutterForRating) if self.wrapped.PinionTypeCutterForRating else None
