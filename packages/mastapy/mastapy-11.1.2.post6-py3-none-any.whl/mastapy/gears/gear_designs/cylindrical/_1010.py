...
from mastapy.gears.gear_designs.cylindrical import _965, _1009
...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    @property
    def create_new_suitable_cutters(self) -> '_965.CreateNewSuitableCutterOption':
        ...
        return constructor.new_from_mastapy_type(_965.CreateNewSuitableCutterOption)(value) if value is not None else None

    @create_new_suitable_cutters.setter
    def create_new_suitable_cutters(self, value: '_965.CreateNewSuitableCutterOption'):
    ...
    @property
    def use_as_design_mode_geometry(self) -> '_965.CreateNewSuitableCutterOption':
    ...
    def use_as_design_mode_geometry(self, value: '_965.CreateNewSuitableCutterOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.UseAsDesignModeGeometry = value

    @property
    def gears(self) -> 'List[_1009.GearManufacturingConfigSetupViewModel]':
