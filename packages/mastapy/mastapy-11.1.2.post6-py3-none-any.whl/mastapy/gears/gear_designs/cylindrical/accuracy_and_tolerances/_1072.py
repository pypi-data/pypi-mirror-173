...
class DIN3967SystemOfGearFits(_0.APIBase):
    ...
    def tooth_thickness_reduction_allowance(self) -> '_980.DIN3967AllowanceSeries':
        ...
        return constructor.new(_980.DIN3967AllowanceSeries)(value) if value is not None else None
    ...
    def tooth_thickness_tolerance(self) -> '_981.DIN3967ToleranceSeries':
        ...
        return constructor.new(_981.DIN3967ToleranceSeries)(value) if value is not None else None
