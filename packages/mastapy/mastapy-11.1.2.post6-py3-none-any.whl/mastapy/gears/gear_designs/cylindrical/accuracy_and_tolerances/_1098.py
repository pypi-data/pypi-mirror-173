...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1093
...
class ISO1328AccuracyGraderCommon(_1093.CylindricalAccuracyGraderWithProfileFormAndSlope):
    """ISO1328AccuracyGraderCommon
