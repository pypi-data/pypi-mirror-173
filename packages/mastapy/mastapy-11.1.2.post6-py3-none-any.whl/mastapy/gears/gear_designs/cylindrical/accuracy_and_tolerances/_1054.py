...
from mastapy.gears.gear_designs.cylindrical import _970, _971
...
class DIN3967SystemOfGearFits(_0.APIBase):
    ...
    @property
    def tooth_thickness_reduction_allowance(self) -> '_970.DIN3967AllowanceSeries':
        ...
        return constructor.new(_970.DIN3967AllowanceSeries)(value) if value else None

    @tooth_thickness_reduction_allowance.setter
    def tooth_thickness_reduction_allowance(self, value: '_970.DIN3967AllowanceSeries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ToothThicknessReductionAllowance = value

    @property
    def tooth_thickness_tolerance(self) -> '_971.DIN3967ToleranceSeries':
        ...
        return constructor.new(_971.DIN3967ToleranceSeries)(value) if value else None

    @tooth_thickness_tolerance.setter
    def tooth_thickness_tolerance(self, value: '_971.DIN3967ToleranceSeries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
