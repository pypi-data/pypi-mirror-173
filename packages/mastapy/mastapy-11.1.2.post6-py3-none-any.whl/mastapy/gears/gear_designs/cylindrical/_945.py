...
class CylindricalGearDesignConstraints(_1558.NamedDatabaseItem):
    '''CylindricalGearDesignConstraints
    ...
    @property
    def design_constraints(self) -> 'List[_944.CylindricalGearDesignConstraint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_944.CylindricalGearDesignConstraint))
        return value
