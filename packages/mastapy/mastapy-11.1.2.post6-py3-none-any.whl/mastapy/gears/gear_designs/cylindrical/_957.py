...
from mastapy.materials.efficiency import _259
...
class CylindricalGearSetDesign(_881.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_929.AddendumModificationDistributionRule':
        ...
        return constructor.new(_929.AddendumModificationDistributionRule)(value) if value else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_929.AddendumModificationDistributionRule'):
    ...
    @property
    def efficiency_rating_method(self) -> '_259.EfficiencyRatingMethod':
        ...
        return constructor.new(_259.EfficiencyRatingMethod)(value) if value else None

    @efficiency_rating_method.setter
    def efficiency_rating_method(self, value: '_259.EfficiencyRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.EfficiencyRatingMethod = value

    @property
    def helical_gear_micro_geometry_option(self) -> '_466.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_466.HelicalGearMicroGeometryOption)(value) if value else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_466.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HelicalGearMicroGeometryOption = value

    @property
    def gear_fit_system(self) -> '_974.GearFitSystems':
        ...
        return constructor.new(_974.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_974.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def scuffing(self) -> '_997.Scuffing':
        ...
        return constructor.new(_997.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_991.Micropitting':
        ...
        return constructor.new(_991.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None
    ...
    @property
    def left_flank(self) -> '_958.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_958.CylindricalGearSetFlankDesign)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_958.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_958.CylindricalGearSetFlankDesign)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def ltca_settings(self) -> '_988.LtcaSettings':
        ...
        return constructor.new(_988.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None

    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_573.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_573.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration else None

    @property
    def gears(self) -> 'List[_943.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_943.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_943.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_943.CylindricalGearDesign))
        return value
    ...
    @property
    def flanks(self) -> 'List[_958.CylindricalGearSetFlankDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_958.CylindricalGearSetFlankDesign))
        return value

    @property
    def micro_geometries(self) -> 'List[_1029.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometries, constructor.new(_1029.CylindricalGearSetMicroGeometry))
        return value

    @property
    def both_flanks(self) -> '_958.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_958.CylindricalGearSetFlankDesign)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks else None

    @property
    def manufacturing_configurations(self) -> 'List[_573.CylindricalSetManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturingConfigurations, constructor.new(_573.CylindricalSetManufacturingConfig))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_423.CylindricalGearSetDutyCycleRating') -> '_959.CylindricalGearSetMacroGeometryOptimiser':
    ...
    def set_active_manufacturing_configuration(self, value: '_573.CylindricalSetManufacturingConfig'):
    ...
    def add_new_manufacturing_configuration(self, new_config_name: Optional['str'] = 'None') -> '_573.CylindricalSetManufacturingConfig':
    ...
    def delete_manufacturing_configuration(self, config: '_573.CylindricalSetManufacturingConfig'):
    ...
    def add_new_micro_geometry(self) -> '_1029.CylindricalGearSetMicroGeometry':
    ...
    def delete_micro_geometry(self, micro_geometry: '_1029.CylindricalGearSetMicroGeometry'):
    ...
    def set_active_micro_geometry(self, value: '_1029.CylindricalGearSetMicroGeometry'):
    ...
    def micro_geometry_named(self, micro_geometry_name: 'str') -> '_1029.CylindricalGearSetMicroGeometry':
