...
class CaseHardeningProperties(_0.APIBase):
    ...
    @property
    def hardness_profile_calculation_method(self) -> '_980.HardnessProfileCalculationMethod':
        ...
        return constructor.new(_980.HardnessProfileCalculationMethod)(value) if value else None

    @hardness_profile_calculation_method.setter
    def hardness_profile_calculation_method(self, value: '_980.HardnessProfileCalculationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HardnessProfileCalculationMethod = value

    @property
    def heat_treatment_type(self) -> '_981.HeatTreatmentType':
        ...
        return constructor.new(_981.HeatTreatmentType)(value) if value else None
