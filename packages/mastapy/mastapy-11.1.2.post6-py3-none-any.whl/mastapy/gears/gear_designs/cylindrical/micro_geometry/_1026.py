...
class CylindricalGearMicroGeometryMap(_0.APIBase):
    ...
    @property
    def measured_map_data_type(self) -> '_1036.MeasuredMapDataTypes':
        ...
        return constructor.new(_1036.MeasuredMapDataTypes)(value) if value else None

    @measured_map_data_type.setter
    def measured_map_data_type(self, value: '_1036.MeasuredMapDataTypes'):
