...
class ProfileReliefWithDeviation(_1044.ReliefWithDeviation):
    '''ProfileReliefWithDeviation
    ...
    @property
    def position_on_profile(self) -> '_954.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_954.CylindricalGearProfileMeasurement)(self.wrapped.PositionOnProfile) if self.wrapped.PositionOnProfile else None
