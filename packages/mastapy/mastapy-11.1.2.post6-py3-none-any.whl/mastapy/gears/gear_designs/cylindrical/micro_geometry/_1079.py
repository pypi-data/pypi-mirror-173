...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    @property
    def gear_option(self) -> '_1068.DrawDefiningGearOrBoth':
        ...
        return constructor.new_from_mastapy_type(_1068.DrawDefiningGearOrBoth)(value) if value is not None else None

    @gear_option.setter
    def gear_option(self, value: '_1068.DrawDefiningGearOrBoth'):
