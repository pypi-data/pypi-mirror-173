...
class MeshedCylindricalGearMicroGeometry(_0.APIBase):
    ...
    @property
    def flanks(self) -> 'List[_1038.MeshedCylindricalGearFlankMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_1038.MeshedCylindricalGearFlankMicroGeometry))
        return value
