...
class CylindricalGearMeshMicroGeometryDutyCycle(_1132.GearMeshDesignAnalysis):
    '''CylindricalGearMeshMicroGeometryDutyCycle
    ...
    @property
    def meshes_analysis(self) -> 'List[_794.CylindricalGearMeshLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesAnalysis, constructor.new(_794.CylindricalGearMeshLoadDistributionAnalysis))
        return value
