...
from mastapy.gears.gear_designs.cylindrical import _943, _969, _954
from mastapy._internal.cast_exception import CastException
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1019, _1039
...
class CylindricalGearMicroGeometry(_1131.GearImplementationDetail):
    '''CylindricalGearMicroGeometry
    ...
    @property
    def cylindrical_gear(self) -> '_943.CylindricalGearDesign':
        ...
        if _943.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGear.__class__.__mro__:
    ...
    @property
    def meshed_gears(self) -> 'List[_1039.MeshedCylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_1039.MeshedCylindricalGearMicroGeometry))
        return value

    @property
    def both_flanks(self) -> '_1019.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_1019.CylindricalGearFlankMicroGeometry)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks else None
