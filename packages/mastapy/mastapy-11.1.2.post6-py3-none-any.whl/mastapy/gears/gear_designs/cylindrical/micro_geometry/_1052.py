...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import (
    _1060, _1061, _1053, _1054,
    _1051, _1064, _1059, _1084,
    _1085, _1068, _1070, _1079,
    _1081
)
from mastapy._internal.cast_exception import CastException
from mastapy.gears.gear_designs.cylindrical import _986, _974, _1001
...
class CylindricalGearFlankMicroGeometry(_535.FlankMicroGeometry):
    '''CylindricalGearFlankMicroGeometry
    ...
    @property
    def micro_geometry_matrix(self) -> '_1467.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'MicroGeometryMatrix' is the original name of this property.'''

        return constructor.new(_1467.GriddedSurfaceAccessor)(self.wrapped.MicroGeometryMatrix) if self.wrapped.MicroGeometryMatrix is not None else None

    @micro_geometry_matrix.setter
    def micro_geometry_matrix(self, value: '_1467.GriddedSurfaceAccessor'):
    ...
    @property
    def profile_relief(self) -> '_1060.CylindricalGearProfileModification':
        ...
        if _1060.CylindricalGearProfileModification.TYPE not in self.wrapped.ProfileRelief.__class__.__mro__:
    ...
    @property
    def lead_relief(self) -> '_1053.CylindricalGearLeadModification':
        ...
        if _1053.CylindricalGearLeadModification.TYPE not in self.wrapped.LeadRelief.__class__.__mro__:
    ...
    @property
    def bias(self) -> '_1051.CylindricalGearBiasModification':
        ...
        return constructor.new(_1051.CylindricalGearBiasModification)(self.wrapped.Bias) if self.wrapped.Bias is not None else None

    @property
    def triangular_end_relief(self) -> '_1064.CylindricalGearTriangularEndModification':
        ...
        return constructor.new(_1064.CylindricalGearTriangularEndModification)(self.wrapped.TriangularEndRelief) if self.wrapped.TriangularEndRelief is not None else None

    @property
    def profile_control_point(self) -> '_986.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_986.CylindricalGearProfileMeasurement)(self.wrapped.ProfileControlPoint) if self.wrapped.ProfileControlPoint is not None else None

    @property
    def micro_geometry_map(self) -> '_1059.CylindricalGearMicroGeometryMap':
        ...
        return constructor.new(_1059.CylindricalGearMicroGeometryMap)(self.wrapped.MicroGeometryMap) if self.wrapped.MicroGeometryMap is not None else None

    @property
    def total_lead_relief_points(self) -> 'List[_1084.TotalLeadReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TotalLeadReliefPoints, constructor.new(_1084.TotalLeadReliefWithDeviation))
        return value

    @property
    def total_profile_relief_points(self) -> 'List[_1085.TotalProfileReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TotalProfileReliefPoints, constructor.new(_1085.TotalProfileReliefWithDeviation))
        return value

    @property
    def lead_form_deviation_points(self) -> 'List[_1068.LeadFormReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeadFormDeviationPoints, constructor.new(_1068.LeadFormReliefWithDeviation))
        return value

    @property
    def lead_slope_deviation_points(self) -> 'List[_1070.LeadSlopeReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeadSlopeDeviationPoints, constructor.new(_1070.LeadSlopeReliefWithDeviation))
        return value

    @property
    def profile_form_deviation_points(self) -> 'List[_1079.ProfileFormReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileFormDeviationPoints, constructor.new(_1079.ProfileFormReliefWithDeviation))
        return value

    @property
    def profile_slope_deviation_at_10_percent_face_width(self) -> 'List[_1081.ProfileSlopeReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileSlopeDeviationAt10PercentFaceWidth, constructor.new(_1081.ProfileSlopeReliefWithDeviation))
        return value

    @property
    def profile_slope_deviation_at_50_percent_face_width(self) -> 'List[_1081.ProfileSlopeReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileSlopeDeviationAt50PercentFaceWidth, constructor.new(_1081.ProfileSlopeReliefWithDeviation))
        return value

    @property
    def profile_slope_deviation_at_90_percent_face_width(self) -> 'List[_1081.ProfileSlopeReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileSlopeDeviationAt90PercentFaceWidth, constructor.new(_1081.ProfileSlopeReliefWithDeviation))
        return value
