...
class CylindricalGearLeadModificationAtProfilePosition(_1020.CylindricalGearLeadModification):
    ...
    @property
    def profile_measurement(self) -> '_954.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_954.CylindricalGearProfileMeasurement)(self.wrapped.ProfileMeasurement) if self.wrapped.ProfileMeasurement else None
