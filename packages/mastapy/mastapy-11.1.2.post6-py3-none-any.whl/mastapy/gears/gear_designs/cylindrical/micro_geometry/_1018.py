...
class CylindricalGearBiasModification(_518.BiasModification):
    '''CylindricalGearBiasModification
    ...
    @property
    def profile_evaluation_upper_limit(self) -> '_954.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_954.CylindricalGearProfileMeasurement)(self.wrapped.ProfileEvaluationUpperLimit) if self.wrapped.ProfileEvaluationUpperLimit else None

    @property
    def profile_evaluation_lower_limit(self) -> '_954.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_954.CylindricalGearProfileMeasurement)(self.wrapped.ProfileEvaluationLowerLimit) if self.wrapped.ProfileEvaluationLowerLimit else None

    @property
    def zero_bias_relief(self) -> '_954.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_954.CylindricalGearProfileMeasurement)(self.wrapped.ZeroBiasRelief) if self.wrapped.ZeroBiasRelief else None
