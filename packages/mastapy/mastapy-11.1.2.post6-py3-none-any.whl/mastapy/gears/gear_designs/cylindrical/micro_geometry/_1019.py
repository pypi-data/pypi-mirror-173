...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import (
    _1027, _1028, _1020, _1021,
    _1018, _1026, _1045, _1046,
    _1033, _1035, _1041, _1043
)
from mastapy._internal.cast_exception import CastException
from mastapy.gears.gear_designs.cylindrical import _954, _943, _969
...
class CylindricalGearFlankMicroGeometry(_519.FlankMicroGeometry):
    '''CylindricalGearFlankMicroGeometry
    ...
    def profile_relief(self) -> '_1027.CylindricalGearProfileModification':
        ...
        if _1027.CylindricalGearProfileModification.TYPE not in self.wrapped.ProfileRelief.__class__.__mro__:
    ...
    def lead_relief(self) -> '_1020.CylindricalGearLeadModification':
        ...
        if _1020.CylindricalGearLeadModification.TYPE not in self.wrapped.LeadRelief.__class__.__mro__:
    ...
    @property
    def profile_control_point(self) -> '_954.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_954.CylindricalGearProfileMeasurement)(self.wrapped.ProfileControlPoint) if self.wrapped.ProfileControlPoint else None
    ...
    @property
    def total_lead_relief_points(self) -> 'List[_1045.TotalLeadReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TotalLeadReliefPoints, constructor.new(_1045.TotalLeadReliefWithDeviation))
        return value

    @property
    def total_profile_relief_points(self) -> 'List[_1046.TotalProfileReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TotalProfileReliefPoints, constructor.new(_1046.TotalProfileReliefWithDeviation))
        return value
    ...
    @property
    def lead_slope_deviation_points(self) -> 'List[_1035.LeadSlopeReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeadSlopeDeviationPoints, constructor.new(_1035.LeadSlopeReliefWithDeviation))
        return value

    @property
    def profile_form_deviation_points(self) -> 'List[_1041.ProfileFormReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileFormDeviationPoints, constructor.new(_1041.ProfileFormReliefWithDeviation))
        return value

    @property
    def profile_slope_deviation_at_10_percent_face_width(self) -> 'List[_1043.ProfileSlopeReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileSlopeDeviationAt10PercentFaceWidth, constructor.new(_1043.ProfileSlopeReliefWithDeviation))
        return value

    @property
    def profile_slope_deviation_at_50_percent_face_width(self) -> 'List[_1043.ProfileSlopeReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileSlopeDeviationAt50PercentFaceWidth, constructor.new(_1043.ProfileSlopeReliefWithDeviation))
        return value

    @property
    def profile_slope_deviation_at_90_percent_face_width(self) -> 'List[_1043.ProfileSlopeReliefWithDeviation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ProfileSlopeDeviationAt90PercentFaceWidth, constructor.new(_1043.ProfileSlopeReliefWithDeviation))
        return value

    @property
    def gear_design(self) -> '_943.CylindricalGearDesign':
