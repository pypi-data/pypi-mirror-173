...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    @property
    def cutter(self) -> '_969.CylindricalGearAbstractRack':
    ...
    @property
    def cutter_of_type_cylindrical_gear_basic_rack(self) -> '_971.CylindricalGearBasicRack':
    ...
    @property
    def cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_985.CylindricalGearPinionTypeCutter':
    ...
    @property
    def cutter_of_type_standard_rack(self) -> '_1037.StandardRack':
