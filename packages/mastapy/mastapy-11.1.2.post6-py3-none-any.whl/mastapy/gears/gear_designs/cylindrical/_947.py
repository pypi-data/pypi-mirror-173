...
class CylindricalGearDesignConstraintSettings(_1351.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_945.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_945.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
