...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    @property
    def gear(self) -> '_943.CylindricalGearDesign':
        ...
        if _943.CylindricalGearDesign.TYPE not in self.wrapped.Gear.__class__.__mro__:
    ...
    @property
    def shaper_for_agma_rating(self) -> '_680.CylindricalGearShaper':
        ...
        return constructor.new(_680.CylindricalGearShaper)(self.wrapped.ShaperForAGMARating) if self.wrapped.ShaperForAGMARating else None

    @property
    def left_flank(self) -> '_938.CylindricalGearAbstractRackFlank':
        ...
        if _938.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_940.CylindricalGearBasicRackFlank':
        ...
        if _940.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_953.CylindricalGearPinionTypeCutterFlank':
        ...
        if _953.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_standard_rack_flank(self) -> '_1004.StandardRackFlank':
        ...
        if _1004.StandardRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def right_flank(self) -> '_938.CylindricalGearAbstractRackFlank':
        ...
        if _938.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_940.CylindricalGearBasicRackFlank':
        ...
        if _940.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_953.CylindricalGearPinionTypeCutterFlank':
        ...
        if _953.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_standard_rack_flank(self) -> '_1004.StandardRackFlank':
        ...
        if _1004.StandardRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def flanks(self) -> 'List[_938.CylindricalGearAbstractRackFlank]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_938.CylindricalGearAbstractRackFlank))
        return value

    @property
    def both_flanks(self) -> '_938.CylindricalGearAbstractRackFlank':
        ...
        if _938.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_cylindrical_gear_basic_rack_flank(self) -> '_940.CylindricalGearBasicRackFlank':
        ...
        if _940.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_953.CylindricalGearPinionTypeCutterFlank':
        ...
        if _953.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_standard_rack_flank(self) -> '_1004.StandardRackFlank':
        ...
        if _1004.StandardRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
