...
class CylindricalGearBasicRack(_969.CylindricalGearAbstractRack):
    """CylindricalGearBasicRack
    ...
    @property
    def basic_rack_profile(self) -> '_963.BasicRackProfiles':
        ...
        return constructor.new_from_mastapy_type(_963.BasicRackProfiles)(value) if value is not None else None

    @basic_rack_profile.setter
    def basic_rack_profile(self, value: '_963.BasicRackProfiles'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BasicRackProfile = value

    @property
    def proportional_method_for_tip_clearance(self) -> '_1042.TipAlterationCoefficientMethod':
        ...
        value = conversion.pn_to_mp_enum(temp)
        return constructor.new_from_mastapy_type(_1042.TipAlterationCoefficientMethod)(value) if value is not None else None

    @proportional_method_for_tip_clearance.setter
    def proportional_method_for_tip_clearance(self, value: '_1042.TipAlterationCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def pinion_type_cutter_for_rating(self) -> '_985.CylindricalGearPinionTypeCutter':
