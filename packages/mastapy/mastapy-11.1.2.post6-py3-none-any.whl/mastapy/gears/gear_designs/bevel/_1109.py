...
from mastapy.gears.gear_designs.bevel import _1115
...
class BevelGearDesign(_1122.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1115.FinishingMethods':
        ...
        return constructor.new(_1115.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1115.FinishingMethods'):
