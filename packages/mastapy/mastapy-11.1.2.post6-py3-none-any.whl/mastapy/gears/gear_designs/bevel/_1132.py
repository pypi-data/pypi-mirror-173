...
from mastapy.gears.gear_designs.bevel import _1138
...
class BevelGearDesign(_1145.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1138.FinishingMethods':
        ...
        return constructor.new(_1138.FinishingMethods)(value) if value is not None else None

    @finishing_method.setter
    def finishing_method(self, value: '_1138.FinishingMethods'):
