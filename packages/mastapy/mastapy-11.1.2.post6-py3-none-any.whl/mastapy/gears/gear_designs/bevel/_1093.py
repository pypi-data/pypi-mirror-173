...
class BevelGearDesign(_1106.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_1099.FinishingMethods':
        ...
        return constructor.new(_1099.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1099.FinishingMethods'):
