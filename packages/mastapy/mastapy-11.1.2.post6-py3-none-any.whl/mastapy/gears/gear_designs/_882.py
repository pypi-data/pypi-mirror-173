...
class SelectedDesignConstraintsCollection(_1351.PerMachineSettings):
    '''SelectedDesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> '_877.DesignConstraintsCollection':
        ...
        return constructor.new(_877.DesignConstraintsCollection)(self.wrapped.DesignConstraints) if self.wrapped.DesignConstraints else None
