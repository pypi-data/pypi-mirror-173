...
from mastapy.gears.gear_designs.bevel import _1097, _1092
...
class StraightBevelDiffGearDesign(_1092.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1097.EdgeRadiusType':
        ...
        return constructor.new(_1097.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1097.EdgeRadiusType'):
