...
from mastapy.gears.gear_designs.bevel import _1114, _1109
...
class StraightBevelDiffGearDesign(_1109.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1114.EdgeRadiusType':
        ...
        return constructor.new(_1114.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1114.EdgeRadiusType'):
