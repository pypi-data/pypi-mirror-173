...
from mastapy.gears.gear_designs.straight_bevel_diff import _892, _893
...
class StraightBevelDiffGearSetDesign(_1095.BevelGearSetDesign):
    '''StraightBevelDiffGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_892.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_892.StraightBevelDiffGearDesign))
        return value
    ...
    @property
    def straight_bevel_diff_meshes(self) -> 'List[_893.StraightBevelDiffGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_893.StraightBevelDiffGearMeshDesign))
        return value
