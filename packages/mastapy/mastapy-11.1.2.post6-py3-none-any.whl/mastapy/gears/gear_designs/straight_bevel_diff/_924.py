...
from mastapy.gears.gear_designs.straight_bevel_diff import _925, _923, _926
...
class StraightBevelDiffGearMeshDesign(_1133.BevelGearMeshDesign):
    '''StraightBevelDiffGearMeshDesign
    ...
    @property
    def straight_bevel_diff_gear_set(self) -> '_925.StraightBevelDiffGearSetDesign':
        ...
        return constructor.new(_925.StraightBevelDiffGearSetDesign)(self.wrapped.StraightBevelDiffGearSet) if self.wrapped.StraightBevelDiffGearSet is not None else None

    @property
    def straight_bevel_diff_gears(self) -> 'List[_923.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGears, constructor.new(_923.StraightBevelDiffGearDesign))
        return value

    @property
    def straight_bevel_diff_meshed_gears(self) -> 'List[_926.StraightBevelDiffMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshedGears, constructor.new(_926.StraightBevelDiffMeshedGearDesign))
        return value
