...
from mastapy.gears.gear_designs.straight_bevel_diff import _901, _899, _902
...
class StraightBevelDiffGearMeshDesign(_1110.BevelGearMeshDesign):
    '''StraightBevelDiffGearMeshDesign
    ...
    @property
    def straight_bevel_diff_meshed_gears(self) -> 'List[_902.StraightBevelDiffMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshedGears, constructor.new(_902.StraightBevelDiffMeshedGearDesign))
        return value
