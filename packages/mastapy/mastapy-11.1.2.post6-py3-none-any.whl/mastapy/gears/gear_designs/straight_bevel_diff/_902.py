...
class StraightBevelDiffGearMeshDesign(_1112.BevelGearMeshDesign):
    ...
    def straight_bevel_diff_gear_set(self) -> '_903.StraightBevelDiffGearSetDesign':
        ...
        return constructor.new(_903.StraightBevelDiffGearSetDesign)(self.wrapped.StraightBevelDiffGearSet) if self.wrapped.StraightBevelDiffGearSet is not None else None
