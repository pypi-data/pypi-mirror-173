...
from mastapy.gears.gear_designs.straight_bevel_diff import _923, _924
...
class StraightBevelDiffGearSetDesign(_1134.BevelGearSetDesign):
    '''StraightBevelDiffGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_923.StraightBevelDiffGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_923.StraightBevelDiffGearDesign))
        return value
    ...
    @property
    def straight_bevel_diff_meshes(self) -> 'List[_924.StraightBevelDiffGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshes, constructor.new(_924.StraightBevelDiffGearMeshDesign))
        return value
