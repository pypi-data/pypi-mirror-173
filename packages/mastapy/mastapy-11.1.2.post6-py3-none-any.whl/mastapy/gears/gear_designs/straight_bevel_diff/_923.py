...
from mastapy.gears.gear_designs.bevel import _1137, _1132
...
class StraightBevelDiffGearDesign(_1132.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1137.EdgeRadiusType':
        ...
        return constructor.new(_1137.EdgeRadiusType)(value) if value is not None else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1137.EdgeRadiusType'):
