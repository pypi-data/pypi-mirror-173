...
from mastapy.gears.gear_designs.bevel import _1098, _1093
...
class StraightBevelDiffGearDesign(_1093.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_1098.EdgeRadiusType':
        ...
        return constructor.new(_1098.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_1098.EdgeRadiusType'):
