...
class BevelMachineSettingOptimizationResult(_0.APIBase):
    ...
    @property
    def calculated_deviations_convex(self) -> '_722.ConicalFlankDeviationsData':
        ...
        return constructor.new(_722.ConicalFlankDeviationsData)(self.wrapped.CalculatedDeviationsConvex) if self.wrapped.CalculatedDeviationsConvex else None

    @property
    def imported_deviations_convex(self) -> '_722.ConicalFlankDeviationsData':
        ...
        return constructor.new(_722.ConicalFlankDeviationsData)(self.wrapped.ImportedDeviationsConvex) if self.wrapped.ImportedDeviationsConvex else None

    @property
    def calculated_deviations_concave(self) -> '_722.ConicalFlankDeviationsData':
        ...
        return constructor.new(_722.ConicalFlankDeviationsData)(self.wrapped.CalculatedDeviationsConcave) if self.wrapped.CalculatedDeviationsConcave else None

    @property
    def imported_deviations_concave(self) -> '_722.ConicalFlankDeviationsData':
        ...
        return constructor.new(_722.ConicalFlankDeviationsData)(self.wrapped.ImportedDeviationsConcave) if self.wrapped.ImportedDeviationsConcave else None
