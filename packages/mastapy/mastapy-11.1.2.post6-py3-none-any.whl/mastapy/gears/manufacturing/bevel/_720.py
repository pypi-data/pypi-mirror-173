...
class AbstractTCA(_0.APIBase):
    ...
    @property
    def conical_mesh_misalignments(self) -> '_1073.ConicalMeshMisalignments':
        ...
        return constructor.new(_1073.ConicalMeshMisalignments)(self.wrapped.ConicalMeshMisalignments) if self.wrapped.ConicalMeshMisalignments else None
