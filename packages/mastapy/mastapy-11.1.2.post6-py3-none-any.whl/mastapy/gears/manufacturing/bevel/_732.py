...
from mastapy.gears.manufacturing.bevel import _743, _727
...
class ConicalMeshManufacturingAnalysis(_1133.GearMeshImplementationAnalysis):
    '''ConicalMeshManufacturingAnalysis
    ...
    @property
    def tca(self) -> '_743.EaseOffBasedTCA':
        ...
        return constructor.new(_743.EaseOffBasedTCA)(self.wrapped.TCA) if self.wrapped.TCA else None

    @property
    def meshed_gears(self) -> 'List[_727.ConicalMeshedGearManufacturingAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_727.ConicalMeshedGearManufacturingAnalysis))
        return value
