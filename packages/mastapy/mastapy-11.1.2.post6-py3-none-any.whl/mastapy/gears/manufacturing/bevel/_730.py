...
from mastapy.gears.gear_designs.conical.micro_geometry import _1086
...
class ConicalMeshFlankMicroGeometryConfig(_0.APIBase):
    ...
    @property
    def specified_ease_off_surface(self) -> '_1086.ConicalGearFlankMicroGeometry':
        ...
        return constructor.new(_1086.ConicalGearFlankMicroGeometry)(self.wrapped.SpecifiedEaseOffSurface) if self.wrapped.SpecifiedEaseOffSurface else None
