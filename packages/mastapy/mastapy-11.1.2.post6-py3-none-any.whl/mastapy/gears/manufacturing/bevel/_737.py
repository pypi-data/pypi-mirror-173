...
class AbstractTCA(_0.APIBase):
    ...
    @property
    def conical_mesh_misalignments(self) -> '_1112.ConicalMeshMisalignments':
        ...
        return constructor.new(_1112.ConicalMeshMisalignments)(self.wrapped.ConicalMeshMisalignments) if self.wrapped.ConicalMeshMisalignments is not None else None
