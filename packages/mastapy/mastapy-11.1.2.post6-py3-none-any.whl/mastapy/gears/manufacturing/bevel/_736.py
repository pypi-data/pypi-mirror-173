...
from mastapy.gears.manufacturing.bevel.cutters import _761, _762
...
class ConicalPinionManufacturingConfig(_724.ConicalGearManufacturingConfig):
    '''ConicalPinionManufacturingConfig
    ...
    @property
    def mesh_config(self) -> '_733.ConicalMeshManufacturingConfig':
        ...
        return constructor.new(_733.ConicalMeshManufacturingConfig)(self.wrapped.MeshConfig) if self.wrapped.MeshConfig else None

    @property
    def pinion_concave_ob_configuration(self) -> '_729.ConicalMeshFlankManufacturingConfig':
        ...
        return constructor.new(_729.ConicalMeshFlankManufacturingConfig)(self.wrapped.PinionConcaveOBConfiguration) if self.wrapped.PinionConcaveOBConfiguration else None

    @property
    def pinion_convex_ib_configuration(self) -> '_729.ConicalMeshFlankManufacturingConfig':
        ...
        return constructor.new(_729.ConicalMeshFlankManufacturingConfig)(self.wrapped.PinionConvexIBConfiguration) if self.wrapped.PinionConvexIBConfiguration else None

    @property
    def pinion_finish_cutter(self) -> '_761.PinionFinishCutter':
        ...
        return constructor.new(_761.PinionFinishCutter)(self.wrapped.PinionFinishCutter) if self.wrapped.PinionFinishCutter else None

    @property
    def pinion_rough_cutter(self) -> '_762.PinionRoughCutter':
        ...
        return constructor.new(_762.PinionRoughCutter)(self.wrapped.PinionRoughCutter) if self.wrapped.PinionRoughCutter else None

    @property
    def pinion_cutter_parameters_concave(self) -> '_754.PinionFinishMachineSettings':
        ...
        if _754.PinionFinishMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_bevel_generating_modified_roll_machine_settings(self) -> '_749.PinionBevelGeneratingModifiedRollMachineSettings':
        ...
        if _749.PinionBevelGeneratingModifiedRollMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_bevel_generating_tilt_machine_settings(self) -> '_750.PinionBevelGeneratingTiltMachineSettings':
        ...
        if _750.PinionBevelGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_conical_machine_settings_specified(self) -> '_752.PinionConicalMachineSettingsSpecified':
        ...
        if _752.PinionConicalMachineSettingsSpecified.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_hypoid_formate_tilt_machine_settings(self) -> '_755.PinionHypoidFormateTiltMachineSettings':
        ...
        if _755.PinionHypoidFormateTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_hypoid_generating_tilt_machine_settings(self) -> '_756.PinionHypoidGeneratingTiltMachineSettings':
        ...
        if _756.PinionHypoidGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_machine_settings_smt(self) -> '_757.PinionMachineSettingsSMT':
        ...
        if _757.PinionMachineSettingsSMT.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex(self) -> '_754.PinionFinishMachineSettings':
        ...
        if _754.PinionFinishMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_bevel_generating_modified_roll_machine_settings(self) -> '_749.PinionBevelGeneratingModifiedRollMachineSettings':
        ...
        if _749.PinionBevelGeneratingModifiedRollMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_bevel_generating_tilt_machine_settings(self) -> '_750.PinionBevelGeneratingTiltMachineSettings':
        ...
        if _750.PinionBevelGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_conical_machine_settings_specified(self) -> '_752.PinionConicalMachineSettingsSpecified':
        ...
        if _752.PinionConicalMachineSettingsSpecified.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_hypoid_formate_tilt_machine_settings(self) -> '_755.PinionHypoidFormateTiltMachineSettings':
        ...
        if _755.PinionHypoidFormateTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_hypoid_generating_tilt_machine_settings(self) -> '_756.PinionHypoidGeneratingTiltMachineSettings':
        ...
        if _756.PinionHypoidGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_machine_settings_smt(self) -> '_757.PinionMachineSettingsSMT':
        ...
        if _757.PinionMachineSettingsSMT.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_rough_machine_setting(self) -> '_758.PinionRoughMachineSetting':
        ...
        return constructor.new(_758.PinionRoughMachineSetting)(self.wrapped.PinionRoughMachineSetting) if self.wrapped.PinionRoughMachineSetting else None
