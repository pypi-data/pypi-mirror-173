...
from mastapy.gears.manufacturing.bevel import _742, _735
...
class ConicalMeshManufacturingConfig(_735.ConicalMeshMicroGeometryConfigBase):
    '''ConicalMeshManufacturingConfig
    ...
    @property
    def wheel_config(self) -> '_742.ConicalWheelManufacturingConfig':
        ...
        return constructor.new(_742.ConicalWheelManufacturingConfig)(self.wrapped.WheelConfig) if self.wrapped.WheelConfig else None
