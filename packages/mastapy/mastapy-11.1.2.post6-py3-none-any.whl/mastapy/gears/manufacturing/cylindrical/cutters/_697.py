...
class CylindricalGearShaper(_701.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_1033.ShaperEdgeTypes':
        ...
        return constructor.new(_1033.ShaperEdgeTypes)(value) if value is not None else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_1033.ShaperEdgeTypes'):
