...
class CylindricalGearShaperTangible(_706.CutterShapeDefinition):
    '''CylindricalGearShaperTangible
    ...
    @property
    def design(self) -> '_697.CylindricalGearShaper':
        ...
        return constructor.new(_697.CylindricalGearShaper)(self.wrapped.Design) if self.wrapped.Design is not None else None
