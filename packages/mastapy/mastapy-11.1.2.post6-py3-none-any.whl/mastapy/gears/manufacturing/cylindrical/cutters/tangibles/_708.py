...
class CylindricalGearHobShape(_713.RackShape):
    '''CylindricalGearHobShape
    ...
    @property
    def design(self) -> '_692.CylindricalGearHobDesign':
        ...
        return constructor.new(_692.CylindricalGearHobDesign)(self.wrapped.Design) if self.wrapped.Design is not None else None
