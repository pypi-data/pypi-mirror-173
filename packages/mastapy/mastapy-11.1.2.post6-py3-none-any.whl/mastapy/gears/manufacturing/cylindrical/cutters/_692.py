...
from mastapy.gears.manufacturing.cylindrical import _596
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _708, _713, _711
...
class CylindricalGearHobDesign(_695.CylindricalGearRackDesign):
    '''CylindricalGearHobDesign
    ...
    @property
    def hob_edge_type(self) -> '_596.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_596.HobEdgeTypes)(value) if value is not None else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_596.HobEdgeTypes'):
    ...
    @property
    def nominal_hob_shape(self) -> '_708.CylindricalGearHobShape':
        ...
        return constructor.new(_708.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape is not None else None

    @property
    def nominal_rack_shape(self) -> '_713.RackShape':
        ...
        if _713.RackShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_708.CylindricalGearHobShape':
        ...
        if _708.CylindricalGearHobShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_711.CylindricalGearWormGrinderShape':
        ...
        if _711.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def maximum_hob_material_shape(self) -> '_708.CylindricalGearHobShape':
        ...
        return constructor.new(_708.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape is not None else None

    @property
    def minimum_hob_material_shape(self) -> '_708.CylindricalGearHobShape':
        ...
        return constructor.new(_708.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape is not None else None
