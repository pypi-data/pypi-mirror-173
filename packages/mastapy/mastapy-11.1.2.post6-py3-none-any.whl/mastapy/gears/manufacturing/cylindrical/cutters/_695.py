...
from mastapy.gears import _304, _322
from mastapy._internal.implicit import overridable
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _713, _708, _711
...
class CylindricalGearRackDesign(_696.CylindricalGearRealCutterDesign):
    '''CylindricalGearRackDesign
    ...
    @property
    def worm_type(self) -> '_322.WormType':
        '''WormType: 'WormType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.WormType)
        return constructor.new(_322.WormType)(value) if value is not None else None

    @worm_type.setter
    def worm_type(self, value: '_322.WormType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
