...
from mastapy.gears.manufacturing.cylindrical.cutters import _687, _689
...
class CylindricalGearRealCutterDesign(_689.CylindricalGearAbstractCutterDesign):
    '''CylindricalGearRealCutterDesign
    ...
    @property
    def nominal_cutter_shape(self) -> '_706.CutterShapeDefinition':
        ...
        if _706.CutterShapeDefinition.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_formed_wheel_grinder_tangible(self) -> '_707.CylindricalGearFormedWheelGrinderTangible':
        ...
        if _707.CylindricalGearFormedWheelGrinderTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_hob_shape(self) -> '_708.CylindricalGearHobShape':
        ...
        if _708.CylindricalGearHobShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaper_tangible(self) -> '_709.CylindricalGearShaperTangible':
        ...
        if _709.CylindricalGearShaperTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaver_tangible(self) -> '_710.CylindricalGearShaverTangible':
        ...
        if _710.CylindricalGearShaverTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_711.CylindricalGearWormGrinderShape':
        ...
        if _711.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_rack_shape(self) -> '_713.RackShape':
        ...
        if _713.RackShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def customised_cutting_edge_profile(self) -> '_687.CustomisableEdgeProfile':
        ...
        return constructor.new(_687.CustomisableEdgeProfile)(self.wrapped.CustomisedCuttingEdgeProfile) if self.wrapped.CustomisedCuttingEdgeProfile is not None else None
