...
class CylindricalGearFormedWheelGrinderTangible(_706.CutterShapeDefinition):
    '''CylindricalGearFormedWheelGrinderTangible
    ...
    @property
    def design(self) -> '_690.CylindricalGearFormGrindingWheel':
        ...
        return constructor.new(_690.CylindricalGearFormGrindingWheel)(self.wrapped.Design) if self.wrapped.Design is not None else None
