...
class InvoluteCutterDesign(_696.CylindricalGearRealCutterDesign):
    '''InvoluteCutterDesign
    ...
    @property
    def hand(self) -> '_304.Hand':
        '''Hand: 'Hand' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Hand)
        return constructor.new(_304.Hand)(value) if value is not None else None

    @hand.setter
    def hand(self, value: '_304.Hand'):
    ...
    @property
    def tooth_thickness(self) -> '_1045.ToothThicknessSpecificationBase':
        ...
        if _1045.ToothThicknessSpecificationBase.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_finish_tooth_thickness_design_specification(self) -> '_1006.FinishToothThicknessDesignSpecification':
        ...
        if _1006.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_readonly_tooth_thickness_specification(self) -> '_1026.ReadonlyToothThicknessSpecification':
        ...
        if _1026.ReadonlyToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_tooth_thickness_specification(self) -> '_1044.ToothThicknessSpecification':
        ...
        if _1044.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
