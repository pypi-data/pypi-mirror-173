...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _712
...
class CutterShapeDefinition(_0.APIBase):
    ...
    def design(self) -> '_696.CylindricalGearRealCutterDesign':
        ...
        if _696.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_690.CylindricalGearFormGrindingWheel':
        ...
        if _690.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_grinding_worm(self) -> '_691.CylindricalGearGrindingWorm':
        ...
        if _691.CylindricalGearGrindingWorm.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_hob_design(self) -> '_692.CylindricalGearHobDesign':
        ...
        if _692.CylindricalGearHobDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_plunge_shaver(self) -> '_693.CylindricalGearPlungeShaver':
        ...
        if _693.CylindricalGearPlungeShaver.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_rack_design(self) -> '_695.CylindricalGearRackDesign':
        ...
        if _695.CylindricalGearRackDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_shaper(self) -> '_697.CylindricalGearShaper':
        ...
        if _697.CylindricalGearShaper.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_cylindrical_gear_shaver(self) -> '_698.CylindricalGearShaver':
        ...
        if _698.CylindricalGearShaver.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def design_of_type_involute_cutter_design(self) -> '_701.InvoluteCutterDesign':
        ...
        if _701.InvoluteCutterDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def fillet_points(self) -> 'List[_712.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FilletPoints, constructor.new(_712.NamedPoint))
        return value

    @property
    def main_blade_points(self) -> 'List[_712.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainBladePoints, constructor.new(_712.NamedPoint))
        return value
