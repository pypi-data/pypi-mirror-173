...
class CylindricalGearFormGrindingWheel(_696.CylindricalGearRealCutterDesign):
    ...
    @property
    def right_hand_cutting_edge_shape(self) -> '_1435.Vector2DListAccessor':
        '''Vector2DListAccessor: 'RightHandCuttingEdgeShape' is the original name of this property.'''

        return constructor.new(_1435.Vector2DListAccessor)(self.wrapped.RightHandCuttingEdgeShape) if self.wrapped.RightHandCuttingEdgeShape is not None else None

    @right_hand_cutting_edge_shape.setter
    def right_hand_cutting_edge_shape(self, value: '_1435.Vector2DListAccessor'):
