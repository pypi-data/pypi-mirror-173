...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _711, _713, _708
...
class CylindricalGearGrindingWorm(_695.CylindricalGearRackDesign):
    '''CylindricalGearGrindingWorm
    ...
    @property
    def nominal_worm_grinder_shape(self) -> '_711.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_711.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape is not None else None
