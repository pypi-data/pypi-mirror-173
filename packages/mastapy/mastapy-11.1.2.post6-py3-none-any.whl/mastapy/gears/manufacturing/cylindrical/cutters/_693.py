...
class CylindricalGearPlungeShaver(_698.CylindricalGearShaver):
    '''CylindricalGearPlungeShaver
    ...
    @property
    def right_flank_micro_geometry(self) -> '_578.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_578.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.RightFlankMicroGeometry) if self.wrapped.RightFlankMicroGeometry is not None else None

    @property
    def left_flank_micro_geometry(self) -> '_578.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_578.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.LeftFlankMicroGeometry) if self.wrapped.LeftFlankMicroGeometry is not None else None

    @property
    def micro_geometry(self) -> 'List[_578.CylindricalGearSpecifiedMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometry, constructor.new(_578.CylindricalGearSpecifiedMicroGeometry))
        return value
