...
class FormWheelGrindingSimulationCalculator(_651.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    def profiled_grinding_wheel(self) -> '_690.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_690.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel else None
