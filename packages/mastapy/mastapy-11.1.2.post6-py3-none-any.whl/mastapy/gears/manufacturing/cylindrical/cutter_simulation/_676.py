...
class GearCutterSimulation(_0.APIBase):
    ...
    @property
    def cutter_simulation_of_type_finish_cutter_simulation(self) -> '_673.FinishCutterSimulation':
        ...
        if _673.FinishCutterSimulation.TYPE not in self.wrapped.CutterSimulation.__class__.__mro__:
    ...
    @property
    def cutter_simulation_of_type_rough_cutter_simulation(self) -> '_681.RoughCutterSimulation':
        ...
        if _681.RoughCutterSimulation.TYPE not in self.wrapped.CutterSimulation.__class__.__mro__:
    ...
    @property
    def minimum_thickness(self) -> '_668.CutterSimulationCalc':
        ...
        if _668.CutterSimulationCalc.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_675.FormWheelGrindingSimulationCalculator':
        ...
        if _675.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_hob_simulation_calculator(self) -> '_677.HobSimulationCalculator':
        ...
        if _677.HobSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_rack_simulation_calculator(self) -> '_680.RackSimulationCalculator':
        ...
        if _680.RackSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_shaper_simulation_calculator(self) -> '_682.ShaperSimulationCalculator':
        ...
        if _682.ShaperSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_shaving_simulation_calculator(self) -> '_683.ShavingSimulationCalculator':
        ...
        if _683.ShavingSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_virtual_simulation_calculator(self) -> '_684.VirtualSimulationCalculator':
        ...
        if _684.VirtualSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_685.WormGrinderSimulationCalculator':
        ...
        if _685.WormGrinderSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def average_thickness(self) -> '_668.CutterSimulationCalc':
        ...
        if _668.CutterSimulationCalc.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_675.FormWheelGrindingSimulationCalculator':
        ...
        if _675.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_hob_simulation_calculator(self) -> '_677.HobSimulationCalculator':
        ...
        if _677.HobSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_rack_simulation_calculator(self) -> '_680.RackSimulationCalculator':
        ...
        if _680.RackSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_shaper_simulation_calculator(self) -> '_682.ShaperSimulationCalculator':
        ...
        if _682.ShaperSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_shaving_simulation_calculator(self) -> '_683.ShavingSimulationCalculator':
        ...
        if _683.ShavingSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_virtual_simulation_calculator(self) -> '_684.VirtualSimulationCalculator':
        ...
        if _684.VirtualSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_685.WormGrinderSimulationCalculator':
        ...
        if _685.WormGrinderSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness(self) -> '_668.CutterSimulationCalc':
        ...
        if _668.CutterSimulationCalc.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_675.FormWheelGrindingSimulationCalculator':
        ...
        if _675.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_hob_simulation_calculator(self) -> '_677.HobSimulationCalculator':
        ...
        if _677.HobSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_rack_simulation_calculator(self) -> '_680.RackSimulationCalculator':
        ...
        if _680.RackSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_shaper_simulation_calculator(self) -> '_682.ShaperSimulationCalculator':
        ...
        if _682.ShaperSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_shaving_simulation_calculator(self) -> '_683.ShavingSimulationCalculator':
        ...
        if _683.ShavingSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_virtual_simulation_calculator(self) -> '_684.VirtualSimulationCalculator':
        ...
        if _684.VirtualSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_685.WormGrinderSimulationCalculator':
        ...
        if _685.WormGrinderSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def smallest_active_profile(self) -> '_668.CutterSimulationCalc':
        ...
        if _668.CutterSimulationCalc.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_form_wheel_grinding_simulation_calculator(self) -> '_675.FormWheelGrindingSimulationCalculator':
        ...
        if _675.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_hob_simulation_calculator(self) -> '_677.HobSimulationCalculator':
        ...
        if _677.HobSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_rack_simulation_calculator(self) -> '_680.RackSimulationCalculator':
        ...
        if _680.RackSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_shaper_simulation_calculator(self) -> '_682.ShaperSimulationCalculator':
        ...
        if _682.ShaperSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_shaving_simulation_calculator(self) -> '_683.ShavingSimulationCalculator':
        ...
        if _683.ShavingSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_virtual_simulation_calculator(self) -> '_684.VirtualSimulationCalculator':
        ...
        if _684.VirtualSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_worm_grinder_simulation_calculator(self) -> '_685.WormGrinderSimulationCalculator':
        ...
        if _685.WormGrinderSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def minimum_thickness_virtual(self) -> '_684.VirtualSimulationCalculator':
        ...
        return constructor.new(_684.VirtualSimulationCalculator)(self.wrapped.MinimumThicknessVirtual) if self.wrapped.MinimumThicknessVirtual is not None else None

    @property
    def average_thickness_virtual(self) -> '_684.VirtualSimulationCalculator':
        ...
        return constructor.new(_684.VirtualSimulationCalculator)(self.wrapped.AverageThicknessVirtual) if self.wrapped.AverageThicknessVirtual is not None else None

    @property
    def maximum_thickness_virtual(self) -> '_684.VirtualSimulationCalculator':
        ...
        return constructor.new(_684.VirtualSimulationCalculator)(self.wrapped.MaximumThicknessVirtual) if self.wrapped.MaximumThicknessVirtual is not None else None

    @property
    def thickness_calculators(self) -> 'List[_668.CutterSimulationCalc]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThicknessCalculators, constructor.new(_668.CutterSimulationCalc))
        return value

    @property
    def virtual_thickness_calculators(self) -> 'List[_684.VirtualSimulationCalculator]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.VirtualThicknessCalculators, constructor.new(_684.VirtualSimulationCalculator))
        return value

    @property
    def gear_mesh_cutter_simulations(self) -> 'List[_671.CylindricalManufacturedRealGearInMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshCutterSimulations, constructor.new(_671.CylindricalManufacturedRealGearInMesh))
        return value

    @property
    def gear_mesh_cutter_simulations_virtual(self) -> 'List[_672.CylindricalManufacturedVirtualGearInMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshCutterSimulationsVirtual, constructor.new(_672.CylindricalManufacturedVirtualGearInMesh))
        return value
