...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _652, _657
...
class CutterSimulationCalc(_0.APIBase):
    ...
    @property
    def gear(self) -> '_652.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_652.CylindricalCutterSimulatableGear)(self.wrapped.Gear) if self.wrapped.Gear else None

    @property
    def stock_removed_at_reference_diameter(self) -> '_657.FinishStockPoint':
        ...
        return constructor.new(_657.FinishStockPoint)(self.wrapped.StockRemovedAtReferenceDiameter) if self.wrapped.StockRemovedAtReferenceDiameter else None

    @property
    def stock_removed_at_designed_sap(self) -> '_657.FinishStockPoint':
        ...
        return constructor.new(_657.FinishStockPoint)(self.wrapped.StockRemovedAtDesignedSAP) if self.wrapped.StockRemovedAtDesignedSAP else None

    @property
    def stock_removed_at_rough_tip_form(self) -> '_657.FinishStockPoint':
        ...
        return constructor.new(_657.FinishStockPoint)(self.wrapped.StockRemovedAtRoughTipForm) if self.wrapped.StockRemovedAtRoughTipForm else None

    @property
    def gear_fillet_points(self) -> 'List[_695.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFilletPoints, constructor.new(_695.NamedPoint))
        return value

    @property
    def finish_stock_indexed_arcs(self) -> 'List[_657.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FinishStockIndexedArcs, constructor.new(_657.FinishStockPoint))
        return value

    @property
    def main_profile_finish_stock(self) -> 'List[_657.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainProfileFinishStock, constructor.new(_657.FinishStockPoint))
        return value
