...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _669, _674
...
class CutterSimulationCalc(_0.APIBase):
    ...
    @property
    def gear(self) -> '_669.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_669.CylindricalCutterSimulatableGear)(self.wrapped.Gear) if self.wrapped.Gear is not None else None

    @property
    def stock_removed_at_reference_diameter(self) -> '_674.FinishStockPoint':
        ...
        return constructor.new(_674.FinishStockPoint)(self.wrapped.StockRemovedAtReferenceDiameter) if self.wrapped.StockRemovedAtReferenceDiameter is not None else None

    @property
    def stock_removed_at_designed_sap(self) -> '_674.FinishStockPoint':
        ...
        return constructor.new(_674.FinishStockPoint)(self.wrapped.StockRemovedAtDesignedSAP) if self.wrapped.StockRemovedAtDesignedSAP is not None else None

    @property
    def stock_removed_at_rough_tip_form(self) -> '_674.FinishStockPoint':
        ...
        return constructor.new(_674.FinishStockPoint)(self.wrapped.StockRemovedAtRoughTipForm) if self.wrapped.StockRemovedAtRoughTipForm is not None else None

    @property
    def gear_fillet_points(self) -> 'List[_712.NamedPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFilletPoints, constructor.new(_712.NamedPoint))
        return value

    @property
    def finish_stock_indexed_arcs(self) -> 'List[_674.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FinishStockIndexedArcs, constructor.new(_674.FinishStockPoint))
        return value

    @property
    def main_profile_finish_stock(self) -> 'List[_674.FinishStockPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MainProfileFinishStock, constructor.new(_674.FinishStockPoint))
        return value
