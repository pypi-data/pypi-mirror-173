...
class GearCutterSimulation(_0.APIBase):
    ...
    @property
    def cutter_simulation_of_type_finish_cutter_simulation(self) -> '_656.FinishCutterSimulation':
        ...
        if _656.FinishCutterSimulation.TYPE not in self.wrapped.CutterSimulation.__class__.__mro__:
    ...
    @property
    def cutter_simulation_of_type_rough_cutter_simulation(self) -> '_664.RoughCutterSimulation':
        ...
        if _664.RoughCutterSimulation.TYPE not in self.wrapped.CutterSimulation.__class__.__mro__:
    ...
    @property
    def minimum_thickness(self) -> '_651.CutterSimulationCalc':
        ...
        if _651.CutterSimulationCalc.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_658.FormWheelGrindingSimulationCalculator':
        ...
        if _658.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_hob_simulation_calculator(self) -> '_660.HobSimulationCalculator':
        ...
        if _660.HobSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_rack_simulation_calculator(self) -> '_663.RackSimulationCalculator':
        ...
        if _663.RackSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_shaper_simulation_calculator(self) -> '_665.ShaperSimulationCalculator':
        ...
        if _665.ShaperSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_shaving_simulation_calculator(self) -> '_666.ShavingSimulationCalculator':
        ...
        if _666.ShavingSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_virtual_simulation_calculator(self) -> '_667.VirtualSimulationCalculator':
        ...
        if _667.VirtualSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_668.WormGrinderSimulationCalculator':
        ...
        if _668.WormGrinderSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def average_thickness(self) -> '_651.CutterSimulationCalc':
        ...
        if _651.CutterSimulationCalc.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_658.FormWheelGrindingSimulationCalculator':
        ...
        if _658.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_hob_simulation_calculator(self) -> '_660.HobSimulationCalculator':
        ...
        if _660.HobSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_rack_simulation_calculator(self) -> '_663.RackSimulationCalculator':
        ...
        if _663.RackSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_shaper_simulation_calculator(self) -> '_665.ShaperSimulationCalculator':
        ...
        if _665.ShaperSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_shaving_simulation_calculator(self) -> '_666.ShavingSimulationCalculator':
        ...
        if _666.ShavingSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_virtual_simulation_calculator(self) -> '_667.VirtualSimulationCalculator':
        ...
        if _667.VirtualSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_668.WormGrinderSimulationCalculator':
        ...
        if _668.WormGrinderSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness(self) -> '_651.CutterSimulationCalc':
        ...
        if _651.CutterSimulationCalc.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_658.FormWheelGrindingSimulationCalculator':
        ...
        if _658.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_hob_simulation_calculator(self) -> '_660.HobSimulationCalculator':
        ...
        if _660.HobSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_rack_simulation_calculator(self) -> '_663.RackSimulationCalculator':
        ...
        if _663.RackSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_shaper_simulation_calculator(self) -> '_665.ShaperSimulationCalculator':
        ...
        if _665.ShaperSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_shaving_simulation_calculator(self) -> '_666.ShavingSimulationCalculator':
        ...
        if _666.ShavingSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_virtual_simulation_calculator(self) -> '_667.VirtualSimulationCalculator':
        ...
        if _667.VirtualSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_668.WormGrinderSimulationCalculator':
        ...
        if _668.WormGrinderSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def smallest_active_profile(self) -> '_651.CutterSimulationCalc':
        ...
        if _651.CutterSimulationCalc.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_form_wheel_grinding_simulation_calculator(self) -> '_658.FormWheelGrindingSimulationCalculator':
        ...
        if _658.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_hob_simulation_calculator(self) -> '_660.HobSimulationCalculator':
        ...
        if _660.HobSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_rack_simulation_calculator(self) -> '_663.RackSimulationCalculator':
        ...
        if _663.RackSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_shaper_simulation_calculator(self) -> '_665.ShaperSimulationCalculator':
        ...
        if _665.ShaperSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_shaving_simulation_calculator(self) -> '_666.ShavingSimulationCalculator':
        ...
        if _666.ShavingSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_virtual_simulation_calculator(self) -> '_667.VirtualSimulationCalculator':
        ...
        if _667.VirtualSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_worm_grinder_simulation_calculator(self) -> '_668.WormGrinderSimulationCalculator':
        ...
        if _668.WormGrinderSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def minimum_thickness_virtual(self) -> '_667.VirtualSimulationCalculator':
        ...
        return constructor.new(_667.VirtualSimulationCalculator)(self.wrapped.MinimumThicknessVirtual) if self.wrapped.MinimumThicknessVirtual else None

    @property
    def average_thickness_virtual(self) -> '_667.VirtualSimulationCalculator':
        ...
        return constructor.new(_667.VirtualSimulationCalculator)(self.wrapped.AverageThicknessVirtual) if self.wrapped.AverageThicknessVirtual else None

    @property
    def maximum_thickness_virtual(self) -> '_667.VirtualSimulationCalculator':
        ...
        return constructor.new(_667.VirtualSimulationCalculator)(self.wrapped.MaximumThicknessVirtual) if self.wrapped.MaximumThicknessVirtual else None

    @property
    def thickness_calculators(self) -> 'List[_651.CutterSimulationCalc]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThicknessCalculators, constructor.new(_651.CutterSimulationCalc))
        return value

    @property
    def virtual_thickness_calculators(self) -> 'List[_667.VirtualSimulationCalculator]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.VirtualThicknessCalculators, constructor.new(_667.VirtualSimulationCalculator))
        return value

    @property
    def gear_mesh_cutter_simulations(self) -> 'List[_654.CylindricalManufacturedRealGearInMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshCutterSimulations, constructor.new(_654.CylindricalManufacturedRealGearInMesh))
        return value

    @property
    def gear_mesh_cutter_simulations_virtual(self) -> 'List[_655.CylindricalManufacturedVirtualGearInMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshCutterSimulationsVirtual, constructor.new(_655.CylindricalManufacturedVirtualGearInMesh))
        return value
