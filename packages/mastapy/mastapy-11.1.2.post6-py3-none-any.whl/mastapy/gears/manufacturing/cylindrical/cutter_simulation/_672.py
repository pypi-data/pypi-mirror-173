...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _684
...
class CylindricalManufacturedVirtualGearInMesh(_0.APIBase):
    ...
    @property
    def virtual_gear(self) -> '_684.VirtualSimulationCalculator':
        ...
        return constructor.new(_684.VirtualSimulationCalculator)(self.wrapped.VirtualGear) if self.wrapped.VirtualGear is not None else None
