...
class FormWheelGrindingSimulationCalculator(_668.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    @property
    def profiled_grinding_wheel(self) -> '_707.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_707.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel is not None else None
