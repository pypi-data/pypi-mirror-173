...
class CylindricalGearSpecification(_0.APIBase):
    ...
    @property
    def tooth_thickness_specification(self) -> '_1045.ToothThicknessSpecificationBase':
        ...
        if _1045.ToothThicknessSpecificationBase.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
    ...
    @property
    def tooth_thickness_specification_of_type_finish_tooth_thickness_design_specification(self) -> '_1006.FinishToothThicknessDesignSpecification':
        ...
        if _1006.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
    ...
    @property
    def tooth_thickness_specification_of_type_readonly_tooth_thickness_specification(self) -> '_1026.ReadonlyToothThicknessSpecification':
        ...
        if _1026.ReadonlyToothThicknessSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
    ...
    @property
    def tooth_thickness_specification_of_type_tooth_thickness_specification(self) -> '_1044.ToothThicknessSpecification':
        ...
        if _1044.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
