...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _692
...
class ShaperSimulationCalculator(_651.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_692.CylindricalGearShaperTangible':
        ...
        return constructor.new(_692.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper else None
