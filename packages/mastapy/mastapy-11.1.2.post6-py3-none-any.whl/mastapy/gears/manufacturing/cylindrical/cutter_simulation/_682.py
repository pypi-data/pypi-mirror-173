...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _709
...
class ShaperSimulationCalculator(_668.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_709.CylindricalGearShaperTangible':
        ...
        return constructor.new(_709.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper is not None else None
