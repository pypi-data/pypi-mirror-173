...
class HobSimulationCalculator(_663.RackSimulationCalculator):
    '''HobSimulationCalculator
    ...
    def hob(self) -> '_691.CylindricalGearHobShape':
        ...
        return constructor.new(_691.CylindricalGearHobShape)(self.wrapped.Hob) if self.wrapped.Hob else None
