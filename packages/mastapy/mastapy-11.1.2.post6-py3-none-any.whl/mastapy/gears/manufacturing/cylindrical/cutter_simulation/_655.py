...
class CylindricalManufacturedVirtualGearInMesh(_0.APIBase):
    ...
    @property
    def virtual_gear(self) -> '_667.VirtualSimulationCalculator':
        ...
        return constructor.new(_667.VirtualSimulationCalculator)(self.wrapped.VirtualGear) if self.wrapped.VirtualGear else None
