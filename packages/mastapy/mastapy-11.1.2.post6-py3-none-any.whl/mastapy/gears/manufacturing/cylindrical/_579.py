...
from mastapy.gears.manufacturing.cylindrical import _600, _601
...
class CylindricalGearSpecifiedMicroGeometry(_0.APIBase):
    ...
    @property
    def lead_micro_geometry(self) -> '_600.MicroGeometryInputsLead':
    ...
    @property
    def profile_micro_geometry(self) -> 'List[_601.MicroGeometryInputsProfile]':
