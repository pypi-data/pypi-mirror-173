...
from mastapy.gears.analysis import _1140
...
class CylindricalManufacturedGearSetDutyCycle(_1140.GearSetImplementationAnalysisDutyCycle):
    '''CylindricalManufacturedGearSetDutyCycle
    ...
    @property
    def rating(self) -> '_423.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_423.CylindricalGearSetDutyCycleRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def manufacturing_configuration(self) -> '_573.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_573.CylindricalSetManufacturingConfig)(self.wrapped.ManufacturingConfiguration) if self.wrapped.ManufacturingConfiguration else None
