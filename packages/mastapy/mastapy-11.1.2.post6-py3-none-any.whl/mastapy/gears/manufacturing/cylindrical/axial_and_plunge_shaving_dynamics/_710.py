...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _711
...
class RollAngleRangeRelativeToAccuracy(_0.APIBase):
    ...
    @property
    def roll_angle_range(self) -> 'List[_711.RollAngleReportObject]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RollAngleRange, constructor.new(_711.RollAngleReportObject))
        return value
