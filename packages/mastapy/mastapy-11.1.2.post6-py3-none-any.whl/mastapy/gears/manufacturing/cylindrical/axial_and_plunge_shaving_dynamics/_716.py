...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _730, _717
...
class AxialShaverRedressing(_730.ShaverRedressing['_717.ConventionalShavingDynamics']):
    """AxialShaverRedressing
