...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _704, _718, _703
...
class PlungeShavingDynamicsViewModel(_718.ShavingDynamicsViewModel['_703.PlungeShaverDynamics']):
    '''PlungeShavingDynamicsViewModel
    ...
    @property
    def settings(self) -> '_704.PlungeShaverDynamicSettings':
        ...
        return constructor.new(_704.PlungeShaverDynamicSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
