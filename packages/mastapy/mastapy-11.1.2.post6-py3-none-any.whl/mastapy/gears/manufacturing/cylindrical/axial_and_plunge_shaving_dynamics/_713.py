...
class ShavingDynamics(_0.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_936.CrossedAxisCylindricalGearPairPointContact':
        ...
        return constructor.new(_936.CrossedAxisCylindricalGearPairPointContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None
