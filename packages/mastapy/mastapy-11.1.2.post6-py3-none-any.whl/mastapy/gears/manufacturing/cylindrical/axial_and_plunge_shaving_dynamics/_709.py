...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _713
...
T = TypeVar('T', bound='_713.ShavingDynamics')
...
class RedressingSettings(_0.APIBase, Generic[T]):
    ...
    @property
    def redressed_shaver(self) -> '_681.CylindricalGearShaver':
        ...
        if _681.CylindricalGearShaver.TYPE not in self.wrapped.RedressedShaver.__class__.__mro__:
