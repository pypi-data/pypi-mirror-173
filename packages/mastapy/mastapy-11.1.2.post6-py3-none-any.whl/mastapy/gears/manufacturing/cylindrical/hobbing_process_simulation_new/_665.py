...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _657, _651
...
class WormGrindingProcessSimulationInput(_651.ProcessSimulationInput):
    """WormGrindingProcessSimulationInput
    ...
    @property
    def worm_grinder_manufacture_error(self) -> '_657.WormGrinderManufactureError':
