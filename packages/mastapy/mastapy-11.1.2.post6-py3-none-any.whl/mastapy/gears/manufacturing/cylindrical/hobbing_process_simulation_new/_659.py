...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _626, _660
...
class WormGrindingLeadCalculation(_660.WormGrindingProcessCalculation):
    """WormGrindingLeadCalculation
    ...
    @property
    def left_flank(self) -> '_626.CalculateLeadDeviationAccuracy':
    ...
    @property
    def right_flank(self) -> '_626.CalculateLeadDeviationAccuracy':
