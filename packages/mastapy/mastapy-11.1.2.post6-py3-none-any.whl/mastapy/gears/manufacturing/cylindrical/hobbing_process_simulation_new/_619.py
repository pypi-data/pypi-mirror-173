...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _610, _614
...
class HobbingProcessProfileCalculation(_614.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
    ...
    @property
    def chart_display_method(self) -> '_955.CylindricalGearProfileMeasurementType':
    ...
    def chart_display_method(self, value: '_955.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ChartDisplayMethod = value

    @property
    def right_flank(self) -> '_610.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_610.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_610.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_610.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
