...
class CalculatePitchDeviationAccuracy(_0.APIBase):
    ...
    @property
    def manufactured_iso132811995e_quality_grades(self) -> 'List[_626.ManufacturedQualityGrade]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturedISO132811995EQualityGrades, constructor.new(_626.ManufacturedQualityGrade))
        return value

    @property
    def manufactured_ansiagma20151a01_quality_grades(self) -> 'List[_626.ManufacturedQualityGrade]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturedANSIAGMA20151A01QualityGrades, constructor.new(_626.ManufacturedQualityGrade))
        return value
