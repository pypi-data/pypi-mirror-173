...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _608, _614
...
class HobbingProcessLeadCalculation(_614.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
    ...
    @property
    def right_flank(self) -> '_608.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_608.CalculateLeadDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_608.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_608.CalculateLeadDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
