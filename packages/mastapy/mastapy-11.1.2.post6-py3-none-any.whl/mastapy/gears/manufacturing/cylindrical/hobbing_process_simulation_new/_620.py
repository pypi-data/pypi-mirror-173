...
class HobbingProcessSimulationInput(_633.ProcessSimulationInput):
    '''HobbingProcessSimulationInput
    ...
    @property
    def hob_manufacture_error(self) -> '_624.HobManufactureError':
        ...
        return constructor.new(_624.HobManufactureError)(self.wrapped.HobManufactureError) if self.wrapped.HobManufactureError else None

    @property
    def hob_resharpening_error(self) -> '_625.HobResharpeningError':
        ...
        return constructor.new(_625.HobResharpeningError)(self.wrapped.HobResharpeningError) if self.wrapped.HobResharpeningError else None
