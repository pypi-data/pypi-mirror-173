...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _628
...
class ProcessProfileCalculation(_0.APIBase):
    ...
    @property
    def left_flank_accuracy_calculation(self) -> '_628.CalculateProfileDeviationAccuracy':
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_628.CalculateProfileDeviationAccuracy':
