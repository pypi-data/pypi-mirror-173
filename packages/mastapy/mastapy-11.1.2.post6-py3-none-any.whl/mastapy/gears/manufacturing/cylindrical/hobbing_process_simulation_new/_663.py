...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _627, _660
...
class WormGrindingProcessPitchCalculation(_660.WormGrindingProcessCalculation):
    """WormGrindingProcessPitchCalculation
    ...
    @property
    def pitch_modification_chart(self) -> '_1634.TwoDChartDefinition':
    ...
    @property
    def left_flank(self) -> '_627.CalculatePitchDeviationAccuracy':
    ...
    @property
    def right_flank(self) -> '_627.CalculatePitchDeviationAccuracy':
