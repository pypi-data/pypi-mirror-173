...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _591, _597
...
class PlungeShaverOutputs(_0.APIBase):
    ...
    @property
    def calculation_details(self) -> '_597.PlungeShaverGeneration':
        ...
        return constructor.new(_597.PlungeShaverGeneration)(self.wrapped.CalculationDetails) if self.wrapped.CalculationDetails else None
