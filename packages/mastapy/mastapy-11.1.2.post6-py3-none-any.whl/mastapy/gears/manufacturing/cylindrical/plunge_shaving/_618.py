...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _611
...
class PlungeShaverSettings(_0.APIBase):
    ...
    @property
    def lead_display_method(self) -> '_611.MicroGeometryDefinitionMethod':
    ...
    def lead_display_method(self, value: '_611.MicroGeometryDefinitionMethod'):
    ...
    @property
    def profile_display_method(self) -> '_611.MicroGeometryDefinitionMethod':
    ...
    def profile_display_method(self, value: '_611.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
