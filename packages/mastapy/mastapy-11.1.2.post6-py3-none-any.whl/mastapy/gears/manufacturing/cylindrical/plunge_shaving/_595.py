...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _596, _605
...
class PlungeShaverCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_596.PlungeShaverCalculationInputs':
        ...
        return constructor.new(_596.PlungeShaverCalculationInputs)(self.wrapped.Inputs) if self.wrapped.Inputs else None

    @property
    def simulation_of_ideal_shaver_conjugate_to_the_designed_gear(self) -> '_605.VirtualPlungeShaverOutputs':
        ...
        return constructor.new(_605.VirtualPlungeShaverOutputs)(self.wrapped.SimulationOfIdealShaverConjugateToTheDesignedGear) if self.wrapped.SimulationOfIdealShaverConjugateToTheDesignedGear else None
