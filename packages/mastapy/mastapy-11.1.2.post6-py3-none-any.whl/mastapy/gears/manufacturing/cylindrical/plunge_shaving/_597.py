...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _604, _590
...
class PlungeShaverGeneration(_0.APIBase):
    ...
    @property
    def calculated_conjugate_face_width(self) -> '_1253.Range':
        ...
        if _1253.Range.TYPE not in self.wrapped.CalculatedConjugateFaceWidth.__class__.__mro__:
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_935.CrossedAxisCylindricalGearPairLineContact':
        ...
        return constructor.new(_935.CrossedAxisCylindricalGearPairLineContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None

    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_604.ShaverPointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestOnTheShaver, constructor.new(_604.ShaverPointOfInterest))
        return value

    @property
    def calculation_errors(self) -> 'List[_590.CalculationError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CalculationErrors, constructor.new(_590.CalculationError))
        return value
