...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _601
...
class ShaverPointOfInterest(_0.APIBase):
    ...
    @property
    def point_of_interest_on_the_gear(self) -> '_601.PointOfInterest':
        ...
        return constructor.new(_601.PointOfInterest)(self.wrapped.PointOfInterestOnTheGear) if self.wrapped.PointOfInterestOnTheGear else None
