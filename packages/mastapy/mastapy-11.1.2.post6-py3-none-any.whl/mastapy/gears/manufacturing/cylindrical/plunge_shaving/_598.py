...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _594, _593, _601
...
class PlungeShaverInputsAndMicroGeometry(_0.APIBase):
    ...
    @property
    def points_of_interest_left_flank(self) -> 'List[_601.PointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestLeftFlank, constructor.new(_601.PointOfInterest))
        return value

    @property
    def points_of_interest_right_flank(self) -> 'List[_601.PointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestRightFlank, constructor.new(_601.PointOfInterest))
        return value
