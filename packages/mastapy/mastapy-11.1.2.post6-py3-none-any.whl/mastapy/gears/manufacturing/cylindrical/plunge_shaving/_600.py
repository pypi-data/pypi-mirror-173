...
class PlungeShaverSettings(_0.APIBase):
    ...
    @property
    def lead_display_method(self) -> '_593.MicroGeometryDefinitionMethod':
    ...
    def lead_display_method(self, value: '_593.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LeadDisplayMethod = value

    @property
    def profile_display_method(self) -> '_593.MicroGeometryDefinitionMethod':
    ...
    def profile_display_method(self, value: '_593.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
