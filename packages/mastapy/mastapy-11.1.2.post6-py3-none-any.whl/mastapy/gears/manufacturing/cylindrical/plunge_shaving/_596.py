...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _652
...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    @property
    def shaver_hand(self) -> '_295.Hand':
    ...
    @shaver_hand.setter
    def shaver_hand(self, value: '_295.Hand'):
    ...
    @property
    def input_gear_geometry(self) -> '_652.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_652.CylindricalCutterSimulatableGear)(self.wrapped.InputGearGeometry) if self.wrapped.InputGearGeometry else None
