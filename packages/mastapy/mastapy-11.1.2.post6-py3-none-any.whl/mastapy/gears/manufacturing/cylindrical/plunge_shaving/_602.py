...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _593, _599
...
class RealPlungeShaverOutputs(_599.PlungeShaverOutputs):
    '''RealPlungeShaverOutputs
    ...
    @property
    def lead_measurement_method(self) -> '_593.MicroGeometryDefinitionMethod':
        ...
        return constructor.new(_593.MicroGeometryDefinitionMethod)(value) if value else None

    @lead_measurement_method.setter
    def lead_measurement_method(self, value: '_593.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LeadMeasurementMethod = value

    @property
    def profile_measurement_method(self) -> '_593.MicroGeometryDefinitionMethod':
    ...
    def profile_measurement_method(self, value: '_593.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def left_flank_micro_geometry(self) -> '_561.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_561.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.LeftFlankMicroGeometry) if self.wrapped.LeftFlankMicroGeometry else None

    @property
    def right_flank_micro_geometry(self) -> '_561.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_561.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.RightFlankMicroGeometry) if self.wrapped.RightFlankMicroGeometry else None
    ...
    def shaver(self) -> '_676.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_676.CylindricalGearPlungeShaver)(self.wrapped.Shaver) if self.wrapped.Shaver else None

    @property
    def micro_geometry(self) -> 'List[_561.CylindricalGearSpecifiedMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometry, constructor.new(_561.CylindricalGearSpecifiedMicroGeometry))
        return value
