...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _614, _623
...
class PlungeShaverCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_614.PlungeShaverCalculationInputs':
    ...
    @property
    def simulation_of_ideal_shaver_conjugate_to_the_designed_gear(self) -> '_623.VirtualPlungeShaverOutputs':
