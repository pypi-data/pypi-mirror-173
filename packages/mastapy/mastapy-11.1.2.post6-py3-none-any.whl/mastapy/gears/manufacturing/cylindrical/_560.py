...
from mastapy.gears.manufacturing.cylindrical import _572, _571, _559
...
from mastapy.gears.gear_designs.cylindrical import _972, _943, _969
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import (
    _659, _656, _664, _653,
    _662
)
from mastapy.gears.manufacturing.cylindrical.process_simulation import _587, _588, _589
...
class CylindricalGearManufacturingConfig(_1131.GearImplementationDetail):
    '''CylindricalGearManufacturingConfig
    ...
    def rough_cutter(self) -> '_679.CylindricalGearRealCutterDesign':
        ...
        if _679.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    def rough_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_673.CylindricalGearFormGrindingWheel':
        ...
        if _673.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    def rough_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_674.CylindricalGearGrindingWorm':
        ...
        if _674.CylindricalGearGrindingWorm.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    def rough_cutter_of_type_cylindrical_gear_hob_design(self) -> '_675.CylindricalGearHobDesign':
        ...
        if _675.CylindricalGearHobDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    def rough_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_676.CylindricalGearPlungeShaver':
        ...
        if _676.CylindricalGearPlungeShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    def rough_cutter_of_type_cylindrical_gear_rack_design(self) -> '_678.CylindricalGearRackDesign':
        ...
        if _678.CylindricalGearRackDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    def rough_cutter_of_type_cylindrical_gear_shaper(self) -> '_680.CylindricalGearShaper':
        ...
        if _680.CylindricalGearShaper.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    def rough_cutter_of_type_cylindrical_gear_shaver(self) -> '_681.CylindricalGearShaver':
        ...
        if _681.CylindricalGearShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    def rough_cutter_of_type_involute_cutter_design(self) -> '_684.InvoluteCutterDesign':
        ...
        if _684.InvoluteCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    def finish_cutter(self) -> '_679.CylindricalGearRealCutterDesign':
        ...
        if _679.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    def finish_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_673.CylindricalGearFormGrindingWheel':
        ...
        if _673.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    def finish_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_674.CylindricalGearGrindingWorm':
        ...
        if _674.CylindricalGearGrindingWorm.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    def finish_cutter_of_type_cylindrical_gear_hob_design(self) -> '_675.CylindricalGearHobDesign':
        ...
        if _675.CylindricalGearHobDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    def finish_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_676.CylindricalGearPlungeShaver':
        ...
        if _676.CylindricalGearPlungeShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    def finish_cutter_of_type_cylindrical_gear_rack_design(self) -> '_678.CylindricalGearRackDesign':
        ...
        if _678.CylindricalGearRackDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    def finish_cutter_of_type_cylindrical_gear_shaper(self) -> '_680.CylindricalGearShaper':
        ...
        if _680.CylindricalGearShaper.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    def finish_cutter_of_type_cylindrical_gear_shaver(self) -> '_681.CylindricalGearShaver':
        ...
        if _681.CylindricalGearShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    def finish_cutter_of_type_involute_cutter_design(self) -> '_684.InvoluteCutterDesign':
        ...
        if _684.InvoluteCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation(self) -> '_659.GearCutterSimulation':
        ...
        if _659.GearCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_656.FinishCutterSimulation':
        ...
        if _656.FinishCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_664.RoughCutterSimulation':
        ...
        if _664.RoughCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation(self) -> '_587.CutterProcessSimulation':
        ...
        if _587.CutterProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_588.FormWheelGrindingProcessSimulation':
        ...
        if _588.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation_of_type_shaping_process_simulation(self) -> '_589.ShapingProcessSimulation':
        ...
        if _589.ShapingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation(self) -> '_659.GearCutterSimulation':
        ...
        if _659.GearCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_656.FinishCutterSimulation':
        ...
        if _656.FinishCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_664.RoughCutterSimulation':
        ...
        if _664.RoughCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation(self) -> '_587.CutterProcessSimulation':
        ...
        if _587.CutterProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_588.FormWheelGrindingProcessSimulation':
        ...
        if _588.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation_of_type_shaping_process_simulation(self) -> '_589.ShapingProcessSimulation':
        ...
        if _589.ShapingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def design(self) -> '_943.CylindricalGearDesign':
        ...
        if _943.CylindricalGearDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def rough_gear_specification(self) -> '_653.CylindricalGearSpecification':
        ...
        return constructor.new(_653.CylindricalGearSpecification)(self.wrapped.RoughGearSpecification) if self.wrapped.RoughGearSpecification else None

    @property
    def finished_gear_specification(self) -> '_653.CylindricalGearSpecification':
        ...
        return constructor.new(_653.CylindricalGearSpecification)(self.wrapped.FinishedGearSpecification) if self.wrapped.FinishedGearSpecification else None

    @property
    def gear_blank(self) -> '_559.CylindricalGearBlank':
        ...
        return constructor.new(_559.CylindricalGearBlank)(self.wrapped.GearBlank) if self.wrapped.GearBlank else None

    @property
    def rough_manufacturing_process_controls(self) -> '_662.ManufacturingProcessControls':
        ...
        return constructor.new(_662.ManufacturingProcessControls)(self.wrapped.RoughManufacturingProcessControls) if self.wrapped.RoughManufacturingProcessControls else None

    @property
    def finish_manufacturing_process_controls(self) -> '_662.ManufacturingProcessControls':
        ...
        return constructor.new(_662.ManufacturingProcessControls)(self.wrapped.FinishManufacturingProcessControls) if self.wrapped.FinishManufacturingProcessControls else None
