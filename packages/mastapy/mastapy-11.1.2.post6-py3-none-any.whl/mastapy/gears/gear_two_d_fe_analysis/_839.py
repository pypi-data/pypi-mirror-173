...
class CylindricalGearSetTIFFAnalysis(_1154.GearSetDesignAnalysis):
    '''CylindricalGearSetTIFFAnalysis
    ...
    @property
    def gears(self) -> 'List[_841.CylindricalGearTIFFAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_841.CylindricalGearTIFFAnalysis))
        return value
