...
class CylindricalGearTIFFAnalysis(_1128.GearDesignAnalysis):
    '''CylindricalGearTIFFAnalysis
    ...
    @property
    def analysis(self) -> '_834.CylindricalGearTwoDimensionalFEAnalysis':
        ...
        return constructor.new(_834.CylindricalGearTwoDimensionalFEAnalysis)(self.wrapped.Analysis) if self.wrapped.Analysis else None
