...
class CylindricalGearTwoDimensionalFEAnalysis(_0.APIBase):
    ...
    def findley_critical_plane_analysis(self) -> '_844.FindleyCriticalPlaneAnalysis':
        ...
        return constructor.new(_844.FindleyCriticalPlaneAnalysis)(self.wrapped.FindleyCriticalPlaneAnalysis) if self.wrapped.FindleyCriticalPlaneAnalysis is not None else None
