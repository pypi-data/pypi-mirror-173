...
class CylindricalGearSetTIFFAnalysisDutyCycle(_1154.GearSetDesignAnalysis):
    '''CylindricalGearSetTIFFAnalysisDutyCycle
    ...
    @property
    def gears(self) -> 'List[_842.CylindricalGearTIFFAnalysisDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_842.CylindricalGearTIFFAnalysisDutyCycle))
        return value
