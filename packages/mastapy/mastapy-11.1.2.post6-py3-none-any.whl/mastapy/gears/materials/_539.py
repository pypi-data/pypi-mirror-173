...
class CylindricalGearMaterial(_542.GearMaterial):
    '''CylindricalGearMaterial
    ...
    @property
    def heat_treatment_process_development(self) -> '_550.ManufactureRating':
        ...
        return constructor.new(_550.ManufactureRating)(value) if value else None

    @heat_treatment_process_development.setter
    def heat_treatment_process_development(self, value: '_550.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentProcessDevelopment = value

    @property
    def heat_treatment_distortion_control(self) -> '_550.ManufactureRating':
    ...
    def heat_treatment_distortion_control(self, value: '_550.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HeatTreatmentDistortionControl = value

    @property
    def machine_process_development(self) -> '_550.ManufactureRating':
    ...
    def machine_process_development(self, value: '_550.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MachineProcessDevelopment = value

    @property
    def manufacturability(self) -> '_550.ManufactureRating':
    ...
    def manufacturability(self, value: '_550.ManufactureRating'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
