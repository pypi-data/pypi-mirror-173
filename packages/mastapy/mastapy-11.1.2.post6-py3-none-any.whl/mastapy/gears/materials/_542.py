...
from mastapy.materials import _246, _236
...
class GearMaterial(_236.Material):
    '''GearMaterial
    ...
    @property
    def sn_curve_contact(self) -> '_246.SNCurve':
        ...
        return constructor.new(_246.SNCurve)(self.wrapped.SNCurveContact) if self.wrapped.SNCurveContact else None

    @property
    def sn_curve_bending(self) -> '_246.SNCurve':
        ...
        return constructor.new(_246.SNCurve)(self.wrapped.SNCurveBending) if self.wrapped.SNCurveBending else None
