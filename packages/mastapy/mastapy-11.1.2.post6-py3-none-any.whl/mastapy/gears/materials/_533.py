...
from mastapy.gears.materials import _535
...
class BevelGearISOMaterial(_535.BevelGearMaterial):
    '''BevelGearISOMaterial
    ...
    @property
    def quality_grade(self) -> '_243.QualityGrade':
        '''QualityGrade: 'QualityGrade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.QualityGrade)
        return constructor.new(_243.QualityGrade)(value) if value else None

    @quality_grade.setter
    def quality_grade(self, value: '_243.QualityGrade'):
