...
from mastapy.materials import _209, _210, _211
...
class AGMACylindricalGearMaterial(_539.CylindricalGearMaterial):
    '''AGMACylindricalGearMaterial
    ...
    @property
    def material_application(self) -> '_209.AGMAMaterialApplications':
        ...
        return constructor.new(_209.AGMAMaterialApplications)(value) if value else None

    @material_application.setter
    def material_application(self, value: '_209.AGMAMaterialApplications'):
    ...
    @property
    def material_class(self) -> '_210.AGMAMaterialClasses':
        ...
        return constructor.new(_210.AGMAMaterialClasses)(value) if value else None

    @material_class.setter
    def material_class(self, value: '_210.AGMAMaterialClasses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MaterialClass = value

    @property
    def grade(self) -> '_211.AGMAMaterialGrade':
        '''AGMAMaterialGrade: 'Grade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Grade)
        return constructor.new(_211.AGMAMaterialGrade)(value) if value else None

    @grade.setter
    def grade(self, value: '_211.AGMAMaterialGrade'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
