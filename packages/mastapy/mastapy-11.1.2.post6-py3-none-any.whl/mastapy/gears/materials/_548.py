...
from mastapy.materials import _215, _216, _217
...
class AGMACylindricalGearMaterial(_556.CylindricalGearMaterial):
    '''AGMACylindricalGearMaterial
    ...
    @property
    def material_application(self) -> '_215.AGMAMaterialApplications':
        ...
        return constructor.new(_215.AGMAMaterialApplications)(value) if value is not None else None

    @material_application.setter
    def material_application(self, value: '_215.AGMAMaterialApplications'):
    ...
    @property
    def material_class(self) -> '_216.AGMAMaterialClasses':
        ...
        return constructor.new(_216.AGMAMaterialClasses)(value) if value is not None else None

    @material_class.setter
    def material_class(self, value: '_216.AGMAMaterialClasses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MaterialClass = value

    @property
    def grade(self) -> '_217.AGMAMaterialGrade':
        '''AGMAMaterialGrade: 'Grade' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Grade)
        return constructor.new(_217.AGMAMaterialGrade)(value) if value is not None else None

    @grade.setter
    def grade(self, value: '_217.AGMAMaterialGrade'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
