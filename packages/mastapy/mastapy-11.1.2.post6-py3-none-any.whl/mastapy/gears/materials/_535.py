...
from mastapy.gears.materials import _556, _542
...
class BevelGearMaterial(_542.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_556.SNCurveDefinition':
        ...
        return constructor.new(_556.SNCurveDefinition)(value) if value else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_556.SNCurveDefinition'):
