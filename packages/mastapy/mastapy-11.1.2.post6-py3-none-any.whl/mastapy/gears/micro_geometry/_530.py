...
class ProfileModification(_527.Modification):
    '''ProfileModification
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_tip_relief(self) -> '_526.MainProfileReliefEndsAtTheStartOfTipReliefOption':
    ...
    def main_profile_modification_ends_at_the_start_of_tip_relief(self, value: '_526.MainProfileReliefEndsAtTheStartOfTipReliefOption'):
    ...
    @property
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief(self) -> '_529.ParabolicTipReliefStartsTangentToMainProfileRelief':
    ...
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief(self, value: '_529.ParabolicTipReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_root_relief(self) -> '_525.MainProfileReliefEndsAtTheStartOfRootReliefOption':
    ...
    def main_profile_modification_ends_at_the_start_of_root_relief(self, value: '_525.MainProfileReliefEndsAtTheStartOfRootReliefOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def parabolic_root_relief_starts_tangent_to_main_profile_relief(self) -> '_528.ParabolicRootReliefStartsTangentToMainProfileRelief':
    ...
    def parabolic_root_relief_starts_tangent_to_main_profile_relief(self, value: '_528.ParabolicRootReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
