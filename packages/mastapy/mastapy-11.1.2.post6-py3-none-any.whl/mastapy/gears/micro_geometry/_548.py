...
class ProfileModification(_545.Modification):
    """ProfileModification
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_root_relief(self) -> '_543.MainProfileReliefEndsAtTheStartOfRootReliefOption':
    ...
    def main_profile_modification_ends_at_the_start_of_root_relief(self, value: '_543.MainProfileReliefEndsAtTheStartOfRootReliefOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MainProfileModificationEndsAtTheStartOfRootRelief = value

    @property
    def main_profile_modification_ends_at_the_start_of_tip_relief(self) -> '_544.MainProfileReliefEndsAtTheStartOfTipReliefOption':
    ...
    def main_profile_modification_ends_at_the_start_of_tip_relief(self, value: '_544.MainProfileReliefEndsAtTheStartOfTipReliefOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def measured_data(self) -> '_1341.Vector2DListAccessor':
    ...
    def measured_data(self, value: '_1341.Vector2DListAccessor'):
    ...
    @property
    def parabolic_root_relief_starts_tangent_to_main_profile_relief(self) -> '_546.ParabolicRootReliefStartsTangentToMainProfileRelief':
    ...
    def parabolic_root_relief_starts_tangent_to_main_profile_relief(self, value: '_546.ParabolicRootReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief(self) -> '_547.ParabolicTipReliefStartsTangentToMainProfileRelief':
    ...
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief(self, value: '_547.ParabolicTipReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
