...
class FaceGearSetRating(_325.GearSetRating):
    '''FaceGearSetRating
    ...
    @property
    def face_gear_set(self) -> '_926.FaceGearSetDesign':
        ...
        return constructor.new(_926.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet else None

    @property
    def face_mesh_ratings(self) -> 'List[_409.FaceGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshRatings, constructor.new(_409.FaceGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_410.FaceGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_410.FaceGearRating))
        return value
