...
from mastapy.gears.rating.face import _412, _410
from mastapy.gears.rating.cylindrical.iso6336 import _470, _472
...
class FaceGearMeshRating(_322.GearMeshRating):
    '''FaceGearMeshRating
    ...
    @property
    def active_flank(self) -> '_288.GearFlanks':
        ...
        return constructor.new(_288.GearFlanks)(value) if value else None

    @property
    def mesh_load_case(self) -> '_818.FaceMeshLoadCase':
        ...
        return constructor.new(_818.FaceMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None

    @property
    def gear_set_rating(self) -> '_412.FaceGearSetRating':
        ...
        return constructor.new(_412.FaceGearSetRating)(self.wrapped.GearSetRating) if self.wrapped.GearSetRating else None

    @property
    def mesh_single_flank_rating(self) -> '_470.ISO63362006MeshSingleFlankRating':
    ...
    @property
    def face_gear_mesh(self) -> '_922.FaceGearMeshDesign':
        ...
        return constructor.new(_922.FaceGearMeshDesign)(self.wrapped.FaceGearMesh) if self.wrapped.FaceGearMesh else None

    @property
    def face_gear_ratings(self) -> 'List[_410.FaceGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearRatings, constructor.new(_410.FaceGearRating))
        return value
