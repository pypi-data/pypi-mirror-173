...
from mastapy.gears.gear_designs.concept import _1090
...
class ConceptGearMeshRating(_322.GearMeshRating):
    '''ConceptGearMeshRating
    ...
    @property
    def concept_gear_mesh(self) -> '_1090.ConceptGearMeshDesign':
        ...
        return constructor.new(_1090.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
