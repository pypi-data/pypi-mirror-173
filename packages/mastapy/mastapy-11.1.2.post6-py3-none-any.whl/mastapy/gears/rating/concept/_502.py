...
class ConceptGearSetRating(_325.GearSetRating):
    '''ConceptGearSetRating
    ...
    @property
    def concept_gear_set(self) -> '_1091.ConceptGearSetDesign':
        ...
        return constructor.new(_1091.ConceptGearSetDesign)(self.wrapped.ConceptGearSet) if self.wrapped.ConceptGearSet else None

    @property
    def concept_mesh_ratings(self) -> 'List[_499.ConceptGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshRatings, constructor.new(_499.ConceptGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_500.ConceptGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_500.ConceptGearRating))
        return value

    @property
    def concept_gear_ratings(self) -> 'List[_500.ConceptGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearRatings, constructor.new(_500.ConceptGearRating))
        return value
