...
class BevelGearMeshRating(_519.AGMAGleasonConicalGearMeshRating):
    ...
    def gleason_bevel_mesh_single_flank_rating(self) -> '_514.GleasonSpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_514.GleasonSpiralBevelMeshSingleFlankRating)(self.wrapped.GleasonBevelMeshSingleFlankRating) if self.wrapped.GleasonBevelMeshSingleFlankRating is not None else None
    ...
    def agma_bevel_mesh_single_flank_rating(self) -> '_512.AGMASpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_512.AGMASpiralBevelMeshSingleFlankRating)(self.wrapped.AGMABevelMeshSingleFlankRating) if self.wrapped.AGMABevelMeshSingleFlankRating is not None else None
    ...
    def iso10300_bevel_mesh_single_flank_rating_method_b1(self) -> '_390.ISO10300MeshSingleFlankRatingMethodB1':
        ...
        return constructor.new(_390.ISO10300MeshSingleFlankRatingMethodB1)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1 is not None else None
    ...
    def iso10300_bevel_mesh_single_flank_rating_method_b2(self) -> '_388.Iso10300MeshSingleFlankRatingBevelMethodB2':
        ...
        return constructor.new(_388.Iso10300MeshSingleFlankRatingBevelMethodB2)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2 is not None else None
