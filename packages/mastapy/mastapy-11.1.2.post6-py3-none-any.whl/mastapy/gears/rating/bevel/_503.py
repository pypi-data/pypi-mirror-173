...
from mastapy.gears.rating.bevel.standards import _509, _507
from mastapy.gears.rating.iso_10300 import _387, _385
...
class BevelGearMeshRating(_514.AGMAGleasonConicalGearMeshRating):
    '''BevelGearMeshRating
    ...
    @property
    def gleason_bevel_mesh_single_flank_rating(self) -> '_509.GleasonSpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_509.GleasonSpiralBevelMeshSingleFlankRating)(self.wrapped.GleasonBevelMeshSingleFlankRating) if self.wrapped.GleasonBevelMeshSingleFlankRating else None

    @property
    def agma_bevel_mesh_single_flank_rating(self) -> '_507.AGMASpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_507.AGMASpiralBevelMeshSingleFlankRating)(self.wrapped.AGMABevelMeshSingleFlankRating) if self.wrapped.AGMABevelMeshSingleFlankRating else None

    @property
    def iso10300_bevel_mesh_single_flank_rating_method_b1(self) -> '_387.ISO10300MeshSingleFlankRatingMethodB1':
        ...
        return constructor.new(_387.ISO10300MeshSingleFlankRatingMethodB1)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1 else None

    @property
    def iso10300_bevel_mesh_single_flank_rating_method_b2(self) -> '_385.Iso10300MeshSingleFlankRatingBevelMethodB2':
        ...
        return constructor.new(_385.Iso10300MeshSingleFlankRatingBevelMethodB2)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2 else None
