...
from mastapy.gears.rating.bevel.standards import _508, _511
...
class GleasonSpiralBevelMeshSingleFlankRating(_511.SpiralBevelMeshSingleFlankRating):
    '''GleasonSpiralBevelMeshSingleFlankRating
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_508.GleasonSpiralBevelGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_508.GleasonSpiralBevelGearSingleFlankRating))
        return value

    @property
    def gleason_bevel_gear_single_flank_ratings(self) -> 'List[_508.GleasonSpiralBevelGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GleasonBevelGearSingleFlankRatings, constructor.new(_508.GleasonSpiralBevelGearSingleFlankRating))
        return value
