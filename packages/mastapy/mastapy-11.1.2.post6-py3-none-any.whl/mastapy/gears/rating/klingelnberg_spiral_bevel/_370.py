...
class KlingelnbergCycloPalloidSpiralBevelGearMeshRating(_376.KlingelnbergCycloPalloidConicalGearMeshRating):
    ...
    def kn3030_klingelnberg_mesh_single_flank_rating(self) -> '_384.KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_384.KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating)(self.wrapped.KN3030KlingelnbergMeshSingleFlankRating) if self.wrapped.KN3030KlingelnbergMeshSingleFlankRating is not None else None
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh(self) -> '_914.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign':
        ...
        return constructor.new(_914.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearMesh) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearMesh is not None else None
