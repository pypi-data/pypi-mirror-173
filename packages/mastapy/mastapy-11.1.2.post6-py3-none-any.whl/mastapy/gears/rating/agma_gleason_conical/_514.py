...
class AGMAGleasonConicalGearMeshRating(_488.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_1082.LoadDistributionFactorMethods':
        ...
        return constructor.new(_1082.LoadDistributionFactorMethods)(value) if value else None
