...
class AGMAGleasonConicalGearMeshRating(_487.ConicalGearMeshRating):
    ...
    @property
    def load_distribution_factor_method(self) -> '_1081.LoadDistributionFactorMethods':
        ...
        return constructor.new(_1081.LoadDistributionFactorMethods)(value) if value else None
