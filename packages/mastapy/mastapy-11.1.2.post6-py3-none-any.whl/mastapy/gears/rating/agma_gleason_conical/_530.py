...
class AGMAGleasonConicalGearMeshRating(_504.ConicalGearMeshRating):
    '''AGMAGleasonConicalGearMeshRating
    ...
    @property
    def load_distribution_factor_method(self) -> '_1121.LoadDistributionFactorMethods':
        ...
        return constructor.new(_1121.LoadDistributionFactorMethods)(value) if value is not None else None
