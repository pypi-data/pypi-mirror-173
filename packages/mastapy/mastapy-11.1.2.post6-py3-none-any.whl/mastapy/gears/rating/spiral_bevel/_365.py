...
class SpiralBevelGearRating(_504.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_900.SpiralBevelGearDesign':
        ...
        return constructor.new(_900.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
