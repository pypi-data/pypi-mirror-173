...
class SpiralBevelGearMeshRating(_519.BevelGearMeshRating):
    '''SpiralBevelGearMeshRating
    ...
    @property
    def spiral_bevel_gear_mesh(self) -> '_932.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_932.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMesh) if self.wrapped.SpiralBevelGearMesh is not None else None

    @property
    def spiral_bevel_gear_ratings(self) -> 'List[_374.SpiralBevelGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearRatings, constructor.new(_374.SpiralBevelGearRating))
        return value
