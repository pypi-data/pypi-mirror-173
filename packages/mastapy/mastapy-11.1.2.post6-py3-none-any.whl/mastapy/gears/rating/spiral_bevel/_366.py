...
from mastapy.gears.rating.spiral_bevel import _364, _365
...
class SpiralBevelGearSetRating(_505.BevelGearSetRating):
    '''SpiralBevelGearSetRating
    ...
    @property
    def spiral_bevel_mesh_ratings(self) -> 'List[_364.SpiralBevelGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshRatings, constructor.new(_364.SpiralBevelGearMeshRating))
        return value
