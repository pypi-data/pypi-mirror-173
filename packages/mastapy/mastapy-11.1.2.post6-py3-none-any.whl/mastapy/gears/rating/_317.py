...
from mastapy.gears.rating import _316, _315
...
class AbstractGearSetRating(_1127.AbstractGearSetAnalysis):
    '''AbstractGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_316.AbstractGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_316.AbstractGearRating))
        return value

    @property
    def gear_mesh_ratings(self) -> 'List[_315.AbstractGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshRatings, constructor.new(_315.AbstractGearMeshRating))
        return value
