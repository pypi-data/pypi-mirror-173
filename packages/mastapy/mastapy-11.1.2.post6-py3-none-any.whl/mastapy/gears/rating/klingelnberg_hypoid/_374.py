...
class KlingelnbergCycloPalloidHypoidGearRating(_377.KlingelnbergCycloPalloidConicalGearRating):
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_917.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_917.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGear) if self.wrapped.KlingelnbergCycloPalloidHypoidGear is not None else None
