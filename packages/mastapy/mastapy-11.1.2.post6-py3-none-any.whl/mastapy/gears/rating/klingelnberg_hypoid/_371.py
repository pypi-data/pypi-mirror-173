...
class KlingelnbergCycloPalloidHypoidGearRating(_374.KlingelnbergCycloPalloidConicalGearRating):
    '''KlingelnbergCycloPalloidHypoidGearRating
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_908.KlingelnbergCycloPalloidHypoidGearDesign':
        ...
        return constructor.new(_908.KlingelnbergCycloPalloidHypoidGearDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGear) if self.wrapped.KlingelnbergCycloPalloidHypoidGear else None
