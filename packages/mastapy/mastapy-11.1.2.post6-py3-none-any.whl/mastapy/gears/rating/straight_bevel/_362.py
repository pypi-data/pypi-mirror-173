...
class StraightBevelGearRating(_504.BevelGearRating):
    '''StraightBevelGearRating
    ...
    @property
    def straight_bevel_gear(self) -> '_896.StraightBevelGearDesign':
        ...
        return constructor.new(_896.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear else None
