...
class StraightBevelGearMeshRating(_519.BevelGearMeshRating):
    '''StraightBevelGearMeshRating
    ...
    @property
    def straight_bevel_gear_mesh(self) -> '_928.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_928.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMesh) if self.wrapped.StraightBevelGearMesh is not None else None
