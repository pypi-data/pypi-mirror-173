...
class StraightBevelGearMeshRating(_503.BevelGearMeshRating):
    '''StraightBevelGearMeshRating
    ...
    @property
    def straight_bevel_gear_mesh(self) -> '_897.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_897.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMesh) if self.wrapped.StraightBevelGearMesh else None
