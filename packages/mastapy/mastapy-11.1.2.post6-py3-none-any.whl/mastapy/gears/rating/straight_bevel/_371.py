...
class StraightBevelGearRating(_520.BevelGearRating):
    '''StraightBevelGearRating
    ...
    @property
    def straight_bevel_gear(self) -> '_927.StraightBevelGearDesign':
        ...
        return constructor.new(_927.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear is not None else None
