...
from mastapy.gears.rating.hypoid import _400, _401
...
class HypoidGearSetRating(_516.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_mesh_ratings(self) -> 'List[_400.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_400.HypoidGearMeshRating))
        return value
