...
class HypoidGearRating(_515.AGMAGleasonConicalGearRating):
    '''HypoidGearRating
    ...
    @property
    def hypoid_gear(self) -> '_916.HypoidGearDesign':
        ...
        return constructor.new(_916.HypoidGearDesign)(self.wrapped.HypoidGear) if self.wrapped.HypoidGear else None
