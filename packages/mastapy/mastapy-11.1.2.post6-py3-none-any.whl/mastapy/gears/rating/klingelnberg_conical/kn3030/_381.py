...
from mastapy.gears.rating.klingelnberg_conical.kn3030 import _378, _376
...
class KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating(_376.KlingelnbergConicalMeshSingleFlankRating):
    '''KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_378.KlingelnbergCycloPalloidConicalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_378.KlingelnbergCycloPalloidConicalGearSingleFlankRating))
        return value

    @property
    def kn3030_klingelnberg_gear_single_flank_ratings(self) -> 'List[_378.KlingelnbergCycloPalloidConicalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KN3030KlingelnbergGearSingleFlankRatings, constructor.new(_378.KlingelnbergCycloPalloidConicalGearSingleFlankRating))
        return value
