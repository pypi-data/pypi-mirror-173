...
from mastapy.gears.rating.virtual_cylindrical_gears import _358
...
class KlingelnbergConicalMeshSingleFlankRating(_337.MeshSingleFlankRating):
    '''KlingelnbergConicalMeshSingleFlankRating
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_358.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_358.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet is not None else None
