...
from mastapy.gears.rating.klingelnberg_conical.kn3030 import _382, _379
...
class KlingelnbergCycloPalloidHypoidMeshSingleFlankRating(_379.KlingelnbergConicalMeshSingleFlankRating):
    '''KlingelnbergCycloPalloidHypoidMeshSingleFlankRating
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_382.KlingelnbergCycloPalloidHypoidGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_382.KlingelnbergCycloPalloidHypoidGearSingleFlankRating))
        return value

    @property
    def kn3030_klingelnberg_gear_single_flank_ratings(self) -> 'List[_382.KlingelnbergCycloPalloidHypoidGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KN3030KlingelnbergGearSingleFlankRatings, constructor.new(_382.KlingelnbergCycloPalloidHypoidGearSingleFlankRating))
        return value
