...
class KlingelnbergConicalMeshSingleFlankRating(_328.MeshSingleFlankRating):
    '''KlingelnbergConicalMeshSingleFlankRating
    ...
    @property
    def virtual_cylindrical_gear_set(self) -> '_349.KlingelnbergVirtualCylindricalGearSet':
        ...
        return constructor.new(_349.KlingelnbergVirtualCylindricalGearSet)(self.wrapped.VirtualCylindricalGearSet) if self.wrapped.VirtualCylindricalGearSet else None
