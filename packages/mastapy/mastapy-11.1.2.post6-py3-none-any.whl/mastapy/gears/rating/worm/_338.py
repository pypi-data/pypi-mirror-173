...
class WormGearSetRating(_325.GearSetRating):
    '''WormGearSetRating
    ...
    @property
    def worm_mesh_ratings(self) -> 'List[_335.WormGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshRatings, constructor.new(_335.WormGearMeshRating))
        return value
