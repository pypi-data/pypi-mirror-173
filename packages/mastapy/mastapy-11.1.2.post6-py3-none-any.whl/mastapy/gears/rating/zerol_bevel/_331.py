...
class ZerolBevelGearMeshRating(_503.BevelGearMeshRating):
    '''ZerolBevelGearMeshRating
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_884.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_884.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh else None
