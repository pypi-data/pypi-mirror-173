...
class ZerolBevelGearMeshRating(_519.BevelGearMeshRating):
    '''ZerolBevelGearMeshRating
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_915.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_915.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh is not None else None

    @property
    def zerol_bevel_gear_ratings(self) -> 'List[_341.ZerolBevelGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearRatings, constructor.new(_341.ZerolBevelGearRating))
        return value
