...
from mastapy.gears.rating.cylindrical import _415, _416, _445
...
class CylindricalGearRating(_323.GearRating):
    '''CylindricalGearRating
    ...
    @property
    def vdi2737_safety_factor(self) -> '_445.VDI2737SafetyFactorReportingObject':
        ...
        return constructor.new(_445.VDI2737SafetyFactorReportingObject)(self.wrapped.VDI2737SafetyFactor) if self.wrapped.VDI2737SafetyFactor else None
