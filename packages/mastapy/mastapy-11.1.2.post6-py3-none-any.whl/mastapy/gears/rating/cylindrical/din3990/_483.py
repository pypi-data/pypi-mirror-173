...
from mastapy.gears.rating.cylindrical import _438, _439
...
class DIN3990MeshSingleFlankRating(_468.ISO63361996MeshSingleFlankRating):
    '''DIN3990MeshSingleFlankRating
    ...
    @property
    def scuffing_rating_method_flash_temperature_method(self) -> '_438.ScuffingFlashTemperatureRatingMethod':
        ...
        return constructor.new(_438.ScuffingFlashTemperatureRatingMethod)(value) if value else None

    @property
    def scuffing_rating_method_integral_temperature_method(self) -> '_439.ScuffingIntegralTemperatureRatingMethod':
        ...
        return constructor.new(_439.ScuffingIntegralTemperatureRatingMethod)(value) if value else None
