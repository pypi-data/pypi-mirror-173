...
class CylindricalGearMicroPittingResults(_0.APIBase):
    ...
    @property
    def micro_pitting_results_row(self) -> 'List[_435.MicroPittingResultsRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroPittingResultsRow, constructor.new(_435.MicroPittingResultsRow))
        return value
