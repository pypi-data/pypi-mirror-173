...
class PlasticSNCurveForTheSpecifiedOperatingConditions(_552.PlasticSNCurve):
    '''PlasticSNCurveForTheSpecifiedOperatingConditions
    ...
    @property
    def lubricant(self) -> '_253.VDI2736LubricantType':
        ...
        return constructor.new(_253.VDI2736LubricantType)(value) if value else None

    @lubricant.setter
    def lubricant(self, value: '_253.VDI2736LubricantType'):
