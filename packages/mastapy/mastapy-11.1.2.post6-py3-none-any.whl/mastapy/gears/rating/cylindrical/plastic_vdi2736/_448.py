...
from mastapy.materials import _250, _251
...
class PlasticGearVDI2736AbstractGearSingleFlankRating(_473.ISO6336AbstractGearSingleFlankRating):
    '''PlasticGearVDI2736AbstractGearSingleFlankRating
    ...
    @property
    def is_gear_driving_or_driven(self) -> '_319.FlankLoadingState':
        ...
        return constructor.new(_319.FlankLoadingState)(value) if value else None
    ...
    @property
    def standard_plastic_sn_curve_for_the_specified_operating_conditions(self) -> '_452.PlasticSNCurveForTheSpecifiedOperatingConditions':
        ...
        return constructor.new(_452.PlasticSNCurveForTheSpecifiedOperatingConditions)(self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions) if self.wrapped.StandardPlasticSNCurveForTheSpecifiedOperatingConditions else None

    @property
    def bending_stress_cycle_data_for_damage_tables(self) -> 'List[_250.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BendingStressCycleDataForDamageTables, constructor.new(_250.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial))
        return value

    @property
    def contact_stress_cycle_data_for_damage_tables(self) -> 'List[_251.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactStressCycleDataForDamageTables, constructor.new(_251.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial))
        return value
