...
class PlasticGearVDI2736AbstractMeshSingleFlankRating(_474.ISO6336AbstractMeshSingleFlankRating):
    '''PlasticGearVDI2736AbstractMeshSingleFlankRating
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_448.PlasticGearVDI2736AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_448.PlasticGearVDI2736AbstractGearSingleFlankRating))
        return value

    @property
    def plastic_vdi2736_cylindrical_gear_single_flank_ratings(self) -> 'List[_448.PlasticGearVDI2736AbstractGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlasticVDI2736CylindricalGearSingleFlankRatings, constructor.new(_448.PlasticGearVDI2736AbstractGearSingleFlankRating))
        return value
