...
class CylindricalGearSetRatingOptimisationHelper(_0.APIBase):
    ...
    @property
    def profile_shift_coefficient_optimisation_results(self) -> '_468.OptimisationResultsPair[_472.SafetyFactorOptimisationStepResultNumber]':
        ...
        return constructor.new(_468.OptimisationResultsPair)[_472.SafetyFactorOptimisationStepResultNumber](self.wrapped.ProfileShiftCoefficientOptimisationResults) if self.wrapped.ProfileShiftCoefficientOptimisationResults is not None else None

    @property
    def helix_angle_optimisation_results(self) -> '_468.OptimisationResultsPair[_471.SafetyFactorOptimisationStepResultAngle]':
        ...
        return constructor.new(_468.OptimisationResultsPair)[_471.SafetyFactorOptimisationStepResultAngle](self.wrapped.HelixAngleOptimisationResults) if self.wrapped.HelixAngleOptimisationResults is not None else None

    @property
    def normal_module_optimisation_results(self) -> '_468.OptimisationResultsPair[_473.SafetyFactorOptimisationStepResultShortLength]':
        ...
        return constructor.new(_468.OptimisationResultsPair)[_473.SafetyFactorOptimisationStepResultShortLength](self.wrapped.NormalModuleOptimisationResults) if self.wrapped.NormalModuleOptimisationResults is not None else None

    @property
    def pressure_angle_optimisation_results(self) -> '_468.OptimisationResultsPair[_471.SafetyFactorOptimisationStepResultAngle]':
        ...
        return constructor.new(_468.OptimisationResultsPair)[_471.SafetyFactorOptimisationStepResultAngle](self.wrapped.PressureAngleOptimisationResults) if self.wrapped.PressureAngleOptimisationResults is not None else None

    @property
    def all_normal_module_optimisation_results(self) -> 'List[_469.SafetyFactorOptimisationResults[_473.SafetyFactorOptimisationStepResultShortLength]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllNormalModuleOptimisationResults, constructor.new(_469.SafetyFactorOptimisationResults)[_473.SafetyFactorOptimisationStepResultShortLength])
        return value

    @property
    def all_helix_angle_optimisation_results(self) -> 'List[_469.SafetyFactorOptimisationResults[_471.SafetyFactorOptimisationStepResultAngle]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllHelixAngleOptimisationResults, constructor.new(_469.SafetyFactorOptimisationResults)[_471.SafetyFactorOptimisationStepResultAngle])
        return value

    @property
    def all_normal_pressure_angle_optimisation_results(self) -> 'List[_469.SafetyFactorOptimisationResults[_471.SafetyFactorOptimisationStepResultAngle]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllNormalPressureAngleOptimisationResults, constructor.new(_469.SafetyFactorOptimisationResults)[_471.SafetyFactorOptimisationStepResultAngle])
        return value

    @property
    def helix_angle_and_normal_pressure_angle_optimisation_results(self) -> 'List[_469.SafetyFactorOptimisationResults[_471.SafetyFactorOptimisationStepResultAngle]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HelixAngleAndNormalPressureAngleOptimisationResults, constructor.new(_469.SafetyFactorOptimisationResults)[_471.SafetyFactorOptimisationStepResultAngle])
        return value

    @property
    def all_profile_shift_optimisation_results(self) -> 'List[_469.SafetyFactorOptimisationResults[_472.SafetyFactorOptimisationStepResultNumber]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllProfileShiftOptimisationResults, constructor.new(_469.SafetyFactorOptimisationResults)[_472.SafetyFactorOptimisationStepResultNumber])
        return value
