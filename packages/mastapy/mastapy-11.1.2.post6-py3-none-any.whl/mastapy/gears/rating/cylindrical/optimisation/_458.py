...
class CylindricalGearSetRatingOptimisationHelper(_0.APIBase):
    ...
    @property
    def profile_shift_coefficient_optimisation_results(self) -> '_459.OptimisationResultsPair[_463.SafetyFactorOptimisationStepResultNumber]':
        ...
        return constructor.new(_459.OptimisationResultsPair)[_463.SafetyFactorOptimisationStepResultNumber](self.wrapped.ProfileShiftCoefficientOptimisationResults) if self.wrapped.ProfileShiftCoefficientOptimisationResults else None

    @property
    def helix_angle_optimisation_results(self) -> '_459.OptimisationResultsPair[_462.SafetyFactorOptimisationStepResultAngle]':
        ...
        return constructor.new(_459.OptimisationResultsPair)[_462.SafetyFactorOptimisationStepResultAngle](self.wrapped.HelixAngleOptimisationResults) if self.wrapped.HelixAngleOptimisationResults else None

    @property
    def normal_module_optimisation_results(self) -> '_459.OptimisationResultsPair[_464.SafetyFactorOptimisationStepResultShortLength]':
        ...
        return constructor.new(_459.OptimisationResultsPair)[_464.SafetyFactorOptimisationStepResultShortLength](self.wrapped.NormalModuleOptimisationResults) if self.wrapped.NormalModuleOptimisationResults else None

    @property
    def pressure_angle_optimisation_results(self) -> '_459.OptimisationResultsPair[_462.SafetyFactorOptimisationStepResultAngle]':
        ...
        return constructor.new(_459.OptimisationResultsPair)[_462.SafetyFactorOptimisationStepResultAngle](self.wrapped.PressureAngleOptimisationResults) if self.wrapped.PressureAngleOptimisationResults else None

    @property
    def all_normal_module_optimisation_results(self) -> 'List[_460.SafetyFactorOptimisationResults[_464.SafetyFactorOptimisationStepResultShortLength]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllNormalModuleOptimisationResults, constructor.new(_460.SafetyFactorOptimisationResults)[_464.SafetyFactorOptimisationStepResultShortLength])
        return value

    @property
    def all_helix_angle_optimisation_results(self) -> 'List[_460.SafetyFactorOptimisationResults[_462.SafetyFactorOptimisationStepResultAngle]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllHelixAngleOptimisationResults, constructor.new(_460.SafetyFactorOptimisationResults)[_462.SafetyFactorOptimisationStepResultAngle])
        return value

    @property
    def all_normal_pressure_angle_optimisation_results(self) -> 'List[_460.SafetyFactorOptimisationResults[_462.SafetyFactorOptimisationStepResultAngle]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllNormalPressureAngleOptimisationResults, constructor.new(_460.SafetyFactorOptimisationResults)[_462.SafetyFactorOptimisationStepResultAngle])
        return value

    @property
    def helix_angle_and_normal_pressure_angle_optimisation_results(self) -> 'List[_460.SafetyFactorOptimisationResults[_462.SafetyFactorOptimisationStepResultAngle]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HelixAngleAndNormalPressureAngleOptimisationResults, constructor.new(_460.SafetyFactorOptimisationResults)[_462.SafetyFactorOptimisationStepResultAngle])
        return value

    @property
    def all_profile_shift_optimisation_results(self) -> 'List[_460.SafetyFactorOptimisationResults[_463.SafetyFactorOptimisationStepResultNumber]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllProfileShiftOptimisationResults, constructor.new(_460.SafetyFactorOptimisationResults)[_463.SafetyFactorOptimisationStepResultNumber])
        return value
