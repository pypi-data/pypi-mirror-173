...
class SafetyFactorOptimisationStepResult(_0.APIBase):
    ...
    @property
    def safety_factors(self) -> '_330.SafetyFactorResults':
        ...
        return constructor.new(_330.SafetyFactorResults)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors else None

    @property
    def normalised_safety_factors(self) -> '_330.SafetyFactorResults':
        ...
        return constructor.new(_330.SafetyFactorResults)(self.wrapped.NormalisedSafetyFactors) if self.wrapped.NormalisedSafetyFactors else None
