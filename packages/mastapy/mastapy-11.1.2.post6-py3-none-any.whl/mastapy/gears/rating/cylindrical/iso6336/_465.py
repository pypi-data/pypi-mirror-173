...
class CylindricalGearToothFatigueFractureResults(_0.APIBase):
    ...
    @property
    def critical_section(self) -> '_480.ToothFlankFractureAnalysisContactPoint':
        ...
        return constructor.new(_480.ToothFlankFractureAnalysisContactPoint)(self.wrapped.CriticalSection) if self.wrapped.CriticalSection else None

    @property
    def analysis_rows(self) -> 'List[_480.ToothFlankFractureAnalysisContactPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AnalysisRows, constructor.new(_480.ToothFlankFractureAnalysisContactPoint))
        return value
