...
from mastapy.gears.rating.cylindrical.iso6336 import _465, _475
...
class ISO63362006GearSingleFlankRating(_475.ISO6336AbstractMetalGearSingleFlankRating):
    '''ISO63362006GearSingleFlankRating
    ...
    @property
    def tooth_fatigue_fracture_results(self) -> '_465.CylindricalGearToothFatigueFractureResults':
        ...
        return constructor.new(_465.CylindricalGearToothFatigueFractureResults)(self.wrapped.ToothFatigueFractureResults) if self.wrapped.ToothFatigueFractureResults else None
