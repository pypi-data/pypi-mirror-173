...
class VDI2737InternalGearSingleFlankRating(_0.APIBase):
    ...
    @property
    def iso_gear_rating(self) -> '_475.ISO6336AbstractMetalGearSingleFlankRating':
        ...
        if _475.ISO6336AbstractMetalGearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_iso63361996_gear_single_flank_rating(self) -> '_467.ISO63361996GearSingleFlankRating':
        ...
        if _467.ISO63361996GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_iso63362006_gear_single_flank_rating(self) -> '_469.ISO63362006GearSingleFlankRating':
        ...
        if _469.ISO63362006GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_iso63362019_gear_single_flank_rating(self) -> '_471.ISO63362019GearSingleFlankRating':
        ...
        if _471.ISO63362019GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
    ...
    @property
    def iso_gear_rating_of_type_din3990_gear_single_flank_rating(self) -> '_482.DIN3990GearSingleFlankRating':
        ...
        if _482.DIN3990GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
