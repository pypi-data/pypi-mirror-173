...
class CylindricalGearRatingSettings(_1351.PerMachineSettings):
    '''CylindricalGearRatingSettings
    ...
    @property
    def tip_relief_in_scuffing_calculation(self) -> '_443.TipReliefScuffingOptions':
        ...
        return constructor.new(_443.TipReliefScuffingOptions)(value) if value else None

    @tip_relief_in_scuffing_calculation.setter
    def tip_relief_in_scuffing_calculation(self, value: '_443.TipReliefScuffingOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TipReliefInScuffingCalculation = value

    @property
    def dynamic_factor_method(self) -> '_430.DynamicFactorMethods':
        ...
        return constructor.new(_430.DynamicFactorMethods)(value) if value else None

    @dynamic_factor_method.setter
    def dynamic_factor_method(self, value: '_430.DynamicFactorMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gear_blank_factor_calculation_option(self) -> '_431.GearBlankFactorCalculationOptions':
        ...
        return constructor.new(_431.GearBlankFactorCalculationOptions)(value) if value else None

    @gear_blank_factor_calculation_option.setter
    def gear_blank_factor_calculation_option(self, value: '_431.GearBlankFactorCalculationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def film_thickness_equation_for_scuffing(self) -> '_440.ScuffingMethods':
        ...
        return constructor.new(_440.ScuffingMethods)(value) if value else None

    @film_thickness_equation_for_scuffing.setter
    def film_thickness_equation_for_scuffing(self, value: '_440.ScuffingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FilmThicknessEquationForScuffing = value

    @property
    def micropitting_rating_method(self) -> '_434.MicropittingRatingMethod':
        ...
        return constructor.new(_434.MicropittingRatingMethod)(value) if value else None

    @micropitting_rating_method.setter
    def micropitting_rating_method(self, value: '_434.MicropittingRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def permissible_bending_stress_method(self) -> '_437.RatingMethod':
        ...
        return constructor.new(_437.RatingMethod)(value) if value else None

    @permissible_bending_stress_method.setter
    def permissible_bending_stress_method(self, value: '_437.RatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chosen_tooth_thickness_for_bending_strength(self) -> '_444.ToothThicknesses':
        ...
        return constructor.new(_444.ToothThicknesses)(value) if value else None

    @chosen_tooth_thickness_for_bending_strength.setter
    def chosen_tooth_thickness_for_bending_strength(self, value: '_444.ToothThicknesses'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
