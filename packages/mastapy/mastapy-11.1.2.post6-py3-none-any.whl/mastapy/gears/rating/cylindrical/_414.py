...
class CylindricalGearDutyCycleRating(_320.GearDutyCycleRating):
    '''CylindricalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_423.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_423.CylindricalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def cylindrical_gear_set_design_duty_cycle(self) -> '_423.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_423.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetDesignDutyCycle) if self.wrapped.CylindricalGearSetDesignDutyCycle else None

    @property
    def gear_ratings(self) -> 'List[_419.CylindricalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_419.CylindricalGearRating))
        return value
    ...
    @property
    def cylindrical_gear_mesh_ratings(self) -> 'List[_433.MeshRatingForReports]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshRatings, constructor.new(_433.MeshRatingForReports))
        return value
