...
from mastapy.gears.gear_designs.cylindrical import _956, _999
...
class AGMA2101MeshSingleFlankRating(_427.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def gearing_type(self) -> '_222.GearingTypes':
        ...
        return constructor.new(_222.GearingTypes)(value) if value else None

    @property
    def scuffing_temperature_method(self) -> '_999.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_999.ScuffingTemperatureMethodsAGMA)(value) if value else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_484.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_484.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_484.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_484.AGMA2101GearSingleFlankRating))
        return value
