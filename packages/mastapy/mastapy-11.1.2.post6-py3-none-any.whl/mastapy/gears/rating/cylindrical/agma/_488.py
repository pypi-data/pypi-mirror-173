...
from mastapy.gears.gear_designs.cylindrical import _964, _1008
from mastapy.materials import _225
from mastapy.gears.rating.cylindrical.agma import _487
...
class AGMA2101MeshSingleFlankRating(_430.CylindricalMeshSingleFlankRating):
    ...
    @property
    def scuffing_temperature_method(self) -> '_1008.ScuffingTemperatureMethodsAGMA':
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_487.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_487.AGMA2101GearSingleFlankRating))
        return value

    @property
    def agma_cylindrical_gear_single_flank_ratings(self) -> 'List[_487.AGMA2101GearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AGMACylindricalGearSingleFlankRatings, constructor.new(_487.AGMA2101GearSingleFlankRating))
        return value
