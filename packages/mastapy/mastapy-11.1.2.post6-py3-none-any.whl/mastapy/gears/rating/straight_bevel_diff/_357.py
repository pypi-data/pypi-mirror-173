...
from mastapy.gears.rating.straight_bevel_diff import _360, _358
...
class StraightBevelDiffGearMeshRating(_488.ConicalGearMeshRating):
    '''StraightBevelDiffGearMeshRating
    ...
    @property
    def straight_bevel_diff_gear_mesh(self) -> '_893.StraightBevelDiffGearMeshDesign':
        ...
        return constructor.new(_893.StraightBevelDiffGearMeshDesign)(self.wrapped.StraightBevelDiffGearMesh) if self.wrapped.StraightBevelDiffGearMesh else None

    @property
    def meshed_gears(self) -> 'List[_360.StraightBevelDiffMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_360.StraightBevelDiffMeshedGearRating))
        return value

    @property
    def gears_in_mesh(self) -> 'List[_360.StraightBevelDiffMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsInMesh, constructor.new(_360.StraightBevelDiffMeshedGearRating))
        return value

    @property
    def straight_bevel_diff_gear_ratings(self) -> 'List[_358.StraightBevelDiffGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearRatings, constructor.new(_358.StraightBevelDiffGearRating))
        return value
