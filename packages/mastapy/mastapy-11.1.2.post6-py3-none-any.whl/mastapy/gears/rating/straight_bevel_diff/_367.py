...
class StraightBevelDiffGearRating(_505.ConicalGearRating):
    '''StraightBevelDiffGearRating
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_923.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_923.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear is not None else None
