...
class StraightBevelDiffGearRating(_494.ConicalGearRating):
    ...
    def straight_bevel_diff_gear(self) -> '_901.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_901.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear is not None else None
