...
class StraightBevelDiffGearRating(_489.ConicalGearRating):
    '''StraightBevelDiffGearRating
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_892.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_892.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear else None
