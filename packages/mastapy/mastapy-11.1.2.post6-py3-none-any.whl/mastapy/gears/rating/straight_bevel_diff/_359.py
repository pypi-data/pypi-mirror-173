...
from mastapy.gears.rating.straight_bevel_diff import _357, _358
...
class StraightBevelDiffGearSetRating(_491.ConicalGearSetRating):
    '''StraightBevelDiffGearSetRating
    ...
    @property
    def straight_bevel_diff_mesh_ratings(self) -> 'List[_357.StraightBevelDiffGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshRatings, constructor.new(_357.StraightBevelDiffGearMeshRating))
        return value
