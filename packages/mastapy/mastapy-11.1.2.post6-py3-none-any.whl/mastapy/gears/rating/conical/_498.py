...
class ConicalMeshDutyCycleRating(_330.MeshDutyCycleRating):
    ...
    @property
    def conical_mesh_ratings(self) -> 'List[_493.ConicalGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshRatings, constructor.new(_493.ConicalGearMeshRating))
        return value
