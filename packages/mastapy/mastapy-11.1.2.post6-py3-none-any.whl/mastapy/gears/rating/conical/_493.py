...
class ConicalMeshDutyCycleRating(_327.MeshDutyCycleRating):
    '''ConicalMeshDutyCycleRating
    ...
    @property
    def conical_mesh_ratings(self) -> 'List[_488.ConicalGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshRatings, constructor.new(_488.ConicalGearMeshRating))
        return value
