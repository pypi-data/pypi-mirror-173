...
class ConicalGearSetDutyCycleRating(_324.GearSetDutyCycleRating):
    '''ConicalGearSetDutyCycleRating
    ...
    @property
    def gear_mesh_duty_cycle_ratings(self) -> 'List[_493.ConicalMeshDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshDutyCycleRatings, constructor.new(_493.ConicalMeshDutyCycleRating))
        return value

    @property
    def conical_mesh_duty_cycle_ratings(self) -> 'List[_493.ConicalMeshDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshDutyCycleRatings, constructor.new(_493.ConicalMeshDutyCycleRating))
        return value
