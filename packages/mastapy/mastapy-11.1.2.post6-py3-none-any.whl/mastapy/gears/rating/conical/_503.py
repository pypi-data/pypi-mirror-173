...
from mastapy.gears.rating.conical import _506, _505
from mastapy._internal import constructor, conversion
from mastapy.gears.rating import _330, _329
from mastapy.gears.rating.cylindrical import _424, _425
...
class ConicalGearDutyCycleRating(_329.GearDutyCycleRating):
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_506.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_506.ConicalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle is not None else None

    @property
    def conical_gear_set_design_duty_cycle(self) -> '_506.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_506.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDesignDutyCycle) if self.wrapped.ConicalGearSetDesignDutyCycle is not None else None

    @property
    def left_flank_rating(self) -> '_330.GearFlankRating':
        ...
        if _330.GearFlankRating.TYPE not in self.wrapped.LeftFlankRating.__class__.__mro__:
    ...
    @property
    def concave_flank_rating(self) -> '_330.GearFlankRating':
        ...
        if _330.GearFlankRating.TYPE not in self.wrapped.ConcaveFlankRating.__class__.__mro__:
    ...
    @property
    def right_flank_rating(self) -> '_330.GearFlankRating':
        ...
        if _330.GearFlankRating.TYPE not in self.wrapped.RightFlankRating.__class__.__mro__:
    ...
    @property
    def convex_flank_rating(self) -> '_330.GearFlankRating':
        ...
        if _330.GearFlankRating.TYPE not in self.wrapped.ConvexFlankRating.__class__.__mro__:
    ...
    @property
    def gear_ratings(self) -> 'List[_505.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_505.ConicalGearRating))
        return value

    @property
    def conical_gear_ratings(self) -> 'List[_505.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGearRatings, constructor.new(_505.ConicalGearRating))
        return value
