...
from mastapy.gears.rating.conical import _490, _489
...
class ConicalGearDutyCycleRating(_320.GearDutyCycleRating):
    '''ConicalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self) -> '_490.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_490.ConicalGearSetDutyCycleRating)(self.wrapped.GearSetDesignDutyCycle) if self.wrapped.GearSetDesignDutyCycle else None

    @property
    def conical_gear_set_design_duty_cycle(self) -> '_490.ConicalGearSetDutyCycleRating':
        ...
        return constructor.new(_490.ConicalGearSetDutyCycleRating)(self.wrapped.ConicalGearSetDesignDutyCycle) if self.wrapped.ConicalGearSetDesignDutyCycle else None
    ...
    @property
    def gear_ratings(self) -> 'List[_489.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_489.ConicalGearRating))
        return value

    @property
    def conical_gear_ratings(self) -> 'List[_489.ConicalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGearRatings, constructor.new(_489.ConicalGearRating))
        return value
