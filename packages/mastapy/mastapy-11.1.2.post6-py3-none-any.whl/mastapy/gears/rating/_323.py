...
from mastapy.gears.rating import _318, _316
...
class GearRating(_316.AbstractGearRating):
    '''GearRating
    ...
    @property
    def static_safety_factor(self) -> '_318.BendingAndContactReportingObject':
        ...
        return constructor.new(_318.BendingAndContactReportingObject)(self.wrapped.StaticSafetyFactor) if self.wrapped.StaticSafetyFactor else None

    @property
    def bending_safety_factor_results(self) -> '_245.SafetyFactorItem':
        ...
        if _245.SafetyFactorItem.TYPE not in self.wrapped.BendingSafetyFactorResults.__class__.__mro__:
    ...
    @property
    def contact_safety_factor_results(self) -> '_245.SafetyFactorItem':
        ...
        if _245.SafetyFactorItem.TYPE not in self.wrapped.ContactSafetyFactorResults.__class__.__mro__:
