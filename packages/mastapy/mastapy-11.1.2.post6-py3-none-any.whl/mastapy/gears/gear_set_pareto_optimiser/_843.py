...
class GearNameMapper(_0.APIBase):
    ...
    @property
    def gear_name_pickers(self) -> 'List[_844.GearNamePicker]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearNamePickers, constructor.new(_844.GearNamePicker))
        return value
