...
class FaceGearSetParetoOptimiser(_846.GearSetParetoOptimiser):
    '''FaceGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_926.FaceGearSetDesign':
        ...
        return constructor.new(_926.FaceGearSetDesign)(self.wrapped.SelectedCandidateGeometry) if self.wrapped.SelectedCandidateGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_926.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_926.FaceGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_926.FaceGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_926.FaceGearSetDesign))
        return value
