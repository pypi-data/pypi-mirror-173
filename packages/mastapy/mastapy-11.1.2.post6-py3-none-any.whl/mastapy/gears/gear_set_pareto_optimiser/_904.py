...
class SpiralBevelGearSetParetoOptimiser(_878.GearSetParetoOptimiser):
    """SpiralBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_934.SpiralBevelGearSetDesign':
    ...
    @property
    def all_candidate_gear_sets(self) -> 'List[_934.SpiralBevelGearSetDesign]':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_934.SpiralBevelGearSetDesign]':
