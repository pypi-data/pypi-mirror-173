...
class HypoidGearSetParetoOptimiser(_846.GearSetParetoOptimiser):
    '''HypoidGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_918.HypoidGearSetDesign':
        ...
        return constructor.new(_918.HypoidGearSetDesign)(self.wrapped.SelectedCandidateGeometry) if self.wrapped.SelectedCandidateGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_918.HypoidGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_918.HypoidGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_918.HypoidGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_918.HypoidGearSetDesign))
        return value
