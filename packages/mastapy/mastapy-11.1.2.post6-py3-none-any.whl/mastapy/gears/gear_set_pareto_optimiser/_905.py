...
class StraightBevelGearSetParetoOptimiser(_878.GearSetParetoOptimiser):
    """StraightBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_926.StraightBevelGearSetDesign':
    ...
    @property
    def all_candidate_gear_sets(self) -> 'List[_926.StraightBevelGearSetDesign]':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_926.StraightBevelGearSetDesign]':
