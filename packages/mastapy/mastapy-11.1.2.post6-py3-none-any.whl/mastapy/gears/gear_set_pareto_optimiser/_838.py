...
from mastapy.utility.reporting_property_framework import _1481
...
TAnalysis = TypeVar('TAnalysis', bound='_1127.AbstractGearSetAnalysis')
...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def chart_type(self) -> '_1481.CustomChartType':
        ...
        return constructor.new(_1481.CustomChartType)(value) if value else None
    ...
    @property
    def optimiser(self) -> '_840.DesignSpaceSearchBase[TAnalysis, TCandidate]':
        ...
        if _840.DesignSpaceSearchBase[TAnalysis, TCandidate].TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_cylindrical_gear_set_pareto_optimiser(self) -> '_839.CylindricalGearSetParetoOptimiser':
        ...
        if _839.CylindricalGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_face_gear_set_pareto_optimiser(self) -> '_842.FaceGearSetParetoOptimiser':
        ...
        if _842.FaceGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_gear_set_pareto_optimiser(self) -> '_846.GearSetParetoOptimiser':
        ...
        if _846.GearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_hypoid_gear_set_pareto_optimiser(self) -> '_847.HypoidGearSetParetoOptimiser':
        ...
        if _847.HypoidGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_micro_geometry_design_space_search(self) -> '_850.MicroGeometryDesignSpaceSearch':
        ...
        if _850.MicroGeometryDesignSpaceSearch.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_micro_geometry_gear_set_design_space_search(self) -> '_853.MicroGeometryGearSetDesignSpaceSearch':
        ...
        if _853.MicroGeometryGearSetDesignSpaceSearch.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_spiral_bevel_gear_set_pareto_optimiser(self) -> '_872.SpiralBevelGearSetParetoOptimiser':
        ...
        if _872.SpiralBevelGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_straight_bevel_gear_set_pareto_optimiser(self) -> '_873.StraightBevelGearSetParetoOptimiser':
        ...
        if _873.StraightBevelGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def bars(self) -> 'List[_836.BarForPareto[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_836.BarForPareto)[TAnalysis, TCandidate])
        return value

    @property
    def input_sliders(self) -> 'List[_848.InputSliderForPareto[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSliders, constructor.new(_848.InputSliderForPareto)[TAnalysis, TCandidate])
        return value
