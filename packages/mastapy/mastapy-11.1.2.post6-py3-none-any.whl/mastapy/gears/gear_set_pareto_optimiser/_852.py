...
class MicroGeometryDesignSpaceSearchChartInformation(_838.ChartInfoBase['_797.CylindricalGearSetLoadDistributionAnalysis', '_851.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchChartInformation
    ...
    @property
    def optimiser(self) -> '_850.MicroGeometryDesignSpaceSearch':
