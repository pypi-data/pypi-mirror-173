...
class CylindricalGearSetParetoOptimiser(_846.GearSetParetoOptimiser):
    '''CylindricalGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_957.CylindricalGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_957.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_957.CylindricalGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_957.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_957.CylindricalGearSetDesign))
        return value
