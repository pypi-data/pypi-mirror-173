...
class GearFEModel(_1130.GearImplementationDetail):
    '''GearFEModel
    ...
    @property
    def element_settings(self) -> '_1111.GearMeshingElementOptions':
        ...
        return constructor.new(_1111.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings else None
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_287.GearFlanks', progress: '_7205.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_7205.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
