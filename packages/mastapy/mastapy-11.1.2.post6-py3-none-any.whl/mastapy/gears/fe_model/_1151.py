...
from mastapy.gears.fe_model import _1153
...
class GearFEModel(_1173.GearImplementationDetail):
    """GearFEModel
    ...
    @property
    def element_settings(self) -> '_1153.GearMeshingElementOptions':
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_298.GearFlanks', progress: '_7285.TaskProgress'):
        """ 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
