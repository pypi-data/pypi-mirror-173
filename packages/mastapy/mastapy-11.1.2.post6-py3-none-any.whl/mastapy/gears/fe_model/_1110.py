...
class GearFEModel(_1131.GearImplementationDetail):
    '''GearFEModel
    ...
    @property
    def element_settings(self) -> '_1112.GearMeshingElementOptions':
        ...
        return constructor.new(_1112.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings else None

    def get_stress_influence_coefficients_from_fe(self, flank: '_288.GearFlanks'):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_288.GearFlanks', progress: '_7202.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_7202.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
