...
class GearFEModel(_1147.GearImplementationDetail):
    '''GearFEModel
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_291.GearFlanks', progress: '_7242.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
