...
class GearFEModel(_1170.GearImplementationDetail):
    '''GearFEModel
    ...
    @property
    def element_settings(self) -> '_1151.GearMeshingElementOptions':
        ...
        return constructor.new(_1151.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings is not None else None

    def get_stress_influence_coefficients_from_fe(self, flank: '_297.GearFlanks'):
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_297.GearFlanks', progress: '_7389.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_7389.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
