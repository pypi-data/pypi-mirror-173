...
from mastapy.gears.fe_model import _1111, _1110
...
class GearSetFEModel(_1141.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def mesh_fe_models(self) -> 'List[_1111.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_1111.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_1110.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_1110.GearFEModel))
        return value
