...
class GearSetGroupDutyCycle(_0.APIBase):
    ...
    @property
    def loaded_rating_duty_cycles(self) -> 'List[_324.GearSetDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedRatingDutyCycles, constructor.new(_324.GearSetDutyCycleRating))
        return value

    @property
    def rating_duty_cycles(self) -> 'List[_324.GearSetDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RatingDutyCycles, constructor.new(_324.GearSetDutyCycleRating))
        return value
