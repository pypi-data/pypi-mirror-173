...
from mastapy.gears import _286, _285
...
class CylindricalMeshLoadCase(_812.MeshLoadCase):
    '''CylindricalMeshLoadCase
    ...
    @property
    def misalignment_source(self) -> '_286.CylindricalMisalignmentDataSource':
        ...
        return constructor.new(_286.CylindricalMisalignmentDataSource)(value) if value else None

    @misalignment_source.setter
    def misalignment_source(self, value: '_286.CylindricalMisalignmentDataSource'):
    ...
    @property
    def load_case_modifiable_settings(self) -> '_987.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_987.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
