...
from mastapy.gears.ltca import _774, _780
...
class CylindricalGearMeshLoadDistributionAnalysis(_780.GearMeshLoadDistributionAnalysis):
    '''CylindricalGearMeshLoadDistributionAnalysis
    ...
    @property
    def cylindrical_mesh_load_case(self) -> '_821.CylindricalMeshLoadCase':
        ...
        return constructor.new(_821.CylindricalMeshLoadCase)(self.wrapped.CylindricalMeshLoadCase) if self.wrapped.CylindricalMeshLoadCase else None

    @property
    def gear_a_in_mesh(self) -> '_774.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_774.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearAInMesh) if self.wrapped.GearAInMesh else None

    @property
    def gear_b_in_mesh(self) -> '_774.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_774.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearBInMesh) if self.wrapped.GearBInMesh else None
    ...
    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_798.CylindricalMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_798.CylindricalMeshLoadDistributionAtRotation))
        return value

    @property
    def meshed_gears(self) -> 'List[_774.CylindricalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_774.CylindricalMeshedGearLoadDistributionAnalysis))
        return value
