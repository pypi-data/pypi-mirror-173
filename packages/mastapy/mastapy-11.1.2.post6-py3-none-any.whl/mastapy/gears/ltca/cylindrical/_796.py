...
class CylindricalGearMeshLoadedContactPoint(_783.GearMeshLoadedContactPoint):
    '''CylindricalGearMeshLoadedContactPoint
    ...
    @property
    def gear_a_profile_measurement(self) -> '_954.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_954.CylindricalGearProfileMeasurement)(self.wrapped.GearAProfileMeasurement) if self.wrapped.GearAProfileMeasurement else None

    @property
    def gear_b_profile_measurement(self) -> '_954.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_954.CylindricalGearProfileMeasurement)(self.wrapped.GearBProfileMeasurement) if self.wrapped.GearBProfileMeasurement else None
