...
class CylindricalGearMeshLoadedContactLine(_782.GearMeshLoadedContactLine):
    '''CylindricalGearMeshLoadedContactLine
    ...
    @property
    def loaded_contact_strip_end_points(self) -> 'List[_796.CylindricalGearMeshLoadedContactPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactStripEndPoints, constructor.new(_796.CylindricalGearMeshLoadedContactPoint))
        return value
