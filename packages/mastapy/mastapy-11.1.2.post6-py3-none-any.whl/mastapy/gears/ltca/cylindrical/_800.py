...
class CylindricalGearMeshLoadDistributionAnalysis(_786.GearMeshLoadDistributionAnalysis):
    ...
    def cylindrical_mesh_load_case(self) -> '_827.CylindricalMeshLoadCase':
        ...
        return constructor.new(_827.CylindricalMeshLoadCase)(self.wrapped.CylindricalMeshLoadCase) if self.wrapped.CylindricalMeshLoadCase is not None else None
    ...
    def gear_a_in_mesh(self) -> '_780.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_780.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearAInMesh) if self.wrapped.GearAInMesh is not None else None
    ...
    def gear_b_in_mesh(self) -> '_780.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_780.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearBInMesh) if self.wrapped.GearBInMesh is not None else None
