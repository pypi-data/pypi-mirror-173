...
from mastapy.gears.cylindrical import _1122, _1121
...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self) -> '_1122.CylindricalGearLTCAContactCharts':
        ...
        return constructor.new(_1122.CylindricalGearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_1121.CylindricalGearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_1121.CylindricalGearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None

    def contact_patch_detailed(self, result_type: '_773.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_1280.GriddedSurface':
    ...
    def contact_patch(self, result_type: '_773.ContactResultType', include_tip_contact: 'bool') -> '_1280.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
    ...
    def contact_patch_as_text(self, result_type: '_773.ContactResultType', include_tip_contact: 'bool', file_name_with_path: 'str'):
