...
class GearMeshLoadedContactLine(_0.APIBase):
    ...
    @property
    def loaded_contact_strip_end_points(self) -> 'List[_789.GearMeshLoadedContactPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactStripEndPoints, constructor.new(_789.GearMeshLoadedContactPoint))
        return value
