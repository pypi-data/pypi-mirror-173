...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    @property
    def loaded_contact_lines(self) -> 'List[_782.GearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_782.GearMeshLoadedContactLine))
        return value
