...
from mastapy.gears.ltca import _781, _779
...
class GearMeshLoadDistributionAnalysis(_1133.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1278.FourierSeries':
        ...
        return constructor.new(_1278.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None

    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_781.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_781.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress(self, gear: '_779.GearLoadDistributionAnalysis', stress_type: '_80.StressResultsType') -> 'float':
    ...
    def maximum_root_stress_with_flanks(self, gear: '_779.GearLoadDistributionAnalysis', flank: '_288.GearFlanks', stress_type: '_80.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
