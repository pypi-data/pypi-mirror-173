...
from mastapy.gears.manufacturing.bevel import _732
...
class ConicalMeshLoadDistributionAnalysis(_780.GearMeshLoadDistributionAnalysis):
    '''ConicalMeshLoadDistributionAnalysis
    ...
    @property
    def conical_mesh_load_case(self) -> '_824.ConicalMeshLoadCase':
        ...
        if _824.ConicalMeshLoadCase.TYPE not in self.wrapped.ConicalMeshLoadCase.__class__.__mro__:
    ...
    @property
    def conical_mesh_manufacturing_analysis(self) -> '_732.ConicalMeshManufacturingAnalysis':
        ...
        return constructor.new(_732.ConicalMeshManufacturingAnalysis)(self.wrapped.ConicalMeshManufacturingAnalysis) if self.wrapped.ConicalMeshManufacturingAnalysis else None

    @property
    def meshed_gears(self) -> 'List[_806.ConicalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_806.ConicalMeshedGearLoadDistributionAnalysis))
        return value
