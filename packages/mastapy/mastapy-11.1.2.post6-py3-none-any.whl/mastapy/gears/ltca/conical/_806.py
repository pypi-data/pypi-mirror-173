...
class ConicalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self) -> '_1124.GearLTCAContactCharts':
        ...
        if _1124.GearLTCAContactCharts.TYPE not in self.wrapped.ContactCharts.__class__.__mro__:
    ...
    @property
    def contact_charts_as_text_file(self) -> '_1123.GearLTCAContactChartDataAsTextFile':
        ...
        if _1123.GearLTCAContactChartDataAsTextFile.TYPE not in self.wrapped.ContactChartsAsTextFile.__class__.__mro__:
