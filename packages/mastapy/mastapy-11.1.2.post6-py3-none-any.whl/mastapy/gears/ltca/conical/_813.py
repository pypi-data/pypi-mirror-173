...
class ConicalMeshLoadDistributionAnalysis(_786.GearMeshLoadDistributionAnalysis):
    ...
    def conical_mesh_manufacturing_analysis(self) -> '_738.ConicalMeshManufacturingAnalysis':
        ...
        return constructor.new(_738.ConicalMeshManufacturingAnalysis)(self.wrapped.ConicalMeshManufacturingAnalysis) if self.wrapped.ConicalMeshManufacturingAnalysis is not None else None
