...
from mastapy.licensing import _7255, _7256, _7257
...
class LicenceServer:
    ...
    @staticmethod
    def update_server_settings(server_details: '_7255.LicenceServerDetails'):
    ...
    @staticmethod
    def get_server_settings() -> '_7255.LicenceServerDetails':
    ...
    @staticmethod
    def get_licensed_module_details() -> 'Iterable[_7256.ModuleDetails]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetLicensedModuleDetails(), constructor.new(_7256.ModuleDetails))

    @staticmethod
    def get_available_module_details() -> 'Iterable[_7256.ModuleDetails]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetAvailableModuleDetails(), constructor.new(_7256.ModuleDetails))

    @staticmethod
    def get_requested_module_statuses() -> 'Iterable[_7257.ModuleLicenceStatus]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(LicenceServer.TYPE.GetRequestedModuleStatuses(), constructor.new(_7257.ModuleLicenceStatus))
