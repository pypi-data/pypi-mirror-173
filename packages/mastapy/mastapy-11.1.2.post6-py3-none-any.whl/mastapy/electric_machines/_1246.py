...
class RotorInternalLayerSpecification(_0.APIBase):
    ...
    def bridge_thickness(self) -> 'float':
        ...
        return self.wrapped.BridgeThickness
    ...
    def central_bridge_thickness(self) -> 'float':
        ...
        return self.wrapped.CentralBridgeThickness
    ...
    @property
    def magnet(self) -> '_1230.Magnet':
        '''Magnet: 'Magnet' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return constructor.new(_1230.Magnet)(self.wrapped.Magnet) if self.wrapped.Magnet is not None else None
