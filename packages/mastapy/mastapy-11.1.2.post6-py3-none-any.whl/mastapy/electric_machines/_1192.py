...
class AbstractStator(_0.APIBase):
    ...
    def stator_material_database(self) -> 'str':
        ...
        return self.wrapped.StatorMaterialDatabase.SelectedItemName
    ...
    @property
    def tooth_and_slot(self) -> '_1193.AbstractToothAndSlot':
        ...
        if _1193.AbstractToothAndSlot.TYPE not in self.wrapped.ToothAndSlot.__class__.__mro__:
            raise CastException('Failed to cast tooth_and_slot to AbstractToothAndSlot. Expected: {}.'.format(self.wrapped.ToothAndSlot.__class__.__qualname__))

        return constructor.new_override(self.wrapped.ToothAndSlot.__class__)(self.wrapped.ToothAndSlot) if self.wrapped.ToothAndSlot is not None else None

    @property
    def tooth_and_slot_of_type_cad_tooth_and_slot(self) -> '_1198.CADToothAndSlot':
        ...
        if _1198.CADToothAndSlot.TYPE not in self.wrapped.ToothAndSlot.__class__.__mro__:
            raise CastException('Failed to cast tooth_and_slot to CADToothAndSlot. Expected: {}.'.format(self.wrapped.ToothAndSlot.__class__.__qualname__))

        return constructor.new_override(self.wrapped.ToothAndSlot.__class__)(self.wrapped.ToothAndSlot) if self.wrapped.ToothAndSlot is not None else None

    @property
    def tooth_and_slot_of_type_tooth_and_slot(self) -> '_1256.ToothAndSlot':
        ...
        if _1256.ToothAndSlot.TYPE not in self.wrapped.ToothAndSlot.__class__.__mro__:
            raise CastException('Failed to cast tooth_and_slot to ToothAndSlot. Expected: {}.'.format(self.wrapped.ToothAndSlot.__class__.__qualname__))
    ...
    @property
    def stator_material(self) -> '_1250.StatorRotorMaterial':
        '''StatorRotorMaterial: 'StatorMaterial' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return constructor.new(_1250.StatorRotorMaterial)(self.wrapped.StatorMaterial) if self.wrapped.StatorMaterial is not None else None
