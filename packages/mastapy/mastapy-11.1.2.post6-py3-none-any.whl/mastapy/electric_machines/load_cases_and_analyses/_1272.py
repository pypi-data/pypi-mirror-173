...
from mastapy.electric_machines.load_cases_and_analyses import _1270
...
class ElectricMachineLoadCaseGroup(_0.APIBase):
    ...
    @property
    def single_operating_point_load_cases(self) -> 'List[_1270.ElectricMachineLoadCase]':
        '''List[ElectricMachineLoadCase]: 'SingleOperatingPointLoadCases' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SingleOperatingPointLoadCases, constructor.new(_1270.ElectricMachineLoadCase))
        return value
