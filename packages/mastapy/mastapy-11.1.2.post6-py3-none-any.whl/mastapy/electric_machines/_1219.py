...
_ELECTRIC_MACHINE_RESULTS_TIME_STEP_AT_LOCATION = python_net_import('SMT.MastaAPI.ElectricMachines', 'ElectricMachineResultsTimeStepAtLocation')
...
class ElectricMachineResultsTimeStepAtLocation(_0.APIBase):
    ...
    def location(self) -> 'Vector2D':
        ...
        value = conversion.pn_to_mp_vector2d(self.wrapped.Location)
        return value
    ...
    def flux_density(self) -> 'float':
        '''float: 'FluxDensity' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return self.wrapped.FluxDensity
