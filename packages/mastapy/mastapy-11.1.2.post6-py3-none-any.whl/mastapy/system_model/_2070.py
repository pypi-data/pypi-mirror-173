...
from mastapy.utility.scripting import _1634
...
class DesignEntity(_0.APIBase):
    ...
    @property
    def design_properties(self) -> '_2066.Design':
        ...
        return constructor.new(_2066.Design)(self.wrapped.DesignProperties) if self.wrapped.DesignProperties is not None else None

    @property
    def user_specified_data(self) -> '_1634.UserSpecifiedData':
        ...
        return constructor.new(_1634.UserSpecifiedData)(self.wrapped.UserSpecifiedData) if self.wrapped.UserSpecifiedData is not None else None
