...
from mastapy.math_utility import _1390
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.system_model import _2086
from mastapy import _0
from mastapy.system_model.part_model import _2306
...
T = TypeVar('T', bound='_2306.Component')
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self) -> '_1390.AlignmentAxis':
    ...
    def alignment_axis(self, value: '_1390.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AlignmentAxis = value

    @property
    def axial_offset(self) -> '_2086.RelativeOffsetOption':
        ...
        return constructor.new(_2086.RelativeOffsetOption)(value) if value is not None else None

    @axial_offset.setter
    def axial_offset(self, value: '_2086.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
