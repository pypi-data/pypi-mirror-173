...
from mastapy.system_model.fe import _2043
from mastapy.bearings.bearing_results.rolling import _1678
from mastapy.system_model.part_model.configurations import _2291, _2289, _2292
...
from mastapy.system_model.database_access import _1946
from mastapy.nodal_analysis import _72
from mastapy.system_model.part_model.creation_options import (
    _2248, _2251, _2252, _2250,
    _2249
)
from mastapy.gears.gear_designs.creation_options import _1059, _1062, _1061
from mastapy import _7202, _0
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2650
...
from mastapy.bearings.bearing_designs.rolling import _1855
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1573.MASTAGUI':
        ...
        return constructor.new(_1573.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI else None
    ...
    @property
    def efficiency_rating_method_for_bearings(self) -> '_257.BearingEfficiencyRatingMethod':
        ...
        return constructor.new(_257.BearingEfficiencyRatingMethod)(value) if value else None

    @efficiency_rating_method_for_bearings.setter
    def efficiency_rating_method_for_bearings(self, value: '_257.BearingEfficiencyRatingMethod'):
    ...
    @property
    def thermal_expansion_for_grounded_nodes(self) -> '_1909.ThermalExpansionOptionForGroundedNodes':
        ...
        return constructor.new(_1909.ThermalExpansionOptionForGroundedNodes)(value) if value else None

    @thermal_expansion_for_grounded_nodes.setter
    def thermal_expansion_for_grounded_nodes(self, value: '_1909.ThermalExpansionOptionForGroundedNodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def transverse_contact_ratio_requirement(self) -> '_284.ContactRatioRequirements':
        ...
        return constructor.new(_284.ContactRatioRequirements)(value) if value else None

    @transverse_contact_ratio_requirement.setter
    def transverse_contact_ratio_requirement(self, value: '_284.ContactRatioRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TransverseContactRatioRequirement = value

    @property
    def axial_contact_ratio_requirement(self) -> '_284.ContactRatioRequirements':
    ...
    def axial_contact_ratio_requirement(self, value: '_284.ContactRatioRequirements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_external_external_meshes(self) -> '_546.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_546.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes else None

    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_internal_external_meshes(self) -> '_546.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_546.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes else None

    @property
    def file_save_details_most_recent(self) -> '_1344.FileHistoryItem':
        ...
        return constructor.new(_1344.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent else None

    @property
    def default_system_temperatures(self) -> '_1910.TransmissionTemperatureSet':
        ...
        return constructor.new(_1910.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None
    ...
    @property
    def detailed_spline_settings(self) -> '_1157.DetailedSplineJointSettings':
        ...
        return constructor.new(_1157.DetailedSplineJointSettings)(self.wrapped.DetailedSplineSettings) if self.wrapped.DetailedSplineSettings else None
    ...
    @property
    def file_save_details_all(self) -> '_1343.FileHistory':
        ...
        return constructor.new(_1343.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll else None

    @property
    def gear_set_design_group(self) -> '_290.GearSetDesignGroup':
        ...
        return constructor.new(_290.GearSetDesignGroup)(self.wrapped.GearSetDesignGroup) if self.wrapped.GearSetDesignGroup else None

    @property
    def selected_gear_set_selection_group(self) -> '_2189.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2189.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None

    @property
    def system(self) -> '_1908.SystemReporting':
        ...
        return constructor.new(_1908.SystemReporting)(self.wrapped.System) if self.wrapped.System else None

    @property
    def fe_batch_operations(self) -> '_2043.BatchOperations':
        ...
        return constructor.new(_2043.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1678.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1678.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2189.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2189.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2291.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2291.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def fe_substructure_configurations(self) -> 'List[_2289.ActiveFESubstructureSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESubstructureConfigurations, constructor.new(_2289.ActiveFESubstructureSelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2292.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2292.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5321.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5321.DesignState))
        return value
    ...
    @property
    def duty_cycles(self) -> 'List[_5322.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5322.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_2153.RootAssembly':
        ...
        return constructor.new(_2153.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_2210.GearSetConfiguration':
        '''GearSetConfiguration: 'GearSetConfig' is the original name of this property.'''

        return constructor.new(_2210.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @gear_set_config.setter
    def gear_set_config(self, value: '_2210.GearSetConfiguration'):
        value = value.wrapped if value else None
        self.wrapped.GearSetConfig = value

    @property
    def status(self) -> '_1526.Status':
        ...
        return constructor.new(_1526.Status)(self.wrapped.Status) if self.wrapped.Status else None

    @property
    def databases(self) -> '_1946.Databases':
        ...
        return constructor.new(_1946.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None

    @property
    def masta_settings(self) -> '_1890.MastaSettings':
        ...
        return constructor.new(_1890.MastaSettings)(self.wrapped.MastaSettings) if self.wrapped.MastaSettings else None
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.08, pulley_b_diameter: Optional['float'] = 0.08, name: Optional['str'] = 'Belt Drive') -> '_2248.BeltCreationOptions':
    ...
    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.05) -> '_2251.PlanetCarrierCreationOptions':
    ...
    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.025, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2252.ShaftCreationOptions':
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2250.CylindricalGearLinearTrainCreationOptions':
    ...
    def new_hypoid_gear_set_creation_options(self) -> '_1061.HypoidGearSetCreationOptions':
    ...
    def new_cycloidal_assembly_creation_options(self, number_of_discs: Optional['int'] = 1, number_of_pins: Optional['int'] = 10, name: Optional['str'] = 'Cycloidal Assembly') -> '_2249.CycloidalAssemblyCreationOptions':
    ...
    def design_state_named(self, name: 'str') -> '_5321.DesignState':
    ...
    def duty_cycle_named(self, name: 'str') -> '_5322.DutyCycle':
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1526.Status':
    ...
    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_7202.TaskProgress') -> '_1526.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2650.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2650.SynchroniserShift':
    ...
    def add_synchroniser_shift_empty(self) -> '_2650.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5321.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5322.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_2114.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2114.Assembly.TYPE](), constructor.new(_2114.Assembly))
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1342.ExternalFullFEFileOption'] = _1342.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1855.RollingBearing'):
