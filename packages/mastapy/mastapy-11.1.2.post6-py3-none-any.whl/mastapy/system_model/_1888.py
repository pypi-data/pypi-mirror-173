...
from mastapy.system_model_gui import _1572
...
from mastapy.system_model.part_model.configurations import _2290, _2288, _2291
from mastapy.system_model.analyses_and_results.load_case_groups import _5320, _5321
...
from mastapy.system_model.database_access import _1945
from mastapy.nodal_analysis import _72
from mastapy.system_model.part_model.creation_options import (
    _2247, _2250, _2251, _2249,
    _2248
)
from mastapy.gears.gear_designs.creation_options import _1058, _1061, _1060
from mastapy import _7205, _0
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2649
...
from mastapy.bearings.bearing_designs.rolling import _1854
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1572.MASTAGUI':
        ...
        return constructor.new(_1572.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI else None
    ...
    @property
    def thermal_expansion_for_grounded_nodes(self) -> '_1908.ThermalExpansionOptionForGroundedNodes':
        ...
        return constructor.new(_1908.ThermalExpansionOptionForGroundedNodes)(value) if value else None

    @thermal_expansion_for_grounded_nodes.setter
    def thermal_expansion_for_grounded_nodes(self, value: '_1908.ThermalExpansionOptionForGroundedNodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def file_save_details_most_recent(self) -> '_1343.FileHistoryItem':
        ...
        return constructor.new(_1343.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent else None

    @property
    def default_system_temperatures(self) -> '_1909.TransmissionTemperatureSet':
        ...
        return constructor.new(_1909.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None
    ...
    @property
    def detailed_spline_settings(self) -> '_1156.DetailedSplineJointSettings':
        ...
        return constructor.new(_1156.DetailedSplineJointSettings)(self.wrapped.DetailedSplineSettings) if self.wrapped.DetailedSplineSettings else None
    ...
    @property
    def file_save_details_all(self) -> '_1342.FileHistory':
        ...
        return constructor.new(_1342.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll else None
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2188.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2188.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None

    @property
    def system(self) -> '_1907.SystemReporting':
        ...
        return constructor.new(_1907.SystemReporting)(self.wrapped.System) if self.wrapped.System else None

    @property
    def fe_batch_operations(self) -> '_2042.BatchOperations':
        ...
        return constructor.new(_2042.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1677.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1677.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2188.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2188.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2290.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2290.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def fe_substructure_configurations(self) -> 'List[_2288.ActiveFESubstructureSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESubstructureConfigurations, constructor.new(_2288.ActiveFESubstructureSelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2291.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2291.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5320.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5320.DesignState))
        return value
    ...
    @property
    def duty_cycles(self) -> 'List[_5321.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5321.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_2152.RootAssembly':
        ...
        return constructor.new(_2152.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_2209.GearSetConfiguration':
        '''GearSetConfiguration: 'GearSetConfig' is the original name of this property.'''

        return constructor.new(_2209.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @gear_set_config.setter
    def gear_set_config(self, value: '_2209.GearSetConfiguration'):
        value = value.wrapped if value else None
        self.wrapped.GearSetConfig = value

    @property
    def status(self) -> '_1525.Status':
        ...
        return constructor.new(_1525.Status)(self.wrapped.Status) if self.wrapped.Status else None

    @property
    def databases(self) -> '_1945.Databases':
        ...
        return constructor.new(_1945.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None

    @property
    def masta_settings(self) -> '_1889.MastaSettings':
        ...
        return constructor.new(_1889.MastaSettings)(self.wrapped.MastaSettings) if self.wrapped.MastaSettings else None
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.08, pulley_b_diameter: Optional['float'] = 0.08, name: Optional['str'] = 'Belt Drive') -> '_2247.BeltCreationOptions':
    ...
    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.05) -> '_2250.PlanetCarrierCreationOptions':
    ...
    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.025, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2251.ShaftCreationOptions':
    ...
    def new_cylindrical_gear_pair_creation_options(self) -> '_1058.CylindricalGearPairCreationOptions':
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2249.CylindricalGearLinearTrainCreationOptions':
    ...
    def new_spiral_bevel_gear_set_creation_options(self) -> '_1061.SpiralBevelGearSetCreationOptions':
    ...
    def new_hypoid_gear_set_creation_options(self) -> '_1060.HypoidGearSetCreationOptions':
    ...
    def new_cycloidal_assembly_creation_options(self, number_of_discs: Optional['int'] = 1, number_of_pins: Optional['int'] = 10, name: Optional['str'] = 'Cycloidal Assembly') -> '_2248.CycloidalAssemblyCreationOptions':
    ...
    def design_state_named(self, name: 'str') -> '_5320.DesignState':
    ...
    def duty_cycle_named(self, name: 'str') -> '_5321.DutyCycle':
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1525.Status':
    ...
    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_7205.TaskProgress') -> '_1525.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2649.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2649.SynchroniserShift':
    ...
    def add_synchroniser_shift_empty(self) -> '_2649.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5320.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5321.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_2113.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2113.Assembly.TYPE](), constructor.new(_2113.Assembly))
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1341.ExternalFullFEFileOption'] = _1341.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1854.RollingBearing'):
