...
class SystemReporting(_0.APIBase):
    ...
    @property
    def measurements_not_using_si_unit(self) -> 'List[_1362.MeasurementBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasurementsNotUsingSIUnit, constructor.new(_1362.MeasurementBase))
        return value

    @property
    def all_measurements(self) -> 'List[_1362.MeasurementBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMeasurements, constructor.new(_1362.MeasurementBase))
        return value
