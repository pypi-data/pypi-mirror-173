...
from mastapy.math_utility import _1255
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.system_model import _1907
...
T = TypeVar('T', bound='_2124.Component')
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self) -> '_1255.AlignmentAxis':
    ...
    def alignment_axis(self, value: '_1255.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AlignmentAxis = value

    @property
    def axial_offset(self) -> '_1907.RelativeOffsetOption':
        ...
        return constructor.new(_1907.RelativeOffsetOption)(value) if value else None

    @axial_offset.setter
    def axial_offset(self, value: '_1907.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
