...
from mastapy.system_model.optimization import _1953, _1945
...
class ConicalGearOptimisationStrategy(_1953.OptimizationStrategy['_1945.ConicalGearOptimizationStep']):
    '''ConicalGearOptimisationStrategy
