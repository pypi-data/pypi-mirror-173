...
from mastapy.system_model.optimization import _2098
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_2098.MicroGeometryOptimisationTarget':
        ...
        return constructor.new(_2098.MicroGeometryOptimisationTarget)(value) if value is not None else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_2098.MicroGeometryOptimisationTarget'):
