...
from mastapy.system_model.optimization import _2097
...
class CylindricalGearSetOptimizer(_0.APIBase):
    ...
    @property
    def constraints(self) -> 'List[_2097.MeasuredAndFactorViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Constraints, constructor.new(_2097.MeasuredAndFactorViewModel))
        return value
