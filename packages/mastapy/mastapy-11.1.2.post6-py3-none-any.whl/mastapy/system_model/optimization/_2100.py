...
from mastapy.system_model.optimization import _2101, _2099
...
TStep = TypeVar('TStep', bound='_2099.OptimizationStep')


class OptimizationStrategy(_2101.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
