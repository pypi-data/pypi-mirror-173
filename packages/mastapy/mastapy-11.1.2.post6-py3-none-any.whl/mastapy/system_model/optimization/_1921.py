...
from mastapy.system_model.optimization import _1922, _1920
...
TStep = TypeVar('TStep', bound='_1920.OptimizationStep')


class OptimizationStrategy(_1922.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
