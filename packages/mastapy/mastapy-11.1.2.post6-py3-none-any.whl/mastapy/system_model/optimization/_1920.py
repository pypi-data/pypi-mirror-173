...
from mastapy.system_model.optimization import _1919
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_1919.MicroGeometryOptimisationTarget':
        ...
        return constructor.new(_1919.MicroGeometryOptimisationTarget)(value) if value else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_1919.MicroGeometryOptimisationTarget'):
