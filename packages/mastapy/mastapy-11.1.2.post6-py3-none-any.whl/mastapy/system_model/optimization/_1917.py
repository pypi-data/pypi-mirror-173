...
class CylindricalGearSetOptimizer(_0.APIBase):
    ...
    @property
    def constraints(self) -> 'List[_1918.MeasuredAndFactorViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Constraints, constructor.new(_1918.MeasuredAndFactorViewModel))
        return value
