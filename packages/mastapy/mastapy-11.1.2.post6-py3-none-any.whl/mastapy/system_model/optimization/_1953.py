...
from mastapy.system_model.optimization import _1954, _1952
...
TStep = TypeVar('TStep', bound='_1952.OptimizationStep')


class OptimizationStrategy(_1954.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
