...
from mastapy.system_model.optimization import _1921, _1913
...
class ConicalGearOptimisationStrategy(_1921.OptimizationStrategy['_1913.ConicalGearOptimizationStep']):
    '''ConicalGearOptimisationStrategy
