...
from mastapy.system_model.fe import _2055
...
class ElectricMachineDynamicLoadData(_0.APIBase):
    ...
    @property
    def electric_machine_data_sets(self) -> 'List[_2055.ElectricMachineDataSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElectricMachineDataSets, constructor.new(_2055.ElectricMachineDataSet))
        return value
    ...
    def add_electric_machine_data_set(self, name: 'str') -> '_2055.ElectricMachineDataSet':
