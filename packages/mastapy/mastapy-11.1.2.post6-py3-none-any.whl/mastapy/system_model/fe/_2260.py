...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _193
...
class MaterialPropertiesWithSelection(_0.APIBase):
    ...
    @property
    def material_properties(self) -> '_193.MaterialPropertiesReporting':
        ...
        return constructor.new(_193.MaterialPropertiesReporting)(self.wrapped.MaterialProperties) if self.wrapped.MaterialProperties is not None else None
