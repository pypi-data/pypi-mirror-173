...
from mastapy.nodal_analysis.dev_tools_analyses import _166, _157
from mastapy.nodal_analysis import _60
from mastapy.system_model.fe import _2248, _2251
...
class FESubstructureWithSelectionForModalAnalysis(_2251.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_166.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_166.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle is not None else None
    ...
    @property
    def full_fe_mode_shapes_at_condensation_nodes(self) -> 'List[_2248.FESubstructureNodeModeShapes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FullFEModeShapesAtCondensationNodes, constructor.new(_2248.FESubstructureNodeModeShapes))
        return value
