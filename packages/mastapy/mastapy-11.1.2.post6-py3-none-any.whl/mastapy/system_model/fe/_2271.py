...
from mastapy.system_model.fe import _2266, _2265
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_2266.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2266.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_2265.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2265.PerLinkExportOptions))
        return value
