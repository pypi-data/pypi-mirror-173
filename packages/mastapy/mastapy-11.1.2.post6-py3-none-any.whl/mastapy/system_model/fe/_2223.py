...
from mastapy.system_model.fe import _2241
...
class BatchOperations(_0.APIBase):
    ...
    @property
    def fe_parts(self) -> 'List[_2241.FEPartWithBatchOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEParts, constructor.new(_2241.FEPartWithBatchOptions))
        return value

    @property
    def fe_parts_with_external_files(self) -> 'List[_2241.FEPartWithBatchOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEPartsWithExternalFiles, constructor.new(_2241.FEPartWithBatchOptions))
        return value
