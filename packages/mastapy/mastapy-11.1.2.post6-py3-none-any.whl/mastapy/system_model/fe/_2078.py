...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _188
...
class MaterialPropertiesWithSelection(_0.APIBase):
    ...
    @property
    def material_properties(self) -> '_188.MaterialPropertiesReporting':
        ...
        return constructor.new(_188.MaterialPropertiesReporting)(self.wrapped.MaterialProperties) if self.wrapped.MaterialProperties else None
