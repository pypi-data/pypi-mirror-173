...
from mastapy.system_model.fe import _2068
...
class FEPartWithBatchOptions(_0.APIBase):
    ...
    @property
    def f_es(self) -> 'List[_2068.FESubstructureWithBatchOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEs, constructor.new(_2068.FESubstructureWithBatchOptions))
        return value

    @property
    def f_es_with_external_files(self) -> 'List[_2068.FESubstructureWithBatchOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEsWithExternalFiles, constructor.new(_2068.FESubstructureWithBatchOptions))
        return value
