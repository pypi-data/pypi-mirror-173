...
from mastapy.math_utility.measured_vectors import _1463, _1465
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def original_result(self) -> '_1463.NodeResults':
        ...
        return constructor.new(_1463.NodeResults)(self.wrapped.OriginalResult) if self.wrapped.OriginalResult is not None else None

    @property
    def new_result(self) -> '_1463.NodeResults':
        ...
        return constructor.new(_1463.NodeResults)(self.wrapped.NewResult) if self.wrapped.NewResult is not None else None

    @property
    def displacement_change(self) -> '_1465.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1465.VectorWithLinearAndAngularComponents)(self.wrapped.DisplacementChange) if self.wrapped.DisplacementChange is not None else None
