...
from mastapy.system_model.fe.version_comparer import _2166, _2162
...
class FESubstructureVersionComparer(_0.APIBase):
    ...
    @property
    def load_cases_to_run(self) -> '_2166.LoadCasesToRun':
        ...
        return constructor.new_from_mastapy_type(_2166.LoadCasesToRun)(value) if value is not None else None

    @load_cases_to_run.setter
    def load_cases_to_run(self, value: '_2166.LoadCasesToRun'):
    ...
    @property
    def design_results(self) -> 'List[_2162.DesignResults]':
