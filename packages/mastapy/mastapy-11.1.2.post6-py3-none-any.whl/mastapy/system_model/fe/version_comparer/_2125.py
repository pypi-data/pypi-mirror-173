...
from mastapy.math_utility.measured_vectors import _1343, _1345
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def original_result(self) -> '_1343.NodeResults':
        ...
        return constructor.new(_1343.NodeResults)(self.wrapped.OriginalResult) if self.wrapped.OriginalResult else None

    @property
    def new_result(self) -> '_1343.NodeResults':
        ...
        return constructor.new(_1343.NodeResults)(self.wrapped.NewResult) if self.wrapped.NewResult else None

    @property
    def displacement_change(self) -> '_1345.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1345.VectorWithLinearAndAngularComponents)(self.wrapped.DisplacementChange) if self.wrapped.DisplacementChange else None
