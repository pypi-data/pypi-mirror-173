...
from mastapy.system_model.fe.version_comparer import _2124, _2120
...
class FESubstructureVersionComparer(_0.APIBase):
    ...
    @property
    def load_cases_to_run(self) -> '_2124.LoadCasesToRun':
        ...
        return constructor.new(_2124.LoadCasesToRun)(value) if value else None

    @load_cases_to_run.setter
    def load_cases_to_run(self, value: '_2124.LoadCasesToRun'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LoadCasesToRun = value

    @property
    def design_results(self) -> 'List[_2120.DesignResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignResults, constructor.new(_2120.DesignResults))
        return value
