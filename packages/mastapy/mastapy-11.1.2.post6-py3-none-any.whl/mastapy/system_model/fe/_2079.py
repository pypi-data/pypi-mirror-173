...
from mastapy.system_model.fe import _2054, _2053
...
class NodeBoundaryConditionStaticAnalysis(_0.APIBase):
    ...
    @property
    def boundary_conditions_linear(self) -> 'List[_2054.DegreeOfFreedomBoundaryConditionLinear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsLinear, constructor.new(_2054.DegreeOfFreedomBoundaryConditionLinear))
        return value

    @property
    def boundary_conditions_angular(self) -> 'List[_2053.DegreeOfFreedomBoundaryConditionAngular]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAngular, constructor.new(_2053.DegreeOfFreedomBoundaryConditionAngular))
        return value
