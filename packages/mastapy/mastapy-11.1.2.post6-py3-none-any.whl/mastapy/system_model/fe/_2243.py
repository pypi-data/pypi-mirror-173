...
class FEStiffnessTester(_0.APIBase):
    ...
    @property
    def fe_stiffness(self) -> '_2244.FESubstructure':
        ...
        return constructor.new(_2244.FESubstructure)(self.wrapped.FEStiffness) if self.wrapped.FEStiffness is not None else None

    @property
    def force_and_displacement_results(self) -> 'List[_1461.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceAndDisplacementResults, constructor.new(_1461.ForceAndDisplacementResults))
        return value
