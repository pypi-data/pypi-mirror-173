...
class FESubstructureWithSelection(_2042.BaseFEWithSelection):
    '''FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self) -> '_2064.FESubstructure':
        ...
        return constructor.new(_2064.FESubstructure)(self.wrapped.FESubstructure) if self.wrapped.FESubstructure else None

    @property
    def element_face_groups(self) -> 'List[_2057.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_2057.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_2080.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_2080.NodeGroupWithSelection))
        return value
