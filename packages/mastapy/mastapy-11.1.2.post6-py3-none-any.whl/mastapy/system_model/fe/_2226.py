...
from mastapy.system_model.fe import _2227
...
class BearingRaceNodeLink(_0.APIBase):
    ...
    @property
    def race_position(self) -> '_2227.BearingRacePosition':
        ...
        return constructor.new(_2227.BearingRacePosition)(value) if value is not None else None
