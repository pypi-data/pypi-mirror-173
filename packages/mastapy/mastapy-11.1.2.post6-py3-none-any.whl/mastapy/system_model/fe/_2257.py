...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def rigid_coupling_type(self) -> '_178.RigidCouplingType':
        ...
        return constructor.new(_178.RigidCouplingType)(value) if value is not None else None

    @rigid_coupling_type.setter
    def rigid_coupling_type(self, value: '_178.RigidCouplingType'):
    ...
    @property
    def fe_substructure_node(self) -> '_2246.FESubstructureNode':
        ...
        return constructor.new(_2246.FESubstructureNode)(self.wrapped.FESubstructureNode) if self.wrapped.FESubstructureNode is not None else None
