...
from mastapy.utility.enums import _1551
...
from mastapy.system_model.fe import _2079, _2069
...
class FESubstructureWithSelectionForStaticAnalysis(_2069.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForStaticAnalysis
    ...
    @property
    def full_fe_results(self) -> '_204.StaticCMSResults':
        ...
        return constructor.new(_204.StaticCMSResults)(self.wrapped.FullFEResults) if self.wrapped.FullFEResults else None

    @property
    def static_draw_style(self) -> '_163.FEModelStaticAnalysisDrawStyle':
        ...
        return constructor.new(_163.FEModelStaticAnalysisDrawStyle)(self.wrapped.StaticDrawStyle) if self.wrapped.StaticDrawStyle else None

    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_2079.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsSelectedNodes, constructor.new(_2079.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def boundary_conditions_all_nodes(self) -> 'List[_2079.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAllNodes, constructor.new(_2079.NodeBoundaryConditionStaticAnalysis))
        return value
