...
class BaseFEWithSelection(_0.APIBase):
    ...
    @property
    def node_selection(self) -> '_166.FENodeSelectionDrawStyle':
        ...
        return constructor.new(_166.FENodeSelectionDrawStyle)(self.wrapped.NodeSelection) if self.wrapped.NodeSelection else None

    @property
    def draw_style(self) -> '_151.DrawStyleForFE':
        ...
        return constructor.new(_151.DrawStyleForFE)(self.wrapped.DrawStyle) if self.wrapped.DrawStyle else None

    @property
    def transparency_draw_style(self) -> '_165.FEModelTransparencyDrawStyle':
        ...
        return constructor.new(_165.FEModelTransparencyDrawStyle)(self.wrapped.TransparencyDrawStyle) if self.wrapped.TransparencyDrawStyle else None

    @property
    def component_draw_style(self) -> '_158.FEModelComponentDrawStyle':
        ...
        return constructor.new(_158.FEModelComponentDrawStyle)(self.wrapped.ComponentDrawStyle) if self.wrapped.ComponentDrawStyle else None
