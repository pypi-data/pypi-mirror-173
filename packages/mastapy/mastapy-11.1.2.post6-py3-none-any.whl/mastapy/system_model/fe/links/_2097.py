...
class FELink(_0.APIBase):
    ...
    @property
    def component(self) -> '_2124.Component':
        ...
        if _2124.Component.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_abstract_shaft(self) -> '_2116.AbstractShaft':
        ...
        if _2116.AbstractShaft.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_abstract_shaft_or_housing(self) -> '_2117.AbstractShaftOrHousing':
        ...
        if _2117.AbstractShaftOrHousing.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_bearing(self) -> '_2120.Bearing':
    ...
    def component_of_type_bolt(self) -> '_2122.Bolt':
        ...
        if _2122.Bolt.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to Bolt. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_connector(self) -> '_2127.Connector':
    ...
    def component_of_type_datum(self) -> '_2128.Datum':
        ...
        if _2128.Datum.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to Datum. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_external_cad_model(self) -> '_2131.ExternalCADModel':
        ...
        if _2131.ExternalCADModel.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_fe_part(self) -> '_2132.FEPart':
        ...
        if _2132.FEPart.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to FEPart. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_guide_dxf_model(self) -> '_2134.GuideDxfModel':
        ...
        if _2134.GuideDxfModel.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_mass_disc(self) -> '_2141.MassDisc':
        ...
        if _2141.MassDisc.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to MassDisc. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_measurement_component(self) -> '_2142.MeasurementComponent':
        ...
        if _2142.MeasurementComponent.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_mountable_component(self) -> '_2143.MountableComponent':
        ...
        if _2143.MountableComponent.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_oil_seal(self) -> '_2145.OilSeal':
        ...
        if _2145.OilSeal.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to OilSeal. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_planet_carrier(self) -> '_2148.PlanetCarrier':
        ...
        if _2148.PlanetCarrier.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_point_load(self) -> '_2150.PointLoad':
        ...
        if _2150.PointLoad.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to PointLoad. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_power_load(self) -> '_2151.PowerLoad':
        ...
        if _2151.PowerLoad.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to PowerLoad. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_unbalanced_mass(self) -> '_2156.UnbalancedMass':
        ...
        if _2156.UnbalancedMass.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_virtual_component(self) -> '_2157.VirtualComponent':
        ...
        if _2157.VirtualComponent.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_shaft(self) -> '_2160.Shaft':
        ...
        if _2160.Shaft.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to Shaft. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_agma_gleason_conical_gear(self) -> '_2190.AGMAGleasonConicalGear':
        ...
        if _2190.AGMAGleasonConicalGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_bevel_differential_gear(self) -> '_2192.BevelDifferentialGear':
        ...
        if _2192.BevelDifferentialGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_bevel_differential_planet_gear(self) -> '_2194.BevelDifferentialPlanetGear':
        ...
        if _2194.BevelDifferentialPlanetGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_bevel_differential_sun_gear(self) -> '_2195.BevelDifferentialSunGear':
        ...
        if _2195.BevelDifferentialSunGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_bevel_gear(self) -> '_2196.BevelGear':
        ...
        if _2196.BevelGear.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to BevelGear. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_concept_gear(self) -> '_2198.ConceptGear':
        ...
        if _2198.ConceptGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_conical_gear(self) -> '_2200.ConicalGear':
        ...
        if _2200.ConicalGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_cylindrical_gear(self) -> '_2202.CylindricalGear':
        ...
        if _2202.CylindricalGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_cylindrical_planet_gear(self) -> '_2204.CylindricalPlanetGear':
        ...
        if _2204.CylindricalPlanetGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_face_gear(self) -> '_2205.FaceGear':
    ...
    def component_of_type_gear(self) -> '_2207.Gear':
        ...
        if _2207.Gear.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to Gear. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_hypoid_gear(self) -> '_2211.HypoidGear':
        ...
        if _2211.HypoidGear.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to HypoidGear. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_klingelnberg_cyclo_palloid_conical_gear(self) -> '_2213.KlingelnbergCycloPalloidConicalGear':
        ...
        if _2213.KlingelnbergCycloPalloidConicalGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_2215.KlingelnbergCycloPalloidHypoidGear':
        ...
        if _2215.KlingelnbergCycloPalloidHypoidGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_2217.KlingelnbergCycloPalloidSpiralBevelGear':
        ...
        if _2217.KlingelnbergCycloPalloidSpiralBevelGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_spiral_bevel_gear(self) -> '_2220.SpiralBevelGear':
        ...
        if _2220.SpiralBevelGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_straight_bevel_diff_gear(self) -> '_2222.StraightBevelDiffGear':
        ...
        if _2222.StraightBevelDiffGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_straight_bevel_gear(self) -> '_2224.StraightBevelGear':
        ...
        if _2224.StraightBevelGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_straight_bevel_planet_gear(self) -> '_2226.StraightBevelPlanetGear':
        ...
        if _2226.StraightBevelPlanetGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_straight_bevel_sun_gear(self) -> '_2227.StraightBevelSunGear':
        ...
        if _2227.StraightBevelSunGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_worm_gear(self) -> '_2228.WormGear':
        ...
        if _2228.WormGear.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to WormGear. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_zerol_bevel_gear(self) -> '_2230.ZerolBevelGear':
        ...
        if _2230.ZerolBevelGear.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_cycloidal_disc(self) -> '_2246.CycloidalDisc':
        ...
        if _2246.CycloidalDisc.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_ring_pins(self) -> '_2247.RingPins':
        ...
        if _2247.RingPins.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to RingPins. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_clutch_half(self) -> '_2256.ClutchHalf':
        ...
        if _2256.ClutchHalf.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to ClutchHalf. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_concept_coupling_half(self) -> '_2259.ConceptCouplingHalf':
        ...
        if _2259.ConceptCouplingHalf.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_coupling_half(self) -> '_2261.CouplingHalf':
        ...
        if _2261.CouplingHalf.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_cvt_pulley(self) -> '_2264.CVTPulley':
        ...
        if _2264.CVTPulley.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to CVTPulley. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_part_to_part_shear_coupling_half(self) -> '_2266.PartToPartShearCouplingHalf':
        ...
        if _2266.PartToPartShearCouplingHalf.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_pulley(self) -> '_2267.Pulley':
        ...
        if _2267.Pulley.TYPE not in self.wrapped.Component.__class__.__mro__:
            raise CastException('Failed to cast component to Pulley. Expected: {}.'.format(self.wrapped.Component.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Component.__class__)(self.wrapped.Component) if self.wrapped.Component else None

    @property
    def component_of_type_rolling_ring(self) -> '_2273.RollingRing':
        ...
        if _2273.RollingRing.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_shaft_hub_connection(self) -> '_2275.ShaftHubConnection':
        ...
        if _2275.ShaftHubConnection.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_spring_damper_half(self) -> '_2278.SpringDamperHalf':
        ...
        if _2278.SpringDamperHalf.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_synchroniser_half(self) -> '_2281.SynchroniserHalf':
        ...
        if _2281.SynchroniserHalf.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_synchroniser_part(self) -> '_2282.SynchroniserPart':
        ...
        if _2282.SynchroniserPart.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_synchroniser_sleeve(self) -> '_2283.SynchroniserSleeve':
        ...
        if _2283.SynchroniserSleeve.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_torque_converter_pump(self) -> '_2285.TorqueConverterPump':
        ...
        if _2285.TorqueConverterPump.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    @property
    def component_of_type_torque_converter_turbine(self) -> '_2287.TorqueConverterTurbine':
        ...
        if _2287.TorqueConverterTurbine.TYPE not in self.wrapped.Component.__class__.__mro__:
    ...
    def socket(self) -> '_1978.Socket':
        ...
        if _1978.Socket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bearing_inner_socket(self) -> '_1948.BearingInnerSocket':
        ...
        if _1948.BearingInnerSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bearing_outer_socket(self) -> '_1949.BearingOuterSocket':
        ...
        if _1949.BearingOuterSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cvt_pulley_socket(self) -> '_1956.CVTPulleySocket':
        ...
        if _1956.CVTPulleySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to CVTPulleySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_cylindrical_socket(self) -> '_1958.CylindricalSocket':
        ...
        if _1958.CylindricalSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_electric_machine_stator_socket(self) -> '_1960.ElectricMachineStatorSocket':
        ...
        if _1960.ElectricMachineStatorSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_inner_shaft_socket(self) -> '_1961.InnerShaftSocket':
        ...
        if _1961.InnerShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to InnerShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_inner_shaft_socket_base(self) -> '_1962.InnerShaftSocketBase':
        ...
        if _1962.InnerShaftSocketBase.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_mountable_component_inner_socket(self) -> '_1964.MountableComponentInnerSocket':
        ...
        if _1964.MountableComponentInnerSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_mountable_component_outer_socket(self) -> '_1965.MountableComponentOuterSocket':
        ...
        if _1965.MountableComponentOuterSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_mountable_component_socket(self) -> '_1966.MountableComponentSocket':
        ...
        if _1966.MountableComponentSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_outer_shaft_socket(self) -> '_1967.OuterShaftSocket':
        ...
        if _1967.OuterShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to OuterShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_outer_shaft_socket_base(self) -> '_1968.OuterShaftSocketBase':
        ...
        if _1968.OuterShaftSocketBase.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_planetary_socket(self) -> '_1970.PlanetarySocket':
        ...
        if _1970.PlanetarySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to PlanetarySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_planetary_socket_base(self) -> '_1971.PlanetarySocketBase':
        ...
        if _1971.PlanetarySocketBase.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_pulley_socket(self) -> '_1972.PulleySocket':
        ...
        if _1972.PulleySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to PulleySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_rolling_ring_socket(self) -> '_1975.RollingRingSocket':
        ...
        if _1975.RollingRingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_shaft_socket(self) -> '_1976.ShaftSocket':
        ...
        if _1976.ShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to ShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_agma_gleason_conical_gear_teeth_socket(self) -> '_1982.AGMAGleasonConicalGearTeethSocket':
        ...
        if _1982.AGMAGleasonConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bevel_differential_gear_teeth_socket(self) -> '_1984.BevelDifferentialGearTeethSocket':
        ...
        if _1984.BevelDifferentialGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bevel_gear_teeth_socket(self) -> '_1986.BevelGearTeethSocket':
        ...
        if _1986.BevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_concept_gear_teeth_socket(self) -> '_1988.ConceptGearTeethSocket':
        ...
        if _1988.ConceptGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_conical_gear_teeth_socket(self) -> '_1990.ConicalGearTeethSocket':
        ...
        if _1990.ConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cylindrical_gear_teeth_socket(self) -> '_1992.CylindricalGearTeethSocket':
        ...
        if _1992.CylindricalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_face_gear_teeth_socket(self) -> '_1994.FaceGearTeethSocket':
        ...
        if _1994.FaceGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_gear_teeth_socket(self) -> '_1996.GearTeethSocket':
        ...
        if _1996.GearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to GearTeethSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_hypoid_gear_teeth_socket(self) -> '_1998.HypoidGearTeethSocket':
        ...
        if _1998.HypoidGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_klingelnberg_conical_gear_teeth_socket(self) -> '_1999.KlingelnbergConicalGearTeethSocket':
        ...
        if _1999.KlingelnbergConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_klingelnberg_hypoid_gear_teeth_socket(self) -> '_2003.KlingelnbergHypoidGearTeethSocket':
        ...
        if _2003.KlingelnbergHypoidGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_klingelnberg_spiral_bevel_gear_teeth_socket(self) -> '_2004.KlingelnbergSpiralBevelGearTeethSocket':
        ...
        if _2004.KlingelnbergSpiralBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_spiral_bevel_gear_teeth_socket(self) -> '_2006.SpiralBevelGearTeethSocket':
        ...
        if _2006.SpiralBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_straight_bevel_diff_gear_teeth_socket(self) -> '_2008.StraightBevelDiffGearTeethSocket':
        ...
        if _2008.StraightBevelDiffGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_straight_bevel_gear_teeth_socket(self) -> '_2010.StraightBevelGearTeethSocket':
        ...
        if _2010.StraightBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_worm_gear_teeth_socket(self) -> '_2012.WormGearTeethSocket':
        ...
        if _2012.WormGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_zerol_bevel_gear_teeth_socket(self) -> '_2014.ZerolBevelGearTeethSocket':
        ...
        if _2014.ZerolBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_axial_left_socket(self) -> '_2015.CycloidalDiscAxialLeftSocket':
        ...
        if _2015.CycloidalDiscAxialLeftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_axial_right_socket(self) -> '_2016.CycloidalDiscAxialRightSocket':
        ...
        if _2016.CycloidalDiscAxialRightSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_inner_socket(self) -> '_2018.CycloidalDiscInnerSocket':
        ...
        if _2018.CycloidalDiscInnerSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_outer_socket(self) -> '_2019.CycloidalDiscOuterSocket':
        ...
        if _2019.CycloidalDiscOuterSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_planetary_bearing_socket(self) -> '_2021.CycloidalDiscPlanetaryBearingSocket':
        ...
        if _2021.CycloidalDiscPlanetaryBearingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_ring_pins_socket(self) -> '_2022.RingPinsSocket':
        ...
        if _2022.RingPinsSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to RingPinsSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_clutch_socket(self) -> '_2025.ClutchSocket':
        ...
        if _2025.ClutchSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to ClutchSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_concept_coupling_socket(self) -> '_2027.ConceptCouplingSocket':
        ...
        if _2027.ConceptCouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_coupling_socket(self) -> '_2029.CouplingSocket':
        ...
        if _2029.CouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to CouplingSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_part_to_part_shear_coupling_socket(self) -> '_2031.PartToPartShearCouplingSocket':
        ...
        if _2031.PartToPartShearCouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_spring_damper_socket(self) -> '_2033.SpringDamperSocket':
        ...
        if _2033.SpringDamperSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_torque_converter_pump_socket(self) -> '_2035.TorqueConverterPumpSocket':
        ...
        if _2035.TorqueConverterPumpSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_torque_converter_turbine_socket(self) -> '_2036.TorqueConverterTurbineSocket':
        ...
        if _2036.TorqueConverterTurbineSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def alignment_in_world_coordinate_system(self) -> '_2076.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_2076.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInWorldCoordinateSystem) if self.wrapped.AlignmentInWorldCoordinateSystem else None

    @property
    def alignment_in_fe_coordinate_system(self) -> '_2076.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_2076.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInFECoordinateSystem) if self.wrapped.AlignmentInFECoordinateSystem else None

    @property
    def alignment_in_component_coordinate_system(self) -> '_2076.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_2076.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInComponentCoordinateSystem) if self.wrapped.AlignmentInComponentCoordinateSystem else None

    @property
    def nodes(self) -> 'List[_2066.FESubstructureNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2066.FESubstructureNode))
        return value
    ...
    def nodes_grouped_by_angle(self) -> 'OrderedDict[float, List[_2066.FESubstructureNode]]':
        ...
        return conversion.pn_to_mp_objects_in_list_in_ordered_dict(self.wrapped.NodesGroupedByAngle(), constructor.new(_2066.FESubstructureNode))
    ...
    def add_or_replace_node(self, node: '_2066.FESubstructureNode'):
