...
class FELink(_0.APIBase):
    ...
    def socket(self) -> '_2005.Socket':
        ...
        if _2005.Socket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bearing_inner_socket(self) -> '_1975.BearingInnerSocket':
        ...
        if _1975.BearingInnerSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bearing_outer_socket(self) -> '_1976.BearingOuterSocket':
        ...
        if _1976.BearingOuterSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cvt_pulley_socket(self) -> '_1983.CVTPulleySocket':
        ...
        if _1983.CVTPulleySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to CVTPulleySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_cylindrical_socket(self) -> '_1985.CylindricalSocket':
        ...
        if _1985.CylindricalSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_electric_machine_stator_socket(self) -> '_1987.ElectricMachineStatorSocket':
        ...
        if _1987.ElectricMachineStatorSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_inner_shaft_socket(self) -> '_1988.InnerShaftSocket':
        ...
        if _1988.InnerShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to InnerShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_inner_shaft_socket_base(self) -> '_1989.InnerShaftSocketBase':
        ...
        if _1989.InnerShaftSocketBase.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_mountable_component_inner_socket(self) -> '_1991.MountableComponentInnerSocket':
        ...
        if _1991.MountableComponentInnerSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_mountable_component_outer_socket(self) -> '_1992.MountableComponentOuterSocket':
        ...
        if _1992.MountableComponentOuterSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_mountable_component_socket(self) -> '_1993.MountableComponentSocket':
        ...
        if _1993.MountableComponentSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_outer_shaft_socket(self) -> '_1994.OuterShaftSocket':
        ...
        if _1994.OuterShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to OuterShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_outer_shaft_socket_base(self) -> '_1995.OuterShaftSocketBase':
        ...
        if _1995.OuterShaftSocketBase.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_planetary_socket(self) -> '_1997.PlanetarySocket':
        ...
        if _1997.PlanetarySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to PlanetarySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_planetary_socket_base(self) -> '_1998.PlanetarySocketBase':
        ...
        if _1998.PlanetarySocketBase.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_pulley_socket(self) -> '_1999.PulleySocket':
        ...
        if _1999.PulleySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to PulleySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_rolling_ring_socket(self) -> '_2002.RollingRingSocket':
        ...
        if _2002.RollingRingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_shaft_socket(self) -> '_2003.ShaftSocket':
        ...
        if _2003.ShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to ShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_agma_gleason_conical_gear_teeth_socket(self) -> '_2009.AGMAGleasonConicalGearTeethSocket':
        ...
        if _2009.AGMAGleasonConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bevel_differential_gear_teeth_socket(self) -> '_2011.BevelDifferentialGearTeethSocket':
        ...
        if _2011.BevelDifferentialGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bevel_gear_teeth_socket(self) -> '_2013.BevelGearTeethSocket':
        ...
        if _2013.BevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_concept_gear_teeth_socket(self) -> '_2015.ConceptGearTeethSocket':
        ...
        if _2015.ConceptGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_conical_gear_teeth_socket(self) -> '_2017.ConicalGearTeethSocket':
        ...
        if _2017.ConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cylindrical_gear_teeth_socket(self) -> '_2019.CylindricalGearTeethSocket':
        ...
        if _2019.CylindricalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_face_gear_teeth_socket(self) -> '_2021.FaceGearTeethSocket':
        ...
        if _2021.FaceGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_gear_teeth_socket(self) -> '_2023.GearTeethSocket':
        ...
        if _2023.GearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to GearTeethSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_hypoid_gear_teeth_socket(self) -> '_2025.HypoidGearTeethSocket':
        ...
        if _2025.HypoidGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_klingelnberg_conical_gear_teeth_socket(self) -> '_2026.KlingelnbergConicalGearTeethSocket':
        ...
        if _2026.KlingelnbergConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_klingelnberg_hypoid_gear_teeth_socket(self) -> '_2030.KlingelnbergHypoidGearTeethSocket':
        ...
        if _2030.KlingelnbergHypoidGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_klingelnberg_spiral_bevel_gear_teeth_socket(self) -> '_2031.KlingelnbergSpiralBevelGearTeethSocket':
        ...
        if _2031.KlingelnbergSpiralBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_spiral_bevel_gear_teeth_socket(self) -> '_2033.SpiralBevelGearTeethSocket':
        ...
        if _2033.SpiralBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_straight_bevel_diff_gear_teeth_socket(self) -> '_2035.StraightBevelDiffGearTeethSocket':
        ...
        if _2035.StraightBevelDiffGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_straight_bevel_gear_teeth_socket(self) -> '_2037.StraightBevelGearTeethSocket':
        ...
        if _2037.StraightBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_worm_gear_teeth_socket(self) -> '_2039.WormGearTeethSocket':
        ...
        if _2039.WormGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_zerol_bevel_gear_teeth_socket(self) -> '_2041.ZerolBevelGearTeethSocket':
        ...
        if _2041.ZerolBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_axial_left_socket(self) -> '_2042.CycloidalDiscAxialLeftSocket':
        ...
        if _2042.CycloidalDiscAxialLeftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_axial_right_socket(self) -> '_2043.CycloidalDiscAxialRightSocket':
        ...
        if _2043.CycloidalDiscAxialRightSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_inner_socket(self) -> '_2045.CycloidalDiscInnerSocket':
        ...
        if _2045.CycloidalDiscInnerSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_outer_socket(self) -> '_2046.CycloidalDiscOuterSocket':
        ...
        if _2046.CycloidalDiscOuterSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_planetary_bearing_socket(self) -> '_2048.CycloidalDiscPlanetaryBearingSocket':
        ...
        if _2048.CycloidalDiscPlanetaryBearingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_ring_pins_socket(self) -> '_2049.RingPinsSocket':
        ...
        if _2049.RingPinsSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to RingPinsSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_clutch_socket(self) -> '_2052.ClutchSocket':
        ...
        if _2052.ClutchSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to ClutchSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_concept_coupling_socket(self) -> '_2054.ConceptCouplingSocket':
        ...
        if _2054.ConceptCouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_coupling_socket(self) -> '_2056.CouplingSocket':
        ...
        if _2056.CouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to CouplingSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_part_to_part_shear_coupling_socket(self) -> '_2058.PartToPartShearCouplingSocket':
        ...
        if _2058.PartToPartShearCouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_spring_damper_socket(self) -> '_2060.SpringDamperSocket':
        ...
        if _2060.SpringDamperSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_torque_converter_pump_socket(self) -> '_2062.TorqueConverterPumpSocket':
        ...
        if _2062.TorqueConverterPumpSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_torque_converter_turbine_socket(self) -> '_2063.TorqueConverterTurbineSocket':
        ...
        if _2063.TorqueConverterTurbineSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def alignment_in_world_coordinate_system(self) -> '_2105.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_2105.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInWorldCoordinateSystem) if self.wrapped.AlignmentInWorldCoordinateSystem else None

    @property
    def alignment_in_fe_coordinate_system(self) -> '_2105.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_2105.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInFECoordinateSystem) if self.wrapped.AlignmentInFECoordinateSystem else None

    @property
    def alignment_in_component_coordinate_system(self) -> '_2105.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_2105.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInComponentCoordinateSystem) if self.wrapped.AlignmentInComponentCoordinateSystem else None
    ...
    def nodes_grouped_by_angle(self) -> 'OrderedDict[float, List[_2093.FESubstructureNode]]':
        ...
        return conversion.pn_to_mp_objects_in_list_in_ordered_dict(self.wrapped.NodesGroupedByAngle(), constructor.new(_2093.FESubstructureNode))
    ...
    def add_or_replace_node(self, node: '_2093.FESubstructureNode'):
