...
from mastapy.nodal_analysis.fe_export_utility import _149, _150
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.utility.units_and_measurements import _1367
from mastapy.system_model.fe import _2084, _2083
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_2084.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2084.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_2083.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2083.PerLinkExportOptions))
        return value
    ...
    def set_alternative_fe_mesh_file(self, file_path: 'str', format_: '_150.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0):
    ...
    def set_fe_mesh_file_to_include(self, file_path: 'str', format_: '_150.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0):
