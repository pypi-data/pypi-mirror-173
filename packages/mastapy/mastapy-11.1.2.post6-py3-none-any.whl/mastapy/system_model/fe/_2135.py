...
class FESubstructureNode(_64.FEStiffnessNode):
    """FESubstructureNode
    ...
    @property
    def force_due_to_gravity_in_local_coordinate_system(self) -> '_1371.VectorWithLinearAndAngularComponents':
    ...
    @property
    def force_due_to_gravity_in_local_coordinate_system_with_gravity_in_fex_direction(self) -> '_1371.VectorWithLinearAndAngularComponents':
    ...
    @property
    def force_due_to_gravity_in_local_coordinate_system_with_gravity_in_fey_direction(self) -> '_1371.VectorWithLinearAndAngularComponents':
    ...
    @property
    def force_due_to_gravity_in_local_coordinate_system_with_gravity_in_fez_direction(self) -> '_1371.VectorWithLinearAndAngularComponents':
