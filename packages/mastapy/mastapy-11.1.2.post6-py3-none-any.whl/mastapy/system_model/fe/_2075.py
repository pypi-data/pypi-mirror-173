...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def rigid_coupling_type(self) -> '_173.RigidCouplingType':
        ...
        return constructor.new(_173.RigidCouplingType)(value) if value else None

    @rigid_coupling_type.setter
    def rigid_coupling_type(self, value: '_173.RigidCouplingType'):
    ...
    @property
    def fe_substructure_node(self) -> '_2066.FESubstructureNode':
        ...
        return constructor.new(_2066.FESubstructureNode)(self.wrapped.FESubstructureNode) if self.wrapped.FESubstructureNode else None
