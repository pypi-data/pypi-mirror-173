...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _180
...
class CoordinateSystemWithSelection(_0.APIBase):
    ...
    @property
    def coordinate_system(self) -> '_180.CoordinateSystemReporting':
        ...
        return constructor.new(_180.CoordinateSystemReporting)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem is not None else None
