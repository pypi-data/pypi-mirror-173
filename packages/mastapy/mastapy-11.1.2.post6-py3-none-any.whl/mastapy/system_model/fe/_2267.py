...
from mastapy.system_model.fe import _2219, _2226
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2219.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_2219.AlignmentMethodForRaceBearing)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2219.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2226.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2226.BearingRaceNodeLink))
        return value
