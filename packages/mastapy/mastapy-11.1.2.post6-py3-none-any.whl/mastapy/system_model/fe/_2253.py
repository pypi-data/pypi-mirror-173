...
from mastapy.nodal_analysis.dev_tools_analyses import _164
...
class FESubstructureWithSelectionForHarmonicAnalysis(_2251.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self) -> '_164.FEModelHarmonicAnalysisDrawStyle':
        ...
        return constructor.new(_164.FEModelHarmonicAnalysisDrawStyle)(self.wrapped.HarmonicDrawStyle) if self.wrapped.HarmonicDrawStyle is not None else None
