...
class CoordinateSystemWithSelection(_0.APIBase):
    ...
    @property
    def coordinate_system(self) -> '_175.CoordinateSystemReporting':
        ...
        return constructor.new(_175.CoordinateSystemReporting)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None
