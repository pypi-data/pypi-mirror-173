...
class BatchOperations(_0.APIBase):
    ...
    @property
    def fe_parts(self) -> 'List[_2061.FEPartWithBatchOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEParts, constructor.new(_2061.FEPartWithBatchOptions))
        return value

    @property
    def fe_parts_with_external_files(self) -> 'List[_2061.FEPartWithBatchOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEPartsWithExternalFiles, constructor.new(_2061.FEPartWithBatchOptions))
        return value
