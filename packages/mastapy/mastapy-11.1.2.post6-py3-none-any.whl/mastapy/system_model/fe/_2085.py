...
from mastapy.system_model.fe import _2039, _2046
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2039.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_2039.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2039.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2046.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2046.BearingRaceNodeLink))
        return value
