...
from mastapy.system_model.fe import (
    _2224, _2249, _2272, _2218,
    _2220, _2245, _2270, _2246,
    _2242, _2256, _2257, _2255,
    _2252, _2253, _2254
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2310, _2306, _2314
...
class FESubstructure(_62.FEStiffness):
    ...
    @property
    def bearing_node_alignment(self) -> '_2224.BearingNodeAlignmentOption':
        ...
        return constructor.new(_2224.BearingNodeAlignmentOption)(value) if value is not None else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2224.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_2218.AlignmentMethod':
        ...
        return constructor.new(_2218.AlignmentMethod)(value) if value is not None else None

    @alignment_method.setter
    def alignment_method(self, value: '_2218.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cms_model(self) -> '_202.CMSModel':
        ...
        return constructor.new(_202.CMSModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel is not None else None
    ...
    @property
    def alignment_to_component(self) -> '_2085.RelativeComponentAlignment[_2306.Component]':
        ...
        return constructor.new(_2085.RelativeComponentAlignment)[_2306.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent is not None else None

    @property
    def alignment_using_axial_node_positions(self) -> '_2220.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_2220.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions is not None else None

    @property
    def coordinate_system(self) -> '_1398.CoordinateSystem3D':
        ...
        return constructor.new(_1398.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem is not None else None

    @property
    def export(self) -> '_2245.FESubstructureExportOptions':
        ...
        return constructor.new(_2245.FESubstructureExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None

    @property
    def acoustic_radiation_efficiency(self) -> '_212.AcousticRadiationEfficiency':
        ...
        return constructor.new(_212.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency is not None else None

    @property
    def sound_pressure_enclosure(self) -> '_254.SoundPressureEnclosure':
        ...
        return constructor.new(_254.SoundPressureEnclosure)(self.wrapped.SoundPressureEnclosure) if self.wrapped.SoundPressureEnclosure is not None else None

    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2270.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_2270.ReplacedShaftSelectionHelper))
        return value

    @property
    def nodes(self) -> 'List[_2246.FESubstructureNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2246.FESubstructureNode))
        return value

    @property
    def replaced_shafts(self) -> 'List[_2343.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2343.Shaft))
        return value

    @property
    def links(self) -> 'List[_2279.FELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2279.FELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1465.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1465.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1465.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1465.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_2242.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_2242.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_2256.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_2256.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2257.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_2257.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def fe_part(self) -> '_2314.FEPart':
        ...
        return constructor.new(_2314.FEPart)(self.wrapped.FEPart) if self.wrapped.FEPart is not None else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7389.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2255.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2252.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2253.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2254.FESubstructureWithSelectionForModalAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_152.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7389.TaskProgress'] = None):
    ...
    def links_for(self, node: '_2246.FESubstructureNode') -> 'List[_2279.FELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_2279.FELink))
