...
class ElectricMachineDynamicLoadData(_0.APIBase):
    ...
    @property
    def electric_machine_data_sets(self) -> 'List[_2235.ElectricMachineDataSet]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElectricMachineDataSets, constructor.new(_2235.ElectricMachineDataSet))
        return value
    ...
    def add_electric_machine_data_set(self, name: 'str') -> '_2235.ElectricMachineDataSet':
