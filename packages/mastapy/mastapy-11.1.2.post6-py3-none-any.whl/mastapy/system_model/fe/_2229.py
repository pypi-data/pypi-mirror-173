...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _179
...
class ContactPairWithSelection(_0.APIBase):
    ...
    @property
    def contact_pair(self) -> '_179.ContactPairReporting':
        ...
        return constructor.new(_179.ContactPairReporting)(self.wrapped.ContactPair) if self.wrapped.ContactPair is not None else None
