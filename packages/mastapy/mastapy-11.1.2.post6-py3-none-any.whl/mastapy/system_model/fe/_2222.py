...
class BaseFEWithSelection(_0.APIBase):
    ...
    @property
    def node_selection(self) -> '_171.FENodeSelectionDrawStyle':
        ...
        return constructor.new(_171.FENodeSelectionDrawStyle)(self.wrapped.NodeSelection) if self.wrapped.NodeSelection is not None else None

    @property
    def draw_style(self) -> '_156.DrawStyleForFE':
        ...
        return constructor.new(_156.DrawStyleForFE)(self.wrapped.DrawStyle) if self.wrapped.DrawStyle is not None else None

    @property
    def transparency_draw_style(self) -> '_170.FEModelTransparencyDrawStyle':
        ...
        return constructor.new(_170.FEModelTransparencyDrawStyle)(self.wrapped.TransparencyDrawStyle) if self.wrapped.TransparencyDrawStyle is not None else None

    @property
    def component_draw_style(self) -> '_163.FEModelComponentDrawStyle':
        ...
        return constructor.new(_163.FEModelComponentDrawStyle)(self.wrapped.ComponentDrawStyle) if self.wrapped.ComponentDrawStyle is not None else None
