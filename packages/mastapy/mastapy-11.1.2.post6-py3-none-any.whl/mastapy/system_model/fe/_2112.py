...
from mastapy.system_model.fe import _2130
...
class BatchOperations(_0.APIBase):
    ...
    @property
    def fe_parts(self) -> 'List[_2130.FEPartWithBatchOptions]':
    ...
    @property
    def fe_parts_with_external_files(self) -> 'List[_2130.FEPartWithBatchOptions]':
