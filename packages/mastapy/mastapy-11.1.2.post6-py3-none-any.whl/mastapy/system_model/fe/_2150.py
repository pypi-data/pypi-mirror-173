...
from mastapy.system_model.fe import _2122, _2123
...
class NodeBoundaryConditionStaticAnalysis(_0.APIBase):
    ...
    @property
    def boundary_conditions_angular(self) -> 'List[_2122.DegreeOfFreedomBoundaryConditionAngular]':
    ...
    @property
    def boundary_conditions_linear(self) -> 'List[_2123.DegreeOfFreedomBoundaryConditionLinear]':
