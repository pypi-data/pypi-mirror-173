...
from mastapy.electric_machines.harmonic_load_data import _1286
from mastapy.math_utility import _1421
from mastapy.units_and_measurements import _7390
...
class ElectricMachineDataSet(_0.APIBase):
    ...
    @property
    def torque_ripple_input_type(self) -> '_6809.TorqueRippleInputType':
        ...
        return constructor.new(_6809.TorqueRippleInputType)(value) if value is not None else None

    @torque_ripple_input_type.setter
    def torque_ripple_input_type(self, value: '_6809.TorqueRippleInputType'):
    ...
    def multiple_fourier_series_interpolator_for(self, harmonic_load_data_type: '_1286.HarmonicLoadDataType') -> '_1421.MultipleFourierSeriesInterpolator':
    ...
    def add_or_replace_excitation_data(self, harmonic_load_data_type: '_1286.HarmonicLoadDataType', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7390.MeasurementType'):
    ...
    def add_or_replace_excitation_data_with_amplitudes_and_phases(self, harmonic_load_data_type: '_1286.HarmonicLoadDataType', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7390.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def multiple_fourier_series_interpolator_for_with_fe_node(self, harmonic_load_data_type: '_1286.HarmonicLoadDataType', node: '_2246.FESubstructureNode') -> '_1421.MultipleFourierSeriesInterpolator':
        ''' 'MultipleFourierSeriesInterpolatorFor' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_fe_node(self, harmonic_load_data_type: '_1286.HarmonicLoadDataType', node: '_2246.FESubstructureNode', speed: 'float', fourier_series_values: 'List[float]', fourier_series_name: 'str', fourier_series_measurement_type: '_7390.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
    ...
    def add_or_replace_excitation_data_with_amplitudes_phases_and_fe_node(self, harmonic_load_data_type: '_1286.HarmonicLoadDataType', node: '_2246.FESubstructureNode', speed: 'float', fourier_series_amplitudes: 'List[float]', fourier_series_phases: 'List[float]', fourier_series_mean_value: 'float', fourier_series_name: 'str', fourier_series_measurement_type: '_7390.MeasurementType'):
        ''' 'AddOrReplaceExcitationData' is the original name of this method.
