...
from mastapy.nodal_analysis.dev_tools_analyses import _161, _152
from mastapy.nodal_analysis import _58
from mastapy.system_model.fe import _2069
...
class FESubstructureWithSelectionForModalAnalysis(_2069.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def modal_draw_style(self) -> '_161.FEModelModalAnalysisDrawStyle':
        ...
        return constructor.new(_161.FEModelModalAnalysisDrawStyle)(self.wrapped.ModalDrawStyle) if self.wrapped.ModalDrawStyle else None
