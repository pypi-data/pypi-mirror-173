...
class ContactPairWithSelection(_0.APIBase):
    ...
    @property
    def contact_pair(self) -> '_174.ContactPairReporting':
        ...
        return constructor.new(_174.ContactPairReporting)(self.wrapped.ContactPair) if self.wrapped.ContactPair else None
