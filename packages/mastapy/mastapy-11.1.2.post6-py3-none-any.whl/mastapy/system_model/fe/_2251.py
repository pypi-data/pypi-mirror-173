...
class FESubstructureWithSelection(_2222.BaseFEWithSelection):
    '''FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self) -> '_2244.FESubstructure':
        ...
        return constructor.new(_2244.FESubstructure)(self.wrapped.FESubstructure) if self.wrapped.FESubstructure is not None else None

    @property
    def element_face_groups(self) -> 'List[_2237.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_2237.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_2262.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_2262.NodeGroupWithSelection))
        return value
