...
from mastapy.utility.units_and_measurements import _1367
from mastapy.system_model.fe import (
    _2044, _2067, _2090, _2038,
    _2040, _2065, _2088, _2066,
    _2062, _2074, _2075, _2073,
    _2070, _2071, _2072
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2128, _2124, _2132
from mastapy.nodal_analysis import _64, _78, _60
from mastapy.nodal_analysis.component_mode_synthesis import _197
from mastapy.nodal_analysis.space_claim_link import _120
from mastapy.system_model import _1906
from mastapy.math_utility import _1263
from mastapy.materials import _206, _248
...
from mastapy import _7202
from mastapy.nodal_analysis.fe_export_utility import _150
...
class FESubstructure(_60.FEStiffness):
    ...
    @property
    def bearing_node_alignment(self) -> '_2044.BearingNodeAlignmentOption':
        ...
        return constructor.new(_2044.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2044.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_2038.AlignmentMethod':
        ...
        return constructor.new(_2038.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2038.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def fe_meshing_options(self) -> '_78.ShaftFEMeshingOptions':
        ...
        return constructor.new(_78.ShaftFEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None

    @property
    def cms_model(self) -> '_197.CMSModel':
        ...
        return constructor.new(_197.CMSModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None

    @property
    def space_claim_dimensions(self) -> '_120.SpaceClaimDimensions':
        ...
        return constructor.new(_120.SpaceClaimDimensions)(self.wrapped.SpaceClaimDimensions) if self.wrapped.SpaceClaimDimensions else None

    @property
    def alignment_to_component(self) -> '_1906.RelativeComponentAlignment[_2124.Component]':
        ...
        return constructor.new(_1906.RelativeComponentAlignment)[_2124.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_2040.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_2040.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None

    @property
    def coordinate_system(self) -> '_1263.CoordinateSystem3D':
        ...
        return constructor.new(_1263.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def export(self) -> '_2065.FESubstructureExportOptions':
        ...
        return constructor.new(_2065.FESubstructureExportOptions)(self.wrapped.Export) if self.wrapped.Export else None

    @property
    def acoustic_radiation_efficiency(self) -> '_206.AcousticRadiationEfficiency':
        ...
        return constructor.new(_206.AcousticRadiationEfficiency)(self.wrapped.AcousticRadiationEfficiency) if self.wrapped.AcousticRadiationEfficiency else None

    @property
    def sound_pressure_enclosure(self) -> '_248.SoundPressureEnclosure':
        ...
        return constructor.new(_248.SoundPressureEnclosure)(self.wrapped.SoundPressureEnclosure) if self.wrapped.SoundPressureEnclosure else None

    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2088.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_2088.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2160.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2160.Shaft))
        return value

    @property
    def links(self) -> 'List[_2097.FELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2097.FELink))
        return value
    ...
    @property
    def geometries(self) -> 'List[_2062.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_2062.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_2074.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_2074.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2075.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_2075.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def fe_part(self) -> '_2132.FEPart':
        ...
        return constructor.new(_2132.FEPart)(self.wrapped.FEPart) if self.wrapped.FEPart else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7202.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2073.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2070.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2071.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2072.FESubstructureWithSelectionForModalAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_150.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7202.TaskProgress'] = None):
    ...
    def links_for(self, node: '_2066.FESubstructureNode') -> 'List[_2097.FELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_2097.FELink))
