...
from mastapy.system_model.fe import _2047
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.math_utility import _1255, _1254
...
class AlignConnectedComponentOptions(_0.APIBase):
    ...
    @property
    def first_component_alignment_axis(self) -> '_1255.Axis':
        ...
        return constructor.new(_1255.Axis)(value) if value else None

    @first_component_alignment_axis.setter
    def first_component_alignment_axis(self, value: '_1255.Axis'):
    ...
    @property
    def first_fe_alignment_axis(self) -> '_1254.AlignmentAxis':
        ...
        return constructor.new(_1254.AlignmentAxis)(value) if value else None

    @first_fe_alignment_axis.setter
    def first_fe_alignment_axis(self, value: '_1254.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def component_direction_normal_to_surface(self) -> '_1255.Axis':
    ...
    def component_direction_normal_to_surface(self, value: '_1255.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def fe_axis_approximately_in_perpendicular_direction(self) -> '_1254.AlignmentAxis':
    ...
    def fe_axis_approximately_in_perpendicular_direction(self, value: '_1254.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
