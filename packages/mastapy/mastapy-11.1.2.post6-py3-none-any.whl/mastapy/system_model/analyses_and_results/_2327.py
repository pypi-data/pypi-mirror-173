...
from mastapy.math_utility import _1263
from mastapy.utility.model_validation import _1526, _1527
...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def safety_factors(self) -> '_244.SafetyFactorGroup':
        ...
        return constructor.new(_244.SafetyFactorGroup)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors else None

    @property
    def component_design(self) -> '_1893.DesignEntity':
        ...
        if _1893.DesignEntity.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_connection(self) -> '_1954.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2147.Part':
    ...
    @property
    def local_coordinate_system(self) -> '_1263.CoordinateSystem3D':
        ...
        return constructor.new(_1263.CoordinateSystem3D)(self.wrapped.LocalCoordinateSystem) if self.wrapped.LocalCoordinateSystem else None
    ...
    @property
    def all_status_errors(self) -> 'List[_1527.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllStatusErrors, constructor.new(_1527.StatusItem))
        return value
