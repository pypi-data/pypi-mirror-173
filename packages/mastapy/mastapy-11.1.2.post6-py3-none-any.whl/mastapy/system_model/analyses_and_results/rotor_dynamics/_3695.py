...
from mastapy.utility.units_and_measurements.measurements import _1432
...
class ShaftModalComplexShape(_3693.ShaftComplexShape['_1432.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
