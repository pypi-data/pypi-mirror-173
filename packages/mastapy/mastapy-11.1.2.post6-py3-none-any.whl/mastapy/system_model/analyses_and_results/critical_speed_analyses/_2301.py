...
class CriticalSpeedAnalysis(_7198.StaticLoadAnalysisCase):
    '''CriticalSpeedAnalysis
    ...
    @property
    def critical_speed_analysis_options(self) -> '_6231.CriticalSpeedAnalysisOptions':
        ...
        return constructor.new(_6231.CriticalSpeedAnalysisOptions)(self.wrapped.CriticalSpeedAnalysisOptions) if self.wrapped.CriticalSpeedAnalysisOptions else None
