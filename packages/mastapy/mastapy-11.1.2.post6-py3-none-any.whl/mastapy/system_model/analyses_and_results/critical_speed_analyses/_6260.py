...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6258, _6259, _6257
...
class KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis(_6257.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_critical_speed_analysis(self) -> 'List[_6258.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsCriticalSpeedAnalysis, constructor.new(_6258.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_critical_speed_analysis(self) -> 'List[_6259.KlingelnbergCycloPalloidHypoidGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesCriticalSpeedAnalysis, constructor.new(_6259.KlingelnbergCycloPalloidHypoidGearMeshCriticalSpeedAnalysis))
        return value
