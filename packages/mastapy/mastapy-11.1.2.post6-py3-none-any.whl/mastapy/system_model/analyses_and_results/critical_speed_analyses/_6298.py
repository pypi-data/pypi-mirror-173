...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6296, _6297, _6329
...
class ConceptGearSetCriticalSpeedAnalysis(_6329.GearSetCriticalSpeedAnalysis):
    """ConceptGearSetCriticalSpeedAnalysis
    ...
    @property
    def concept_gears_critical_speed_analysis(self) -> 'List[_6296.ConceptGearCriticalSpeedAnalysis]':
    ...
    @property
    def concept_meshes_critical_speed_analysis(self) -> 'List[_6297.ConceptGearMeshCriticalSpeedAnalysis]':
