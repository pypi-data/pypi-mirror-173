...
class CriticalSpeedAnalysis(_7240.StaticLoadAnalysisCase):
    ...
    def critical_speed_analysis_options(self) -> '_6272.CriticalSpeedAnalysisOptions':
        ...
        return constructor.new(_6272.CriticalSpeedAnalysisOptions)(self.wrapped.CriticalSpeedAnalysisOptions) if self.wrapped.CriticalSpeedAnalysisOptions is not None else None
