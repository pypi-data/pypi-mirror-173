...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6377, _6378, _6285
...
class StraightBevelGearSetCriticalSpeedAnalysis(_6285.BevelGearSetCriticalSpeedAnalysis):
    """StraightBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_gears_critical_speed_analysis(self) -> 'List[_6377.StraightBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def straight_bevel_meshes_critical_speed_analysis(self) -> 'List[_6378.StraightBevelGearMeshCriticalSpeedAnalysis]':
