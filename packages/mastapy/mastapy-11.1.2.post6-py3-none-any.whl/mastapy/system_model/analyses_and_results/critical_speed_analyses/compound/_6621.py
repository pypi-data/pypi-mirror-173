...
class StraightBevelSunGearCompoundCriticalSpeedAnalysis(_6614.StraightBevelDiffGearCompoundCriticalSpeedAnalysis):
    '''StraightBevelSunGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6492.StraightBevelSunGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6492.StraightBevelSunGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6492.StraightBevelSunGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6492.StraightBevelSunGearCriticalSpeedAnalysis))
        return value
