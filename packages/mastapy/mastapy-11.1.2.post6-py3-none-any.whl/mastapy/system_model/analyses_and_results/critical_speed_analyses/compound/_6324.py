...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6352
...
class AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis(_6352.ConicalGearSetCompoundCriticalSpeedAnalysis):
    '''AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6193.AGMAGleasonConicalGearSetCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6193.AGMAGleasonConicalGearSetCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6193.AGMAGleasonConicalGearSetCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6193.AGMAGleasonConicalGearSetCriticalSpeedAnalysis))
        return value
