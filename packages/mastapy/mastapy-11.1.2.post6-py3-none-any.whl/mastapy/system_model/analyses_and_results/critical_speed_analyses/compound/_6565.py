...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6436
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6511
...
class FEPartCompoundCriticalSpeedAnalysis(_6511.AbstractShaftOrHousingCompoundCriticalSpeedAnalysis):
    '''FEPartCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6436.FEPartCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6436.FEPartCriticalSpeedAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6436.FEPartCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6436.FEPartCriticalSpeedAnalysis))
        return value
