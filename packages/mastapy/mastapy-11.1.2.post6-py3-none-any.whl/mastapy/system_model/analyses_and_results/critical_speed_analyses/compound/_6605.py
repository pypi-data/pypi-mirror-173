...
class ShaftHubConnectionCompoundCriticalSpeedAnalysis(_6545.ConnectorCompoundCriticalSpeedAnalysis):
    '''ShaftHubConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6476.ShaftHubConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6476.ShaftHubConnectionCriticalSpeedAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6476.ShaftHubConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6476.ShaftHubConnectionCriticalSpeedAnalysis))
        return value
