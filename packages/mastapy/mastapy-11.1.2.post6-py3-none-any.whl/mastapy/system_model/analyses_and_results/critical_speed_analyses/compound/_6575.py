...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6541
...
class KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis(_6541.ConicalGearCompoundCriticalSpeedAnalysis):
    '''KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6446.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6446.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6446.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6446.KlingelnbergCycloPalloidConicalGearCriticalSpeedAnalysis))
        return value
