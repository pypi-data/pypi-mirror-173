...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6460, _6461, _6404
...
class HypoidGearSetCompoundCriticalSpeedAnalysis(_6404.AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis):
    """HypoidGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6333.HypoidGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_gears_compound_critical_speed_analysis(self) -> 'List[_6460.HypoidGearCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_critical_speed_analysis(self) -> 'List[_6461.HypoidGearMeshCompoundCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6333.HypoidGearSetCriticalSpeedAnalysis]':
