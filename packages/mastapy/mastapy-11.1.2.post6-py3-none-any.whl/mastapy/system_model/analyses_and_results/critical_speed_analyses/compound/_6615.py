...
class StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis(_6526.BevelGearMeshCompoundCriticalSpeedAnalysis):
    '''StraightBevelDiffGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6486.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6486.StraightBevelDiffGearMeshCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6486.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6486.StraightBevelDiffGearMeshCriticalSpeedAnalysis))
        return value
