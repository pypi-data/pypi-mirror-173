...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6390
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6520
...
class UnbalancedMassCompoundCriticalSpeedAnalysis(_6520.VirtualComponentCompoundCriticalSpeedAnalysis):
    """UnbalancedMassCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6390.UnbalancedMassCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6390.UnbalancedMassCriticalSpeedAnalysis]':
