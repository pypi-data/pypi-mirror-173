...
class AbstractShaftCompoundCriticalSpeedAnalysis(_6320.AbstractShaftOrHousingCompoundCriticalSpeedAnalysis):
    '''AbstractShaftCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6188.AbstractShaftCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6188.AbstractShaftCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6188.AbstractShaftCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6188.AbstractShaftCriticalSpeedAnalysis))
        return value
