...
class CouplingCompoundCriticalSpeedAnalysis(_6416.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    '''CouplingCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6225.CouplingCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6225.CouplingCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6225.CouplingCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6225.CouplingCriticalSpeedAnalysis))
        return value
