...
class HypoidGearMeshCompoundCriticalSpeedAnalysis(_6403.AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis):
    """HypoidGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6332.HypoidGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6332.HypoidGearMeshCriticalSpeedAnalysis]':
