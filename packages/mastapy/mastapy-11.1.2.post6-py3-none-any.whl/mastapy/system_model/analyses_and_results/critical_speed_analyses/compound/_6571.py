...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6442
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6513
...
class HypoidGearCompoundCriticalSpeedAnalysis(_6513.AGMAGleasonConicalGearCompoundCriticalSpeedAnalysis):
    '''HypoidGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6442.HypoidGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6442.HypoidGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6442.HypoidGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6442.HypoidGearCriticalSpeedAnalysis))
        return value
