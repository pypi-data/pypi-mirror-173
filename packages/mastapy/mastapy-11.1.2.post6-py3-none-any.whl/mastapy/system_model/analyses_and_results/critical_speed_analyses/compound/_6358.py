...
class AbstractShaftOrHousingCompoundCriticalSpeedAnalysis(_6381.ComponentCompoundCriticalSpeedAnalysis):
    '''AbstractShaftOrHousingCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6227.AbstractShaftOrHousingCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6227.AbstractShaftOrHousingCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6227.AbstractShaftOrHousingCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6227.AbstractShaftOrHousingCriticalSpeedAnalysis))
        return value
