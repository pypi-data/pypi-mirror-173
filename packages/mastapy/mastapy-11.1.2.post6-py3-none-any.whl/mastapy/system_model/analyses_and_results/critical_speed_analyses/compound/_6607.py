...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6509
...
class SpecialisedAssemblyCompoundCriticalSpeedAnalysis(_6509.AbstractAssemblyCompoundCriticalSpeedAnalysis):
    '''SpecialisedAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6478.SpecialisedAssemblyCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6478.SpecialisedAssemblyCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6478.SpecialisedAssemblyCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6478.SpecialisedAssemblyCriticalSpeedAnalysis))
        return value
