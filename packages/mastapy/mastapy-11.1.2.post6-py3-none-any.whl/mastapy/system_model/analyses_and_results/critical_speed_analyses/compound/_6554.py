...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6425
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6510
...
class CycloidalDiscCompoundCriticalSpeedAnalysis(_6510.AbstractShaftCompoundCriticalSpeedAnalysis):
    '''CycloidalDiscCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6425.CycloidalDiscCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6425.CycloidalDiscCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6425.CycloidalDiscCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6425.CycloidalDiscCriticalSpeedAnalysis))
        return value
