...
class StraightBevelPlanetGearCompoundCriticalSpeedAnalysis(_6614.StraightBevelDiffGearCompoundCriticalSpeedAnalysis):
    '''StraightBevelPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6491.StraightBevelPlanetGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6491.StraightBevelPlanetGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6491.StraightBevelPlanetGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6491.StraightBevelPlanetGearCriticalSpeedAnalysis))
        return value
