...
class CouplingConnectionCompoundCriticalSpeedAnalysis(_6574.InterMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    '''CouplingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6415.CouplingConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6415.CouplingConnectionCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6415.CouplingConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6415.CouplingConnectionCriticalSpeedAnalysis))
        return value
