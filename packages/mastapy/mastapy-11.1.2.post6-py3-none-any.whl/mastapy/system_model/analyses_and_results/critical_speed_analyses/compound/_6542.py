...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6411
...
class ConicalGearMeshCompoundCriticalSpeedAnalysis(_6568.GearMeshCompoundCriticalSpeedAnalysis):
    '''ConicalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6411.ConicalGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6411.ConicalGearMeshCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6411.ConicalGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6411.ConicalGearMeshCriticalSpeedAnalysis))
        return value
