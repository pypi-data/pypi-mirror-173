...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6455
...
class MassDiscCompoundCriticalSpeedAnalysis(_6631.VirtualComponentCompoundCriticalSpeedAnalysis):
    '''MassDiscCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6455.MassDiscCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6455.MassDiscCriticalSpeedAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6455.MassDiscCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6455.MassDiscCriticalSpeedAnalysis))
        return value
