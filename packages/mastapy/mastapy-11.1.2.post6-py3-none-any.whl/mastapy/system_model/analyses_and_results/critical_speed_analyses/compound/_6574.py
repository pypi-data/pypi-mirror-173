...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6544
...
class InterMountableComponentConnectionCompoundCriticalSpeedAnalysis(_6544.ConnectionCompoundCriticalSpeedAnalysis):
    '''InterMountableComponentConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6445.InterMountableComponentConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6445.InterMountableComponentConnectionCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6445.InterMountableComponentConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6445.InterMountableComponentConnectionCriticalSpeedAnalysis))
        return value
