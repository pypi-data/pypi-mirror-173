...
class BevelDifferentialPlanetGearCompoundCriticalSpeedAnalysis(_6373.BevelDifferentialGearCompoundCriticalSpeedAnalysis):
    '''BevelDifferentialPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6245.BevelDifferentialPlanetGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6245.BevelDifferentialPlanetGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6245.BevelDifferentialPlanetGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6245.BevelDifferentialPlanetGearCriticalSpeedAnalysis))
        return value
