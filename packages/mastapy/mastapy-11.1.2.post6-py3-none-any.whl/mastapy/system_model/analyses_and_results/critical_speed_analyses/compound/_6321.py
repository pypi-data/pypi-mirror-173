...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6353
...
class AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis(_6353.ConnectionCompoundCriticalSpeedAnalysis):
    '''AbstractShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6190.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6190.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6190.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6190.AbstractShaftToMountableComponentConnectionCriticalSpeedAnalysis))
        return value
