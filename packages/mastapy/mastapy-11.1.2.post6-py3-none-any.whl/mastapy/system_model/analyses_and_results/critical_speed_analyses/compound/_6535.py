...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6405
...
class ConceptCouplingCompoundCriticalSpeedAnalysis(_6546.CouplingCompoundCriticalSpeedAnalysis):
    '''ConceptCouplingCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6405.ConceptCouplingCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6405.ConceptCouplingCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6405.ConceptCouplingCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6405.ConceptCouplingCriticalSpeedAnalysis))
        return value
