...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6404
...
class BevelGearSetCompoundCriticalSpeedAnalysis(_6404.AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis):
    """BevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6285.BevelGearSetCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6285.BevelGearSetCriticalSpeedAnalysis]':
