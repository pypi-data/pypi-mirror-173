...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6324
...
class BevelGearSetCompoundCriticalSpeedAnalysis(_6324.AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis):
    '''BevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6205.BevelGearSetCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6205.BevelGearSetCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6205.BevelGearSetCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6205.BevelGearSetCriticalSpeedAnalysis))
        return value
