...
class GearCompoundCriticalSpeedAnalysis(_6475.MountableComponentCompoundCriticalSpeedAnalysis):
    """GearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6327.GearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6327.GearCriticalSpeedAnalysis]':
