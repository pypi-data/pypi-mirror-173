...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6525
...
class StraightBevelDiffGearCompoundCriticalSpeedAnalysis(_6525.BevelGearCompoundCriticalSpeedAnalysis):
    '''StraightBevelDiffGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6485.StraightBevelDiffGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6485.StraightBevelDiffGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6485.StraightBevelDiffGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6485.StraightBevelDiffGearCriticalSpeedAnalysis))
        return value
