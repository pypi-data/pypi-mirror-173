...
class CouplingHalfCompoundCriticalSpeedAnalysis(_6586.MountableComponentCompoundCriticalSpeedAnalysis):
    '''CouplingHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6417.CouplingHalfCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6417.CouplingHalfCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6417.CouplingHalfCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6417.CouplingHalfCriticalSpeedAnalysis))
        return value
