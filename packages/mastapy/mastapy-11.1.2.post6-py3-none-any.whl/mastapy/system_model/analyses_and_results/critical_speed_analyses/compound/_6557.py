...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6428
...
class CylindricalGearMeshCompoundCriticalSpeedAnalysis(_6568.GearMeshCompoundCriticalSpeedAnalysis):
    '''CylindricalGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6428.CylindricalGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6428.CylindricalGearMeshCriticalSpeedAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6428.CylindricalGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6428.CylindricalGearMeshCriticalSpeedAnalysis))
        return value
