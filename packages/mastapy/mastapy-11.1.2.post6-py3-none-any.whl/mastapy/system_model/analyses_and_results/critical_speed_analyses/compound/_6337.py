...
class BoltCompoundCriticalSpeedAnalysis(_6343.ComponentCompoundCriticalSpeedAnalysis):
    '''BoltCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6206.BoltCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6206.BoltCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6206.BoltCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6206.BoltCriticalSpeedAnalysis))
        return value
