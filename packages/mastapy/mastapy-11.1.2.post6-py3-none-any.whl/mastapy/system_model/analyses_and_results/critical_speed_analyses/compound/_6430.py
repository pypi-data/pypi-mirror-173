...
class ConicalGearCompoundCriticalSpeedAnalysis(_6456.GearCompoundCriticalSpeedAnalysis):
    """ConicalGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6299.ConicalGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6299.ConicalGearCriticalSpeedAnalysis]':
