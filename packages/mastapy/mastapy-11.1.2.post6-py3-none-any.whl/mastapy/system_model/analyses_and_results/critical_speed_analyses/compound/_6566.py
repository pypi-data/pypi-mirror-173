...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6437
...
class FlexiblePinAssemblyCompoundCriticalSpeedAnalysis(_6607.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    '''FlexiblePinAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6437.FlexiblePinAssemblyCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6437.FlexiblePinAssemblyCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6437.FlexiblePinAssemblyCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6437.FlexiblePinAssemblyCriticalSpeedAnalysis))
        return value
