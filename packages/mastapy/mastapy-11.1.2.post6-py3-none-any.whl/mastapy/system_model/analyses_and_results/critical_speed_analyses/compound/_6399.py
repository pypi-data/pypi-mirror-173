...
class AbstractShaftCompoundCriticalSpeedAnalysis(_6400.AbstractShaftOrHousingCompoundCriticalSpeedAnalysis):
    """AbstractShaftCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6268.AbstractShaftCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6268.AbstractShaftCriticalSpeedAnalysis]':
