...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6443
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6514
...
class HypoidGearMeshCompoundCriticalSpeedAnalysis(_6514.AGMAGleasonConicalGearMeshCompoundCriticalSpeedAnalysis):
    '''HypoidGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6443.HypoidGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6443.HypoidGearMeshCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6443.HypoidGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6443.HypoidGearMeshCriticalSpeedAnalysis))
        return value
