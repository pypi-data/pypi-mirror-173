...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6449
...
class KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis(_6575.KlingelnbergCycloPalloidConicalGearCompoundCriticalSpeedAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6449.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6449.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6449.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6449.KlingelnbergCycloPalloidHypoidGearCriticalSpeedAnalysis))
        return value
