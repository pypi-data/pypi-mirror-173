...
class RollingRingCompoundCriticalSpeedAnalysis(_6548.CouplingHalfCompoundCriticalSpeedAnalysis):
    '''RollingRingCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6473.RollingRingCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6473.RollingRingCriticalSpeedAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6473.RollingRingCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6473.RollingRingCriticalSpeedAnalysis))
        return value
