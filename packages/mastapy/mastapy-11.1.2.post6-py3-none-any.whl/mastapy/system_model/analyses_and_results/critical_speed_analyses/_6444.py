...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6442, _6443, _6384
...
class HypoidGearSetCriticalSpeedAnalysis(_6384.AGMAGleasonConicalGearSetCriticalSpeedAnalysis):
    '''HypoidGearSetCriticalSpeedAnalysis
    ...
    @property
    def hypoid_gears_critical_speed_analysis(self) -> 'List[_6442.HypoidGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsCriticalSpeedAnalysis, constructor.new(_6442.HypoidGearCriticalSpeedAnalysis))
        return value

    @property
    def hypoid_meshes_critical_speed_analysis(self) -> 'List[_6443.HypoidGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesCriticalSpeedAnalysis, constructor.new(_6443.HypoidGearMeshCriticalSpeedAnalysis))
        return value
