...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6419
...
class CriticalSpeedAnalysis(_7381.StaticLoadAnalysisCase):
    '''CriticalSpeedAnalysis
    ...
    @property
    def critical_speed_analysis_options(self) -> '_6419.CriticalSpeedAnalysisOptions':
        ...
        return constructor.new(_6419.CriticalSpeedAnalysisOptions)(self.wrapped.CriticalSpeedAnalysisOptions) if self.wrapped.CriticalSpeedAnalysisOptions is not None else None
