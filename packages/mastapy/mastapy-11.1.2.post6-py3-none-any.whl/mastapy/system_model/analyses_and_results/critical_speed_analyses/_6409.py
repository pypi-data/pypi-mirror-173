...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6407, _6408, _6440
...
class ConceptGearSetCriticalSpeedAnalysis(_6440.GearSetCriticalSpeedAnalysis):
    '''ConceptGearSetCriticalSpeedAnalysis
    ...
    @property
    def concept_gears_critical_speed_analysis(self) -> 'List[_6407.ConceptGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCriticalSpeedAnalysis, constructor.new(_6407.ConceptGearCriticalSpeedAnalysis))
        return value

    @property
    def concept_meshes_critical_speed_analysis(self) -> 'List[_6408.ConceptGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCriticalSpeedAnalysis, constructor.new(_6408.ConceptGearMeshCriticalSpeedAnalysis))
        return value
