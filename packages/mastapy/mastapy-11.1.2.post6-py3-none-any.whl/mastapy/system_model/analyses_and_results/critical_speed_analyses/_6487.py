...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6485, _6486, _6396
...
class StraightBevelDiffGearSetCriticalSpeedAnalysis(_6396.BevelGearSetCriticalSpeedAnalysis):
    '''StraightBevelDiffGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_diff_gears_critical_speed_analysis(self) -> 'List[_6485.StraightBevelDiffGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsCriticalSpeedAnalysis, constructor.new(_6485.StraightBevelDiffGearCriticalSpeedAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_critical_speed_analysis(self) -> 'List[_6486.StraightBevelDiffGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesCriticalSpeedAnalysis, constructor.new(_6486.StraightBevelDiffGearMeshCriticalSpeedAnalysis))
        return value
