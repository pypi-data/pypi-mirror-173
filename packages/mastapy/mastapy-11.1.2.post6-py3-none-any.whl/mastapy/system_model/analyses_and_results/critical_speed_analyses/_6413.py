...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _2485
...
class ConnectionCriticalSpeedAnalysis(_7372.ConnectionStaticLoadAnalysisCase):
    '''ConnectionCriticalSpeedAnalysis
    ...
    @property
    def critical_speed_analysis(self) -> '_2485.CriticalSpeedAnalysis':
        ...
        return constructor.new(_2485.CriticalSpeedAnalysis)(self.wrapped.CriticalSpeedAnalysis) if self.wrapped.CriticalSpeedAnalysis is not None else None
