...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2859, _2857, _2744
...
class ZerolBevelGearSetSteadyStateSynchronousResponse(_2744.BevelGearSetSteadyStateSynchronousResponse):
    """ZerolBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def zerol_bevel_gears_steady_state_synchronous_response(self) -> 'List[_2859.ZerolBevelGearSteadyStateSynchronousResponse]':
    ...
    @property
    def zerol_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_2857.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
