...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3485, _3483, _3416
...
class WormGearSetSteadyStateSynchronousResponse(_3416.GearSetSteadyStateSynchronousResponse):
    '''WormGearSetSteadyStateSynchronousResponse
    ...
    @property
    def worm_gears_steady_state_synchronous_response(self) -> 'List[_3485.WormGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsSteadyStateSynchronousResponse, constructor.new(_3485.WormGearSteadyStateSynchronousResponse))
        return value

    @property
    def worm_meshes_steady_state_synchronous_response(self) -> 'List[_3483.WormGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesSteadyStateSynchronousResponse, constructor.new(_3483.WormGearMeshSteadyStateSynchronousResponse))
        return value
