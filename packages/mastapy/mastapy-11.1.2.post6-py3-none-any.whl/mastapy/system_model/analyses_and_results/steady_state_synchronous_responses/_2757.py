...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2758, _2756, _2787
...
class ConceptGearSetSteadyStateSynchronousResponse(_2787.GearSetSteadyStateSynchronousResponse):
    """ConceptGearSetSteadyStateSynchronousResponse
    ...
    @property
    def concept_gears_steady_state_synchronous_response(self) -> 'List[_2758.ConceptGearSteadyStateSynchronousResponse]':
    ...
    @property
    def concept_meshes_steady_state_synchronous_response(self) -> 'List[_2756.ConceptGearMeshSteadyStateSynchronousResponse]':
