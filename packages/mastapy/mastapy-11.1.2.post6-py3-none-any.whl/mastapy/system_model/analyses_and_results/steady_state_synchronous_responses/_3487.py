...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3488, _3486, _3373
...
class ZerolBevelGearSetSteadyStateSynchronousResponse(_3373.BevelGearSetSteadyStateSynchronousResponse):
    '''ZerolBevelGearSetSteadyStateSynchronousResponse
    ...
    @property
    def zerol_bevel_gears_steady_state_synchronous_response(self) -> 'List[_3488.ZerolBevelGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsSteadyStateSynchronousResponse, constructor.new(_3488.ZerolBevelGearSteadyStateSynchronousResponse))
        return value

    @property
    def zerol_bevel_meshes_steady_state_synchronous_response(self) -> 'List[_3486.ZerolBevelGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesSteadyStateSynchronousResponse, constructor.new(_3486.ZerolBevelGearMeshSteadyStateSynchronousResponse))
        return value
