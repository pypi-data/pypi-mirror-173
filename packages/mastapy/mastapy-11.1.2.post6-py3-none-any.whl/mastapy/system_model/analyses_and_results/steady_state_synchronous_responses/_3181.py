...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3182, _3180, _3186
...
class BevelDifferentialGearSetSteadyStateSynchronousResponse(_3186.BevelGearSetSteadyStateSynchronousResponse):
    '''BevelDifferentialGearSetSteadyStateSynchronousResponse
    ...
    @property
    def bevel_differential_gears_steady_state_synchronous_response(self) -> 'List[_3182.BevelDifferentialGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsSteadyStateSynchronousResponse, constructor.new(_3182.BevelDifferentialGearSteadyStateSynchronousResponse))
        return value

    @property
    def bevel_differential_meshes_steady_state_synchronous_response(self) -> 'List[_3180.BevelDifferentialGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesSteadyStateSynchronousResponse, constructor.new(_3180.BevelDifferentialGearMeshSteadyStateSynchronousResponse))
        return value
