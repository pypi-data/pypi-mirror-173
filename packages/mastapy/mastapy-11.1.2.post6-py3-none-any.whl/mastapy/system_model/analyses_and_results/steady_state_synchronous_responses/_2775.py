...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2776, _2774, _2787
...
class CylindricalGearSetSteadyStateSynchronousResponse(_2787.GearSetSteadyStateSynchronousResponse):
    """CylindricalGearSetSteadyStateSynchronousResponse
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response(self) -> 'List[_2776.CylindricalGearSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_meshes_steady_state_synchronous_response(self) -> 'List[_2774.CylindricalGearMeshSteadyStateSynchronousResponse]':
