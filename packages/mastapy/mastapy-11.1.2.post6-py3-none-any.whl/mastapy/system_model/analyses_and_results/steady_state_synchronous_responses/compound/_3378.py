...
class ConnectorCompoundSteadyStateSynchronousResponse(_3419.MountableComponentCompoundSteadyStateSynchronousResponse):
    '''ConnectorCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3245.ConnectorSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3245.ConnectorSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3245.ConnectorSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3245.ConnectorSteadyStateSynchronousResponse))
        return value
