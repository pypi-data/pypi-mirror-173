...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3403
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3548
...
class CylindricalGearMeshCompoundSteadyStateSynchronousResponse(_3548.GearMeshCompoundSteadyStateSynchronousResponse):
    '''CylindricalGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3403.CylindricalGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3403.CylindricalGearMeshSteadyStateSynchronousResponse))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3403.CylindricalGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3403.CylindricalGearMeshSteadyStateSynchronousResponse))
        return value
