...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2837
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _2965, _2966, _2878
...
class StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse(_2878.BevelGearSetCompoundSteadyStateSynchronousResponse):
    """StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2837.StraightBevelDiffGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_gears_compound_steady_state_synchronous_response(self) -> 'List[_2965.StraightBevelDiffGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_steady_state_synchronous_response(self) -> 'List[_2966.StraightBevelDiffGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2837.StraightBevelDiffGearSetSteadyStateSynchronousResponse]':
