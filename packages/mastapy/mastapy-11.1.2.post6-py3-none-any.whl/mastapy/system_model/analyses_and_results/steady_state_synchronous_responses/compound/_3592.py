...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3459
...
class SpringDamperConnectionCompoundSteadyStateSynchronousResponse(_3527.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    '''SpringDamperConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3459.SpringDamperConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3459.SpringDamperConnectionSteadyStateSynchronousResponse))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3459.SpringDamperConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3459.SpringDamperConnectionSteadyStateSynchronousResponse))
        return value
