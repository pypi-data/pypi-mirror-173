...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3489
...
class SpecialisedAssemblyCompoundSteadyStateSynchronousResponse(_3489.AbstractAssemblyCompoundSteadyStateSynchronousResponse):
    '''SpecialisedAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3455.SpecialisedAssemblySteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3455.SpecialisedAssemblySteadyStateSynchronousResponse))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3455.SpecialisedAssemblySteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3455.SpecialisedAssemblySteadyStateSynchronousResponse))
        return value
