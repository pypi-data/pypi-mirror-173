...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3391
...
class PlanetaryGearSetCompoundSteadyStateSynchronousResponse(_3391.CylindricalGearSetCompoundSteadyStateSynchronousResponse):
    '''PlanetaryGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3294.PlanetaryGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3294.PlanetaryGearSetSteadyStateSynchronousResponse))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3294.PlanetaryGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3294.PlanetaryGearSetSteadyStateSynchronousResponse))
        return value
