...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3392
...
class ConnectorCompoundSteadyStateSynchronousResponse(_3566.MountableComponentCompoundSteadyStateSynchronousResponse):
    '''ConnectorCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3392.ConnectorSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3392.ConnectorSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3392.ConnectorSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3392.ConnectorSteadyStateSynchronousResponse))
        return value
