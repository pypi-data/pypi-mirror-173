...
class AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponse(_3375.ConicalGearMeshCompoundSteadyStateSynchronousResponse):
    '''AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3213.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3213.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponse))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3213.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3213.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponse))
        return value
