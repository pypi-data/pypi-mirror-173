...
class KlingelnbergCycloPalloidConicalGearCompoundSteadyStateSynchronousResponse(_3374.ConicalGearCompoundSteadyStateSynchronousResponse):
    '''KlingelnbergCycloPalloidConicalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3278.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3278.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3278.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3278.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponse))
        return value
