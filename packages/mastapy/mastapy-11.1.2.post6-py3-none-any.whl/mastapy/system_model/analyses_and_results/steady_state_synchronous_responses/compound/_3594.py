...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3467
...
class StraightBevelDiffGearCompoundSteadyStateSynchronousResponse(_3505.BevelGearCompoundSteadyStateSynchronousResponse):
    '''StraightBevelDiffGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3467.StraightBevelDiffGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3467.StraightBevelDiffGearSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3467.StraightBevelDiffGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3467.StraightBevelDiffGearSteadyStateSynchronousResponse))
        return value
