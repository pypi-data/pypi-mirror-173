...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _2864
...
class HypoidGearCompoundSteadyStateSynchronousResponse(_2864.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse):
    """HypoidGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2792.HypoidGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2792.HypoidGearSteadyStateSynchronousResponse]':
