...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3452
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3525
...
class ShaftHubConnectionCompoundSteadyStateSynchronousResponse(_3525.ConnectorCompoundSteadyStateSynchronousResponse):
    '''ShaftHubConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3452.ShaftHubConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3452.ShaftHubConnectionSteadyStateSynchronousResponse))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3452.ShaftHubConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3452.ShaftHubConnectionSteadyStateSynchronousResponse))
        return value
