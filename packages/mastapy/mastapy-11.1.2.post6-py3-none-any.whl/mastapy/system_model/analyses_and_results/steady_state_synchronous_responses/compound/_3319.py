...
class BevelGearMeshCompoundSteadyStateSynchronousResponse(_3307.AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponse):
    '''BevelGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3185.BevelGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3185.BevelGearMeshSteadyStateSynchronousResponse))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3185.BevelGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3185.BevelGearMeshSteadyStateSynchronousResponse))
        return value
