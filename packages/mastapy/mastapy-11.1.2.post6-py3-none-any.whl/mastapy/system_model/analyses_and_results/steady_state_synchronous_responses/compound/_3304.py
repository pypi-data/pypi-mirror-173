...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3327
...
class AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse(_3327.ComponentCompoundSteadyStateSynchronousResponse):
    '''AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3170.AbstractShaftOrHousingSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3170.AbstractShaftOrHousingSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3170.AbstractShaftOrHousingSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3170.AbstractShaftOrHousingSteadyStateSynchronousResponse))
        return value
