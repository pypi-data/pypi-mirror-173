...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2783
...
class FaceGearCompoundSteadyStateSynchronousResponse(_2918.GearCompoundSteadyStateSynchronousResponse):
    """FaceGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2783.FaceGearSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2783.FaceGearSteadyStateSynchronousResponse]':
