...
class CouplingCompoundSteadyStateSynchronousResponse(_3440.SpecialisedAssemblyCompoundSteadyStateSynchronousResponse):
    '''CouplingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3248.CouplingSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3248.CouplingSteadyStateSynchronousResponse))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3248.CouplingSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3248.CouplingSteadyStateSynchronousResponse))
        return value
