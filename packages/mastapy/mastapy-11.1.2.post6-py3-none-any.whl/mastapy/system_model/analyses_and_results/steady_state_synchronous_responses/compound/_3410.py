...
class KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponse(_3376.ConicalGearSetCompoundSteadyStateSynchronousResponse):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3277.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3277.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3277.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3277.KlingelnbergCycloPalloidConicalGearSetSteadyStateSynchronousResponse))
        return value
