...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3418
...
class GuideDxfModelCompoundSteadyStateSynchronousResponse(_3514.ComponentCompoundSteadyStateSynchronousResponse):
    '''GuideDxfModelCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3418.GuideDxfModelSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3418.GuideDxfModelSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3418.GuideDxfModelSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3418.GuideDxfModelSteadyStateSynchronousResponse))
        return value
