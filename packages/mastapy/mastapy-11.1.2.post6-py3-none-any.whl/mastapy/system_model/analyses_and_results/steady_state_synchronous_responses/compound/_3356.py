...
class BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse(_3353.BevelDifferentialGearCompoundSteadyStateSynchronousResponse):
    '''BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3223.BevelDifferentialPlanetGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3223.BevelDifferentialPlanetGearSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3223.BevelDifferentialPlanetGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3223.BevelDifferentialPlanetGearSteadyStateSynchronousResponse))
        return value
