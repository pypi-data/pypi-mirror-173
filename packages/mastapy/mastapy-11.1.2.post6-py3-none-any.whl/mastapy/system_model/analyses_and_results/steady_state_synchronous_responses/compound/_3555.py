...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3521
...
class KlingelnbergCycloPalloidConicalGearCompoundSteadyStateSynchronousResponse(_3521.ConicalGearCompoundSteadyStateSynchronousResponse):
    '''KlingelnbergCycloPalloidConicalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3425.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3425.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3425.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3425.KlingelnbergCycloPalloidConicalGearSteadyStateSynchronousResponse))
        return value
