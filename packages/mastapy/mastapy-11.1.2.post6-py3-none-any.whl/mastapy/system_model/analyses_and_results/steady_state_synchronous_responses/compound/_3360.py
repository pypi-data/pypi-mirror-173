...
class BevelGearSetCompoundSteadyStateSynchronousResponse(_3348.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse):
    '''BevelGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3226.BevelGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3226.BevelGearSetSteadyStateSynchronousResponse))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3226.BevelGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3226.BevelGearSetSteadyStateSynchronousResponse))
        return value
