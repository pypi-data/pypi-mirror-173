...
class AbstractAssemblyCompoundSteadyStateSynchronousResponse(_3415.PartCompoundSteadyStateSynchronousResponse):
    '''AbstractAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3203.AbstractAssemblySteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3203.AbstractAssemblySteadyStateSynchronousResponse))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3203.AbstractAssemblySteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3203.AbstractAssemblySteadyStateSynchronousResponse))
        return value
