...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2763
...
class ConnectorCompoundSteadyStateSynchronousResponse(_2937.MountableComponentCompoundSteadyStateSynchronousResponse):
    """ConnectorCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2763.ConnectorSteadyStateSynchronousResponse]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2763.ConnectorSteadyStateSynchronousResponse]':
