...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3477
...
class TorqueConverterConnectionCompoundSteadyStateSynchronousResponse(_3527.CouplingConnectionCompoundSteadyStateSynchronousResponse):
    '''TorqueConverterConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3477.TorqueConverterConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3477.TorqueConverterConnectionSteadyStateSynchronousResponse))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3477.TorqueConverterConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3477.TorqueConverterConnectionSteadyStateSynchronousResponse))
        return value
