...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _2907, _2908, _2920
...
class CylindricalGearSetCompoundSteadyStateSynchronousResponse(_2920.GearSetCompoundSteadyStateSynchronousResponse):
    """CylindricalGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2775.CylindricalGearSetSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_gears_compound_steady_state_synchronous_response(self) -> 'List[_2907.CylindricalGearCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def cylindrical_meshes_compound_steady_state_synchronous_response(self) -> 'List[_2908.CylindricalGearMeshCompoundSteadyStateSynchronousResponse]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2775.CylindricalGearSetSteadyStateSynchronousResponse]':
