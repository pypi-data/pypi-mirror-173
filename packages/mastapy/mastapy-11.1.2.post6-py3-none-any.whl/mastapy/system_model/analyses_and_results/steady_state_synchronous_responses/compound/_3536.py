...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3405
...
class CylindricalGearCompoundSteadyStateSynchronousResponse(_3547.GearCompoundSteadyStateSynchronousResponse):
    '''CylindricalGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3405.CylindricalGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3405.CylindricalGearSteadyStateSynchronousResponse))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3405.CylindricalGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3405.CylindricalGearSteadyStateSynchronousResponse))
        return value
