...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3364
...
class BearingCompoundSteadyStateSynchronousResponse(_3525.ConnectorCompoundSteadyStateSynchronousResponse):
    '''BearingCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3364.BearingSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3364.BearingSteadyStateSynchronousResponse))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3364.BearingSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3364.BearingSteadyStateSynchronousResponse))
        return value
