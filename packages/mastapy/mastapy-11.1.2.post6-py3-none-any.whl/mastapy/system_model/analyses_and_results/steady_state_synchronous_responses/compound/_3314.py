...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3319
...
class BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse(_3319.BevelGearMeshCompoundSteadyStateSynchronousResponse):
    '''BevelDifferentialGearMeshCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3180.BevelDifferentialGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3180.BevelDifferentialGearMeshSteadyStateSynchronousResponse))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3180.BevelDifferentialGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3180.BevelDifferentialGearMeshSteadyStateSynchronousResponse))
        return value
