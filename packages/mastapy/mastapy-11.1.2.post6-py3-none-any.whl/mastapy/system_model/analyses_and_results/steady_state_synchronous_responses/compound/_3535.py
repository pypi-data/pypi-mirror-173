...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3401
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3492
...
class CycloidalDiscPlanetaryBearingConnectionCompoundSteadyStateSynchronousResponse(_3492.AbstractShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3401.CycloidalDiscPlanetaryBearingConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3401.CycloidalDiscPlanetaryBearingConnectionSteadyStateSynchronousResponse))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3401.CycloidalDiscPlanetaryBearingConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3401.CycloidalDiscPlanetaryBearingConnectionSteadyStateSynchronousResponse))
        return value
