...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _2771
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _2884
...
class CycloidalDiscCentralBearingConnectionCompoundSteadyStateSynchronousResponse(_2884.CoaxialConnectionCompoundSteadyStateSynchronousResponse):
    """CycloidalDiscCentralBearingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2771.CycloidalDiscCentralBearingConnectionSteadyStateSynchronousResponse]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2771.CycloidalDiscCentralBearingConnectionSteadyStateSynchronousResponse]':
