...
class AbstractShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse(_3337.ConnectionCompoundSteadyStateSynchronousResponse):
    '''AbstractShaftToMountableComponentConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3172.AbstractShaftToMountableComponentConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3172.AbstractShaftToMountableComponentConnectionSteadyStateSynchronousResponse))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3172.AbstractShaftToMountableComponentConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3172.AbstractShaftToMountableComponentConnectionSteadyStateSynchronousResponse))
        return value
