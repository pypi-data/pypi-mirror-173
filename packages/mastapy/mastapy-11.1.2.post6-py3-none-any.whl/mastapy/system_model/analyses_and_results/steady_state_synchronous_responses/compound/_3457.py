...
class SynchroniserPartCompoundSteadyStateSynchronousResponse(_3381.CouplingHalfCompoundSteadyStateSynchronousResponse):
    '''SynchroniserPartCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3327.SynchroniserPartSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3327.SynchroniserPartSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3327.SynchroniserPartSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3327.SynchroniserPartSteadyStateSynchronousResponse))
        return value
