...
class PartSteadyStateSynchronousResponse(_7238.PartStaticLoadAnalysisCase):
    ...
    def steady_state_synchronous_response(self) -> '_3315.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3315.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse is not None else None
