...
class AGMAGleasonConicalGearSetSystemDeflection(_2469.ConicalGearSetSystemDeflection):
    """AGMAGleasonConicalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3780.AGMAGleasonConicalGearSetPowerFlow':
