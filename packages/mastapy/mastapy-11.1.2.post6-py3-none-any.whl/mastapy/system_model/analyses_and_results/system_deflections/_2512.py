...
from mastapy.system_model.analyses_and_results.power_flows import _3841, _3844, _3847
...
class KlingelnbergCycloPalloidConicalGearMeshSystemDeflection(_2468.ConicalGearMeshSystemDeflection):
    """KlingelnbergCycloPalloidConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3841.KlingelnbergCycloPalloidConicalGearMeshPowerFlow':
