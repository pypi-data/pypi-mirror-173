...
class CycloidalDiscCentralBearingConnectionSystemDeflection(_2569.CoaxialConnectionSystemDeflection):
    '''CycloidalDiscCentralBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3929.CycloidalDiscCentralBearingConnectionPowerFlow':
        ...
        return constructor.new(_3929.CycloidalDiscCentralBearingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
