...
class ExternalCADModelSystemDeflection(_2570.ComponentSystemDeflection):
    '''ExternalCADModelSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3938.ExternalCADModelPowerFlow':
        ...
        return constructor.new(_3938.ExternalCADModelPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
