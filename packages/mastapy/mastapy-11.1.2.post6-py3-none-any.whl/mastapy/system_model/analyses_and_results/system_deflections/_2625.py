...
from mastapy.system_model.analyses_and_results.power_flows import _3953, _3956, _3959
...
class KlingelnbergCycloPalloidConicalGearSystemDeflection(_2581.ConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3953.KlingelnbergCycloPalloidConicalGearPowerFlow':
