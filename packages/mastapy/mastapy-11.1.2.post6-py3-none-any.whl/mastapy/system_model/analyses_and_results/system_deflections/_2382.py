...
class ClutchHalfSystemDeflection(_2400.CouplingHalfSystemDeflection):
    '''ClutchHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3720.ClutchHalfPowerFlow':
        ...
        return constructor.new(_3720.ClutchHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
