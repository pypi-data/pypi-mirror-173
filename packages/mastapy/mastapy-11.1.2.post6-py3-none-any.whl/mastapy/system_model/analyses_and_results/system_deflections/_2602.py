...
from mastapy.system_model.analyses_and_results.system_deflections import _2600
...
class CylindricalGearSystemDeflectionWithLTCAResults(_2600.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_821.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_821.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults is not None else None
