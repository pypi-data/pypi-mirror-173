...
from mastapy.system_model.analyses_and_results.system_deflections import _2621
...
class RingPinToDiscContactReporting(_0.APIBase):
    ...
    @property
    def contact(self) -> '_2705.SplineFlankContactReporting':
        ...
        return constructor.new(_2705.SplineFlankContactReporting)(self.wrapped.Contact) if self.wrapped.Contact is not None else None

    @property
    def information_at_ring_pin_to_disc_contact_point_from_geometry(self) -> '_6742.InformationAtRingPinToDiscContactPointFromGeometry':
        ...
        return constructor.new(_6742.InformationAtRingPinToDiscContactPointFromGeometry)(self.wrapped.InformationAtRingPinToDiscContactPointFromGeometry) if self.wrapped.InformationAtRingPinToDiscContactPointFromGeometry is not None else None

    @property
    def information_for_contact_points_along_face_width(self) -> 'List[_2621.InformationForContactAtPointAlongFaceWidth]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InformationForContactPointsAlongFaceWidth, constructor.new(_2621.InformationForContactAtPointAlongFaceWidth))
        return value
