...
class ConceptGearSystemDeflection(_2429.GearSystemDeflection):
    '''ConceptGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3728.ConceptGearPowerFlow':
        ...
        return constructor.new(_3728.ConceptGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
