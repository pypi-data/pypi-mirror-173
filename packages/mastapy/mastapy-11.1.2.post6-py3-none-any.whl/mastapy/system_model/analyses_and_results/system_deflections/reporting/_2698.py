...
from mastapy.utility_gui.charts import _1739
...
class FlexibleGearChart(_0.APIBase):
    ...
    @property
    def chart(self) -> '_1739.LegacyChartMathChartDefinition':
        ...
        return constructor.new(_1739.LegacyChartMathChartDefinition)(self.wrapped.Chart) if self.wrapped.Chart is not None else None
