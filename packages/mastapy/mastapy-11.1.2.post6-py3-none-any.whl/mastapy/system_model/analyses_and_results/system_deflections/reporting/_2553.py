...
class MeshDeflectionResults(_0.APIBase):
    ...
    @property
    def gears(self) -> 'List[_2552.GearInMeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_2552.GearInMeshDeflectionResults))
        return value
