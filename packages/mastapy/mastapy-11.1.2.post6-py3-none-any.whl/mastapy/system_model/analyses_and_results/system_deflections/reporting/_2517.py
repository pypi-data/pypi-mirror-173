...
from mastapy.utility.enums import _1550
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.utility.report import _1492
...
class ShaftSystemDeflectionSectionsReport(_1492.CustomReportChart):
    '''ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1550.TableAndChartOptions':
        '''TableAndChartOptions: 'Display' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Display)
        return constructor.new(_1550.TableAndChartOptions)(value) if value else None

    @display.setter
    def display(self, value: '_1550.TableAndChartOptions'):
