...
class MeshDeflectionResults(_0.APIBase):
    ...
    @property
    def gears(self) -> 'List[_2512.GearInMeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_2512.GearInMeshDeflectionResults))
        return value
