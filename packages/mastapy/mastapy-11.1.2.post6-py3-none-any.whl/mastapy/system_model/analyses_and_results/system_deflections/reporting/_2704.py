...
from mastapy.utility.enums import _1708
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.utility.report import _1648
...
class ShaftSystemDeflectionSectionsReport(_1648.CustomReportChart):
    '''ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1708.TableAndChartOptions':
        '''TableAndChartOptions: 'Display' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Display)
        return constructor.new(_1708.TableAndChartOptions)(value) if value is not None else None

    @display.setter
    def display(self, value: '_1708.TableAndChartOptions'):
