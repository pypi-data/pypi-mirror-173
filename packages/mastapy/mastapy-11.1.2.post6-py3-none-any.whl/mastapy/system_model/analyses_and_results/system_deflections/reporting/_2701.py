...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2702
...
class PlanetCarrierWindup(_0.APIBase):
    ...
    @property
    def pin_wind_ups(self) -> 'List[_2702.PlanetPinWindup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PinWindUps, constructor.new(_2702.PlanetPinWindup))
        return value
