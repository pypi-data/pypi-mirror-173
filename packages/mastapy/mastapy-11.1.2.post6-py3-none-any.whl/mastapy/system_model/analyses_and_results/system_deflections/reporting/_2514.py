...
class PlanetCarrierWindup(_0.APIBase):
    ...
    @property
    def pin_wind_ups(self) -> 'List[_2515.PlanetPinWindup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PinWindUps, constructor.new(_2515.PlanetPinWindup))
        return value
