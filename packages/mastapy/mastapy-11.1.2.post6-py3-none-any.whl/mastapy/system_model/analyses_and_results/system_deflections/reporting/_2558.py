...
class SplineFlankContactReporting(_0.APIBase):
    ...
    def relative_deflection_wcs(self) -> '_1347.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1347.VectorWithLinearAndAngularComponents)(self.wrapped.RelativeDeflectionWCS) if self.wrapped.RelativeDeflectionWCS is not None else None
    ...
    def relative_deflection_lcs(self) -> '_1347.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1347.VectorWithLinearAndAngularComponents)(self.wrapped.RelativeDeflectionLCS) if self.wrapped.RelativeDeflectionLCS is not None else None
    ...
    def force_on_inner_wcs(self) -> '_1347.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1347.VectorWithLinearAndAngularComponents)(self.wrapped.ForceOnInnerWCS) if self.wrapped.ForceOnInnerWCS is not None else None
    ...
    def force_on_inner_contact_coordinate_system(self) -> '_1347.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1347.VectorWithLinearAndAngularComponents)(self.wrapped.ForceOnInnerContactCoordinateSystem) if self.wrapped.ForceOnInnerContactCoordinateSystem is not None else None
