...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2546
...
class MeshDeflectionResults(_0.APIBase):
    ...
    @property
    def gears(self) -> 'List[_2546.GearInMeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_2546.GearInMeshDeflectionResults))
        return value
