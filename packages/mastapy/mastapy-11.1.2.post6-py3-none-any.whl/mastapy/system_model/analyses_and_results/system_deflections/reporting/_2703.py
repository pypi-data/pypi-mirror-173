...
from mastapy.system_model.analyses_and_results import _2512
...
class RigidlyConnectedComponentGroupSystemDeflection(_2512.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def mass_properties(self) -> '_1418.MassProperties':
        ...
        return constructor.new(_1418.MassProperties)(self.wrapped.MassProperties) if self.wrapped.MassProperties is not None else None

    @property
    def components(self) -> 'List[_2570.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2570.ComponentSystemDeflection))
        return value
