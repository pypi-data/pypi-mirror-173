...
class CylindricalPlanetGearSystemDeflection(_2602.CylindricalGearSystemDeflectionWithLTCAResults):
    '''CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3936.CylindricalPlanetGearPowerFlow':
        ...
        return constructor.new(_3936.CylindricalPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
