...
from mastapy.system_model.analyses_and_results.power_flows import _3722, _3742
...
class CoaxialConnectionSystemDeflection(_2473.ShaftToMountableComponentConnectionSystemDeflection):
    '''CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3722.CoaxialConnectionPowerFlow':
