...
class ConceptCouplingConnectionSystemDeflection(_2473.CouplingConnectionSystemDeflection):
    """ConceptCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3800.ConceptCouplingConnectionPowerFlow':
