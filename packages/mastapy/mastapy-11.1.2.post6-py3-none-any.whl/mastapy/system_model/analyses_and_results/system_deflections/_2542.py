...
class RollingRingConnectionSystemDeflection(_2511.InterMountableComponentConnectionSystemDeflection):
    """RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3869.RollingRingConnectionPowerFlow':
