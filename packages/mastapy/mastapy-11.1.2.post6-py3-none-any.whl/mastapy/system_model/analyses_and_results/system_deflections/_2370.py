...
from mastapy.system_model.analyses_and_results.static_loads import _6463, _6496
from mastapy.system_model.analyses_and_results.power_flows import _3708, _3739
from mastapy.system_model.analyses_and_results.system_deflections import _2369, _2474
...
class BeltDriveSystemDeflection(_2474.SpecialisedAssemblySystemDeflection):
    '''BeltDriveSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6463.BeltDriveLoadCase':
        ...
        if _6463.BeltDriveLoadCase.TYPE not in self.wrapped.AssemblyLoadCase.__class__.__mro__:
    ...
    @property
    def power_flow_results(self) -> '_3708.BeltDrivePowerFlow':
        ...
        if _3708.BeltDrivePowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def belts(self) -> 'List[_2369.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Belts, constructor.new(_2369.BeltConnectionSystemDeflection))
        return value
