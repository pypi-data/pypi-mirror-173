...
from mastapy.system_model.analyses_and_results.system_deflections import _2565, _2550
...
class SynchroniserSystemDeflection(_2550.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3892.SynchroniserPowerFlow':
    ...
    @property
    def cones(self) -> 'List[_2565.SynchroniserHalfSystemDeflection]':
