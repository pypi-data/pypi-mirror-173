...
class ShaftSectionSystemDeflection(_121.Bar):
    ...
    @property
    def left_end(self) -> '_2657.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2657.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd is not None else None

    @property
    def right_end(self) -> '_2657.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2657.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd is not None else None
