...
class CVTBeltConnectionSystemDeflection(_2554.BeltConnectionSystemDeflection):
    '''CVTBeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3925.CVTBeltConnectionPowerFlow':
        ...
        return constructor.new(_3925.CVTBeltConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
