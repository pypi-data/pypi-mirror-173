...
class FaceGearSystemDeflection(_2429.GearSystemDeflection):
    '''FaceGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3753.FaceGearPowerFlow':
        ...
        return constructor.new(_3753.FaceGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
