...
class BevelDifferentialPlanetGearSystemDeflection(_2373.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3712.BevelDifferentialPlanetGearPowerFlow':
        ...
        return constructor.new(_3712.BevelDifferentialPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
