...
class RollingRingConnectionSystemDeflection(_2622.InterMountableComponentConnectionSystemDeflection):
    '''RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3980.RollingRingConnectionPowerFlow':
        ...
        return constructor.new(_3980.RollingRingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
