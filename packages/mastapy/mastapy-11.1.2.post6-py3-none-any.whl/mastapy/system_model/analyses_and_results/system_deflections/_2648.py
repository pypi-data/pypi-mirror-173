...
from mastapy.system_model.analyses_and_results.power_flows import _3976, _3927
...
class PulleySystemDeflection(_2585.CouplingHalfSystemDeflection):
    '''PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3976.PulleyPowerFlow':
