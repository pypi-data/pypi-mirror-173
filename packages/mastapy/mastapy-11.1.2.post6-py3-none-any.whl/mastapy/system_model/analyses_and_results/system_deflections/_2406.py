...
class CycloidalDiscCentralBearingConnectionSystemDeflection(_2384.CoaxialConnectionSystemDeflection):
    '''CycloidalDiscCentralBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3742.CycloidalDiscCentralBearingConnectionPowerFlow':
        ...
        return constructor.new(_3742.CycloidalDiscCentralBearingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
