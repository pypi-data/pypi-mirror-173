...
class BevelGearMeshSystemDeflection(_2438.AGMAGleasonConicalGearMeshSystemDeflection):
    """BevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3790.BevelGearMeshPowerFlow':
