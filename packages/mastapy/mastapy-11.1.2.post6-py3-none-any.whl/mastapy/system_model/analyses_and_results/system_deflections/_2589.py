...
class CVTSystemDeflection(_2555.BeltDriveSystemDeflection):
    '''CVTSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3926.CVTPowerFlow':
        ...
        return constructor.new(_3926.CVTPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
