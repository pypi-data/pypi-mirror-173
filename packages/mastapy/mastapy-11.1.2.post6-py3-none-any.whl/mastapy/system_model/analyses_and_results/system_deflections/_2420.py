...
class ExternalCADModelSystemDeflection(_2385.ComponentSystemDeflection):
    '''ExternalCADModelSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3751.ExternalCADModelPowerFlow':
        ...
        return constructor.new(_3751.ExternalCADModelPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
