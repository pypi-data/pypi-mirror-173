...
class HypoidGearMeshSystemDeflection(_2438.AGMAGleasonConicalGearMeshSystemDeflection):
    """HypoidGearMeshSystemDeflection
    ...
    @property
    def rating(self) -> '_410.HypoidGearMeshRating':
    ...
    @property
    def power_flow_results(self) -> '_3837.HypoidGearMeshPowerFlow':
