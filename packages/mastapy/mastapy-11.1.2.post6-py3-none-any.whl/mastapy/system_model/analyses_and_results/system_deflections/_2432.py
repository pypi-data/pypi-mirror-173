...
from mastapy.system_model.analyses_and_results.system_deflections import _2433, _2431, _2365
...
class HypoidGearSetSystemDeflection(_2365.AGMAGleasonConicalGearSetSystemDeflection):
    '''HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3763.HypoidGearSetPowerFlow':
        ...
        return constructor.new(_3763.HypoidGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def hypoid_gears_system_deflection(self) -> 'List[_2433.HypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsSystemDeflection, constructor.new(_2433.HypoidGearSystemDeflection))
        return value

    @property
    def hypoid_meshes_system_deflection(self) -> 'List[_2431.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesSystemDeflection, constructor.new(_2431.HypoidGearMeshSystemDeflection))
        return value
