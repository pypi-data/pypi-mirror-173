...
class ConicalGearCompoundSystemDeflection(_2765.GearCompoundSystemDeflection):
    '''ConicalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self) -> '_503.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_503.ConicalGearDutyCycleRating)(self.wrapped.DutyCycleRating) if self.wrapped.DutyCycleRating is not None else None

    @property
    def conical_duty_cycle_rating(self) -> '_503.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_503.ConicalGearDutyCycleRating)(self.wrapped.ConicalDutyCycleRating) if self.wrapped.ConicalDutyCycleRating is not None else None
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2581.ConicalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2581.ConicalGearSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2581.ConicalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2581.ConicalGearSystemDeflection))
        return value
