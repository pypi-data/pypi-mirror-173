...
class ClutchConnectionCompoundSystemDeflection(_2633.CouplingConnectionCompoundSystemDeflection):
    """ClutchConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2455.ClutchConnectionSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2455.ClutchConnectionSystemDeflection]':
