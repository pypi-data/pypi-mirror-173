...
class StraightBevelPlanetGearCompoundSystemDeflection(_2813.StraightBevelDiffGearCompoundSystemDeflection):
    '''StraightBevelPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2674.StraightBevelPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2674.StraightBevelPlanetGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2674.StraightBevelPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2674.StraightBevelPlanetGearSystemDeflection))
        return value
