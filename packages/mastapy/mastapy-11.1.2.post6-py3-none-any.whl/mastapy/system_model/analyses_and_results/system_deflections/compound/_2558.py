...
class CouplingHalfCompoundSystemDeflection(_2597.MountableComponentCompoundSystemDeflection):
    '''CouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2400.CouplingHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2400.CouplingHalfSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2400.CouplingHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2400.CouplingHalfSystemDeflection))
        return value
