...
class CoaxialConnectionCompoundSystemDeflection(_2805.ShaftToMountableComponentConnectionCompoundSystemDeflection):
    '''CoaxialConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2569.CoaxialConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2569.CoaxialConnectionSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2569.CoaxialConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2569.CoaxialConnectionSystemDeflection))
        return value
