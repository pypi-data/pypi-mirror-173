...
class AbstractAssemblyCompoundSystemDeflection(_2598.PartCompoundSystemDeflection):
    '''AbstractAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2359.AbstractAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2359.AbstractAssemblySystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2359.AbstractAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2359.AbstractAssemblySystemDeflection))
        return value
