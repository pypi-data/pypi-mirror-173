...
class ComponentCompoundSystemDeflection(_2599.PartCompoundSystemDeflection):
    '''ComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2385.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2385.ComponentSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2385.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2385.ComponentSystemDeflection))
        return value
