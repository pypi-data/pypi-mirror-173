...
class SpringDamperHalfCompoundSystemDeflection(_2634.CouplingHalfCompoundSystemDeflection):
    """SpringDamperHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2555.SpringDamperHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2555.SpringDamperHalfSystemDeflection]':
