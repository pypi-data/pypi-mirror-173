...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2599
...
class AbstractAssemblyCompoundSystemDeflection(_2599.PartCompoundSystemDeflection):
    '''AbstractAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2360.AbstractAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2360.AbstractAssemblySystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2360.AbstractAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2360.AbstractAssemblySystemDeflection))
        return value
