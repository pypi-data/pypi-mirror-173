...
class AbstractShaftOrHousingCompoundSystemDeflection(_2544.ComponentCompoundSystemDeflection):
    '''AbstractShaftOrHousingCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2361.AbstractShaftOrHousingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2361.AbstractShaftOrHousingSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2361.AbstractShaftOrHousingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2361.AbstractShaftOrHousingSystemDeflection))
        return value
