...
from mastapy.system_model.analyses_and_results.system_deflections import _2615
...
class GearSetCompoundSystemDeflection(_2806.SpecialisedAssemblyCompoundSystemDeflection):
    '''GearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2615.GearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2615.GearSetSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2615.GearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2615.GearSetSystemDeflection))
        return value
