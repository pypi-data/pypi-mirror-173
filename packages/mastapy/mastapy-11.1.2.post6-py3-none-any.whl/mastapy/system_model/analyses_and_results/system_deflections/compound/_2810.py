...
class SpringDamperCompoundSystemDeflection(_2743.CouplingCompoundSystemDeflection):
    '''SpringDamperCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2667.SpringDamperSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2667.SpringDamperSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2667.SpringDamperSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2667.SpringDamperSystemDeflection))
        return value
