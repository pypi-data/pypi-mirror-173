...
class ZerolBevelGearCompoundSystemDeflection(_2611.BevelGearCompoundSystemDeflection):
    """ZerolBevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2585.ZerolBevelGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2585.ZerolBevelGearSystemDeflection]':
