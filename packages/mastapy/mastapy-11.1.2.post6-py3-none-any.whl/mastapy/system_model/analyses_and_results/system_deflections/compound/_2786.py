...
class PartCompoundSystemDeflection(_7377.PartCompoundAnalysis):
    '''PartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2640.PartSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2640.PartSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2640.PartSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2640.PartSystemDeflection))
        return value
