...
class SynchroniserPartCompoundSystemDeflection(_2745.CouplingHalfCompoundSystemDeflection):
    '''SynchroniserPartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2677.SynchroniserPartSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2677.SynchroniserPartSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2677.SynchroniserPartSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2677.SynchroniserPartSystemDeflection))
        return value
