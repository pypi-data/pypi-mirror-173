...
class BevelDifferentialGearMeshCompoundSystemDeflection(_2612.BevelGearMeshCompoundSystemDeflection):
    """BevelDifferentialGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2445.BevelDifferentialGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2445.BevelDifferentialGearMeshSystemDeflection]':
