...
class BearingCompoundSystemDeflection(_2555.ConnectorCompoundSystemDeflection):
    '''BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_1652.LoadedBearingDutyCycle':
        ...
        if _1652.LoadedBearingDutyCycle.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2368.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2368.BearingSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2368.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2368.BearingSystemDeflection))
        return value
