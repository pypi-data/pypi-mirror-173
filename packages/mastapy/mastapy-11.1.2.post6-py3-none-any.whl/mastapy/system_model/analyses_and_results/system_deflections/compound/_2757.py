...
class DatumCompoundSystemDeflection(_2731.ComponentCompoundSystemDeflection):
    '''DatumCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2606.DatumSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2606.DatumSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2606.DatumSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2606.DatumSystemDeflection))
        return value
