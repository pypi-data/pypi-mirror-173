...
class ConceptCouplingHalfCompoundSystemDeflection(_2634.CouplingHalfCompoundSystemDeflection):
    """ConceptCouplingHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2462.ConceptCouplingHalfSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2462.ConceptCouplingHalfSystemDeflection]':
