...
class RollingRingAssemblyCompoundSystemDeflection(_2695.SpecialisedAssemblyCompoundSystemDeflection):
    """RollingRingAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2541.RollingRingAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2541.RollingRingAssemblySystemDeflection]':
