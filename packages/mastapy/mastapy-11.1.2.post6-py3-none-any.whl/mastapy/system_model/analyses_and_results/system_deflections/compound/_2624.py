...
class ConceptGearCompoundSystemDeflection(_2654.GearCompoundSystemDeflection):
    """ConceptGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2466.ConceptGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2466.ConceptGearSystemDeflection]':
