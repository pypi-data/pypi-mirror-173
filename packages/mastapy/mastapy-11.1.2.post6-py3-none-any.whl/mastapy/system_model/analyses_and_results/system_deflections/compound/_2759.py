...
class ExternalCADModelCompoundSystemDeflection(_2731.ComponentCompoundSystemDeflection):
    '''ExternalCADModelCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2607.ExternalCADModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2607.ExternalCADModelSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2607.ExternalCADModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2607.ExternalCADModelSystemDeflection))
        return value
