...
class ConicalGearSetCompoundSystemDeflection(_2580.GearSetCompoundSystemDeflection):
    '''ConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2395.ConicalGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2395.ConicalGearSetSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2395.ConicalGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2395.ConicalGearSetSystemDeflection))
        return value
