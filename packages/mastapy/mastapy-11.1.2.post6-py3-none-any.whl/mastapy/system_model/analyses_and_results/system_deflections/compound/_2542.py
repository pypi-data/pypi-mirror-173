...
class ClutchHalfCompoundSystemDeflection(_2558.CouplingHalfCompoundSystemDeflection):
    '''ClutchHalfCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2382.ClutchHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2382.ClutchHalfSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2382.ClutchHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2382.ClutchHalfSystemDeflection))
        return value
