...
class ConceptGearMeshCompoundSystemDeflection(_2766.GearMeshCompoundSystemDeflection):
    '''ConceptGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2575.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2575.ConceptGearMeshSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2575.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2575.ConceptGearMeshSystemDeflection))
        return value
