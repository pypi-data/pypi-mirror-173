...
class AGMAGleasonConicalGearCompoundSystemDeflection(_2551.ConicalGearCompoundSystemDeflection):
    '''AGMAGleasonConicalGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2366.AGMAGleasonConicalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2366.AGMAGleasonConicalGearSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2366.AGMAGleasonConicalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2366.AGMAGleasonConicalGearSystemDeflection))
        return value
