...
class BevelGearCompoundSystemDeflection(_2523.AGMAGleasonConicalGearCompoundSystemDeflection):
    '''BevelGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2378.BevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2378.BevelGearSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2378.BevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2378.BevelGearSystemDeflection))
        return value
