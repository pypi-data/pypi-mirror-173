...
class BevelDifferentialPlanetGearCompoundSystemDeflection(_2606.BevelDifferentialGearCompoundSystemDeflection):
    """BevelDifferentialPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2448.BevelDifferentialPlanetGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2448.BevelDifferentialPlanetGearSystemDeflection]':
