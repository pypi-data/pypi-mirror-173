...
from mastapy.system_model.analyses_and_results.system_deflections import _2613
...
class FlexiblePinAssemblyCompoundSystemDeflection(_2806.SpecialisedAssemblyCompoundSystemDeflection):
    '''FlexiblePinAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2613.FlexiblePinAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2613.FlexiblePinAssemblySystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2613.FlexiblePinAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2613.FlexiblePinAssemblySystemDeflection))
        return value
