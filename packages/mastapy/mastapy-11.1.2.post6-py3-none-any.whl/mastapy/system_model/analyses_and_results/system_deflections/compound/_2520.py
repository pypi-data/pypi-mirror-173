...
class AbstractShaftCompoundSystemDeflection(_2521.AbstractShaftOrHousingCompoundSystemDeflection):
    '''AbstractShaftCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2362.AbstractShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2362.AbstractShaftSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2362.AbstractShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2362.AbstractShaftSystemDeflection))
        return value
