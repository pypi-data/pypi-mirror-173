...
class BeltConnectionCompoundSystemDeflection(_2585.InterMountableComponentConnectionCompoundSystemDeflection):
    '''BeltConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2369.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2369.BeltConnectionSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2369.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2369.BeltConnectionSystemDeflection))
        return value
