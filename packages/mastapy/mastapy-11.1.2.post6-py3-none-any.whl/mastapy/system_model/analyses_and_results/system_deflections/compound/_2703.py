...
class StraightBevelDiffGearMeshCompoundSystemDeflection(_2612.BevelGearMeshCompoundSystemDeflection):
    """StraightBevelDiffGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2557.StraightBevelDiffGearMeshSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2557.StraightBevelDiffGearMeshSystemDeflection]':
