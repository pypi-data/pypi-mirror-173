...
class AGMAGleasonConicalGearSetCompoundSystemDeflection(_2553.ConicalGearSetCompoundSystemDeflection):
    '''AGMAGleasonConicalGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2365.AGMAGleasonConicalGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2365.AGMAGleasonConicalGearSetSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2365.AGMAGleasonConicalGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2365.AGMAGleasonConicalGearSetSystemDeflection))
        return value
