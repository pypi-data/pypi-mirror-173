...
class KlingelnbergCycloPalloidConicalGearMeshCompoundSystemDeflection(_2552.ConicalGearMeshCompoundSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2436.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2436.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_2436.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2436.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection))
        return value
