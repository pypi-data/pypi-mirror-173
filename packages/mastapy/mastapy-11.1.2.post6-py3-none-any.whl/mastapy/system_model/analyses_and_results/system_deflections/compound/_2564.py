...
class CycloidalDiscCompoundSystemDeflection(_2520.AbstractShaftCompoundSystemDeflection):
    '''CycloidalDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2408.CycloidalDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2408.CycloidalDiscSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2408.CycloidalDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2408.CycloidalDiscSystemDeflection))
        return value
