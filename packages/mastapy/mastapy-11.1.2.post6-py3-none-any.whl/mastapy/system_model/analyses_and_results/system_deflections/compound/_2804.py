...
class ShaftHubConnectionCompoundSystemDeflection(_2742.ConnectorCompoundSystemDeflection):
    '''ShaftHubConnectionCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2656.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2656.ShaftHubConnectionSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2656.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2656.ShaftHubConnectionSystemDeflection))
        return value
