...
class HypoidGearMeshCompoundSystemDeflection(_2524.AGMAGleasonConicalGearMeshCompoundSystemDeflection):
    '''HypoidGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2431.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2431.HypoidGearMeshSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2431.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2431.HypoidGearMeshSystemDeflection))
        return value
