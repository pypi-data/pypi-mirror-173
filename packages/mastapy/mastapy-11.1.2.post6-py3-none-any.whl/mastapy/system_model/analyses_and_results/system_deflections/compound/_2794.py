...
class PowerLoadCompoundSystemDeflection(_2830.VirtualComponentCompoundSystemDeflection):
    '''PowerLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2647.PowerLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2647.PowerLoadSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2647.PowerLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2647.PowerLoadSystemDeflection))
        return value
