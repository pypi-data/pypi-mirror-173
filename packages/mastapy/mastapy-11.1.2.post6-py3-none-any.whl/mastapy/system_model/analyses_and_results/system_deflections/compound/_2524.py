...
class AGMAGleasonConicalGearMeshCompoundSystemDeflection(_2552.ConicalGearMeshCompoundSystemDeflection):
    '''AGMAGleasonConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2364.AGMAGleasonConicalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2364.AGMAGleasonConicalGearMeshSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_2364.AGMAGleasonConicalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2364.AGMAGleasonConicalGearMeshSystemDeflection))
        return value
