...
class AbstractShaftToMountableComponentConnectionCompoundSystemDeflection(_2554.ConnectionCompoundSystemDeflection):
    '''AbstractShaftToMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2363.AbstractShaftToMountableComponentConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2363.AbstractShaftToMountableComponentConnectionSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_2363.AbstractShaftToMountableComponentConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2363.AbstractShaftToMountableComponentConnectionSystemDeflection))
        return value
