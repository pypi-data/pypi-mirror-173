...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2566, _2567, _2580
...
class CylindricalGearSetCompoundSystemDeflection(_2580.GearSetCompoundSystemDeflection):
    '''CylindricalGearSetCompoundSystemDeflection
    ...
    @property
    def cylindrical_gear_set_rating_using_basic_ltca(self) -> '_423.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_423.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetRatingUsingBasicLTCA) if self.wrapped.CylindricalGearSetRatingUsingBasicLTCA else None

    @property
    def cylindrical_gear_set_rating(self) -> '_423.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_423.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetRating) if self.wrapped.CylindricalGearSetRating else None

    @property
    def load_case_rating_with_lowest_safety_factor_for_scuffing(self) -> '_424.CylindricalGearSetRating':
        ...
        return constructor.new(_424.CylindricalGearSetRating)(self.wrapped.LoadCaseRatingWithLowestSafetyFactorForScuffing) if self.wrapped.LoadCaseRatingWithLowestSafetyFactorForScuffing else None
    ...
    @property
    def cylindrical_gears_compound_system_deflection(self) -> 'List[_2566.CylindricalGearCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundSystemDeflection, constructor.new(_2566.CylindricalGearCompoundSystemDeflection))
        return value

    @property
    def cylindrical_meshes_compound_system_deflection(self) -> 'List[_2567.CylindricalGearMeshCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundSystemDeflection, constructor.new(_2567.CylindricalGearMeshCompoundSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2414.CylindricalGearSetSystemDeflectionWithLTCAResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2414.CylindricalGearSetSystemDeflectionWithLTCAResults))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2414.CylindricalGearSetSystemDeflectionWithLTCAResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2414.CylindricalGearSetSystemDeflectionWithLTCAResults))
        return value
