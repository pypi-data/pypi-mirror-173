...
class SynchroniserSleeveCompoundSystemDeflection(_2823.SynchroniserPartCompoundSystemDeflection):
    '''SynchroniserSleeveCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2678.SynchroniserSleeveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2678.SynchroniserSleeveSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2678.SynchroniserSleeveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2678.SynchroniserSleeveSystemDeflection))
        return value
