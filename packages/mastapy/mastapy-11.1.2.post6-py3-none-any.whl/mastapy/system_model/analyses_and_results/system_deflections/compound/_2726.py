...
class BoltedJointCompoundSystemDeflection(_2806.SpecialisedAssemblyCompoundSystemDeflection):
    '''BoltedJointCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2564.BoltedJointSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2564.BoltedJointSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2564.BoltedJointSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2564.BoltedJointSystemDeflection))
        return value
