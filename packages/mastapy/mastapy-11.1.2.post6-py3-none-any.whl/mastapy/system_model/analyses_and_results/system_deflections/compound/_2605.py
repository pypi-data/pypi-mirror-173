...
class BeltDriveCompoundSystemDeflection(_2695.SpecialisedAssemblyCompoundSystemDeflection):
    """BeltDriveCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2444.BeltDriveSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2444.BeltDriveSystemDeflection]':
