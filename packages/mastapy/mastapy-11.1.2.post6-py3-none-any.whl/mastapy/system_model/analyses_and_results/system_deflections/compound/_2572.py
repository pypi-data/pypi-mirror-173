...
class ExternalCADModelCompoundSystemDeflection(_2544.ComponentCompoundSystemDeflection):
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2420.ExternalCADModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2420.ExternalCADModelSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2420.ExternalCADModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2420.ExternalCADModelSystemDeflection))
        return value
