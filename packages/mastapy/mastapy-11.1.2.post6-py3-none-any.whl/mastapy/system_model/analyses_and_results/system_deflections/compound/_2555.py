...
class ConnectorCompoundSystemDeflection(_2597.MountableComponentCompoundSystemDeflection):
    '''ConnectorCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2398.ConnectorSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2398.ConnectorSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2398.ConnectorSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2398.ConnectorSystemDeflection))
        return value
