...
class DatumCompoundSystemDeflection(_2544.ComponentCompoundSystemDeflection):
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2419.DatumSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2419.DatumSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2419.DatumSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2419.DatumSystemDeflection))
        return value
