...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2692, _2596
...
class ShaftCompoundSystemDeflection(_2596.AbstractShaftCompoundSystemDeflection):
    """ShaftCompoundSystemDeflection
    ...
    @property
    def shaft_duty_cycle_damage_results(self) -> '_2692.ShaftDutyCycleSystemDeflection':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2548.ShaftSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2548.ShaftSystemDeflection]':
