...
class MeasurementComponentCompoundSystemDeflection(_2830.VirtualComponentCompoundSystemDeflection):
    '''MeasurementComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2635.MeasurementComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2635.MeasurementComponentSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2635.MeasurementComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2635.MeasurementComponentSystemDeflection))
        return value
