...
class CouplingCompoundSystemDeflection(_2619.SpecialisedAssemblyCompoundSystemDeflection):
    '''CouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2401.CouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2401.CouplingSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2401.CouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2401.CouplingSystemDeflection))
        return value
