...
class ClutchCompoundSystemDeflection(_2743.CouplingCompoundSystemDeflection):
    '''ClutchCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2568.ClutchSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2568.ClutchSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2568.ClutchSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2568.ClutchSystemDeflection))
        return value
