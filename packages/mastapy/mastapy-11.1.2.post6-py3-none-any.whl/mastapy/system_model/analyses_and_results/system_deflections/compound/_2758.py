...
class DutyCycleEfficiencyResults(_0.APIBase):
    ...
    @property
    def load_case_overall_efficiency_result(self) -> 'List[_2632.LoadCaseOverallEfficiencyResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseOverallEfficiencyResult, constructor.new(_2632.LoadCaseOverallEfficiencyResult))
        return value
