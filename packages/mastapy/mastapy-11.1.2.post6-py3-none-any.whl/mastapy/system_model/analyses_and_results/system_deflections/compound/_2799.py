...
class RollingRingCompoundSystemDeflection(_2745.CouplingHalfCompoundSystemDeflection):
    '''RollingRingCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2654.RollingRingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2654.RollingRingSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2654.RollingRingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2654.RollingRingSystemDeflection))
        return value
