...
class FlexiblePinAssemblyCompoundSystemDeflection(_2695.SpecialisedAssemblyCompoundSystemDeflection):
    """FlexiblePinAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2502.FlexiblePinAssemblySystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2502.FlexiblePinAssemblySystemDeflection]':
