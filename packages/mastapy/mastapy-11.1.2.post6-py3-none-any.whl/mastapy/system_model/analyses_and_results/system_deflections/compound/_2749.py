...
class CycloidalAssemblyCompoundSystemDeflection(_2806.SpecialisedAssemblyCompoundSystemDeflection):
    '''CycloidalAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2590.CycloidalAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2590.CycloidalAssemblySystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2590.CycloidalAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2590.CycloidalAssemblySystemDeflection))
        return value
