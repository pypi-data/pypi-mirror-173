...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2606, _2607, _2613
...
class BevelDifferentialGearSetCompoundSystemDeflection(_2613.BevelGearSetCompoundSystemDeflection):
    """BevelDifferentialGearSetCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2446.BevelDifferentialGearSetSystemDeflection]':
    ...
    @property
    def bevel_differential_gears_compound_system_deflection(self) -> 'List[_2606.BevelDifferentialGearCompoundSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_compound_system_deflection(self) -> 'List[_2607.BevelDifferentialGearMeshCompoundSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2446.BevelDifferentialGearSetSystemDeflection]':
