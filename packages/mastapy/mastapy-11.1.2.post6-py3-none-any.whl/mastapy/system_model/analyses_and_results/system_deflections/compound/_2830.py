...
class VirtualComponentCompoundSystemDeflection(_2784.MountableComponentCompoundSystemDeflection):
    '''VirtualComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2690.VirtualComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2690.VirtualComponentSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2690.VirtualComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2690.VirtualComponentSystemDeflection))
        return value
