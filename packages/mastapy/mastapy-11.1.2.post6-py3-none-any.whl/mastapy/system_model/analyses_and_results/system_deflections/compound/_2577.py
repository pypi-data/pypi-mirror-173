...
class FlexiblePinAssemblyCompoundSystemDeflection(_2619.SpecialisedAssemblyCompoundSystemDeflection):
    '''FlexiblePinAssemblyCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2426.FlexiblePinAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2426.FlexiblePinAssemblySystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2426.FlexiblePinAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2426.FlexiblePinAssemblySystemDeflection))
        return value
