...
class CVTPulleyCompoundSystemDeflection(_2608.PulleyCompoundSystemDeflection):
    '''CVTPulleyCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2403.CVTPulleySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2403.CVTPulleySystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2403.CVTPulleySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2403.CVTPulleySystemDeflection))
        return value
