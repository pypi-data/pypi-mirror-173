...
class BevelDifferentialGearCompoundSystemDeflection(_2611.BevelGearCompoundSystemDeflection):
    """BevelDifferentialGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2447.BevelDifferentialGearSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2447.BevelDifferentialGearSystemDeflection]':
