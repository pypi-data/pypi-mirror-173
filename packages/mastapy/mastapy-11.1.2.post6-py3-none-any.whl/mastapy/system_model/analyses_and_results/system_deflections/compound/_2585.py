...
class InterMountableComponentConnectionCompoundSystemDeflection(_2554.ConnectionCompoundSystemDeflection):
    '''InterMountableComponentConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2435.InterMountableComponentConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2435.InterMountableComponentConnectionSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_2435.InterMountableComponentConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2435.InterMountableComponentConnectionSystemDeflection))
        return value
