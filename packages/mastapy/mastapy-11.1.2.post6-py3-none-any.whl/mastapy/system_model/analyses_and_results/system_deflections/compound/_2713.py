...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2712
...
class SynchroniserSleeveCompoundSystemDeflection(_2712.SynchroniserPartCompoundSystemDeflection):
    """SynchroniserSleeveCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2567.SynchroniserSleeveSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2567.SynchroniserSleeveSystemDeflection]':
