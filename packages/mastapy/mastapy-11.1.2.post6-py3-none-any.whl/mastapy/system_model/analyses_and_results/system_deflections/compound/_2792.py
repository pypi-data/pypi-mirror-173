...
class PlanetCarrierCompoundSystemDeflection(_2784.MountableComponentCompoundSystemDeflection):
    '''PlanetCarrierCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2645.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2645.PlanetCarrierSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2645.PlanetCarrierSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2645.PlanetCarrierSystemDeflection))
        return value
