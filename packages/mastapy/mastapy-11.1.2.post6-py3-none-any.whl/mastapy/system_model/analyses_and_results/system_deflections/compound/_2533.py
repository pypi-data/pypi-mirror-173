...
class BevelDifferentialPlanetGearCompoundSystemDeflection(_2530.BevelDifferentialGearCompoundSystemDeflection):
    '''BevelDifferentialPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2374.BevelDifferentialPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2374.BevelDifferentialPlanetGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2374.BevelDifferentialPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2374.BevelDifferentialPlanetGearSystemDeflection))
        return value
