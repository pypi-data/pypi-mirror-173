...
class KlingelnbergCycloPalloidConicalGearMeshCompoundSystemDeflection(_2739.ConicalGearMeshCompoundSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2623.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2623.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_2623.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2623.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection))
        return value
