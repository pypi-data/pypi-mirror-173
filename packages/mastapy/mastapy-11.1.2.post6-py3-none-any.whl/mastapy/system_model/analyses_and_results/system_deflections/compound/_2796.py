...
class RingPinsCompoundSystemDeflection(_2784.MountableComponentCompoundSystemDeflection):
    '''RingPinsCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2649.RingPinsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2649.RingPinsSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2649.RingPinsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2649.RingPinsSystemDeflection))
        return value
