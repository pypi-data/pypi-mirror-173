...
class FEPartCompoundSystemDeflection(_2521.AbstractShaftOrHousingCompoundSystemDeflection):
    '''FEPartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2425.FEPartSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2425.FEPartSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2425.FEPartSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2425.FEPartSystemDeflection))
        return value
