...
class MountableComponentCompoundSystemDeflection(_2731.ComponentCompoundSystemDeflection):
    '''MountableComponentCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2637.MountableComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2637.MountableComponentSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2637.MountableComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2637.MountableComponentSystemDeflection))
        return value
