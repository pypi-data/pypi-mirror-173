...
class ConceptGearMeshCompoundSystemDeflection(_2579.GearMeshCompoundSystemDeflection):
    '''ConceptGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2390.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2390.ConceptGearMeshSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2390.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2390.ConceptGearMeshSystemDeflection))
        return value
