...
class GuideDxfModelCompoundSystemDeflection(_2620.ComponentCompoundSystemDeflection):
    """GuideDxfModelCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2506.GuideDxfModelSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2506.GuideDxfModelSystemDeflection]':
