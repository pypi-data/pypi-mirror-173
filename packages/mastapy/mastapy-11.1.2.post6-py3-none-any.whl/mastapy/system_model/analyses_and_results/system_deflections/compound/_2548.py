...
class ConceptGearCompoundSystemDeflection(_2578.GearCompoundSystemDeflection):
    '''ConceptGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2392.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2392.ConceptGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2392.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2392.ConceptGearSystemDeflection))
        return value
