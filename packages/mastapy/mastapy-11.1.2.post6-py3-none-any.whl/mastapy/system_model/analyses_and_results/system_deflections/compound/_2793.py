...
class PointLoadCompoundSystemDeflection(_2830.VirtualComponentCompoundSystemDeflection):
    '''PointLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2646.PointLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2646.PointLoadSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2646.PointLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2646.PointLoadSystemDeflection))
        return value
