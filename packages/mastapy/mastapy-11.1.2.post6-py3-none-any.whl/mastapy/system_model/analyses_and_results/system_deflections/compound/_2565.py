...
class CycloidalDiscPlanetaryBearingConnectionCompoundSystemDeflection(_2522.AbstractShaftToMountableComponentConnectionCompoundSystemDeflection):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2407.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2407.CycloidalDiscPlanetaryBearingConnectionSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2407.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2407.CycloidalDiscPlanetaryBearingConnectionSystemDeflection))
        return value
