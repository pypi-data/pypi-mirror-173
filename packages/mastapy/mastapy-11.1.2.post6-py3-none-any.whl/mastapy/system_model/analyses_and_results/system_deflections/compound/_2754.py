...
from mastapy.system_model.analyses_and_results.system_deflections import _2596
...
class CylindricalGearMeshCompoundSystemDeflection(_2766.GearMeshCompoundSystemDeflection):
    '''CylindricalGearMeshCompoundSystemDeflection
    ...
    @property
    def cylindrical_mesh_rating(self) -> '_435.CylindricalMeshDutyCycleRating':
        ...
        return constructor.new(_435.CylindricalMeshDutyCycleRating)(self.wrapped.CylindricalMeshRating) if self.wrapped.CylindricalMeshRating is not None else None

    @property
    def connection_analysis_cases_ready(self) -> 'List[_2596.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2596.CylindricalGearMeshSystemDeflectionWithLTCAResults))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2596.CylindricalGearMeshSystemDeflectionWithLTCAResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2596.CylindricalGearMeshSystemDeflectionWithLTCAResults))
        return value
