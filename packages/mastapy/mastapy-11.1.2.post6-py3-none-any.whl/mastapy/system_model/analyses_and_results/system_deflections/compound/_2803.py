...
class ShaftDutyCycleSystemDeflection(_0.APIBase):
    ...
    @property
    def shaft_design(self) -> '_2343.Shaft':
        ...
        return constructor.new(_2343.Shaft)(self.wrapped.ShaftDesign) if self.wrapped.ShaftDesign is not None else None
    ...
    @property
    def shaft_static_analyses(self) -> 'List[_2659.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftStaticAnalyses, constructor.new(_2659.ShaftSystemDeflection))
        return value
