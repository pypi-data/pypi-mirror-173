...
class PulleyCompoundSystemDeflection(_2745.CouplingHalfCompoundSystemDeflection):
    '''PulleyCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2648.PulleySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2648.PulleySystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2648.PulleySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2648.PulleySystemDeflection))
        return value
