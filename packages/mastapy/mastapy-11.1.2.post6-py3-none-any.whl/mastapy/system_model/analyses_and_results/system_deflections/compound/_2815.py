...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2813, _2814, _2724
...
class StraightBevelDiffGearSetCompoundSystemDeflection(_2724.BevelGearSetCompoundSystemDeflection):
    '''StraightBevelDiffGearSetCompoundSystemDeflection
    ...
    @property
    def straight_bevel_diff_gears_compound_system_deflection(self) -> 'List[_2813.StraightBevelDiffGearCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsCompoundSystemDeflection, constructor.new(_2813.StraightBevelDiffGearCompoundSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_compound_system_deflection(self) -> 'List[_2814.StraightBevelDiffGearMeshCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesCompoundSystemDeflection, constructor.new(_2814.StraightBevelDiffGearMeshCompoundSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2669.StraightBevelDiffGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2669.StraightBevelDiffGearSetSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2669.StraightBevelDiffGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2669.StraightBevelDiffGearSetSystemDeflection))
        return value
