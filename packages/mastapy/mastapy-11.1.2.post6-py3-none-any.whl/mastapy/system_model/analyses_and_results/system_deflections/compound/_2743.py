...
class CouplingCompoundSystemDeflection(_2806.SpecialisedAssemblyCompoundSystemDeflection):
    '''CouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2586.CouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2586.CouplingSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2586.CouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2586.CouplingSystemDeflection))
        return value
