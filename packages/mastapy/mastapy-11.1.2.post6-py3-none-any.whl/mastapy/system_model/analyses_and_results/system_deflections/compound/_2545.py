...
class ConceptCouplingCompoundSystemDeflection(_2556.CouplingCompoundSystemDeflection):
    '''ConceptCouplingCompoundSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2389.ConceptCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2389.ConceptCouplingSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2389.ConceptCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2389.ConceptCouplingSystemDeflection))
        return value
