...
class CylindricalGearMeshSystemDeflectionTimestep(_2594.CylindricalGearMeshSystemDeflection):
    '''CylindricalGearMeshSystemDeflectionTimestep
    ...
    @property
    def loaded_contact_lines(self) -> 'List[_823.CylindricalGearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_823.CylindricalGearMeshLoadedContactLine))
        return value
