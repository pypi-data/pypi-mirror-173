...
from mastapy.system_model.analyses_and_results.power_flows import _3935, _3970
from mastapy.gears.rating.cylindrical import _433
from mastapy.gears.manufacturing.cylindrical import _586
from mastapy.system_model.analyses_and_results.system_deflections import _2600, _2594, _2615
...
class CylindricalGearSetSystemDeflection(_2615.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3935.CylindricalGearSetPowerFlow':
    ...
    @property
    def manufacturing_analysis(self) -> '_586.CylindricalManufacturedGearSetLoadCase':
        ...
        return constructor.new(_586.CylindricalManufacturedGearSetLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis is not None else None

    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2600.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2600.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2594.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2594.CylindricalGearMeshSystemDeflection))
        return value
