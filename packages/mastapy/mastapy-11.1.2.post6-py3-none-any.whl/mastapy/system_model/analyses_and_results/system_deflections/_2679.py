...
from mastapy.system_model.analyses_and_results.system_deflections import _2676, _2661
...
class SynchroniserSystemDeflection(_2661.SpecialisedAssemblySystemDeflection):
    '''SynchroniserSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4003.SynchroniserPowerFlow':
        ...
        return constructor.new(_4003.SynchroniserPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def cones(self) -> 'List[_2676.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2676.SynchroniserHalfSystemDeflection))
        return value
