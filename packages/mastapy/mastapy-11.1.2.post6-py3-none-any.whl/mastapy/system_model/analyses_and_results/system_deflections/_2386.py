...
class ConcentricPartGroupCombinationSystemDeflectionResults(_0.APIBase):
    ...
    @property
    def shaft_deflections_in_view_coordinate_system(self) -> 'List[_1926.ConcentricPartGroupCombinationSystemDeflectionShaftResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDeflectionsInViewCoordinateSystem, constructor.new(_1926.ConcentricPartGroupCombinationSystemDeflectionShaftResults))
        return value
