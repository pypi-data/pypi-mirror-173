...
from mastapy.system_model.analyses_and_results.system_deflections import _2517, _2515, _2513
...
class KlingelnbergCycloPalloidHypoidGearSetSystemDeflection(_2513.KlingelnbergCycloPalloidConicalGearSetSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3846.KlingelnbergCycloPalloidHypoidGearSetPowerFlow':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_system_deflection(self) -> 'List[_2517.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_system_deflection(self) -> 'List[_2515.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
