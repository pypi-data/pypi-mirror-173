...
class ConceptCouplingHalfSystemDeflection(_2400.CouplingHalfSystemDeflection):
    '''ConceptCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3725.ConceptCouplingHalfPowerFlow':
        ...
        return constructor.new(_3725.ConceptCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
