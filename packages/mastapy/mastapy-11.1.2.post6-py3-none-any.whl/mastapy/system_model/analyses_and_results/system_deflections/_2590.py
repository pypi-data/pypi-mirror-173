...
from mastapy.system_model.analyses_and_results.system_deflections import _2650, _2661
...
class CycloidalAssemblySystemDeflection(_2661.SpecialisedAssemblySystemDeflection):
    '''CycloidalAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3928.CycloidalAssemblyPowerFlow':
        ...
        return constructor.new(_3928.CycloidalAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def ring_pins_to_disc_connections(self) -> 'List[_2650.RingPinsToDiscConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinsToDiscConnections, constructor.new(_2650.RingPinsToDiscConnectionSystemDeflection))
        return value
