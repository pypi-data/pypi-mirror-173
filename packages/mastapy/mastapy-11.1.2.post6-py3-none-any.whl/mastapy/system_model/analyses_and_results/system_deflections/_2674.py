...
class StraightBevelPlanetGearSystemDeflection(_2670.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3999.StraightBevelPlanetGearPowerFlow':
        ...
        return constructor.new(_3999.StraightBevelPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
