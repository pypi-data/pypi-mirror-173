...
class CVTSystemDeflection(_2370.BeltDriveSystemDeflection):
    '''CVTSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3739.CVTPowerFlow':
        ...
        return constructor.new(_3739.CVTPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
