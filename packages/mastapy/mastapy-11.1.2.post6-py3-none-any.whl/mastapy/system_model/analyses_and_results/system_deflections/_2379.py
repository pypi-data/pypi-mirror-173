...
class BoltedJointSystemDeflection(_2474.SpecialisedAssemblySystemDeflection):
    '''BoltedJointSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3717.BoltedJointPowerFlow':
        ...
        return constructor.new(_3717.BoltedJointPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
