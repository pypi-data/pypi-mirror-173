...
class CylindricalGearSystemDeflectionWithLTCAResults(_2415.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_793.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_793.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults else None
