...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2701
...
class PlanetCarrierSystemDeflection(_2637.MountableComponentSystemDeflection):
    '''PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3971.PlanetCarrierPowerFlow':
        ...
        return constructor.new(_3971.PlanetCarrierPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def windup(self) -> 'List[_2701.PlanetCarrierWindup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Windup, constructor.new(_2701.PlanetCarrierWindup))
        return value
