...
class ConceptGearMeshSystemDeflection(_2427.GearMeshSystemDeflection):
    '''ConceptGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3727.ConceptGearMeshPowerFlow':
        ...
        return constructor.new(_3727.ConceptGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
