...
class BoltSystemDeflection(_2385.ComponentSystemDeflection):
    '''BoltSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3718.BoltPowerFlow':
        ...
        return constructor.new(_3718.BoltPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
