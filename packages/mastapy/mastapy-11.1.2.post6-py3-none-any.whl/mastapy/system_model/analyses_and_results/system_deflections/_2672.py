...
from mastapy.system_model.analyses_and_results.system_deflections import _2673, _2671, _2562
...
class StraightBevelGearSetSystemDeflection(_2562.BevelGearSetSystemDeflection):
    '''StraightBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3998.StraightBevelGearSetPowerFlow':
        ...
        return constructor.new(_3998.StraightBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
    ...
    @property
    def straight_bevel_gears_system_deflection(self) -> 'List[_2673.StraightBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsSystemDeflection, constructor.new(_2673.StraightBevelGearSystemDeflection))
        return value

    @property
    def straight_bevel_meshes_system_deflection(self) -> 'List[_2671.StraightBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesSystemDeflection, constructor.new(_2671.StraightBevelGearMeshSystemDeflection))
        return value
