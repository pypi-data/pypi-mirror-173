...
class StraightBevelSunGearSystemDeflection(_2670.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4000.StraightBevelSunGearPowerFlow':
        ...
        return constructor.new(_4000.StraightBevelSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
