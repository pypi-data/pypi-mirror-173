...
class HypoidGearMeshSystemDeflection(_2364.AGMAGleasonConicalGearMeshSystemDeflection):
    '''HypoidGearMeshSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6550.HypoidGearMeshLoadCase':
        ...
        return constructor.new(_6550.HypoidGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def power_flow_results(self) -> '_3761.HypoidGearMeshPowerFlow':
        ...
        return constructor.new(_3761.HypoidGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_400.HypoidGearMeshRating':
        ...
        return constructor.new(_400.HypoidGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def component_detailed_analysis(self) -> '_400.HypoidGearMeshRating':
        ...
        return constructor.new(_400.HypoidGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
