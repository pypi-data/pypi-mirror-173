...
class VirtualComponentSystemDeflection(_2526.MountableComponentSystemDeflection):
    """VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3900.VirtualComponentPowerFlow':
