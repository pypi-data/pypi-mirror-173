...
from mastapy.system_model.analyses_and_results.power_flows import _3784, _3815
from mastapy.system_model.analyses_and_results.system_deflections import _2443, _2550
...
class BeltDriveSystemDeflection(_2550.SpecialisedAssemblySystemDeflection):
    """BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3784.BeltDrivePowerFlow':
    ...
    @property
    def belts(self) -> 'List[_2443.BeltConnectionSystemDeflection]':
