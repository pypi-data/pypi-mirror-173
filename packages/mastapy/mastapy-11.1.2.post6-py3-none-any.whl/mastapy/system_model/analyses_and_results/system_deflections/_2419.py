...
class DatumSystemDeflection(_2385.ComponentSystemDeflection):
    '''DatumSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3750.DatumPowerFlow':
        ...
        return constructor.new(_3750.DatumPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
