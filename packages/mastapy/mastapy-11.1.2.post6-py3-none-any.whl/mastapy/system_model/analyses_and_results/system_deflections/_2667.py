...
class SpringDamperSystemDeflection(_2586.CouplingSystemDeflection):
    '''SpringDamperSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3992.SpringDamperPowerFlow':
        ...
        return constructor.new(_3992.SpringDamperPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
