...
class CVTPulleySystemDeflection(_2461.PulleySystemDeflection):
    '''CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3740.CVTPulleyPowerFlow':
        ...
        return constructor.new(_3740.CVTPulleyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
