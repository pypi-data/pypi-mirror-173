...
class ConnectorSystemDeflection(_2450.MountableComponentSystemDeflection):
    '''ConnectorSystemDeflection
    ...
    @property
    def outer_fe_part(self) -> '_2425.FEPartSystemDeflection':
        ...
        return constructor.new(_2425.FEPartSystemDeflection)(self.wrapped.OuterFEPart) if self.wrapped.OuterFEPart else None
    ...
    @property
    def outer_fe_substructure_nodes(self) -> 'List[_2066.FESubstructureNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OuterFESubstructureNodes, constructor.new(_2066.FESubstructureNode))
        return value

    @property
    def power_flow_results(self) -> '_3734.ConnectorPowerFlow':
        ...
        if _3734.ConnectorPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_bearing_power_flow(self) -> '_3706.BearingPowerFlow':
        ...
        if _3706.BearingPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_oil_seal_power_flow(self) -> '_3777.OilSealPowerFlow':
        ...
        if _3777.OilSealPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_shaft_hub_connection_power_flow(self) -> '_3796.ShaftHubConnectionPowerFlow':
        ...
        if _3796.ShaftHubConnectionPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
