...
class CycloidalDiscPlanetaryBearingConnectionSystemDeflection(_2363.AbstractShaftToMountableComponentConnectionSystemDeflection):
    '''CycloidalDiscPlanetaryBearingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3743.CycloidalDiscPlanetaryBearingConnectionPowerFlow':
        ...
        return constructor.new(_3743.CycloidalDiscPlanetaryBearingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
