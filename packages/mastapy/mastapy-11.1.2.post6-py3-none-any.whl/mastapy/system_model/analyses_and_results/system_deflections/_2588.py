...
from mastapy.system_model.analyses_and_results.power_flows import _3927
from mastapy.math_utility.measured_vectors import _1463
...
class CVTPulleySystemDeflection(_2648.PulleySystemDeflection):
    '''CVTPulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3927.CVTPulleyPowerFlow':
        ...
        return constructor.new(_3927.CVTPulleyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def fixed_sheave_contact_results(self) -> 'List[_1463.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FixedSheaveContactResults, constructor.new(_1463.NodeResults))
        return value

    @property
    def moving_sheave_contact_results(self) -> 'List[_1463.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MovingSheaveContactResults, constructor.new(_1463.NodeResults))
        return value
