...
class CylindricalGearMeshSystemDeflection(_2427.GearMeshSystemDeflection):
    '''CylindricalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3746.CylindricalGearMeshPowerFlow':
        ...
        return constructor.new(_3746.CylindricalGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def gear_a(self) -> '_2415.CylindricalGearSystemDeflection':
    ...
    @property
    def gear_b(self) -> '_2415.CylindricalGearSystemDeflection':
    ...
    @property
    def cylindrical_gears(self) -> 'List[_2415.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2415.CylindricalGearSystemDeflection))
        return value

    @property
    def mesh_deflections_left_flank(self) -> 'List[_2513.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsLeftFlank, constructor.new(_2513.MeshDeflectionResults))
        return value

    @property
    def mesh_deflections_right_flank(self) -> 'List[_2513.MeshDeflectionResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshDeflectionsRightFlank, constructor.new(_2513.MeshDeflectionResults))
        return value
