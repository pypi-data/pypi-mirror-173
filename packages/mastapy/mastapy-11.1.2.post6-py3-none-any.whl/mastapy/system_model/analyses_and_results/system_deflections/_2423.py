...
from mastapy.system_model.analyses_and_results.system_deflections import _2424, _2422, _2428
...
class FaceGearSetSystemDeflection(_2428.GearSetSystemDeflection):
    '''FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3754.FaceGearSetPowerFlow':
        ...
        return constructor.new(_3754.FaceGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2424.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsSystemDeflection, constructor.new(_2424.FaceGearSystemDeflection))
        return value

    @property
    def face_meshes_system_deflection(self) -> 'List[_2422.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesSystemDeflection, constructor.new(_2422.FaceGearMeshSystemDeflection))
        return value
