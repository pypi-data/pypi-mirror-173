...
from mastapy.gears.gear_designs.conical import _1073
...
class FaceGearMeshSystemDeflection(_2427.GearMeshSystemDeflection):
    '''FaceGearMeshSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6527.FaceGearMeshLoadCase':
        ...
        return constructor.new(_6527.FaceGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def power_flow_results(self) -> '_3752.FaceGearMeshPowerFlow':
        ...
        return constructor.new(_3752.FaceGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_409.FaceGearMeshRating':
        ...
        return constructor.new(_409.FaceGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def component_detailed_analysis(self) -> '_409.FaceGearMeshRating':
        ...
        return constructor.new(_409.FaceGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
