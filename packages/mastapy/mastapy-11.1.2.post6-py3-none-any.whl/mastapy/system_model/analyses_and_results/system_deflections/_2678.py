...
class SynchroniserSleeveSystemDeflection(_2677.SynchroniserPartSystemDeflection):
    '''SynchroniserSleeveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_4004.SynchroniserSleevePowerFlow':
        ...
        return constructor.new(_4004.SynchroniserSleevePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
