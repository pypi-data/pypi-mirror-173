...
class FEPartSystemDeflection(_2361.AbstractShaftOrHousingSystemDeflection):
    '''FEPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3755.FEPartPowerFlow':
        ...
        return constructor.new(_3755.FEPartPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def export(self) -> '_2089.SystemDeflectionFEExportOptions':
        ...
        return constructor.new(_2089.SystemDeflectionFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
