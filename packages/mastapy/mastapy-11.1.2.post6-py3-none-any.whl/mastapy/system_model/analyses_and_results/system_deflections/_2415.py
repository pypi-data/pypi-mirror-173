...
from mastapy.system_model.analyses_and_results.power_flows import _3747, _3749
...
class CylindricalGearSystemDeflection(_2429.GearSystemDeflection):
    '''CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3747.CylindricalGearPowerFlow':
        ...
        if _3747.CylindricalGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def manufacturing_analysis(self) -> '_565.CylindricalManufacturedGearLoadCase':
        ...
        return constructor.new(_565.CylindricalManufacturedGearLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis else None
