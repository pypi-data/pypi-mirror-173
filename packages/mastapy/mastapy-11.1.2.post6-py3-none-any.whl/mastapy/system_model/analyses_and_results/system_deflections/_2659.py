...
from mastapy.system_model.analyses_and_results.system_deflections import _2657, _2658, _2547
from mastapy.shafts import _19
from mastapy.math_utility.measured_vectors import _1462
...
class ShaftSystemDeflection(_2547.AbstractShaftSystemDeflection):
    '''ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3984.ShaftPowerFlow':
        ...
        return constructor.new(_3984.ShaftPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_2657.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2657.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor is not None else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_2657.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2657.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor is not None else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_2657.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2657.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife is not None else None
    ...
    @property
    def shaft_section_results(self) -> 'List[_2658.ShaftSectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionResults, constructor.new(_2658.ShaftSectionSystemDeflection))
        return value

    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_2657.ShaftSectionEndResultsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionEndResultsByOffsetWithWorstSafetyFactor, constructor.new(_2657.ShaftSectionEndResultsSystemDeflection))
        return value

    @property
    def mounted_components_applying_torque(self) -> 'List[_1462.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MountedComponentsApplyingTorque, constructor.new(_1462.ForceResults))
        return value
