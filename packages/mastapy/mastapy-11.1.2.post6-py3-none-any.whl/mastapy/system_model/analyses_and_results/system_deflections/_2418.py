...
class CylindricalPlanetGearSystemDeflection(_2417.CylindricalGearSystemDeflectionWithLTCAResults):
    '''CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3749.CylindricalPlanetGearPowerFlow':
        ...
        return constructor.new(_3749.CylindricalPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
