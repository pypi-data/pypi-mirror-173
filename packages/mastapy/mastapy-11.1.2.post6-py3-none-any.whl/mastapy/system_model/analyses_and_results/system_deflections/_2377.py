...
class BevelGearSetSystemDeflection(_2365.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3716.BevelGearSetPowerFlow':
