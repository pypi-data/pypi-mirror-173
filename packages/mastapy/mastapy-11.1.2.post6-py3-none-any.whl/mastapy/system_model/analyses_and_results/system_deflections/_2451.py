...
class BevelGearSetSystemDeflection(_2439.AGMAGleasonConicalGearSetSystemDeflection):
    """BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3792.BevelGearSetPowerFlow':
