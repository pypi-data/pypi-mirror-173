...
from mastapy.system_model.analyses_and_results.static_loads import _6713
from mastapy.system_model.analyses_and_results.power_flows import _3905
...
class ZerolBevelGearSystemDeflection(_2452.BevelGearSystemDeflection):
    """ZerolBevelGearSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_342.ZerolBevelGearRating':
    ...
    @property
    def component_load_case(self) -> '_6713.ZerolBevelGearLoadCase':
    ...
    @property
    def power_flow_results(self) -> '_3905.ZerolBevelGearPowerFlow':
