...
from mastapy.system_model.analyses_and_results.system_deflections import _2566, _2677
...
class SynchroniserHalfSystemDeflection(_2677.SynchroniserPartSystemDeflection):
    '''SynchroniserHalfSystemDeflection
    ...
    @property
    def clutch_connection(self) -> '_2566.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2566.ClutchConnectionSystemDeflection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection is not None else None
    ...
    @property
    def power_flow_results(self) -> '_4001.SynchroniserHalfPowerFlow':
        ...
        return constructor.new(_4001.SynchroniserHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None
