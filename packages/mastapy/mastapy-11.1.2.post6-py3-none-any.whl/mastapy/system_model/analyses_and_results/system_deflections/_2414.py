...
from mastapy.gears.ltca.cylindrical import _797, _799
...
class CylindricalGearSetSystemDeflectionWithLTCAResults(_2412.CylindricalGearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflectionWithLTCAResults
    ...
    @property
    def basic_ltca_results(self) -> '_797.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _797.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.BasicLTCAResults.__class__.__mro__:
    ...
    @property
    def basic_ltca_results_only_first_planetary_mesh(self) -> '_797.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _797.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.BasicLTCAResultsOnlyFirstPlanetaryMesh.__class__.__mro__:
    ...
    @property
    def advanced_ltca_results(self) -> '_797.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _797.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.AdvancedLTCAResults.__class__.__mro__:
    ...
    @property
    def advanced_ltca_results_only_first_planetary_mesh(self) -> '_797.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _797.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.AdvancedLTCAResultsOnlyFirstPlanetaryMesh.__class__.__mro__:
