...
class BevelDifferentialGearMeshSystemDeflection(_2450.BevelGearMeshSystemDeflection):
    """BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def rating(self) -> '_520.BevelGearMeshRating':
    ...
    @property
    def power_flow_results(self) -> '_3785.BevelDifferentialGearMeshPowerFlow':
