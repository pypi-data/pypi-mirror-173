...
class BevelDifferentialSunGearSystemDeflection(_2373.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3713.BevelDifferentialSunGearPowerFlow':
        ...
        return constructor.new(_3713.BevelDifferentialSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
