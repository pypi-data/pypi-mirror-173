...
from mastapy.system_model.analyses_and_results.system_deflections import _2463, _2474
...
class CycloidalAssemblySystemDeflection(_2474.SpecialisedAssemblySystemDeflection):
    '''CycloidalAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3741.CycloidalAssemblyPowerFlow':
        ...
        return constructor.new(_3741.CycloidalAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def ring_pins_to_disc_connections(self) -> 'List[_2463.RingPinsToDiscConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinsToDiscConnections, constructor.new(_2463.RingPinsToDiscConnectionSystemDeflection))
        return value
