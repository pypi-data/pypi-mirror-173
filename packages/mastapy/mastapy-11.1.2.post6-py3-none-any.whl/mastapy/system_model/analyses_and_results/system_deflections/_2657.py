...
class ShaftSectionEndResultsSystemDeflection(_0.APIBase):
    ...
    @property
    def displacements(self) -> '_1465.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1465.VectorWithLinearAndAngularComponents)(self.wrapped.Displacements) if self.wrapped.Displacements is not None else None

    @property
    def forces(self) -> '_1465.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1465.VectorWithLinearAndAngularComponents)(self.wrapped.Forces) if self.wrapped.Forces is not None else None
