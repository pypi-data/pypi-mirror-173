...
from mastapy.system_model.drawing import _2117, _2107
...
class SystemDeflectionDrawStyle(_2107.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_2117.ScalingDrawStyle':
        ...
        return constructor.new(_2117.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling is not None else None
