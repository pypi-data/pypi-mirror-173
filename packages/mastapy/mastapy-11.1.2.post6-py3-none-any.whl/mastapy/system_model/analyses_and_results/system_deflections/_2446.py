...
from mastapy.system_model.analyses_and_results.system_deflections import _2447, _2445, _2451
...
class BevelDifferentialGearSetSystemDeflection(_2451.BevelGearSetSystemDeflection):
    """BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3787.BevelDifferentialGearSetPowerFlow':
    ...
    @property
    def bevel_differential_gears_system_deflection(self) -> 'List[_2447.BevelDifferentialGearSystemDeflection]':
    ...
    @property
    def bevel_differential_meshes_system_deflection(self) -> 'List[_2445.BevelDifferentialGearMeshSystemDeflection]':
