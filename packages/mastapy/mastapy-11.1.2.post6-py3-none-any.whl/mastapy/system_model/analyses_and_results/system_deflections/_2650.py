...
from mastapy.system_model.analyses_and_results.system_deflections import _2651, _2622
...
class RingPinsToDiscConnectionSystemDeflection(_2622.InterMountableComponentConnectionSystemDeflection):
    '''RingPinsToDiscConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3978.RingPinsToDiscConnectionPowerFlow':
        ...
        return constructor.new(_3978.RingPinsToDiscConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults is not None else None

    @property
    def ring_pin_to_disc_contacts(self) -> 'List[_2651.RingPinToDiscContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinToDiscContacts, constructor.new(_2651.RingPinToDiscContactReporting))
        return value
