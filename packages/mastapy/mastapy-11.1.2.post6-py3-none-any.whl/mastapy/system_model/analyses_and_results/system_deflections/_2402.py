...
class CVTBeltConnectionSystemDeflection(_2369.BeltConnectionSystemDeflection):
    '''CVTBeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3738.CVTBeltConnectionPowerFlow':
        ...
        return constructor.new(_3738.CVTBeltConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
