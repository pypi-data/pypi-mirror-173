...
class CycloidalDiscSystemDeflection(_2362.AbstractShaftSystemDeflection):
    '''CycloidalDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3744.CycloidalDiscPowerFlow':
        ...
        return constructor.new(_3744.CycloidalDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
