...
from mastapy.system_model.analyses_and_results.power_flows import _3748, _3783
from mastapy.gears.rating.cylindrical import _424
from mastapy.gears.manufacturing.cylindrical import _569
from mastapy.system_model.analyses_and_results.system_deflections import _2415, _2409, _2428
...
class CylindricalGearSetSystemDeflection(_2428.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3748.CylindricalGearSetPowerFlow':
        ...
        if _3748.CylindricalGearSetPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def manufacturing_analysis(self) -> '_569.CylindricalManufacturedGearSetLoadCase':
        ...
        return constructor.new(_569.CylindricalManufacturedGearSetLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis else None

    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2415.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2415.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2409.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2409.CylindricalGearMeshSystemDeflection))
        return value
