...
from mastapy.system_model.analyses_and_results.system_deflections import _2392, _2390, _2428
...
class ConceptGearSetSystemDeflection(_2428.GearSetSystemDeflection):
    '''ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3729.ConceptGearSetPowerFlow':
        ...
        return constructor.new(_3729.ConceptGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def concept_gears_system_deflection(self) -> 'List[_2392.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsSystemDeflection, constructor.new(_2392.ConceptGearSystemDeflection))
        return value

    @property
    def concept_meshes_system_deflection(self) -> 'List[_2390.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesSystemDeflection, constructor.new(_2390.ConceptGearMeshSystemDeflection))
        return value
