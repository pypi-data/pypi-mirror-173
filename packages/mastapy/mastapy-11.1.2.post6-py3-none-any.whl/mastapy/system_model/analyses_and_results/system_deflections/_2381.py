...
class ClutchConnectionSystemDeflection(_2399.CouplingConnectionSystemDeflection):
    '''ClutchConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3719.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_3719.ClutchConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
