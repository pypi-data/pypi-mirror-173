...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6167, _6168, _6174
...
class FaceGearSetDynamicAnalysis(_6174.GearSetDynamicAnalysis):
    '''FaceGearSetDynamicAnalysis
    ...
    @property
    def face_gears_dynamic_analysis(self) -> 'List[_6167.FaceGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsDynamicAnalysis, constructor.new(_6167.FaceGearDynamicAnalysis))
        return value

    @property
    def face_meshes_dynamic_analysis(self) -> 'List[_6168.FaceGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesDynamicAnalysis, constructor.new(_6168.FaceGearMeshDynamicAnalysis))
        return value
