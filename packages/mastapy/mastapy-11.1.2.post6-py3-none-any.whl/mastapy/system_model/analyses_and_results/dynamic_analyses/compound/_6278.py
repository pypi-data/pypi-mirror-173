...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6148
...
class ConnectionCompoundDynamicAnalysis(_7370.ConnectionCompoundAnalysis):
    '''ConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6148.ConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6148.ConnectionDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6148.ConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6148.ConnectionDynamicAnalysis))
        return value
