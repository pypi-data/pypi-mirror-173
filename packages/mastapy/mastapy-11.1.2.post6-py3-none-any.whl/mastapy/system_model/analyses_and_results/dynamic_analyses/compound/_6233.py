...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6231, _6232, _6150
...
class SpiralBevelGearSetCompoundDynamicAnalysis(_6150.BevelGearSetCompoundDynamicAnalysis):
    """SpiralBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6104.SpiralBevelGearSetDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6231.SpiralBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6232.SpiralBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6104.SpiralBevelGearSetDynamicAnalysis]':
