...
class AGMAGleasonConicalGearCompoundDynamicAnalysis(_6084.ConicalGearCompoundDynamicAnalysis):
    '''AGMAGleasonConicalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5926.AGMAGleasonConicalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5926.AGMAGleasonConicalGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5926.AGMAGleasonConicalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5926.AGMAGleasonConicalGearDynamicAnalysis))
        return value
