...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6089
...
class ConceptCouplingCompoundDynamicAnalysis(_6089.CouplingCompoundDynamicAnalysis):
    '''ConceptCouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5949.ConceptCouplingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5949.ConceptCouplingDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5949.ConceptCouplingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5949.ConceptCouplingDynamicAnalysis))
        return value
