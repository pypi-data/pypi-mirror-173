...
class InterMountableComponentConnectionCompoundDynamicAnalysis(_6087.ConnectionCompoundDynamicAnalysis):
    '''InterMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5988.InterMountableComponentConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5988.InterMountableComponentConnectionDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5988.InterMountableComponentConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5988.InterMountableComponentConnectionDynamicAnalysis))
        return value
