...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6081, _6082, _6112
...
class ConceptGearSetCompoundDynamicAnalysis(_6112.GearSetCompoundDynamicAnalysis):
    '''ConceptGearSetCompoundDynamicAnalysis
    ...
    @property
    def concept_gears_compound_dynamic_analysis(self) -> 'List[_6081.ConceptGearCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundDynamicAnalysis, constructor.new(_6081.ConceptGearCompoundDynamicAnalysis))
        return value

    @property
    def concept_meshes_compound_dynamic_analysis(self) -> 'List[_6082.ConceptGearMeshCompoundDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundDynamicAnalysis, constructor.new(_6082.ConceptGearMeshCompoundDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5953.ConceptGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5953.ConceptGearSetDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5953.ConceptGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5953.ConceptGearSetDynamicAnalysis))
        return value
