...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6276
...
class KlingelnbergCycloPalloidConicalGearMeshCompoundDynamicAnalysis(_6276.ConicalGearMeshCompoundDynamicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6181.KlingelnbergCycloPalloidConicalGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6181.KlingelnbergCycloPalloidConicalGearMeshDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6181.KlingelnbergCycloPalloidConicalGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6181.KlingelnbergCycloPalloidConicalGearMeshDynamicAnalysis))
        return value
