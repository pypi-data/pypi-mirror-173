...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6177
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6248
...
class HypoidGearMeshCompoundDynamicAnalysis(_6248.AGMAGleasonConicalGearMeshCompoundDynamicAnalysis):
    '''HypoidGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6177.HypoidGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6177.HypoidGearMeshDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6177.HypoidGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6177.HypoidGearMeshDynamicAnalysis))
        return value
