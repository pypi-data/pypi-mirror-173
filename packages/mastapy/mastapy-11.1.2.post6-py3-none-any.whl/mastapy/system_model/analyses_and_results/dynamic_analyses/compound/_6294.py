...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6164
...
class DatumCompoundDynamicAnalysis(_6268.ComponentCompoundDynamicAnalysis):
    '''DatumCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6164.DatumDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6164.DatumDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6164.DatumDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6164.DatumDynamicAnalysis))
        return value
