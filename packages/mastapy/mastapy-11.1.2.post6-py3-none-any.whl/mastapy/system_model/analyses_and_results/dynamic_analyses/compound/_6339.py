...
class ShaftHubConnectionCompoundDynamicAnalysis(_6279.ConnectorCompoundDynamicAnalysis):
    '''ShaftHubConnectionCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6210.ShaftHubConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6210.ShaftHubConnectionDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6210.ShaftHubConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6210.ShaftHubConnectionDynamicAnalysis))
        return value
