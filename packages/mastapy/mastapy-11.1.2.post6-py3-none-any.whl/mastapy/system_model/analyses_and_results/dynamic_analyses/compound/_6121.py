...
class KlingelnbergCycloPalloidHypoidGearCompoundDynamicAnalysis(_6118.KlingelnbergCycloPalloidConicalGearCompoundDynamicAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5992.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5992.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5992.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5992.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis))
        return value
