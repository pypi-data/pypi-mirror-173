...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6240, _6241, _6150
...
class StraightBevelGearSetCompoundDynamicAnalysis(_6150.BevelGearSetCompoundDynamicAnalysis):
    """StraightBevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6113.StraightBevelGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_dynamic_analysis(self) -> 'List[_6240.StraightBevelGearCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_dynamic_analysis(self) -> 'List[_6241.StraightBevelGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6113.StraightBevelGearSetDynamicAnalysis]':
