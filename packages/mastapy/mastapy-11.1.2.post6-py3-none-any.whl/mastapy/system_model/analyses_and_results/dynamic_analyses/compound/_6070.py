...
class BevelGearSetCompoundDynamicAnalysis(_6058.AGMAGleasonConicalGearSetCompoundDynamicAnalysis):
    '''BevelGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5940.BevelGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5940.BevelGearSetDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5940.BevelGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5940.BevelGearSetDynamicAnalysis))
        return value
