...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6086
...
class KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis(_6086.ConicalGearSetCompoundDynamicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5991.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5991.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5991.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5991.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis))
        return value
