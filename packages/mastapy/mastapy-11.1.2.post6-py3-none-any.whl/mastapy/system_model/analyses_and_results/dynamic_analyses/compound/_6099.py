...
class CylindricalGearCompoundDynamicAnalysis(_6110.GearCompoundDynamicAnalysis):
    '''CylindricalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5969.CylindricalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5969.CylindricalGearDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5969.CylindricalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5969.CylindricalGearDynamicAnalysis))
        return value
