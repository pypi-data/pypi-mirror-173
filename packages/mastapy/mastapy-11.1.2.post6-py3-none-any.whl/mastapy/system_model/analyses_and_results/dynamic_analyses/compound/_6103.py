...
class DatumCompoundDynamicAnalysis(_6077.ComponentCompoundDynamicAnalysis):
    '''DatumCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5973.DatumDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5973.DatumDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5973.DatumDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5973.DatumDynamicAnalysis))
        return value
