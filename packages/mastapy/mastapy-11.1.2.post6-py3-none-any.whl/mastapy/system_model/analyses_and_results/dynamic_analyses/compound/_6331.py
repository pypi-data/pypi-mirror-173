...
class PulleyCompoundDynamicAnalysis(_6282.CouplingHalfCompoundDynamicAnalysis):
    '''PulleyCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6202.PulleyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6202.PulleyDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6202.PulleyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6202.PulleyDynamicAnalysis))
        return value
