...
class ConceptGearCompoundDynamicAnalysis(_6110.GearCompoundDynamicAnalysis):
    '''ConceptGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5951.ConceptGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5951.ConceptGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5951.ConceptGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5951.ConceptGearDynamicAnalysis))
        return value
