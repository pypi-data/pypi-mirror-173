...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6159
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6246
...
class CycloidalDiscPlanetaryBearingConnectionCompoundDynamicAnalysis(_6246.AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6159.CycloidalDiscPlanetaryBearingConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6159.CycloidalDiscPlanetaryBearingConnectionDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6159.CycloidalDiscPlanetaryBearingConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6159.CycloidalDiscPlanetaryBearingConnectionDynamicAnalysis))
        return value
