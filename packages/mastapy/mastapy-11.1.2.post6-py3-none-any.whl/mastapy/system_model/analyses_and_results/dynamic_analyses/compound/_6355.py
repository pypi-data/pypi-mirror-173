...
class StraightBevelSunGearCompoundDynamicAnalysis(_6348.StraightBevelDiffGearCompoundDynamicAnalysis):
    '''StraightBevelSunGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6226.StraightBevelSunGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6226.StraightBevelSunGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6226.StraightBevelSunGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6226.StraightBevelSunGearDynamicAnalysis))
        return value
