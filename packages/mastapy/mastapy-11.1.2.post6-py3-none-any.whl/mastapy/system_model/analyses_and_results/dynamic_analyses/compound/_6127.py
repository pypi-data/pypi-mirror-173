...
class MassDiscCompoundDynamicAnalysis(_6174.VirtualComponentCompoundDynamicAnalysis):
    '''MassDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5998.MassDiscDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5998.MassDiscDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5998.MassDiscDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5998.MassDiscDynamicAnalysis))
        return value
