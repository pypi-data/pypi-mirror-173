...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6243
...
class SpecialisedAssemblyCompoundDynamicAnalysis(_6243.AbstractAssemblyCompoundDynamicAnalysis):
    '''SpecialisedAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6212.SpecialisedAssemblyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6212.SpecialisedAssemblyDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6212.SpecialisedAssemblyDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6212.SpecialisedAssemblyDynamicAnalysis))
        return value
