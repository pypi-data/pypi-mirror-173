...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6141
...
class CVTBeltConnectionCompoundDynamicAnalysis(_6141.BeltConnectionCompoundDynamicAnalysis):
    """CVTBeltConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6042.CVTBeltConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6042.CVTBeltConnectionDynamicAnalysis]':
