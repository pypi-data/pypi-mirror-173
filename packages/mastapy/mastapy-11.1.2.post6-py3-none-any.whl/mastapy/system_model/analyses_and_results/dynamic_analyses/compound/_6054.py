...
class AbstractShaftOrHousingCompoundDynamicAnalysis(_6077.ComponentCompoundDynamicAnalysis):
    '''AbstractShaftOrHousingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5924.AbstractShaftOrHousingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5924.AbstractShaftOrHousingDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5924.AbstractShaftOrHousingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5924.AbstractShaftOrHousingDynamicAnalysis))
        return value
