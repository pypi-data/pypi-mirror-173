...
class BevelDifferentialGearCompoundDynamicAnalysis(_6068.BevelGearCompoundDynamicAnalysis):
    '''BevelDifferentialGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5933.BevelDifferentialGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5933.BevelDifferentialGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5933.BevelDifferentialGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5933.BevelDifferentialGearDynamicAnalysis))
        return value
