...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6170
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6245
...
class FEPartCompoundDynamicAnalysis(_6245.AbstractShaftOrHousingCompoundDynamicAnalysis):
    '''FEPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6170.FEPartDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6170.FEPartDynamicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6170.FEPartDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6170.FEPartDynamicAnalysis))
        return value
