...
class StraightBevelDiffGearCompoundDynamicAnalysis(_6148.BevelGearCompoundDynamicAnalysis):
    """StraightBevelDiffGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6108.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6108.StraightBevelDiffGearDynamicAnalysis]':
