...
class ShaftToMountableComponentConnectionCompoundDynamicAnalysis(_6246.AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    '''ShaftToMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6211.ShaftToMountableComponentConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6211.ShaftToMountableComponentConnectionDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6211.ShaftToMountableComponentConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6211.ShaftToMountableComponentConnectionDynamicAnalysis))
        return value
