...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6176
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6247
...
class HypoidGearCompoundDynamicAnalysis(_6247.AGMAGleasonConicalGearCompoundDynamicAnalysis):
    '''HypoidGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6176.HypoidGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6176.HypoidGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6176.HypoidGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6176.HypoidGearDynamicAnalysis))
        return value
