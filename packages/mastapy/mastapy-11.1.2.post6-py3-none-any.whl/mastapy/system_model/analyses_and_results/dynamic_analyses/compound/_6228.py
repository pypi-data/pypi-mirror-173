...
class ShaftHubConnectionCompoundDynamicAnalysis(_6168.ConnectorCompoundDynamicAnalysis):
    """ShaftHubConnectionCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6099.ShaftHubConnectionDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6099.ShaftHubConnectionDynamicAnalysis]':
