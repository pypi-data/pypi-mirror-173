...
class CycloidalDiscCompoundDynamicAnalysis(_6133.AbstractShaftCompoundDynamicAnalysis):
    """CycloidalDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6047.CycloidalDiscDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6047.CycloidalDiscDynamicAnalysis]':
