...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundDynamicAnalysis(_6118.KlingelnbergCycloPalloidConicalGearCompoundDynamicAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5995.KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5995.KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5995.KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5995.KlingelnbergCycloPalloidSpiralBevelGearDynamicAnalysis))
        return value
