...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6158
...
class CycloidalDiscCompoundDynamicAnalysis(_6244.AbstractShaftCompoundDynamicAnalysis):
    '''CycloidalDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6158.CycloidalDiscDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6158.CycloidalDiscDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6158.CycloidalDiscDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6158.CycloidalDiscDynamicAnalysis))
        return value
