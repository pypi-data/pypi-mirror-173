...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6230
...
class BeltDriveCompoundDynamicAnalysis(_6230.SpecialisedAssemblyCompoundDynamicAnalysis):
    """BeltDriveCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6012.BeltDriveDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6012.BeltDriveDynamicAnalysis]':
