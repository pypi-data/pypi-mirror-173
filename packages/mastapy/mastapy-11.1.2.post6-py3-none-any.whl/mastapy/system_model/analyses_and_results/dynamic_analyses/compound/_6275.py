...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6145
...
class ConicalGearCompoundDynamicAnalysis(_6301.GearCompoundDynamicAnalysis):
    '''ConicalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6145.ConicalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6145.ConicalGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6145.ConicalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6145.ConicalGearDynamicAnalysis))
        return value
