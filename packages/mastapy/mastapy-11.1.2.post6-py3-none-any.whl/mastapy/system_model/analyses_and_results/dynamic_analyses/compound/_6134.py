...
class AbstractShaftOrHousingCompoundDynamicAnalysis(_6157.ComponentCompoundDynamicAnalysis):
    """AbstractShaftOrHousingCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6004.AbstractShaftOrHousingDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6004.AbstractShaftOrHousingDynamicAnalysis]':
