...
class SynchroniserSleeveCompoundDynamicAnalysis(_6358.SynchroniserPartCompoundDynamicAnalysis):
    '''SynchroniserSleeveCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6230.SynchroniserSleeveDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6230.SynchroniserSleeveDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6230.SynchroniserSleeveDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6230.SynchroniserSleeveDynamicAnalysis))
        return value
