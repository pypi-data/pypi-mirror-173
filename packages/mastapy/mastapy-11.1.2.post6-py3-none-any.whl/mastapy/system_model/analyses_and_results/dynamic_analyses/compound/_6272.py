...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6142
...
class ConceptGearCompoundDynamicAnalysis(_6301.GearCompoundDynamicAnalysis):
    '''ConceptGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6142.ConceptGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6142.ConceptGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6142.ConceptGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6142.ConceptGearDynamicAnalysis))
        return value
