...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6237, _6238, _6150
...
class StraightBevelDiffGearSetCompoundDynamicAnalysis(_6150.BevelGearSetCompoundDynamicAnalysis):
    """StraightBevelDiffGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6110.StraightBevelDiffGearSetDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gears_compound_dynamic_analysis(self) -> 'List[_6237.StraightBevelDiffGearCompoundDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_compound_dynamic_analysis(self) -> 'List[_6238.StraightBevelDiffGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6110.StraightBevelDiffGearSetDynamicAnalysis]':
