...
class CycloidalDiscCompoundDynamicAnalysis(_6053.AbstractShaftCompoundDynamicAnalysis):
    '''CycloidalDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5967.CycloidalDiscDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5967.CycloidalDiscDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5967.CycloidalDiscDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5967.CycloidalDiscDynamicAnalysis))
        return value
