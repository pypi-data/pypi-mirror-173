...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6183
...
class KlingelnbergCycloPalloidHypoidGearCompoundDynamicAnalysis(_6309.KlingelnbergCycloPalloidConicalGearCompoundDynamicAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6183.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6183.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6183.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6183.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis))
        return value
