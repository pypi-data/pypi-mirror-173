...
class CylindricalGearCompoundDynamicAnalysis(_6190.GearCompoundDynamicAnalysis):
    """CylindricalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6049.CylindricalGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6049.CylindricalGearDynamicAnalysis]':
