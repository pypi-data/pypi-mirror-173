...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6124
...
class UnbalancedMassCompoundDynamicAnalysis(_6254.VirtualComponentCompoundDynamicAnalysis):
    """UnbalancedMassCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6124.UnbalancedMassDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6124.UnbalancedMassDynamicAnalysis]':
