...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6275
...
class KlingelnbergCycloPalloidConicalGearCompoundDynamicAnalysis(_6275.ConicalGearCompoundDynamicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6180.KlingelnbergCycloPalloidConicalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6180.KlingelnbergCycloPalloidConicalGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6180.KlingelnbergCycloPalloidConicalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6180.KlingelnbergCycloPalloidConicalGearDynamicAnalysis))
        return value
