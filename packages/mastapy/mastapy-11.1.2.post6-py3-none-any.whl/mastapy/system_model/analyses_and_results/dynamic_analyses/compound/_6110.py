...
class GearCompoundDynamicAnalysis(_6129.MountableComponentCompoundDynamicAnalysis):
    '''GearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5981.GearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5981.GearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5981.GearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5981.GearDynamicAnalysis))
        return value
