...
class ConnectorCompoundDynamicAnalysis(_6129.MountableComponentCompoundDynamicAnalysis):
    '''ConnectorCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5958.ConnectorDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5958.ConnectorDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5958.ConnectorDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5958.ConnectorDynamicAnalysis))
        return value
