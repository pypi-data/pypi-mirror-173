...
class SynchroniserCompoundDynamicAnalysis(_6341.SpecialisedAssemblyCompoundDynamicAnalysis):
    '''SynchroniserCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6227.SynchroniserDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6227.SynchroniserDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6227.SynchroniserDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6227.SynchroniserDynamicAnalysis))
        return value
