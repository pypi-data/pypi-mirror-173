...
class CycloidalAssemblyCompoundDynamicAnalysis(_6230.SpecialisedAssemblyCompoundDynamicAnalysis):
    """CycloidalAssemblyCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6045.CycloidalAssemblyDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6045.CycloidalAssemblyDynamicAnalysis]':
