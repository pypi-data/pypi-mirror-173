...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6087
...
class AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis(_6087.ConnectionCompoundDynamicAnalysis):
    '''AbstractShaftToMountableComponentConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5925.AbstractShaftToMountableComponentConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5925.AbstractShaftToMountableComponentConnectionDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5925.AbstractShaftToMountableComponentConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5925.AbstractShaftToMountableComponentConnectionDynamicAnalysis))
        return value
