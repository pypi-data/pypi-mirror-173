...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6187
...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundDynamicAnalysis(_6310.KlingelnbergCycloPalloidConicalGearMeshCompoundDynamicAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6187.KlingelnbergCycloPalloidSpiralBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6187.KlingelnbergCycloPalloidSpiralBevelGearMeshDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6187.KlingelnbergCycloPalloidSpiralBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6187.KlingelnbergCycloPalloidSpiralBevelGearMeshDynamicAnalysis))
        return value
