...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6119
...
class SynchroniserSleeveCompoundDynamicAnalysis(_6247.SynchroniserPartCompoundDynamicAnalysis):
    """SynchroniserSleeveCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6119.SynchroniserSleeveDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6119.SynchroniserSleeveDynamicAnalysis]':
