...
class GuideDxfModelCompoundDynamicAnalysis(_6157.ComponentCompoundDynamicAnalysis):
    """GuideDxfModelCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6064.GuideDxfModelDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6064.GuideDxfModelDynamicAnalysis]':
