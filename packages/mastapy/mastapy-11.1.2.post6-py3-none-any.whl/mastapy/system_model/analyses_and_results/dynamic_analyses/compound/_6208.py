...
class MeasurementComponentCompoundDynamicAnalysis(_6254.VirtualComponentCompoundDynamicAnalysis):
    """MeasurementComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6079.MeasurementComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6079.MeasurementComponentDynamicAnalysis]':
