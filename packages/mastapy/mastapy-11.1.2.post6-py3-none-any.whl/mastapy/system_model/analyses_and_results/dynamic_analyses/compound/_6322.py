...
class PartCompoundDynamicAnalysis(_7377.PartCompoundAnalysis):
    '''PartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6193.PartDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6193.PartDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6193.PartDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6193.PartDynamicAnalysis))
        return value
