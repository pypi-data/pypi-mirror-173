...
class KlingelnbergCycloPalloidConicalGearCompoundDynamicAnalysis(_6084.ConicalGearCompoundDynamicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5989.KlingelnbergCycloPalloidConicalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5989.KlingelnbergCycloPalloidConicalGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5989.KlingelnbergCycloPalloidConicalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5989.KlingelnbergCycloPalloidConicalGearDynamicAnalysis))
        return value
