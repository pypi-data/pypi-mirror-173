...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6123
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6171
...
class TorqueConverterTurbineCompoundDynamicAnalysis(_6171.CouplingHalfCompoundDynamicAnalysis):
    """TorqueConverterTurbineCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6123.TorqueConverterTurbineDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6123.TorqueConverterTurbineDynamicAnalysis]':
