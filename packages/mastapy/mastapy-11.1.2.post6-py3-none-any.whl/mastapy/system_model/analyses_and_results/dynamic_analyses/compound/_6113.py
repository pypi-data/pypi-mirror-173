...
class GuideDxfModelCompoundDynamicAnalysis(_6077.ComponentCompoundDynamicAnalysis):
    '''GuideDxfModelCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5984.GuideDxfModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5984.GuideDxfModelDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5984.GuideDxfModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5984.GuideDxfModelDynamicAnalysis))
        return value
