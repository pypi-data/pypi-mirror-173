...
class FaceGearCompoundDynamicAnalysis(_6110.GearCompoundDynamicAnalysis):
    '''FaceGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5976.FaceGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5976.FaceGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5976.FaceGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5976.FaceGearDynamicAnalysis))
        return value
