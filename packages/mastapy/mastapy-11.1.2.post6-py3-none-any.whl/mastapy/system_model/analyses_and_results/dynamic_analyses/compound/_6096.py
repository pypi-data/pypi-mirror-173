...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6076
...
class CycloidalDiscCentralBearingConnectionCompoundDynamicAnalysis(_6076.CoaxialConnectionCompoundDynamicAnalysis):
    '''CycloidalDiscCentralBearingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5966.CycloidalDiscCentralBearingConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5966.CycloidalDiscCentralBearingConnectionDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5966.CycloidalDiscCentralBearingConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5966.CycloidalDiscCentralBearingConnectionDynamicAnalysis))
        return value
