...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6209
...
class RingPinsCompoundDynamicAnalysis(_6209.MountableComponentCompoundDynamicAnalysis):
    """RingPinsCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6092.RingPinsDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6092.RingPinsDynamicAnalysis]':
