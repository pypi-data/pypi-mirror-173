...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6129, _6130, _6020
...
class ZerolBevelGearSetDynamicAnalysis(_6020.BevelGearSetDynamicAnalysis):
    """ZerolBevelGearSetDynamicAnalysis
    ...
    @property
    def zerol_bevel_gears_dynamic_analysis(self) -> 'List[_6129.ZerolBevelGearDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_dynamic_analysis(self) -> 'List[_6130.ZerolBevelGearMeshDynamicAnalysis]':
