...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5951, _5952, _5983
...
class ConceptGearSetDynamicAnalysis(_5983.GearSetDynamicAnalysis):
    '''ConceptGearSetDynamicAnalysis
    ...
    @property
    def concept_gears_dynamic_analysis(self) -> 'List[_5951.ConceptGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsDynamicAnalysis, constructor.new(_5951.ConceptGearDynamicAnalysis))
        return value

    @property
    def concept_meshes_dynamic_analysis(self) -> 'List[_5952.ConceptGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesDynamicAnalysis, constructor.new(_5952.ConceptGearMeshDynamicAnalysis))
        return value
