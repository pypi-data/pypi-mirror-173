...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2486
...
from mastapy.system_model.analyses_and_results.analysis_cases import _7371
...
class ConnectionDynamicAnalysis(_7371.ConnectionFEAnalysis):
    '''ConnectionDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_2486.DynamicAnalysis':
        ...
        if _2486.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysis.__class__.__mro__:
