...
class ConnectionSteadyStateSynchronousResponseOnAShaft(_7372.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def steady_state_synchronous_response_on_a_shaft(self) -> '_2943.SteadyStateSynchronousResponseOnAShaft':
        ...
        return constructor.new(_2943.SteadyStateSynchronousResponseOnAShaft)(self.wrapped.SteadyStateSynchronousResponseOnAShaft) if self.wrapped.SteadyStateSynchronousResponseOnAShaft is not None else None
