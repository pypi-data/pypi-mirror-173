...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3115, _3113, _3048
...
class WormGearSetSteadyStateSynchronousResponseOnAShaft(_3048.GearSetSteadyStateSynchronousResponseOnAShaft):
    """WormGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def worm_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3115.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def worm_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_3113.WormGearMeshSteadyStateSynchronousResponseOnAShaft]':
