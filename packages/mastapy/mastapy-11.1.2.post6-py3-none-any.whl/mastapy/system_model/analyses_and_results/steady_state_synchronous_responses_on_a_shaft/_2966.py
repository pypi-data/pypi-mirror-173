...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _2967, _2965, _2855
...
class ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft(_2855.BevelGearSetSteadyStateSynchronousResponseOnAShaft):
    '''ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def zerol_bevel_gears_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_2967.ZerolBevelGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsSteadyStateSynchronousResponseOnAShaft, constructor.new(_2967.ZerolBevelGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def zerol_bevel_meshes_steady_state_synchronous_response_on_a_shaft(self) -> 'List[_2965.ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesSteadyStateSynchronousResponseOnAShaft, constructor.new(_2965.ZerolBevelGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value
