...
class RootAssemblySteadyStateSynchronousResponseOnAShaft(_2698.AssemblySteadyStateSynchronousResponseOnAShaft):
    ...
    def steady_state_synchronous_response_on_a_shaft_inputs(self) -> '_2796.SteadyStateSynchronousResponseOnAShaft':
        ...
        return constructor.new(_2796.SteadyStateSynchronousResponseOnAShaft)(self.wrapped.SteadyStateSynchronousResponseOnAShaftInputs) if self.wrapped.SteadyStateSynchronousResponseOnAShaftInputs is not None else None
