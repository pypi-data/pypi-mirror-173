...
class PartToPartShearCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft(_3007.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    '''PartToPartShearCouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2919.PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2919.PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2919.PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2919.PartToPartShearCouplingHalfSteadyStateSynchronousResponseOnAShaft))
        return value
