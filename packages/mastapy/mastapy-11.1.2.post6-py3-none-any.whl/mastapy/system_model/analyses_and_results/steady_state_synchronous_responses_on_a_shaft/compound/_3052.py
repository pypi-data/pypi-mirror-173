...
class PlanetaryGearSetCompoundSteadyStateSynchronousResponseOnAShaft(_3017.CylindricalGearSetCompoundSteadyStateSynchronousResponseOnAShaft):
    '''PlanetaryGearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2922.PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2922.PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2922.PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2922.PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft))
        return value
