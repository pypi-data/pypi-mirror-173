...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _2958
...
class TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft(_3005.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    '''TorqueConverterCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2958.TorqueConverterSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2958.TorqueConverterSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2958.TorqueConverterSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2958.TorqueConverterSteadyStateSynchronousResponseOnAShaft))
        return value
