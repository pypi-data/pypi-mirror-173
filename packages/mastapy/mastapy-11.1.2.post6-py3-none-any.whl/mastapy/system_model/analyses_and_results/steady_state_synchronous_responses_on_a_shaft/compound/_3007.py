...
class CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft(_3045.MountableComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    '''CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2876.CouplingHalfSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2876.CouplingHalfSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2876.CouplingHalfSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2876.CouplingHalfSteadyStateSynchronousResponseOnAShaft))
        return value
