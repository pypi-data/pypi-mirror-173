...
class ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft(_2839.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2682.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2682.ConceptGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2682.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2682.ConceptGearSteadyStateSynchronousResponseOnAShaft))
        return value
