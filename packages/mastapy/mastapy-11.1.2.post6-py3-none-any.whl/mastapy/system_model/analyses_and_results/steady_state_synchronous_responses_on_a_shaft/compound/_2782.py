...
class AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft(_2783.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseOnAShaft):
    '''AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2653.AbstractShaftSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2653.AbstractShaftSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2653.AbstractShaftSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2653.AbstractShaftSteadyStateSynchronousResponseOnAShaft))
        return value
