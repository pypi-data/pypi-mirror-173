...
class AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseOnAShaft(_2853.ConicalGearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2697.AGMAGleasonConicalGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2697.AGMAGleasonConicalGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2697.AGMAGleasonConicalGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2697.AGMAGleasonConicalGearSteadyStateSynchronousResponseOnAShaft))
        return value
