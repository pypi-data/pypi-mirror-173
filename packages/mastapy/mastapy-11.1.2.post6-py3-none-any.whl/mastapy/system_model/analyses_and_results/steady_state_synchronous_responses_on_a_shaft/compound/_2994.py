...
class ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft(_3005.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    '''ConceptCouplingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2866.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2866.ConceptCouplingSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2866.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2866.ConceptCouplingSteadyStateSynchronousResponseOnAShaft))
        return value
