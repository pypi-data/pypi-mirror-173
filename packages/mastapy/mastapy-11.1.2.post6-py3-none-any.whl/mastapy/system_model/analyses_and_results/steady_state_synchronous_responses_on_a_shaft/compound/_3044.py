...
class MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft(_3090.VirtualComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    '''MeasurementComponentCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2914.MeasurementComponentSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2914.MeasurementComponentSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2914.MeasurementComponentSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2914.MeasurementComponentSteadyStateSynchronousResponseOnAShaft))
        return value
