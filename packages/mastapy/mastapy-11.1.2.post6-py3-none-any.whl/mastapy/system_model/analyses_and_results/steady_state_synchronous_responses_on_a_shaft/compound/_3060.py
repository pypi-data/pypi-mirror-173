...
class RollingRingCompoundSteadyStateSynchronousResponseOnAShaft(_3007.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    '''RollingRingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2931.RollingRingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2931.RollingRingSteadyStateSynchronousResponseOnAShaft))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2931.RollingRingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2931.RollingRingSteadyStateSynchronousResponseOnAShaft))
        return value
