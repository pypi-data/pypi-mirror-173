...
class AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseOnAShaft(_3000.ConicalGearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2844.AGMAGleasonConicalGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2844.AGMAGleasonConicalGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2844.AGMAGleasonConicalGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2844.AGMAGleasonConicalGearSteadyStateSynchronousResponseOnAShaft))
        return value
