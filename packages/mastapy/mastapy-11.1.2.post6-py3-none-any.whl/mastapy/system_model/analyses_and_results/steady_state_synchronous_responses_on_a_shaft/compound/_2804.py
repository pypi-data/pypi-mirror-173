...
class ClutchHalfCompoundSteadyStateSynchronousResponseOnAShaft(_2820.CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft):
    '''ClutchHalfCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2673.ClutchHalfSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2673.ClutchHalfSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2673.ClutchHalfSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2673.ClutchHalfSteadyStateSynchronousResponseOnAShaft))
        return value
