...
class BevelGearCompoundSteadyStateSynchronousResponseOnAShaft(_2785.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''BevelGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2669.BevelGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2669.BevelGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2669.BevelGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2669.BevelGearSteadyStateSynchronousResponseOnAShaft))
        return value
