...
class BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft(_2879.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    '''BoltedJointCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2670.BoltedJointSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2670.BoltedJointSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2670.BoltedJointSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2670.BoltedJointSteadyStateSynchronousResponseOnAShaft))
        return value
