...
class AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseOnAShaft(_2846.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    '''AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2692.AbstractShaftOrHousingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2692.AbstractShaftOrHousingSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2692.AbstractShaftOrHousingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2692.AbstractShaftOrHousingSteadyStateSynchronousResponseOnAShaft))
        return value
