...
class GearSetCompoundSteadyStateSynchronousResponseOnAShaft(_2919.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    '''GearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2750.GearSetSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2750.GearSetSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2750.GearSetSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2750.GearSetSteadyStateSynchronousResponseOnAShaft))
        return value
