...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3115
...
class WormGearCompoundSteadyStateSynchronousResponseOnAShaft(_3177.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    """WormGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3115.WormGearSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3115.WormGearSteadyStateSynchronousResponseOnAShaft]':
