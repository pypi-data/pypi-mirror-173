...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _3040
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _3144
...
class DatumCompoundSteadyStateSynchronousResponseOnAShaft(_3144.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    """DatumCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3040.DatumSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3040.DatumSteadyStateSynchronousResponseOnAShaft]':
