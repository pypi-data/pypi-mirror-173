...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft import _2887
...
class CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft(_3026.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2887.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2887.CylindricalGearSteadyStateSynchronousResponseOnAShaft))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2887.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2887.CylindricalGearSteadyStateSynchronousResponseOnAShaft))
        return value
