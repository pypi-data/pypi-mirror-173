...
class PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft(_3005.CouplingCompoundSteadyStateSynchronousResponseOnAShaft):
    '''PartToPartShearCouplingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2920.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2920.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2920.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2920.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft))
        return value
