...
class CVTCompoundSteadyStateSynchronousResponseOnAShaft(_2831.BeltDriveCompoundSteadyStateSynchronousResponseOnAShaft):
    '''CVTCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2733.CVTSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2733.CVTSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2733.CVTSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2733.CVTSteadyStateSynchronousResponseOnAShaft))
        return value
