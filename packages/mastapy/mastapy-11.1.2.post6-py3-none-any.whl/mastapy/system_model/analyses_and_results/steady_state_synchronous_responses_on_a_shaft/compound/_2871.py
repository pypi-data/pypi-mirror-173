...
class CylindricalPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft(_2868.CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''CylindricalPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2741.CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2741.CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2741.CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2741.CylindricalPlanetGearSteadyStateSynchronousResponseOnAShaft))
        return value
