...
class AbstractAssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_2859.PartCompoundSteadyStateSynchronousResponseOnAShaft):
    '''AbstractAssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2650.AbstractAssemblySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2650.AbstractAssemblySteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2650.AbstractAssemblySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2650.AbstractAssemblySteadyStateSynchronousResponseOnAShaft))
        return value
