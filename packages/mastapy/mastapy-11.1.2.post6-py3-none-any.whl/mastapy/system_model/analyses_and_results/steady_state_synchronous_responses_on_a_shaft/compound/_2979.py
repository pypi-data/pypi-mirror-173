...
class BevelDifferentialGearCompoundSteadyStateSynchronousResponseOnAShaft(_2984.BevelGearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''BevelDifferentialGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2851.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2851.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2851.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2851.BevelDifferentialGearSteadyStateSynchronousResponseOnAShaft))
        return value
