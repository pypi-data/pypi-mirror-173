...
class ComponentCompoundSteadyStateSynchronousResponseOnAShaft(_2860.PartCompoundSteadyStateSynchronousResponseOnAShaft):
    '''ComponentCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2676.ComponentSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2676.ComponentSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2676.ComponentSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2676.ComponentSteadyStateSynchronousResponseOnAShaft))
        return value
