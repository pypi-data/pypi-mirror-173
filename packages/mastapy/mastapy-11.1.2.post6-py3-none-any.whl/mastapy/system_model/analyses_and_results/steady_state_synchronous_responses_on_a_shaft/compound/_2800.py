...
class BoltCompoundSteadyStateSynchronousResponseOnAShaft(_2806.ComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    '''BoltCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2671.BoltSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2671.BoltSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2671.BoltSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2671.BoltSteadyStateSynchronousResponseOnAShaft))
        return value
