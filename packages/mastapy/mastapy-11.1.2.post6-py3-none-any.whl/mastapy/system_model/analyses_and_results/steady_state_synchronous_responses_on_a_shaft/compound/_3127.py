...
class BearingCompoundSteadyStateSynchronousResponseOnAShaft(_3155.ConnectorCompoundSteadyStateSynchronousResponseOnAShaft):
    """BearingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2997.BearingSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2997.BearingSteadyStateSynchronousResponseOnAShaft]':
