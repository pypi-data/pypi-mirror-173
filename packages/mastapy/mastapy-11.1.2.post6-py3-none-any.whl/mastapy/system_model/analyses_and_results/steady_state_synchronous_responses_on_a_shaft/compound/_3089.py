...
class UnbalancedMassCompoundSteadyStateSynchronousResponseOnAShaft(_3090.VirtualComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    '''UnbalancedMassCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2960.UnbalancedMassSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2960.UnbalancedMassSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2960.UnbalancedMassSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2960.UnbalancedMassSteadyStateSynchronousResponseOnAShaft))
        return value
