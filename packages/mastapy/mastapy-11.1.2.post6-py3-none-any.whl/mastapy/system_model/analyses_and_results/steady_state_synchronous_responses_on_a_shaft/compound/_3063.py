...
class ShaftCompoundSteadyStateSynchronousResponseOnAShaft(_2969.AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft):
    '''ShaftCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2934.ShaftSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2934.ShaftSteadyStateSynchronousResponseOnAShaft))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2934.ShaftSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2934.ShaftSteadyStateSynchronousResponseOnAShaft))
        return value
