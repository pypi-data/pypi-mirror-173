...
class BevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft(_3124.AGMAGleasonConicalGearMeshCompoundSteadyStateSynchronousResponseOnAShaft):
    """BevelGearMeshCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3005.BevelGearMeshSteadyStateSynchronousResponseOnAShaft]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3005.BevelGearMeshSteadyStateSynchronousResponseOnAShaft]':
