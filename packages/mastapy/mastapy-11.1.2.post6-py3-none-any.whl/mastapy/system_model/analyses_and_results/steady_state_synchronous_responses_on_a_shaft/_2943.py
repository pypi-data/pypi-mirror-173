...
class SteadyStateSynchronousResponseOnAShaft(_7381.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3464.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3464.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options is not None else None
