...
class GuideDxfModelSteadyStateSynchronousResponseAtASpeed(_3273.ComponentSteadyStateSynchronousResponseAtASpeed):
    """GuideDxfModelSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_load_case(self) -> '_6620.GuideDxfModelLoadCase':
