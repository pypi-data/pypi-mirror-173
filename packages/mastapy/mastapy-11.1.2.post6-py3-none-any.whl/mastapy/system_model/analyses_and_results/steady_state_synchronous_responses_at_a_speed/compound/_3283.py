...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3153
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3229
...
class FEPartCompoundSteadyStateSynchronousResponseAtASpeed(_3229.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed):
    '''FEPartCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3153.FEPartSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3153.FEPartSteadyStateSynchronousResponseAtASpeed))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3153.FEPartSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3153.FEPartSteadyStateSynchronousResponseAtASpeed))
        return value
