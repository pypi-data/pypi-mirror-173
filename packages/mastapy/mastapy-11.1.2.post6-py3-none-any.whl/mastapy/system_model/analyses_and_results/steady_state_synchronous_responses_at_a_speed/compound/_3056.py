...
class BevelGearCompoundSteadyStateSynchronousResponseAtASpeed(_3044.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseAtASpeed):
    '''BevelGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2928.BevelGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2928.BevelGearSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2928.BevelGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2928.BevelGearSteadyStateSynchronousResponseAtASpeed))
        return value
