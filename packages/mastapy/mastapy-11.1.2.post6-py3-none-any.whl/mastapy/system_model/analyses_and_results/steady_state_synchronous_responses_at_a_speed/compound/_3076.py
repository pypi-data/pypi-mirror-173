...
class AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed(_3099.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2945.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2945.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2945.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2945.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed))
        return value
