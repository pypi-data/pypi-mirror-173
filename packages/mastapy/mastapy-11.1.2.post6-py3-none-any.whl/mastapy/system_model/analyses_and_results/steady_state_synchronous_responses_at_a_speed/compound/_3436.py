...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3308
...
class GearCompoundSteadyStateSynchronousResponseAtASpeed(_3455.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """GearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3308.GearSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3308.GearSteadyStateSynchronousResponseAtASpeed]':
