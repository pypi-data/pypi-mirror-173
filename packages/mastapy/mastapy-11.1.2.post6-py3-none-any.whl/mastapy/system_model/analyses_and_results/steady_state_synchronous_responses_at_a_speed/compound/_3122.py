...
class CVTPulleyCompoundSteadyStateSynchronousResponseAtASpeed(_3168.PulleyCompoundSteadyStateSynchronousResponseAtASpeed):
    '''CVTPulleyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2991.CVTPulleySteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2991.CVTPulleySteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2991.CVTPulleySteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2991.CVTPulleySteadyStateSynchronousResponseAtASpeed))
        return value
