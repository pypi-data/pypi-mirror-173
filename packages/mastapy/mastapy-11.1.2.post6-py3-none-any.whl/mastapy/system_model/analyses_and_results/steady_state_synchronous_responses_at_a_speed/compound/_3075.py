...
class AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed(_3076.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed):
    '''AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2946.AbstractShaftSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2946.AbstractShaftSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2946.AbstractShaftSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2946.AbstractShaftSteadyStateSynchronousResponseAtASpeed))
        return value
