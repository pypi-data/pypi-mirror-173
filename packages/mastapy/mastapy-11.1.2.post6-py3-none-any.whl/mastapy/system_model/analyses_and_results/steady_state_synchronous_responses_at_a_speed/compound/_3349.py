...
class VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3304.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3220.VirtualComponentSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3220.VirtualComponentSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3220.VirtualComponentSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3220.VirtualComponentSteadyStateSynchronousResponseAtASpeed))
        return value
