...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3129
...
class PlanetaryGearSetCompoundSteadyStateSynchronousResponseAtASpeed(_3129.CylindricalGearSetCompoundSteadyStateSynchronousResponseAtASpeed):
    '''PlanetaryGearSetCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3034.PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3034.PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3034.PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3034.PlanetaryGearSetSteadyStateSynchronousResponseAtASpeed))
        return value
