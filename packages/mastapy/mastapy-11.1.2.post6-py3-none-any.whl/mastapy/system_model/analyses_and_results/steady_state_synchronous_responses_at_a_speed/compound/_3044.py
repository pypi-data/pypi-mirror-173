...
class AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseAtASpeed(_3072.ConicalGearCompoundSteadyStateSynchronousResponseAtASpeed):
    '''AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2916.AGMAGleasonConicalGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2916.AGMAGleasonConicalGearSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2916.AGMAGleasonConicalGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2916.AGMAGleasonConicalGearSteadyStateSynchronousResponseAtASpeed))
        return value
