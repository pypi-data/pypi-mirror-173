...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3201
...
class SpringDamperCompoundSteadyStateSynchronousResponseAtASpeed(_3264.CouplingCompoundSteadyStateSynchronousResponseAtASpeed):
    '''SpringDamperCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3201.SpringDamperSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3201.SpringDamperSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3201.SpringDamperSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3201.SpringDamperSteadyStateSynchronousResponseAtASpeed))
        return value
