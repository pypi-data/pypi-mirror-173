...
class AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed(_3252.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3098.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3098.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3098.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3098.AbstractShaftOrHousingSteadyStateSynchronousResponseAtASpeed))
        return value
