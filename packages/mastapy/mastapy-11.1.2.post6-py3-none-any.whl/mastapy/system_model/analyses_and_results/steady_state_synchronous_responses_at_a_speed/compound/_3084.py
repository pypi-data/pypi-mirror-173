...
class AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseAtASpeed(_3112.ConicalGearCompoundSteadyStateSynchronousResponseAtASpeed):
    '''AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2956.AGMAGleasonConicalGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2956.AGMAGleasonConicalGearSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2956.AGMAGleasonConicalGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2956.AGMAGleasonConicalGearSteadyStateSynchronousResponseAtASpeed))
        return value
