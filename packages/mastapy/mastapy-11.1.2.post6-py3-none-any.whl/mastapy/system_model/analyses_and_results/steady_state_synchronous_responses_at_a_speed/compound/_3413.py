...
class ConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_7265.ConnectionCompoundAnalysis):
    """ConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3283.ConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3283.ConnectionSteadyStateSynchronousResponseAtASpeed]':
