...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3255
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import (
    _3386, _3388, _3391, _3398,
    _3397, _3419, _3399, _3404,
    _3409, _3421, _3423, _3427,
    _3434, _3433, _3435, _3442,
    _3449, _3452, _3453, _3454,
    _3456, _3458, _3463, _3464,
    _3465, _3467, _3469, _3474,
    _3473, _3479, _3480, _3485,
    _3488, _3491, _3495, _3499,
    _3503, _3506, _3378
)
...
class AssemblyCompoundSteadyStateSynchronousResponseAtASpeed(_3378.AbstractAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    """AssemblyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3255.AssemblySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bearings(self) -> 'List[_3386.BearingCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def belt_drives(self) -> 'List[_3388.BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3391.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3398.BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def bolts(self) -> 'List[_3397.BoltCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cv_ts(self) -> 'List[_3419.CVTCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def clutches(self) -> 'List[_3399.ClutchCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3404.ConceptCouplingCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3409.ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3421.CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3423.CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3427.CylindricalGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def fe_parts(self) -> 'List[_3434.FEPartCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3433.FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3435.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3442.HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3449.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3452.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def mass_discs(self) -> 'List[_3453.MassDiscCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def measurement_components(self) -> 'List[_3454.MeasurementComponentCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def oil_seals(self) -> 'List[_3456.OilSealCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3458.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3463.PlanetCarrierCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def point_loads(self) -> 'List[_3464.PointLoadCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def power_loads(self) -> 'List[_3465.PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def ring_pins(self) -> 'List[_3467.RingPinsCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3469.RollingRingAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3474.ShaftHubConnectionCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def shafts(self) -> 'List[_3473.ShaftCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3479.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3480.SpringDamperCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3485.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3488.StraightBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def synchronisers(self) -> 'List[_3491.SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def torque_converters(self) -> 'List[_3495.TorqueConverterCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3499.UnbalancedMassCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3503.WormGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3506.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3255.AssemblySteadyStateSynchronousResponseAtASpeed]':
