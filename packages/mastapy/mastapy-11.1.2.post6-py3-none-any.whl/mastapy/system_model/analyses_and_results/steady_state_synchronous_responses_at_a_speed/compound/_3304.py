...
class MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3252.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3174.MountableComponentSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3174.MountableComponentSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3174.MountableComponentSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3174.MountableComponentSteadyStateSynchronousResponseAtASpeed))
        return value
