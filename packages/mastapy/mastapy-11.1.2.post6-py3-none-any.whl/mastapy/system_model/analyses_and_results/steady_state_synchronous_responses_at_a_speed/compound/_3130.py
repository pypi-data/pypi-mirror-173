...
class CylindricalPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed(_3127.CylindricalGearCompoundSteadyStateSynchronousResponseAtASpeed):
    '''CylindricalPlanetGearCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3000.CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3000.CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3000.CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3000.CylindricalPlanetGearSteadyStateSynchronousResponseAtASpeed))
        return value
