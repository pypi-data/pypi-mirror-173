...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3327
...
class PartCompoundSteadyStateSynchronousResponseAtASpeed(_7272.PartCompoundAnalysis):
    """PartCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3327.PartSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3327.PartSteadyStateSynchronousResponseAtASpeed]':
