...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3299
...
class DatumCompoundSteadyStateSynchronousResponseAtASpeed(_3403.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    """DatumCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3299.DatumSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3299.DatumSteadyStateSynchronousResponseAtASpeed]':
