...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3213
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3342
...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed(_3342.SynchroniserPartCompoundSteadyStateSynchronousResponseAtASpeed):
    '''SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3213.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3213.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3213.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3213.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed))
        return value
