...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3173
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3349
...
class MeasurementComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3349.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''MeasurementComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3173.MeasurementComponentSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3173.MeasurementComponentSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3173.MeasurementComponentSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3173.MeasurementComponentSteadyStateSynchronousResponseAtASpeed))
        return value
