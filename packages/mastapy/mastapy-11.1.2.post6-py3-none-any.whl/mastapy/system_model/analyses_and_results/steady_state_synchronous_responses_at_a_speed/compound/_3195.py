...
class SynchroniserPartCompoundSteadyStateSynchronousResponseAtASpeed(_3119.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    '''SynchroniserPartCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3065.SynchroniserPartSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3065.SynchroniserPartSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3065.SynchroniserPartSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3065.SynchroniserPartSteadyStateSynchronousResponseAtASpeed))
        return value
