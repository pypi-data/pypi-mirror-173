...
class AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed(_3229.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponseAtASpeed):
    '''AbstractShaftCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3099.AbstractShaftSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3099.AbstractShaftSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3099.AbstractShaftSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3099.AbstractShaftSteadyStateSynchronousResponseAtASpeed))
        return value
