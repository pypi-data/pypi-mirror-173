...
class CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed(_3157.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2988.CouplingHalfSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2988.CouplingHalfSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2988.CouplingHalfSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2988.CouplingHalfSteadyStateSynchronousResponseAtASpeed))
        return value
