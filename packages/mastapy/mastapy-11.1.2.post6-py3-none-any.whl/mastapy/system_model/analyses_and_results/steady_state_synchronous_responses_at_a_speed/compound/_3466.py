...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3336
...
class PulleyCompoundSteadyStateSynchronousResponseAtASpeed(_3417.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    """PulleyCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3336.PulleySteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3336.PulleySteadyStateSynchronousResponseAtASpeed]':
