...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3125
...
class ConceptCouplingCompoundSteadyStateSynchronousResponseAtASpeed(_3264.CouplingCompoundSteadyStateSynchronousResponseAtASpeed):
    '''ConceptCouplingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3125.ConceptCouplingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3125.ConceptCouplingSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3125.ConceptCouplingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3125.ConceptCouplingSteadyStateSynchronousResponseAtASpeed))
        return value
