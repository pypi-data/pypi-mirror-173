...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed import _3257
...
class BeltConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3443.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    """BeltConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_design(self) -> '_2019.BeltConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3257.BeltConnectionSteadyStateSynchronousResponseAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3257.BeltConnectionSteadyStateSynchronousResponseAtASpeed]':
