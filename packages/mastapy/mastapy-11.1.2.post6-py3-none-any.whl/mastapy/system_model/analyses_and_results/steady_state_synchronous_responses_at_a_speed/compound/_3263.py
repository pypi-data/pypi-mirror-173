...
class ConnectorCompoundSteadyStateSynchronousResponseAtASpeed(_3304.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''ConnectorCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3133.ConnectorSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3133.ConnectorSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3133.ConnectorSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3133.ConnectorSteadyStateSynchronousResponseAtASpeed))
        return value
