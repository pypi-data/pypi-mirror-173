...
class BearingCompoundSteadyStateSynchronousResponseAtASpeed(_3076.ConnectorCompoundSteadyStateSynchronousResponseAtASpeed):
    '''BearingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2918.BearingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2918.BearingSteadyStateSynchronousResponseAtASpeed))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2918.BearingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2918.BearingSteadyStateSynchronousResponseAtASpeed))
        return value
