...
class RingPinsSteadyStateSynchronousResponseAtASpeed(_3325.MountableComponentSteadyStateSynchronousResponseAtASpeed):
    """RingPinsSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_load_case(self) -> '_6670.RingPinsLoadCase':
