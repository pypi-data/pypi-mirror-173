...
class RollingRingSteadyStateSynchronousResponseAtASpeed(_3286.CouplingHalfSteadyStateSynchronousResponseAtASpeed):
    """RollingRingSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_load_case(self) -> '_6674.RollingRingLoadCase':
