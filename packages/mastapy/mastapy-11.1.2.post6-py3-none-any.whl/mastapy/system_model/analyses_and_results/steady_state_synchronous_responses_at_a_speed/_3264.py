...
class BevelGearMeshSteadyStateSynchronousResponseAtASpeed(_3252.AGMAGleasonConicalGearMeshSteadyStateSynchronousResponseAtASpeed):
    """BevelGearMeshSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_design(self) -> '_2054.BevelGearMesh':
