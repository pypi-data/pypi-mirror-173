...
class ClutchHalfSteadyStateSynchronousResponseAtASpeed(_3286.CouplingHalfSteadyStateSynchronousResponseAtASpeed):
    """ClutchHalfSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_load_case(self) -> '_6557.ClutchHalfLoadCase':
