...
from mastapy.system_model.analyses_and_results.stability_analyses import _3538, _3536, _3567
...
class ConceptGearSetStabilityAnalysis(_3567.GearSetStabilityAnalysis):
    """ConceptGearSetStabilityAnalysis
    ...
    @property
    def concept_gears_stability_analysis(self) -> 'List[_3538.ConceptGearStabilityAnalysis]':
    ...
    @property
    def concept_meshes_stability_analysis(self) -> 'List[_3536.ConceptGearMeshStabilityAnalysis]':
