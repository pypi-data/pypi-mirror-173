...
from mastapy.system_model.analyses_and_results.stability_analyses import _3462, _3460, _3491
...
class ConceptGearSetStabilityAnalysis(_3491.GearSetStabilityAnalysis):
    '''ConceptGearSetStabilityAnalysis
    ...
    @property
    def concept_gears_stability_analysis(self) -> 'List[_3462.ConceptGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsStabilityAnalysis, constructor.new(_3462.ConceptGearStabilityAnalysis))
        return value

    @property
    def concept_meshes_stability_analysis(self) -> 'List[_3460.ConceptGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesStabilityAnalysis, constructor.new(_3460.ConceptGearMeshStabilityAnalysis))
        return value
