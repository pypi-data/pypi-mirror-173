...
from mastapy.system_model.analyses_and_results.stability_analyses import _3444, _3442, _3448
...
class BevelDifferentialGearSetStabilityAnalysis(_3448.BevelGearSetStabilityAnalysis):
    '''BevelDifferentialGearSetStabilityAnalysis
    ...
    @property
    def bevel_differential_gears_stability_analysis(self) -> 'List[_3444.BevelDifferentialGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsStabilityAnalysis, constructor.new(_3444.BevelDifferentialGearStabilityAnalysis))
        return value

    @property
    def bevel_differential_meshes_stability_analysis(self) -> 'List[_3442.BevelDifferentialGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesStabilityAnalysis, constructor.new(_3442.BevelDifferentialGearMeshStabilityAnalysis))
        return value
