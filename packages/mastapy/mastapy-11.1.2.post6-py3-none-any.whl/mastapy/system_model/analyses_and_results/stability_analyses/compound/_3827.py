...
class MountableComponentCompoundStabilityAnalysis(_3775.ComponentCompoundStabilityAnalysis):
    '''MountableComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3696.MountableComponentStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3696.MountableComponentStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3696.MountableComponentStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3696.MountableComponentStabilityAnalysis))
        return value
