...
class BevelDifferentialSunGearCompoundStabilityAnalysis(_3574.BevelDifferentialGearCompoundStabilityAnalysis):
    '''BevelDifferentialSunGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3446.BevelDifferentialSunGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3446.BevelDifferentialSunGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3446.BevelDifferentialSunGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3446.BevelDifferentialSunGearStabilityAnalysis))
        return value
