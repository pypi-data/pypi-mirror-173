...
from mastapy.system_model.analyses_and_results.stability_analyses import _3633
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3698
...
class WormGearMeshCompoundStabilityAnalysis(_3698.GearMeshCompoundStabilityAnalysis):
    """WormGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3633.WormGearMeshStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3633.WormGearMeshStabilityAnalysis]':
