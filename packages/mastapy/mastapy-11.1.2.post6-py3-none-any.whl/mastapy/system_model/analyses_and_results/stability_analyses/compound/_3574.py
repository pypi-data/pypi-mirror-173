...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3579
...
class BevelDifferentialGearCompoundStabilityAnalysis(_3579.BevelGearCompoundStabilityAnalysis):
    '''BevelDifferentialGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3444.BevelDifferentialGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3444.BevelDifferentialGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3444.BevelDifferentialGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3444.BevelDifferentialGearStabilityAnalysis))
        return value
