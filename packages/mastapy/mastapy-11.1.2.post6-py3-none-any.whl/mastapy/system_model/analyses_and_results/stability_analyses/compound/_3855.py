...
class StraightBevelDiffGearCompoundStabilityAnalysis(_3766.BevelGearCompoundStabilityAnalysis):
    '''StraightBevelDiffGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3728.StraightBevelDiffGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3728.StraightBevelDiffGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3728.StraightBevelDiffGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3728.StraightBevelDiffGearStabilityAnalysis))
        return value
