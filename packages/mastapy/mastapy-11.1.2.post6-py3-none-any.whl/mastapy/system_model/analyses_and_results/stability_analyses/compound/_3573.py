...
class BeltDriveCompoundStabilityAnalysis(_3661.SpecialisedAssemblyCompoundStabilityAnalysis):
    '''BeltDriveCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3441.BeltDriveStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3441.BeltDriveStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3441.BeltDriveStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3441.BeltDriveStabilityAnalysis))
        return value
