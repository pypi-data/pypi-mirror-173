...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3785
...
class InterMountableComponentConnectionCompoundStabilityAnalysis(_3785.ConnectionCompoundStabilityAnalysis):
    '''InterMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3684.InterMountableComponentConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3684.InterMountableComponentConnectionStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3684.InterMountableComponentConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3684.InterMountableComponentConnectionStabilityAnalysis))
        return value
