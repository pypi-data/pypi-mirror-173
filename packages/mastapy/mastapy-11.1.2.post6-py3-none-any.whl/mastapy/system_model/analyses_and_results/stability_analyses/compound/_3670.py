...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3668, _3669, _3699
...
class ConceptGearSetCompoundStabilityAnalysis(_3699.GearSetCompoundStabilityAnalysis):
    """ConceptGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3537.ConceptGearSetStabilityAnalysis]':
    ...
    @property
    def concept_gears_compound_stability_analysis(self) -> 'List[_3668.ConceptGearCompoundStabilityAnalysis]':
    ...
    @property
    def concept_meshes_compound_stability_analysis(self) -> 'List[_3669.ConceptGearMeshCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3537.ConceptGearSetStabilityAnalysis]':
