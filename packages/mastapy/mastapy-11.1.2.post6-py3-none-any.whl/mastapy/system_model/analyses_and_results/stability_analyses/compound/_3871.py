...
class UnbalancedMassCompoundStabilityAnalysis(_3872.VirtualComponentCompoundStabilityAnalysis):
    '''UnbalancedMassCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3742.UnbalancedMassStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3742.UnbalancedMassStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3742.UnbalancedMassStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3742.UnbalancedMassStabilityAnalysis))
        return value
