...
from mastapy.system_model.analyses_and_results.stability_analyses import _3664
...
class CycloidalDiscPlanetaryBearingConnectionCompoundStabilityAnalysis(_3753.AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3664.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3664.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3664.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3664.CycloidalDiscPlanetaryBearingConnectionStabilityAnalysis))
        return value
