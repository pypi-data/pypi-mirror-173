...
class SynchroniserSleeveCompoundStabilityAnalysis(_3865.SynchroniserPartCompoundStabilityAnalysis):
    '''SynchroniserSleeveCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3736.SynchroniserSleeveStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3736.SynchroniserSleeveStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3736.SynchroniserSleeveStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3736.SynchroniserSleeveStabilityAnalysis))
        return value
