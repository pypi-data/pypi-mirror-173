...
from mastapy.system_model.analyses_and_results.stability_analyses import _3630
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3678
...
class TorqueConverterTurbineCompoundStabilityAnalysis(_3678.CouplingHalfCompoundStabilityAnalysis):
    """TorqueConverterTurbineCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3630.TorqueConverterTurbineStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3630.TorqueConverterTurbineStabilityAnalysis]':
