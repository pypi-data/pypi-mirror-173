...
class ShaftHubConnectionCompoundStabilityAnalysis(_3786.ConnectorCompoundStabilityAnalysis):
    '''ShaftHubConnectionCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3714.ShaftHubConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3714.ShaftHubConnectionStabilityAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3714.ShaftHubConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3714.ShaftHubConnectionStabilityAnalysis))
        return value
