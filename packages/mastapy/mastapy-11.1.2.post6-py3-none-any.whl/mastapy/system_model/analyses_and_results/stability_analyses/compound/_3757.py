...
from mastapy.system_model.analyses_and_results.stability_analyses import _3627
...
class TorqueConverterConnectionCompoundStabilityAnalysis(_3677.CouplingConnectionCompoundStabilityAnalysis):
    """TorqueConverterConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3627.TorqueConverterConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3627.TorqueConverterConnectionStabilityAnalysis]':
