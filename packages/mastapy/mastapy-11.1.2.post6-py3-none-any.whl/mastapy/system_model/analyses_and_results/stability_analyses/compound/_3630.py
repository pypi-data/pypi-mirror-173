...
class KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis(_3596.ConicalGearMeshCompoundStabilityAnalysis):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3498.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3498.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3498.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3498.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis))
        return value
