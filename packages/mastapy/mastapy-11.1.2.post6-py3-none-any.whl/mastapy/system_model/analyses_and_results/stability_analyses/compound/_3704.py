...
class InterMountableComponentConnectionCompoundStabilityAnalysis(_3674.ConnectionCompoundStabilityAnalysis):
    """InterMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3573.InterMountableComponentConnectionStabilityAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3573.InterMountableComponentConnectionStabilityAnalysis]':
