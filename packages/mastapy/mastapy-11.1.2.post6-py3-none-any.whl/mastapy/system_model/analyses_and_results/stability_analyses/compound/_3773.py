...
from mastapy.system_model.analyses_and_results.stability_analyses import _3640
...
class ClutchHalfCompoundStabilityAnalysis(_3789.CouplingHalfCompoundStabilityAnalysis):
    '''ClutchHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3640.ClutchHalfStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3640.ClutchHalfStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3640.ClutchHalfStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3640.ClutchHalfStabilityAnalysis))
        return value
