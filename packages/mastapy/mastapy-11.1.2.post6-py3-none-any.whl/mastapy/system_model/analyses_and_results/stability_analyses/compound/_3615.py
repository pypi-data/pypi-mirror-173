...
class ExternalCADModelCompoundStabilityAnalysis(_3588.ComponentCompoundStabilityAnalysis):
    '''ExternalCADModelCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3484.ExternalCADModelStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3484.ExternalCADModelStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3484.ExternalCADModelStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3484.ExternalCADModelStabilityAnalysis))
        return value
