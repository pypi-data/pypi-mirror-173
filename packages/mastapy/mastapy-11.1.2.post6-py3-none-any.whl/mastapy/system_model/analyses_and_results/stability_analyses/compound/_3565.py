...
class AbstractShaftOrHousingCompoundStabilityAnalysis(_3588.ComponentCompoundStabilityAnalysis):
    '''AbstractShaftOrHousingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3432.AbstractShaftOrHousingStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3432.AbstractShaftOrHousingStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3432.AbstractShaftOrHousingStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3432.AbstractShaftOrHousingStabilityAnalysis))
        return value
