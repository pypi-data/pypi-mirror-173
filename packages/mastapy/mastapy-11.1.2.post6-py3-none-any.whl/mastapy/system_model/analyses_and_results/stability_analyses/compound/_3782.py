...
class ConicalGearCompoundStabilityAnalysis(_3808.GearCompoundStabilityAnalysis):
    '''ConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3652.ConicalGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3652.ConicalGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3652.ConicalGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3652.ConicalGearStabilityAnalysis))
        return value
