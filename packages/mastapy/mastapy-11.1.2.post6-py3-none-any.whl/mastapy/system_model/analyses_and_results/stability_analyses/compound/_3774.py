...
from mastapy.system_model.analyses_and_results.stability_analyses import _3642
...
class CoaxialConnectionCompoundStabilityAnalysis(_3847.ShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    '''CoaxialConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3642.CoaxialConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3642.CoaxialConnectionStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3642.CoaxialConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3642.CoaxialConnectionStabilityAnalysis))
        return value
