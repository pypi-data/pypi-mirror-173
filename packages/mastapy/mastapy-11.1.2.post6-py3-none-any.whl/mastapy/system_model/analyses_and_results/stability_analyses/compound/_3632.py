...
class KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis(_3629.KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3503.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3503.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3503.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3503.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis))
        return value
