...
class StraightBevelDiffGearCompoundStabilityAnalysis(_3655.BevelGearCompoundStabilityAnalysis):
    """StraightBevelDiffGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3617.StraightBevelDiffGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3617.StraightBevelDiffGearStabilityAnalysis]':
