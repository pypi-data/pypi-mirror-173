...
class TorqueConverterCompoundStabilityAnalysis(_3787.CouplingCompoundStabilityAnalysis):
    '''TorqueConverterCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3740.TorqueConverterStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3740.TorqueConverterStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3740.TorqueConverterStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3740.TorqueConverterStabilityAnalysis))
        return value
