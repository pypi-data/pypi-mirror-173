...
from mastapy.system_model.analyses_and_results.stability_analyses import _3671
...
class ExternalCADModelCompoundStabilityAnalysis(_3775.ComponentCompoundStabilityAnalysis):
    '''ExternalCADModelCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3671.ExternalCADModelStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3671.ExternalCADModelStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3671.ExternalCADModelStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3671.ExternalCADModelStabilityAnalysis))
        return value
