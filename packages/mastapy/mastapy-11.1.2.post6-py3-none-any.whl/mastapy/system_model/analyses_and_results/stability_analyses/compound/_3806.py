...
from mastapy.system_model.analyses_and_results.stability_analyses import _3675
...
class FEPartCompoundStabilityAnalysis(_3752.AbstractShaftOrHousingCompoundStabilityAnalysis):
    '''FEPartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3675.FEPartStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3675.FEPartStabilityAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3675.FEPartStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3675.FEPartStabilityAnalysis))
        return value
