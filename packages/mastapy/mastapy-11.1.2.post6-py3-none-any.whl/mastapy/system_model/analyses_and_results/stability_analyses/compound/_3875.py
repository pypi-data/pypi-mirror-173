...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3873, _3874, _3810
...
class WormGearSetCompoundStabilityAnalysis(_3810.GearSetCompoundStabilityAnalysis):
    '''WormGearSetCompoundStabilityAnalysis
    ...
    @property
    def worm_gears_compound_stability_analysis(self) -> 'List[_3873.WormGearCompoundStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCompoundStabilityAnalysis, constructor.new(_3873.WormGearCompoundStabilityAnalysis))
        return value

    @property
    def worm_meshes_compound_stability_analysis(self) -> 'List[_3874.WormGearMeshCompoundStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCompoundStabilityAnalysis, constructor.new(_3874.WormGearMeshCompoundStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3745.WormGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3745.WormGearSetStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3745.WormGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3745.WormGearSetStabilityAnalysis))
        return value
