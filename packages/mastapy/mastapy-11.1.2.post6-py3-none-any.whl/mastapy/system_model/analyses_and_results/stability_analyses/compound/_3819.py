...
from mastapy.system_model.analyses_and_results.stability_analyses import _3690
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3816
...
class KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis(_3816.KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3690.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3690.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3690.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3690.KlingelnbergCycloPalloidHypoidGearStabilityAnalysis))
        return value
