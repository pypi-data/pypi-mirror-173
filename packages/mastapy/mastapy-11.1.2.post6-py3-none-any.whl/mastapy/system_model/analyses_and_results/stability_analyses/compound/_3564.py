...
class AbstractShaftCompoundStabilityAnalysis(_3565.AbstractShaftOrHousingCompoundStabilityAnalysis):
    '''AbstractShaftCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3433.AbstractShaftStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3433.AbstractShaftStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3433.AbstractShaftStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3433.AbstractShaftStabilityAnalysis))
        return value
