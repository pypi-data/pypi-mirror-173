...
class InterMountableComponentConnectionCompoundStabilityAnalysis(_3598.ConnectionCompoundStabilityAnalysis):
    '''InterMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3497.InterMountableComponentConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3497.InterMountableComponentConnectionStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3497.InterMountableComponentConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3497.InterMountableComponentConnectionStabilityAnalysis))
        return value
