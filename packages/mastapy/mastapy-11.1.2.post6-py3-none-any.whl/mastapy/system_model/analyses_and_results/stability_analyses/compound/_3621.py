...
class GearCompoundStabilityAnalysis(_3640.MountableComponentCompoundStabilityAnalysis):
    '''GearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3492.GearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3492.GearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3492.GearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3492.GearStabilityAnalysis))
        return value
