...
class MassDiscCompoundStabilityAnalysis(_3685.VirtualComponentCompoundStabilityAnalysis):
    '''MassDiscCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3507.MassDiscStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3507.MassDiscStabilityAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3507.MassDiscStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3507.MassDiscStabilityAnalysis))
        return value
