...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3779, _3780, _3810
from mastapy.system_model.analyses_and_results.stability_analyses import _3648
...
class ConceptGearSetCompoundStabilityAnalysis(_3810.GearSetCompoundStabilityAnalysis):
    '''ConceptGearSetCompoundStabilityAnalysis
    ...
    @property
    def concept_gears_compound_stability_analysis(self) -> 'List[_3779.ConceptGearCompoundStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundStabilityAnalysis, constructor.new(_3779.ConceptGearCompoundStabilityAnalysis))
        return value

    @property
    def concept_meshes_compound_stability_analysis(self) -> 'List[_3780.ConceptGearMeshCompoundStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundStabilityAnalysis, constructor.new(_3780.ConceptGearMeshCompoundStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3648.ConceptGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3648.ConceptGearSetStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3648.ConceptGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3648.ConceptGearSetStabilityAnalysis))
        return value
