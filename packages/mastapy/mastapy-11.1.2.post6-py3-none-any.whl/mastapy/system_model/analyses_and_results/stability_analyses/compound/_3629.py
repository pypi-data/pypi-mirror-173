...
class KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis(_3595.ConicalGearCompoundStabilityAnalysis):
    '''KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3500.KlingelnbergCycloPalloidConicalGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3500.KlingelnbergCycloPalloidConicalGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3500.KlingelnbergCycloPalloidConicalGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3500.KlingelnbergCycloPalloidConicalGearStabilityAnalysis))
        return value
