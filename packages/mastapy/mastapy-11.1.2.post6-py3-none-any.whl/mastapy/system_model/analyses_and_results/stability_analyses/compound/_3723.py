...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3688
...
class PlanetaryGearSetCompoundStabilityAnalysis(_3688.CylindricalGearSetCompoundStabilityAnalysis):
    """PlanetaryGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3592.PlanetaryGearSetStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3592.PlanetaryGearSetStabilityAnalysis]':
