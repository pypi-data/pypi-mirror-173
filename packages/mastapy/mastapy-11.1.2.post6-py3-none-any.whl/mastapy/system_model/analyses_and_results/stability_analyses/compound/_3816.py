...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3782
...
class KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis(_3782.ConicalGearCompoundStabilityAnalysis):
    '''KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3687.KlingelnbergCycloPalloidConicalGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3687.KlingelnbergCycloPalloidConicalGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3687.KlingelnbergCycloPalloidConicalGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3687.KlingelnbergCycloPalloidConicalGearStabilityAnalysis))
        return value
