...
class PlanetCarrierCompoundStabilityAnalysis(_3716.MountableComponentCompoundStabilityAnalysis):
    """PlanetCarrierCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3593.PlanetCarrierStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3593.PlanetCarrierStabilityAnalysis]':
