...
class SynchroniserPartCompoundStabilityAnalysis(_3789.CouplingHalfCompoundStabilityAnalysis):
    '''SynchroniserPartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3735.SynchroniserPartStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3735.SynchroniserPartStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3735.SynchroniserPartStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3735.SynchroniserPartStabilityAnalysis))
        return value
