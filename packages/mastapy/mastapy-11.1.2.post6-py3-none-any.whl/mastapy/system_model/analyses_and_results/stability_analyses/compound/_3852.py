...
class SpringDamperCompoundStabilityAnalysis(_3787.CouplingCompoundStabilityAnalysis):
    '''SpringDamperCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3723.SpringDamperStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3723.SpringDamperStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3723.SpringDamperStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3723.SpringDamperStabilityAnalysis))
        return value
