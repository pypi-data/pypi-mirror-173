...
class FEPartCompoundStabilityAnalysis(_3565.AbstractShaftOrHousingCompoundStabilityAnalysis):
    '''FEPartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3488.FEPartStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3488.FEPartStabilityAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3488.FEPartStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3488.FEPartStabilityAnalysis))
        return value
