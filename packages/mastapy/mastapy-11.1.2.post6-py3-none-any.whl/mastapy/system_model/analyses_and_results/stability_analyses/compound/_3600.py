...
class CouplingCompoundStabilityAnalysis(_3661.SpecialisedAssemblyCompoundStabilityAnalysis):
    '''CouplingCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3470.CouplingStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3470.CouplingStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3470.CouplingStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3470.CouplingStabilityAnalysis))
        return value
