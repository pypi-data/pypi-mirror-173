...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3803, _3804, _3810
from mastapy.system_model.analyses_and_results.stability_analyses import _3673
...
class FaceGearSetCompoundStabilityAnalysis(_3810.GearSetCompoundStabilityAnalysis):
    '''FaceGearSetCompoundStabilityAnalysis
    ...
    @property
    def face_gears_compound_stability_analysis(self) -> 'List[_3803.FaceGearCompoundStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundStabilityAnalysis, constructor.new(_3803.FaceGearCompoundStabilityAnalysis))
        return value

    @property
    def face_meshes_compound_stability_analysis(self) -> 'List[_3804.FaceGearMeshCompoundStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundStabilityAnalysis, constructor.new(_3804.FaceGearMeshCompoundStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3673.FaceGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3673.FaceGearSetStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3673.FaceGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3673.FaceGearSetStabilityAnalysis))
        return value
