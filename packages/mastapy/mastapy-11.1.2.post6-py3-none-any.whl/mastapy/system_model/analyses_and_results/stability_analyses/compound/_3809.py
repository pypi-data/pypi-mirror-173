...
from mastapy.system_model.analyses_and_results.stability_analyses import _3677
...
class GearMeshCompoundStabilityAnalysis(_3815.InterMountableComponentConnectionCompoundStabilityAnalysis):
    '''GearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3677.GearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3677.GearMeshStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3677.GearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3677.GearMeshStabilityAnalysis))
        return value
