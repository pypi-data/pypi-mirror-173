...
from mastapy.system_model.analyses_and_results.stability_analyses import _3641
...
class ClutchCompoundStabilityAnalysis(_3787.CouplingCompoundStabilityAnalysis):
    '''ClutchCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3641.ClutchStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3641.ClutchStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3641.ClutchStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3641.ClutchStabilityAnalysis))
        return value
