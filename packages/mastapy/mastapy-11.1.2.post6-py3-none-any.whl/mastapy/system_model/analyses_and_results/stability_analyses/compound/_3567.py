...
class AGMAGleasonConicalGearCompoundStabilityAnalysis(_3595.ConicalGearCompoundStabilityAnalysis):
    '''AGMAGleasonConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3437.AGMAGleasonConicalGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3437.AGMAGleasonConicalGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3437.AGMAGleasonConicalGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3437.AGMAGleasonConicalGearStabilityAnalysis))
        return value
