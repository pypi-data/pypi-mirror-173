...
class CouplingHalfCompoundStabilityAnalysis(_3640.MountableComponentCompoundStabilityAnalysis):
    '''CouplingHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3469.CouplingHalfStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3469.CouplingHalfStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3469.CouplingHalfStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3469.CouplingHalfStabilityAnalysis))
        return value
