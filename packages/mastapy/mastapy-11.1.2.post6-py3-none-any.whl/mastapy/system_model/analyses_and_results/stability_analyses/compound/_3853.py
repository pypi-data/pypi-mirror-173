...
class SpringDamperConnectionCompoundStabilityAnalysis(_3788.CouplingConnectionCompoundStabilityAnalysis):
    '''SpringDamperConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3721.SpringDamperConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3721.SpringDamperConnectionStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3721.SpringDamperConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3721.SpringDamperConnectionStabilityAnalysis))
        return value
