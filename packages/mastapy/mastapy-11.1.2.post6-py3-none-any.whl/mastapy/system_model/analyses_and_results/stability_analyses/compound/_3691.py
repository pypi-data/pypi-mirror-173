...
class ExternalCADModelCompoundStabilityAnalysis(_3664.ComponentCompoundStabilityAnalysis):
    """ExternalCADModelCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3560.ExternalCADModelStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3560.ExternalCADModelStabilityAnalysis]':
