...
class ConicalGearCompoundStabilityAnalysis(_3697.GearCompoundStabilityAnalysis):
    """ConicalGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3541.ConicalGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3541.ConicalGearStabilityAnalysis]':
