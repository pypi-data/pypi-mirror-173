...
class PartCompoundStabilityAnalysis(_7377.PartCompoundAnalysis):
    '''PartCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3698.PartStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3698.PartStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3698.PartStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3698.PartStabilityAnalysis))
        return value
