...
from mastapy.system_model.analyses_and_results.stability_analyses import _3670
...
class DatumCompoundStabilityAnalysis(_3775.ComponentCompoundStabilityAnalysis):
    '''DatumCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3670.DatumStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3670.DatumStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3670.DatumStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3670.DatumStabilityAnalysis))
        return value
