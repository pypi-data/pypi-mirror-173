...
class TorqueConverterPumpCompoundStabilityAnalysis(_3789.CouplingHalfCompoundStabilityAnalysis):
    '''TorqueConverterPumpCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3739.TorqueConverterPumpStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3739.TorqueConverterPumpStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3739.TorqueConverterPumpStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3739.TorqueConverterPumpStabilityAnalysis))
        return value
