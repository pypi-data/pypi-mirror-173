...
class AGMAGleasonConicalGearMeshCompoundStabilityAnalysis(_3596.ConicalGearMeshCompoundStabilityAnalysis):
    '''AGMAGleasonConicalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3435.AGMAGleasonConicalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3435.AGMAGleasonConicalGearMeshStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3435.AGMAGleasonConicalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3435.AGMAGleasonConicalGearMeshStabilityAnalysis))
        return value
