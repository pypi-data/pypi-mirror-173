...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3783
...
class KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis(_3783.ConicalGearMeshCompoundStabilityAnalysis):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3685.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3685.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3685.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3685.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis))
        return value
