...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import (
    _3647, _3649, _3652, _3659,
    _3658, _3680, _3660, _3665,
    _3670, _3682, _3684, _3688,
    _3695, _3694, _3696, _3703,
    _3710, _3713, _3714, _3715,
    _3717, _3719, _3724, _3725,
    _3726, _3728, _3730, _3735,
    _3734, _3740, _3741, _3746,
    _3749, _3752, _3756, _3760,
    _3764, _3767, _3639
)
...
class AssemblyCompoundStabilityAnalysis(_3639.AbstractAssemblyCompoundStabilityAnalysis):
    """AssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3514.AssemblyStabilityAnalysis]':
    ...
    @property
    def bearings(self) -> 'List[_3647.BearingCompoundStabilityAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_3649.BeltDriveCompoundStabilityAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3652.BevelDifferentialGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3659.BoltedJointCompoundStabilityAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_3658.BoltCompoundStabilityAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_3680.CVTCompoundStabilityAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_3660.ClutchCompoundStabilityAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3665.ConceptCouplingCompoundStabilityAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3670.ConceptGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3682.CycloidalAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3684.CycloidalDiscCompoundStabilityAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3688.CylindricalGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_3695.FEPartCompoundStabilityAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3694.FaceGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3696.FlexiblePinAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3703.HypoidGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3710.KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3713.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_3714.MassDiscCompoundStabilityAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_3715.MeasurementComponentCompoundStabilityAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_3717.OilSealCompoundStabilityAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3719.PartToPartShearCouplingCompoundStabilityAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3724.PlanetCarrierCompoundStabilityAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_3725.PointLoadCompoundStabilityAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_3726.PowerLoadCompoundStabilityAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_3728.RingPinsCompoundStabilityAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3730.RollingRingAssemblyCompoundStabilityAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_3735.ShaftHubConnectionCompoundStabilityAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_3734.ShaftCompoundStabilityAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_3740.SpiralBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_3741.SpringDamperCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_3746.StraightBevelDiffGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_3749.StraightBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_3752.SynchroniserCompoundStabilityAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_3756.TorqueConverterCompoundStabilityAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_3760.UnbalancedMassCompoundStabilityAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_3764.WormGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_3767.ZerolBevelGearSetCompoundStabilityAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3514.AssemblyStabilityAnalysis]':
