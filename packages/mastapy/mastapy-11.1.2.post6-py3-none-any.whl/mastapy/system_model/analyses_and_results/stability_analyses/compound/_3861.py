...
class StraightBevelPlanetGearCompoundStabilityAnalysis(_3855.StraightBevelDiffGearCompoundStabilityAnalysis):
    '''StraightBevelPlanetGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3732.StraightBevelPlanetGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3732.StraightBevelPlanetGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3732.StraightBevelPlanetGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3732.StraightBevelPlanetGearStabilityAnalysis))
        return value
