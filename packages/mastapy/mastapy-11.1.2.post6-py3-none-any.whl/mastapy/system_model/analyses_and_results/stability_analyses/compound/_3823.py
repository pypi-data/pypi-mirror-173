...
from mastapy.system_model.analyses_and_results.stability_analyses import _3691
...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundStabilityAnalysis(_3817.KlingelnbergCycloPalloidConicalGearMeshCompoundStabilityAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3691.KlingelnbergCycloPalloidSpiralBevelGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3691.KlingelnbergCycloPalloidSpiralBevelGearMeshStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3691.KlingelnbergCycloPalloidSpiralBevelGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3691.KlingelnbergCycloPalloidSpiralBevelGearMeshStabilityAnalysis))
        return value
