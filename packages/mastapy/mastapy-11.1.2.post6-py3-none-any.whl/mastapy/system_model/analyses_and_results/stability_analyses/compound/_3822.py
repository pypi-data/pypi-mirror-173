...
from mastapy.system_model.analyses_and_results.stability_analyses import _3693
...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundStabilityAnalysis(_3816.KlingelnbergCycloPalloidConicalGearCompoundStabilityAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3693.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3693.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3693.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3693.KlingelnbergCycloPalloidSpiralBevelGearStabilityAnalysis))
        return value
