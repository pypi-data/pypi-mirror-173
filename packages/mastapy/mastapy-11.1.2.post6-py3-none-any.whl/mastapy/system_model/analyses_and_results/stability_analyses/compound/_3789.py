...
class CouplingHalfCompoundStabilityAnalysis(_3827.MountableComponentCompoundStabilityAnalysis):
    '''CouplingHalfCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3656.CouplingHalfStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3656.CouplingHalfStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3656.CouplingHalfStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3656.CouplingHalfStabilityAnalysis))
        return value
