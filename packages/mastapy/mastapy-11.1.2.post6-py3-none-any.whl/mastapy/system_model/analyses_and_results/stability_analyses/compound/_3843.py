...
class RollingRingConnectionCompoundStabilityAnalysis(_3815.InterMountableComponentConnectionCompoundStabilityAnalysis):
    '''RollingRingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3711.RollingRingConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3711.RollingRingConnectionStabilityAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3711.RollingRingConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3711.RollingRingConnectionStabilityAnalysis))
        return value
