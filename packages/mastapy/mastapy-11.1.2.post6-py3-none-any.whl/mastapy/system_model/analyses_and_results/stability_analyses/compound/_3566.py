...
class AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis(_3598.ConnectionCompoundStabilityAnalysis):
    '''AbstractShaftToMountableComponentConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3434.AbstractShaftToMountableComponentConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3434.AbstractShaftToMountableComponentConnectionStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3434.AbstractShaftToMountableComponentConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3434.AbstractShaftToMountableComponentConnectionStabilityAnalysis))
        return value
