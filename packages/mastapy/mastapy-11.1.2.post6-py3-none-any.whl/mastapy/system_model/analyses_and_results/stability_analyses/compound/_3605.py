...
class CVTPulleyCompoundStabilityAnalysis(_3651.PulleyCompoundStabilityAnalysis):
    '''CVTPulleyCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3473.CVTPulleyStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3473.CVTPulleyStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3473.CVTPulleyStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3473.CVTPulleyStabilityAnalysis))
        return value
