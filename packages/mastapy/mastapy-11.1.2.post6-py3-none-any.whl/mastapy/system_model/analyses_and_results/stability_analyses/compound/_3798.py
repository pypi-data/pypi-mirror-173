...
from mastapy.system_model.analyses_and_results.stability_analyses import _3666
...
class CylindricalGearMeshCompoundStabilityAnalysis(_3809.GearMeshCompoundStabilityAnalysis):
    '''CylindricalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3666.CylindricalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3666.CylindricalGearMeshStabilityAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3666.CylindricalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3666.CylindricalGearMeshStabilityAnalysis))
        return value
