...
class BearingCompoundStabilityAnalysis(_3599.ConnectorCompoundStabilityAnalysis):
    '''BearingCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3439.BearingStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3439.BearingStabilityAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3439.BearingStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3439.BearingStabilityAnalysis))
        return value
