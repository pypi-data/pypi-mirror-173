...
class GearCompoundStabilityAnalysis(_3827.MountableComponentCompoundStabilityAnalysis):
    '''GearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3679.GearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3679.GearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3679.GearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3679.GearStabilityAnalysis))
        return value
