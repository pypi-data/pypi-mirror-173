...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3643
...
class HypoidGearCompoundStabilityAnalysis(_3643.AGMAGleasonConicalGearCompoundStabilityAnalysis):
    """HypoidGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3572.HypoidGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3572.HypoidGearStabilityAnalysis]':
