...
from mastapy.system_model.analyses_and_results.stability_analyses.compound import _3587
...
class CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis(_3587.CoaxialConnectionCompoundStabilityAnalysis):
    '''CycloidalDiscCentralBearingConnectionCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3476.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3476.CycloidalDiscCentralBearingConnectionStabilityAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3476.CycloidalDiscCentralBearingConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3476.CycloidalDiscCentralBearingConnectionStabilityAnalysis))
        return value
