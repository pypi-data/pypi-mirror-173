...
class StraightBevelSunGearCompoundStabilityAnalysis(_3855.StraightBevelDiffGearCompoundStabilityAnalysis):
    '''StraightBevelSunGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3733.StraightBevelSunGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3733.StraightBevelSunGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3733.StraightBevelSunGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3733.StraightBevelSunGearStabilityAnalysis))
        return value
