...
class CVTCompoundStabilityAnalysis(_3573.BeltDriveCompoundStabilityAnalysis):
    '''CVTCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3474.CVTStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3474.CVTStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3474.CVTStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3474.CVTStabilityAnalysis))
        return value
