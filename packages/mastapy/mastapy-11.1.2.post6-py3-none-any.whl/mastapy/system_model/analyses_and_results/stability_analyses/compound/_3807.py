...
from mastapy.system_model.analyses_and_results.stability_analyses import _3676
...
class FlexiblePinAssemblyCompoundStabilityAnalysis(_3848.SpecialisedAssemblyCompoundStabilityAnalysis):
    '''FlexiblePinAssemblyCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3676.FlexiblePinAssemblyStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3676.FlexiblePinAssemblyStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3676.FlexiblePinAssemblyStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3676.FlexiblePinAssemblyStabilityAnalysis))
        return value
