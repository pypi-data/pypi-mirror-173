...
class ConceptGearCompoundStabilityAnalysis(_3697.GearCompoundStabilityAnalysis):
    """ConceptGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3538.ConceptGearStabilityAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3538.ConceptGearStabilityAnalysis]':
