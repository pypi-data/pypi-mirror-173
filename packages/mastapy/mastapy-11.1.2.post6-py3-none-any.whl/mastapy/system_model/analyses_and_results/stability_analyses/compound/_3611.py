...
class CylindricalGearMeshCompoundStabilityAnalysis(_3622.GearMeshCompoundStabilityAnalysis):
    '''CylindricalGearMeshCompoundStabilityAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3479.CylindricalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3479.CylindricalGearMeshStabilityAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3479.CylindricalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3479.CylindricalGearMeshStabilityAnalysis))
        return value
