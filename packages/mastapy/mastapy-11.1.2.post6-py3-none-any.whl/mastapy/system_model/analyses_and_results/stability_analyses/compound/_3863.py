...
class SynchroniserCompoundStabilityAnalysis(_3848.SpecialisedAssemblyCompoundStabilityAnalysis):
    '''SynchroniserCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3737.SynchroniserStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3737.SynchroniserStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3737.SynchroniserStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3737.SynchroniserStabilityAnalysis))
        return value
