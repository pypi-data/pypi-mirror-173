...
from mastapy.system_model.analyses_and_results.stability_analyses import _3720, _3718, _3635
...
class SpiralBevelGearSetStabilityAnalysis(_3635.BevelGearSetStabilityAnalysis):
    '''SpiralBevelGearSetStabilityAnalysis
    ...
    @property
    def spiral_bevel_gears_stability_analysis(self) -> 'List[_3720.SpiralBevelGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsStabilityAnalysis, constructor.new(_3720.SpiralBevelGearStabilityAnalysis))
        return value

    @property
    def spiral_bevel_meshes_stability_analysis(self) -> 'List[_3718.SpiralBevelGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesStabilityAnalysis, constructor.new(_3718.SpiralBevelGearMeshStabilityAnalysis))
        return value
