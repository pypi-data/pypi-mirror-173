...
class StabilityAnalysis(_7240.StaticLoadAnalysisCase):
    ...
    def stability_analysis_options(self) -> '_3578.StabilityAnalysisOptions':
        ...
        return constructor.new(_3578.StabilityAnalysisOptions)(self.wrapped.StabilityAnalysisOptions) if self.wrapped.StabilityAnalysisOptions is not None else None
