...
from mastapy.system_model.analyses_and_results.stability_analyses import _2502
...
class ConnectionStabilityAnalysis(_7372.ConnectionStaticLoadAnalysisCase):
    '''ConnectionStabilityAnalysis
    ...
    @property
    def stability_analysis(self) -> '_2502.StabilityAnalysis':
        ...
        return constructor.new(_2502.StabilityAnalysis)(self.wrapped.StabilityAnalysis) if self.wrapped.StabilityAnalysis is not None else None
