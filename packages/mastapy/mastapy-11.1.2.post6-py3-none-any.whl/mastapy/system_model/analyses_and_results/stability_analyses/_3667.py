...
from mastapy.system_model.analyses_and_results.stability_analyses import _3668, _3666, _3678
...
class CylindricalGearSetStabilityAnalysis(_3678.GearSetStabilityAnalysis):
    '''CylindricalGearSetStabilityAnalysis
    ...
    @property
    def cylindrical_gears_stability_analysis(self) -> 'List[_3668.CylindricalGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsStabilityAnalysis, constructor.new(_3668.CylindricalGearStabilityAnalysis))
        return value

    @property
    def cylindrical_meshes_stability_analysis(self) -> 'List[_3666.CylindricalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesStabilityAnalysis, constructor.new(_3666.CylindricalGearMeshStabilityAnalysis))
        return value
