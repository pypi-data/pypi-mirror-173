...
from mastapy.system_model.analyses_and_results.stability_analyses import _3481, _3479, _3491
...
class CylindricalGearSetStabilityAnalysis(_3491.GearSetStabilityAnalysis):
    '''CylindricalGearSetStabilityAnalysis
    ...
    @property
    def cylindrical_gears_stability_analysis(self) -> 'List[_3481.CylindricalGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsStabilityAnalysis, constructor.new(_3481.CylindricalGearStabilityAnalysis))
        return value

    @property
    def cylindrical_meshes_stability_analysis(self) -> 'List[_3479.CylindricalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesStabilityAnalysis, constructor.new(_3479.CylindricalGearMeshStabilityAnalysis))
        return value
