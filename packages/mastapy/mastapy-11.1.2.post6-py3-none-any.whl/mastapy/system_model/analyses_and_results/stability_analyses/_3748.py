...
from mastapy.system_model.analyses_and_results.stability_analyses import _3749, _3747, _3635
...
class ZerolBevelGearSetStabilityAnalysis(_3635.BevelGearSetStabilityAnalysis):
    '''ZerolBevelGearSetStabilityAnalysis
    ...
    @property
    def zerol_bevel_gears_stability_analysis(self) -> 'List[_3749.ZerolBevelGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsStabilityAnalysis, constructor.new(_3749.ZerolBevelGearStabilityAnalysis))
        return value

    @property
    def zerol_bevel_meshes_stability_analysis(self) -> 'List[_3747.ZerolBevelGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesStabilityAnalysis, constructor.new(_3747.ZerolBevelGearMeshStabilityAnalysis))
        return value
