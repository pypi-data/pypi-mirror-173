...
class StabilityAnalysis(_7195.StaticLoadAnalysisCase):
    '''StabilityAnalysis
    ...
    @property
    def stability_analysis_options(self) -> '_3538.StabilityAnalysisOptions':
        ...
        return constructor.new(_3538.StabilityAnalysisOptions)(self.wrapped.StabilityAnalysisOptions) if self.wrapped.StabilityAnalysisOptions else None
