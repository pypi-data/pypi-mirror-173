...
class StabilityAnalysis(_7198.StaticLoadAnalysisCase):
    '''StabilityAnalysis
    ...
    @property
    def stability_analysis_options(self) -> '_3537.StabilityAnalysisOptions':
        ...
        return constructor.new(_3537.StabilityAnalysisOptions)(self.wrapped.StabilityAnalysisOptions) if self.wrapped.StabilityAnalysisOptions else None
