...
class StabilityAnalysis(_7234.StaticLoadAnalysisCase):
    '''StabilityAnalysis
    ...
    @property
    def stability_analysis_options(self) -> '_3572.StabilityAnalysisOptions':
        ...
        return constructor.new(_3572.StabilityAnalysisOptions)(self.wrapped.StabilityAnalysisOptions) if self.wrapped.StabilityAnalysisOptions else None
