...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4736, _4735, _4742
...
class FaceGearSetModalAnalysisAtASpeed(_4742.GearSetModalAnalysisAtASpeed):
    '''FaceGearSetModalAnalysisAtASpeed
    ...
    @property
    def face_gears_modal_analysis_at_a_speed(self) -> 'List[_4736.FaceGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysisAtASpeed, constructor.new(_4736.FaceGearModalAnalysisAtASpeed))
        return value

    @property
    def face_meshes_modal_analysis_at_a_speed(self) -> 'List[_4735.FaceGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysisAtASpeed, constructor.new(_4735.FaceGearMeshModalAnalysisAtASpeed))
        return value
