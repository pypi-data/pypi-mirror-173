...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _2312, _4502
...
class RootAssemblyModalAnalysisAtASpeed(_4502.AssemblyModalAnalysisAtASpeed):
    '''RootAssemblyModalAnalysisAtASpeed
    ...
    @property
    def modal_analysis_at_a_speed_inputs(self) -> '_2312.ModalAnalysisAtASpeed':
        ...
        return constructor.new(_2312.ModalAnalysisAtASpeed)(self.wrapped.ModalAnalysisAtASpeedInputs) if self.wrapped.ModalAnalysisAtASpeedInputs else None
