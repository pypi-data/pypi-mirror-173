...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4788, _4787, _4700
...
class StraightBevelDiffGearSetModalAnalysisAtASpeed(_4700.BevelGearSetModalAnalysisAtASpeed):
    '''StraightBevelDiffGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis_at_a_speed(self) -> 'List[_4788.StraightBevelDiffGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysisAtASpeed, constructor.new(_4788.StraightBevelDiffGearModalAnalysisAtASpeed))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analysis_at_a_speed(self) -> 'List[_4787.StraightBevelDiffGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysisAtASpeed, constructor.new(_4787.StraightBevelDiffGearMeshModalAnalysisAtASpeed))
        return value
