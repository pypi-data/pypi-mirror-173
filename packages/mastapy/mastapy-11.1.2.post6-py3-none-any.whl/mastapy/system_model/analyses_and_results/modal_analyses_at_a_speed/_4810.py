...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4809, _4808, _4700
...
class ZerolBevelGearSetModalAnalysisAtASpeed(_4700.BevelGearSetModalAnalysisAtASpeed):
    '''ZerolBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def zerol_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_4809.ZerolBevelGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysisAtASpeed, constructor.new(_4809.ZerolBevelGearModalAnalysisAtASpeed))
        return value

    @property
    def zerol_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_4808.ZerolBevelGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysisAtASpeed, constructor.new(_4808.ZerolBevelGearMeshModalAnalysisAtASpeed))
        return value
