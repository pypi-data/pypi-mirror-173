...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4962, _4961, _4871
...
class StraightBevelGearSetModalAnalysisAtASpeed(_4871.BevelGearSetModalAnalysisAtASpeed):
    """StraightBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_4962.StraightBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def straight_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_4961.StraightBevelGearMeshModalAnalysisAtASpeed]':
