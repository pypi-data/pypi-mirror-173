...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4865, _4864, _4871
...
class BevelDifferentialGearSetModalAnalysisAtASpeed(_4871.BevelGearSetModalAnalysisAtASpeed):
    """BevelDifferentialGearSetModalAnalysisAtASpeed
    ...
    @property
    def bevel_differential_gears_modal_analysis_at_a_speed(self) -> 'List[_4865.BevelDifferentialGearModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_modal_analysis_at_a_speed(self) -> 'List[_4864.BevelDifferentialGearMeshModalAnalysisAtASpeed]':
