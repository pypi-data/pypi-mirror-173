...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4894
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4992
...
class CVTCompoundModalAnalysisAtASpeed(_4992.BeltDriveCompoundModalAnalysisAtASpeed):
    """CVTCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4894.CVTModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4894.CVTModalAnalysisAtASpeed]':
