...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4760
...
class OilSealCompoundModalAnalysisAtASpeed(_4847.ConnectorCompoundModalAnalysisAtASpeed):
    '''OilSealCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4760.OilSealModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4760.OilSealModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4760.OilSealModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4760.OilSealModalAnalysisAtASpeed))
        return value
