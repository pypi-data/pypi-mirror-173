...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4913
...
class GearSetCompoundModalAnalysisAtASpeed(_5080.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """GearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4913.GearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4913.GearSetModalAnalysisAtASpeed]':
