...
class BevelGearSetCompoundModalAnalysisAtASpeed(_4670.AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed):
    '''BevelGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4553.BevelGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4553.BevelGearSetModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4553.BevelGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4553.BevelGearSetModalAnalysisAtASpeed))
        return value
