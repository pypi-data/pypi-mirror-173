...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4936
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5079
...
class PlanetaryConnectionCompoundModalAnalysisAtASpeed(_5079.ShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """PlanetaryConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4936.PlanetaryConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4936.PlanetaryConnectionModalAnalysisAtASpeed]':
