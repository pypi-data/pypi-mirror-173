...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4980
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4998
...
class ZerolBevelGearCompoundModalAnalysisAtASpeed(_4998.BevelGearCompoundModalAnalysisAtASpeed):
    """ZerolBevelGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4980.ZerolBevelGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4980.ZerolBevelGearModalAnalysisAtASpeed]':
