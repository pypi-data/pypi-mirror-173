...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4801
...
class TorqueConverterPumpCompoundModalAnalysisAtASpeed(_4850.CouplingHalfCompoundModalAnalysisAtASpeed):
    '''TorqueConverterPumpCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4801.TorqueConverterPumpModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4801.TorqueConverterPumpModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4801.TorqueConverterPumpModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4801.TorqueConverterPumpModalAnalysisAtASpeed))
        return value
