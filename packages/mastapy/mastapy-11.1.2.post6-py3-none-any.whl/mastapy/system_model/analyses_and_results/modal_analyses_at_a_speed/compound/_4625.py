...
class AbstractShaftCompoundModalAnalysisAtASpeed(_4626.AbstractShaftOrHousingCompoundModalAnalysisAtASpeed):
    '''AbstractShaftCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4496.AbstractShaftModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4496.AbstractShaftModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4496.AbstractShaftModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4496.AbstractShaftModalAnalysisAtASpeed))
        return value
