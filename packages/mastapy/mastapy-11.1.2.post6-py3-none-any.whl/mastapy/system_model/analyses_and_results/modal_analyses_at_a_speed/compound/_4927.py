...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4798
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4926
...
class SynchroniserSleeveCompoundModalAnalysisAtASpeed(_4926.SynchroniserPartCompoundModalAnalysisAtASpeed):
    '''SynchroniserSleeveCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4798.SynchroniserSleeveModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4798.SynchroniserSleeveModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4798.SynchroniserSleeveModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4798.SynchroniserSleeveModalAnalysisAtASpeed))
        return value
