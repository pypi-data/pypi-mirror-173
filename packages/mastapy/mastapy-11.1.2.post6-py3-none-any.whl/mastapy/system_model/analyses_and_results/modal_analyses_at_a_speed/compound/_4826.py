...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4697
...
class BevelDifferentialSunGearCompoundModalAnalysisAtASpeed(_4822.BevelDifferentialGearCompoundModalAnalysisAtASpeed):
    '''BevelDifferentialSunGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4697.BevelDifferentialSunGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4697.BevelDifferentialSunGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4697.BevelDifferentialSunGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4697.BevelDifferentialSunGearModalAnalysisAtASpeed))
        return value
