...
class CVTPulleyCompoundModalAnalysisAtASpeed(_4752.PulleyCompoundModalAnalysisAtASpeed):
    '''CVTPulleyCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4577.CVTPulleyModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4577.CVTPulleyModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4577.CVTPulleyModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4577.CVTPulleyModalAnalysisAtASpeed))
        return value
