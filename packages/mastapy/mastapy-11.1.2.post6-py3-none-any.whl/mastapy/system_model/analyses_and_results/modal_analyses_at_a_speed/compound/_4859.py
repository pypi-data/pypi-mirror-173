...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4729
...
class CylindricalGearMeshCompoundModalAnalysisAtASpeed(_4870.GearMeshCompoundModalAnalysisAtASpeed):
    '''CylindricalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4729.CylindricalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4729.CylindricalGearMeshModalAnalysisAtASpeed))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4729.CylindricalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4729.CylindricalGearMeshModalAnalysisAtASpeed))
        return value
