...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4730
...
class CylindricalGearCompoundModalAnalysisAtASpeed(_4869.GearCompoundModalAnalysisAtASpeed):
    '''CylindricalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4730.CylindricalGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4730.CylindricalGearModalAnalysisAtASpeed))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4730.CylindricalGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4730.CylindricalGearModalAnalysisAtASpeed))
        return value
