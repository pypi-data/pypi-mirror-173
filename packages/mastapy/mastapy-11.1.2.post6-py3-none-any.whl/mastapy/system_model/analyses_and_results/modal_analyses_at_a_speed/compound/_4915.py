...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4785
...
class SpringDamperHalfCompoundModalAnalysisAtASpeed(_4850.CouplingHalfCompoundModalAnalysisAtASpeed):
    '''SpringDamperHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4785.SpringDamperHalfModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4785.SpringDamperHalfModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4785.SpringDamperHalfModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4785.SpringDamperHalfModalAnalysisAtASpeed))
        return value
