...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4944
...
class RollingRingAssemblyCompoundModalAnalysisAtASpeed(_5080.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """RollingRingAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4944.RollingRingAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4944.RollingRingAssemblyModalAnalysisAtASpeed]':
