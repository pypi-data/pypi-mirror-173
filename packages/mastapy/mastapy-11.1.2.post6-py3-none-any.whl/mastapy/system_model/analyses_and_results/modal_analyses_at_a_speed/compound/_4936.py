...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4934, _4935, _4871
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4807
...
class WormGearSetCompoundModalAnalysisAtASpeed(_4871.GearSetCompoundModalAnalysisAtASpeed):
    '''WormGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def worm_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_4934.WormGearCompoundModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCompoundModalAnalysisAtASpeed, constructor.new(_4934.WormGearCompoundModalAnalysisAtASpeed))
        return value

    @property
    def worm_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_4935.WormGearMeshCompoundModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCompoundModalAnalysisAtASpeed, constructor.new(_4935.WormGearMeshCompoundModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4807.WormGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4807.WormGearSetModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4807.WormGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4807.WormGearSetModalAnalysisAtASpeed))
        return value
