...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4802
...
class TorqueConverterTurbineCompoundModalAnalysisAtASpeed(_4850.CouplingHalfCompoundModalAnalysisAtASpeed):
    '''TorqueConverterTurbineCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4802.TorqueConverterTurbineModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4802.TorqueConverterTurbineModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4802.TorqueConverterTurbineModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4802.TorqueConverterTurbineModalAnalysisAtASpeed))
        return value
