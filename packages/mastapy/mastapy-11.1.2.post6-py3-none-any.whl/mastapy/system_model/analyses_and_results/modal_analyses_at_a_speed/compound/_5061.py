...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4932
...
class PartCompoundModalAnalysisAtASpeed(_7272.PartCompoundAnalysis):
    """PartCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4932.PartModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4932.PartModalAnalysisAtASpeed]':
