...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed(_4693.ConnectionCompoundModalAnalysisAtASpeed):
    '''AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4532.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4532.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4532.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4532.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed))
        return value
