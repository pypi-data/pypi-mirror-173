...
class KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtASpeed(_4698.ConicalGearSetCompoundModalAnalysisAtASpeed):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4603.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4603.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4603.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4603.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtASpeed))
        return value
