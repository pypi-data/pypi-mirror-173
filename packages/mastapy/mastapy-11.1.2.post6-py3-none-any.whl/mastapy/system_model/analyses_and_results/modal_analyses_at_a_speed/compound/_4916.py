...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4788
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4827
...
class StraightBevelDiffGearCompoundModalAnalysisAtASpeed(_4827.BevelGearCompoundModalAnalysisAtASpeed):
    '''StraightBevelDiffGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4788.StraightBevelDiffGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4788.StraightBevelDiffGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4788.StraightBevelDiffGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4788.StraightBevelDiffGearModalAnalysisAtASpeed))
        return value
