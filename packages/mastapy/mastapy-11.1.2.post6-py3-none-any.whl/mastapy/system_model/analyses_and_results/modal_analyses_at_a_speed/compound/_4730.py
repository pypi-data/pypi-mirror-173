...
class KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtASpeed(_4696.ConicalGearCompoundModalAnalysisAtASpeed):
    '''KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4602.KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4602.KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4602.KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4602.KlingelnbergCycloPalloidConicalGearModalAnalysisAtASpeed))
        return value
