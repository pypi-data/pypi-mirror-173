...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4795
...
class SynchroniserHalfCompoundModalAnalysisAtASpeed(_4926.SynchroniserPartCompoundModalAnalysisAtASpeed):
    '''SynchroniserHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4795.SynchroniserHalfModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4795.SynchroniserHalfModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4795.SynchroniserHalfModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4795.SynchroniserHalfModalAnalysisAtASpeed))
        return value
