...
class CylindricalPlanetGearCompoundModalAnalysisAtASpeed(_4711.CylindricalGearCompoundModalAnalysisAtASpeed):
    '''CylindricalPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4585.CylindricalPlanetGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4585.CylindricalPlanetGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4585.CylindricalPlanetGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4585.CylindricalPlanetGearModalAnalysisAtASpeed))
        return value
