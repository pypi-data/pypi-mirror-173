...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4908
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5035, _5036, _5042
...
class FaceGearSetCompoundModalAnalysisAtASpeed(_5042.GearSetCompoundModalAnalysisAtASpeed):
    """FaceGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4908.FaceGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def face_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5035.FaceGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def face_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5036.FaceGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4908.FaceGearSetModalAnalysisAtASpeed]':
