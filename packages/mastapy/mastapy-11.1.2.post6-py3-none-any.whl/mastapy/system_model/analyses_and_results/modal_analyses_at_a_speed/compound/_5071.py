...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4942
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5059
...
class RingPinsCompoundModalAnalysisAtASpeed(_5059.MountableComponentCompoundModalAnalysisAtASpeed):
    """RingPinsCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4942.RingPinsModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4942.RingPinsModalAnalysisAtASpeed]':
