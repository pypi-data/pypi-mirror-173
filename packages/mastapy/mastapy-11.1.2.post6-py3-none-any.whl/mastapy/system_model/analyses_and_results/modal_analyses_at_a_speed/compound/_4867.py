...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4738
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4813
...
class FEPartCompoundModalAnalysisAtASpeed(_4813.AbstractShaftOrHousingCompoundModalAnalysisAtASpeed):
    '''FEPartCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4738.FEPartModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4738.FEPartModalAnalysisAtASpeed))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4738.FEPartModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4738.FEPartModalAnalysisAtASpeed))
        return value
