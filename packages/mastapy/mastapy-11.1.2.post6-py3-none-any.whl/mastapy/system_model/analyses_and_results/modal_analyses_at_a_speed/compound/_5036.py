...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4906
...
class FaceGearMeshCompoundModalAnalysisAtASpeed(_5041.GearMeshCompoundModalAnalysisAtASpeed):
    """FaceGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4906.FaceGearMeshModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4906.FaceGearMeshModalAnalysisAtASpeed]':
