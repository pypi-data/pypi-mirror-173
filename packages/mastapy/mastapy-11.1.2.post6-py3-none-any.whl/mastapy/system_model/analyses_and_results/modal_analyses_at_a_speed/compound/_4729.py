...
class InterMountableComponentConnectionCompoundModalAnalysisAtASpeed(_4699.ConnectionCompoundModalAnalysisAtASpeed):
    '''InterMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4600.InterMountableComponentConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4600.InterMountableComponentConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4600.InterMountableComponentConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4600.InterMountableComponentConnectionModalAnalysisAtASpeed))
        return value
