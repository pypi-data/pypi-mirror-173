...
class BoltCompoundModalAnalysisAtASpeed(_4649.ComponentCompoundModalAnalysisAtASpeed):
    '''BoltCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4515.BoltModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4515.BoltModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4515.BoltModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4515.BoltModalAnalysisAtASpeed))
        return value
