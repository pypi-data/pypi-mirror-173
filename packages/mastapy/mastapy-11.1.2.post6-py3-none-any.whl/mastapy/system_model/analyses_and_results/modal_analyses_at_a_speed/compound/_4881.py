...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4751
...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed(_4878.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4751.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4751.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4751.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4751.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed))
        return value
