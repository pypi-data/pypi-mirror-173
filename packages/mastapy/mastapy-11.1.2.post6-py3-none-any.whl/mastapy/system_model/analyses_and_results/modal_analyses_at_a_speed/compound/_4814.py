...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4846
...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed(_4846.ConnectionCompoundModalAnalysisAtASpeed):
    '''AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4685.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4685.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4685.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4685.AbstractShaftToMountableComponentConnectionModalAnalysisAtASpeed))
        return value
