...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4887
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5042
...
class ConicalGearSetCompoundModalAnalysisAtASpeed(_5042.GearSetCompoundModalAnalysisAtASpeed):
    """ConicalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4887.ConicalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4887.ConicalGearSetModalAnalysisAtASpeed]':
