...
class KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed(_4697.ConicalGearMeshCompoundModalAnalysisAtASpeed):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4601.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4601.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4601.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4601.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed))
        return value
