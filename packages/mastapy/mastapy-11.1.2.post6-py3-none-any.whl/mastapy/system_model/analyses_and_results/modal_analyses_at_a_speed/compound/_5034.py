...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4905
...
class ExternalCADModelCompoundModalAnalysisAtASpeed(_5007.ComponentCompoundModalAnalysisAtASpeed):
    """ExternalCADModelCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4905.ExternalCADModelModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4905.ExternalCADModelModalAnalysisAtASpeed]':
