...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4787
...
class StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed(_4828.BevelGearMeshCompoundModalAnalysisAtASpeed):
    '''StraightBevelDiffGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4787.StraightBevelDiffGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4787.StraightBevelDiffGearMeshModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4787.StraightBevelDiffGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4787.StraightBevelDiffGearMeshModalAnalysisAtASpeed))
        return value
