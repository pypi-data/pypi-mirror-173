...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4803
...
class UnbalancedMassCompoundModalAnalysisAtASpeed(_4933.VirtualComponentCompoundModalAnalysisAtASpeed):
    '''UnbalancedMassCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4803.UnbalancedMassModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4803.UnbalancedMassModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4803.UnbalancedMassModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4803.UnbalancedMassModalAnalysisAtASpeed))
        return value
