...
class VirtualComponentCompoundModalAnalysisAtASpeed(_4888.MountableComponentCompoundModalAnalysisAtASpeed):
    '''VirtualComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4804.VirtualComponentModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4804.VirtualComponentModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4804.VirtualComponentModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4804.VirtualComponentModalAnalysisAtASpeed))
        return value
