...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4767
...
class PlanetCarrierCompoundModalAnalysisAtASpeed(_4888.MountableComponentCompoundModalAnalysisAtASpeed):
    '''PlanetCarrierCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4767.PlanetCarrierModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4767.PlanetCarrierModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4767.PlanetCarrierModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4767.PlanetCarrierModalAnalysisAtASpeed))
        return value
