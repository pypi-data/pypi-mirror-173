...
class CouplingConnectionCompoundModalAnalysisAtASpeed(_4729.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    '''CouplingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4572.CouplingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4572.CouplingConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4572.CouplingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4572.CouplingConnectionModalAnalysisAtASpeed))
        return value
