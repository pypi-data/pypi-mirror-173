...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4759
...
class MountableComponentCompoundModalAnalysisAtASpeed(_4836.ComponentCompoundModalAnalysisAtASpeed):
    '''MountableComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4759.MountableComponentModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4759.MountableComponentModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4759.MountableComponentModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4759.MountableComponentModalAnalysisAtASpeed))
        return value
