...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtASpeed(_4688.CoaxialConnectionCompoundModalAnalysisAtASpeed):
    '''CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4579.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4579.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4579.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4579.CycloidalDiscCentralBearingConnectionModalAnalysisAtASpeed))
        return value
