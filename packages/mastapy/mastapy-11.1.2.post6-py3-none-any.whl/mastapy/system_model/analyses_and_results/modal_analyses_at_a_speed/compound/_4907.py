...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4777
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4847
...
class ShaftHubConnectionCompoundModalAnalysisAtASpeed(_4847.ConnectorCompoundModalAnalysisAtASpeed):
    '''ShaftHubConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4777.ShaftHubConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4777.ShaftHubConnectionModalAnalysisAtASpeed))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4777.ShaftHubConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4777.ShaftHubConnectionModalAnalysisAtASpeed))
        return value
