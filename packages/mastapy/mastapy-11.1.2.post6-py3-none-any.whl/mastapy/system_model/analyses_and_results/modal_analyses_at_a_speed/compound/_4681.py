...
class BevelGearMeshCompoundModalAnalysisAtASpeed(_4669.AGMAGleasonConicalGearMeshCompoundModalAnalysisAtASpeed):
    '''BevelGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4551.BevelGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4551.BevelGearMeshModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4551.BevelGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4551.BevelGearMeshModalAnalysisAtASpeed))
        return value
