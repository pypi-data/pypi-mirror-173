...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4704
...
class ClutchHalfCompoundModalAnalysisAtASpeed(_4850.CouplingHalfCompoundModalAnalysisAtASpeed):
    '''ClutchHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4704.ClutchHalfModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4704.ClutchHalfModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4704.ClutchHalfModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4704.ClutchHalfModalAnalysisAtASpeed))
        return value
