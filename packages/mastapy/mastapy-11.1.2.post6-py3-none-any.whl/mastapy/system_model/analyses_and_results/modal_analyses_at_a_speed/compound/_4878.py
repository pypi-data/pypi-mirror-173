...
class KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed(_4844.ConicalGearMeshCompoundModalAnalysisAtASpeed):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4748.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4748.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4748.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4748.KlingelnbergCycloPalloidConicalGearMeshModalAnalysisAtASpeed))
        return value
