...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4752
...
class KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysisAtASpeed(_4877.KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtASpeed):
    '''KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4752.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4752.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4752.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4752.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed))
        return value
