...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5029, _5030, _5042
...
class CylindricalGearSetCompoundModalAnalysisAtASpeed(_5042.GearSetCompoundModalAnalysisAtASpeed):
    """CylindricalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4902.CylindricalGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_5029.CylindricalGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_5030.CylindricalGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4902.CylindricalGearSetModalAnalysisAtASpeed]':
