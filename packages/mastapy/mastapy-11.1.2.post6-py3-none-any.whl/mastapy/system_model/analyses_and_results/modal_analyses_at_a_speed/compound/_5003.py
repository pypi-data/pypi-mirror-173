...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4876
...
class ClutchCompoundModalAnalysisAtASpeed(_5019.CouplingCompoundModalAnalysisAtASpeed):
    """ClutchCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4876.ClutchModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4876.ClutchModalAnalysisAtASpeed]':
