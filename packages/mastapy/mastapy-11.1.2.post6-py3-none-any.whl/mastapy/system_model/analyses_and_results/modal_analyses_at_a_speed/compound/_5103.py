...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4974
...
class UnbalancedMassCompoundModalAnalysisAtASpeed(_5104.VirtualComponentCompoundModalAnalysisAtASpeed):
    """UnbalancedMassCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4974.UnbalancedMassModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4974.UnbalancedMassModalAnalysisAtASpeed]':
