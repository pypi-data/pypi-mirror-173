...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4840, _4841, _4871
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4713
...
class ConceptGearSetCompoundModalAnalysisAtASpeed(_4871.GearSetCompoundModalAnalysisAtASpeed):
    '''ConceptGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def concept_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_4840.ConceptGearCompoundModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundModalAnalysisAtASpeed, constructor.new(_4840.ConceptGearCompoundModalAnalysisAtASpeed))
        return value

    @property
    def concept_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_4841.ConceptGearMeshCompoundModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundModalAnalysisAtASpeed, constructor.new(_4841.ConceptGearMeshCompoundModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4713.ConceptGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4713.ConceptGearSetModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4713.ConceptGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4713.ConceptGearSetModalAnalysisAtASpeed))
        return value
