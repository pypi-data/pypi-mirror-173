...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4694
...
class BevelDifferentialGearCompoundModalAnalysisAtASpeed(_4827.BevelGearCompoundModalAnalysisAtASpeed):
    '''BevelDifferentialGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4694.BevelDifferentialGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4694.BevelDifferentialGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4694.BevelDifferentialGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4694.BevelDifferentialGearModalAnalysisAtASpeed))
        return value
