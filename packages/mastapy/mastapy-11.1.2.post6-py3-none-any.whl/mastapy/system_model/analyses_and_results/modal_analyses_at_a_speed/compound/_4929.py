...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4799
...
class TorqueConverterConnectionCompoundModalAnalysisAtASpeed(_4849.CouplingConnectionCompoundModalAnalysisAtASpeed):
    '''TorqueConverterConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4799.TorqueConverterConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4799.TorqueConverterConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4799.TorqueConverterConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4799.TorqueConverterConnectionModalAnalysisAtASpeed))
        return value
