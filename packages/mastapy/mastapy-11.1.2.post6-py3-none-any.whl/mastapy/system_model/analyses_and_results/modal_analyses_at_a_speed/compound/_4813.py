...
class AbstractShaftOrHousingCompoundModalAnalysisAtASpeed(_4836.ComponentCompoundModalAnalysisAtASpeed):
    '''AbstractShaftOrHousingCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4684.AbstractShaftOrHousingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4684.AbstractShaftOrHousingModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4684.AbstractShaftOrHousingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4684.AbstractShaftOrHousingModalAnalysisAtASpeed))
        return value
