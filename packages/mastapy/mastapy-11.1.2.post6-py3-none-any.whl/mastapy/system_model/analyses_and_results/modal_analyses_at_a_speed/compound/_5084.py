...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4957
...
class SpringDamperCompoundModalAnalysisAtASpeed(_5019.CouplingCompoundModalAnalysisAtASpeed):
    """SpringDamperCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4957.SpringDamperModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4957.SpringDamperModalAnalysisAtASpeed]':
