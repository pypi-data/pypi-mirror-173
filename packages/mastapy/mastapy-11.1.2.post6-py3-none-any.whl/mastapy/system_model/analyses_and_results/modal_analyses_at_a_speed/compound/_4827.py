...
class BevelGearCompoundModalAnalysisAtASpeed(_4815.AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed):
    '''BevelGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4699.BevelGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4699.BevelGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4699.BevelGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4699.BevelGearModalAnalysisAtASpeed))
        return value
