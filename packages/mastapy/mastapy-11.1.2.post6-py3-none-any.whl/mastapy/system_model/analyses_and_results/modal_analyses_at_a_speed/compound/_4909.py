...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4811
...
class SpecialisedAssemblyCompoundModalAnalysisAtASpeed(_4811.AbstractAssemblyCompoundModalAnalysisAtASpeed):
    '''SpecialisedAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4780.SpecialisedAssemblyModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4780.SpecialisedAssemblyModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4780.SpecialisedAssemblyModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4780.SpecialisedAssemblyModalAnalysisAtASpeed))
        return value
