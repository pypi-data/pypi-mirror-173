...
class AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed(_4656.ConicalGearCompoundModalAnalysisAtASpeed):
    '''AGMAGleasonConicalGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4500.AGMAGleasonConicalGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4500.AGMAGleasonConicalGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4500.AGMAGleasonConicalGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4500.AGMAGleasonConicalGearModalAnalysisAtASpeed))
        return value
