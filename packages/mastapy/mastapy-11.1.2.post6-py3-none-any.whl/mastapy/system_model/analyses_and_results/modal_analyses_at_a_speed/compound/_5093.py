...
class StraightBevelPlanetGearCompoundModalAnalysisAtASpeed(_5087.StraightBevelDiffGearCompoundModalAnalysisAtASpeed):
    """StraightBevelPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4964.StraightBevelPlanetGearModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4964.StraightBevelPlanetGearModalAnalysisAtASpeed]':
