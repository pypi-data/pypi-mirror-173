...
class CVTBeltConnectionCompoundModalAnalysisAtASpeed(_4673.BeltConnectionCompoundModalAnalysisAtASpeed):
    '''CVTBeltConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4575.CVTBeltConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4575.CVTBeltConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4575.CVTBeltConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4575.CVTBeltConnectionModalAnalysisAtASpeed))
        return value
