...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4757
...
class MassDiscCompoundModalAnalysisAtASpeed(_4933.VirtualComponentCompoundModalAnalysisAtASpeed):
    '''MassDiscCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4757.MassDiscModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4757.MassDiscModalAnalysisAtASpeed))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4757.MassDiscModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4757.MassDiscModalAnalysisAtASpeed))
        return value
