...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4772
...
class RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed(_4876.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    '''RingPinsToDiscConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4772.RingPinsToDiscConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4772.RingPinsToDiscConnectionModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4772.RingPinsToDiscConnectionModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4772.RingPinsToDiscConnectionModalAnalysisAtASpeed))
        return value
