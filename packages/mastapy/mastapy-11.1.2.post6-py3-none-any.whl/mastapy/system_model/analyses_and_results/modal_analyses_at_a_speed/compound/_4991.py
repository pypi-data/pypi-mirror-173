...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4862
...
class BeltConnectionCompoundModalAnalysisAtASpeed(_5047.InterMountableComponentConnectionCompoundModalAnalysisAtASpeed):
    """BeltConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4862.BeltConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4862.BeltConnectionModalAnalysisAtASpeed]':
