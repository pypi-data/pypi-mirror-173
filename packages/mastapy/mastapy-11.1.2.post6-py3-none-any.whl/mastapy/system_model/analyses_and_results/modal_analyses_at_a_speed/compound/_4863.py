...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4734
...
class ExternalCADModelCompoundModalAnalysisAtASpeed(_4836.ComponentCompoundModalAnalysisAtASpeed):
    '''ExternalCADModelCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4734.ExternalCADModelModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4734.ExternalCADModelModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4734.ExternalCADModelModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4734.ExternalCADModelModalAnalysisAtASpeed))
        return value
