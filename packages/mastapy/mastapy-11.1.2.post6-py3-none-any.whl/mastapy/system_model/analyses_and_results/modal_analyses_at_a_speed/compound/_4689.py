...
class ComponentCompoundModalAnalysisAtASpeed(_4743.PartCompoundModalAnalysisAtASpeed):
    '''ComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4560.ComponentModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4560.ComponentModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4560.ComponentModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4560.ComponentModalAnalysisAtASpeed))
        return value
