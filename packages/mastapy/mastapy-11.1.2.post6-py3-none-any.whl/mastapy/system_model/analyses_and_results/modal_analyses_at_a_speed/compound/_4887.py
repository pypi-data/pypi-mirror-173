...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4758
...
class MeasurementComponentCompoundModalAnalysisAtASpeed(_4933.VirtualComponentCompoundModalAnalysisAtASpeed):
    '''MeasurementComponentCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4758.MeasurementComponentModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4758.MeasurementComponentModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4758.MeasurementComponentModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4758.MeasurementComponentModalAnalysisAtASpeed))
        return value
