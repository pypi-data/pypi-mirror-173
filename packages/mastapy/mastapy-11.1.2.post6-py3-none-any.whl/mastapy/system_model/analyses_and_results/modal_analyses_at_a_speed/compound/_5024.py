...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4895
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5070
...
class CVTPulleyCompoundModalAnalysisAtASpeed(_5070.PulleyCompoundModalAnalysisAtASpeed):
    """CVTPulleyCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4895.CVTPulleyModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4895.CVTPulleyModalAnalysisAtASpeed]':
