...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4972
...
class TorqueConverterPumpCompoundModalAnalysisAtASpeed(_5021.CouplingHalfCompoundModalAnalysisAtASpeed):
    """TorqueConverterPumpCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4972.TorqueConverterPumpModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4972.TorqueConverterPumpModalAnalysisAtASpeed]':
