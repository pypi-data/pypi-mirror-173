...
class AGMAGleasonConicalGearMeshCompoundModalAnalysisAtASpeed(_4691.ConicalGearMeshCompoundModalAnalysisAtASpeed):
    '''AGMAGleasonConicalGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4533.AGMAGleasonConicalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4533.AGMAGleasonConicalGearMeshModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4533.AGMAGleasonConicalGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4533.AGMAGleasonConicalGearMeshModalAnalysisAtASpeed))
        return value
