...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4649
...
class AbstractShaftOrHousingCompoundModalAnalysisAtASpeed(_4649.ComponentCompoundModalAnalysisAtASpeed):
    '''AbstractShaftOrHousingCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4497.AbstractShaftOrHousingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4497.AbstractShaftOrHousingModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4497.AbstractShaftOrHousingModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4497.AbstractShaftOrHousingModalAnalysisAtASpeed))
        return value
