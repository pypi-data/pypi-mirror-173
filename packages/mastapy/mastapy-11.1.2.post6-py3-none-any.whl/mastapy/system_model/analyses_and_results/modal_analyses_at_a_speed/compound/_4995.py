...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4866
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4993, _4994, _5000
...
class BevelDifferentialGearSetCompoundModalAnalysisAtASpeed(_5000.BevelGearSetCompoundModalAnalysisAtASpeed):
    """BevelDifferentialGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4866.BevelDifferentialGearSetModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis_at_a_speed(self) -> 'List[_4993.BevelDifferentialGearCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis_at_a_speed(self) -> 'List[_4994.BevelDifferentialGearMeshCompoundModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4866.BevelDifferentialGearSetModalAnalysisAtASpeed]':
