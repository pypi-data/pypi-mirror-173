...
class AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed(_4698.ConicalGearSetCompoundModalAnalysisAtASpeed):
    '''AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4541.AGMAGleasonConicalGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4541.AGMAGleasonConicalGearSetModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4541.AGMAGleasonConicalGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4541.AGMAGleasonConicalGearSetModalAnalysisAtASpeed))
        return value
