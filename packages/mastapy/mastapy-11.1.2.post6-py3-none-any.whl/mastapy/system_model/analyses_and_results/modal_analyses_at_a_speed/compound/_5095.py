...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4967
...
class SynchroniserCompoundModalAnalysisAtASpeed(_5080.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """SynchroniserCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4967.SynchroniserModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4967.SynchroniserModalAnalysisAtASpeed]':
