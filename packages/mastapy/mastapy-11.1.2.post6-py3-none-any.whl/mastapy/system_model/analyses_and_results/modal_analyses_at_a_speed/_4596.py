...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4595, _4594, _4513
...
class SpiralBevelGearSetModalAnalysisAtASpeed(_4513.BevelGearSetModalAnalysisAtASpeed):
    '''SpiralBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def spiral_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_4595.SpiralBevelGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysisAtASpeed, constructor.new(_4595.SpiralBevelGearModalAnalysisAtASpeed))
        return value

    @property
    def spiral_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_4594.SpiralBevelGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysisAtASpeed, constructor.new(_4594.SpiralBevelGearMeshModalAnalysisAtASpeed))
        return value
