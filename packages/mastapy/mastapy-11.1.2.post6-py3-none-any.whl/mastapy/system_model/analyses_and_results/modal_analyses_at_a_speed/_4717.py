...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _2496
...
class ConnectionModalAnalysisAtASpeed(_7372.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysisAtASpeed
    ...
    @property
    def modal_analysis_at_a_speed(self) -> '_2496.ModalAnalysisAtASpeed':
        ...
        return constructor.new(_2496.ModalAnalysisAtASpeed)(self.wrapped.ModalAnalysisAtASpeed) if self.wrapped.ModalAnalysisAtASpeed is not None else None
