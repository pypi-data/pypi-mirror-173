...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4806, _4805, _4742
...
class WormGearSetModalAnalysisAtASpeed(_4742.GearSetModalAnalysisAtASpeed):
    '''WormGearSetModalAnalysisAtASpeed
    ...
    @property
    def worm_gears_modal_analysis_at_a_speed(self) -> 'List[_4806.WormGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysisAtASpeed, constructor.new(_4806.WormGearModalAnalysisAtASpeed))
        return value

    @property
    def worm_meshes_modal_analysis_at_a_speed(self) -> 'List[_4805.WormGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysisAtASpeed, constructor.new(_4805.WormGearMeshModalAnalysisAtASpeed))
        return value
