...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4622, _4621, _4513
...
class ZerolBevelGearSetModalAnalysisAtASpeed(_4513.BevelGearSetModalAnalysisAtASpeed):
    '''ZerolBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def zerol_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_4622.ZerolBevelGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysisAtASpeed, constructor.new(_4622.ZerolBevelGearModalAnalysisAtASpeed))
        return value

    @property
    def zerol_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_4621.ZerolBevelGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysisAtASpeed, constructor.new(_4621.ZerolBevelGearMeshModalAnalysisAtASpeed))
        return value
