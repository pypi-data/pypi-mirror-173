...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4525, _4524, _4555
...
class ConceptGearSetModalAnalysisAtASpeed(_4555.GearSetModalAnalysisAtASpeed):
    '''ConceptGearSetModalAnalysisAtASpeed
    ...
    @property
    def concept_gears_modal_analysis_at_a_speed(self) -> 'List[_4525.ConceptGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysisAtASpeed, constructor.new(_4525.ConceptGearModalAnalysisAtASpeed))
        return value

    @property
    def concept_meshes_modal_analysis_at_a_speed(self) -> 'List[_4524.ConceptGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysisAtASpeed, constructor.new(_4524.ConceptGearMeshModalAnalysisAtASpeed))
        return value
