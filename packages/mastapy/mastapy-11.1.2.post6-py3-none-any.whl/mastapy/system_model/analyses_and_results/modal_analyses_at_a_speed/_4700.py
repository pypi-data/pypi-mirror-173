...
class BevelGearSetModalAnalysisAtASpeed(_4688.AGMAGleasonConicalGearSetModalAnalysisAtASpeed):
    '''BevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def assembly_design(self) -> '_2380.BevelGearSet':
