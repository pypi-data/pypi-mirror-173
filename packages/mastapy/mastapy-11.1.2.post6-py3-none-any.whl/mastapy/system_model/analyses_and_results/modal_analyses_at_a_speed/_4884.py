...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4883, _4882, _4913
...
class ConceptGearSetModalAnalysisAtASpeed(_4913.GearSetModalAnalysisAtASpeed):
    """ConceptGearSetModalAnalysisAtASpeed
    ...
    @property
    def concept_gears_modal_analysis_at_a_speed(self) -> 'List[_4883.ConceptGearModalAnalysisAtASpeed]':
    ...
    @property
    def concept_meshes_modal_analysis_at_a_speed(self) -> 'List[_4882.ConceptGearMeshModalAnalysisAtASpeed]':
