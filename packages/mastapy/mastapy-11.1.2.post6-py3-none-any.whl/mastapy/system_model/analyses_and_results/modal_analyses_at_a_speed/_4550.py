...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4549, _4548, _4555
...
class FaceGearSetModalAnalysisAtASpeed(_4555.GearSetModalAnalysisAtASpeed):
    '''FaceGearSetModalAnalysisAtASpeed
    ...
    @property
    def face_gears_modal_analysis_at_a_speed(self) -> 'List[_4549.FaceGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysisAtASpeed, constructor.new(_4549.FaceGearModalAnalysisAtASpeed))
        return value

    @property
    def face_meshes_modal_analysis_at_a_speed(self) -> 'List[_4548.FaceGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysisAtASpeed, constructor.new(_4548.FaceGearMeshModalAnalysisAtASpeed))
        return value
