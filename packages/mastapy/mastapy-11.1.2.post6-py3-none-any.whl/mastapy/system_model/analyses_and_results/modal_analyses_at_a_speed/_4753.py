...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4752, _4751, _4750
...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed(_4750.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtASpeed):
    '''KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_modal_analysis_at_a_speed(self) -> 'List[_4752.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsModalAnalysisAtASpeed, constructor.new(_4752.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtASpeed))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_modal_analysis_at_a_speed(self) -> 'List[_4751.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesModalAnalysisAtASpeed, constructor.new(_4751.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed))
        return value
