...
from mastapy.system_model.part_model.couplings import _2280, _2282
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2280.SynchroniserHalf':
        ...
        return constructor.new(_2280.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2282.SynchroniserSleeve':
        ...
        return constructor.new(_2282.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
