...
from mastapy.system_model.part_model.couplings import _2311, _2313
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2311.SynchroniserHalf':
        ...
        return constructor.new(_2311.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2313.SynchroniserSleeve':
        ...
        return constructor.new(_2313.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
