...
from mastapy.system_model.part_model.couplings import _2464, _2466
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2464.SynchroniserHalf':
        ...
        return constructor.new(_2464.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone is not None else None

    @property
    def sleeve(self) -> '_2466.SynchroniserSleeve':
        ...
        return constructor.new(_2466.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve is not None else None
