...
from mastapy.system_model.part_model.couplings import _2281, _2283
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2281.SynchroniserHalf':
        ...
        return constructor.new(_2281.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2283.SynchroniserSleeve':
        ...
        return constructor.new(_2283.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
