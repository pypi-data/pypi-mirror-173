...
from mastapy.utility.report import _1646
...
from mastapy.utility.model_validation import _1683, _1684
...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def active_report_as_text(self) -> '_1646.CustomReport':
        ...
        return constructor.new(_1646.CustomReport)(self.wrapped.ActiveReportAsText) if self.wrapped.ActiveReportAsText is not None else None

    @property
    def safety_factors(self) -> '_250.SafetyFactorGroup':
        ...
        return constructor.new(_250.SafetyFactorGroup)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors is not None else None

    @property
    def component_design(self) -> '_2070.DesignEntity':
        ...
        if _2070.DesignEntity.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_connection(self) -> '_2134.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2329.Part':
    ...
    @property
    def local_coordinate_system(self) -> '_1398.CoordinateSystem3D':
        ...
        return constructor.new(_1398.CoordinateSystem3D)(self.wrapped.LocalCoordinateSystem) if self.wrapped.LocalCoordinateSystem is not None else None
    ...
    @property
    def all_status_errors(self) -> 'List[_1684.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllStatusErrors, constructor.new(_1684.StatusItem))
        return value
