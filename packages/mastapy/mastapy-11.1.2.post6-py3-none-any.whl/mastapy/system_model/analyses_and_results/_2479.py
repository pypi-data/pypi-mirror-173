...
from mastapy.system_model.analyses_and_results.analysis_cases import _7374
...
class CompoundAnalysis:
    ...
    def perform_analysis_with_progress(self, progress: '_7389.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_2070.DesignEntity') -> 'Iterable[_7374.DesignEntityCompoundAnalysis]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.ResultsFor(design_entity.wrapped if design_entity else None), constructor.new(_7374.DesignEntityCompoundAnalysis))
