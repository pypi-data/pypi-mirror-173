...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5335
...
TAssembly = TypeVar('TAssembly', bound='_2115.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6448.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5335.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
