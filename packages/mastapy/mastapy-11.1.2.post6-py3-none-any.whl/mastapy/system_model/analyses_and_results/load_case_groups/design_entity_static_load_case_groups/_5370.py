...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5375
...
TAssembly = TypeVar('TAssembly', bound='_2150.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6494.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5375.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
