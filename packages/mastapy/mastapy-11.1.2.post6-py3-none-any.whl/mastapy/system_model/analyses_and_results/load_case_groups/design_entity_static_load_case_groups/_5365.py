...
TReal = TypeVar('TReal', bound='_2153.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6518.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5369.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
