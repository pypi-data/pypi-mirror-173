...
TConnection = TypeVar('TConnection', bound='_2134.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6683.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5520.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
