...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5369
...
TAssembly = TypeVar('TAssembly', bound='_2144.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6488.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5369.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
