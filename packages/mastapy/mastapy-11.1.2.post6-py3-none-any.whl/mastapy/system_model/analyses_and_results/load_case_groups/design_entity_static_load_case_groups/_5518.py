...
TReal = TypeVar('TReal', bound='_2306.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6671.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5522.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
