...
TConnection = TypeVar('TConnection', bound='_1981.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6530.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5367.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
