...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5334
...
TAssembly = TypeVar('TAssembly', bound='_2114.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6451.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5334.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
