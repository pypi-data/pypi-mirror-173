...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5522
from mastapy.system_model.part_model import _2297
...
TAssembly = TypeVar('TAssembly', bound='_2297.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6641.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5522.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
