...
TConnection = TypeVar('TConnection', bound='_1987.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6536.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5373.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
