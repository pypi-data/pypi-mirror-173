...
TReal = TypeVar('TReal', bound='_2124.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6478.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5335.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
