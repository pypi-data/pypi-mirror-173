...
from mastapy.system_model.analyses_and_results.static_loads import _6633, _6485
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    @property
    def load_case_root_assemblies(self) -> 'List[_6633.RootAssemblyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseRootAssemblies, constructor.new(_6633.RootAssemblyLoadCase))
        return value
    ...
    def create_load_cases(self, number_of_load_cases: 'int', token: '_7242.TaskProgress') -> 'List[_6485.LoadCase]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.CreateLoadCases(number_of_load_cases if number_of_load_cases else 0, token.wrapped if token else None), constructor.new(_6485.LoadCase))
