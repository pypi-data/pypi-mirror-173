...
from mastapy.system_model.analyses_and_results.static_loads import _6675, _6527
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    @property
    def load_case_root_assemblies(self) -> 'List[_6675.RootAssemblyLoadCase]':
    ...
    def create_load_cases(self, number_of_load_cases: 'int', token: '_7285.TaskProgress') -> 'List[_6527.LoadCase]':
