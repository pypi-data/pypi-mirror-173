...
from mastapy.system_model.analyses_and_results.load_case_groups import _5353, _5354, _5350
...
class DesignState(_5350.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_5353.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_5353.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5354.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_5354.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_2051.ClutchConnection') -> '_5353.ClutchEngagementStatus':
    ...
    def concept_synchro_gear_engagement_status_for(self, gear: '_2232.CylindricalGear') -> '_5354.ConceptSynchroGearEngagementStatus':
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6486.StaticLoadCase':
