...
from mastapy.system_model.analyses_and_results.load_case_groups import _5506, _5507, _5503
from mastapy._internal import constructor, conversion
from mastapy.system_model.connections_and_sockets.couplings import _2204
from mastapy.system_model.part_model.gears import _2385
...
class DesignState(_5503.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_5506.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_5506.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5507.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_5507.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_2204.ClutchConnection') -> '_5506.ClutchEngagementStatus':
    ...
    def concept_synchro_gear_engagement_status_for(self, gear: '_2385.CylindricalGear') -> '_5507.ConceptSynchroGearEngagementStatus':
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6639.StaticLoadCase':
