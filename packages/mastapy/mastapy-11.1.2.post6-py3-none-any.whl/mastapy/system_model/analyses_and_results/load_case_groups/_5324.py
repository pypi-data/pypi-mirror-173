...
class GroupOfTimeSeriesLoadCases(_5317.AbstractLoadCaseGroup):
    '''GroupOfTimeSeriesLoadCases
    ...
    @property
    def load_cases(self) -> 'List[_6618.TimeSeriesLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCases, constructor.new(_6618.TimeSeriesLoadCase))
        return value
