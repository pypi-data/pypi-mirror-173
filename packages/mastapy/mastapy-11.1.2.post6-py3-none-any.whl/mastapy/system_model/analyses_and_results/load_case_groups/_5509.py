...
from mastapy.system_model.analyses_and_results.load_case_groups import _5512, _5505
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6834
...
class DutyCycle(_5505.AbstractStaticLoadCaseGroup):
    '''DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_5512.SubGroupInSingleDesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycleDesignStates, constructor.new(_5512.SubGroupInSingleDesignState))
        return value

    @property
    def time_series_importer(self) -> '_6834.TimeSeriesImporter':
        ...
        return constructor.new(_6834.TimeSeriesImporter)(self.wrapped.TimeSeriesImporter) if self.wrapped.TimeSeriesImporter is not None else None
    ...
    def add_static_load(self, static_load: '_6639.StaticLoadCase'):
    ...
    def remove_static_load(self, static_load: '_6639.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_5512.SubGroupInSingleDesignState'):
