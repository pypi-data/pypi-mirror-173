...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4649, _4648, _4655
...
class FaceGearSetModalAnalysisAtAStiffness(_4655.GearSetModalAnalysisAtAStiffness):
    """FaceGearSetModalAnalysisAtAStiffness
    ...
    @property
    def face_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4649.FaceGearModalAnalysisAtAStiffness]':
    ...
    @property
    def face_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4648.FaceGearMeshModalAnalysisAtAStiffness]':
