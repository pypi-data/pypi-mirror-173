...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4524, _4523, _4441
...
class SpiralBevelGearSetModalAnalysisAtAStiffness(_4441.BevelGearSetModalAnalysisAtAStiffness):
    '''SpiralBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def spiral_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4524.SpiralBevelGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysisAtAStiffness, constructor.new(_4524.SpiralBevelGearModalAnalysisAtAStiffness))
        return value

    @property
    def spiral_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4523.SpiralBevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysisAtAStiffness, constructor.new(_4523.SpiralBevelGearMeshModalAnalysisAtAStiffness))
        return value
