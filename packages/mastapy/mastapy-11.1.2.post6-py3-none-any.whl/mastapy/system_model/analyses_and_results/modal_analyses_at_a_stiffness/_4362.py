...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4361, _4360, _4297
...
class WormGearSetModalAnalysisAtAStiffness(_4297.GearSetModalAnalysisAtAStiffness):
    '''WormGearSetModalAnalysisAtAStiffness
    ...
    @property
    def worm_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4361.WormGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysisAtAStiffness, constructor.new(_4361.WormGearModalAnalysisAtAStiffness))
        return value

    @property
    def worm_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4360.WormGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysisAtAStiffness, constructor.new(_4360.WormGearMeshModalAnalysisAtAStiffness))
        return value
