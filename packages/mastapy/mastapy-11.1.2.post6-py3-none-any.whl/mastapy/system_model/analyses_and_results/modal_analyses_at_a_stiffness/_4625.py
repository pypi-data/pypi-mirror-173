...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4624, _4623, _4655
...
class ConceptGearSetModalAnalysisAtAStiffness(_4655.GearSetModalAnalysisAtAStiffness):
    """ConceptGearSetModalAnalysisAtAStiffness
    ...
    @property
    def concept_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4624.ConceptGearModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4623.ConceptGearMeshModalAnalysisAtAStiffness]':
