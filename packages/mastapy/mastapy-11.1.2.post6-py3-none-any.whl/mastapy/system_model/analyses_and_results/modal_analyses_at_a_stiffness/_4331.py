...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _2313, _4243
...
class RootAssemblyModalAnalysisAtAStiffness(_4243.AssemblyModalAnalysisAtAStiffness):
    '''RootAssemblyModalAnalysisAtAStiffness
    ...
    @property
    def modal_analysis_at_a_stiffness_inputs(self) -> '_2313.ModalAnalysisAtAStiffness':
        ...
        return constructor.new(_2313.ModalAnalysisAtAStiffness)(self.wrapped.ModalAnalysisAtAStiffnessInputs) if self.wrapped.ModalAnalysisAtAStiffnessInputs else None
