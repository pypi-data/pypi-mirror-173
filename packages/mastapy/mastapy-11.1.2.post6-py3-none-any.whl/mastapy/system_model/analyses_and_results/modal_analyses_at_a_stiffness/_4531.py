...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4530, _4529, _4441
...
class StraightBevelDiffGearSetModalAnalysisAtAStiffness(_4441.BevelGearSetModalAnalysisAtAStiffness):
    '''StraightBevelDiffGearSetModalAnalysisAtAStiffness
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4530.StraightBevelDiffGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysisAtAStiffness, constructor.new(_4530.StraightBevelDiffGearModalAnalysisAtAStiffness))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4529.StraightBevelDiffGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysisAtAStiffness, constructor.new(_4529.StraightBevelDiffGearMeshModalAnalysisAtAStiffness))
        return value
