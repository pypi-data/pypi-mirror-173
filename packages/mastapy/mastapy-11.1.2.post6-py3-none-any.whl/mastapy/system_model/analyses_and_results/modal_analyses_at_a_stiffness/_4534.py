...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4533, _4532, _4441
...
class StraightBevelGearSetModalAnalysisAtAStiffness(_4441.BevelGearSetModalAnalysisAtAStiffness):
    '''StraightBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4533.StraightBevelGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysisAtAStiffness, constructor.new(_4533.StraightBevelGearModalAnalysisAtAStiffness))
        return value

    @property
    def straight_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4532.StraightBevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysisAtAStiffness, constructor.new(_4532.StraightBevelGearMeshModalAnalysisAtAStiffness))
        return value
