...
class PlanetaryGearSetModalAnalysisAtAStiffness(_4285.CylindricalGearSetModalAnalysisAtAStiffness):
    '''PlanetaryGearSetModalAnalysisAtAStiffness
    ...
    @property
    def assembly_design(self) -> '_2219.PlanetaryGearSet':
        ...
        return constructor.new(_2219.PlanetaryGearSet)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
