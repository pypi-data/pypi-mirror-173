...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4665, _4664, _4663
...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness(_4663.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness):
    """KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4665.KlingelnbergCycloPalloidHypoidGearModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4664.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtAStiffness]':
