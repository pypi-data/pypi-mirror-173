...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4548, _4547, _4484
...
class WormGearSetModalAnalysisAtAStiffness(_4484.GearSetModalAnalysisAtAStiffness):
    '''WormGearSetModalAnalysisAtAStiffness
    ...
    @property
    def worm_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4548.WormGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysisAtAStiffness, constructor.new(_4548.WormGearModalAnalysisAtAStiffness))
        return value

    @property
    def worm_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4547.WormGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysisAtAStiffness, constructor.new(_4547.WormGearMeshModalAnalysisAtAStiffness))
        return value
