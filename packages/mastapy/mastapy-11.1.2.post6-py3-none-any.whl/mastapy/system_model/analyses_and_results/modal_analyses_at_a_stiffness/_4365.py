...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4364, _4363, _4254
...
class ZerolBevelGearSetModalAnalysisAtAStiffness(_4254.BevelGearSetModalAnalysisAtAStiffness):
    '''ZerolBevelGearSetModalAnalysisAtAStiffness
    ...
    @property
    def zerol_bevel_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4364.ZerolBevelGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysisAtAStiffness, constructor.new(_4364.ZerolBevelGearModalAnalysisAtAStiffness))
        return value

    @property
    def zerol_bevel_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4363.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysisAtAStiffness, constructor.new(_4363.ZerolBevelGearMeshModalAnalysisAtAStiffness))
        return value
