...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4300, _4299, _4242
...
class HypoidGearSetModalAnalysisAtAStiffness(_4242.AGMAGleasonConicalGearSetModalAnalysisAtAStiffness):
    '''HypoidGearSetModalAnalysisAtAStiffness
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4300.HypoidGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysisAtAStiffness, constructor.new(_4300.HypoidGearModalAnalysisAtAStiffness))
        return value

    @property
    def hypoid_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4299.HypoidGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysisAtAStiffness, constructor.new(_4299.HypoidGearMeshModalAnalysisAtAStiffness))
        return value
