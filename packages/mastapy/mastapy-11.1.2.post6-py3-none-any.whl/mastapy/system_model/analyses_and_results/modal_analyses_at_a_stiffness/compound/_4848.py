...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4718
...
class WormGearMeshCompoundModalAnalysisAtAStiffness(_4783.GearMeshCompoundModalAnalysisAtAStiffness):
    """WormGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4718.WormGearMeshModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4718.WormGearMeshModalAnalysisAtAStiffness]':
