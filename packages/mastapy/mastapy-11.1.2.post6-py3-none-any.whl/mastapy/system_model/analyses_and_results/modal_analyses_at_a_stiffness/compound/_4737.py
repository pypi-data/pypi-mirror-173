...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4735, _4736, _4742
...
class BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness(_4742.BevelGearSetCompoundModalAnalysisAtAStiffness):
    """BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4607.BevelDifferentialGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4735.BevelDifferentialGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4736.BevelDifferentialGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4607.BevelDifferentialGearSetModalAnalysisAtAStiffness]':
