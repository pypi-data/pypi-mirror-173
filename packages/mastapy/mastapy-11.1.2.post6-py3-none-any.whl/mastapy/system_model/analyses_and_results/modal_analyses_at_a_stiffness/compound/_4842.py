...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4712
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4762
...
class TorqueConverterConnectionCompoundModalAnalysisAtAStiffness(_4762.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """TorqueConverterConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4712.TorqueConverterConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4712.TorqueConverterConnectionModalAnalysisAtAStiffness]':
