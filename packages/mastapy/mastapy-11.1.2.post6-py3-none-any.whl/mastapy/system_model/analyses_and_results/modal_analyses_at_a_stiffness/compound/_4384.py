...
class BevelGearSetCompoundModalAnalysisAtAStiffness(_4372.AGMAGleasonConicalGearSetCompoundModalAnalysisAtAStiffness):
    '''BevelGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4254.BevelGearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4254.BevelGearSetModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4254.BevelGearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4254.BevelGearSetModalAnalysisAtAStiffness))
        return value
