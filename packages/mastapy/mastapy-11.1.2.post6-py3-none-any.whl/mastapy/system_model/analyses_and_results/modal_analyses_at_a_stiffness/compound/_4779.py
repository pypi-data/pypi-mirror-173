...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4650
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4777, _4778, _4784
...
class FaceGearSetCompoundModalAnalysisAtAStiffness(_4784.GearSetCompoundModalAnalysisAtAStiffness):
    """FaceGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4650.FaceGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def face_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4777.FaceGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def face_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4778.FaceGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4650.FaceGearSetModalAnalysisAtAStiffness]':
