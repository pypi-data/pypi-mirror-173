...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4516
...
class RollingRingConnectionCompoundModalAnalysisAtAStiffness(_4618.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    '''RollingRingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4516.RollingRingConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4516.RollingRingConnectionModalAnalysisAtAStiffness))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4516.RollingRingConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4516.RollingRingConnectionModalAnalysisAtAStiffness))
        return value
