...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4639
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4725
...
class CycloidalDiscCompoundModalAnalysisAtAStiffness(_4725.AbstractShaftCompoundModalAnalysisAtAStiffness):
    """CycloidalDiscCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4639.CycloidalDiscModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4639.CycloidalDiscModalAnalysisAtAStiffness]':
