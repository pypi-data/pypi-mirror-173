...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4680
...
class PlanetCarrierCompoundModalAnalysisAtAStiffness(_4801.MountableComponentCompoundModalAnalysisAtAStiffness):
    """PlanetCarrierCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4680.PlanetCarrierModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4680.PlanetCarrierModalAnalysisAtAStiffness]':
