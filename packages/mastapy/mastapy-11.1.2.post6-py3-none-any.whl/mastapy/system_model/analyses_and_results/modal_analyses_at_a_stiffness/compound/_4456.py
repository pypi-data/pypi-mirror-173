...
class CylindricalPlanetGearCompoundModalAnalysisAtAStiffness(_4453.CylindricalGearCompoundModalAnalysisAtAStiffness):
    '''CylindricalPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4326.CylindricalPlanetGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4326.CylindricalPlanetGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4326.CylindricalPlanetGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4326.CylindricalPlanetGearModalAnalysisAtAStiffness))
        return value
