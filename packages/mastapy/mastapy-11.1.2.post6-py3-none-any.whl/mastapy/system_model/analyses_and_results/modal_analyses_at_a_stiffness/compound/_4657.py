...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4527
...
class SpringDamperHalfCompoundModalAnalysisAtAStiffness(_4592.CouplingHalfCompoundModalAnalysisAtAStiffness):
    '''SpringDamperHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4527.SpringDamperHalfModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4527.SpringDamperHalfModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4527.SpringDamperHalfModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4527.SpringDamperHalfModalAnalysisAtAStiffness))
        return value
