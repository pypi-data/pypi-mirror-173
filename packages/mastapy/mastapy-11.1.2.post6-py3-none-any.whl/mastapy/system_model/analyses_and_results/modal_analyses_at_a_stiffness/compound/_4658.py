...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4530
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4569
...
class StraightBevelDiffGearCompoundModalAnalysisAtAStiffness(_4569.BevelGearCompoundModalAnalysisAtAStiffness):
    '''StraightBevelDiffGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4530.StraightBevelDiffGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4530.StraightBevelDiffGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4530.StraightBevelDiffGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4530.StraightBevelDiffGearModalAnalysisAtAStiffness))
        return value
