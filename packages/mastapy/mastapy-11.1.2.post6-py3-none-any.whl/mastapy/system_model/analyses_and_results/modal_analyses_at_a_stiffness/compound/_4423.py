...
class BevelGearMeshCompoundModalAnalysisAtAStiffness(_4411.AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness):
    '''BevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4292.BevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4292.BevelGearMeshModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4292.BevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4292.BevelGearMeshModalAnalysisAtAStiffness))
        return value
