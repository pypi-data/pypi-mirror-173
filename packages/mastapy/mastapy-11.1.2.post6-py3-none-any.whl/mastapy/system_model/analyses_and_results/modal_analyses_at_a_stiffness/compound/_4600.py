...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4471
...
class CylindricalGearCompoundModalAnalysisAtAStiffness(_4611.GearCompoundModalAnalysisAtAStiffness):
    '''CylindricalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4471.CylindricalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4471.CylindricalGearModalAnalysisAtAStiffness))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4471.CylindricalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4471.CylindricalGearModalAnalysisAtAStiffness))
        return value
