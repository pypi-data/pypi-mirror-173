...
class StraightBevelSunGearCompoundModalAnalysisAtAStiffness(_4511.StraightBevelDiffGearCompoundModalAnalysisAtAStiffness):
    '''StraightBevelSunGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4389.StraightBevelSunGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4389.StraightBevelSunGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4389.StraightBevelSunGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4389.StraightBevelSunGearModalAnalysisAtAStiffness))
        return value
