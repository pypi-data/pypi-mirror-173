...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4659
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4786, _4787, _4730
...
class HypoidGearSetCompoundModalAnalysisAtAStiffness(_4730.AGMAGleasonConicalGearSetCompoundModalAnalysisAtAStiffness):
    """HypoidGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4659.HypoidGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4786.HypoidGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4787.HypoidGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4659.HypoidGearSetModalAnalysisAtAStiffness]':
