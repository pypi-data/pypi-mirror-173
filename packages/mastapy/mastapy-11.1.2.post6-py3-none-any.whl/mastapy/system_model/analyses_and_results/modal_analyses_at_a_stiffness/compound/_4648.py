...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4520
...
class ShaftCompoundModalAnalysisAtAStiffness(_4554.AbstractShaftCompoundModalAnalysisAtAStiffness):
    '''ShaftCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4520.ShaftModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4520.ShaftModalAnalysisAtAStiffness))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4520.ShaftModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4520.ShaftModalAnalysisAtAStiffness))
        return value
