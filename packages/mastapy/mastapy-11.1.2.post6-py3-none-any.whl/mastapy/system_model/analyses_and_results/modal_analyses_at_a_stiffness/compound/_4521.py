...
class SynchroniserPartCompoundModalAnalysisAtAStiffness(_4445.CouplingHalfCompoundModalAnalysisAtAStiffness):
    '''SynchroniserPartCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4392.SynchroniserPartModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4392.SynchroniserPartModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4392.SynchroniserPartModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4392.SynchroniserPartModalAnalysisAtAStiffness))
        return value
