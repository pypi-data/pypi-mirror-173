...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4433
...
class BeltDriveCompoundModalAnalysisAtAStiffness(_4651.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    '''BeltDriveCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4433.BeltDriveModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4433.BeltDriveModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4433.BeltDriveModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4433.BeltDriveModalAnalysisAtAStiffness))
        return value
