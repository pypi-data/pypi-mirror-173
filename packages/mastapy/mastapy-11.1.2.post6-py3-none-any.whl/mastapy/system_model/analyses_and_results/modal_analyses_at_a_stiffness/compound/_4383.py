...
class BevelGearMeshCompoundModalAnalysisAtAStiffness(_4371.AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness):
    '''BevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4252.BevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4252.BevelGearMeshModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4252.BevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4252.BevelGearMeshModalAnalysisAtAStiffness))
        return value
