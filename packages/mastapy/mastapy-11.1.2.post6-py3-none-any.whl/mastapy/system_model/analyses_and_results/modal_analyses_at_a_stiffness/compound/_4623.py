...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4493
...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtAStiffness(_4620.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtAStiffness):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4493.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4493.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4493.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4493.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtAStiffness))
        return value
