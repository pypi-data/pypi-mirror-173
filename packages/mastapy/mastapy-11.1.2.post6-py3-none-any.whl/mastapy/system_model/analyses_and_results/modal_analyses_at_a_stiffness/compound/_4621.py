...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4492
...
class KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtAStiffness(_4587.ConicalGearSetCompoundModalAnalysisAtAStiffness):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4492.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4492.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4492.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4492.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness))
        return value
