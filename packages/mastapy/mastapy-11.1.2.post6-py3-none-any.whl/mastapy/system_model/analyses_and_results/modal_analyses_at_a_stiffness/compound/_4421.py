...
class BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness(_4417.BevelDifferentialGearCompoundModalAnalysisAtAStiffness):
    '''BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4291.BevelDifferentialSunGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4291.BevelDifferentialSunGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4291.BevelDifferentialSunGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4291.BevelDifferentialSunGearModalAnalysisAtAStiffness))
        return value
