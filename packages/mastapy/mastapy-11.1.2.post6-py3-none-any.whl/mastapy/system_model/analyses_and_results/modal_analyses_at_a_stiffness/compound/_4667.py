...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4537
...
class SynchroniserHalfCompoundModalAnalysisAtAStiffness(_4668.SynchroniserPartCompoundModalAnalysisAtAStiffness):
    '''SynchroniserHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4537.SynchroniserHalfModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4537.SynchroniserHalfModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4537.SynchroniserHalfModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4537.SynchroniserHalfModalAnalysisAtAStiffness))
        return value
