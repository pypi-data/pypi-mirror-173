...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4526
...
class SpringDamperConnectionCompoundModalAnalysisAtAStiffness(_4591.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    '''SpringDamperConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4526.SpringDamperConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4526.SpringDamperConnectionModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4526.SpringDamperConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4526.SpringDamperConnectionModalAnalysisAtAStiffness))
        return value
