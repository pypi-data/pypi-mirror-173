...
class CVTBeltConnectionCompoundModalAnalysisAtAStiffness(_4415.BeltConnectionCompoundModalAnalysisAtAStiffness):
    '''CVTBeltConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4316.CVTBeltConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4316.CVTBeltConnectionModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4316.CVTBeltConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4316.CVTBeltConnectionModalAnalysisAtAStiffness))
        return value
