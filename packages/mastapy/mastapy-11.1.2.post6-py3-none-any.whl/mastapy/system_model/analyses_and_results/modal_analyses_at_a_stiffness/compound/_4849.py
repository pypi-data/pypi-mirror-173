...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4720
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4847, _4848, _4784
...
class WormGearSetCompoundModalAnalysisAtAStiffness(_4784.GearSetCompoundModalAnalysisAtAStiffness):
    """WormGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4720.WormGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_gears_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4847.WormGearCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_meshes_compound_modal_analysis_at_a_stiffness(self) -> 'List[_4848.WormGearMeshCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4720.WormGearSetModalAnalysisAtAStiffness]':
