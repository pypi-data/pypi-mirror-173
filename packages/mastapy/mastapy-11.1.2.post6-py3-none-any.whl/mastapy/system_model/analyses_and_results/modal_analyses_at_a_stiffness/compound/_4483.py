...
class MountableComponentCompoundModalAnalysisAtAStiffness(_4431.ComponentCompoundModalAnalysisAtAStiffness):
    '''MountableComponentCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4354.MountableComponentModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4354.MountableComponentModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4354.MountableComponentModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4354.MountableComponentModalAnalysisAtAStiffness))
        return value
