...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4615
...
class ClutchConnectionCompoundModalAnalysisAtAStiffness(_4762.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    """ClutchConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4615.ClutchConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4615.ClutchConnectionModalAnalysisAtAStiffness]':
