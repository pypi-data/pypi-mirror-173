...
class CouplingCompoundModalAnalysisAtAStiffness(_4504.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    '''CouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4315.CouplingModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4315.CouplingModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4315.CouplingModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4315.CouplingModalAnalysisAtAStiffness))
        return value
