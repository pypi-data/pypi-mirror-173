...
class CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtAStiffness(_4430.CoaxialConnectionCompoundModalAnalysisAtAStiffness):
    '''CycloidalDiscCentralBearingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4320.CycloidalDiscCentralBearingConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4320.CycloidalDiscCentralBearingConnectionModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4320.CycloidalDiscCentralBearingConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4320.CycloidalDiscCentralBearingConnectionModalAnalysisAtAStiffness))
        return value
