...
class CVTCompoundModalAnalysisAtAStiffness(_4416.BeltDriveCompoundModalAnalysisAtAStiffness):
    '''CVTCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4317.CVTModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4317.CVTModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4317.CVTModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4317.CVTModalAnalysisAtAStiffness))
        return value
