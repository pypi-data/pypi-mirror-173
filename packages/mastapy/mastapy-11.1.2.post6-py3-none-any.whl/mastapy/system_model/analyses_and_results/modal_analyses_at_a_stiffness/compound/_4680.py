...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4550
...
class ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness(_4570.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    '''ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4550.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4550.ZerolBevelGearMeshModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4550.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4550.ZerolBevelGearMeshModalAnalysisAtAStiffness))
        return value
