...
class KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtAStiffness(_4585.ConicalGearCompoundModalAnalysisAtAStiffness):
    '''KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4491.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4491.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4491.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4491.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness))
        return value
