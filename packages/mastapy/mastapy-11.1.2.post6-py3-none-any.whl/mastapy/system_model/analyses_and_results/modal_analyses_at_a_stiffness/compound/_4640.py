...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4511
...
class PowerLoadCompoundModalAnalysisAtAStiffness(_4675.VirtualComponentCompoundModalAnalysisAtAStiffness):
    '''PowerLoadCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4511.PowerLoadModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4511.PowerLoadModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4511.PowerLoadModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4511.PowerLoadModalAnalysisAtAStiffness))
        return value
