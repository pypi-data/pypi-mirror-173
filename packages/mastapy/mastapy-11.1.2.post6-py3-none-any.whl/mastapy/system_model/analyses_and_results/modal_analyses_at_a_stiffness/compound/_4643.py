...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4514
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4618
...
class RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness(_4618.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    '''RingPinsToDiscConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4514.RingPinsToDiscConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4514.RingPinsToDiscConnectionModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4514.RingPinsToDiscConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4514.RingPinsToDiscConnectionModalAnalysisAtAStiffness))
        return value
