...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4506
...
class PartToPartShearCouplingCompoundModalAnalysisAtAStiffness(_4590.CouplingCompoundModalAnalysisAtAStiffness):
    '''PartToPartShearCouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4506.PartToPartShearCouplingModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4506.PartToPartShearCouplingModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4506.PartToPartShearCouplingModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4506.PartToPartShearCouplingModalAnalysisAtAStiffness))
        return value
