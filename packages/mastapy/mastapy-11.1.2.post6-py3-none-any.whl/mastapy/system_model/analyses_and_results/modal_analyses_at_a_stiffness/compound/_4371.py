...
class AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness(_4399.ConicalGearMeshCompoundModalAnalysisAtAStiffness):
    '''AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4240.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4240.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4240.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4240.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness))
        return value
