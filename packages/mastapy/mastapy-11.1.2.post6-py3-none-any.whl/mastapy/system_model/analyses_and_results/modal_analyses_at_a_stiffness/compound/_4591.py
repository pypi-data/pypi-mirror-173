...
class CouplingConnectionCompoundModalAnalysisAtAStiffness(_4618.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    '''CouplingConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4460.CouplingConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4460.CouplingConnectionModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4460.CouplingConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4460.CouplingConnectionModalAnalysisAtAStiffness))
        return value
