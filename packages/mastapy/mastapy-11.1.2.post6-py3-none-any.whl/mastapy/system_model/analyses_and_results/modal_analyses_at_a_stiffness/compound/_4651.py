...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4553
...
class SpecialisedAssemblyCompoundModalAnalysisAtAStiffness(_4553.AbstractAssemblyCompoundModalAnalysisAtAStiffness):
    '''SpecialisedAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4522.SpecialisedAssemblyModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4522.SpecialisedAssemblyModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4522.SpecialisedAssemblyModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4522.SpecialisedAssemblyModalAnalysisAtAStiffness))
        return value
