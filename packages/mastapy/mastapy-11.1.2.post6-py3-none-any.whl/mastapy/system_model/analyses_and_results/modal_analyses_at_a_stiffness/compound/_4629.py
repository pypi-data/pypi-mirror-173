...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4500
...
class MeasurementComponentCompoundModalAnalysisAtAStiffness(_4675.VirtualComponentCompoundModalAnalysisAtAStiffness):
    '''MeasurementComponentCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4500.MeasurementComponentModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4500.MeasurementComponentModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4500.MeasurementComponentModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4500.MeasurementComponentModalAnalysisAtAStiffness))
        return value
