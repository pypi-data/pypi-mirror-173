...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4451
...
class ConceptCouplingCompoundModalAnalysisAtAStiffness(_4590.CouplingCompoundModalAnalysisAtAStiffness):
    '''ConceptCouplingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4451.ConceptCouplingModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4451.ConceptCouplingModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4451.ConceptCouplingModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4451.ConceptCouplingModalAnalysisAtAStiffness))
        return value
