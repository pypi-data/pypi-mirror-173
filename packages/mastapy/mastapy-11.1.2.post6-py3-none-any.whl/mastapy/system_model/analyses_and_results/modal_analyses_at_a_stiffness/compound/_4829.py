...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4701
...
class StraightBevelDiffGearCompoundModalAnalysisAtAStiffness(_4740.BevelGearCompoundModalAnalysisAtAStiffness):
    """StraightBevelDiffGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4701.StraightBevelDiffGearModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4701.StraightBevelDiffGearModalAnalysisAtAStiffness]':
