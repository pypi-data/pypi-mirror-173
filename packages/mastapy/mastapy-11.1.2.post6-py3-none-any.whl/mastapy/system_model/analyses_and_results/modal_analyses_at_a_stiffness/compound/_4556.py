...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4588
...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness(_4588.ConnectionCompoundModalAnalysisAtAStiffness):
    '''AbstractShaftToMountableComponentConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4426.AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4426.AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4426.AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4426.AbstractShaftToMountableComponentConnectionModalAnalysisAtAStiffness))
        return value
