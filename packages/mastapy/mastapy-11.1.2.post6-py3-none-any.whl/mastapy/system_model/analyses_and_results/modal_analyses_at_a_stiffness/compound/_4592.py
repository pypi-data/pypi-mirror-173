...
class CouplingHalfCompoundModalAnalysisAtAStiffness(_4630.MountableComponentCompoundModalAnalysisAtAStiffness):
    '''CouplingHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4461.CouplingHalfModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4461.CouplingHalfModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4461.CouplingHalfModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4461.CouplingHalfModalAnalysisAtAStiffness))
        return value
