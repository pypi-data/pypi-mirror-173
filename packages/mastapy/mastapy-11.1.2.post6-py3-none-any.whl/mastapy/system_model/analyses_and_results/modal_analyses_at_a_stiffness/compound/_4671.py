...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4541
...
class TorqueConverterConnectionCompoundModalAnalysisAtAStiffness(_4591.CouplingConnectionCompoundModalAnalysisAtAStiffness):
    '''TorqueConverterConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4541.TorqueConverterConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4541.TorqueConverterConnectionModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4541.TorqueConverterConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4541.TorqueConverterConnectionModalAnalysisAtAStiffness))
        return value
