...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4485
...
class GuideDxfModelCompoundModalAnalysisAtAStiffness(_4578.ComponentCompoundModalAnalysisAtAStiffness):
    '''GuideDxfModelCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4485.GuideDxfModelModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4485.GuideDxfModelModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4485.GuideDxfModelModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4485.GuideDxfModelModalAnalysisAtAStiffness))
        return value
