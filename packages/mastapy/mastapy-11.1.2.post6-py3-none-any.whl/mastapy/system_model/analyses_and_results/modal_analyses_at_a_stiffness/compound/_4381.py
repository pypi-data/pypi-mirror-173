...
class BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness(_4377.BevelDifferentialGearCompoundModalAnalysisAtAStiffness):
    '''BevelDifferentialSunGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4251.BevelDifferentialSunGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4251.BevelDifferentialSunGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4251.BevelDifferentialSunGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4251.BevelDifferentialSunGearModalAnalysisAtAStiffness))
        return value
