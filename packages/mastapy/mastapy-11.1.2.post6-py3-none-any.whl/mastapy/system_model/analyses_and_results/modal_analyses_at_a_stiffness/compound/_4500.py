...
class RootAssemblyCompoundModalAnalysisAtAStiffness(_4413.AssemblyCompoundModalAnalysisAtAStiffness):
    '''RootAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4371.RootAssemblyModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4371.RootAssemblyModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4371.RootAssemblyModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4371.RootAssemblyModalAnalysisAtAStiffness))
        return value
