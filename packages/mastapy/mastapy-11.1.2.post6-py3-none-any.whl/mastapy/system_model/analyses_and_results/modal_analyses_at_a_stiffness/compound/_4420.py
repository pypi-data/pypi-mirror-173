...
class BevelDifferentialPlanetGearCompoundModalAnalysisAtAStiffness(_4417.BevelDifferentialGearCompoundModalAnalysisAtAStiffness):
    '''BevelDifferentialPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4290.BevelDifferentialPlanetGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4290.BevelDifferentialPlanetGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4290.BevelDifferentialPlanetGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4290.BevelDifferentialPlanetGearModalAnalysisAtAStiffness))
        return value
