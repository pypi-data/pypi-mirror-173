...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4681
...
class PointLoadCompoundModalAnalysisAtAStiffness(_4846.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """PointLoadCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4681.PointLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4681.PointLoadModalAnalysisAtAStiffness]':
