...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4603
...
class BeltConnectionCompoundModalAnalysisAtAStiffness(_4789.InterMountableComponentConnectionCompoundModalAnalysisAtAStiffness):
    """BeltConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4603.BeltConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4603.BeltConnectionModalAnalysisAtAStiffness]':
