...
class AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness(_4586.ConicalGearMeshCompoundModalAnalysisAtAStiffness):
    '''AGMAGleasonConicalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4427.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4427.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4427.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4427.AGMAGleasonConicalGearMeshModalAnalysisAtAStiffness))
        return value
