...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4672
...
class MountableComponentCompoundModalAnalysisAtAStiffness(_4749.ComponentCompoundModalAnalysisAtAStiffness):
    """MountableComponentCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4672.MountableComponentModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4672.MountableComponentModalAnalysisAtAStiffness]':
