...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4529
...
class StraightBevelDiffGearMeshCompoundModalAnalysisAtAStiffness(_4570.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    '''StraightBevelDiffGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4529.StraightBevelDiffGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4529.StraightBevelDiffGearMeshModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4529.StraightBevelDiffGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4529.StraightBevelDiffGearMeshModalAnalysisAtAStiffness))
        return value
