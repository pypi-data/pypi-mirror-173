...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4651
...
class FEPartCompoundModalAnalysisAtAStiffness(_4726.AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness):
    """FEPartCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4651.FEPartModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4651.FEPartModalAnalysisAtAStiffness]':
