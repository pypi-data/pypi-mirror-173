...
class KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtAStiffness(_4440.ConicalGearSetCompoundModalAnalysisAtAStiffness):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4345.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4345.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4345.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4345.KlingelnbergCycloPalloidConicalGearSetModalAnalysisAtAStiffness))
        return value
