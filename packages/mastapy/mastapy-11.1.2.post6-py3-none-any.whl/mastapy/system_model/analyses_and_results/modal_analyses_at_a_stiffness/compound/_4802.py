...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4673
...
class OilSealCompoundModalAnalysisAtAStiffness(_4760.ConnectorCompoundModalAnalysisAtAStiffness):
    """OilSealCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4673.OilSealModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4673.OilSealModalAnalysisAtAStiffness]':
