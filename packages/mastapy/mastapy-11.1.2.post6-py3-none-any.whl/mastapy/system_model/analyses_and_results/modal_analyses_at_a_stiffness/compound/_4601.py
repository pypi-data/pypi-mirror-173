...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4470
...
class CylindricalGearMeshCompoundModalAnalysisAtAStiffness(_4612.GearMeshCompoundModalAnalysisAtAStiffness):
    '''CylindricalGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4470.CylindricalGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4470.CylindricalGearMeshModalAnalysisAtAStiffness))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4470.CylindricalGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4470.CylindricalGearMeshModalAnalysisAtAStiffness))
        return value
