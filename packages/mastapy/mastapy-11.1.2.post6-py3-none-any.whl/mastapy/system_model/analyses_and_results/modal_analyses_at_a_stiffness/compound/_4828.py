...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4698
...
class SpringDamperHalfCompoundModalAnalysisAtAStiffness(_4763.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """SpringDamperHalfCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4698.SpringDamperHalfModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4698.SpringDamperHalfModalAnalysisAtAStiffness]':
