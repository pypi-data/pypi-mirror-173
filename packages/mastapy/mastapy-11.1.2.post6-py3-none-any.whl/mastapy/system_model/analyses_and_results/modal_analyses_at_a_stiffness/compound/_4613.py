...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4484
...
class GearSetCompoundModalAnalysisAtAStiffness(_4651.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    '''GearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4484.GearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4484.GearSetModalAnalysisAtAStiffness))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4484.GearSetModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4484.GearSetModalAnalysisAtAStiffness))
        return value
