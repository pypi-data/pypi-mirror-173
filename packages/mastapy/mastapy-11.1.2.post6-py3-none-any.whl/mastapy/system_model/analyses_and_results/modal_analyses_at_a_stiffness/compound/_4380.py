...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import _4377
...
class BevelDifferentialPlanetGearCompoundModalAnalysisAtAStiffness(_4377.BevelDifferentialGearCompoundModalAnalysisAtAStiffness):
    '''BevelDifferentialPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4250.BevelDifferentialPlanetGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4250.BevelDifferentialPlanetGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4250.BevelDifferentialPlanetGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4250.BevelDifferentialPlanetGearModalAnalysisAtAStiffness))
        return value
