...
class ConnectorCompoundModalAnalysisAtAStiffness(_4630.MountableComponentCompoundModalAnalysisAtAStiffness):
    '''ConnectorCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4459.ConnectorModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4459.ConnectorModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4459.ConnectorModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4459.ConnectorModalAnalysisAtAStiffness))
        return value
