...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4519
...
class ShaftHubConnectionCompoundModalAnalysisAtAStiffness(_4589.ConnectorCompoundModalAnalysisAtAStiffness):
    '''ShaftHubConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4519.ShaftHubConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4519.ShaftHubConnectionModalAnalysisAtAStiffness))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4519.ShaftHubConnectionModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4519.ShaftHubConnectionModalAnalysisAtAStiffness))
        return value
