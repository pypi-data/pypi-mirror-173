...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3990, _3989, _4027
...
class ConceptGearSetParametricStudyTool(_4027.GearSetParametricStudyTool):
    '''ConceptGearSetParametricStudyTool
    ...
    @property
    def concept_gears_parametric_study_tool(self) -> 'List[_3990.ConceptGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsParametricStudyTool, constructor.new(_3990.ConceptGearParametricStudyTool))
        return value

    @property
    def concept_meshes_parametric_study_tool(self) -> 'List[_3989.ConceptGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesParametricStudyTool, constructor.new(_3989.ConceptGearMeshParametricStudyTool))
        return value
