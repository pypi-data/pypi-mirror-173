...
class ParametricStudyDOEResultVariable(_1454.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1456.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1456.PropertyTargetForDominantCandidateSearch'):
