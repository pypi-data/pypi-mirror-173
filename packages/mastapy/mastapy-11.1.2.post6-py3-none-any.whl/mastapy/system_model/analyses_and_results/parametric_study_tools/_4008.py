...
class CylindricalGearParametricStudyTool(_4026.GearParametricStudyTool):
    '''CylindricalGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2415.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2415.CylindricalGearSystemDeflection))
        return value
