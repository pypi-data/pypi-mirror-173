...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4234, _4231, _4199
...
class ParametricStudyVariable(_2508.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4234.ParametricStudyDimension':
        ...
        return constructor.new(_4234.ParametricStudyDimension)(value) if value is not None else None

    @dimension.setter
    def dimension(self, value: '_4234.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4231.MonteCarloDistribution':
        ...
        return constructor.new(_4231.MonteCarloDistribution)(value) if value is not None else None

    @distribution.setter
    def distribution(self, value: '_4231.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def doe_variable_setter(self) -> '_4199.DesignOfExperimentsVariableSetter':
        ...
        return constructor.new(_4199.DesignOfExperimentsVariableSetter)(self.wrapped.DOEVariableSetter) if self.wrapped.DOEVariableSetter is not None else None
