...
from mastapy.bearings.bearing_results import _1652
...
class BearingParametricStudyTool(_3996.ConnectorParametricStudyTool):
    '''BearingParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> 'List[_1652.LoadedBearingDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDutyCycleResults, constructor.new(_1652.LoadedBearingDutyCycle))
        return value
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2368.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2368.BearingSystemDeflection))
        return value
