...
class GearSetParametricStudyTool(_4263.SpecialisedAssemblyParametricStudyTool):
    '''GearSetParametricStudyTool
    ...
    @property
    def gear_set_duty_cycle_results(self) -> 'List[_333.GearSetDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDutyCycleResults, constructor.new(_333.GearSetDutyCycleRating))
        return value
