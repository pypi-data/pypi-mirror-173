...
from mastapy.system_model.analyses_and_results.static_loads import _6652, _6760
from mastapy.system_model import _2075, _2070
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4242, _4243
from mastapy.system_model.analyses_and_results import _2508
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6760.ParametricStudyType':
        ...
        return constructor.new(_6760.ParametricStudyType)(value) if value is not None else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6760.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_2075.ExternalFullFELoader':
        ...
        return constructor.new(_2075.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader is not None else None

    @property
    def step_results(self) -> 'List[_4242.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4242.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4243.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4243.ParametricStudyVariable))
        return value

    @property
    def parametric_study_logging_variables(self) -> 'List[_2508.AnalysisCaseVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParametricStudyLoggingVariables, constructor.new(_2508.AnalysisCaseVariable))
        return value
    ...
    def data_logger_for(self, design_entity: '_2070.DesignEntity') -> '_1474.DataLogger':
    ...
    def add_study_variable(self, design_entity: '_2070.DesignEntity', path: 'List[str]') -> '_4243.ParametricStudyVariable':
    ...
    def remove_study_variable(self, study_variable: '_4243.ParametricStudyVariable'):
    ...
    def move_study_variable_up(self, study_variable: '_4243.ParametricStudyVariable'):
    ...
    def move_study_variable_down(self, study_variable: '_4243.ParametricStudyVariable'):
    ...
    def add_logging_variable(self, design_entity: '_2070.DesignEntity', path: 'List[str]') -> '_2508.AnalysisCaseVariable':
    ...
    def remove_logging_variable(self, analysis_variable: '_2508.AnalysisCaseVariable'):
