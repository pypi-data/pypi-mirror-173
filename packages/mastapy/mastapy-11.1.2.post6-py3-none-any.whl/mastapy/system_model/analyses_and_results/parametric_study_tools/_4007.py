...
class CylindricalGearMeshParametricStudyTool(_4025.GearMeshParametricStudyTool):
    '''CylindricalGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2409.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2409.CylindricalGearMeshSystemDeflection))
        return value
