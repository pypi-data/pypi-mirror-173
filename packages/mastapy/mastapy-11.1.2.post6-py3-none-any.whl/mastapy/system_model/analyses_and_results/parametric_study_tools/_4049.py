...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4048, _4047, _4054
...
class BevelDifferentialGearSetParametricStudyTool(_4054.BevelGearSetParametricStudyTool):
    """BevelDifferentialGearSetParametricStudyTool
    ...
    @property
    def bevel_differential_gears_parametric_study_tool(self) -> 'List[_4048.BevelDifferentialGearParametricStudyTool]':
    ...
    @property
    def bevel_differential_meshes_parametric_study_tool(self) -> 'List[_4047.BevelDifferentialGearMeshParametricStudyTool]':
