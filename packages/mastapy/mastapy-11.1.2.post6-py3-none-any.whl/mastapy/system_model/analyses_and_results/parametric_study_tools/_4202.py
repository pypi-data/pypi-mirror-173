...
class DutyCycleResultsForAllGearSets(_0.APIBase):
    ...
    @property
    def duty_cycle_results(self) -> '_1176.GearSetGroupDutyCycle':
        ...
        return constructor.new(_1176.GearSetGroupDutyCycle)(self.wrapped.DutyCycleResults) if self.wrapped.DutyCycleResults is not None else None
