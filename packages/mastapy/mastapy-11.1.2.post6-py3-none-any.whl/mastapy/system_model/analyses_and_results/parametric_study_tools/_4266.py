...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4265, _4264, _4165
...
class SpiralBevelGearSetParametricStudyTool(_4165.BevelGearSetParametricStudyTool):
    '''SpiralBevelGearSetParametricStudyTool
    ...
    @property
    def spiral_bevel_gears_parametric_study_tool(self) -> 'List[_4265.SpiralBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsParametricStudyTool, constructor.new(_4265.SpiralBevelGearParametricStudyTool))
        return value

    @property
    def spiral_bevel_meshes_parametric_study_tool(self) -> 'List[_4264.SpiralBevelGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesParametricStudyTool, constructor.new(_4264.SpiralBevelGearMeshParametricStudyTool))
        return value
