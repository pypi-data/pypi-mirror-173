...
class CylindricalGearParametricStudyTool(_4102.GearParametricStudyTool):
    """CylindricalGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2489.CylindricalGearSystemDeflection]':
