...
class CylindricalGearParametricStudyTool(_4213.GearParametricStudyTool):
    '''CylindricalGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2600.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2600.CylindricalGearSystemDeflection))
        return value
