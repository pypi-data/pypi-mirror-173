...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4116, _4115, _4111
...
class KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool(_4111.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool):
    """KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_parametric_study_tool(self) -> 'List[_4116.KlingelnbergCycloPalloidSpiralBevelGearParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_parametric_study_tool(self) -> 'List[_4115.KlingelnbergCycloPalloidSpiralBevelGearMeshParametricStudyTool]':
