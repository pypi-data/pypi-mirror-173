...
class ConnectionParametricStudyTool(_7183.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_4052.ParametricStudyTool':
        ...
        return constructor.new(_4052.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
