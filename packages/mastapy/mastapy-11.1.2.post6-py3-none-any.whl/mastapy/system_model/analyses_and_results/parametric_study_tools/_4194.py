...
class CylindricalGearMeshParametricStudyTool(_4212.GearMeshParametricStudyTool):
    '''CylindricalGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2594.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2594.CylindricalGearMeshSystemDeflection))
        return value
