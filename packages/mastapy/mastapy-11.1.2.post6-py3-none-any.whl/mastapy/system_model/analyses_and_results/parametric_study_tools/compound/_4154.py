...
class CylindricalGearCompoundParametricStudyTool(_4165.GearCompoundParametricStudyTool):
    '''CylindricalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4008.CylindricalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4008.CylindricalGearParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4008.CylindricalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4008.CylindricalGearParametricStudyTool))
        return value
