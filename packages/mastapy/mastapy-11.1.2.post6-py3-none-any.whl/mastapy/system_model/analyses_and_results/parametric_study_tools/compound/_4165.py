...
class GearCompoundParametricStudyTool(_4184.MountableComponentCompoundParametricStudyTool):
    '''GearCompoundParametricStudyTool
    ...
    @property
    def gear_duty_cycle_results(self) -> '_320.GearDutyCycleRating':
        ...
        if _320.GearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def gear_duty_cycle_results_of_type_worm_gear_duty_cycle_rating(self) -> '_334.WormGearDutyCycleRating':
        ...
        if _334.WormGearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def gear_duty_cycle_results_of_type_face_gear_duty_cycle_rating(self) -> '_407.FaceGearDutyCycleRating':
        ...
        if _407.FaceGearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def gear_duty_cycle_results_of_type_cylindrical_gear_duty_cycle_rating(self) -> '_414.CylindricalGearDutyCycleRating':
        ...
        if _414.CylindricalGearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def gear_duty_cycle_results_of_type_conical_gear_duty_cycle_rating(self) -> '_487.ConicalGearDutyCycleRating':
        ...
        if _487.ConicalGearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def gear_duty_cycle_results_of_type_concept_gear_duty_cycle_rating(self) -> '_497.ConceptGearDutyCycleRating':
        ...
        if _497.ConceptGearDutyCycleRating.TYPE not in self.wrapped.GearDutyCycleResults.__class__.__mro__:
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4026.GearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4026.GearParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4026.GearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4026.GearParametricStudyTool))
        return value
