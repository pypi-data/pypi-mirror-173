...
class ClutchHalfCompoundParametricStudyTool(_4146.CouplingHalfCompoundParametricStudyTool):
    '''ClutchHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3982.ClutchHalfParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3982.ClutchHalfParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3982.ClutchHalfParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3982.ClutchHalfParametricStudyTool))
        return value
