...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4309, _4310, _4201
...
class ZerolBevelGearSetCompoundParametricStudyTool(_4201.BevelGearSetCompoundParametricStudyTool):
    """ZerolBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4182.ZerolBevelGearSetParametricStudyTool]':
    ...
    @property
    def zerol_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4309.ZerolBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def zerol_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4310.ZerolBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4182.ZerolBevelGearSetParametricStudyTool]':
