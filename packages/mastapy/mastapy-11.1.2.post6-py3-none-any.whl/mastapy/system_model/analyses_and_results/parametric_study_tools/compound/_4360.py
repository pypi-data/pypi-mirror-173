...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4326
...
class KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool(_4326.ConicalGearCompoundParametricStudyTool):
    '''KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4221.KlingelnbergCycloPalloidConicalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4221.KlingelnbergCycloPalloidConicalGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4221.KlingelnbergCycloPalloidConicalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4221.KlingelnbergCycloPalloidConicalGearParametricStudyTool))
        return value
