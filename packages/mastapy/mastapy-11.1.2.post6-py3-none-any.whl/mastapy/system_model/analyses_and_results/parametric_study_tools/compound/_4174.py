...
class KlingelnbergCycloPalloidConicalGearMeshCompoundParametricStudyTool(_4140.ConicalGearMeshCompoundParametricStudyTool):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4033.KlingelnbergCycloPalloidConicalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4033.KlingelnbergCycloPalloidConicalGearMeshParametricStudyTool))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4033.KlingelnbergCycloPalloidConicalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4033.KlingelnbergCycloPalloidConicalGearMeshParametricStudyTool))
        return value
