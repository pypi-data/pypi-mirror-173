...
class SpringDamperHalfCompoundParametricStudyTool(_4222.CouplingHalfCompoundParametricStudyTool):
    """SpringDamperHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4157.SpringDamperHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4157.SpringDamperHalfParametricStudyTool]':
