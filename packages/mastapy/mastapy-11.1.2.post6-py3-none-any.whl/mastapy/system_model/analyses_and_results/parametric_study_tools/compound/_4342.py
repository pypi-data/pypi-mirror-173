...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4194
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4353
...
class CylindricalGearMeshCompoundParametricStudyTool(_4353.GearMeshCompoundParametricStudyTool):
    '''CylindricalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4194.CylindricalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4194.CylindricalGearMeshParametricStudyTool))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4194.CylindricalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4194.CylindricalGearMeshParametricStudyTool))
        return value
