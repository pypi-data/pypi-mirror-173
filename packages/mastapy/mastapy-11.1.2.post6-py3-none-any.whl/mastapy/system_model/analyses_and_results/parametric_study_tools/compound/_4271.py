...
class PulleyCompoundParametricStudyTool(_4222.CouplingHalfCompoundParametricStudyTool):
    """PulleyCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4142.PulleyParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4142.PulleyParametricStudyTool]':
