...
class AbstractAssemblyCompoundParametricStudyTool(_4186.PartCompoundParametricStudyTool):
    '''AbstractAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3960.AbstractAssemblyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3960.AbstractAssemblyParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3960.AbstractAssemblyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3960.AbstractAssemblyParametricStudyTool))
        return value
