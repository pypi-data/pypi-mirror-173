...
class FEPartCompoundParametricStudyTool(_4109.AbstractShaftOrHousingCompoundParametricStudyTool):
    '''FEPartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4023.FEPartParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4023.FEPartParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4023.FEPartParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4023.FEPartParametricStudyTool))
        return value
