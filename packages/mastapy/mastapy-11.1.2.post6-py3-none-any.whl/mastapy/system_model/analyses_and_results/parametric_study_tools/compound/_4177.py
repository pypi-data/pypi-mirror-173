...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundParametricStudyTool(_4174.KlingelnbergCycloPalloidConicalGearMeshCompoundParametricStudyTool):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4036.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4036.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4036.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4036.KlingelnbergCycloPalloidHypoidGearMeshParametricStudyTool))
        return value
