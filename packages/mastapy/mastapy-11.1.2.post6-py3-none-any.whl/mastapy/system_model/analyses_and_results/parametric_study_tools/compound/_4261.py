...
class OilSealCompoundParametricStudyTool(_4219.ConnectorCompoundParametricStudyTool):
    """OilSealCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4122.OilSealParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4122.OilSealParametricStudyTool]':
