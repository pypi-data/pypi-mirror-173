...
class MassDiscCompoundParametricStudyTool(_4229.VirtualComponentCompoundParametricStudyTool):
    '''MassDiscCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4042.MassDiscParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4042.MassDiscParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4042.MassDiscParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4042.MassDiscParametricStudyTool))
        return value
