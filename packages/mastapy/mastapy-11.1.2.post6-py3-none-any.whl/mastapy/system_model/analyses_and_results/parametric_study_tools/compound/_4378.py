...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4343
...
class PlanetaryGearSetCompoundParametricStudyTool(_4343.CylindricalGearSetCompoundParametricStudyTool):
    '''PlanetaryGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4249.PlanetaryGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4249.PlanetaryGearSetParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4249.PlanetaryGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4249.PlanetaryGearSetParametricStudyTool))
        return value
