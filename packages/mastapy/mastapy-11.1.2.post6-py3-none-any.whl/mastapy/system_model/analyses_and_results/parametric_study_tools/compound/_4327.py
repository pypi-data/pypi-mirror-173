...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4179
...
class ConicalGearMeshCompoundParametricStudyTool(_4353.GearMeshCompoundParametricStudyTool):
    '''ConicalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4179.ConicalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4179.ConicalGearMeshParametricStudyTool))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4179.ConicalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4179.ConicalGearMeshParametricStudyTool))
        return value
