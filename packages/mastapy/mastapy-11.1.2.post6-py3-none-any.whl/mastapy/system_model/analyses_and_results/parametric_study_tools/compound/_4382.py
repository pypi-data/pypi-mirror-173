...
class PulleyCompoundParametricStudyTool(_4333.CouplingHalfCompoundParametricStudyTool):
    '''PulleyCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4253.PulleyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4253.PulleyParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4253.PulleyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4253.PulleyParametricStudyTool))
        return value
