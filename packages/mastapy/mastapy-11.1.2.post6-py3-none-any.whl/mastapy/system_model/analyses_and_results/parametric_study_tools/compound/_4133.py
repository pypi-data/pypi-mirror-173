...
class ConceptCouplingCompoundParametricStudyTool(_4144.CouplingCompoundParametricStudyTool):
    '''ConceptCouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3988.ConceptCouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3988.ConceptCouplingParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3988.ConceptCouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3988.ConceptCouplingParametricStudyTool))
        return value
