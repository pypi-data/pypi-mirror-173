...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4195
...
class CylindricalGearCompoundParametricStudyTool(_4352.GearCompoundParametricStudyTool):
    '''CylindricalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4195.CylindricalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4195.CylindricalGearParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4195.CylindricalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4195.CylindricalGearParametricStudyTool))
        return value
