...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4177
...
class ConceptGearCompoundParametricStudyTool(_4352.GearCompoundParametricStudyTool):
    '''ConceptGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4177.ConceptGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4177.ConceptGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4177.ConceptGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4177.ConceptGearParametricStudyTool))
        return value
