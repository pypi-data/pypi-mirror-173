...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4224
...
class KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool(_4360.KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool):
    '''KlingelnbergCycloPalloidHypoidGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4224.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4224.KlingelnbergCycloPalloidHypoidGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4224.KlingelnbergCycloPalloidHypoidGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4224.KlingelnbergCycloPalloidHypoidGearParametricStudyTool))
        return value
