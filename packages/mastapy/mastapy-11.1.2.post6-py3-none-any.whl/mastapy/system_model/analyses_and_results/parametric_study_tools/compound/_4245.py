...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4187
...
class HypoidGearCompoundParametricStudyTool(_4187.AGMAGleasonConicalGearCompoundParametricStudyTool):
    """HypoidGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4106.HypoidGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4106.HypoidGearParametricStudyTool]':
