...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4183
...
class ConnectorCompoundParametricStudyTool(_4371.MountableComponentCompoundParametricStudyTool):
    '''ConnectorCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4183.ConnectorParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4183.ConnectorParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4183.ConnectorParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4183.ConnectorParametricStudyTool))
        return value
