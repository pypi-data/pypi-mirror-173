...
class TorqueConverterPumpCompoundParametricStudyTool(_4333.CouplingHalfCompoundParametricStudyTool):
    '''TorqueConverterPumpCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4284.TorqueConverterPumpParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4284.TorqueConverterPumpParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4284.TorqueConverterPumpParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4284.TorqueConverterPumpParametricStudyTool))
        return value
