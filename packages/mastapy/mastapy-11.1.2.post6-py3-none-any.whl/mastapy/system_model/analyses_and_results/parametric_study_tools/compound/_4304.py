...
class UnbalancedMassCompoundParametricStudyTool(_4305.VirtualComponentCompoundParametricStudyTool):
    """UnbalancedMassCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4175.UnbalancedMassParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4175.UnbalancedMassParametricStudyTool]':
