...
class ConnectorCompoundParametricStudyTool(_4184.MountableComponentCompoundParametricStudyTool):
    '''ConnectorCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3996.ConnectorParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3996.ConnectorParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3996.ConnectorParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3996.ConnectorParametricStudyTool))
        return value
