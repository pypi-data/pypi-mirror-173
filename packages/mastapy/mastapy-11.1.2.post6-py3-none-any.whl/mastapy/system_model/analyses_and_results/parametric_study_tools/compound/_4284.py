...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4282, _4283, _4201
...
class SpiralBevelGearSetCompoundParametricStudyTool(_4201.BevelGearSetCompoundParametricStudyTool):
    """SpiralBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4155.SpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def spiral_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4282.SpiralBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def spiral_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4283.SpiralBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4155.SpiralBevelGearSetParametricStudyTool]':
