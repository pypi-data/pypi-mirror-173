...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4207
...
class FaceGearMeshCompoundParametricStudyTool(_4353.GearMeshCompoundParametricStudyTool):
    '''FaceGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4207.FaceGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4207.FaceGearMeshParametricStudyTool))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4207.FaceGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4207.FaceGearMeshParametricStudyTool))
        return value
