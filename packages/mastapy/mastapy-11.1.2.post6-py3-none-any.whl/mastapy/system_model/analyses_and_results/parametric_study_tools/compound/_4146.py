...
class CouplingHalfCompoundParametricStudyTool(_4184.MountableComponentCompoundParametricStudyTool):
    '''CouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3998.CouplingHalfParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3998.CouplingHalfParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3998.CouplingHalfParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3998.CouplingHalfParametricStudyTool))
        return value
