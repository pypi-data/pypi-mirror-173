...
class ClutchConnectionCompoundParametricStudyTool(_4145.CouplingConnectionCompoundParametricStudyTool):
    '''ClutchConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3981.ClutchConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3981.ClutchConnectionParametricStudyTool))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3981.ClutchConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3981.ClutchConnectionParametricStudyTool))
        return value
