...
class BevelDifferentialGearCompoundParametricStudyTool(_4199.BevelGearCompoundParametricStudyTool):
    """BevelDifferentialGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4048.BevelDifferentialGearParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4048.BevelDifferentialGearParametricStudyTool]':
