...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4186
...
class CouplingCompoundParametricStudyTool(_4392.SpecialisedAssemblyCompoundParametricStudyTool):
    '''CouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4186.CouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4186.CouplingParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4186.CouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4186.CouplingParametricStudyTool))
        return value
