...
class ConceptCouplingHalfCompoundParametricStudyTool(_4222.CouplingHalfCompoundParametricStudyTool):
    """ConceptCouplingHalfCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4063.ConceptCouplingHalfParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4063.ConceptCouplingHalfParametricStudyTool]':
