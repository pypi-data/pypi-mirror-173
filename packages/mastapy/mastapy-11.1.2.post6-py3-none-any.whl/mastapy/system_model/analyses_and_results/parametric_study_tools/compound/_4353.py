...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4212
...
class GearMeshCompoundParametricStudyTool(_4359.InterMountableComponentConnectionCompoundParametricStudyTool):
    '''GearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4212.GearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4212.GearMeshParametricStudyTool))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4212.GearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4212.GearMeshParametricStudyTool))
        return value
