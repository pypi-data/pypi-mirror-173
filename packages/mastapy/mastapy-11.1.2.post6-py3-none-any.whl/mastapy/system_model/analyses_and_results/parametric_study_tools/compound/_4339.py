...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4192
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4295
...
class CycloidalDiscCompoundParametricStudyTool(_4295.AbstractShaftCompoundParametricStudyTool):
    '''CycloidalDiscCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4192.CycloidalDiscParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4192.CycloidalDiscParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4192.CycloidalDiscParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4192.CycloidalDiscParametricStudyTool))
        return value
