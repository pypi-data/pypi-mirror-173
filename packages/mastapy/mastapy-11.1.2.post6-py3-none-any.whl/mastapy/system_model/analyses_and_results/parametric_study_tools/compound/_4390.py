...
class ShaftHubConnectionCompoundParametricStudyTool(_4330.ConnectorCompoundParametricStudyTool):
    '''ShaftHubConnectionCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4260.ShaftHubConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4260.ShaftHubConnectionParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4260.ShaftHubConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4260.ShaftHubConnectionParametricStudyTool))
        return value
