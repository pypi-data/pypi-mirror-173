...
class ShaftCompoundParametricStudyTool(_4295.AbstractShaftCompoundParametricStudyTool):
    '''ShaftCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4261.ShaftParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4261.ShaftParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4261.ShaftParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4261.ShaftParametricStudyTool))
        return value
