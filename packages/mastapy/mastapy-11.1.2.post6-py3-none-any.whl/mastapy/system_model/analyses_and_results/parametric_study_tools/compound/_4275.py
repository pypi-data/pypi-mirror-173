...
class RollingRingCompoundParametricStudyTool(_4222.CouplingHalfCompoundParametricStudyTool):
    """RollingRingCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4147.RollingRingParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4147.RollingRingParametricStudyTool]':
