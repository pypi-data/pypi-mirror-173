...
class ConceptCouplingConnectionCompoundParametricStudyTool(_4221.CouplingConnectionCompoundParametricStudyTool):
    """ConceptCouplingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4062.ConceptCouplingConnectionParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4062.ConceptCouplingConnectionParametricStudyTool]':
