...
class PlanetCarrierCompoundParametricStudyTool(_4371.MountableComponentCompoundParametricStudyTool):
    '''PlanetCarrierCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4250.PlanetCarrierParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4250.PlanetCarrierParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4250.PlanetCarrierParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4250.PlanetCarrierParametricStudyTool))
        return value
