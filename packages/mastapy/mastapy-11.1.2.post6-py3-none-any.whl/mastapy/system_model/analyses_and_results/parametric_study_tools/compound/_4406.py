...
class StraightBevelSunGearCompoundParametricStudyTool(_4399.StraightBevelDiffGearCompoundParametricStudyTool):
    '''StraightBevelSunGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4277.StraightBevelSunGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4277.StraightBevelSunGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4277.StraightBevelSunGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4277.StraightBevelSunGearParametricStudyTool))
        return value
