...
class AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool(_4142.ConnectionCompoundParametricStudyTool):
    '''AbstractShaftToMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3963.AbstractShaftToMountableComponentConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3963.AbstractShaftToMountableComponentConnectionParametricStudyTool))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3963.AbstractShaftToMountableComponentConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3963.AbstractShaftToMountableComponentConnectionParametricStudyTool))
        return value
