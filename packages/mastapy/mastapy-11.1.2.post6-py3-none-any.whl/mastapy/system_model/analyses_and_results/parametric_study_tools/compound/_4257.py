...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4255, _4256, _4251
...
class KlingelnbergCycloPalloidSpiralBevelGearSetCompoundParametricStudyTool(_4251.KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool):
    """KlingelnbergCycloPalloidSpiralBevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4117.KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_compound_parametric_study_tool(self) -> 'List[_4255.KlingelnbergCycloPalloidSpiralBevelGearCompoundParametricStudyTool]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_compound_parametric_study_tool(self) -> 'List[_4256.KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4117.KlingelnbergCycloPalloidSpiralBevelGearSetParametricStudyTool]':
