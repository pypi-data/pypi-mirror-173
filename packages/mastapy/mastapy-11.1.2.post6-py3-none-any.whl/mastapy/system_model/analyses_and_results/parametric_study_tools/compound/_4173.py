...
class KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool(_4139.ConicalGearCompoundParametricStudyTool):
    '''KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4034.KlingelnbergCycloPalloidConicalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4034.KlingelnbergCycloPalloidConicalGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4034.KlingelnbergCycloPalloidConicalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4034.KlingelnbergCycloPalloidConicalGearParametricStudyTool))
        return value
