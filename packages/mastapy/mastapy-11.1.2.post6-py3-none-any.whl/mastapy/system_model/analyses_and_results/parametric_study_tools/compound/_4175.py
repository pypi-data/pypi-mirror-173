...
class KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool(_4141.ConicalGearSetCompoundParametricStudyTool):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4035.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4035.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4035.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4035.KlingelnbergCycloPalloidConicalGearSetParametricStudyTool))
        return value
