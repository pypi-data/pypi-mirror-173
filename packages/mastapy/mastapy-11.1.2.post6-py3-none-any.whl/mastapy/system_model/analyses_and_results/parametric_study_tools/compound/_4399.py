...
class StraightBevelDiffGearCompoundParametricStudyTool(_4310.BevelGearCompoundParametricStudyTool):
    '''StraightBevelDiffGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4271.StraightBevelDiffGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4271.StraightBevelDiffGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4271.StraightBevelDiffGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4271.StraightBevelDiffGearParametricStudyTool))
        return value
