...
class ComponentCompoundParametricStudyTool(_4186.PartCompoundParametricStudyTool):
    '''ComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3985.ComponentParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3985.ComponentParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3985.ComponentParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3985.ComponentParametricStudyTool))
        return value
