...
class StraightBevelGearCompoundParametricStudyTool(_4310.BevelGearCompoundParametricStudyTool):
    '''StraightBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4274.StraightBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4274.StraightBevelGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4274.StraightBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4274.StraightBevelGearParametricStudyTool))
        return value
