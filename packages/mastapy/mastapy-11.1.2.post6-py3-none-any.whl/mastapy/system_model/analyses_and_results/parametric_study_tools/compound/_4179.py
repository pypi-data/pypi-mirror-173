...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundParametricStudyTool(_4173.KlingelnbergCycloPalloidConicalGearCompoundParametricStudyTool):
    '''KlingelnbergCycloPalloidSpiralBevelGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4040.KlingelnbergCycloPalloidSpiralBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4040.KlingelnbergCycloPalloidSpiralBevelGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4040.KlingelnbergCycloPalloidSpiralBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4040.KlingelnbergCycloPalloidSpiralBevelGearParametricStudyTool))
        return value
