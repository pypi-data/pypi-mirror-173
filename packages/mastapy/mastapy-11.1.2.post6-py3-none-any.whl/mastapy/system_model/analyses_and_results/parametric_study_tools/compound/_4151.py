...
class CycloidalDiscCentralBearingConnectionCompoundParametricStudyTool(_4131.CoaxialConnectionCompoundParametricStudyTool):
    '''CycloidalDiscCentralBearingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4004.CycloidalDiscCentralBearingConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4004.CycloidalDiscCentralBearingConnectionParametricStudyTool))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4004.CycloidalDiscCentralBearingConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4004.CycloidalDiscCentralBearingConnectionParametricStudyTool))
        return value
