...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4198
...
class DatumCompoundParametricStudyTool(_4319.ComponentCompoundParametricStudyTool):
    '''DatumCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4198.DatumParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4198.DatumParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4198.DatumParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4198.DatumParametricStudyTool))
        return value
