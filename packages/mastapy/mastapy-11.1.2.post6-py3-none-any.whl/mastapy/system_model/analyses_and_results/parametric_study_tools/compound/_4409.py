...
class SynchroniserPartCompoundParametricStudyTool(_4333.CouplingHalfCompoundParametricStudyTool):
    '''SynchroniserPartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4280.SynchroniserPartParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4280.SynchroniserPartParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4280.SynchroniserPartParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4280.SynchroniserPartParametricStudyTool))
        return value
