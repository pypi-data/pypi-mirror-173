...
class BevelGearSetCompoundParametricStudyTool(_4113.AGMAGleasonConicalGearSetCompoundParametricStudyTool):
    '''BevelGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3978.BevelGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3978.BevelGearSetParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3978.BevelGearSetParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3978.BevelGearSetParametricStudyTool))
        return value
