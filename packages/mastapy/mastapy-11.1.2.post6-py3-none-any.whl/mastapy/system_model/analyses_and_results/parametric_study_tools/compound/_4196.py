...
class BevelDifferentialGearSetCompoundParametricStudyTool(_4201.BevelGearSetCompoundParametricStudyTool):
    """BevelDifferentialGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4049.BevelDifferentialGearSetParametricStudyTool]':
    ...
    @property
    def bevel_differential_gears_compound_parametric_study_tool(self) -> 'List[_4194.BevelDifferentialGearCompoundParametricStudyTool]':
    ...
    @property
    def bevel_differential_meshes_compound_parametric_study_tool(self) -> 'List[_4195.BevelDifferentialGearMeshCompoundParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4049.BevelDifferentialGearSetParametricStudyTool]':
