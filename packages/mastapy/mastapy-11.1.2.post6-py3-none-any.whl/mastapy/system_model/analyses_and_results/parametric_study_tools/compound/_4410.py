...
class SynchroniserSleeveCompoundParametricStudyTool(_4409.SynchroniserPartCompoundParametricStudyTool):
    '''SynchroniserSleeveCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4281.SynchroniserSleeveParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4281.SynchroniserSleeveParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4281.SynchroniserSleeveParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4281.SynchroniserSleeveParametricStudyTool))
        return value
