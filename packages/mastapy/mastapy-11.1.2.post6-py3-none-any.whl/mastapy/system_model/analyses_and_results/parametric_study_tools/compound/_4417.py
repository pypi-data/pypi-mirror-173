...
class WormGearCompoundParametricStudyTool(_4352.GearCompoundParametricStudyTool):
    '''WormGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4289.WormGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4289.WormGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4289.WormGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4289.WormGearParametricStudyTool))
        return value
