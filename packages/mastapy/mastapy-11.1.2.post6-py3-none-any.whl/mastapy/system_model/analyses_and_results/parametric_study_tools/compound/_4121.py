...
class BevelDifferentialPlanetGearCompoundParametricStudyTool(_4118.BevelDifferentialGearCompoundParametricStudyTool):
    '''BevelDifferentialPlanetGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3974.BevelDifferentialPlanetGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3974.BevelDifferentialPlanetGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3974.BevelDifferentialPlanetGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3974.BevelDifferentialPlanetGearParametricStudyTool))
        return value
