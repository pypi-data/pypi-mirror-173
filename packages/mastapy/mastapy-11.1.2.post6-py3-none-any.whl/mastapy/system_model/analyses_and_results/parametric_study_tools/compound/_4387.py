...
class RollingRingConnectionCompoundParametricStudyTool(_4359.InterMountableComponentConnectionCompoundParametricStudyTool):
    '''RollingRingConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4257.RollingRingConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4257.RollingRingConnectionParametricStudyTool))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4257.RollingRingConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4257.RollingRingConnectionParametricStudyTool))
        return value
