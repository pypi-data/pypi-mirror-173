...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4327
...
class KlingelnbergCycloPalloidConicalGearMeshCompoundParametricStudyTool(_4327.ConicalGearMeshCompoundParametricStudyTool):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4220.KlingelnbergCycloPalloidConicalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4220.KlingelnbergCycloPalloidConicalGearMeshParametricStudyTool))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4220.KlingelnbergCycloPalloidConicalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4220.KlingelnbergCycloPalloidConicalGearMeshParametricStudyTool))
        return value
