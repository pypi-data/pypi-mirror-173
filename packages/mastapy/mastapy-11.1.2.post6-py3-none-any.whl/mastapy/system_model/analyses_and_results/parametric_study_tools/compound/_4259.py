...
class MeasurementComponentCompoundParametricStudyTool(_4305.VirtualComponentCompoundParametricStudyTool):
    """MeasurementComponentCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4119.MeasurementComponentParametricStudyTool]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4119.MeasurementComponentParametricStudyTool]':
