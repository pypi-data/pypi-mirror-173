...
class DatumCompoundParametricStudyTool(_4132.ComponentCompoundParametricStudyTool):
    '''DatumCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4011.DatumParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4011.DatumParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4011.DatumParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4011.DatumParametricStudyTool))
        return value
