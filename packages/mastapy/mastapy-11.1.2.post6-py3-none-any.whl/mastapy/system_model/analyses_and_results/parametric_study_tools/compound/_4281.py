...
class SpecialisedAssemblyCompoundParametricStudyTool(_4183.AbstractAssemblyCompoundParametricStudyTool):
    """SpecialisedAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4152.SpecialisedAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4152.SpecialisedAssemblyParametricStudyTool]':
