...
class AbstractShaftOrHousingCompoundParametricStudyTool(_4132.ComponentCompoundParametricStudyTool):
    '''AbstractShaftOrHousingCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3961.AbstractShaftOrHousingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3961.AbstractShaftOrHousingParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3961.AbstractShaftOrHousingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3961.AbstractShaftOrHousingParametricStudyTool))
        return value
