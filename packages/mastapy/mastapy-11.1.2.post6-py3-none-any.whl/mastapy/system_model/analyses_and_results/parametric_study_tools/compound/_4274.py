...
class RollingRingAssemblyCompoundParametricStudyTool(_4281.SpecialisedAssemblyCompoundParametricStudyTool):
    """RollingRingAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4145.RollingRingAssemblyParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4145.RollingRingAssemblyParametricStudyTool]':
