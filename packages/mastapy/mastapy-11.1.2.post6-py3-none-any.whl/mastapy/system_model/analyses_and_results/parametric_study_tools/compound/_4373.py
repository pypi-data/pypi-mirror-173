...
class PartCompoundParametricStudyTool(_7377.PartCompoundAnalysis):
    '''PartCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4244.PartParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4244.PartParametricStudyTool))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4244.PartParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4244.PartParametricStudyTool))
        return value
