...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4294
...
class SpecialisedAssemblyCompoundParametricStudyTool(_4294.AbstractAssemblyCompoundParametricStudyTool):
    '''SpecialisedAssemblyCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4263.SpecialisedAssemblyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4263.SpecialisedAssemblyParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4263.SpecialisedAssemblyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4263.SpecialisedAssemblyParametricStudyTool))
        return value
