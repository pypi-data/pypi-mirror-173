...
class AGMAGleasonConicalGearSetCompoundParametricStudyTool(_4217.ConicalGearSetCompoundParametricStudyTool):
    """AGMAGleasonConicalGearSetCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4042.AGMAGleasonConicalGearSetParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4042.AGMAGleasonConicalGearSetParametricStudyTool]':
