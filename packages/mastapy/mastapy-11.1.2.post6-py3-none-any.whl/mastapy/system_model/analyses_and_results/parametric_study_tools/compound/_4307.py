...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4242
...
class WormGearMeshCompoundParametricStudyTool(_4242.GearMeshCompoundParametricStudyTool):
    """WormGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4177.WormGearMeshParametricStudyTool]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4177.WormGearMeshParametricStudyTool]':
