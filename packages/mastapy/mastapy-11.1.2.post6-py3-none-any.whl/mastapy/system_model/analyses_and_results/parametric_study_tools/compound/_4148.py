...
class CVTCompoundParametricStudyTool(_4117.BeltDriveCompoundParametricStudyTool):
    '''CVTCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4001.CVTParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4001.CVTParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4001.CVTParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4001.CVTParametricStudyTool))
        return value
