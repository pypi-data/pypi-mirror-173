...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4329
...
class InterMountableComponentConnectionCompoundParametricStudyTool(_4329.ConnectionCompoundParametricStudyTool):
    '''InterMountableComponentConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4219.InterMountableComponentConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4219.InterMountableComponentConnectionParametricStudyTool))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4219.InterMountableComponentConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4219.InterMountableComponentConnectionParametricStudyTool))
        return value
