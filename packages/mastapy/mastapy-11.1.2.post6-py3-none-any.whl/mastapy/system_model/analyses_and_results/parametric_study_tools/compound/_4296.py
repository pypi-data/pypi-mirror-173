...
class SynchroniserCompoundParametricStudyTool(_4281.SpecialisedAssemblyCompoundParametricStudyTool):
    """SynchroniserCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4168.SynchroniserParametricStudyTool]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4168.SynchroniserParametricStudyTool]':
