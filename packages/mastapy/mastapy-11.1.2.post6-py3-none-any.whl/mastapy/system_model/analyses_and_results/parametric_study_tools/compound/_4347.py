...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4208
...
class FaceGearCompoundParametricStudyTool(_4352.GearCompoundParametricStudyTool):
    '''FaceGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4208.FaceGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4208.FaceGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4208.FaceGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4208.FaceGearParametricStudyTool))
        return value
