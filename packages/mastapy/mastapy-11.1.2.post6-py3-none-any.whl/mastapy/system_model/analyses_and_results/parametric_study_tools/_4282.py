...
class TorqueConverterConnectionParametricStudyTool(_4184.CouplingConnectionParametricStudyTool):
    '''TorqueConverterConnectionParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2683.TorqueConverterConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2683.TorqueConverterConnectionSystemDeflection))
        return value
