...
class GearParametricStudyTool(_4045.MountableComponentParametricStudyTool):
    ...
    @property
    def gear_duty_cycle_results(self) -> 'List[_320.GearDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearDutyCycleResults, constructor.new(_320.GearDutyCycleRating))
        return value
