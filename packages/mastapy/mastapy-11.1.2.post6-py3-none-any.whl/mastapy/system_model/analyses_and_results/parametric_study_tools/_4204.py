...
from mastapy.bearings.bearing_results import _1821, _1829, _1832
from mastapy._internal import constructor
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling import (
    _1860, _1867, _1875, _1891,
    _1915
)
...
class DutyCycleResultsForSingleBearing(_0.APIBase):
    ...
    @property
    def duty_cycle_results(self) -> '_1821.LoadedBearingDutyCycle':
        ...
        if _1821.LoadedBearingDutyCycle.TYPE not in self.wrapped.DutyCycleResults.__class__.__mro__:
