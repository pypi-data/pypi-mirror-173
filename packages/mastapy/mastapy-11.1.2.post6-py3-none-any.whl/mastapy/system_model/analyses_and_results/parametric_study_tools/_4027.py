...
class GearSetParametricStudyTool(_4076.SpecialisedAssemblyParametricStudyTool):
    '''GearSetParametricStudyTool
    ...
    @property
    def gear_set_duty_cycle_results(self) -> 'List[_324.GearSetDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDutyCycleResults, constructor.new(_324.GearSetDutyCycleRating))
        return value
