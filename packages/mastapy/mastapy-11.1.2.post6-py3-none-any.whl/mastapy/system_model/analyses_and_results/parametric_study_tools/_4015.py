...
class DutyCycleResultsForAllGearSets(_0.APIBase):
    ...
    @property
    def duty_cycle_results(self) -> '_1137.GearSetGroupDutyCycle':
        ...
        return constructor.new(_1137.GearSetGroupDutyCycle)(self.wrapped.DutyCycleResults) if self.wrapped.DutyCycleResults else None
