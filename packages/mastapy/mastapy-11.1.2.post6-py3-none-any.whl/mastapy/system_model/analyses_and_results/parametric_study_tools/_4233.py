...
class OilSealParametricStudyTool(_4183.ConnectorParametricStudyTool):
    '''OilSealParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2639.OilSealSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2639.OilSealSystemDeflection))
        return value
