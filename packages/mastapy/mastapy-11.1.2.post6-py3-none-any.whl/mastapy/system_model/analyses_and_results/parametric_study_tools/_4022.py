...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4021, _4020, _4027
...
class FaceGearSetParametricStudyTool(_4027.GearSetParametricStudyTool):
    '''FaceGearSetParametricStudyTool
    ...
    @property
    def face_gears_parametric_study_tool(self) -> 'List[_4021.FaceGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsParametricStudyTool, constructor.new(_4021.FaceGearParametricStudyTool))
        return value

    @property
    def face_meshes_parametric_study_tool(self) -> 'List[_4020.FaceGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesParametricStudyTool, constructor.new(_4020.FaceGearMeshParametricStudyTool))
        return value
