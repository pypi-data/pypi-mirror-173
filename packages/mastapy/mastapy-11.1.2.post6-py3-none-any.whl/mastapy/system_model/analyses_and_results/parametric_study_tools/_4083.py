...
class CylindricalGearMeshParametricStudyTool(_4101.GearMeshParametricStudyTool):
    """CylindricalGearMeshParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2483.CylindricalGearMeshSystemDeflection]':
