...
from mastapy.utility import _1482
...
class Context(_0.APIBase):
    ...
    @property
    def save_history_information(self) -> '_1482.FileHistoryItem':
        ...
        return constructor.new(_1482.FileHistoryItem)(self.wrapped.SaveHistoryInformation) if self.wrapped.SaveHistoryInformation is not None else None
