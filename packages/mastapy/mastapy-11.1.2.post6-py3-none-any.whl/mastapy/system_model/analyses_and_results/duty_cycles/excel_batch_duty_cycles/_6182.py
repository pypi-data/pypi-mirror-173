...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6186, _6183, _6185
from mastapy.utility import _1356
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6186.MASTAFileDetails':
        ...
        return constructor.new(_6186.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails else None

    @property
    def excel_file_details(self) -> '_6183.ExcelFileDetails':
        ...
        return constructor.new(_6183.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails else None

    @property
    def working_folder(self) -> '_1356.SelectableFolder':
        ...
        return constructor.new(_1356.SelectableFolder)(self.wrapped.WorkingFolder) if self.wrapped.WorkingFolder else None

    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6185.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6185.ExcelSheetDesignStateSelector))
        return value
