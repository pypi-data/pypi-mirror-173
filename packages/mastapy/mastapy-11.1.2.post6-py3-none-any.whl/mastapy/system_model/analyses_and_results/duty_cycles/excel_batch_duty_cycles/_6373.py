...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6377, _6374, _6376
from mastapy.utility import _1494
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6377.MASTAFileDetails':
        ...
        return constructor.new(_6377.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails is not None else None

    @property
    def excel_file_details(self) -> '_6374.ExcelFileDetails':
        ...
        return constructor.new(_6374.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails is not None else None

    @property
    def working_folder(self) -> '_1494.SelectableFolder':
        ...
        return constructor.new(_1494.SelectableFolder)(self.wrapped.WorkingFolder) if self.wrapped.WorkingFolder is not None else None

    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6376.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6376.ExcelSheetDesignStateSelector))
        return value
