...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6224, _6221, _6223
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6224.MASTAFileDetails':
        ...
        return constructor.new(_6224.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails else None

    @property
    def excel_file_details(self) -> '_6221.ExcelFileDetails':
        ...
        return constructor.new(_6221.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails else None

    @property
    def working_folder(self) -> '_1374.SelectableFolder':
        ...
        return constructor.new(_1374.SelectableFolder)(self.wrapped.WorkingFolder) if self.wrapped.WorkingFolder else None

    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6223.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6223.ExcelSheetDesignStateSelector))
        return value
