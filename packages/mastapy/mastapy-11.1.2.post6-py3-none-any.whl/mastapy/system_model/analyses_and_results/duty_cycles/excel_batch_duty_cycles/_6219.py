...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6220
...
class ExcelBatchDutyCycleCreator(_0.APIBase):
    ...
    @property
    def batch_details(self) -> '_6220.ExcelBatchDutyCycleSpectraCreatorDetails':
        ...
        return constructor.new(_6220.ExcelBatchDutyCycleSpectraCreatorDetails)(self.wrapped.BatchDetails) if self.wrapped.BatchDetails else None
