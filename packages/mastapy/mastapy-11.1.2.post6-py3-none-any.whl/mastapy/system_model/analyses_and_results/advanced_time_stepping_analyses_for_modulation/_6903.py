...
class GuideDxfModelAdvancedTimeSteppingAnalysisForModulation(_6867.ComponentAdvancedTimeSteppingAnalysisForModulation):
    '''GuideDxfModelAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2617.GuideDxfModelSystemDeflection':
        ...
        return constructor.new(_2617.GuideDxfModelSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
