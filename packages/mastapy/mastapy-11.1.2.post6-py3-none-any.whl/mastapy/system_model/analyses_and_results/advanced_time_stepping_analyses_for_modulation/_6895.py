...
class FaceGearAdvancedTimeSteppingAnalysisForModulation(_6900.GearAdvancedTimeSteppingAnalysisForModulation):
    '''FaceGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2611.FaceGearSystemDeflection':
        ...
        return constructor.new(_2611.FaceGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
