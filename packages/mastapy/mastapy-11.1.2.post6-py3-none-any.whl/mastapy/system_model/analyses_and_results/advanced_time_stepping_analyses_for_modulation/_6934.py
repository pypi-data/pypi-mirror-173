...
class RollingRingAdvancedTimeSteppingAnalysisForModulation(_6881.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    '''RollingRingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2654.RollingRingSystemDeflection':
        ...
        return constructor.new(_2654.RollingRingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
