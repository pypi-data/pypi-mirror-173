...
class BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation(_6673.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2371.BevelDifferentialGearMeshSystemDeflection':
        ...
        return constructor.new(_2371.BevelDifferentialGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
