...
class ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation(_6858.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    '''ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2696.ZerolBevelGearSystemDeflection':
        ...
        return constructor.new(_2696.ZerolBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
