...
class SynchroniserAdvancedTimeSteppingAnalysisForModulation(_6941.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''SynchroniserAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2679.SynchroniserSystemDeflection':
        ...
        return constructor.new(_2679.SynchroniserSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
