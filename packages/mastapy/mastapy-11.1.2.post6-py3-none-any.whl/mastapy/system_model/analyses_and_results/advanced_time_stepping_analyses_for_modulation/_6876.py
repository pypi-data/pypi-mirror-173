...
class ConicalGearSetAdvancedTimeSteppingAnalysisForModulation(_6902.GearSetAdvancedTimeSteppingAnalysisForModulation):
    '''ConicalGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_design(self) -> '_2384.ConicalGearSet':
    ...
    @property
    def system_deflection_results(self) -> '_2580.ConicalGearSetSystemDeflection':
