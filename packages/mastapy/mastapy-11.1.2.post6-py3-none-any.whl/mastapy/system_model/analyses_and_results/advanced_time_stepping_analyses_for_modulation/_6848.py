...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6846, _6847, _6755
...
class StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6755.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2561.StraightBevelGearSetSystemDeflection':
    ...
    @property
    def straight_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6846.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6847.StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
