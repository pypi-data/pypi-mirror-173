...
class GearAdvancedTimeSteppingAnalysisForModulation(_6920.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    '''GearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2616.GearSystemDeflection':
