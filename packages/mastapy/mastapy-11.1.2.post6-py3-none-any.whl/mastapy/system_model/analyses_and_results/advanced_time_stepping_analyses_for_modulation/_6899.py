...
class FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation(_6941.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2613.FlexiblePinAssemblySystemDeflection':
        ...
        return constructor.new(_2613.FlexiblePinAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
