...
class BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation(_6755.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def bevel_differential_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6748.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def bevel_differential_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6749.BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation]':
