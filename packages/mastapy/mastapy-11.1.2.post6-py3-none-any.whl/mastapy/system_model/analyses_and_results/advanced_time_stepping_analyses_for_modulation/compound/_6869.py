...
class AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation(_6892.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    """AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6735.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6735.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation]':
