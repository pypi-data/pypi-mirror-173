...
class AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation(_6788.AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''AbstractShaftCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6653.AbstractShaftAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6653.AbstractShaftAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6653.AbstractShaftAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6653.AbstractShaftAdvancedTimeSteppingAnalysisForModulation))
        return value
