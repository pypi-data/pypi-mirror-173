...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6918
...
class MassDiscCompoundAdvancedTimeSteppingAnalysisForModulation(_7094.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''MassDiscCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6918.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6918.MassDiscAdvancedTimeSteppingAnalysisForModulation))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6918.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6918.MassDiscAdvancedTimeSteppingAnalysisForModulation))
        return value
