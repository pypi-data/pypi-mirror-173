...
class CouplingCompoundAdvancedTimeSteppingAnalysisForModulation(_7070.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''CouplingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6879.CouplingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6879.CouplingAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6879.CouplingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6879.CouplingAdvancedTimeSteppingAnalysisForModulation))
        return value
