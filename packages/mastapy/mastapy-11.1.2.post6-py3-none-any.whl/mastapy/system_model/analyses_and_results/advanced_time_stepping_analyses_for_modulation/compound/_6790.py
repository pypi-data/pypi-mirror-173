...
class AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation(_6818.ConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6659.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6659.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6659.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6659.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation))
        return value
