...
class ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation(_6863.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''ConnectorCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6692.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6692.ConnectorAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6692.ConnectorAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6692.ConnectorAdvancedTimeSteppingAnalysisForModulation))
        return value
