...
class AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation(_6811.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''AbstractShaftOrHousingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6654.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6654.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6654.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6654.AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation))
        return value
