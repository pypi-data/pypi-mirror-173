...
class VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_7049.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6965.VirtualComponentAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6965.VirtualComponentAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6965.VirtualComponentAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6965.VirtualComponentAdvancedTimeSteppingAnalysisForModulation))
        return value
