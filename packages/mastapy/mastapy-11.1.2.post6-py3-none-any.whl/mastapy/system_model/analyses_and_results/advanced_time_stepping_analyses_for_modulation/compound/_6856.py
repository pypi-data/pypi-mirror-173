...
class ComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_6910.PartCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''ComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6726.ComponentAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6726.ComponentAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6726.ComponentAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6726.ComponentAdvancedTimeSteppingAnalysisForModulation))
        return value
