...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6870
...
class ConceptCouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation(_7011.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''ConceptCouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6870.ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6870.ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6870.ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6870.ConceptCouplingHalfAdvancedTimeSteppingAnalysisForModulation))
        return value
