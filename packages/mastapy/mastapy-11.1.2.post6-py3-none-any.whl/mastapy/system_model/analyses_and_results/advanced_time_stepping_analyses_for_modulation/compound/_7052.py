...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6923
...
class PartToPartShearCouplingCompoundAdvancedTimeSteppingAnalysisForModulation(_7009.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''PartToPartShearCouplingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6923.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6923.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6923.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6923.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation))
        return value
