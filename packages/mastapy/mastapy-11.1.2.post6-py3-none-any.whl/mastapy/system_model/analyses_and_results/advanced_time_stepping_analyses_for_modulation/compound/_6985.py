...
from mastapy.system_model.connections_and_sockets.couplings import _2103
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6856
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _6905
...
class TorqueConverterConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_6905.CouplingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2103.TorqueConverterConnection':
    ...
    @property
    def connection_design(self) -> '_2103.TorqueConverterConnection':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6856.TorqueConverterConnectionAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6856.TorqueConverterConnectionAdvancedTimeSteppingAnalysisForModulation]':
