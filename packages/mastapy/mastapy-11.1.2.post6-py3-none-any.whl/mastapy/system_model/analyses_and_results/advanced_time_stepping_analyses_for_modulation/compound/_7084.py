...
class StraightBevelSunGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7077.StraightBevelDiffGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelSunGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6955.StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6955.StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6955.StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6955.StraightBevelSunGearAdvancedTimeSteppingAnalysisForModulation))
        return value
