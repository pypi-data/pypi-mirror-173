...
class AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation(_6863.ConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6704.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6704.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6704.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6704.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation))
        return value
