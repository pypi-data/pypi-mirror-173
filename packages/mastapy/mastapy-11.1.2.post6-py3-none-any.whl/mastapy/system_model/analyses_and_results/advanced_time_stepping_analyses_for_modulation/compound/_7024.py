...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6894
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation.compound import _6997
...
class ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation(_6997.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''ExternalCADModelCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6894.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6894.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6894.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6894.ExternalCADModelAdvancedTimeSteppingAnalysisForModulation))
        return value
