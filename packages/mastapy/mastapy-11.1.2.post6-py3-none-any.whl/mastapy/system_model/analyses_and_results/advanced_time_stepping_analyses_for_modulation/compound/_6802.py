...
class BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation(_6790.AGMAGleasonConicalGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6672.BevelGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6672.BevelGearAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6672.BevelGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6672.BevelGearAdvancedTimeSteppingAnalysisForModulation))
        return value
