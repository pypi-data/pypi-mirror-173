...
class CouplingCompoundAdvancedTimeSteppingAnalysisForModulation(_6884.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''CouplingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6693.CouplingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6693.CouplingAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6693.CouplingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6693.CouplingAdvancedTimeSteppingAnalysisForModulation))
        return value
