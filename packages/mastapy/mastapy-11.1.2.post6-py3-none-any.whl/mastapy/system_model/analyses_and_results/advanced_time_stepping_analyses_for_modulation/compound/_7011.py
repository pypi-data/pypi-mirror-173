...
class CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation(_7049.MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6881.CouplingHalfAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6881.CouplingHalfAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6881.CouplingHalfAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6881.CouplingHalfAdvancedTimeSteppingAnalysisForModulation))
        return value
