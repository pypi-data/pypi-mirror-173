...
class CylindricalGearCompoundAdvancedTimeSteppingAnalysisForModulation(_7030.GearCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''CylindricalGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6889.CylindricalGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6889.CylindricalGearAdvancedTimeSteppingAnalysisForModulation))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6889.CylindricalGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6889.CylindricalGearAdvancedTimeSteppingAnalysisForModulation))
        return value
