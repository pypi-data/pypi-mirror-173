...
class VirtualComponentAdvancedTimeSteppingAnalysisForModulation(_6920.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    '''VirtualComponentAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2690.VirtualComponentSystemDeflection':
