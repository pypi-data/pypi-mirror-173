...
class PartToPartShearCouplingHalfAdvancedTimeSteppingAnalysisForModulation(_6881.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    '''PartToPartShearCouplingHalfAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2642.PartToPartShearCouplingHalfSystemDeflection':
        ...
        return constructor.new(_2642.PartToPartShearCouplingHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
