...
class BearingAdvancedTimeSteppingAnalysisForModulation(_6692.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    '''BearingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2368.BearingSystemDeflection':
        ...
        return constructor.new(_2368.BearingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
