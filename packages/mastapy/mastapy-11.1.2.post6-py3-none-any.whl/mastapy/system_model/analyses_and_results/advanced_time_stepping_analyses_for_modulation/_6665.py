...
from mastapy.system_model.analyses_and_results.static_loads import _6462, _6495
from mastapy.system_model.analyses_and_results.system_deflections import _2369, _2402
...
class BeltConnectionAdvancedTimeSteppingAnalysisForModulation(_6722.InterMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''BeltConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6462.BeltConnectionLoadCase':
        ...
        if _6462.BeltConnectionLoadCase.TYPE not in self.wrapped.ConnectionLoadCase.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2369.BeltConnectionSystemDeflection':
