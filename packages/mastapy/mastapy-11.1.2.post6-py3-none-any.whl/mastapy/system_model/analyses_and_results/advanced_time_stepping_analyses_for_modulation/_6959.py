...
class SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation(_6958.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation):
    '''SynchroniserSleeveAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2678.SynchroniserSleeveSystemDeflection':
        ...
        return constructor.new(_2678.SynchroniserSleeveSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
