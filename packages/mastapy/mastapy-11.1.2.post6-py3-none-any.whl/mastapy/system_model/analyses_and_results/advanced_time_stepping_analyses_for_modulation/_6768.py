...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6766, _6767, _6797
...
class ConceptGearSetAdvancedTimeSteppingAnalysisForModulation(_6797.GearSetAdvancedTimeSteppingAnalysisForModulation):
    """ConceptGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2465.ConceptGearSetSystemDeflection':
    ...
    @property
    def concept_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6766.ConceptGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def concept_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6767.ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation]':
