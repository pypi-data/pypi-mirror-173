...
class ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation(_6901.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2579.ConicalGearMeshSystemDeflection':
