...
class SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation(_6753.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2553.SpiralBevelGearSystemDeflection':
