...
class AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation(_6681.ComponentAdvancedTimeSteppingAnalysisForModulation):
    '''AbstractShaftOrHousingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2361.AbstractShaftOrHousingSystemDeflection':
