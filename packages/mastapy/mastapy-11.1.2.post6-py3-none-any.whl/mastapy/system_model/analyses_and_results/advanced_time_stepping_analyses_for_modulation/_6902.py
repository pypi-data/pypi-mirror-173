...
from mastapy.math_utility import _1408
...
class GearSetAdvancedTimeSteppingAnalysisForModulation(_6941.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''GearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def eignenmodes_indexed_by_mode_id(self) -> 'List[_1408.Eigenmodes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.EignenmodesIndexedByModeId, constructor.new(_1408.Eigenmodes))
        return value
