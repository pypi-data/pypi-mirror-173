...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6837, _6838, _6755
...
class SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6755.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2552.SpiralBevelGearSetSystemDeflection':
    ...
    @property
    def spiral_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6837.SpiralBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def spiral_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6838.SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
