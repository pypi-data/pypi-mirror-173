...
class PlanetCarrierAdvancedTimeSteppingAnalysisForModulation(_6920.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    '''PlanetCarrierAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2645.PlanetCarrierSystemDeflection':
        ...
        return constructor.new(_2645.PlanetCarrierSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
