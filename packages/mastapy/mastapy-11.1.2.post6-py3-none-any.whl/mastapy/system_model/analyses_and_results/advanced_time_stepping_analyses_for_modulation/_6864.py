...
class ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation(_6753.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2585.ZerolBevelGearSystemDeflection':
