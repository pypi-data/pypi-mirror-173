...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6800, _6801, _6742
...
class HypoidGearSetAdvancedTimeSteppingAnalysisForModulation(_6742.AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    """HypoidGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2508.HypoidGearSetSystemDeflection':
    ...
    @property
    def hypoid_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6800.HypoidGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def hypoid_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_6801.HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation]':
