...
class CompoundAnalysis:
    ...
    def perform_analysis_with_progress(self, progress: '_7205.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_1892.DesignEntity') -> 'Iterable[_7191.DesignEntityCompoundAnalysis]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.ResultsFor(design_entity.wrapped if design_entity else None), constructor.new(_7191.DesignEntityCompoundAnalysis))
