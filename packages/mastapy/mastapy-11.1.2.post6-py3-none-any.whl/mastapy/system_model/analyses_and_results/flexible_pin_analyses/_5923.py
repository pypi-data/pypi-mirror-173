...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5917
...
class FlexiblePinAnalysisStopStartAnalysis(_5917.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_nominal_load_case(self) -> '_2471.ShaftSystemDeflection':
        ...
        return constructor.new(_2471.ShaftSystemDeflection)(self.wrapped.ShaftNominalLoadCase) if self.wrapped.ShaftNominalLoadCase else None

    @property
    def shaft_extreme_load_case(self) -> '_2471.ShaftSystemDeflection':
        ...
        return constructor.new(_2471.ShaftSystemDeflection)(self.wrapped.ShaftExtremeLoadCase) if self.wrapped.ShaftExtremeLoadCase else None
