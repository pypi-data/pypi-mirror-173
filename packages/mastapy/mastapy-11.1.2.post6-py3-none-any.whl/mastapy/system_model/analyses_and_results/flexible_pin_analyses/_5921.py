...
from mastapy.system_model.analyses_and_results.load_case_groups import _5322
...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5913
...
class WindTurbineCertificationReport(_5913.CombinationAnalysis):
    '''WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2153.RootAssembly':
        ...
        return constructor.new(_2153.RootAssembly)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def ldd_static_analysis(self) -> '_2614.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2614.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis else None

    @property
    def nominal_load_case_static_analysis(self) -> '_2468.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2468.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2468.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2468.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis else None
