...
class FlexiblePinAnalysisManufactureLevel(_6105.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_4194.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_4194.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis is not None else None
