...
class FlexiblePinAnalysisManufactureLevel(_5914.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_4007.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_4007.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
