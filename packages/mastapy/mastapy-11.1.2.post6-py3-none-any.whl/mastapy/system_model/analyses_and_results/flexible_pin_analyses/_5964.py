...
class FlexiblePinAnalysisStopStartAnalysis(_5958.FlexiblePinAnalysis):
    ...
    def shaft_nominal_load_case(self) -> '_2512.ShaftSystemDeflection':
        ...
        return constructor.new(_2512.ShaftSystemDeflection)(self.wrapped.ShaftNominalLoadCase) if self.wrapped.ShaftNominalLoadCase is not None else None
    ...
    def shaft_extreme_load_case(self) -> '_2512.ShaftSystemDeflection':
        ...
        return constructor.new(_2512.ShaftSystemDeflection)(self.wrapped.ShaftExtremeLoadCase) if self.wrapped.ShaftExtremeLoadCase is not None else None
