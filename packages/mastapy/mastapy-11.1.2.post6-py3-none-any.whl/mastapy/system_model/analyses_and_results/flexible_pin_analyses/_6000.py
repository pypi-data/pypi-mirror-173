...
class FlexiblePinAnalysisStopStartAnalysis(_5994.FlexiblePinAnalysis):
    """FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_extreme_load_case(self) -> '_2548.ShaftSystemDeflection':
    ...
    @property
    def shaft_nominal_load_case(self) -> '_2548.ShaftSystemDeflection':
