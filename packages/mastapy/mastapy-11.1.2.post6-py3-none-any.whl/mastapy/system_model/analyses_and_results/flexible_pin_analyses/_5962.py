...
class FlexiblePinAnalysisManufactureLevel(_5958.FlexiblePinAnalysis):
    ...
    def planetary_mesh_analysis(self) -> '_4047.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_4047.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis is not None else None
