...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2602, _2638, _2561
...
class FlexiblePinAnalysisGearAndBearingRating(_5952.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2602.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2602.CylindricalGearSetCompoundSystemDeflection.TYPE not in self.wrapped.GearSetAnalysis.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2561.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingAnalyses, constructor.new(_2561.BearingCompoundSystemDeflection))
        return value
