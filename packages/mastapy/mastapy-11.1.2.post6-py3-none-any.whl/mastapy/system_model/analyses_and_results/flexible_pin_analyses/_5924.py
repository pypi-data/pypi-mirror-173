...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5916
...
class WindTurbineCertificationReport(_5916.CombinationAnalysis):
    '''WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2152.RootAssembly':
        ...
        return constructor.new(_2152.RootAssembly)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def ldd_static_analysis(self) -> '_2613.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2613.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis else None

    @property
    def nominal_load_case_static_analysis(self) -> '_2467.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2467.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2467.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2467.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis else None
