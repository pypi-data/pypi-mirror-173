...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2568, _2604, _2527
...
class FlexiblePinAnalysisGearAndBearingRating(_5914.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2568.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2568.CylindricalGearSetCompoundSystemDeflection.TYPE not in self.wrapped.GearSetAnalysis.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2527.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingAnalyses, constructor.new(_2527.BearingCompoundSystemDeflection))
        return value
