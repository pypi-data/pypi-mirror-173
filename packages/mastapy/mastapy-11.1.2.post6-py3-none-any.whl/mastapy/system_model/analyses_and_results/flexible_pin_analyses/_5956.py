...
class FlexiblePinAnalysisManufactureLevel(_5952.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_4041.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_4041.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
