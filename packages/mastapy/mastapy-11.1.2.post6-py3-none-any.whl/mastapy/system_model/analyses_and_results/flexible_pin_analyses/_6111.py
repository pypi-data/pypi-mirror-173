...
class FlexiblePinAnalysisStopStartAnalysis(_6105.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_nominal_load_case(self) -> '_2659.ShaftSystemDeflection':
        ...
        return constructor.new(_2659.ShaftSystemDeflection)(self.wrapped.ShaftNominalLoadCase) if self.wrapped.ShaftNominalLoadCase is not None else None

    @property
    def shaft_extreme_load_case(self) -> '_2659.ShaftSystemDeflection':
        ...
        return constructor.new(_2659.ShaftSystemDeflection)(self.wrapped.ShaftExtremeLoadCase) if self.wrapped.ShaftExtremeLoadCase is not None else None
