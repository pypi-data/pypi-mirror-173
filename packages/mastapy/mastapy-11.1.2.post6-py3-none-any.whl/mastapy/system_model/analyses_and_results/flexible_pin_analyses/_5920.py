...
class FlexiblePinAnalysisStopStartAnalysis(_5914.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_nominal_load_case(self) -> '_2472.ShaftSystemDeflection':
        ...
        return constructor.new(_2472.ShaftSystemDeflection)(self.wrapped.ShaftNominalLoadCase) if self.wrapped.ShaftNominalLoadCase else None

    @property
    def shaft_extreme_load_case(self) -> '_2472.ShaftSystemDeflection':
        ...
        return constructor.new(_2472.ShaftSystemDeflection)(self.wrapped.ShaftExtremeLoadCase) if self.wrapped.ShaftExtremeLoadCase else None
