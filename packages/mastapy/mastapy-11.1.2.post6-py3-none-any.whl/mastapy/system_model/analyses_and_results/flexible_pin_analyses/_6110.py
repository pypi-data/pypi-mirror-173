...
from mastapy.system_model.analyses_and_results.static_loads import _6639, _6646
...
class FlexiblePinAnalysisOptions(_0.APIBase):
    ...
    @property
    def extreme_load_case_for_stop_start(self) -> '_6639.StaticLoadCase':
        '''StaticLoadCase: 'ExtremeLoadCaseForStopStart' is the original name of this property.'''

        if _6639.StaticLoadCase.TYPE not in self.wrapped.ExtremeLoadCaseForStopStart.__class__.__mro__:
    ...
    def extreme_load_case_for_stop_start(self, value: '_6639.StaticLoadCase'):
    ...
    @property
    def nominal_load_case_for_stop_start(self) -> '_6639.StaticLoadCase':
        '''StaticLoadCase: 'NominalLoadCaseForStopStart' is the original name of this property.'''

        if _6639.StaticLoadCase.TYPE not in self.wrapped.NominalLoadCaseForStopStart.__class__.__mro__:
    ...
    def nominal_load_case_for_stop_start(self, value: '_6639.StaticLoadCase'):
        value = value.wrapped if value else None
