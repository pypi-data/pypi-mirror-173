...
class TransmissionErrorToOtherPowerLoad(_0.APIBase):
    ...
    @property
    def fourier_series_of_te(self) -> '_1413.FourierSeries':
        ...
        return constructor.new(_1413.FourierSeries)(self.wrapped.FourierSeriesOfTE) if self.wrapped.FourierSeriesOfTE is not None else None
