...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6966, _6970, _6967
...
class CylindricalMeshedGearAdvancedSystemDeflection(_0.APIBase):
    ...
    @property
    def cylindrical_gear_advanced_system_deflection(self) -> '_6966.CylindricalGearAdvancedSystemDeflection':
        ...
        if _6966.CylindricalGearAdvancedSystemDeflection.TYPE not in self.wrapped.CylindricalGearAdvancedSystemDeflection.__class__.__mro__:
    ...
    @property
    def other_cylindrical_gear_advanced_system_deflection(self) -> '_6966.CylindricalGearAdvancedSystemDeflection':
        ...
        if _6966.CylindricalGearAdvancedSystemDeflection.TYPE not in self.wrapped.OtherCylindricalGearAdvancedSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_mesh_advanced_system_deflection(self) -> '_6967.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_6967.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.CylindricalGearMeshAdvancedSystemDeflection) if self.wrapped.CylindricalGearMeshAdvancedSystemDeflection else None
