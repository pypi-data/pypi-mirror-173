...
class FaceGearAdvancedSystemDeflection(_6978.GearAdvancedSystemDeflection):
    '''FaceGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_410.FaceGearRating':
        ...
        return constructor.new(_410.FaceGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2424.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2424.FaceGearSystemDeflection))
        return value
