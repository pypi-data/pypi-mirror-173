...
class RingPinsToDiscConnectionAdvancedSystemDeflection(_7171.InterMountableComponentConnectionAdvancedSystemDeflection):
    '''RingPinsToDiscConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2650.RingPinsToDiscConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2650.RingPinsToDiscConnectionSystemDeflection))
        return value
