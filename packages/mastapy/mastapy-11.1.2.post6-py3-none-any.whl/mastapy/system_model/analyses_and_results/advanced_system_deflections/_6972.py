...
class ExternalCADModelAdvancedSystemDeflection(_6943.ComponentAdvancedSystemDeflection):
    '''ExternalCADModelAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2420.ExternalCADModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2420.ExternalCADModelSystemDeflection))
        return value
