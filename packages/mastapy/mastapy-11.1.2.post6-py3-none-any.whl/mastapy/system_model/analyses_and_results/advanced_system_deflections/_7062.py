...
class GuideDxfModelAdvancedSystemDeflection(_7024.ComponentAdvancedSystemDeflection):
    """GuideDxfModelAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2506.GuideDxfModelSystemDeflection]':
