...
class TorqueConverterAdvancedSystemDeflection(_7142.CouplingAdvancedSystemDeflection):
    '''TorqueConverterAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2685.TorqueConverterSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2685.TorqueConverterSystemDeflection))
        return value
