...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7105, _7111
...
class RootAssemblyAdvancedSystemDeflection(_7111.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_7105.AdvancedSystemDeflection':
        ...
        return constructor.new(_7105.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs is not None else None
