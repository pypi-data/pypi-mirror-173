...
class FaceGearMeshAdvancedSystemDeflection(_6979.GearMeshAdvancedSystemDeflection):
    '''FaceGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2422.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2422.FaceGearMeshSystemDeflection))
        return value
