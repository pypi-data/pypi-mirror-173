...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7159, _7160, _7166
...
class FaceGearSetAdvancedSystemDeflection(_7166.GearSetAdvancedSystemDeflection):
    '''FaceGearSetAdvancedSystemDeflection
    ...
    @property
    def face_gears_advanced_system_deflection(self) -> 'List[_7159.FaceGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsAdvancedSystemDeflection, constructor.new(_7159.FaceGearAdvancedSystemDeflection))
        return value

    @property
    def face_meshes_advanced_system_deflection(self) -> 'List[_7160.FaceGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesAdvancedSystemDeflection, constructor.new(_7160.FaceGearMeshAdvancedSystemDeflection))
        return value
