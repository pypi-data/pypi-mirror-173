...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7063, _7064, _7005
...
class HypoidGearSetAdvancedSystemDeflection(_7005.AGMAGleasonConicalGearSetAdvancedSystemDeflection):
    """HypoidGearSetAdvancedSystemDeflection
    ...
    @property
    def hypoid_gears_advanced_system_deflection(self) -> 'List[_7063.HypoidGearAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_meshes_advanced_system_deflection(self) -> 'List[_7064.HypoidGearMeshAdvancedSystemDeflection]':
