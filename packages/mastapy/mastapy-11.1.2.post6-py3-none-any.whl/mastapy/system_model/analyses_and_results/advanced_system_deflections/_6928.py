...
class BeltDriveAdvancedSystemDeflection(_7019.SpecialisedAssemblyAdvancedSystemDeflection):
    '''BeltDriveAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2370.BeltDriveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2370.BeltDriveSystemDeflection))
        return value
