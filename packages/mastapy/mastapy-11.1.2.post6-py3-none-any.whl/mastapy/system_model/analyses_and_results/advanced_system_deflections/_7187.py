...
class PartToPartShearCouplingAdvancedSystemDeflection(_7142.CouplingAdvancedSystemDeflection):
    '''PartToPartShearCouplingAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2643.PartToPartShearCouplingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2643.PartToPartShearCouplingSystemDeflection))
        return value
