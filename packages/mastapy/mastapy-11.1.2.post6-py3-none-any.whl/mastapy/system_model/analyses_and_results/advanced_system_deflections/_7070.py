...
class KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection(_7067.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection):
    """KlingelnbergCycloPalloidHypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_381.KlingelnbergCycloPalloidHypoidGearRating':
    ...
    @property
    def component_load_case(self) -> '_6641.KlingelnbergCycloPalloidHypoidGearLoadCase':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2517.KlingelnbergCycloPalloidHypoidGearSystemDeflection]':
