...
class ClutchAdvancedSystemDeflection(_7037.CouplingAdvancedSystemDeflection):
    """ClutchAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2457.ClutchSystemDeflection]':
