...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7228, _7230
...
class PowerLoadAdvancedSystemDeflection(_7230.VirtualComponentAdvancedSystemDeflection):
    '''PowerLoadAdvancedSystemDeflection
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_7228.TransmissionErrorToOtherPowerLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_7228.TransmissionErrorToOtherPowerLoad))
        return value

    @property
    def component_system_deflection_results(self) -> 'List[_2647.PowerLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2647.PowerLoadSystemDeflection))
        return value
