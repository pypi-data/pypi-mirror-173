...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6966, _6967, _6980
...
class CylindricalGearSetAdvancedSystemDeflection(_6980.GearSetAdvancedSystemDeflection):
    '''CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def gear_set_design(self) -> '_957.CylindricalGearSetDesign':
    ...
    @property
    def cylindrical_gears_advanced_system_deflection(self) -> 'List[_6966.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsAdvancedSystemDeflection, constructor.new(_6966.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshes_advanced_system_deflection(self) -> 'List[_6967.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesAdvancedSystemDeflection, constructor.new(_6967.CylindricalGearMeshAdvancedSystemDeflection))
        return value
