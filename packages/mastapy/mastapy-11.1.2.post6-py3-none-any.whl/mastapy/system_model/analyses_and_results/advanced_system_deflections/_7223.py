...
class SynchroniserSleeveAdvancedSystemDeflection(_7222.SynchroniserPartAdvancedSystemDeflection):
    '''SynchroniserSleeveAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2678.SynchroniserSleeveSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2678.SynchroniserSleeveSystemDeflection))
        return value
