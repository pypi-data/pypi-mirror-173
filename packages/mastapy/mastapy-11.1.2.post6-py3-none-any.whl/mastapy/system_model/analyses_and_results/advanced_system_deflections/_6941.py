...
class ClutchHalfAdvancedSystemDeflection(_6958.CouplingHalfAdvancedSystemDeflection):
    '''ClutchHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2382.ClutchHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2382.ClutchHalfSystemDeflection))
        return value
