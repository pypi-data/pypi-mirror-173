...
class GearMeshAdvancedSystemDeflection(_7171.InterMountableComponentConnectionAdvancedSystemDeflection):
    '''GearMeshAdvancedSystemDeflection
    ...
    @property
    def misalignment_fourier_series_for_first_tooth_passing_period(self) -> '_1413.FourierSeries':
        ...
        return constructor.new(_1413.FourierSeries)(self.wrapped.MisalignmentFourierSeriesForFirstToothPassingPeriod) if self.wrapped.MisalignmentFourierSeriesForFirstToothPassingPeriod is not None else None
