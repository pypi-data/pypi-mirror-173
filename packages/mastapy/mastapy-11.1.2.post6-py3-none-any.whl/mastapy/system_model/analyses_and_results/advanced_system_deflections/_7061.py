...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7076, _7100
...
class GearSetAdvancedSystemDeflection(_7100.SpecialisedAssemblyAdvancedSystemDeflection):
    """GearSetAdvancedSystemDeflection
    ...
    @property
    def use_ltca_in_advanced_system_deflection(self) -> '_7076.UseLtcaInAsdOption':
        ...
        return constructor.new_from_mastapy_type(_7076.UseLtcaInAsdOption)(value) if value is not None else None

    @use_ltca_in_advanced_system_deflection.setter
    def use_ltca_in_advanced_system_deflection(self, value: '_7076.UseLtcaInAsdOption'):
