...
class ClutchAdvancedSystemDeflection(_6956.CouplingAdvancedSystemDeflection):
    '''ClutchAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2383.ClutchSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2383.ClutchSystemDeflection))
        return value
