...
class TorqueConverterPumpAdvancedSystemDeflection(_7039.CouplingHalfAdvancedSystemDeflection):
    """TorqueConverterPumpAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2573.TorqueConverterPumpSystemDeflection]':
