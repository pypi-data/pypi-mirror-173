...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @property
    def use_advanced_ltca(self) -> '_787.UseAdvancedLTCAOptions':
        ...
        return constructor.new(_787.UseAdvancedLTCAOptions)(value) if value else None

    @use_advanced_ltca.setter
    def use_advanced_ltca(self, value: '_787.UseAdvancedLTCAOptions'):
