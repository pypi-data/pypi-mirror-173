...
class UnbalancedMassAdvancedSystemDeflection(_7230.VirtualComponentAdvancedSystemDeflection):
    '''UnbalancedMassAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2689.UnbalancedMassSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2689.UnbalancedMassSystemDeflection))
        return value
