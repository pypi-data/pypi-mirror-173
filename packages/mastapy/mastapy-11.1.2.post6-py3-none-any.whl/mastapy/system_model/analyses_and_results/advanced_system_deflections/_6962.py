...
class CycloidalAssemblyAdvancedSystemDeflection(_7019.SpecialisedAssemblyAdvancedSystemDeflection):
    '''CycloidalAssemblyAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2405.CycloidalAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2405.CycloidalAssemblySystemDeflection))
        return value
