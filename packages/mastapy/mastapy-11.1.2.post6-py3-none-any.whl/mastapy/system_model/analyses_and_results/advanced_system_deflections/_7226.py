...
class TorqueConverterPumpAdvancedSystemDeflection(_7144.CouplingHalfAdvancedSystemDeflection):
    '''TorqueConverterPumpAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2684.TorqueConverterPumpSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2684.TorqueConverterPumpSystemDeflection))
        return value
