...
class ConceptCouplingHalfAdvancedSystemDeflection(_6958.CouplingHalfAdvancedSystemDeflection):
    '''ConceptCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2388.ConceptCouplingHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2388.ConceptCouplingHalfSystemDeflection))
        return value
