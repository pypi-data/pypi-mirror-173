...
from mastapy.math_utility.convergence import _1336, _1335
from mastapy.utility_gui import _1576
...
class ConnectionAdvancedSystemDeflection(_7186.ConnectionStaticLoadAnalysisCase):
    '''ConnectionAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_6919.AdvancedSystemDeflection':
        ...
        return constructor.new(_6919.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection else None

    @property
    def data_logger(self) -> '_1336.DataLogger':
        ...
        if _1336.DataLogger.TYPE not in self.wrapped.DataLogger.__class__.__mro__:
