...
class KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection(_6987.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6560.KlingelnbergCycloPalloidHypoidGearMeshLoadCase':
        ...
        return constructor.new(_6560.KlingelnbergCycloPalloidHypoidGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def component_detailed_analysis(self) -> '_370.KlingelnbergCycloPalloidHypoidGearMeshRating':
        ...
        return constructor.new(_370.KlingelnbergCycloPalloidHypoidGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2439.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2439.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection))
        return value
