...
class PointLoadAdvancedSystemDeflection(_7230.VirtualComponentAdvancedSystemDeflection):
    '''PointLoadAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2646.PointLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2646.PointLoadSystemDeflection))
        return value
