...
class ConceptGearMeshAdvancedSystemDeflection(_7060.GearMeshAdvancedSystemDeflection):
    """ConceptGearMeshAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_516.ConceptGearMeshRating':
    ...
    @property
    def connection_load_case(self) -> '_6565.ConceptGearMeshLoadCase':
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2464.ConceptGearMeshSystemDeflection]':
