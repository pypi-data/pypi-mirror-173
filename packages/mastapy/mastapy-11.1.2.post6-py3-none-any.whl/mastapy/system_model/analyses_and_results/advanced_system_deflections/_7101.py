...
class SpiralBevelGearAdvancedSystemDeflection(_7015.BevelGearAdvancedSystemDeflection):
    """SpiralBevelGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_375.SpiralBevelGearRating':
    ...
    @property
    def component_load_case(self) -> '_6681.SpiralBevelGearLoadCase':
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2553.SpiralBevelGearSystemDeflection]':
