...
class BearingAdvancedSystemDeflection(_6954.ConnectorAdvancedSystemDeflection):
    '''BearingAdvancedSystemDeflection
    ...
    @property
    def duty_cycle(self) -> '_1652.LoadedBearingDutyCycle':
        ...
        if _1652.LoadedBearingDutyCycle.TYPE not in self.wrapped.DutyCycle.__class__.__mro__:
