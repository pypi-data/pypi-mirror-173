...
class DatumAdvancedSystemDeflection(_6943.ComponentAdvancedSystemDeflection):
    '''DatumAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2419.DatumSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2419.DatumSystemDeflection))
        return value
