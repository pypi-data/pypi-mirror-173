...
class ConceptGearAdvancedSystemDeflection(_6978.GearAdvancedSystemDeflection):
    '''ConceptGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_500.ConceptGearRating':
        ...
        return constructor.new(_500.ConceptGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2392.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2392.ConceptGearSystemDeflection))
        return value
