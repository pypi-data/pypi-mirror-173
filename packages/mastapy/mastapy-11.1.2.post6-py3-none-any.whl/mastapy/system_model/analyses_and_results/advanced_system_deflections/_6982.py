...
class HypoidGearAdvancedSystemDeflection(_6922.AGMAGleasonConicalGearAdvancedSystemDeflection):
    '''HypoidGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_401.HypoidGearRating':
        ...
        return constructor.new(_401.HypoidGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2433.HypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2433.HypoidGearSystemDeflection))
        return value
