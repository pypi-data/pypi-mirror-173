...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7237
...
class SpecialisedAssemblyCompoundAdvancedSystemDeflection(_7237.AbstractAssemblyCompoundAdvancedSystemDeflection):
    '''SpecialisedAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7205.SpecialisedAssemblyAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_7205.SpecialisedAssemblyAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7205.SpecialisedAssemblyAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_7205.SpecialisedAssemblyAdvancedSystemDeflection))
        return value
