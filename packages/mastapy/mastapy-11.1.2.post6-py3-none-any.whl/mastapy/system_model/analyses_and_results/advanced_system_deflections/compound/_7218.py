...
class PointLoadCompoundAdvancedSystemDeflection(_7254.VirtualComponentCompoundAdvancedSystemDeflection):
    """PointLoadCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7088.PointLoadAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7088.PointLoadAdvancedSystemDeflection]':
