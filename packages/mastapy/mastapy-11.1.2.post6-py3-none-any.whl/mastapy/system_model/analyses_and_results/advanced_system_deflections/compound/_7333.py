...
class ShaftHubConnectionCompoundAdvancedSystemDeflection(_7273.ConnectorCompoundAdvancedSystemDeflection):
    '''ShaftHubConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7203.ShaftHubConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7203.ShaftHubConnectionAdvancedSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7203.ShaftHubConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7203.ShaftHubConnectionAdvancedSystemDeflection))
        return value
