...
class PartCompoundAdvancedSystemDeflection(_7272.PartCompoundAnalysis):
    """PartCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7081.PartAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7081.PartAdvancedSystemDeflection]':
