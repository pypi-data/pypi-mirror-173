...
class TorqueConverterTurbineCompoundAdvancedSystemDeflection(_7171.CouplingHalfCompoundAdvancedSystemDeflection):
    """TorqueConverterTurbineCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7122.TorqueConverterTurbineAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7122.TorqueConverterTurbineAdvancedSystemDeflection]':
