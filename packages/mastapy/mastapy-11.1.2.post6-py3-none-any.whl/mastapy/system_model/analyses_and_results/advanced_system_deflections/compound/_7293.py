...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7162
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7239
...
class FEPartCompoundAdvancedSystemDeflection(_7239.AbstractShaftOrHousingCompoundAdvancedSystemDeflection):
    '''FEPartCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7162.FEPartAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7162.FEPartAdvancedSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7162.FEPartAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7162.FEPartAdvancedSystemDeflection))
        return value
