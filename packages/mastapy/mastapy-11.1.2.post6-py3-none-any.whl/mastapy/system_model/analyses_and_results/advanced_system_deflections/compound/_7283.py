...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7151
...
class CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection(_7240.AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7151.CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_7151.CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_7151.CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_7151.CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection))
        return value
