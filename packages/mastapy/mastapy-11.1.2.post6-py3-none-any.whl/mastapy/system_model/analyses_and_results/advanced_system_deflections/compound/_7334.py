...
class ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection(_7240.AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection):
    '''ShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7204.ShaftToMountableComponentConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_7204.ShaftToMountableComponentConnectionAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_7204.ShaftToMountableComponentConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_7204.ShaftToMountableComponentConnectionAdvancedSystemDeflection))
        return value
