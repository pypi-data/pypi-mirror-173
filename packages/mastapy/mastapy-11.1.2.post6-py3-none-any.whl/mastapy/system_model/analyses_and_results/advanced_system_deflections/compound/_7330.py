...
class RollingRingConnectionCompoundAdvancedSystemDeflection(_7302.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    '''RollingRingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7200.RollingRingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_7200.RollingRingConnectionAdvancedSystemDeflection))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7200.RollingRingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_7200.RollingRingConnectionAdvancedSystemDeflection))
        return value
