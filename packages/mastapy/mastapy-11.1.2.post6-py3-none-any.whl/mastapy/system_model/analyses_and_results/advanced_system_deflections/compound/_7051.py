...
class AbstractAssemblyCompoundAdvancedSystemDeflection(_7130.PartCompoundAdvancedSystemDeflection):
    '''AbstractAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6915.AbstractAssemblyAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6915.AbstractAssemblyAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6915.AbstractAssemblyAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6915.AbstractAssemblyAdvancedSystemDeflection))
        return value
