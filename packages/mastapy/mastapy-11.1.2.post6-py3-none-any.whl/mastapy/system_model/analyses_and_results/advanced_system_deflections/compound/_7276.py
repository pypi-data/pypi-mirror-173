...
class CouplingHalfCompoundAdvancedSystemDeflection(_7314.MountableComponentCompoundAdvancedSystemDeflection):
    '''CouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7144.CouplingHalfAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7144.CouplingHalfAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_7144.CouplingHalfAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7144.CouplingHalfAdvancedSystemDeflection))
        return value
