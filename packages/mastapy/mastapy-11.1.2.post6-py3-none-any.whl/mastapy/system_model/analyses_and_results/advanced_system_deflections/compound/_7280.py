...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7148
...
class CycloidalAssemblyCompoundAdvancedSystemDeflection(_7335.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    '''CycloidalAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7148.CycloidalAssemblyAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_7148.CycloidalAssemblyAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_7148.CycloidalAssemblyAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_7148.CycloidalAssemblyAdvancedSystemDeflection))
        return value
