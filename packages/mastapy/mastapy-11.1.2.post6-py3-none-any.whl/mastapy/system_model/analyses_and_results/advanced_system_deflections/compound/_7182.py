...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7179
...
class CylindricalPlanetGearCompoundAdvancedSystemDeflection(_7179.CylindricalGearCompoundAdvancedSystemDeflection):
    """CylindricalPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7051.CylindricalPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7051.CylindricalPlanetGearAdvancedSystemDeflection]':
