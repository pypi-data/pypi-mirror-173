...
class CouplingConnectionCompoundAdvancedSystemDeflection(_7302.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    '''CouplingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7143.CouplingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_7143.CouplingConnectionAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_7143.CouplingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_7143.CouplingConnectionAdvancedSystemDeflection))
        return value
