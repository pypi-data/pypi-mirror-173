...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7190
...
class CylindricalGearCompoundAdvancedSystemDeflection(_7190.GearCompoundAdvancedSystemDeflection):
    """CylindricalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_424.CylindricalGearDutyCycleRating':
    ...
    @property
    def cylindrical_gear_rating(self) -> '_424.CylindricalGearDutyCycleRating':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7047.CylindricalGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7047.CylindricalGearAdvancedSystemDeflection]':
