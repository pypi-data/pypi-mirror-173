...
class BevelDifferentialSunGearCompoundAdvancedSystemDeflection(_7107.BevelDifferentialGearCompoundAdvancedSystemDeflection):
    '''BevelDifferentialSunGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6978.BevelDifferentialSunGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6978.BevelDifferentialSunGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6978.BevelDifferentialSunGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6978.BevelDifferentialSunGearAdvancedSystemDeflection))
        return value
