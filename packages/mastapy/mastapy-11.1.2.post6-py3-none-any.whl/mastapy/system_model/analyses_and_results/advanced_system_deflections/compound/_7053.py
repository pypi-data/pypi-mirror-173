...
class AbstractShaftOrHousingCompoundAdvancedSystemDeflection(_7076.ComponentCompoundAdvancedSystemDeflection):
    '''AbstractShaftOrHousingCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6917.AbstractShaftOrHousingAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6917.AbstractShaftOrHousingAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6917.AbstractShaftOrHousingAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6917.AbstractShaftOrHousingAdvancedSystemDeflection))
        return value
