...
class PulleyCompoundAdvancedSystemDeflection(_7171.CouplingHalfCompoundAdvancedSystemDeflection):
    """PulleyCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7090.PulleyAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7090.PulleyAdvancedSystemDeflection]':
