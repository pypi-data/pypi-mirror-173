...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7149
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7238
...
class CycloidalDiscCompoundAdvancedSystemDeflection(_7238.AbstractShaftCompoundAdvancedSystemDeflection):
    '''CycloidalDiscCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7149.CycloidalDiscAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7149.CycloidalDiscAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_7149.CycloidalDiscAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7149.CycloidalDiscAdvancedSystemDeflection))
        return value
