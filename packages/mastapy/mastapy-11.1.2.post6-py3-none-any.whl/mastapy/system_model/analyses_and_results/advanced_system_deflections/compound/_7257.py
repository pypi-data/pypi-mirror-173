...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7128
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7255, _7256, _7192
...
class WormGearSetCompoundAdvancedSystemDeflection(_7192.GearSetCompoundAdvancedSystemDeflection):
    """WormGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_347.WormGearSetDutyCycleRating':
    ...
    @property
    def worm_gear_duty_cycle_rating(self) -> '_347.WormGearSetDutyCycleRating':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7128.WormGearSetAdvancedSystemDeflection]':
    ...
    @property
    def worm_gears_compound_advanced_system_deflection(self) -> 'List[_7255.WormGearCompoundAdvancedSystemDeflection]':
    ...
    @property
    def worm_meshes_compound_advanced_system_deflection(self) -> 'List[_7256.WormGearMeshCompoundAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7128.WormGearSetAdvancedSystemDeflection]':
