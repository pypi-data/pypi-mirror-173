...
class MeasurementComponentCompoundAdvancedSystemDeflection(_7254.VirtualComponentCompoundAdvancedSystemDeflection):
    """MeasurementComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7078.MeasurementComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7078.MeasurementComponentAdvancedSystemDeflection]':
