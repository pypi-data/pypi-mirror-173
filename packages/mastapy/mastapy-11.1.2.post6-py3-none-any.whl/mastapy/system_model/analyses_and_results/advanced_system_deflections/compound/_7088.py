...
class CouplingCompoundAdvancedSystemDeflection(_7149.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    '''CouplingCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6956.CouplingAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6956.CouplingAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6956.CouplingAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6956.CouplingAdvancedSystemDeflection))
        return value
