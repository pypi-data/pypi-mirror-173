...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7269
...
class KlingelnbergCycloPalloidConicalGearCompoundAdvancedSystemDeflection(_7269.ConicalGearCompoundAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7172.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7172.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_7172.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7172.KlingelnbergCycloPalloidConicalGearAdvancedSystemDeflection))
        return value
