...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7085
...
class AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection(_7085.ConicalGearSetCompoundAdvancedSystemDeflection):
    '''AGMAGleasonConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6924.AGMAGleasonConicalGearSetAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6924.AGMAGleasonConicalGearSetAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6924.AGMAGleasonConicalGearSetAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6924.AGMAGleasonConicalGearSetAdvancedSystemDeflection))
        return value
