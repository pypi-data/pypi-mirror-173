...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7086
...
class AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection(_7086.ConnectionCompoundAdvancedSystemDeflection):
    '''AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6918.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6918.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6918.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6918.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection))
        return value
