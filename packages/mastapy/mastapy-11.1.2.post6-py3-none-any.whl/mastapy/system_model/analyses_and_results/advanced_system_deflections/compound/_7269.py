...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7136
...
class ConicalGearCompoundAdvancedSystemDeflection(_7295.GearCompoundAdvancedSystemDeflection):
    '''ConicalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_503.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_503.ConicalGearDutyCycleRating)(self.wrapped.GearDutyCycleRating) if self.wrapped.GearDutyCycleRating is not None else None

    @property
    def conical_gear_duty_cycle_rating(self) -> '_503.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_503.ConicalGearDutyCycleRating)(self.wrapped.ConicalGearDutyCycleRating) if self.wrapped.ConicalGearDutyCycleRating is not None else None
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7136.ConicalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7136.ConicalGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_7136.ConicalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7136.ConicalGearAdvancedSystemDeflection))
        return value
