...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7342, _7343, _7255
...
class StraightBevelDiffGearSetCompoundAdvancedSystemDeflection(_7255.BevelGearSetCompoundAdvancedSystemDeflection):
    '''StraightBevelDiffGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def straight_bevel_diff_gears_compound_advanced_system_deflection(self) -> 'List[_7342.StraightBevelDiffGearCompoundAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsCompoundAdvancedSystemDeflection, constructor.new(_7342.StraightBevelDiffGearCompoundAdvancedSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_compound_advanced_system_deflection(self) -> 'List[_7343.StraightBevelDiffGearMeshCompoundAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesCompoundAdvancedSystemDeflection, constructor.new(_7343.StraightBevelDiffGearMeshCompoundAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7214.StraightBevelDiffGearSetAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_7214.StraightBevelDiffGearSetAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_7214.StraightBevelDiffGearSetAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_7214.StraightBevelDiffGearSetAdvancedSystemDeflection))
        return value
