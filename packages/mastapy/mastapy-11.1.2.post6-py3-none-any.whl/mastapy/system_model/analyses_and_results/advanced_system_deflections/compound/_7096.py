...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7175
...
class AbstractAssemblyCompoundAdvancedSystemDeflection(_7175.PartCompoundAdvancedSystemDeflection):
    '''AbstractAssemblyCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6960.AbstractAssemblyAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6960.AbstractAssemblyAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6960.AbstractAssemblyAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6960.AbstractAssemblyAdvancedSystemDeflection))
        return value
