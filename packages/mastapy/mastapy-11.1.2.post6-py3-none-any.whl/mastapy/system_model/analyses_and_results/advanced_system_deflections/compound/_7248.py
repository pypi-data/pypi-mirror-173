...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7118
...
class SynchroniserSleeveCompoundAdvancedSystemDeflection(_7247.SynchroniserPartCompoundAdvancedSystemDeflection):
    """SynchroniserSleeveCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7118.SynchroniserSleeveAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7118.SynchroniserSleeveAdvancedSystemDeflection]':
