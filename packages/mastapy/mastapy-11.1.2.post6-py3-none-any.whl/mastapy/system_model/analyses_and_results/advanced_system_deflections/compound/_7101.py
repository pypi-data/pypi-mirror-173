...
class AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection(_7129.ConicalGearMeshCompoundAdvancedSystemDeflection):
    '''AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6968.AGMAGleasonConicalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6968.AGMAGleasonConicalGearMeshAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6968.AGMAGleasonConicalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6968.AGMAGleasonConicalGearMeshAdvancedSystemDeflection))
        return value
