...
class ZerolBevelGearCompoundAdvancedSystemDeflection(_7148.BevelGearCompoundAdvancedSystemDeflection):
    """ZerolBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7129.ZerolBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7129.ZerolBevelGearAdvancedSystemDeflection]':
