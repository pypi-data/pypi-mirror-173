...
class BevelDifferentialGearMeshCompoundAdvancedSystemDeflection(_7068.BevelGearMeshCompoundAdvancedSystemDeflection):
    '''BevelDifferentialGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6930.BevelDifferentialGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6930.BevelDifferentialGearMeshAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6930.BevelDifferentialGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6930.BevelDifferentialGearMeshAdvancedSystemDeflection))
        return value
