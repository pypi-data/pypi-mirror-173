...
class MountableComponentCompoundAdvancedSystemDeflection(_7262.ComponentCompoundAdvancedSystemDeflection):
    '''MountableComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7184.MountableComponentAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7184.MountableComponentAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_7184.MountableComponentAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7184.MountableComponentAdvancedSystemDeflection))
        return value
