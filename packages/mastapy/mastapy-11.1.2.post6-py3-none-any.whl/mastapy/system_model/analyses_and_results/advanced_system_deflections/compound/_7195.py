...
class HypoidGearMeshCompoundAdvancedSystemDeflection(_7137.AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection):
    """HypoidGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7064.HypoidGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7064.HypoidGearMeshAdvancedSystemDeflection]':
