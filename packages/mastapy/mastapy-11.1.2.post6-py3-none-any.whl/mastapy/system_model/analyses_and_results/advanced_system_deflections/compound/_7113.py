...
class BevelGearMeshCompoundAdvancedSystemDeflection(_7101.AGMAGleasonConicalGearMeshCompoundAdvancedSystemDeflection):
    '''BevelGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6980.BevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6980.BevelGearMeshAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6980.BevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6980.BevelGearMeshAdvancedSystemDeflection))
        return value
