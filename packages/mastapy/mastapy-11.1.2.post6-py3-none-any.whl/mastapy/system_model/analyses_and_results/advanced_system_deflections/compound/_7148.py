...
class BevelGearCompoundAdvancedSystemDeflection(_7136.AGMAGleasonConicalGearCompoundAdvancedSystemDeflection):
    """BevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7015.BevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7015.BevelGearAdvancedSystemDeflection]':
