...
class AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection(_7131.ConnectionCompoundAdvancedSystemDeflection):
    '''AbstractShaftToMountableComponentConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6963.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6963.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6963.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6963.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection))
        return value
