...
class StraightBevelPlanetGearCompoundAdvancedSystemDeflection(_7342.StraightBevelDiffGearCompoundAdvancedSystemDeflection):
    '''StraightBevelPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7218.StraightBevelPlanetGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7218.StraightBevelPlanetGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_7218.StraightBevelPlanetGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7218.StraightBevelPlanetGearAdvancedSystemDeflection))
        return value
