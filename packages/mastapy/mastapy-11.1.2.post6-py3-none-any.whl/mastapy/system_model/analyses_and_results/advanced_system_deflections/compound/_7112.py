...
class BevelGearCompoundAdvancedSystemDeflection(_7100.AGMAGleasonConicalGearCompoundAdvancedSystemDeflection):
    '''BevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6979.BevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6979.BevelGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6979.BevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6979.BevelGearAdvancedSystemDeflection))
        return value
