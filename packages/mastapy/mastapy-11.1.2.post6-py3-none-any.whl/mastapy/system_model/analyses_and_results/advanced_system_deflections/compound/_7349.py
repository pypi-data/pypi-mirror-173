...
class StraightBevelSunGearCompoundAdvancedSystemDeflection(_7342.StraightBevelDiffGearCompoundAdvancedSystemDeflection):
    '''StraightBevelSunGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7219.StraightBevelSunGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7219.StraightBevelSunGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_7219.StraightBevelSunGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7219.StraightBevelSunGearAdvancedSystemDeflection))
        return value
