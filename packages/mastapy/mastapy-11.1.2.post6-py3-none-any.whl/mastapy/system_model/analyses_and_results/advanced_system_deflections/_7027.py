...
class ConceptCouplingHalfAdvancedSystemDeflection(_7039.CouplingHalfAdvancedSystemDeflection):
    """ConceptCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2462.ConceptCouplingHalfSystemDeflection]':
