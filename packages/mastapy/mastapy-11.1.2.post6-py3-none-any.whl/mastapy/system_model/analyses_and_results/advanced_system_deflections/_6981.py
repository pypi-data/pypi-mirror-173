...
class GuideDxfModelAdvancedSystemDeflection(_6943.ComponentAdvancedSystemDeflection):
    '''GuideDxfModelAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6538.GuideDxfModelLoadCase':
        ...
        return constructor.new(_6538.GuideDxfModelLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2430.GuideDxfModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2430.GuideDxfModelSystemDeflection))
        return value
