...
class BevelDifferentialGearAdvancedSystemDeflection(_6934.BevelGearAdvancedSystemDeflection):
    '''BevelDifferentialGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_504.BevelGearRating':
        ...
        if _504.BevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_zerol_bevel_gear_rating(self) -> '_332.ZerolBevelGearRating':
        ...
        if _332.ZerolBevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_straight_bevel_gear_rating(self) -> '_362.StraightBevelGearRating':
        ...
        if _362.StraightBevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_spiral_bevel_gear_rating(self) -> '_365.SpiralBevelGearRating':
        ...
        if _365.SpiralBevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2373.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2373.BevelDifferentialGearSystemDeflection))
        return value
