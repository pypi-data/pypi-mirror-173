...
from mastapy.system_model.drawing import _2105
...
class PartAdvancedSystemDeflection(_7379.PartStaticLoadAnalysisCase):
    '''PartAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_7105.AdvancedSystemDeflection':
        ...
        return constructor.new(_7105.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection is not None else None
    ...
    def create_viewable(self) -> '_2105.AdvancedSystemDeflectionViewable':
