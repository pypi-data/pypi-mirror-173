...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7152, _7202, _7205
from mastapy.system_model.analyses_and_results.system_deflections import _2656, _2633, _2613
...
class FlexiblePinAssemblyAdvancedSystemDeflection(_7205.SpecialisedAssemblyAdvancedSystemDeflection):
    '''FlexiblePinAssemblyAdvancedSystemDeflection
    ...
    @property
    def planet_gear_analyses(self) -> 'List[_7152.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetGearAnalyses, constructor.new(_7152.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def pin_advanced_analyses(self) -> 'List[_7202.ShaftAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PinAdvancedAnalyses, constructor.new(_7202.ShaftAdvancedSystemDeflection))
        return value

    @property
    def spindle_advanced_analyses(self) -> 'List[_7202.ShaftAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpindleAdvancedAnalyses, constructor.new(_7202.ShaftAdvancedSystemDeflection))
        return value

    @property
    def pin_spindle_fit_advanced_analyses(self) -> 'List[_2656.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PinSpindleFitAdvancedAnalyses, constructor.new(_2656.ShaftHubConnectionSystemDeflection))
        return value
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2613.FlexiblePinAssemblySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2613.FlexiblePinAssemblySystemDeflection))
        return value
