...
from mastapy.system_model.analyses_and_results import _2517
...
class PartLoadCase(_2517.PartAnalysis):
    '''PartLoadCase
    ...
    @property
    def static_load_case(self) -> '_6639.StaticLoadCase':
        ...
        if _6639.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
    ...
    def get_harmonic_load_data_for_import(self) -> '_1284.HarmonicLoadDataBase':
