...
class GearSetLoadCase(_6679.SpecialisedAssemblyLoadCase):
    """GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5173.GearMeshStiffnessModel':
        ...
        return constructor.new_from_mastapy_type(_5173.GearMeshStiffnessModel)(value) if value is not None else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5173.GearMeshStiffnessModel'):
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_options(self) -> '_6739.AdvancedTimeSteppingAnalysisForModulationOptions':
    ...
    @property
    def gears(self) -> 'List[_6614.GearLoadCase]':
    ...
    @property
    def gears_without_clones(self) -> 'List[_6614.GearLoadCase]':
    ...
    @property
    def meshes_without_planetary_duplicates(self) -> 'List[_6616.GearMeshLoadCase]':
