...
from mastapy.system_model.analyses_and_results.static_loads import _6751, _6752, _6747
...
class KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase(_6747.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6751.KlingelnbergCycloPalloidSpiralBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6751.KlingelnbergCycloPalloidSpiralBevelGearLoadCase))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_load_case(self) -> 'List[_6751.KlingelnbergCycloPalloidSpiralBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearsLoadCase, constructor.new(_6751.KlingelnbergCycloPalloidSpiralBevelGearLoadCase))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_load_case(self) -> 'List[_6752.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshesLoadCase, constructor.new(_6752.KlingelnbergCycloPalloidSpiralBevelGearMeshLoadCase))
        return value
