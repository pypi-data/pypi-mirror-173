...
from mastapy.system_model.fe import _2221, _2244
...
class FEPartLoadCase(_6643.AbstractShaftOrHousingLoadCase):
    '''FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2221.AngleSource':
        ...
        return constructor.new(_2221.AngleSource)(value) if value is not None else None
    ...
    def planetaries(self) -> 'List[FEPartLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(FEPartLoadCase))
        return value
