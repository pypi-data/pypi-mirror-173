...
class MassDiscLoadCase(_6814.VirtualComponentLoadCase):
    '''MassDiscLoadCase
    ...
    def planetaries(self) -> 'List[MassDiscLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planetaries, constructor.new(MassDiscLoadCase))
        return value
