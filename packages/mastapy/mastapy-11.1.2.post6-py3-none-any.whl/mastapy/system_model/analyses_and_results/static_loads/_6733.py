...
from mastapy.system_model.analyses_and_results.static_loads import _6743, _6731, _6712
...
class HarmonicLoadDataFluxImport(_6731.HarmonicLoadDataCSVImport['_6712.ElectricMachineHarmonicLoadFluxImportOptions']):
    '''HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6743.InnerDiameterReference':
        ...
        return constructor.new(_6743.InnerDiameterReference)(value) if value is not None else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6743.InnerDiameterReference'):
