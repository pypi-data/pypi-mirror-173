...
from mastapy.system_model.analyses_and_results.static_loads import _6651, _6757
...
class RingPinsLoadCase(_6757.MountableComponentLoadCase):
    '''RingPinsLoadCase
    ...
    @property
    def all_ring_pins_manufacturing_error(self) -> '_6651.AllRingPinsManufacturingError':
        ...
        return constructor.new(_6651.AllRingPinsManufacturingError)(self.wrapped.AllRingPinsManufacturingError) if self.wrapped.AllRingPinsManufacturingError is not None else None
