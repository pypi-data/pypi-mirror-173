...
from mastapy.system_model.analyses_and_results.static_loads import _6717, _6718, _6728
...
class FaceGearSetLoadCase(_6728.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6717.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6717.FaceGearLoadCase))
        return value

    @property
    def face_gears_load_case(self) -> 'List[_6717.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6717.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6718.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6718.FaceGearMeshLoadCase))
        return value
