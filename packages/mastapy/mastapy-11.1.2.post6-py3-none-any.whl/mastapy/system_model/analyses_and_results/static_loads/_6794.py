...
from mastapy.system_model.analyses_and_results.static_loads import _6792, _6793, _6664
...
class StraightBevelDiffGearSetLoadCase(_6664.BevelGearSetLoadCase):
    '''StraightBevelDiffGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6792.StraightBevelDiffGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6792.StraightBevelDiffGearLoadCase))
        return value

    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6792.StraightBevelDiffGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsLoadCase, constructor.new(_6792.StraightBevelDiffGearLoadCase))
        return value

    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6793.StraightBevelDiffGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesLoadCase, constructor.new(_6793.StraightBevelDiffGearMeshLoadCase))
        return value
