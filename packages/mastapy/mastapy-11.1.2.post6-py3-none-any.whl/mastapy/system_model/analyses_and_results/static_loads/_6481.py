...
from mastapy.math_utility.control import _1337
...
class ConceptCouplingLoadCase(_6494.CouplingLoadCase):
    '''ConceptCouplingLoadCase
    ...
    @property
    def speed_ratio_specification_method(self) -> '_1892.ConceptCouplingSpeedRatioSpecificationMethod':
        ...
        return constructor.new(_1892.ConceptCouplingSpeedRatioSpecificationMethod)(value) if value else None

    @speed_ratio_specification_method.setter
    def speed_ratio_specification_method(self, value: '_1892.ConceptCouplingSpeedRatioSpecificationMethod'):
    ...
    @property
    def speed_ratio_pid_control(self) -> '_1337.PIDControlSettings':
        ...
        return constructor.new(_1337.PIDControlSettings)(self.wrapped.SpeedRatioPIDControl) if self.wrapped.SpeedRatioPIDControl else None
