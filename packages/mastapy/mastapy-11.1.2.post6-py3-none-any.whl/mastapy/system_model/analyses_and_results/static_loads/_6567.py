...
from mastapy.system_model.analyses_and_results.static_loads import _6568, _6614
...
class ConicalGearLoadCase(_6614.GearLoadCase):
    """ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6568.ConicalGearManufactureError':
