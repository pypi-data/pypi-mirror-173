...
from mastapy.system_model.analyses_and_results.static_loads import _6726
...
class GearSetHarmonicLoadData(_1284.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6726.GearMeshTEOrderType':
        ...
        return constructor.new(_6726.GearMeshTEOrderType)(value) if value is not None else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6726.GearMeshTEOrderType'):
