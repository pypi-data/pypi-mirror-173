...
class DataFromMotorPackagePerSpeed(_0.APIBase):
    ...
    @property
    def data_per_mean_torque(self) -> 'List[_6508.DataFromMotorPackagePerMeanTorque]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DataPerMeanTorque, constructor.new(_6508.DataFromMotorPackagePerMeanTorque))
        return value
