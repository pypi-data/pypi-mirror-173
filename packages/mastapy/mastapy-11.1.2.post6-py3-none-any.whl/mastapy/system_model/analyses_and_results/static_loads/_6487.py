...
from mastapy.gears.gear_designs.conical import _1079, _1073
from mastapy.system_model.analyses_and_results.static_loads import _6488, _6534
...
class ConicalGearMeshLoadCase(_6534.GearMeshLoadCase):
    '''ConicalGearMeshLoadCase
    ...
    @property
    def results_from_imported_xml(self) -> '_1079.KimosBevelHypoidSingleLoadCaseResultsData':
        ...
        return constructor.new(_1079.KimosBevelHypoidSingleLoadCaseResultsData)(self.wrapped.ResultsFromImportedXML) if self.wrapped.ResultsFromImportedXML else None
    ...
    def get_harmonic_load_data_for_import(self) -> '_6488.ConicalGearSetHarmonicLoadData':
