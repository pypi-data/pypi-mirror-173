...
from mastapy.system_model.analyses_and_results.static_loads import _6604, _6453, _6618
...
class ConnectionLoadCase(_2325.ConnectionAnalysis):
    '''ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_6604.StaticLoadCase':
        ...
        if _6604.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
    ...
    @property
    def time_series_load_case(self) -> '_6618.TimeSeriesLoadCase':
        ...
        return constructor.new(_6618.TimeSeriesLoadCase)(self.wrapped.TimeSeriesLoadCase) if self.wrapped.TimeSeriesLoadCase else None
