...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6824, _6835, _6826, _6823,
    _6827, _6829, _6836, _6833,
    _6825, _6828, _6822
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.utility.file_access_helpers import _1705
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6741.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6741.ImportType)(value) if value is not None else None

    @import_type.setter
    def import_type(self, value: '_6741.ImportType'):
    ...
    @property
    def force_chart(self) -> '_1745.TwoDChartDefinition':
        ...
        if _1745.TwoDChartDefinition.TYPE not in self.wrapped.ForceChart.__class__.__mro__:
    ...
    @property
    def moment_chart(self) -> '_1745.TwoDChartDefinition':
        ...
        if _1745.TwoDChartDefinition.TYPE not in self.wrapped.MomentChart.__class__.__mro__:
    ...
    @property
    def time_step_input(self) -> '_6835.TimeStepInputOptions':
        ...
        return constructor.new(_6835.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput is not None else None

    @property
    def gear_ratio_options(self) -> '_6826.GearRatioInputOptions':
        ...
        return constructor.new(_6826.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions is not None else None

    @property
    def design_state_options(self) -> '_6823.DesignStateOptions':
        ...
        return constructor.new(_6823.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions is not None else None

    @property
    def load_case_name_inputs(self) -> '_6827.LoadCaseNameOptions':
        ...
        return constructor.new(_6827.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs is not None else None

    @property
    def file_inputs(self) -> 'List[_6829.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6829.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6836.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6836.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6833.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6833.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6825.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6825.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6828.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6828.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6822.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6822.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1705.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1705.ColumnTitle))
        return value
