...
from mastapy.utility.file_access_helpers import _1706
from mastapy.utility_gui import _1734
...
class MultiTimeSeriesDataInputFileOptions(_1734.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1706.TextFileDelimiterOptions':
        ...
        return constructor.new(_1706.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions is not None else None
