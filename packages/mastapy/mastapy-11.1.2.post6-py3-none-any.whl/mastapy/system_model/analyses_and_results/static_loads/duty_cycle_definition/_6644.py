...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6635
...
class PointLoadInputOptions(_1574.ColumnInputOptions):
    '''PointLoadInputOptions
    ...
    @axis.setter
    def axis(self, value: '_1256.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Axis = value

    @property
    def conversion_to_load_case(self) -> '_6635.AdditionalForcesObtainedFrom':
        ...
        return constructor.new(_6635.AdditionalForcesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6635.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
