...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6651, _6645
...
class TorqueInputOptions(_6645.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6651.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6651.TorqueValuesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6651.TorqueValuesObtainedFrom'):
