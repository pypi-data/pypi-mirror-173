...
from mastapy.math_utility import _1391
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6821
from mastapy.utility_gui import _1733
...
class PointLoadInputOptions(_1733.ColumnInputOptions):
    '''PointLoadInputOptions
    ...
    @axis.setter
    def axis(self, value: '_1391.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Axis = value

    @property
    def conversion_to_load_case(self) -> '_6821.AdditionalForcesObtainedFrom':
        ...
        return constructor.new(_6821.AdditionalForcesObtainedFrom)(value) if value is not None else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6821.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
