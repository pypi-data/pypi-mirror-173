...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6638, _6649, _6640, _6637,
    _6641, _6643, _6650, _6647,
    _6639, _6642, _6636
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6552.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6552.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6552.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6649.TimeStepInputOptions':
        ...
        return constructor.new(_6649.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6640.GearRatioInputOptions':
        ...
        return constructor.new(_6640.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6637.DesignStateOptions':
        ...
        return constructor.new(_6637.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6641.LoadCaseNameOptions':
        ...
        return constructor.new(_6641.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6643.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6643.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6650.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6650.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6647.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6647.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6639.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6639.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6642.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6642.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6636.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6636.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1548.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1548.ColumnTitle))
        return value
