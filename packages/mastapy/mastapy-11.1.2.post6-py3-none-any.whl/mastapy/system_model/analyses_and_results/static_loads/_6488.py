...
class ConicalGearSetHarmonicLoadData(_6536.GearSetHarmonicLoadData):
    '''ConicalGearSetHarmonicLoadData
    ...
    @property
    def te_specification_type(self) -> '_311.TESpecificationType':
        ...
        return constructor.new(_311.TESpecificationType)(value) if value else None

    @te_specification_type.setter
    def te_specification_type(self, value: '_311.TESpecificationType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TESpecificationType = value

    @property
    def excitations(self) -> 'List[_1278.FourierSeries]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Excitations, constructor.new(_1278.FourierSeries))
        return value
