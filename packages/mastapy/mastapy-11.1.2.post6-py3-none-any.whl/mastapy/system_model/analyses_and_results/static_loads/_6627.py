...
from mastapy.system_model.analyses_and_results.static_loads import _6630, _6626, _6604
...
class HarmonicLoadDataImportFromMotorPackages(_6626.HarmonicLoadDataImportBase['T'], Generic[T]):
    """HarmonicLoadDataImportFromMotorPackages
