...
class RootAssemblyLoadCase(_6653.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self) -> '_1475.PIDControlSettings':
        ...
        return constructor.new(_1475.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings is not None else None
    ...
    @property
    def load_case(self) -> '_6639.StaticLoadCase':
        ...
        if _6639.StaticLoadCase.TYPE not in self.wrapped.LoadCase.__class__.__mro__:
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6699.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6699.CylindricalGearSetLoadCase))
        return value
