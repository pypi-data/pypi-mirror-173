...
from mastapy.system_model.analyses_and_results.static_loads import _6734, _6713
...
class HarmonicLoadDataImportFromMotorPackages(_6734.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
