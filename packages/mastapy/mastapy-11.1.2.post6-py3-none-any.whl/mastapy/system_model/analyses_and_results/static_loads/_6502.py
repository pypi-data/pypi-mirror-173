...
from mastapy.system_model.analyses_and_results.static_loads import _6503, _6532
...
class CylindricalGearLoadCase(_6532.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6503.CylindricalGearManufactureError':
        ...
        return constructor.new(_6503.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
