...
from mastapy.gears.manufacturing.bevel import _741, _739, _740
...
class AGMAGleasonConicalGearSetLoadCase(_6489.ConicalGearSetLoadCase):
    '''AGMAGleasonConicalGearSetLoadCase
    ...
    @property
    def overridden_manufacturing_config_micro_geometry(self) -> '_741.ConicalSetMicroGeometryConfigBase':
        ...
        if _741.ConicalSetMicroGeometryConfigBase.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
    ...
    @property
    def overridden_manufacturing_config_micro_geometry_of_type_conical_set_manufacturing_config(self) -> '_739.ConicalSetManufacturingConfig':
        ...
        if _739.ConicalSetManufacturingConfig.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
    ...
    @property
    def overridden_manufacturing_config_micro_geometry_of_type_conical_set_micro_geometry_config(self) -> '_740.ConicalSetMicroGeometryConfig':
        ...
        if _740.ConicalSetMicroGeometryConfig.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
