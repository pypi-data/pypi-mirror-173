...
from mastapy.bearings.tolerances import _1621, _1627
...
class BearingLoadCase(_6491.ConnectorLoadCase):
    '''BearingLoadCase
    ...
    @property
    def include_fitting_effects(self) -> '_1349.LoadCaseOverrideOption':
        ...
        return constructor.new(_1349.LoadCaseOverrideOption)(value) if value else None

    @include_fitting_effects.setter
    def include_fitting_effects(self, value: '_1349.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeFittingEffects = value

    @property
    def include_thermal_expansion_effects(self) -> '_1349.LoadCaseOverrideOption':
    ...
    def include_thermal_expansion_effects(self, value: '_1349.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.IncludeThermalExpansionEffects = value

    @property
    def include_ring_ovality(self) -> '_1349.LoadCaseOverrideOption':
    ...
    def include_ring_ovality(self, value: '_1349.LoadCaseOverrideOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def bearing_stiffness_model(self) -> '_5045.BearingStiffnessModel':
        ...
        return constructor.new(_5045.BearingStiffnessModel)(value) if value else None

    @bearing_stiffness_model.setter
    def bearing_stiffness_model(self, value: '_5045.BearingStiffnessModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingStiffnessModel = value

    @property
    def bearing_stiffness_model_used_in_analysis(self) -> '_5045.BearingStiffnessModel':
    ...
    @property
    def left_ring_detail(self) -> '_1621.RaceDetail':
        ...
        return constructor.new(_1621.RaceDetail)(self.wrapped.LeftRingDetail) if self.wrapped.LeftRingDetail else None

    @property
    def right_ring_detail(self) -> '_1621.RaceDetail':
        ...
        return constructor.new(_1621.RaceDetail)(self.wrapped.RightRingDetail) if self.wrapped.RightRingDetail else None
    ...
    @property
    def inner_ring_detail(self) -> '_1621.RaceDetail':
        ...
        return constructor.new(_1621.RaceDetail)(self.wrapped.InnerRingDetail) if self.wrapped.InnerRingDetail else None
    ...
    @property
    def outer_ring_detail(self) -> '_1621.RaceDetail':
        ...
        return constructor.new(_1621.RaceDetail)(self.wrapped.OuterRingDetail) if self.wrapped.OuterRingDetail else None
