...
from mastapy.system_model.analyses_and_results.static_loads import _6505, _6534
...
class CylindricalGearMeshLoadCase(_6534.GearMeshLoadCase):
    '''CylindricalGearMeshLoadCase
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents(self) -> '_546.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_546.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponents) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponents else None
