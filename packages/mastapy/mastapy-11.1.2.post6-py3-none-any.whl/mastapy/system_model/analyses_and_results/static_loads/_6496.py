...
from mastapy.system_model.analyses_and_results.static_loads import _6497, _6463
...
class CVTLoadCase(_6463.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def assembly_design(self) -> '_2263.CVT':
        ...
        return constructor.new(_2263.CVT)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def pulleys(self) -> 'List[_6497.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6497.CVTPulleyLoadCase))
        return value
