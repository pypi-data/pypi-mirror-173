...
class TorqueConverterLoadCase(_6687.CouplingLoadCase):
    '''TorqueConverterLoadCase
    ...
    @property
    def lock_up_clutch_pressure_time_profile(self) -> '_1435.Vector2DListAccessor':
        '''Vector2DListAccessor: 'LockUpClutchPressureTimeProfile' is the original name of this property.'''

        return constructor.new(_1435.Vector2DListAccessor)(self.wrapped.LockUpClutchPressureTimeProfile) if self.wrapped.LockUpClutchPressureTimeProfile is not None else None

    @lock_up_clutch_pressure_time_profile.setter
    def lock_up_clutch_pressure_time_profile(self, value: '_1435.Vector2DListAccessor'):
