...
class AllRingPinsManufacturingError(_0.APIBase):
    ...
    @property
    def roundness_specification(self) -> '_1625.RoundnessSpecification':
        ...
        return constructor.new(_1625.RoundnessSpecification)(self.wrapped.RoundnessSpecification) if self.wrapped.RoundnessSpecification else None

    @property
    def ring_pin_manufacturing_errors(self) -> 'List[_6586.RingPinManufacturingError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinManufacturingErrors, constructor.new(_6586.RingPinManufacturingError))
        return value
