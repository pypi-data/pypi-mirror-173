...
from mastapy.system_model.analyses_and_results.static_loads import _6464, _6465, _6471
...
class BevelDifferentialGearSetLoadCase(_6471.BevelGearSetLoadCase):
    '''BevelDifferentialGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6464.BevelDifferentialGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6464.BevelDifferentialGearLoadCase))
        return value

    @property
    def bevel_differential_gears_load_case(self) -> 'List[_6464.BevelDifferentialGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsLoadCase, constructor.new(_6464.BevelDifferentialGearLoadCase))
        return value

    @property
    def bevel_differential_meshes_load_case(self) -> 'List[_6465.BevelDifferentialGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesLoadCase, constructor.new(_6465.BevelDifferentialGearMeshLoadCase))
        return value
