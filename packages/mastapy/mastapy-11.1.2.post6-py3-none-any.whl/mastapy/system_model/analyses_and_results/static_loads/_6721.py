...
from mastapy.utility import _1487
...
class FlexiblePinAssemblyLoadCase(_6785.SpecialisedAssemblyLoadCase):
    '''FlexiblePinAssemblyLoadCase
    ...
    @property
    def include_inner_race_distortion_for_flexible_pin_spindle(self) -> '_1487.LoadCaseOverrideOption':
        ...
        return constructor.new(_1487.LoadCaseOverrideOption)(value) if value is not None else None

    @include_inner_race_distortion_for_flexible_pin_spindle.setter
    def include_inner_race_distortion_for_flexible_pin_spindle(self, value: '_1487.LoadCaseOverrideOption'):
