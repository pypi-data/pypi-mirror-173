...
class PlanetarySocketManufactureError(_0.APIBase):
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6769.PlanetManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6769.PlanetManufactureError))
        return value
