...
from mastapy.system_model.analyses_and_results.static_loads import _6514, _6522
...
T = TypeVar('T', bound='_6522.ElectricMachineHarmonicLoadImportOptionsBase')


class ElectricMachineHarmonicLoadDataFromMotorPackages(_6514.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
