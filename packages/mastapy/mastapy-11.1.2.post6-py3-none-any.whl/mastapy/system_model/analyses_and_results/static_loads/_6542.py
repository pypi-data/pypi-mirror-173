...
from mastapy.system_model.analyses_and_results.static_loads import (
    _6543, _6545, _6548, _6554,
    _6555, _6578, _6556, _6558,
    _6563, _6566, _6580, _6582,
    _6588, _6611, _6610, _6612,
    _6616, _6633, _6643, _6646,
    _6647, _6648, _6653, _6658,
    _6662, _6665, _6666, _6670,
    _6671, _6672, _6676, _6677,
    _6532, _6683, _6686, _6689,
    _6692, _6696, _6701, _6708,
    _6712, _6715, _6530
)
...
class AssemblyLoadCase(_6530.AbstractAssemblyLoadCase):
    """AssemblyLoadCase
    ...
    @property
    def bearings(self) -> 'List[_6543.BearingLoadCase]':
    ...
    @property
    def belt_drives(self) -> 'List[_6545.BeltDriveLoadCase]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_6548.BevelDifferentialGearSetLoadCase]':
    ...
    @property
    def bolted_joints(self) -> 'List[_6554.BoltedJointLoadCase]':
    ...
    @property
    def bolts(self) -> 'List[_6555.BoltLoadCase]':
    ...
    @property
    def cv_ts(self) -> 'List[_6578.CVTLoadCase]':
    ...
    @property
    def clutch_connections(self) -> 'List[_6556.ClutchConnectionLoadCase]':
    ...
    @property
    def clutches(self) -> 'List[_6558.ClutchLoadCase]':
    ...
    @property
    def concept_couplings(self) -> 'List[_6563.ConceptCouplingLoadCase]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_6566.ConceptGearSetLoadCase]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_6580.CycloidalAssemblyLoadCase]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_6582.CycloidalDiscLoadCase]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_6588.CylindricalGearSetLoadCase]':
    ...
    @property
    def fe_parts(self) -> 'List[_6611.FEPartLoadCase]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_6610.FaceGearSetLoadCase]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_6612.FlexiblePinAssemblyLoadCase]':
    ...
    @property
    def gear_meshes(self) -> 'List[_6616.GearMeshLoadCase]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_6633.HypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_6643.KlingelnbergCycloPalloidHypoidGearSetLoadCase]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_6646.KlingelnbergCycloPalloidSpiralBevelGearSetLoadCase]':
    ...
    @property
    def mass_discs(self) -> 'List[_6647.MassDiscLoadCase]':
    ...
    @property
    def measurement_components(self) -> 'List[_6648.MeasurementComponentLoadCase]':
    ...
    @property
    def oil_seals(self) -> 'List[_6653.OilSealLoadCase]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_6658.PartToPartShearCouplingLoadCase]':
    ...
    @property
    def planet_carriers(self) -> 'List[_6662.PlanetCarrierLoadCase]':
    ...
    @property
    def point_loads(self) -> 'List[_6665.PointLoadLoadCase]':
    ...
    @property
    def ring_pins(self) -> 'List[_6670.RingPinsLoadCase]':
    ...
    @property
    def ring_pins_to_cycloidal_disc_connections(self) -> 'List[_6671.RingPinsToDiscConnectionLoadCase]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_6672.RollingRingAssemblyLoadCase]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_6676.ShaftHubConnectionLoadCase]':
    ...
    @property
    def shafts(self) -> 'List[_6677.ShaftLoadCase]':
    ...
    @property
    def shafts_and_housings(self) -> 'List[_6532.AbstractShaftOrHousingLoadCase]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_6683.SpiralBevelGearSetLoadCase]':
    ...
    @property
    def spring_dampers(self) -> 'List[_6686.SpringDamperLoadCase]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_6689.StraightBevelDiffGearSetLoadCase]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_6692.StraightBevelGearSetLoadCase]':
    ...
    @property
    def synchronisers(self) -> 'List[_6696.SynchroniserLoadCase]':
    ...
    @property
    def torque_converters(self) -> 'List[_6701.TorqueConverterLoadCase]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_6708.UnbalancedMassLoadCase]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_6712.WormGearSetLoadCase]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_6715.ZerolBevelGearSetLoadCase]':
