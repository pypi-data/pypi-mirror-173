...
class PlanetaryGearSetLoadCase(_6699.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1487.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1487.LoadCaseOverrideOption'):
