...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5678, _5598
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5766
...
class FEPartHarmonicAnalysis(_5598.AbstractShaftOrHousingHarmonicAnalysis):
    '''FEPartHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4810.FEPartModalAnalysis':
        ...
        return constructor.new(_4810.FEPartModalAnalysis)(self.wrapped.CoupledModalAnalysis) if self.wrapped.CoupledModalAnalysis else None

    @property
    def export(self) -> '_5678.HarmonicAnalysisFEExportOptions':
        ...
        return constructor.new(_5678.HarmonicAnalysisFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None

    @property
    def results(self) -> '_5766.FEPartHarmonicAnalysisResultsPropertyAccessor':
        ...
        return constructor.new(_5766.FEPartHarmonicAnalysisResultsPropertyAccessor)(self.wrapped.Results) if self.wrapped.Results else None

    @property
    def component_design(self) -> '_2132.FEPart':
        ...
        return constructor.new(_2132.FEPart)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def component_load_case(self) -> '_6529.FEPartLoadCase':
        ...
        return constructor.new(_6529.FEPartLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2425.FEPartSystemDeflection':
        ...
        return constructor.new(_2425.FEPartSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
