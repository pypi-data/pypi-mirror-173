...
from mastapy.system_model.analyses_and_results.harmonic_analyses import (
    _5421, _5423, _5426, _5432,
    _5433, _5455, _5436, _5442,
    _5445, _5457, _5459, _5463,
    _5482, _5481, _5483, _5501,
    _5508, _5511, _5490, _5512,
    _5513, _5515, _5519, _5523,
    _5524, _5525, _5527, _5529,
    _5534, _5533, _5541, _5544,
    _5547, _5550, _5554, _5558,
    _5562, _5566, _5569, _5412
)
...
class AssemblyHarmonicAnalysis(_5412.AbstractAssemblyHarmonicAnalysis):
    """AssemblyHarmonicAnalysis
    ...
    @property
    def bearings(self) -> 'List[_5421.BearingHarmonicAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5423.BeltDriveHarmonicAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5426.BevelDifferentialGearSetHarmonicAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5432.BoltedJointHarmonicAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5433.BoltHarmonicAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5455.CVTHarmonicAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5436.ClutchHarmonicAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5442.ConceptCouplingHarmonicAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5445.ConceptGearSetHarmonicAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5457.CycloidalAssemblyHarmonicAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5459.CycloidalDiscHarmonicAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5463.CylindricalGearSetHarmonicAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5482.FEPartHarmonicAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5481.FaceGearSetHarmonicAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5483.FlexiblePinAssemblyHarmonicAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5501.HypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5508.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5511.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def loaded_gear_sets(self) -> 'List[_5490.GearSetHarmonicAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5512.MassDiscHarmonicAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5513.MeasurementComponentHarmonicAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5515.OilSealHarmonicAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5519.PartToPartShearCouplingHarmonicAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5523.PlanetCarrierHarmonicAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5524.PointLoadHarmonicAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5525.PowerLoadHarmonicAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5527.RingPinsHarmonicAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5529.RollingRingAssemblyHarmonicAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5534.ShaftHubConnectionHarmonicAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5533.ShaftHarmonicAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5541.SpiralBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5544.SpringDamperHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5547.StraightBevelDiffGearSetHarmonicAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5550.StraightBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5554.SynchroniserHarmonicAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5558.TorqueConverterHarmonicAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5562.UnbalancedMassHarmonicAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5566.WormGearSetHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5569.ZerolBevelGearSetHarmonicAnalysis]':
