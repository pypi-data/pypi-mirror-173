...
from mastapy.system_model.analyses_and_results.static_loads import _6670, _6692
from mastapy.system_model.analyses_and_results.system_deflections import _2569, _2591
...
class CoaxialConnectionHarmonicAnalysis(_5905.ShaftToMountableComponentConnectionHarmonicAnalysis):
    '''CoaxialConnectionHarmonicAnalysis
    ...
    @property
    def connection_load_case(self) -> '_6670.CoaxialConnectionLoadCase':
        ...
        if _6670.CoaxialConnectionLoadCase.TYPE not in self.wrapped.ConnectionLoadCase.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2569.CoaxialConnectionSystemDeflection':
