...
class CycloidalDiscCentralBearingConnectionHarmonicAnalysis(_5620.CoaxialConnectionHarmonicAnalysis):
    '''CycloidalDiscCentralBearingConnectionHarmonicAnalysis
    ...
    @property
    def connection_design(self) -> '_2017.CycloidalDiscCentralBearingConnection':
        ...
        return constructor.new(_2017.CycloidalDiscCentralBearingConnection)(self.wrapped.ConnectionDesign) if self.wrapped.ConnectionDesign else None

    @property
    def system_deflection_results(self) -> '_2406.CycloidalDiscCentralBearingConnectionSystemDeflection':
        ...
        return constructor.new(_2406.CycloidalDiscCentralBearingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
