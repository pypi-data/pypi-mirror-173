...
class FaceGearHarmonicAnalysis(_5668.GearHarmonicAnalysis):
    '''FaceGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2424.FaceGearSystemDeflection':
        ...
        return constructor.new(_2424.FaceGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
