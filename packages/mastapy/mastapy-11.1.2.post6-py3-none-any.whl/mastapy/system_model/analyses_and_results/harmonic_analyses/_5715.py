...
class RootAssemblyHarmonicAnalysis(_5603.AssemblyHarmonicAnalysis):
    '''RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self) -> '_5680.HarmonicAnalysisRootAssemblyExportOptions':
        ...
        return constructor.new(_5680.HarmonicAnalysisRootAssemblyExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def harmonic_analysis_inputs(self) -> '_2308.HarmonicAnalysis':
        ...
        if _2308.HarmonicAnalysis.TYPE not in self.wrapped.HarmonicAnalysisInputs.__class__.__mro__:
