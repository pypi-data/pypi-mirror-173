...
class SynchroniserHarmonicAnalysis(_5720.SpecialisedAssemblyHarmonicAnalysis):
    '''SynchroniserHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2492.SynchroniserSystemDeflection':
        ...
        return constructor.new(_2492.SynchroniserSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
