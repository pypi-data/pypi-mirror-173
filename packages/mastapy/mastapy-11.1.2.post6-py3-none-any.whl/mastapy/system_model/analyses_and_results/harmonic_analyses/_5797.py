...
from mastapy.system_model.part_model.gears import _2377
...
class BevelDifferentialPlanetGearHarmonicAnalysis(_5794.BevelDifferentialGearHarmonicAnalysis):
    '''BevelDifferentialPlanetGearHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2377.BevelDifferentialPlanetGear':
        ...
        return constructor.new(_2377.BevelDifferentialPlanetGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None

    @property
    def system_deflection_results(self) -> '_2559.BevelDifferentialPlanetGearSystemDeflection':
        ...
        return constructor.new(_2559.BevelDifferentialPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
