...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5930
...
class TorqueConverterTurbineCompoundHarmonicAnalysis(_6014.CouplingHalfCompoundHarmonicAnalysis):
    '''TorqueConverterTurbineCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5930.TorqueConverterTurbineHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5930.TorqueConverterTurbineHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5930.TorqueConverterTurbineHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5930.TorqueConverterTurbineHarmonicAnalysis))
        return value
