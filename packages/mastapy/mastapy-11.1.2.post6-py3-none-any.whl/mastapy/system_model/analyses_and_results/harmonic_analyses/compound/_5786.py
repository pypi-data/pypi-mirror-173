...
class AbstractShaftOrHousingCompoundHarmonicAnalysis(_5809.ComponentCompoundHarmonicAnalysis):
    '''AbstractShaftOrHousingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5598.AbstractShaftOrHousingHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5598.AbstractShaftOrHousingHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5598.AbstractShaftOrHousingHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5598.AbstractShaftOrHousingHarmonicAnalysis))
        return value
