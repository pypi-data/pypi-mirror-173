...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5919
...
class StraightBevelGearMeshCompoundHarmonicAnalysis(_5992.BevelGearMeshCompoundHarmonicAnalysis):
    '''StraightBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5919.StraightBevelGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5919.StraightBevelGearMeshHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5919.StraightBevelGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5919.StraightBevelGearMeshHarmonicAnalysis))
        return value
