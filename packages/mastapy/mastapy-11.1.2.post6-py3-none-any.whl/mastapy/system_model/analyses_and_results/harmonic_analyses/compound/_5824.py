...
class CVTBeltConnectionCompoundHarmonicAnalysis(_5793.BeltConnectionCompoundHarmonicAnalysis):
    '''CVTBeltConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5637.CVTBeltConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5637.CVTBeltConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5637.CVTBeltConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5637.CVTBeltConnectionHarmonicAnalysis))
        return value
