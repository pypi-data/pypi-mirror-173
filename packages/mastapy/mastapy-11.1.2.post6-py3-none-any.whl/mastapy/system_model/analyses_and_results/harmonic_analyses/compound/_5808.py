...
class CoaxialConnectionCompoundHarmonicAnalysis(_5881.ShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    '''CoaxialConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5620.CoaxialConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5620.CoaxialConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5620.CoaxialConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5620.CoaxialConnectionHarmonicAnalysis))
        return value
