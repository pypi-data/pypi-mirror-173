...
class CouplingCompoundHarmonicAnalysis(_6073.SpecialisedAssemblyCompoundHarmonicAnalysis):
    '''CouplingCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5823.CouplingHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5823.CouplingHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5823.CouplingHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5823.CouplingHarmonicAnalysis))
        return value
