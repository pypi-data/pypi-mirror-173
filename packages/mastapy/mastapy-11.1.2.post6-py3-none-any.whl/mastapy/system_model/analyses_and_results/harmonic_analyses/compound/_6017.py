...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _6063
...
class CVTPulleyCompoundHarmonicAnalysis(_6063.PulleyCompoundHarmonicAnalysis):
    '''CVTPulleyCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5826.CVTPulleyHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5826.CVTPulleyHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5826.CVTPulleyHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5826.CVTPulleyHarmonicAnalysis))
        return value
