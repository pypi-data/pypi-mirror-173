...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5904
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _6011
...
class ShaftHubConnectionCompoundHarmonicAnalysis(_6011.ConnectorCompoundHarmonicAnalysis):
    '''ShaftHubConnectionCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5904.ShaftHubConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5904.ShaftHubConnectionHarmonicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5904.ShaftHubConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5904.ShaftHubConnectionHarmonicAnalysis))
        return value
