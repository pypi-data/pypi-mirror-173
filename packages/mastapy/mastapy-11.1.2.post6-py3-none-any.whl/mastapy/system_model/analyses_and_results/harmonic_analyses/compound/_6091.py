...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5926
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _6090
...
class SynchroniserSleeveCompoundHarmonicAnalysis(_6090.SynchroniserPartCompoundHarmonicAnalysis):
    '''SynchroniserSleeveCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5926.SynchroniserSleeveHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5926.SynchroniserSleeveHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5926.SynchroniserSleeveHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5926.SynchroniserSleeveHarmonicAnalysis))
        return value
