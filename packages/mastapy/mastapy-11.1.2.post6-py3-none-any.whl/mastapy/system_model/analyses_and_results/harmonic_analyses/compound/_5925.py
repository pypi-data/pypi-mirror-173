...
class ShaftToMountableComponentConnectionCompoundHarmonicAnalysis(_5831.AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    '''ShaftToMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5758.ShaftToMountableComponentConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5758.ShaftToMountableComponentConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5758.ShaftToMountableComponentConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5758.ShaftToMountableComponentConnectionHarmonicAnalysis))
        return value
