...
class CVTCompoundHarmonicAnalysis(_5985.BeltDriveCompoundHarmonicAnalysis):
    '''CVTCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5825.CVTHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5825.CVTHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5825.CVTHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5825.CVTHarmonicAnalysis))
        return value
