...
class ShaftCompoundHarmonicAnalysis(_5785.AbstractShaftCompoundHarmonicAnalysis):
    '''ShaftCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5716.ShaftHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5716.ShaftHarmonicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5716.ShaftHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5716.ShaftHarmonicAnalysis))
        return value
