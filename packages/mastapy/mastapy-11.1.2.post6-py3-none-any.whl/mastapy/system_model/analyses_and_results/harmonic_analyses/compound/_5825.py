...
class CVTCompoundHarmonicAnalysis(_5794.BeltDriveCompoundHarmonicAnalysis):
    '''CVTCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5638.CVTHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5638.CVTHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5638.CVTHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5638.CVTHarmonicAnalysis))
        return value
