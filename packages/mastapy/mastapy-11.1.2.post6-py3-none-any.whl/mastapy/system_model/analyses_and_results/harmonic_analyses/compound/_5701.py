...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5534
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5641
...
class ShaftHubConnectionCompoundHarmonicAnalysis(_5641.ConnectorCompoundHarmonicAnalysis):
    """ShaftHubConnectionCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5534.ShaftHubConnectionHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5534.ShaftHubConnectionHarmonicAnalysis]':
