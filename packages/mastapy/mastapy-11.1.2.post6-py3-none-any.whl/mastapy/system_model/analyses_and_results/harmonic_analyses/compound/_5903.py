...
class TorqueConverterPumpCompoundHarmonicAnalysis(_5823.CouplingHalfCompoundHarmonicAnalysis):
    '''TorqueConverterPumpCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5742.TorqueConverterPumpHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5742.TorqueConverterPumpHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5742.TorqueConverterPumpHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5742.TorqueConverterPumpHarmonicAnalysis))
        return value
