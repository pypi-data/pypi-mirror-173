...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5875
...
class KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis(_6009.ConicalGearSetCompoundHarmonicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5875.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5875.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5875.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5875.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis))
        return value
