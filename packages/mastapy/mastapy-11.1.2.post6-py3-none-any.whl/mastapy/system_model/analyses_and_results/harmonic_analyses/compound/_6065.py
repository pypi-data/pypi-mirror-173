...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5898
...
class RingPinsToDiscConnectionCompoundHarmonicAnalysis(_6040.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    '''RingPinsToDiscConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5898.RingPinsToDiscConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5898.RingPinsToDiscConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5898.RingPinsToDiscConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5898.RingPinsToDiscConnectionHarmonicAnalysis))
        return value
