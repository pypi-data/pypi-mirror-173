...
class CycloidalDiscCompoundHarmonicAnalysis(_5785.AbstractShaftCompoundHarmonicAnalysis):
    '''CycloidalDiscCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5642.CycloidalDiscHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5642.CycloidalDiscHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5642.CycloidalDiscHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5642.CycloidalDiscHarmonicAnalysis))
        return value
