...
class StraightBevelDiffGearCompoundHarmonicAnalysis(_5991.BevelGearCompoundHarmonicAnalysis):
    '''StraightBevelDiffGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5915.StraightBevelDiffGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5915.StraightBevelDiffGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5915.StraightBevelDiffGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5915.StraightBevelDiffGearHarmonicAnalysis))
        return value
