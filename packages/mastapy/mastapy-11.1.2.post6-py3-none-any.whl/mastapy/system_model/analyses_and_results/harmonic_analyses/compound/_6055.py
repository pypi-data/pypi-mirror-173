...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5889
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _6012
...
class PartToPartShearCouplingCompoundHarmonicAnalysis(_6012.CouplingCompoundHarmonicAnalysis):
    '''PartToPartShearCouplingCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5889.PartToPartShearCouplingHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5889.PartToPartShearCouplingHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5889.PartToPartShearCouplingHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5889.PartToPartShearCouplingHarmonicAnalysis))
        return value
