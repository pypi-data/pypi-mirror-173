...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5900
...
class RollingRingConnectionCompoundHarmonicAnalysis(_6040.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    '''RollingRingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5900.RollingRingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5900.RollingRingConnectionHarmonicAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5900.RollingRingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5900.RollingRingConnectionHarmonicAnalysis))
        return value
