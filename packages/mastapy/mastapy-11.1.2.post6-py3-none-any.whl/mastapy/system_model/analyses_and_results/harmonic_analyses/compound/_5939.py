...
class StraightBevelPlanetGearCompoundHarmonicAnalysis(_5933.StraightBevelDiffGearCompoundHarmonicAnalysis):
    '''StraightBevelPlanetGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5774.StraightBevelPlanetGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5774.StraightBevelPlanetGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5774.StraightBevelPlanetGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5774.StraightBevelPlanetGearHarmonicAnalysis))
        return value
