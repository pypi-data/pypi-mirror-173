...
class VirtualComponentCompoundHarmonicAnalysis(_5861.MountableComponentCompoundHarmonicAnalysis):
    '''VirtualComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5746.VirtualComponentHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5746.VirtualComponentHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5746.VirtualComponentHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5746.VirtualComponentHarmonicAnalysis))
        return value
