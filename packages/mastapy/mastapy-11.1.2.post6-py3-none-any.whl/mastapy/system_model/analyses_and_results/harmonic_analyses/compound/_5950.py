...
class VirtualComponentCompoundHarmonicAnalysis(_5905.MountableComponentCompoundHarmonicAnalysis):
    '''VirtualComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5786.VirtualComponentHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5786.VirtualComponentHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5786.VirtualComponentHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5786.VirtualComponentHarmonicAnalysis))
        return value
