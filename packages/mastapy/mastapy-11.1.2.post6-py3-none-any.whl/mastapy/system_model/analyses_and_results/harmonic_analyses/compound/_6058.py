...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5891
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _6072
...
class PlanetaryConnectionCompoundHarmonicAnalysis(_6072.ShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    '''PlanetaryConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5891.PlanetaryConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5891.PlanetaryConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5891.PlanetaryConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5891.PlanetaryConnectionHarmonicAnalysis))
        return value
