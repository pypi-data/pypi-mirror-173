...
class StraightBevelPlanetGearCompoundHarmonicAnalysis(_5889.StraightBevelDiffGearCompoundHarmonicAnalysis):
    '''StraightBevelPlanetGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5734.StraightBevelPlanetGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5734.StraightBevelPlanetGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5734.StraightBevelPlanetGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5734.StraightBevelPlanetGearHarmonicAnalysis))
        return value
