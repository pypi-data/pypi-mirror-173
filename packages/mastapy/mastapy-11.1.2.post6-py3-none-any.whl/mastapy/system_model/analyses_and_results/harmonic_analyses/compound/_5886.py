...
class SpringDamperCompoundHarmonicAnalysis(_5821.CouplingCompoundHarmonicAnalysis):
    '''SpringDamperCompoundHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2277.SpringDamper':
        ...
        return constructor.new(_2277.SpringDamper)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5727.SpringDamperHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5727.SpringDamperHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5727.SpringDamperHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5727.SpringDamperHarmonicAnalysis))
        return value
