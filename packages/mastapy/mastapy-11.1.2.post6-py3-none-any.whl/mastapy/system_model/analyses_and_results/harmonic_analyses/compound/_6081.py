...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5916
...
class StraightBevelDiffGearMeshCompoundHarmonicAnalysis(_5992.BevelGearMeshCompoundHarmonicAnalysis):
    '''StraightBevelDiffGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5916.StraightBevelDiffGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5916.StraightBevelDiffGearMeshHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5916.StraightBevelDiffGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5916.StraightBevelDiffGearMeshHarmonicAnalysis))
        return value
