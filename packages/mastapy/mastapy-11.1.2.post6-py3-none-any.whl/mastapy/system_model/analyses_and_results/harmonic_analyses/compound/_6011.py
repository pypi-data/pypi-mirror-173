...
class ConnectorCompoundHarmonicAnalysis(_6052.MountableComponentCompoundHarmonicAnalysis):
    '''ConnectorCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5820.ConnectorHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5820.ConnectorHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5820.ConnectorHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5820.ConnectorHarmonicAnalysis))
        return value
