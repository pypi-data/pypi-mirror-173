...
class AGMAGleasonConicalGearSetCompoundHarmonicAnalysis(_6009.ConicalGearSetCompoundHarmonicAnalysis):
    '''AGMAGleasonConicalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5789.AGMAGleasonConicalGearSetHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5789.AGMAGleasonConicalGearSetHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5789.AGMAGleasonConicalGearSetHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5789.AGMAGleasonConicalGearSetHarmonicAnalysis))
        return value
