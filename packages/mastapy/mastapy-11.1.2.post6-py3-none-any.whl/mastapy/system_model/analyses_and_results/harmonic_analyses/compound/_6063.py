...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5896
...
class PulleyCompoundHarmonicAnalysis(_6014.CouplingHalfCompoundHarmonicAnalysis):
    '''PulleyCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5896.PulleyHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5896.PulleyHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5896.PulleyHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5896.PulleyHarmonicAnalysis))
        return value
