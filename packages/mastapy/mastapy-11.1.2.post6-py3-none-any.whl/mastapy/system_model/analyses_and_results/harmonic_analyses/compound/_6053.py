...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5885
...
class OilSealCompoundHarmonicAnalysis(_6011.ConnectorCompoundHarmonicAnalysis):
    '''OilSealCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5885.OilSealHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5885.OilSealHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5885.OilSealHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5885.OilSealHarmonicAnalysis))
        return value
