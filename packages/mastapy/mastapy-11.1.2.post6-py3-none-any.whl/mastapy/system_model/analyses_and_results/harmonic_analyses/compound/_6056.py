...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5887
...
class PartToPartShearCouplingConnectionCompoundHarmonicAnalysis(_6013.CouplingConnectionCompoundHarmonicAnalysis):
    '''PartToPartShearCouplingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5887.PartToPartShearCouplingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5887.PartToPartShearCouplingConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5887.PartToPartShearCouplingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5887.PartToPartShearCouplingConnectionHarmonicAnalysis))
        return value
