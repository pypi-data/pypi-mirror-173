...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5937
...
class ZerolBevelGearCompoundHarmonicAnalysis(_5991.BevelGearCompoundHarmonicAnalysis):
    '''ZerolBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5937.ZerolBevelGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5937.ZerolBevelGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5937.ZerolBevelGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5937.ZerolBevelGearHarmonicAnalysis))
        return value
