...
class WormGearMeshCompoundHarmonicAnalysis(_5664.GearMeshCompoundHarmonicAnalysis):
    """WormGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5565.WormGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5565.WormGearMeshHarmonicAnalysis]':
