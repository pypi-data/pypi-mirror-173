...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5457
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5703
...
class CycloidalAssemblyCompoundHarmonicAnalysis(_5703.SpecialisedAssemblyCompoundHarmonicAnalysis):
    """CycloidalAssemblyCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5457.CycloidalAssemblyHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5457.CycloidalAssemblyHarmonicAnalysis]':
