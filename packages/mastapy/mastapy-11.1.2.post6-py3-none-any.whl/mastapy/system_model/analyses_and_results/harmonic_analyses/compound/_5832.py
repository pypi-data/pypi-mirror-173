...
class CylindricalGearMeshCompoundHarmonicAnalysis(_5843.GearMeshCompoundHarmonicAnalysis):
    '''CylindricalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5645.CylindricalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5645.CylindricalGearMeshHarmonicAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5645.CylindricalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5645.CylindricalGearMeshHarmonicAnalysis))
        return value
