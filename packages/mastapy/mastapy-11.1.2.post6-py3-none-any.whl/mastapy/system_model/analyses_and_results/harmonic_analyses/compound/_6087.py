...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5922
...
class StraightBevelSunGearCompoundHarmonicAnalysis(_6080.StraightBevelDiffGearCompoundHarmonicAnalysis):
    '''StraightBevelSunGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5922.StraightBevelSunGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5922.StraightBevelSunGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5922.StraightBevelSunGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5922.StraightBevelSunGearHarmonicAnalysis))
        return value
