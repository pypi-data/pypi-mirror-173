...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _6008
...
class KlingelnbergCycloPalloidConicalGearMeshCompoundHarmonicAnalysis(_6008.ConicalGearMeshCompoundHarmonicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5874.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5874.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5874.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5874.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis))
        return value
