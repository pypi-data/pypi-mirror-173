...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5527
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5682
...
class RingPinsCompoundHarmonicAnalysis(_5682.MountableComponentCompoundHarmonicAnalysis):
    """RingPinsCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5527.RingPinsHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5527.RingPinsHarmonicAnalysis]':
