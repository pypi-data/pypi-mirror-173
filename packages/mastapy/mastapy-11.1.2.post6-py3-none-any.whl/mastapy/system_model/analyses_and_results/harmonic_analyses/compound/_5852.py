...
class KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis(_5818.ConicalGearSetCompoundHarmonicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5688.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5688.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5688.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5688.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis))
        return value
