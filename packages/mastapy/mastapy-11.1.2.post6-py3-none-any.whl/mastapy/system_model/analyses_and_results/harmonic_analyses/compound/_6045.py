...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5877
...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundHarmonicAnalysis(_6042.KlingelnbergCycloPalloidConicalGearMeshCompoundHarmonicAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5877.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5877.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5877.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5877.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis))
        return value
