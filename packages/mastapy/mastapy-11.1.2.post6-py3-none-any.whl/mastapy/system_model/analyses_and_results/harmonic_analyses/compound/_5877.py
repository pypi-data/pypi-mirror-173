...
class RollingRingConnectionCompoundHarmonicAnalysis(_5849.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    '''RollingRingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_1974.RollingRingConnection':
        ...
        return constructor.new(_1974.RollingRingConnection)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def connection_design(self) -> '_1974.RollingRingConnection':
        ...
        return constructor.new(_1974.RollingRingConnection)(self.wrapped.ConnectionDesign) if self.wrapped.ConnectionDesign else None

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5713.RollingRingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5713.RollingRingConnectionHarmonicAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5713.RollingRingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5713.RollingRingConnectionHarmonicAnalysis))
        return value
