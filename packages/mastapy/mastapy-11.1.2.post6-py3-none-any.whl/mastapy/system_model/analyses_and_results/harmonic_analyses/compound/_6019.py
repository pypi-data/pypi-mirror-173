...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5999
...
class CycloidalDiscCentralBearingConnectionCompoundHarmonicAnalysis(_5999.CoaxialConnectionCompoundHarmonicAnalysis):
    '''CycloidalDiscCentralBearingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5828.CycloidalDiscCentralBearingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5828.CycloidalDiscCentralBearingConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5828.CycloidalDiscCentralBearingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5828.CycloidalDiscCentralBearingConnectionHarmonicAnalysis))
        return value
