...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5634, _5635, _5665
...
class ConceptGearSetCompoundHarmonicAnalysis(_5665.GearSetCompoundHarmonicAnalysis):
    """ConceptGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5445.ConceptGearSetHarmonicAnalysis]':
    ...
    @property
    def concept_gears_compound_harmonic_analysis(self) -> 'List[_5634.ConceptGearCompoundHarmonicAnalysis]':
    ...
    @property
    def concept_meshes_compound_harmonic_analysis(self) -> 'List[_5635.ConceptGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5445.ConceptGearSetHarmonicAnalysis]':
