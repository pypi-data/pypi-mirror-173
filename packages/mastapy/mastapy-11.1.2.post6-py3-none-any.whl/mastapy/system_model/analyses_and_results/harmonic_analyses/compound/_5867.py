...
class PlanetaryConnectionCompoundHarmonicAnalysis(_5881.ShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    '''PlanetaryConnectionCompoundHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_1969.PlanetaryConnection':
        ...
        return constructor.new(_1969.PlanetaryConnection)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5704.PlanetaryConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5704.PlanetaryConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5704.PlanetaryConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5704.PlanetaryConnectionHarmonicAnalysis))
        return value
