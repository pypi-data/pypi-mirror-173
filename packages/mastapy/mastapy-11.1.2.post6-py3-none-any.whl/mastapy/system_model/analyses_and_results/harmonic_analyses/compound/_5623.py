...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5611
...
class BevelGearSetCompoundHarmonicAnalysis(_5611.AGMAGleasonConicalGearSetCompoundHarmonicAnalysis):
    """BevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5431.BevelGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5431.BevelGearSetHarmonicAnalysis]':
