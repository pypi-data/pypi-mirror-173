...
class BearingCompoundHarmonicAnalysis(_6011.ConnectorCompoundHarmonicAnalysis):
    '''BearingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5791.BearingHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5791.BearingHarmonicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5791.BearingHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5791.BearingHarmonicAnalysis))
        return value
