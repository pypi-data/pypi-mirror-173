...
class KlingelnbergCycloPalloidConicalGearMeshCompoundHarmonicAnalysis(_5817.ConicalGearMeshCompoundHarmonicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5687.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5687.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5687.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5687.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis))
        return value
