...
from mastapy.system_model.part_model.couplings import _2267, _2264
...
class PulleyCompoundHarmonicAnalysis(_5823.CouplingHalfCompoundHarmonicAnalysis):
    '''PulleyCompoundHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2267.Pulley':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5709.PulleyHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5709.PulleyHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5709.PulleyHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5709.PulleyHarmonicAnalysis))
        return value
