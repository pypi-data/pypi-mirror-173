...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5731, _5732, _5623
...
class ZerolBevelGearSetCompoundHarmonicAnalysis(_5623.BevelGearSetCompoundHarmonicAnalysis):
    """ZerolBevelGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5569.ZerolBevelGearSetHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_harmonic_analysis(self) -> 'List[_5731.ZerolBevelGearCompoundHarmonicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_harmonic_analysis(self) -> 'List[_5732.ZerolBevelGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5569.ZerolBevelGearSetHarmonicAnalysis]':
