...
class KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis(_5816.ConicalGearCompoundHarmonicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5686.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5686.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5686.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5686.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis))
        return value
