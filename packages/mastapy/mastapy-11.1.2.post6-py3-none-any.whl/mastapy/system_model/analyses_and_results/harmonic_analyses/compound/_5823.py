...
class CouplingHalfCompoundHarmonicAnalysis(_5861.MountableComponentCompoundHarmonicAnalysis):
    '''CouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5635.CouplingHalfHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5635.CouplingHalfHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5635.CouplingHalfHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5635.CouplingHalfHarmonicAnalysis))
        return value
