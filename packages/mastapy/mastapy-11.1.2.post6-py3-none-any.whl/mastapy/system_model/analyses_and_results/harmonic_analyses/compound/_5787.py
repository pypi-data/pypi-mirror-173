...
class AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis(_5819.ConnectionCompoundHarmonicAnalysis):
    '''AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5599.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5599.AbstractShaftToMountableComponentConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5599.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5599.AbstractShaftToMountableComponentConnectionHarmonicAnalysis))
        return value
