...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5502
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5640
...
class InterMountableComponentConnectionCompoundHarmonicAnalysis(_5640.ConnectionCompoundHarmonicAnalysis):
    """InterMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5502.InterMountableComponentConnectionHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5502.InterMountableComponentConnectionHarmonicAnalysis]':
