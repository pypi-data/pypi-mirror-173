...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5506
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5671
...
class KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis(_5671.KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5506.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5506.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
