...
class MountableComponentCompoundHarmonicAnalysis(_6000.ComponentCompoundHarmonicAnalysis):
    '''MountableComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5884.MountableComponentHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5884.MountableComponentHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5884.MountableComponentHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5884.MountableComponentHarmonicAnalysis))
        return value
