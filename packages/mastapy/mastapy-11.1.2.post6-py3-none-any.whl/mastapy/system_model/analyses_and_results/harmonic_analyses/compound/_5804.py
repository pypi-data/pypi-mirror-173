...
class BoltedJointCompoundHarmonicAnalysis(_5882.SpecialisedAssemblyCompoundHarmonicAnalysis):
    '''BoltedJointCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5615.BoltedJointHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5615.BoltedJointHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5615.BoltedJointHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5615.BoltedJointHarmonicAnalysis))
        return value
