...
class StraightBevelDiffGearCompoundHarmonicAnalysis(_5800.BevelGearCompoundHarmonicAnalysis):
    '''StraightBevelDiffGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5728.StraightBevelDiffGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5728.StraightBevelDiffGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5728.StraightBevelDiffGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5728.StraightBevelDiffGearHarmonicAnalysis))
        return value
