...
class StraightBevelSunGearCompoundHarmonicAnalysis(_5889.StraightBevelDiffGearCompoundHarmonicAnalysis):
    '''StraightBevelSunGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5735.StraightBevelSunGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5735.StraightBevelSunGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5735.StraightBevelSunGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5735.StraightBevelSunGearHarmonicAnalysis))
        return value
