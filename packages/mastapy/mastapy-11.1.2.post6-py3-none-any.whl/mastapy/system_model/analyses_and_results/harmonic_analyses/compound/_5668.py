...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5500
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5610
...
class HypoidGearMeshCompoundHarmonicAnalysis(_5610.AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis):
    """HypoidGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5500.HypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5500.HypoidGearMeshHarmonicAnalysis]':
