...
class AbstractShaftCompoundHarmonicAnalysis(_5977.AbstractShaftOrHousingCompoundHarmonicAnalysis):
    '''AbstractShaftCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5784.AbstractShaftHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5784.AbstractShaftHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5784.AbstractShaftHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5784.AbstractShaftHarmonicAnalysis))
        return value
