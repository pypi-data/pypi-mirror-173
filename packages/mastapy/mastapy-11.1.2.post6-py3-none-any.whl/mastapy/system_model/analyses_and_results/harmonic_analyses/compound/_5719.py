...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5553
...
class SynchroniserHalfCompoundHarmonicAnalysis(_5720.SynchroniserPartCompoundHarmonicAnalysis):
    """SynchroniserHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5553.SynchroniserHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5553.SynchroniserHalfHarmonicAnalysis]':
