...
class SynchroniserHalfCompoundHarmonicAnalysis(_5899.SynchroniserPartCompoundHarmonicAnalysis):
    '''SynchroniserHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5736.SynchroniserHalfHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5736.SynchroniserHalfHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5736.SynchroniserHalfHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5736.SynchroniserHalfHarmonicAnalysis))
        return value
