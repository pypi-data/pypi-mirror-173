...
class FEPartCompoundHarmonicAnalysis(_5786.AbstractShaftOrHousingCompoundHarmonicAnalysis):
    '''FEPartCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5665.FEPartHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5665.FEPartHarmonicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5665.FEPartHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5665.FEPartHarmonicAnalysis))
        return value
