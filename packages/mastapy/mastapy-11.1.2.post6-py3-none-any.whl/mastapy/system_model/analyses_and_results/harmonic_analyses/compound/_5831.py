...
class CylindricalGearCompoundHarmonicAnalysis(_5842.GearCompoundHarmonicAnalysis):
    '''CylindricalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5644.CylindricalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5644.CylindricalGearHarmonicAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5644.CylindricalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5644.CylindricalGearHarmonicAnalysis))
        return value
