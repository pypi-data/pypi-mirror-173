...
class BeltDriveCompoundHarmonicAnalysis(_5882.SpecialisedAssemblyCompoundHarmonicAnalysis):
    '''BeltDriveCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5606.BeltDriveHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5606.BeltDriveHarmonicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5606.BeltDriveHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5606.BeltDriveHarmonicAnalysis))
        return value
