...
class AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis(_6008.ConicalGearMeshCompoundHarmonicAnalysis):
    '''AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5788.AGMAGleasonConicalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5788.AGMAGleasonConicalGearMeshHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5788.AGMAGleasonConicalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5788.AGMAGleasonConicalGearMeshHarmonicAnalysis))
        return value
