...
class RingPinsToDiscConnectionCompoundHarmonicAnalysis(_5849.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    '''RingPinsToDiscConnectionCompoundHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2023.RingPinsToDiscConnection':
        ...
        return constructor.new(_2023.RingPinsToDiscConnection)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5711.RingPinsToDiscConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5711.RingPinsToDiscConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5711.RingPinsToDiscConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5711.RingPinsToDiscConnectionHarmonicAnalysis))
        return value
