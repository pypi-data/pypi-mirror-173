...
class AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis(_6010.ConnectionCompoundHarmonicAnalysis):
    '''AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5786.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5786.AbstractShaftToMountableComponentConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5786.AbstractShaftToMountableComponentConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5786.AbstractShaftToMountableComponentConnectionHarmonicAnalysis))
        return value
