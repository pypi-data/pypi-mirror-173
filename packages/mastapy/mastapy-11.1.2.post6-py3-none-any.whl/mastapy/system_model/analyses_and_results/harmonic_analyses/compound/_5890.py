...
class StraightBevelDiffGearMeshCompoundHarmonicAnalysis(_5801.BevelGearMeshCompoundHarmonicAnalysis):
    '''StraightBevelDiffGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5729.StraightBevelDiffGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5729.StraightBevelDiffGearMeshHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5729.StraightBevelDiffGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5729.StraightBevelDiffGearMeshHarmonicAnalysis))
        return value
