...
class WormGearCompoundHarmonicAnalysis(_5663.GearCompoundHarmonicAnalysis):
    """WormGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5564.WormGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5564.WormGearHarmonicAnalysis]':
