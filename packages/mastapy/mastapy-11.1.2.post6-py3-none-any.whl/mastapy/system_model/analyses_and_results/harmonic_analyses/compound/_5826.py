...
class CVTPulleyCompoundHarmonicAnalysis(_5872.PulleyCompoundHarmonicAnalysis):
    '''CVTPulleyCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5639.CVTPulleyHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5639.CVTPulleyHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5639.CVTPulleyHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5639.CVTPulleyHarmonicAnalysis))
        return value
