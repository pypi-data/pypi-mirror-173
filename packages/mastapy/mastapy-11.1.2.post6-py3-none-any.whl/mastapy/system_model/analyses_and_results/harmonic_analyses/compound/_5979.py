...
class AGMAGleasonConicalGearCompoundHarmonicAnalysis(_6007.ConicalGearCompoundHarmonicAnalysis):
    '''AGMAGleasonConicalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5787.AGMAGleasonConicalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5787.AGMAGleasonConicalGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5787.AGMAGleasonConicalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5787.AGMAGleasonConicalGearHarmonicAnalysis))
        return value
