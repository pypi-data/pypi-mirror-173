...
class BevelDifferentialSunGearCompoundHarmonicAnalysis(_5795.BevelDifferentialGearCompoundHarmonicAnalysis):
    '''BevelDifferentialSunGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5611.BevelDifferentialSunGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5611.BevelDifferentialSunGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5611.BevelDifferentialSunGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5611.BevelDifferentialSunGearHarmonicAnalysis))
        return value
