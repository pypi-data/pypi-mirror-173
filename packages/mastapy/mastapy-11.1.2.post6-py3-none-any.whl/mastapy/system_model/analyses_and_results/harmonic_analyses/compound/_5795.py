...
class BevelDifferentialGearCompoundHarmonicAnalysis(_5800.BevelGearCompoundHarmonicAnalysis):
    '''BevelDifferentialGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5607.BevelDifferentialGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5607.BevelDifferentialGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5607.BevelDifferentialGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5607.BevelDifferentialGearHarmonicAnalysis))
        return value
