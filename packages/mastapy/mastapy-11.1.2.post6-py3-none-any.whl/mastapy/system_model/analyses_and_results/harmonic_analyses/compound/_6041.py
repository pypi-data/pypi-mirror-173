...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _6007
...
class KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis(_6007.ConicalGearCompoundHarmonicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5873.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5873.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5873.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5873.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis))
        return value
