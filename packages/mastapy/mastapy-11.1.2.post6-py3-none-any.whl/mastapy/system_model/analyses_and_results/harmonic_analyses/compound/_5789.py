...
class AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis(_5817.ConicalGearMeshCompoundHarmonicAnalysis):
    '''AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5601.AGMAGleasonConicalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5601.AGMAGleasonConicalGearMeshHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5601.AGMAGleasonConicalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5601.AGMAGleasonConicalGearMeshHarmonicAnalysis))
        return value
