...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5808
...
class CycloidalDiscCentralBearingConnectionCompoundHarmonicAnalysis(_5808.CoaxialConnectionCompoundHarmonicAnalysis):
    '''CycloidalDiscCentralBearingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5641.CycloidalDiscCentralBearingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5641.CycloidalDiscCentralBearingConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5641.CycloidalDiscCentralBearingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5641.CycloidalDiscCentralBearingConnectionHarmonicAnalysis))
        return value
