...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5888
...
class PartToPartShearCouplingHalfCompoundHarmonicAnalysis(_6014.CouplingHalfCompoundHarmonicAnalysis):
    '''PartToPartShearCouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5888.PartToPartShearCouplingHalfHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5888.PartToPartShearCouplingHalfHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5888.PartToPartShearCouplingHalfHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5888.PartToPartShearCouplingHalfHarmonicAnalysis))
        return value
