...
class SpiralBevelGearMeshHarmonicAnalysis(_5613.BevelGearMeshHarmonicAnalysis):
    '''SpiralBevelGearMeshHarmonicAnalysis
    ...
    @property
    def connection_load_case(self) -> '_6599.SpiralBevelGearMeshLoadCase':
        ...
        return constructor.new(_6599.SpiralBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2475.SpiralBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2475.SpiralBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
