...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _2381, _2382
...
class ConnectionHarmonicAnalysis(_7267.ConnectionStaticLoadAnalysisCase):
    """ConnectionHarmonicAnalysis
    ...
    @property
    def harmonic_analyses_of_single_excitations(self) -> 'List[_5796.HarmonicAnalysisOfSingleExcitation]':
