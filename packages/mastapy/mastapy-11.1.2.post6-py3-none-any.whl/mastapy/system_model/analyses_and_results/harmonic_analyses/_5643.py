...
class CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis(_5599.AbstractShaftToMountableComponentConnectionHarmonicAnalysis):
    '''CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2407.CycloidalDiscPlanetaryBearingConnectionSystemDeflection':
        ...
        return constructor.new(_2407.CycloidalDiscPlanetaryBearingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
