...
class StraightBevelGearMeshHarmonicAnalysis(_5613.BevelGearMeshHarmonicAnalysis):
    '''StraightBevelGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2484.StraightBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2484.StraightBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
