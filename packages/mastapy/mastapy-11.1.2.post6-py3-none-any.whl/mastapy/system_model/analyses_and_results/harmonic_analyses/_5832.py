...
class CylindricalGearMeshHarmonicAnalysis(_5857.GearMeshHarmonicAnalysis):
    '''CylindricalGearMeshHarmonicAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_7153.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_7153.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults is not None else None
