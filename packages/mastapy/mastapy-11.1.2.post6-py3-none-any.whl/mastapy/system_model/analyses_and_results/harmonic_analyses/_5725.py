...
class SpringDamperConnectionHarmonicAnalysis(_5634.CouplingConnectionHarmonicAnalysis):
    '''SpringDamperConnectionHarmonicAnalysis
    ...
    @property
    def connection_load_case(self) -> '_6601.SpringDamperConnectionLoadCase':
        ...
        return constructor.new(_6601.SpringDamperConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2478.SpringDamperConnectionSystemDeflection':
        ...
        return constructor.new(_2478.SpringDamperConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
