...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5443, _5444, _5490
...
class ConceptGearSetHarmonicAnalysis(_5490.GearSetHarmonicAnalysis):
    """ConceptGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5443.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def concept_gears_harmonic_analysis(self) -> 'List[_5443.ConceptGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5444.ConceptGearMeshHarmonicAnalysis]':
    ...
    @property
    def concept_meshes_harmonic_analysis(self) -> 'List[_5444.ConceptGearMeshHarmonicAnalysis]':
