...
class HypoidGearMeshHarmonicAnalysis(_5601.AGMAGleasonConicalGearMeshHarmonicAnalysis):
    '''HypoidGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2431.HypoidGearMeshSystemDeflection':
        ...
        return constructor.new(_2431.HypoidGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
