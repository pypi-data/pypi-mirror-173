...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5466
...
class ElectricMachineTorqueRipplePeriodicExcitationDetail(_5466.ElectricMachinePeriodicExcitationDetail):
    """ElectricMachineTorqueRipplePeriodicExcitationDetail
