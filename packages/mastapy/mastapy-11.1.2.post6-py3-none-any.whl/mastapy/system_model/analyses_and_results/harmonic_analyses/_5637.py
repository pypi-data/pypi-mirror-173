...
class CVTBeltConnectionHarmonicAnalysis(_5605.BeltConnectionHarmonicAnalysis):
    '''CVTBeltConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2402.CVTBeltConnectionSystemDeflection':
        ...
        return constructor.new(_2402.CVTBeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
