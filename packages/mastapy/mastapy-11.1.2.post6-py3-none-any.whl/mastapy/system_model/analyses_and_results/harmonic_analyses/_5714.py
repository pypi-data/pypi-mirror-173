...
class RollingRingHarmonicAnalysis(_5635.CouplingHalfHarmonicAnalysis):
    '''RollingRingHarmonicAnalysis
    ...
    @property
    def component_load_case(self) -> '_6591.RollingRingLoadCase':
        ...
        return constructor.new(_6591.RollingRingLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2467.RollingRingSystemDeflection':
        ...
        return constructor.new(_2467.RollingRingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
