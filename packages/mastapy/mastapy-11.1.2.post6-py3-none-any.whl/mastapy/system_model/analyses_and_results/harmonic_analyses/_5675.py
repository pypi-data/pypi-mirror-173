...
class GuideDxfModelHarmonicAnalysis(_5622.ComponentHarmonicAnalysis):
    '''GuideDxfModelHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2430.GuideDxfModelSystemDeflection':
        ...
        return constructor.new(_2430.GuideDxfModelSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
