...
class AbstractShaftToMountableComponentConnectionHarmonicAnalysis(_5449.ConnectionHarmonicAnalysis):
    """AbstractShaftToMountableComponentConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2437.AbstractShaftToMountableComponentConnectionSystemDeflection':
