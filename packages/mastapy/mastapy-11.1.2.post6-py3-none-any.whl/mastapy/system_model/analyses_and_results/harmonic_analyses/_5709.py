...
from mastapy.system_model.analyses_and_results.static_loads import _6584, _6497
from mastapy.system_model.analyses_and_results.system_deflections import _2461, _2403
...
class PulleyHarmonicAnalysis(_5635.CouplingHalfHarmonicAnalysis):
    '''PulleyHarmonicAnalysis
    ...
    @property
    def component_load_case(self) -> '_6584.PulleyLoadCase':
        ...
        if _6584.PulleyLoadCase.TYPE not in self.wrapped.ComponentLoadCase.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2461.PulleySystemDeflection':
