...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5890
...
class SingleNodePeriodicExcitationWithReferenceShaft(_5890.PeriodicExcitationWithReferenceShaft):
    '''SingleNodePeriodicExcitationWithReferenceShaft
