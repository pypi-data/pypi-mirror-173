...
class KlingelnbergCycloPalloidSpiralBevelGearMeshHarmonicAnalysis(_5687.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2442.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2442.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
