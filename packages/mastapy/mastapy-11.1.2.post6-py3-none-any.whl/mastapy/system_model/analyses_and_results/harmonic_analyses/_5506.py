...
class KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis(_5503.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2517.KlingelnbergCycloPalloidHypoidGearSystemDeflection':
