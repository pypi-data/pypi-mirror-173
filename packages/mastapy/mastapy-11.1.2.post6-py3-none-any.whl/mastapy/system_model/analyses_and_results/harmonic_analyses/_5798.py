...
from mastapy.system_model.part_model.gears import _2378
...
class BevelDifferentialSunGearHarmonicAnalysis(_5794.BevelDifferentialGearHarmonicAnalysis):
    '''BevelDifferentialSunGearHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2378.BevelDifferentialSunGear':
        ...
        return constructor.new(_2378.BevelDifferentialSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign is not None else None

    @property
    def system_deflection_results(self) -> '_2560.BevelDifferentialSunGearSystemDeflection':
        ...
        return constructor.new(_2560.BevelDifferentialSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
