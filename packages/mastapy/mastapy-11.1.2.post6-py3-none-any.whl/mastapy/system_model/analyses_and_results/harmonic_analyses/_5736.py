...
class SynchroniserHalfHarmonicAnalysis(_5738.SynchroniserPartHarmonicAnalysis):
    '''SynchroniserHalfHarmonicAnalysis
    ...
    @property
    def component_load_case(self) -> '_6613.SynchroniserHalfLoadCase':
        ...
        return constructor.new(_6613.SynchroniserHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2489.SynchroniserHalfSystemDeflection':
        ...
        return constructor.new(_2489.SynchroniserHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
