...
class BoltHarmonicAnalysis(_5809.ComponentHarmonicAnalysis):
    '''BoltHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2565.BoltSystemDeflection':
        ...
        return constructor.new(_2565.BoltSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
