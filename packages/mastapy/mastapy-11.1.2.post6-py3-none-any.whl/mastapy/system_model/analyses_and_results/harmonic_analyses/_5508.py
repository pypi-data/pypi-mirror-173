...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5506, _5507, _5505
...
class KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis(_5505.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2516.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection':
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5506.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_harmonic_analysis(self) -> 'List[_5506.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5507.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_harmonic_analysis(self) -> 'List[_5507.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
