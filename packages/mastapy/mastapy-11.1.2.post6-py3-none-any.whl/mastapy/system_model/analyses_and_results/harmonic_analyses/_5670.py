...
class GearMeshHarmonicAnalysis(_5685.InterMountableComponentConnectionHarmonicAnalysis):
    '''GearMeshHarmonicAnalysis
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_3818.ToothPassingHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothPassingHarmonics, constructor.new(_3818.ToothPassingHarmonic))
        return value
