...
class CVTPulleyHarmonicAnalysis(_5709.PulleyHarmonicAnalysis):
    '''CVTPulleyHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2264.CVTPulley':
        ...
        return constructor.new(_2264.CVTPulley)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2403.CVTPulleySystemDeflection':
        ...
        return constructor.new(_2403.CVTPulleySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
