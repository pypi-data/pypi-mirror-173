...
class CylindricalGearMeshHarmonicAnalysis(_5670.GearMeshHarmonicAnalysis):
    '''CylindricalGearMeshHarmonicAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_6967.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_6967.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults else None
    ...
    @property
    def system_deflection_results(self) -> '_2409.CylindricalGearMeshSystemDeflection':
