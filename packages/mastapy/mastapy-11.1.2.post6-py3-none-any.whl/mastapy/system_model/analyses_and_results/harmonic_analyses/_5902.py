...
class RootAssemblyHarmonicAnalysis(_5790.AssemblyHarmonicAnalysis):
    '''RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self) -> '_5867.HarmonicAnalysisRootAssemblyExportOptions':
        ...
        return constructor.new(_5867.HarmonicAnalysisRootAssemblyExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None
    ...
    @property
    def harmonic_analysis_inputs(self) -> '_2492.HarmonicAnalysis':
        ...
        if _2492.HarmonicAnalysis.TYPE not in self.wrapped.HarmonicAnalysisInputs.__class__.__mro__:
