...
class RingPinsToDiscConnectionHarmonicAnalysis(_5685.InterMountableComponentConnectionHarmonicAnalysis):
    '''RingPinsToDiscConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2463.RingPinsToDiscConnectionSystemDeflection':
        ...
        return constructor.new(_2463.RingPinsToDiscConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
