...
class MeasurementComponentHarmonicAnalysis(_5746.VirtualComponentHarmonicAnalysis):
    '''MeasurementComponentHarmonicAnalysis
    ...
    @property
    def component_load_case(self) -> '_6566.MeasurementComponentLoadCase':
        ...
        return constructor.new(_6566.MeasurementComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2448.MeasurementComponentSystemDeflection':
        ...
        return constructor.new(_2448.MeasurementComponentSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
