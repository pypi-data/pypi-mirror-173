...
class KlingelnbergCycloPalloidSpiralBevelGearMeshHarmonicAnalysis(_5504.KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2518.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection':
