...
from mastapy.system_model.analyses_and_results import _2514
...
class HarmonicAnalysisFEExportOptions(_5864.HarmonicAnalysisExportOptions['_2514.IHaveFEPartHarmonicAnalysisResults', '_2314.FEPart']):
    '''HarmonicAnalysisFEExportOptions
    ...
    @property
    def analysis_options(self) -> '_5866.HarmonicAnalysisOptions':
        ...
        if _5866.HarmonicAnalysisOptions.TYPE not in self.wrapped.AnalysisOptions.__class__.__mro__:
    ...
    @property
    def eigenvalue_options(self) -> '_157.EigenvalueOptions':
        ...
        return constructor.new(_157.EigenvalueOptions)(self.wrapped.EigenvalueOptions) if self.wrapped.EigenvalueOptions is not None else None
