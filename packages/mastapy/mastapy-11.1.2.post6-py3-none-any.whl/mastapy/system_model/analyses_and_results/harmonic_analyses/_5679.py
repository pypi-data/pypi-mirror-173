...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5756
from mastapy.system_model.analyses_and_results.modal_analyses import _4834
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5721, _5667
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5756.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5756.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None

    @property
    def modal_analysis_options(self) -> '_4834.ModalAnalysisOptions':
        ...
        return constructor.new(_4834.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
