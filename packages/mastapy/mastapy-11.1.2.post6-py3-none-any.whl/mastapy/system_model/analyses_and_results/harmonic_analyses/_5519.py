...
class PartToPartShearCouplingHarmonicAnalysis(_5453.CouplingHarmonicAnalysis):
    """PartToPartShearCouplingHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2532.PartToPartShearCouplingSystemDeflection':
