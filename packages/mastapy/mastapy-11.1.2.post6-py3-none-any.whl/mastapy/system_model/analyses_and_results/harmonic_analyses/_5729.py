...
class StraightBevelDiffGearMeshHarmonicAnalysis(_5613.BevelGearMeshHarmonicAnalysis):
    '''StraightBevelDiffGearMeshHarmonicAnalysis
    ...
    @property
    def connection_load_case(self) -> '_6606.StraightBevelDiffGearMeshLoadCase':
        ...
        return constructor.new(_6606.StraightBevelDiffGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2481.StraightBevelDiffGearMeshSystemDeflection':
        ...
        return constructor.new(_2481.StraightBevelDiffGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
