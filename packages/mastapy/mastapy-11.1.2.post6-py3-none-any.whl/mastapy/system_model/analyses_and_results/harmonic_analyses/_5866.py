...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5943
from mastapy.system_model.analyses_and_results.modal_analyses import _5021
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5908, _5854
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5943.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5943.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection is not None else None

    @property
    def modal_analysis_options(self) -> '_5021.ModalAnalysisOptions':
        ...
        return constructor.new(_5021.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions is not None else None

    @property
    def reference_speed_options(self) -> '_5908.SpeedOptionsForHarmonicAnalysisResults':
        ...
        return constructor.new(_5908.SpeedOptionsForHarmonicAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions is not None else None

    @property
    def frequency_options(self) -> '_5854.FrequencyOptionsForHarmonicAnalysisResults':
        ...
        return constructor.new(_5854.FrequencyOptionsForHarmonicAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions is not None else None
