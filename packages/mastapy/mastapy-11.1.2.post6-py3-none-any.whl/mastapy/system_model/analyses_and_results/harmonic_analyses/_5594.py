...
from mastapy.system_model.part_model import (
    _2114, _2113, _2122, _2132,
    _2152, _2154
)
from mastapy._internal import constructor
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.part_model.gears import (
    _2190, _2192, _2196, _2198,
    _2200, _2202, _2205, _2208,
    _2211, _2213, _2215, _2217,
    _2218, _2220, _2222, _2224,
    _2228, _2230
)
from mastapy.system_model.part_model.cycloidal import _2244
from mastapy.system_model.part_model.couplings import (
    _2252, _2254, _2257, _2259,
    _2262, _2264, _2273, _2276,
    _2278, _2283
)
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2359, _2364, _2366, _2369,
    _2371, _2376, _2378, _2382,
    _2388, _2390, _2394, _2400,
    _2403, _2404, _2411, _2412,
    _2413, _2422, _2425, _2427,
    _2431, _2436, _2439, _2442,
    _2455, _2464, _2467, _2473,
    _2475, _2479, _2481, _2484,
    _2491, _2497, _2504, _2507
)
...
class AbstractAssemblyHarmonicAnalysis(_5698.PartHarmonicAnalysis):
    '''AbstractAssemblyHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2114.AbstractAssembly':
        ...
        if _2114.AbstractAssembly.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_assembly(self) -> '_2113.Assembly':
    ...
    @property
    def component_design_of_type_bolted_joint(self) -> '_2122.BoltedJoint':
        ...
        if _2122.BoltedJoint.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_flexible_pin_assembly(self) -> '_2132.FlexiblePinAssembly':
        ...
        if _2132.FlexiblePinAssembly.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_root_assembly(self) -> '_2152.RootAssembly':
        ...
        if _2152.RootAssembly.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_specialised_assembly(self) -> '_2154.SpecialisedAssembly':
        ...
        if _2154.SpecialisedAssembly.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_agma_gleason_conical_gear_set(self) -> '_2190.AGMAGleasonConicalGearSet':
        ...
        if _2190.AGMAGleasonConicalGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_bevel_differential_gear_set(self) -> '_2192.BevelDifferentialGearSet':
        ...
        if _2192.BevelDifferentialGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_bevel_gear_set(self) -> '_2196.BevelGearSet':
        ...
        if _2196.BevelGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_concept_gear_set(self) -> '_2198.ConceptGearSet':
        ...
        if _2198.ConceptGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_conical_gear_set(self) -> '_2200.ConicalGearSet':
        ...
        if _2200.ConicalGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_cylindrical_gear_set(self) -> '_2202.CylindricalGearSet':
    ...
    @property
    def component_design_of_type_face_gear_set(self) -> '_2205.FaceGearSet':
        ...
        if _2205.FaceGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_gear_set(self) -> '_2208.GearSet':
        ...
        if _2208.GearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_hypoid_gear_set(self) -> '_2211.HypoidGearSet':
        ...
        if _2211.HypoidGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_klingelnberg_cyclo_palloid_conical_gear_set(self) -> '_2213.KlingelnbergCycloPalloidConicalGearSet':
        ...
        if _2213.KlingelnbergCycloPalloidConicalGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(self) -> '_2215.KlingelnbergCycloPalloidHypoidGearSet':
        ...
        if _2215.KlingelnbergCycloPalloidHypoidGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self) -> '_2217.KlingelnbergCycloPalloidSpiralBevelGearSet':
        ...
        if _2217.KlingelnbergCycloPalloidSpiralBevelGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_planetary_gear_set(self) -> '_2218.PlanetaryGearSet':
        ...
        if _2218.PlanetaryGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_spiral_bevel_gear_set(self) -> '_2220.SpiralBevelGearSet':
        ...
        if _2220.SpiralBevelGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_straight_bevel_diff_gear_set(self) -> '_2222.StraightBevelDiffGearSet':
        ...
        if _2222.StraightBevelDiffGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_straight_bevel_gear_set(self) -> '_2224.StraightBevelGearSet':
        ...
        if _2224.StraightBevelGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_worm_gear_set(self) -> '_2228.WormGearSet':
        ...
        if _2228.WormGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_zerol_bevel_gear_set(self) -> '_2230.ZerolBevelGearSet':
        ...
        if _2230.ZerolBevelGearSet.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_cycloidal_assembly(self) -> '_2244.CycloidalAssembly':
        ...
        if _2244.CycloidalAssembly.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_belt_drive(self) -> '_2252.BeltDrive':
        ...
        if _2252.BeltDrive.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
            raise CastException('Failed to cast component_design to BeltDrive. Expected: {}.'.format(self.wrapped.ComponentDesign.__class__.__qualname__))

        return constructor.new_override(self.wrapped.ComponentDesign.__class__)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def component_design_of_type_clutch(self) -> '_2254.Clutch':
        ...
        if _2254.Clutch.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_concept_coupling(self) -> '_2257.ConceptCoupling':
        ...
        if _2257.ConceptCoupling.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_coupling(self) -> '_2259.Coupling':
        ...
        if _2259.Coupling.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_cvt(self) -> '_2262.CVT':
        ...
        if _2262.CVT.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_part_to_part_shear_coupling(self) -> '_2264.PartToPartShearCoupling':
        ...
        if _2264.PartToPartShearCoupling.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_rolling_ring_assembly(self) -> '_2273.RollingRingAssembly':
        ...
        if _2273.RollingRingAssembly.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_spring_damper(self) -> '_2276.SpringDamper':
        ...
        if _2276.SpringDamper.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_synchroniser(self) -> '_2278.Synchroniser':
        ...
        if _2278.Synchroniser.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_torque_converter(self) -> '_2283.TorqueConverter':
        ...
        if _2283.TorqueConverter.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def assembly_design(self) -> '_2114.AbstractAssembly':
        ...
        if _2114.AbstractAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_assembly(self) -> '_2113.Assembly':
    ...
    @property
    def assembly_design_of_type_bolted_joint(self) -> '_2122.BoltedJoint':
        ...
        if _2122.BoltedJoint.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_flexible_pin_assembly(self) -> '_2132.FlexiblePinAssembly':
        ...
        if _2132.FlexiblePinAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_root_assembly(self) -> '_2152.RootAssembly':
        ...
        if _2152.RootAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_specialised_assembly(self) -> '_2154.SpecialisedAssembly':
        ...
        if _2154.SpecialisedAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_agma_gleason_conical_gear_set(self) -> '_2190.AGMAGleasonConicalGearSet':
    ...
    @property
    def assembly_design_of_type_concept_gear_set(self) -> '_2198.ConceptGearSet':
        ...
        if _2198.ConceptGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_conical_gear_set(self) -> '_2200.ConicalGearSet':
        ...
        if _2200.ConicalGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_cylindrical_gear_set(self) -> '_2202.CylindricalGearSet':
    ...
    @property
    def assembly_design_of_type_face_gear_set(self) -> '_2205.FaceGearSet':
        ...
        if _2205.FaceGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_gear_set(self) -> '_2208.GearSet':
        ...
        if _2208.GearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_klingelnberg_cyclo_palloid_conical_gear_set(self) -> '_2213.KlingelnbergCycloPalloidConicalGearSet':
        ...
        if _2213.KlingelnbergCycloPalloidConicalGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(self) -> '_2215.KlingelnbergCycloPalloidHypoidGearSet':
        ...
        if _2215.KlingelnbergCycloPalloidHypoidGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
            raise CastException('Failed to cast assembly_design to KlingelnbergCycloPalloidHypoidGearSet. Expected: {}.'.format(self.wrapped.AssemblyDesign.__class__.__qualname__))

        return constructor.new_override(self.wrapped.AssemblyDesign.__class__)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def assembly_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self) -> '_2217.KlingelnbergCycloPalloidSpiralBevelGearSet':
        ...
        if _2217.KlingelnbergCycloPalloidSpiralBevelGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
            raise CastException('Failed to cast assembly_design to KlingelnbergCycloPalloidSpiralBevelGearSet. Expected: {}.'.format(self.wrapped.AssemblyDesign.__class__.__qualname__))

        return constructor.new_override(self.wrapped.AssemblyDesign.__class__)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def assembly_design_of_type_planetary_gear_set(self) -> '_2218.PlanetaryGearSet':
        ...
        if _2218.PlanetaryGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_worm_gear_set(self) -> '_2228.WormGearSet':
        ...
        if _2228.WormGearSet.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_cycloidal_assembly(self) -> '_2244.CycloidalAssembly':
        ...
        if _2244.CycloidalAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_belt_drive(self) -> '_2252.BeltDrive':
        ...
        if _2252.BeltDrive.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_coupling(self) -> '_2259.Coupling':
    ...
    @property
    def assembly_design_of_type_cvt(self) -> '_2262.CVT':
        ...
        if _2262.CVT.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_rolling_ring_assembly(self) -> '_2273.RollingRingAssembly':
        ...
        if _2273.RollingRingAssembly.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def assembly_design_of_type_synchroniser(self) -> '_2278.Synchroniser':
        ...
        if _2278.Synchroniser.TYPE not in self.wrapped.AssemblyDesign.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2359.AbstractAssemblySystemDeflection':
        ...
        if _2359.AbstractAssemblySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_agma_gleason_conical_gear_set_system_deflection(self) -> '_2364.AGMAGleasonConicalGearSetSystemDeflection':
        ...
        if _2364.AGMAGleasonConicalGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_assembly_system_deflection(self) -> '_2366.AssemblySystemDeflection':
    ...
    @property
    def system_deflection_results_of_type_belt_drive_system_deflection(self) -> '_2369.BeltDriveSystemDeflection':
        ...
        if _2369.BeltDriveSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_bevel_differential_gear_set_system_deflection(self) -> '_2371.BevelDifferentialGearSetSystemDeflection':
        ...
        if _2371.BevelDifferentialGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_bevel_gear_set_system_deflection(self) -> '_2376.BevelGearSetSystemDeflection':
        ...
        if _2376.BevelGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_bolted_joint_system_deflection(self) -> '_2378.BoltedJointSystemDeflection':
        ...
        if _2378.BoltedJointSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_clutch_system_deflection(self) -> '_2382.ClutchSystemDeflection':
        ...
        if _2382.ClutchSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_concept_coupling_system_deflection(self) -> '_2388.ConceptCouplingSystemDeflection':
        ...
        if _2388.ConceptCouplingSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_concept_gear_set_system_deflection(self) -> '_2390.ConceptGearSetSystemDeflection':
        ...
        if _2390.ConceptGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_conical_gear_set_system_deflection(self) -> '_2394.ConicalGearSetSystemDeflection':
        ...
        if _2394.ConicalGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_coupling_system_deflection(self) -> '_2400.CouplingSystemDeflection':
        ...
        if _2400.CouplingSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cvt_system_deflection(self) -> '_2403.CVTSystemDeflection':
        ...
        if _2403.CVTSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cycloidal_assembly_system_deflection(self) -> '_2404.CycloidalAssemblySystemDeflection':
        ...
        if _2404.CycloidalAssemblySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cylindrical_gear_set_system_deflection(self) -> '_2411.CylindricalGearSetSystemDeflection':
        ...
        if _2411.CylindricalGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cylindrical_gear_set_system_deflection_timestep(self) -> '_2412.CylindricalGearSetSystemDeflectionTimestep':
        ...
        if _2412.CylindricalGearSetSystemDeflectionTimestep.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cylindrical_gear_set_system_deflection_with_ltca_results(self) -> '_2413.CylindricalGearSetSystemDeflectionWithLTCAResults':
        ...
        if _2413.CylindricalGearSetSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_face_gear_set_system_deflection(self) -> '_2422.FaceGearSetSystemDeflection':
        ...
        if _2422.FaceGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_flexible_pin_assembly_system_deflection(self) -> '_2425.FlexiblePinAssemblySystemDeflection':
        ...
        if _2425.FlexiblePinAssemblySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_gear_set_system_deflection(self) -> '_2427.GearSetSystemDeflection':
        ...
        if _2427.GearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_hypoid_gear_set_system_deflection(self) -> '_2431.HypoidGearSetSystemDeflection':
        ...
        if _2431.HypoidGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_klingelnberg_cyclo_palloid_conical_gear_set_system_deflection(self) -> '_2436.KlingelnbergCycloPalloidConicalGearSetSystemDeflection':
        ...
        if _2436.KlingelnbergCycloPalloidConicalGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_system_deflection(self) -> '_2439.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection':
        ...
        if _2439.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_system_deflection(self) -> '_2442.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection':
        ...
        if _2442.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_part_to_part_shear_coupling_system_deflection(self) -> '_2455.PartToPartShearCouplingSystemDeflection':
        ...
        if _2455.PartToPartShearCouplingSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_rolling_ring_assembly_system_deflection(self) -> '_2464.RollingRingAssemblySystemDeflection':
        ...
        if _2464.RollingRingAssemblySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_root_assembly_system_deflection(self) -> '_2467.RootAssemblySystemDeflection':
        ...
        if _2467.RootAssemblySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_specialised_assembly_system_deflection(self) -> '_2473.SpecialisedAssemblySystemDeflection':
        ...
        if _2473.SpecialisedAssemblySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_spiral_bevel_gear_set_system_deflection(self) -> '_2475.SpiralBevelGearSetSystemDeflection':
        ...
        if _2475.SpiralBevelGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_spring_damper_system_deflection(self) -> '_2479.SpringDamperSystemDeflection':
        ...
        if _2479.SpringDamperSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_straight_bevel_diff_gear_set_system_deflection(self) -> '_2481.StraightBevelDiffGearSetSystemDeflection':
        ...
        if _2481.StraightBevelDiffGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_straight_bevel_gear_set_system_deflection(self) -> '_2484.StraightBevelGearSetSystemDeflection':
        ...
        if _2484.StraightBevelGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_synchroniser_system_deflection(self) -> '_2491.SynchroniserSystemDeflection':
        ...
        if _2491.SynchroniserSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_torque_converter_system_deflection(self) -> '_2497.TorqueConverterSystemDeflection':
        ...
        if _2497.TorqueConverterSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_worm_gear_set_system_deflection(self) -> '_2504.WormGearSetSystemDeflection':
        ...
        if _2504.WormGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_zerol_bevel_gear_set_system_deflection(self) -> '_2507.ZerolBevelGearSetSystemDeflection':
        ...
        if _2507.ZerolBevelGearSetSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
