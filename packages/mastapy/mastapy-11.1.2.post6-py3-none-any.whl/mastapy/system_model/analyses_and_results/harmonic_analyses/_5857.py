...
class GearMeshHarmonicAnalysis(_5872.InterMountableComponentConnectionHarmonicAnalysis):
    '''GearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2614.GearMeshSystemDeflection':
