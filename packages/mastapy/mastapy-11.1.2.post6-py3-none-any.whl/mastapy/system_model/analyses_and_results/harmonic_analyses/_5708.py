...
class PowerLoadHarmonicAnalysis(_5746.VirtualComponentHarmonicAnalysis):
    '''PowerLoadHarmonicAnalysis
    ...
    @property
    def component_load_case(self) -> '_6583.PowerLoadLoadCase':
        ...
        return constructor.new(_6583.PowerLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2460.PowerLoadSystemDeflection':
        ...
        return constructor.new(_2460.PowerLoadSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
