...
class WormGearMeshHarmonicAnalysis(_5670.GearMeshHarmonicAnalysis):
    '''WormGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2504.WormGearMeshSystemDeflection':
        ...
        return constructor.new(_2504.WormGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
