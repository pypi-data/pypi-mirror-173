...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5819, _5803
...
class RootAssemblySingleWhineAnalysisResultsPropertyAccessor(_5803.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    '''RootAssemblySingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5819.ResultsForOrderIncludingGroups]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5819.ResultsForOrderIncludingGroups))
        return value
