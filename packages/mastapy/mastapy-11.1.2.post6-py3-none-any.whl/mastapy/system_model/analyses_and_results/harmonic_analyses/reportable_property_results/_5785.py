...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5778, _5766
...
class RootAssemblySingleWhineAnalysisResultsPropertyAccessor(_5766.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    '''RootAssemblySingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5778.ResultsForOrderIncludingGroups]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5778.ResultsForOrderIncludingGroups))
        return value
