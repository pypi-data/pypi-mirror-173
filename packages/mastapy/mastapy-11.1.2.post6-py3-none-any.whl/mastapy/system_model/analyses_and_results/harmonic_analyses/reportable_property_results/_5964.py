...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5957, _5962
...
class ResultsForMultipleOrdersForGroups(_5962.ResultsForMultipleOrders):
    '''ResultsForMultipleOrdersForGroups
    ...
    @property
    def groups(self) -> 'List[_5957.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Groups, constructor.new(_5957.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic))
        return value
