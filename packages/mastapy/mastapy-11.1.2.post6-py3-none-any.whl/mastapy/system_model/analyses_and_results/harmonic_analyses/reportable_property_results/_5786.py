...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5779, _5766
...
class SingleWhineAnalysisResultsPropertyAccessor(_5766.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    '''SingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5779.ResultsForOrderIncludingNodes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5779.ResultsForOrderIncludingNodes))
        return value
