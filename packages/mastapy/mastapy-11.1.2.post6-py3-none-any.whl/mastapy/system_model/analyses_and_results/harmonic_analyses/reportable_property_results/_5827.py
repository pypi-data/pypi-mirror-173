...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5820, _5803
...
class SingleWhineAnalysisResultsPropertyAccessor(_5803.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    '''SingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5820.ResultsForOrderIncludingNodes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5820.ResultsForOrderIncludingNodes))
        return value
