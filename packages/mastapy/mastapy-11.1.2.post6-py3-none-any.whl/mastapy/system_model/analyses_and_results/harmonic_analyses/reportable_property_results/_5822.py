...
class ResultsForResponseOfAComponentOrSurfaceInAHarmonic(_0.APIBase):
    ...
    def magnitude(self) -> '_5824.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic':
        ...
        return constructor.new(_5824.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic)(self.wrapped.Magnitude) if self.wrapped.Magnitude is not None else None
    ...
    def result_at_reference_speed(self) -> '_5804.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic':
        ...
        return constructor.new(_5804.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic)(self.wrapped.ResultAtReferenceSpeed) if self.wrapped.ResultAtReferenceSpeed is not None else None
