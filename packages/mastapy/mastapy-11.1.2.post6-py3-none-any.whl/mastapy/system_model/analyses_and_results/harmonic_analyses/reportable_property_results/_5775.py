...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5769, _5774
...
class ResultsForOrderIncludingGroups(_5774.ResultsForOrder):
    '''ResultsForOrderIncludingGroups
    ...
    @property
    def groups(self) -> 'List[_5769.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Groups, constructor.new(_5769.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic))
        return value
