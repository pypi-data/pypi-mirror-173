...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5815, _5821
...
class FEPartSingleWhineAnalysisResultsPropertyAccessor(_5821.SingleWhineAnalysisResultsPropertyAccessor):
    '''FEPartSingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5815.ResultsForOrderIncludingSurfaces]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5815.ResultsForOrderIncludingSurfaces))
        return value
