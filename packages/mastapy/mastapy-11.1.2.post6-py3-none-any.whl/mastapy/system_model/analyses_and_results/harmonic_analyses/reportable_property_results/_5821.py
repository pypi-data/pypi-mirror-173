...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5813, _5820
...
class ResultsForOrderIncludingSurfaces(_5820.ResultsForOrderIncludingNodes):
    '''ResultsForOrderIncludingSurfaces
