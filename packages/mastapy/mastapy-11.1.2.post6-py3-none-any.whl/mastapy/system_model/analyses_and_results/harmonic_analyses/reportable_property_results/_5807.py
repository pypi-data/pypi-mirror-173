...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5821, _5827
...
class FEPartSingleWhineAnalysisResultsPropertyAccessor(_5827.SingleWhineAnalysisResultsPropertyAccessor):
    '''FEPartSingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5821.ResultsForOrderIncludingSurfaces]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5821.ResultsForOrderIncludingSurfaces))
        return value
