...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5968, _5974
...
class FEPartSingleWhineAnalysisResultsPropertyAccessor(_5974.SingleWhineAnalysisResultsPropertyAccessor):
    '''FEPartSingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5968.ResultsForOrderIncludingSurfaces]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5968.ResultsForOrderIncludingSurfaces))
        return value
