...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5780, _5764
...
class ResultsForResponseOfAComponentOrSurfaceInAHarmonic(_0.APIBase):
    ...
    @property
    def magnitude(self) -> '_5780.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic':
        ...
        return constructor.new(_5780.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic)(self.wrapped.Magnitude) if self.wrapped.Magnitude else None
