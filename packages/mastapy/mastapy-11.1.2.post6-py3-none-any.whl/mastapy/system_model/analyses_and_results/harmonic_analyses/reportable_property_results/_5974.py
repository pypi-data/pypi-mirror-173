...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5967, _5950
...
class SingleWhineAnalysisResultsPropertyAccessor(_5950.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    '''SingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5967.ResultsForOrderIncludingNodes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5967.ResultsForOrderIncludingNodes))
        return value
