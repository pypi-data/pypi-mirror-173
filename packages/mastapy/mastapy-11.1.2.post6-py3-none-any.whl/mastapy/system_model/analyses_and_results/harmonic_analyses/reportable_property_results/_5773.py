...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5783, _5776
...
class HarmonicAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def excitations(self) -> 'List[_5783.SingleWhineAnalysisResultsPropertyAccessor]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Excitations, constructor.new(_5783.SingleWhineAnalysisResultsPropertyAccessor))
        return value

    @property
    def orders_for_combined_excitations(self) -> 'List[_5776.ResultsForOrderIncludingNodes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OrdersForCombinedExcitations, constructor.new(_5776.ResultsForOrderIncludingNodes))
        return value
