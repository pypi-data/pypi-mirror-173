...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5589, _5595
...
class ResultsForOrderIncludingNodes(_5595.ResultsForOrder):
    """ResultsForOrderIncludingNodes
    ...
    @property
    def node_results_global_coordinate_system(self) -> 'List[_5589.HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic]':
    ...
    @property
    def node_results_local_coordinate_system(self) -> 'List[_5589.HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic]':
