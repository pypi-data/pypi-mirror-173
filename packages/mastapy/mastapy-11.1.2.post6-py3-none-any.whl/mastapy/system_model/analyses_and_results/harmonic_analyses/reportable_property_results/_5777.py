...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5772, _5776
...
class ResultsForOrderIncludingSurfaces(_5776.ResultsForOrderIncludingNodes):
    '''ResultsForOrderIncludingSurfaces
    ...
    @property
    def fe_surfaces(self) -> 'List[_5772.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESurfaces, constructor.new(_5772.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic))
        return value
