...
class RollingRingConnectionHarmonicAnalysis(_5685.InterMountableComponentConnectionHarmonicAnalysis):
    '''RollingRingConnectionHarmonicAnalysis
    ...
    @property
    def connection_load_case(self) -> '_6590.RollingRingConnectionLoadCase':
        ...
        return constructor.new(_6590.RollingRingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2466.RollingRingConnectionSystemDeflection':
        ...
        return constructor.new(_2466.RollingRingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
