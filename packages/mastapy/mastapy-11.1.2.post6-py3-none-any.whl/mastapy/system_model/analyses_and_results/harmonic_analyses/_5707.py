...
class PointLoadHarmonicAnalysis(_5746.VirtualComponentHarmonicAnalysis):
    '''PointLoadHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2459.PointLoadSystemDeflection':
        ...
        return constructor.new(_2459.PointLoadSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
