...
class ConceptCouplingHarmonicAnalysis(_5453.CouplingHarmonicAnalysis):
    """ConceptCouplingHarmonicAnalysis
    ...
    @property
    def assembly_load_case(self) -> '_6563.ConceptCouplingLoadCase':
    ...
    @property
    def system_deflection_results(self) -> '_2463.ConceptCouplingSystemDeflection':
