...
from mastapy.system_model.connections_and_sockets.gears import _2000, _2001, _2002
...
class KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis(_5630.ConicalGearMeshHarmonicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearMeshHarmonicAnalysis
    ...
    @property
    def connection_design(self) -> '_2000.KlingelnbergCycloPalloidConicalGearMesh':
    ...
    @property
    def system_deflection_results(self) -> '_2436.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection':
