...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5906
...
class GeneralPeriodicExcitationDetail(_5906.SingleNodePeriodicExcitationWithReferenceShaft):
    '''GeneralPeriodicExcitationDetail
