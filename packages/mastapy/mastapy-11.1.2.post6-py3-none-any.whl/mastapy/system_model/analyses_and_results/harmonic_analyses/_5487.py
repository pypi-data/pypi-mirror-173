...
class GearMeshHarmonicAnalysis(_5502.InterMountableComponentConnectionHarmonicAnalysis):
    """GearMeshHarmonicAnalysis
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_3894.ToothPassingHarmonic]':
    ...
    @property
    def system_deflection_results(self) -> '_2503.GearMeshSystemDeflection':
