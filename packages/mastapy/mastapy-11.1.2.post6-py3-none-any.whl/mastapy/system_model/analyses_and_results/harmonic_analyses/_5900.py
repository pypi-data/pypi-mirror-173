...
class RollingRingConnectionHarmonicAnalysis(_5872.InterMountableComponentConnectionHarmonicAnalysis):
    '''RollingRingConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2653.RollingRingConnectionSystemDeflection':
        ...
        return constructor.new(_2653.RollingRingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
