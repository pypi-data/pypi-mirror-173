...
class ShaftToMountableComponentConnectionHarmonicAnalysis(_5599.AbstractShaftToMountableComponentConnectionHarmonicAnalysis):
    '''ShaftToMountableComponentConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2473.ShaftToMountableComponentConnectionSystemDeflection':
