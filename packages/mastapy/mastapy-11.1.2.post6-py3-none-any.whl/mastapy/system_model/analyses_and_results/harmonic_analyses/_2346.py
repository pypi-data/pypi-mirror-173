...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _2345
...
class HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation(_2345.HarmonicAnalysis):
    '''HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
