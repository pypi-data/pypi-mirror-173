...
class BearingHarmonicAnalysis(_5820.ConnectorHarmonicAnalysis):
    '''BearingHarmonicAnalysis
    ...
    @property
    def rolling_bearing_speed_results(self) -> '_1940.RollingBearingSpeedResults':
        ...
        return constructor.new(_1940.RollingBearingSpeedResults)(self.wrapped.RollingBearingSpeedResults) if self.wrapped.RollingBearingSpeedResults is not None else None
    ...
    @property
    def system_deflection_results(self) -> '_2553.BearingSystemDeflection':
        ...
        return constructor.new(_2553.BearingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
