...
class CVTHarmonicAnalysis(_5606.BeltDriveHarmonicAnalysis):
    '''CVTHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2404.CVTSystemDeflection':
        ...
        return constructor.new(_2404.CVTSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
