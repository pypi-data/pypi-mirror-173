...
class SpringDamperHarmonicAnalysis(_5636.CouplingHarmonicAnalysis):
    '''SpringDamperHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2480.SpringDamperSystemDeflection':
        ...
        return constructor.new(_2480.SpringDamperSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
