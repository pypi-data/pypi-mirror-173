...
class SpringDamperHalfHarmonicAnalysis(_5635.CouplingHalfHarmonicAnalysis):
    '''SpringDamperHalfHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2479.SpringDamperHalfSystemDeflection':
        ...
        return constructor.new(_2479.SpringDamperHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
