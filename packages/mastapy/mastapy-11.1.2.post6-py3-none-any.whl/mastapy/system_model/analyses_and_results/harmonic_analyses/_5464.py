...
class CylindricalPlanetGearHarmonicAnalysis(_5461.CylindricalGearHarmonicAnalysis):
    """CylindricalPlanetGearHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2276.CylindricalPlanetGear':
    ...
    @property
    def system_deflection_results(self) -> '_2494.CylindricalPlanetGearSystemDeflection':
