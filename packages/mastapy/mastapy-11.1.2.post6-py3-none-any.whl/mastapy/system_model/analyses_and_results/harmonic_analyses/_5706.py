...
class PlanetCarrierHarmonicAnalysis(_5697.MountableComponentHarmonicAnalysis):
    '''PlanetCarrierHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2458.PlanetCarrierSystemDeflection':
        ...
        return constructor.new(_2458.PlanetCarrierSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
