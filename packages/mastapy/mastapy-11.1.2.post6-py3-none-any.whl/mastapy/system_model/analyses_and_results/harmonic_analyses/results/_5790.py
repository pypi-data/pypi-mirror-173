...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5789
...
class ExcitationSourceSelectionGroup(_5789.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self) -> 'List[_5789.ExcitationSourceSelectionBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubItems, constructor.new(_5789.ExcitationSourceSelectionBase))
        return value
