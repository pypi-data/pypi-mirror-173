...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5947
...
class ResultLocationSelectionGroups(_0.APIBase):
    ...
    @property
    def selected_result_location_group(self) -> '_5947.ResultLocationSelectionGroup':
        ...
        return constructor.new(_5947.ResultLocationSelectionGroup)(self.wrapped.SelectedResultLocationGroup) if self.wrapped.SelectedResultLocationGroup is not None else None

    @property
    def result_location_groups(self) -> 'List[_5947.ResultLocationSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultLocationGroups, constructor.new(_5947.ResultLocationSelectionGroup))
        return value
