...
class ResultLocationSelectionGroup(_0.APIBase):
    ...
    @property
    def response_locations(self) -> 'List[_5762.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResponseLocations, constructor.new(_5762.ResultNodeSelection))
        return value
