...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5944, _5942
...
class ExcitationSourceSelection(_5942.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5944.HarmonicSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicSelections, constructor.new(_5944.HarmonicSelection))
        return value
