...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5795
...
class ExcitationSourceSelectionGroup(_5795.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self) -> 'List[_5795.ExcitationSourceSelectionBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubItems, constructor.new(_5795.ExcitationSourceSelectionBase))
        return value
