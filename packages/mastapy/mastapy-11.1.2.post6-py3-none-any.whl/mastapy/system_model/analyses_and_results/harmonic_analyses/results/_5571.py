...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5574, _5572
...
class ExcitationSourceSelection(_5572.ExcitationSourceSelectionBase):
    """ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5574.HarmonicSelection]':
