...
class ResultLocationSelectionGroups(_0.APIBase):
    ...
    @property
    def selected_result_location_group(self) -> '_5763.ResultLocationSelectionGroup':
        ...
        return constructor.new(_5763.ResultLocationSelectionGroup)(self.wrapped.SelectedResultLocationGroup) if self.wrapped.SelectedResultLocationGroup else None

    @property
    def result_location_groups(self) -> 'List[_5763.ResultLocationSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultLocationGroups, constructor.new(_5763.ResultLocationSelectionGroup))
        return value
