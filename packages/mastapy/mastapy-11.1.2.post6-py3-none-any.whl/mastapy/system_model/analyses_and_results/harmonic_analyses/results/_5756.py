...
class ExcitationSourceSelectionGroup(_5755.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self) -> 'List[_5755.ExcitationSourceSelectionBase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SubItems, constructor.new(_5755.ExcitationSourceSelectionBase))
        return value
