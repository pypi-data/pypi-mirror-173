...
class ResultLocationSelectionGroups(_0.APIBase):
    ...
    @property
    def selected_result_location_group(self) -> '_5760.ResultLocationSelectionGroup':
        ...
        return constructor.new(_5760.ResultLocationSelectionGroup)(self.wrapped.SelectedResultLocationGroup) if self.wrapped.SelectedResultLocationGroup else None

    @property
    def result_location_groups(self) -> 'List[_5760.ResultLocationSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultLocationGroups, constructor.new(_5760.ResultLocationSelectionGroup))
        return value
