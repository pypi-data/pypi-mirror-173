...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5791, _5789
...
class ExcitationSourceSelection(_5789.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5791.HarmonicSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicSelections, constructor.new(_5791.HarmonicSelection))
        return value
