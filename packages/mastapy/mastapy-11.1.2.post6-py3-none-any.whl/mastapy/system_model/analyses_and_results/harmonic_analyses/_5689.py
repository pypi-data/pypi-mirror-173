...
class KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis(_5686.KlingelnbergCycloPalloidConicalGearHarmonicAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2441.KlingelnbergCycloPalloidHypoidGearSystemDeflection':
        ...
        return constructor.new(_2441.KlingelnbergCycloPalloidHypoidGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
