...
class FaceGearMeshHarmonicAnalysis(_5670.GearMeshHarmonicAnalysis):
    '''FaceGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2422.FaceGearMeshSystemDeflection':
        ...
        return constructor.new(_2422.FaceGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
