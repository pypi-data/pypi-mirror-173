...
class StraightBevelPlanetGearHarmonicAnalysis(_5728.StraightBevelDiffGearHarmonicAnalysis):
    '''StraightBevelPlanetGearHarmonicAnalysis
    ...
    @property
    def component_design(self) -> '_2226.StraightBevelPlanetGear':
        ...
        return constructor.new(_2226.StraightBevelPlanetGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2487.StraightBevelPlanetGearSystemDeflection':
        ...
        return constructor.new(_2487.StraightBevelPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
