...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _2308
...
class HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation(_2308.HarmonicAnalysis):
    '''HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
