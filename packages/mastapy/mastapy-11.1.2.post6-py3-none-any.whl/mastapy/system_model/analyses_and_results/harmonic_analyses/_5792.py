...
from mastapy.system_model.analyses_and_results.static_loads import _6655, _6688
from mastapy.system_model.analyses_and_results.system_deflections import _2554, _2587
...
class BeltConnectionHarmonicAnalysis(_5872.InterMountableComponentConnectionHarmonicAnalysis):
    '''BeltConnectionHarmonicAnalysis
    ...
    @property
    def connection_load_case(self) -> '_6655.BeltConnectionLoadCase':
        ...
        if _6655.BeltConnectionLoadCase.TYPE not in self.wrapped.ConnectionLoadCase.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2554.BeltConnectionSystemDeflection':
