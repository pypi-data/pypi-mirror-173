...
class CouplingHarmonicAnalysis(_5907.SpecialisedAssemblyHarmonicAnalysis):
    '''CouplingHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2586.CouplingSystemDeflection':
