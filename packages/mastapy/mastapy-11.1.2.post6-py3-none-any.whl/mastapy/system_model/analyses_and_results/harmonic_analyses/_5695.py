...
class MassDiscHarmonicAnalysis(_5746.VirtualComponentHarmonicAnalysis):
    '''MassDiscHarmonicAnalysis
    ...
    @property
    def component_load_case(self) -> '_6565.MassDiscLoadCase':
        ...
        return constructor.new(_6565.MassDiscLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2447.MassDiscSystemDeflection':
        ...
        return constructor.new(_2447.MassDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
