...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _2339
...
class HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation(_2339.HarmonicAnalysis):
    '''HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
