...
class BevelGearSetHarmonicAnalysis(_5789.AGMAGleasonConicalGearSetHarmonicAnalysis):
    '''BevelGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2562.BevelGearSetSystemDeflection':
