...
class CycloidalAssemblyHarmonicAnalysis(_5720.SpecialisedAssemblyHarmonicAnalysis):
    '''CycloidalAssemblyHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2405.CycloidalAssemblySystemDeflection':
        ...
        return constructor.new(_2405.CycloidalAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
