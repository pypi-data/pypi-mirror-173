...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5621, _5596
...
class GearMeshExcitationDetail(_5596.AbstractPeriodicExcitationDetail):
    '''GearMeshExcitationDetail
    ...
    @property
    def gear_mesh(self) -> '_2427.GearMeshSystemDeflection':
        ...
        if _2427.GearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_agma_gleason_conical_gear_mesh_system_deflection(self) -> '_2364.AGMAGleasonConicalGearMeshSystemDeflection':
        ...
        if _2364.AGMAGleasonConicalGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_bevel_differential_gear_mesh_system_deflection(self) -> '_2371.BevelDifferentialGearMeshSystemDeflection':
        ...
        if _2371.BevelDifferentialGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_bevel_gear_mesh_system_deflection(self) -> '_2376.BevelGearMeshSystemDeflection':
        ...
        if _2376.BevelGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_concept_gear_mesh_system_deflection(self) -> '_2390.ConceptGearMeshSystemDeflection':
        ...
        if _2390.ConceptGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_conical_gear_mesh_system_deflection(self) -> '_2394.ConicalGearMeshSystemDeflection':
        ...
        if _2394.ConicalGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_cylindrical_gear_mesh_system_deflection(self) -> '_2409.CylindricalGearMeshSystemDeflection':
        ...
        if _2409.CylindricalGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_cylindrical_gear_mesh_system_deflection_timestep(self) -> '_2410.CylindricalGearMeshSystemDeflectionTimestep':
        ...
        if _2410.CylindricalGearMeshSystemDeflectionTimestep.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_cylindrical_gear_mesh_system_deflection_with_ltca_results(self) -> '_2411.CylindricalGearMeshSystemDeflectionWithLTCAResults':
        ...
        if _2411.CylindricalGearMeshSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_face_gear_mesh_system_deflection(self) -> '_2422.FaceGearMeshSystemDeflection':
        ...
        if _2422.FaceGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_hypoid_gear_mesh_system_deflection(self) -> '_2431.HypoidGearMeshSystemDeflection':
        ...
        if _2431.HypoidGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_klingelnberg_cyclo_palloid_conical_gear_mesh_system_deflection(self) -> '_2436.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection':
        ...
        if _2436.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_klingelnberg_cyclo_palloid_hypoid_gear_mesh_system_deflection(self) -> '_2439.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection':
        ...
        if _2439.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh_system_deflection(self) -> '_2442.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection':
        ...
        if _2442.KlingelnbergCycloPalloidSpiralBevelGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_spiral_bevel_gear_mesh_system_deflection(self) -> '_2475.SpiralBevelGearMeshSystemDeflection':
        ...
        if _2475.SpiralBevelGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_straight_bevel_diff_gear_mesh_system_deflection(self) -> '_2481.StraightBevelDiffGearMeshSystemDeflection':
        ...
        if _2481.StraightBevelDiffGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_straight_bevel_gear_mesh_system_deflection(self) -> '_2484.StraightBevelGearMeshSystemDeflection':
        ...
        if _2484.StraightBevelGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_worm_gear_mesh_system_deflection(self) -> '_2504.WormGearMeshSystemDeflection':
        ...
        if _2504.WormGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    @property
    def gear_mesh_of_type_zerol_bevel_gear_mesh_system_deflection(self) -> '_2507.ZerolBevelGearMeshSystemDeflection':
        ...
        if _2507.ZerolBevelGearMeshSystemDeflection.TYPE not in self.wrapped.GearMesh.__class__.__mro__:
    ...
    def get_compliance_and_force_data(self, excitation_type: '_6617.TEExcitationType') -> '_5621.ComplianceAndForceData':
