...
class HarmonicAnalysis(_7185.CompoundAnalysisCase):
    '''HarmonicAnalysis
    ...
    @property
    def harmonic_analyses_of_single_excitations(self) -> 'List[_5397.HarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicAnalysesOfSingleExcitations, constructor.new(_5397.HarmonicAnalysisOfSingleExcitation))
        return value
