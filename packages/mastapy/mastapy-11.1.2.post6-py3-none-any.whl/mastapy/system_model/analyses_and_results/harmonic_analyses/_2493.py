...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _2492
...
class HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation(_2492.HarmonicAnalysis):
    '''HarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
