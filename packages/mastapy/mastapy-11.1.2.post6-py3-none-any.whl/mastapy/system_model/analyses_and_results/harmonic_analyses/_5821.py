...
class CouplingConnectionHarmonicAnalysis(_5872.InterMountableComponentConnectionHarmonicAnalysis):
    '''CouplingConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2584.CouplingConnectionSystemDeflection':
