...
class AGMAGleasonConicalGearSetHarmonicAnalysis(_5631.ConicalGearSetHarmonicAnalysis):
    '''AGMAGleasonConicalGearSetHarmonicAnalysis
    ...
    @property
    def assembly_design(self) -> '_2191.AGMAGleasonConicalGearSet':
    ...
    @property
    def system_deflection_results(self) -> '_2365.AGMAGleasonConicalGearSetSystemDeflection':
