...
class DatumHarmonicAnalysis(_5622.ComponentHarmonicAnalysis):
    '''DatumHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2419.DatumSystemDeflection':
        ...
        return constructor.new(_2419.DatumSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
