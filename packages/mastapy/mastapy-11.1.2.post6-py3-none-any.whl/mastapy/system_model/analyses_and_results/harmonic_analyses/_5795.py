...
class BevelDifferentialGearMeshHarmonicAnalysis(_5800.BevelGearMeshHarmonicAnalysis):
    '''BevelDifferentialGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2556.BevelDifferentialGearMeshSystemDeflection':
        ...
        return constructor.new(_2556.BevelDifferentialGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
