...
class ConnectorHarmonicAnalysis(_5697.MountableComponentHarmonicAnalysis):
    '''ConnectorHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2398.ConnectorSystemDeflection':
