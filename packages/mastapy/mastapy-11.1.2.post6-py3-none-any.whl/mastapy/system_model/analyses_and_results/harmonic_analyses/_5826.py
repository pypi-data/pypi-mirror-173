...
class CVTPulleyHarmonicAnalysis(_5896.PulleyHarmonicAnalysis):
    '''CVTPulleyHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2588.CVTPulleySystemDeflection':
        ...
        return constructor.new(_2588.CVTPulleySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
