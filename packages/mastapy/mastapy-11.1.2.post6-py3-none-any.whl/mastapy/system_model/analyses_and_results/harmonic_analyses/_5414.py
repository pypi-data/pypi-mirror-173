...
from mastapy.system_model.analyses_and_results.system_deflections import _2436, _2482, _2548
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5415
...
class AbstractShaftHarmonicAnalysis(_5415.AbstractShaftOrHousingHarmonicAnalysis):
    """AbstractShaftHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2436.AbstractShaftSystemDeflection':
