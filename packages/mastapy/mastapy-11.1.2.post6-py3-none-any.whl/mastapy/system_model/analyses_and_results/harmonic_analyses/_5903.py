...
from mastapy.system_model.analyses_and_results.modal_analyses import _5042
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5868, _5784
...
class ShaftHarmonicAnalysis(_5784.AbstractShaftHarmonicAnalysis):
    '''ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_5042.ShaftModalAnalysis':
        ...
        return constructor.new(_5042.ShaftModalAnalysis)(self.wrapped.CoupledModalAnalysis) if self.wrapped.CoupledModalAnalysis is not None else None

    @property
    def export(self) -> '_5868.HarmonicAnalysisShaftExportOptions':
        ...
        return constructor.new(_5868.HarmonicAnalysisShaftExportOptions)(self.wrapped.Export) if self.wrapped.Export is not None else None
    ...
    @property
    def system_deflection_results(self) -> '_2659.ShaftSystemDeflection':
        ...
        return constructor.new(_2659.ShaftSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
