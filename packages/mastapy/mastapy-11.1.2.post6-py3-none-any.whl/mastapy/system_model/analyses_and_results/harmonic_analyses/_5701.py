...
class PartToPartShearCouplingHalfHarmonicAnalysis(_5635.CouplingHalfHarmonicAnalysis):
    '''PartToPartShearCouplingHalfHarmonicAnalysis
    ...
    @property
    def component_load_case(self) -> '_6574.PartToPartShearCouplingHalfLoadCase':
        ...
        return constructor.new(_6574.PartToPartShearCouplingHalfLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2455.PartToPartShearCouplingHalfSystemDeflection':
        ...
        return constructor.new(_2455.PartToPartShearCouplingHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
