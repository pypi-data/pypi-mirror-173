...
class HarmonicAnalysisFEExportOptions(_5677.HarmonicAnalysisExportOptions['_2330.IHaveFEPartHarmonicAnalysisResults', '_2132.FEPart']):
    '''HarmonicAnalysisFEExportOptions
    ...
    @property
    def analysis_options(self) -> '_5679.HarmonicAnalysisOptions':
        ...
        if _5679.HarmonicAnalysisOptions.TYPE not in self.wrapped.AnalysisOptions.__class__.__mro__:
    ...
    @property
    def eigenvalue_options(self) -> '_152.EigenvalueOptions':
        ...
        return constructor.new(_152.EigenvalueOptions)(self.wrapped.EigenvalueOptions) if self.wrapped.EigenvalueOptions else None
