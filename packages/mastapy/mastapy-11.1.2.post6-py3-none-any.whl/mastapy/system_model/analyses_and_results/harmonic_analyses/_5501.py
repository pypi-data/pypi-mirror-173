...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5499, _5500, _5419
...
class HypoidGearSetHarmonicAnalysis(_5419.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """HypoidGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5499.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def hypoid_gears_harmonic_analysis(self) -> 'List[_5499.HypoidGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5500.HypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def hypoid_meshes_harmonic_analysis(self) -> 'List[_5500.HypoidGearMeshHarmonicAnalysis]':
