...
from mastapy.system_model.analyses_and_results import _2511
...
class SingleAnalysis:
    ...
    def perform_analysis_with_progress(self, task_progress: '_7389.TaskProgress'):
        ''' 'PerformAnalysis' is the original name of this method.
    ...
    def results_for(self, design_entity: '_2070.DesignEntity') -> '_2511.DesignEntityAnalysis':
    ...
    def results_for_design_entity_analysis(self, design_entity_analysis: '_2511.DesignEntityAnalysis') -> '_2511.DesignEntityAnalysis':
        ''' 'ResultsFor' is the original name of this method.
