...
from mastapy.system_model.analyses_and_results.static_loads import _6607, _6456
...
class StaticLoadAnalysisCase(_7183.AnalysisCase):
    '''StaticLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6607.StaticLoadCase':
        ...
        if _6607.StaticLoadCase.TYPE not in self.wrapped.LoadCase.__class__.__mro__:
