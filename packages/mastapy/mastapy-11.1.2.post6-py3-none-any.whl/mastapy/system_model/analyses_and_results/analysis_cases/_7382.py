...
class TimeSeriesLoadAnalysisCase(_7366.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6640.TimeSeriesLoadCase':
        ...
        return constructor.new(_6640.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase is not None else None
