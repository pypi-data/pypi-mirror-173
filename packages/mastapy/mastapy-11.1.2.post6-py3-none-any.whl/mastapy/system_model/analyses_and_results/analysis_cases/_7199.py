...
class TimeSeriesLoadAnalysisCase(_7183.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6621.TimeSeriesLoadCase':
        ...
        return constructor.new(_6621.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
