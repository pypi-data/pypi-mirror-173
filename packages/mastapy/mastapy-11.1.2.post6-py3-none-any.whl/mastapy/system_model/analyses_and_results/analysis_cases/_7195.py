...
class StaticLoadAnalysisCase(_7180.AnalysisCase):
    '''StaticLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6604.StaticLoadCase':
        ...
        if _6604.StaticLoadCase.TYPE not in self.wrapped.LoadCase.__class__.__mro__:
