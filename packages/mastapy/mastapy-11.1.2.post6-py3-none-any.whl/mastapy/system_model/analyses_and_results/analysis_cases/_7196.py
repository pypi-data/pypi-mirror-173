...
class TimeSeriesLoadAnalysisCase(_7180.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6618.TimeSeriesLoadCase':
        ...
        return constructor.new(_6618.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
