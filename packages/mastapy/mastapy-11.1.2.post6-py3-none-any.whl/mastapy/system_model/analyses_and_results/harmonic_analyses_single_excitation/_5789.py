...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5787, _5788, _5794
...
class FaceGearSetHarmonicAnalysisOfSingleExcitation(_5794.GearSetHarmonicAnalysisOfSingleExcitation):
    """FaceGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def face_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5787.FaceGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def face_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5788.FaceGearMeshHarmonicAnalysisOfSingleExcitation]':
