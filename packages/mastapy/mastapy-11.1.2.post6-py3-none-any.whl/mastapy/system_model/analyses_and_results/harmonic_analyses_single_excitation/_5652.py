...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5650, _5651, _5541
...
class ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation(_5541.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    '''ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def zerol_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5650.ZerolBevelGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsHarmonicAnalysisOfSingleExcitation, constructor.new(_5650.ZerolBevelGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def zerol_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5651.ZerolBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesHarmonicAnalysisOfSingleExcitation, constructor.new(_5651.ZerolBevelGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
