...
class ModalAnalysisForHarmonicAnalysis(_2342.ModalAnalysis):
    '''ModalAnalysisForHarmonicAnalysis
    ...
    @property
    def harmonic_analysis_settings(self) -> '_5713.HarmonicAnalysisOptions':
        ...
        if _5713.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisSettings.__class__.__mro__:
