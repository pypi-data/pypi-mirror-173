...
from mastapy.system_model.analyses_and_results.modal_analyses import _2310
...
class ModalAnalysisForHarmonicAnalysis(_2310.ModalAnalysis):
    '''ModalAnalysisForHarmonicAnalysis
    ...
    @property
    def harmonic_analysis_settings(self) -> '_5678.HarmonicAnalysisOptions':
        ...
        if _5678.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisSettings.__class__.__mro__:
