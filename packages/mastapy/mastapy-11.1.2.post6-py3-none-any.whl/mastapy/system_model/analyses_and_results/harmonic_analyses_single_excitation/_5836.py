...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5834, _5835, _5752
...
class SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation(_5752.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    """SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def spiral_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5834.SpiralBevelGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def spiral_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5835.SpiralBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
