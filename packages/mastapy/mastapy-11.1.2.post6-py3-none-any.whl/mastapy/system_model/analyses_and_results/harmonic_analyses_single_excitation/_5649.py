...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5647, _5648, _5583
...
class WormGearSetHarmonicAnalysisOfSingleExcitation(_5583.GearSetHarmonicAnalysisOfSingleExcitation):
    '''WormGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def worm_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5647.WormGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsHarmonicAnalysisOfSingleExcitation, constructor.new(_5647.WormGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def worm_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5648.WormGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesHarmonicAnalysisOfSingleExcitation, constructor.new(_5648.WormGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
