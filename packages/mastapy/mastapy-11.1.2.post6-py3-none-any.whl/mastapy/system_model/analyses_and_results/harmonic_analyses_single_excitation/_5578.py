...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5576, _5577, _5583
...
class FaceGearSetHarmonicAnalysisOfSingleExcitation(_5583.GearSetHarmonicAnalysisOfSingleExcitation):
    '''FaceGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def face_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5576.FaceGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsHarmonicAnalysisOfSingleExcitation, constructor.new(_5576.FaceGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def face_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5577.FaceGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesHarmonicAnalysisOfSingleExcitation, constructor.new(_5577.FaceGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
