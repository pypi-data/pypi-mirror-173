...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5858, _5859, _5794
...
class WormGearSetHarmonicAnalysisOfSingleExcitation(_5794.GearSetHarmonicAnalysisOfSingleExcitation):
    """WormGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def worm_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5858.WormGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5859.WormGearMeshHarmonicAnalysisOfSingleExcitation]':
