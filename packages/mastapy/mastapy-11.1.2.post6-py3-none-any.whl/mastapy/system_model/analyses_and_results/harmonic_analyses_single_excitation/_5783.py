...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5781, _5782, _5794
...
class CylindricalGearSetHarmonicAnalysisOfSingleExcitation(_5794.GearSetHarmonicAnalysisOfSingleExcitation):
    """CylindricalGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def cylindrical_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5781.CylindricalGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def cylindrical_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5782.CylindricalGearMeshHarmonicAnalysisOfSingleExcitation]':
