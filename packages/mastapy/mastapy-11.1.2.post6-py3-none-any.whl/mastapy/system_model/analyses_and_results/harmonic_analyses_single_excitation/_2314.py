...
class ModalAnalysisForHarmonicAnalysis(_2311.ModalAnalysis):
    '''ModalAnalysisForHarmonicAnalysis
    ...
    @property
    def harmonic_analysis_settings(self) -> '_5679.HarmonicAnalysisOptions':
        ...
        if _5679.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisSettings.__class__.__mro__:
