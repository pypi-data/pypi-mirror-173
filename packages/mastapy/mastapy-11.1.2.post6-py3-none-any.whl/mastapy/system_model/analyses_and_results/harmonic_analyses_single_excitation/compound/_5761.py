...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5632
...
class StraightBevelGearCompoundHarmonicAnalysisOfSingleExcitation(_5669.BevelGearCompoundHarmonicAnalysisOfSingleExcitation):
    '''StraightBevelGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5632.StraightBevelGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5632.StraightBevelGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5632.StraightBevelGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5632.StraightBevelGearHarmonicAnalysisOfSingleExcitation))
        return value
