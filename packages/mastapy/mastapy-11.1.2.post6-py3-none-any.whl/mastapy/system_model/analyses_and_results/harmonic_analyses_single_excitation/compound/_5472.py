...
class AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation(_5500.ConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    '''AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5342.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5342.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5342.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5342.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation))
        return value
