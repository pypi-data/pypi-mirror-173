...
class AGMAGleasonConicalGearCompoundHarmonicAnalysisOfSingleExcitation(_5538.ConicalGearCompoundHarmonicAnalysisOfSingleExcitation):
    '''AGMAGleasonConicalGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5380.AGMAGleasonConicalGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5380.AGMAGleasonConicalGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5380.AGMAGleasonConicalGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5380.AGMAGleasonConicalGearHarmonicAnalysisOfSingleExcitation))
        return value
