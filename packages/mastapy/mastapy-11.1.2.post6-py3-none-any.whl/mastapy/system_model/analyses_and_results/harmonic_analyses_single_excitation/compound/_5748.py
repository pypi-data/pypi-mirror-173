...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5619
...
class ShaftCompoundHarmonicAnalysisOfSingleExcitation(_5654.AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation):
    '''ShaftCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5619.ShaftHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5619.ShaftHarmonicAnalysisOfSingleExcitation))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5619.ShaftHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5619.ShaftHarmonicAnalysisOfSingleExcitation))
        return value
