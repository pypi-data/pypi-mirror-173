...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5551
...
class ConceptCouplingCompoundHarmonicAnalysisOfSingleExcitation(_5690.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    '''ConceptCouplingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5551.ConceptCouplingHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5551.ConceptCouplingHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5551.ConceptCouplingHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5551.ConceptCouplingHarmonicAnalysisOfSingleExcitation))
        return value
