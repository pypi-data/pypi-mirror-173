...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5568
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _5654
...
class CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation(_5654.AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation):
    '''CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5568.CycloidalDiscHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5568.CycloidalDiscHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5568.CycloidalDiscHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5568.CycloidalDiscHarmonicAnalysisOfSingleExcitation))
        return value
