...
class CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation(_5571.InterMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    '''CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5413.CouplingConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5413.CouplingConnectionHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5413.CouplingConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5413.CouplingConnectionHarmonicAnalysisOfSingleExcitation))
        return value
