...
class AbstractAssemblyCompoundHarmonicAnalysisOfSingleExcitation(_5585.PartCompoundHarmonicAnalysisOfSingleExcitation):
    '''AbstractAssemblyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5376.AbstractAssemblyHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5376.AbstractAssemblyHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5376.AbstractAssemblyHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5376.AbstractAssemblyHarmonicAnalysisOfSingleExcitation))
        return value
