...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5616
...
class RollingRingConnectionCompoundHarmonicAnalysisOfSingleExcitation(_5718.InterMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    '''RollingRingConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5616.RollingRingConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5616.RollingRingConnectionHarmonicAnalysisOfSingleExcitation))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5616.RollingRingConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5616.RollingRingConnectionHarmonicAnalysisOfSingleExcitation))
        return value
