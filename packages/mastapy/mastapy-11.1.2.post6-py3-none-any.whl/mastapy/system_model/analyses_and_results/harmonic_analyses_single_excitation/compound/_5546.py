...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _5515
...
class CVTBeltConnectionCompoundHarmonicAnalysisOfSingleExcitation(_5515.BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    '''CVTBeltConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5416.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5416.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5416.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5416.CVTBeltConnectionHarmonicAnalysisOfSingleExcitation))
        return value
