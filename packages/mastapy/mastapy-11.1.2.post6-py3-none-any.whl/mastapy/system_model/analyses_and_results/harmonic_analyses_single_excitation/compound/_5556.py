...
class CylindricalPlanetGearCompoundHarmonicAnalysisOfSingleExcitation(_5553.CylindricalGearCompoundHarmonicAnalysisOfSingleExcitation):
    '''CylindricalPlanetGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5426.CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5426.CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5426.CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5426.CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation))
        return value
