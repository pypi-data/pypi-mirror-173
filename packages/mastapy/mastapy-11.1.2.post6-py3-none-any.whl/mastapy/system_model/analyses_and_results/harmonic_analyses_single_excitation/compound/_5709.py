...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5579
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _5655
...
class FEPartCompoundHarmonicAnalysisOfSingleExcitation(_5655.AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation):
    '''FEPartCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5579.FEPartHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5579.FEPartHarmonicAnalysisOfSingleExcitation))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5579.FEPartHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5579.FEPartHarmonicAnalysisOfSingleExcitation))
        return value
