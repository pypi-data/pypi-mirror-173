...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5620
...
class ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation(_5689.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    '''ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5620.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5620.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5620.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5620.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation))
        return value
