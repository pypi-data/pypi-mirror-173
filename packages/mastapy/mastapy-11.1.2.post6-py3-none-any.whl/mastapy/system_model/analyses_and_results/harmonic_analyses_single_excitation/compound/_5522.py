...
class BevelGearCompoundHarmonicAnalysisOfSingleExcitation(_5510.AGMAGleasonConicalGearCompoundHarmonicAnalysisOfSingleExcitation):
    '''BevelGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5392.BevelGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5392.BevelGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5392.BevelGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5392.BevelGearHarmonicAnalysisOfSingleExcitation))
        return value
