...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _5555
...
class PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation(_5555.CylindricalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    '''PlanetaryGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5461.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5461.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5461.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5461.PlanetaryGearSetHarmonicAnalysisOfSingleExcitation))
        return value
