...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5606
...
class PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation(_5690.CouplingCompoundHarmonicAnalysisOfSingleExcitation):
    '''PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5606.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5606.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5606.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5606.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation))
        return value
