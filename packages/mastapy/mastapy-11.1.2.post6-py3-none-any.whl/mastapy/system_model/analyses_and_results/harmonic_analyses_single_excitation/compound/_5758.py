...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5629
...
class StraightBevelDiffGearCompoundHarmonicAnalysisOfSingleExcitation(_5669.BevelGearCompoundHarmonicAnalysisOfSingleExcitation):
    '''StraightBevelDiffGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5629.StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5629.StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5629.StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5629.StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation))
        return value
