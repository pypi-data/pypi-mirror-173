...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5637
...
class SynchroniserHalfCompoundHarmonicAnalysisOfSingleExcitation(_5768.SynchroniserPartCompoundHarmonicAnalysisOfSingleExcitation):
    '''SynchroniserHalfCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5637.SynchroniserHalfHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5637.SynchroniserHalfHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5637.SynchroniserHalfHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5637.SynchroniserHalfHarmonicAnalysisOfSingleExcitation))
        return value
