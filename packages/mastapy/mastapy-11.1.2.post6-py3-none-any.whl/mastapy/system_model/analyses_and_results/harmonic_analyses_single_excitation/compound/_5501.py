...
class AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation(_5502.AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation):
    '''AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5371.AbstractShaftHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5371.AbstractShaftHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5371.AbstractShaftHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5371.AbstractShaftHarmonicAnalysisOfSingleExcitation))
        return value
