...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5636
...
class StraightBevelSunGearCompoundHarmonicAnalysisOfSingleExcitation(_5758.StraightBevelDiffGearCompoundHarmonicAnalysisOfSingleExcitation):
    '''StraightBevelSunGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5636.StraightBevelSunGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5636.StraightBevelSunGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5636.StraightBevelSunGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5636.StraightBevelSunGearHarmonicAnalysisOfSingleExcitation))
        return value
