...
class BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation(_5531.InterMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    '''BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5345.BeltConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5345.BeltConnectionHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5345.BeltConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5345.BeltConnectionHarmonicAnalysisOfSingleExcitation))
        return value
