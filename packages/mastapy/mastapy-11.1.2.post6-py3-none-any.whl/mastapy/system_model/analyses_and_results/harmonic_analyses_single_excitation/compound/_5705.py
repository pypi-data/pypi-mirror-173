...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5575
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _5678
...
class ExternalCADModelCompoundHarmonicAnalysisOfSingleExcitation(_5678.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''ExternalCADModelCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5575.ExternalCADModelHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5575.ExternalCADModelHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5575.ExternalCADModelHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5575.ExternalCADModelHarmonicAnalysisOfSingleExcitation))
        return value
