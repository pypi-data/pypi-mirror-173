...
class AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation(_5655.AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation):
    '''AbstractShaftCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5524.AbstractShaftHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5524.AbstractShaftHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5524.AbstractShaftHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5524.AbstractShaftHarmonicAnalysisOfSingleExcitation))
        return value
