...
class CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation(_5718.InterMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    '''CouplingConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5560.CouplingConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5560.CouplingConnectionHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5560.CouplingConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5560.CouplingConnectionHarmonicAnalysisOfSingleExcitation))
        return value
