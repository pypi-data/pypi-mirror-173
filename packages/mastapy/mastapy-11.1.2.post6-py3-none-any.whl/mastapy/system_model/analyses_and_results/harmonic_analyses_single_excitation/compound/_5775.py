...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5646
...
class VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation(_5730.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5646.VirtualComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5646.VirtualComponentHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5646.VirtualComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5646.VirtualComponentHarmonicAnalysisOfSingleExcitation))
        return value
