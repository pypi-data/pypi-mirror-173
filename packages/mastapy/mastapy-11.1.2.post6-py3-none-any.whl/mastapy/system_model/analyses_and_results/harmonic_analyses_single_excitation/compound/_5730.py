...
class MountableComponentCompoundHarmonicAnalysisOfSingleExcitation(_5678.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''MountableComponentCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5601.MountableComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5601.MountableComponentHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5601.MountableComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5601.MountableComponentHarmonicAnalysisOfSingleExcitation))
        return value
