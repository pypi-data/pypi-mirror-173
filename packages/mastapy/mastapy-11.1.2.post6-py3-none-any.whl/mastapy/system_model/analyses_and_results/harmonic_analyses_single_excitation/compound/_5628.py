...
class VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation(_5583.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5499.VirtualComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5499.VirtualComponentHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5499.VirtualComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5499.VirtualComponentHarmonicAnalysisOfSingleExcitation))
        return value
