...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5599
...
class MassDiscCompoundHarmonicAnalysisOfSingleExcitation(_5775.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''MassDiscCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5599.MassDiscHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5599.MassDiscHarmonicAnalysisOfSingleExcitation))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5599.MassDiscHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5599.MassDiscHarmonicAnalysisOfSingleExcitation))
        return value
