...
class BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(_5472.AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    '''BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5354.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5354.BevelGearSetHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5354.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5354.BevelGearSetHarmonicAnalysisOfSingleExcitation))
        return value
