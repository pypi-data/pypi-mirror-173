...
class CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation(_5583.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5414.CouplingHalfHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5414.CouplingHalfHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5414.CouplingHalfHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5414.CouplingHalfHarmonicAnalysisOfSingleExcitation))
        return value
