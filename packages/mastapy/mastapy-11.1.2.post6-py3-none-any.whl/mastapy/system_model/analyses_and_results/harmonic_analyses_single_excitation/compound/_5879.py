...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5749
...
class BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation(_5875.BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation):
    """BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5749.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5749.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
