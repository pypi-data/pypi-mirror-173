...
class ConnectorCompoundHarmonicAnalysisOfSingleExcitation(_5730.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''ConnectorCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5559.ConnectorHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5559.ConnectorHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5559.ConnectorHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5559.ConnectorHarmonicAnalysisOfSingleExcitation))
        return value
