...
class CVTPulleyCompoundHarmonicAnalysisOfSingleExcitation(_5594.PulleyCompoundHarmonicAnalysisOfSingleExcitation):
    '''CVTPulleyCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5418.CVTPulleyHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5418.CVTPulleyHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5418.CVTPulleyHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5418.CVTPulleyHarmonicAnalysisOfSingleExcitation))
        return value
