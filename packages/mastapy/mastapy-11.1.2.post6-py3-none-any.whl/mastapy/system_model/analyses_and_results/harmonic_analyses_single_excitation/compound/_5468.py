...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _5491
...
class AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation(_5491.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''AbstractShaftOrHousingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5338.AbstractShaftOrHousingHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5338.AbstractShaftOrHousingHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5338.AbstractShaftOrHousingHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5338.AbstractShaftOrHousingHarmonicAnalysisOfSingleExcitation))
        return value
