...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5600
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _5775
...
class MeasurementComponentCompoundHarmonicAnalysisOfSingleExcitation(_5775.VirtualComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''MeasurementComponentCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5600.MeasurementComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5600.MeasurementComponentHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5600.MeasurementComponentHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5600.MeasurementComponentHarmonicAnalysisOfSingleExcitation))
        return value
