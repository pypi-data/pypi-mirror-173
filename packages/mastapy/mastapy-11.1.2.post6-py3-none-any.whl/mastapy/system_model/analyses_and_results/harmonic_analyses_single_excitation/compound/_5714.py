...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5584
...
class GuideDxfModelCompoundHarmonicAnalysisOfSingleExcitation(_5678.ComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''GuideDxfModelCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5584.GuideDxfModelHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5584.GuideDxfModelHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5584.GuideDxfModelHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5584.GuideDxfModelHarmonicAnalysisOfSingleExcitation))
        return value
