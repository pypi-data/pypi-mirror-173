...
class BearingCompoundHarmonicAnalysisOfSingleExcitation(_5502.ConnectorCompoundHarmonicAnalysisOfSingleExcitation):
    '''BearingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5344.BearingHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5344.BearingHarmonicAnalysisOfSingleExcitation))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5344.BearingHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5344.BearingHarmonicAnalysisOfSingleExcitation))
        return value
