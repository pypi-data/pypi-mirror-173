...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5794
...
class GearSetCompoundHarmonicAnalysisOfSingleExcitation(_5962.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    """GearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5794.GearSetHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5794.GearSetHarmonicAnalysisOfSingleExcitation]':
