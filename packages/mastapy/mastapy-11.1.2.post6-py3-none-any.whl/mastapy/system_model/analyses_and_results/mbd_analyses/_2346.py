...
class MultibodyDynamicsAnalysis(_7235.TimeSeriesLoadAnalysisCase):
    '''MultibodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5154.MBDAnalysisOptions':
        ...
        return constructor.new(_5154.MBDAnalysisOptions)(self.wrapped.MBDOptions) if self.wrapped.MBDOptions else None
