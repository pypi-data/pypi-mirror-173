...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2499, _5230
...
class RootAssemblyMultibodyDynamicsAnalysis(_5230.AssemblyMultibodyDynamicsAnalysis):
    '''RootAssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis_inputs(self) -> '_2499.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2499.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysisInputs) if self.wrapped.MultibodyDynamicsAnalysisInputs is not None else None
