...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2499
from mastapy.math_utility.convergence import _1474, _1473
from mastapy.utility_gui import _1735
from mastapy.system_model.analyses_and_results.analysis_cases import _7373
...
class ConnectionMultibodyDynamicsAnalysis(_7373.ConnectionTimeSeriesLoadAnalysisCase):
    '''ConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis(self) -> '_2499.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2499.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysis) if self.wrapped.MultibodyDynamicsAnalysis is not None else None

    @property
    def data_logger(self) -> '_1474.DataLogger':
        ...
        if _1474.DataLogger.TYPE not in self.wrapped.DataLogger.__class__.__mro__:
