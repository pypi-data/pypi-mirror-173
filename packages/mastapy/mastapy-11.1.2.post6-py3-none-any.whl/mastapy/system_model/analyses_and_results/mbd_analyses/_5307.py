...
from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _5373
from mastapy.system_model.analyses_and_results.modal_analyses import _4999
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_5229.AnalysisTypes':
        '''AnalysisTypes: 'AnalysisType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.AnalysisType)
        return constructor.new(_5229.AnalysisTypes)(value) if value is not None else None

    @analysis_type.setter
    def analysis_type(self, value: '_5229.AnalysisTypes'):
    ...
    @property
    def method_to_define_period(self) -> '_5291.InertiaAdjustedLoadCasePeriodMethod':
        ...
        return constructor.new(_5291.InertiaAdjustedLoadCasePeriodMethod)(value) if value is not None else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_5291.InertiaAdjustedLoadCasePeriodMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_load_cases_to_create(self) -> '_5292.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        return constructor.new(_5292.InertiaAdjustedLoadCaseResultsToCreate)(value) if value is not None else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_5292.InertiaAdjustedLoadCaseResultsToCreate'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_interface_options(self) -> '_5373.DynamicExternalInterfaceOptions':
        ...
        return constructor.new(_5373.DynamicExternalInterfaceOptions)(self.wrapped.ExternalInterfaceOptions) if self.wrapped.ExternalInterfaceOptions is not None else None

    @property
    def run_up_analysis_options(self) -> '_5308.MBDRunUpAnalysisOptions':
        ...
        return constructor.new(_5308.MBDRunUpAnalysisOptions)(self.wrapped.RunUpAnalysisOptions) if self.wrapped.RunUpAnalysisOptions is not None else None

    @property
    def frequency_response_options(self) -> '_4999.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4999.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptions) if self.wrapped.FrequencyResponseOptions is not None else None
