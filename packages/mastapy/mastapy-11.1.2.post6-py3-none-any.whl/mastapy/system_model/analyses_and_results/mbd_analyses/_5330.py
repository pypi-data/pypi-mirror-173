...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5370, _5372
...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5261.ConnectorMultibodyDynamicsAnalysis):
    '''ShaftHubConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5370.DynamicForceVector3DResult':
        ...
        return constructor.new(_5370.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce is not None else None

    @property
    def peak_dynamic_force_angular(self) -> '_5372.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5372.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular is not None else None
