...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5134, _5147
...
class BeltDriveMultibodyDynamicsAnalysis(_5147.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''BeltDriveMultibodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5134.PulleyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_5134.PulleyMultibodyDynamicsAnalysis))
        return value
