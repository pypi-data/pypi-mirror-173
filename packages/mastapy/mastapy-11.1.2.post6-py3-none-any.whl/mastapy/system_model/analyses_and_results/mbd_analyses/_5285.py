...
class GearMultibodyDynamicsAnalysis(_5310.MountableComponentMultibodyDynamicsAnalysis):
    '''GearMultibodyDynamicsAnalysis
    ...
    @property
    def peak_gear_torque(self) -> 'List[_5371.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakGearTorque, constructor.new(_5371.DynamicTorqueResultAtTime))
        return value
