...
class BoltedJointCompoundMultibodyDynamicsAnalysis(_5285.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    '''BoltedJointCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5056.BoltedJointMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5056.BoltedJointMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5056.BoltedJointMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5056.BoltedJointMultibodyDynamicsAnalysis))
        return value
