...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5251
...
class ConceptCouplingConnectionCompoundMultibodyDynamicsAnalysis(_5412.CouplingConnectionCompoundMultibodyDynamicsAnalysis):
    '''ConceptCouplingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5251.ConceptCouplingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5251.ConceptCouplingConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5251.ConceptCouplingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5251.ConceptCouplingConnectionMultibodyDynamicsAnalysis))
        return value
