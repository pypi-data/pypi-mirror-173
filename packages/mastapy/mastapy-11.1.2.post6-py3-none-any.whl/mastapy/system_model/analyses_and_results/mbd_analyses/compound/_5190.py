...
class AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(_5222.ConnectionCompoundMultibodyDynamicsAnalysis):
    '''AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5038.AbstractShaftToMountableComponentConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5038.AbstractShaftToMountableComponentConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5038.AbstractShaftToMountableComponentConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5038.AbstractShaftToMountableComponentConnectionMultibodyDynamicsAnalysis))
        return value
