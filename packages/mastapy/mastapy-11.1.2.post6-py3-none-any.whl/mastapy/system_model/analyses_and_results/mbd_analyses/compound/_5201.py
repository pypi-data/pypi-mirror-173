...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5198
...
class BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis(_5198.BevelDifferentialGearCompoundMultibodyDynamicsAnalysis):
    '''BevelDifferentialPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5051.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5051.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5051.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5051.BevelDifferentialPlanetGearMultibodyDynamicsAnalysis))
        return value
