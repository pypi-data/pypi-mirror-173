...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5289
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5378
...
class HypoidGearCompoundMultibodyDynamicsAnalysis(_5378.AGMAGleasonConicalGearCompoundMultibodyDynamicsAnalysis):
    '''HypoidGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5289.HypoidGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5289.HypoidGearMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5289.HypoidGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5289.HypoidGearMultibodyDynamicsAnalysis))
        return value
