...
class ShaftHubConnectionCompoundMultibodyDynamicsAnalysis(_5410.ConnectorCompoundMultibodyDynamicsAnalysis):
    '''ShaftHubConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5330.ShaftHubConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5330.ShaftHubConnectionMultibodyDynamicsAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5330.ShaftHubConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5330.ShaftHubConnectionMultibodyDynamicsAnalysis))
        return value
