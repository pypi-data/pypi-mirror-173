...
class SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis(_5263.AbstractAssemblyCompoundMultibodyDynamicsAnalysis):
    """SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5223.SpecialisedAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5223.SpecialisedAssemblyMultibodyDynamicsAnalysis]':
