...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5270
...
class CycloidalDiscCompoundMultibodyDynamicsAnalysis(_5375.AbstractShaftCompoundMultibodyDynamicsAnalysis):
    '''CycloidalDiscCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5270.CycloidalDiscMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5270.CycloidalDiscMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5270.CycloidalDiscMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5270.CycloidalDiscMultibodyDynamicsAnalysis))
        return value
