...
class StraightBevelSunGearCompoundMultibodyDynamicsAnalysis(_5368.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis):
    """StraightBevelSunGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5237.StraightBevelSunGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5237.StraightBevelSunGearMultibodyDynamicsAnalysis]':
