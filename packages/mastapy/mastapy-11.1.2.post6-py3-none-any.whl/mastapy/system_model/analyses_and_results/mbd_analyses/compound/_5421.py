...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5273
...
class CylindricalGearCompoundMultibodyDynamicsAnalysis(_5432.GearCompoundMultibodyDynamicsAnalysis):
    '''CylindricalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5273.CylindricalGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5273.CylindricalGearMultibodyDynamicsAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5273.CylindricalGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5273.CylindricalGearMultibodyDynamicsAnalysis))
        return value
