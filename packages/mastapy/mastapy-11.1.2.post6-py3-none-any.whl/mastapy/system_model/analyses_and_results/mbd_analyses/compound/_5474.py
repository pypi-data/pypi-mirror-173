...
class SpiralBevelGearMeshCompoundMultibodyDynamicsAnalysis(_5391.BevelGearMeshCompoundMultibodyDynamicsAnalysis):
    '''SpiralBevelGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5335.SpiralBevelGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5335.SpiralBevelGearMeshMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5335.SpiralBevelGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5335.SpiralBevelGearMeshMultibodyDynamicsAnalysis))
        return value
