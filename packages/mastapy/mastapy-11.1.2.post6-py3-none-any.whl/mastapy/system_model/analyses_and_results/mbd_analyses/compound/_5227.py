...
class CVTBeltConnectionCompoundMultibodyDynamicsAnalysis(_5196.BeltConnectionCompoundMultibodyDynamicsAnalysis):
    '''CVTBeltConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5078.CVTBeltConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5078.CVTBeltConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5078.CVTBeltConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5078.CVTBeltConnectionMultibodyDynamicsAnalysis))
        return value
