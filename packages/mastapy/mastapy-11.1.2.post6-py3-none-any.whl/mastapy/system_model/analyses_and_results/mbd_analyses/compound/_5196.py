...
class BeltConnectionCompoundMultibodyDynamicsAnalysis(_5252.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    '''BeltConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5046.BeltConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5046.BeltConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5046.BeltConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5046.BeltConnectionMultibodyDynamicsAnalysis))
        return value
