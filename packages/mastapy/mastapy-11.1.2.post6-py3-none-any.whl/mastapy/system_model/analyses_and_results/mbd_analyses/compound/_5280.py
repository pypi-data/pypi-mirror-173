...
class BevelGearMeshCompoundMultibodyDynamicsAnalysis(_5268.AGMAGleasonConicalGearMeshCompoundMultibodyDynamicsAnalysis):
    """BevelGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5129.BevelGearMeshMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5129.BevelGearMeshMultibodyDynamicsAnalysis]':
