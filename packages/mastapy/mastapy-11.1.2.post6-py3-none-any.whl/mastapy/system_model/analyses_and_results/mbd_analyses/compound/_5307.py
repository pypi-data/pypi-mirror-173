...
class CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis(_5287.CoaxialConnectionCompoundMultibodyDynamicsAnalysis):
    """CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5158.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5158.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis]':
