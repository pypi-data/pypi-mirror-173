...
class GearSetCompoundMultibodyDynamicsAnalysis(_5285.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    '''GearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5099.GearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5099.GearSetMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5099.GearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5099.GearSetMultibodyDynamicsAnalysis))
        return value
