...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5247
...
class ConicalGearSetCompoundMultibodyDynamicsAnalysis(_5247.GearSetCompoundMultibodyDynamicsAnalysis):
    '''ConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5072.ConicalGearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5072.ConicalGearSetMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5072.ConicalGearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5072.ConicalGearSetMultibodyDynamicsAnalysis))
        return value
