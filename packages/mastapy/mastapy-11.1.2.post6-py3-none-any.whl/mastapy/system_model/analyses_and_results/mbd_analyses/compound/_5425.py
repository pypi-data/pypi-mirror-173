...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5276
...
class DatumCompoundMultibodyDynamicsAnalysis(_5399.ComponentCompoundMultibodyDynamicsAnalysis):
    '''DatumCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5276.DatumMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5276.DatumMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5276.DatumMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5276.DatumMultibodyDynamicsAnalysis))
        return value
