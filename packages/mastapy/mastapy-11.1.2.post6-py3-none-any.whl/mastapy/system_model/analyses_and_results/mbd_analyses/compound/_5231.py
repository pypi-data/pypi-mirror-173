...
class CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis(_5211.CoaxialConnectionCompoundMultibodyDynamicsAnalysis):
    '''CycloidalDiscCentralBearingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5082.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5082.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5082.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5082.CycloidalDiscCentralBearingConnectionMultibodyDynamicsAnalysis))
        return value
