...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5260
...
class ConnectionCompoundMultibodyDynamicsAnalysis(_7370.ConnectionCompoundAnalysis):
    '''ConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5260.ConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5260.ConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5260.ConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5260.ConnectionMultibodyDynamicsAnalysis))
        return value
