...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5361
...
class BeltDriveCompoundMultibodyDynamicsAnalysis(_5361.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """BeltDriveCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5123.BeltDriveMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5123.BeltDriveMultibodyDynamicsAnalysis]':
