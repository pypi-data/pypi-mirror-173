...
class InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(_5222.ConnectionCompoundMultibodyDynamicsAnalysis):
    '''InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5108.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5108.InterMountableComponentConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5108.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5108.InterMountableComponentConnectionMultibodyDynamicsAnalysis))
        return value
