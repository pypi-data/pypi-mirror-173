...
class StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis(_5479.StraightBevelDiffGearCompoundMultibodyDynamicsAnalysis):
    '''StraightBevelPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5347.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5347.StraightBevelPlanetGearMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5347.StraightBevelPlanetGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5347.StraightBevelPlanetGearMultibodyDynamicsAnalysis))
        return value
