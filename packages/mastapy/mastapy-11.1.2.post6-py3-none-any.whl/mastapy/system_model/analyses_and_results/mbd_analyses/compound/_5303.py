...
class CVTBeltConnectionCompoundMultibodyDynamicsAnalysis(_5272.BeltConnectionCompoundMultibodyDynamicsAnalysis):
    """CVTBeltConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5154.CVTBeltConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5154.CVTBeltConnectionMultibodyDynamicsAnalysis]':
