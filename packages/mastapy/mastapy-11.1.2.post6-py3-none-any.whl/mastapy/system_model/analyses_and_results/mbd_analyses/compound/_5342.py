...
class PartCompoundMultibodyDynamicsAnalysis(_7272.PartCompoundAnalysis):
    """PartCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5201.PartMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5201.PartMultibodyDynamicsAnalysis]':
