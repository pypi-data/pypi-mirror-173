...
class KlingelnbergCycloPalloidConicalGearSetCompoundMultibodyDynamicsAnalysis(_5221.ConicalGearSetCompoundMultibodyDynamicsAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5111.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5111.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5111.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5111.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis))
        return value
