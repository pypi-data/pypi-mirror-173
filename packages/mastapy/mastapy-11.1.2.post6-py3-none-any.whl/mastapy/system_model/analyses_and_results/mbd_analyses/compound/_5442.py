...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5298
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5408
...
class KlingelnbergCycloPalloidConicalGearSetCompoundMultibodyDynamicsAnalysis(_5408.ConicalGearSetCompoundMultibodyDynamicsAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5298.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5298.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5298.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5298.KlingelnbergCycloPalloidConicalGearSetMultibodyDynamicsAnalysis))
        return value
