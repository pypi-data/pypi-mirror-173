...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5374
...
class SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis(_5374.AbstractAssemblyCompoundMultibodyDynamicsAnalysis):
    '''SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5334.SpecialisedAssemblyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5334.SpecialisedAssemblyMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5334.SpecialisedAssemblyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5334.SpecialisedAssemblyMultibodyDynamicsAnalysis))
        return value
