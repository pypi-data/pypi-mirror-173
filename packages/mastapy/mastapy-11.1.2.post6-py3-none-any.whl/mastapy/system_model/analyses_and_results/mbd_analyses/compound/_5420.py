...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5271
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5377
...
class CycloidalDiscPlanetaryBearingConnectionCompoundMultibodyDynamicsAnalysis(_5377.AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5271.CycloidalDiscPlanetaryBearingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5271.CycloidalDiscPlanetaryBearingConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5271.CycloidalDiscPlanetaryBearingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5271.CycloidalDiscPlanetaryBearingConnectionMultibodyDynamicsAnalysis))
        return value
