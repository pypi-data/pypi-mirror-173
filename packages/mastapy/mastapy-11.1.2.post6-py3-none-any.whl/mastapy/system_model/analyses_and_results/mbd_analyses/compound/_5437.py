...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5288
...
class HypoidGearMeshCompoundMultibodyDynamicsAnalysis(_5379.AGMAGleasonConicalGearMeshCompoundMultibodyDynamicsAnalysis):
    '''HypoidGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5288.HypoidGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5288.HypoidGearMeshMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5288.HypoidGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5288.HypoidGearMeshMultibodyDynamicsAnalysis))
        return value
