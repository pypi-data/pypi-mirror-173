...
class AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis(_5297.ConicalGearSetCompoundMultibodyDynamicsAnalysis):
    """AGMAGleasonConicalGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5117.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5117.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis]':
