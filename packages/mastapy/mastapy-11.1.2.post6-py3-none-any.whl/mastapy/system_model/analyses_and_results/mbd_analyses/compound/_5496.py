...
class VirtualComponentCompoundMultibodyDynamicsAnalysis(_5451.MountableComponentCompoundMultibodyDynamicsAnalysis):
    '''VirtualComponentCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5360.VirtualComponentMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5360.VirtualComponentMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5360.VirtualComponentMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5360.VirtualComponentMultibodyDynamicsAnalysis))
        return value
