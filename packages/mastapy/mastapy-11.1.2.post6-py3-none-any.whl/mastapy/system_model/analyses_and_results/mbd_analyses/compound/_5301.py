...
class CouplingConnectionCompoundMultibodyDynamicsAnalysis(_5328.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """CouplingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5151.CouplingConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5151.CouplingConnectionMultibodyDynamicsAnalysis]':
