...
class MassDiscCompoundMultibodyDynamicsAnalysis(_5309.VirtualComponentCompoundMultibodyDynamicsAnalysis):
    '''MassDiscCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5118.MassDiscMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5118.MassDiscMultibodyDynamicsAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5118.MassDiscMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5118.MassDiscMultibodyDynamicsAnalysis))
        return value
