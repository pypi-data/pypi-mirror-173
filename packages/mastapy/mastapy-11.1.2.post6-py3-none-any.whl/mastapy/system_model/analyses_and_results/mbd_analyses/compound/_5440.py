...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5406
...
class KlingelnbergCycloPalloidConicalGearCompoundMultibodyDynamicsAnalysis(_5406.ConicalGearCompoundMultibodyDynamicsAnalysis):
    '''KlingelnbergCycloPalloidConicalGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5297.KlingelnbergCycloPalloidConicalGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5297.KlingelnbergCycloPalloidConicalGearMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5297.KlingelnbergCycloPalloidConicalGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5297.KlingelnbergCycloPalloidConicalGearMultibodyDynamicsAnalysis))
        return value
