...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5381
...
class RootAssemblyCompoundMultibodyDynamicsAnalysis(_5381.AssemblyCompoundMultibodyDynamicsAnalysis):
    '''RootAssemblyCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5327.RootAssemblyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5327.RootAssemblyMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5327.RootAssemblyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5327.RootAssemblyMultibodyDynamicsAnalysis))
        return value
