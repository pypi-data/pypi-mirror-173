...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5386, _5387, _5323
...
class WormGearSetCompoundMultibodyDynamicsAnalysis(_5323.GearSetCompoundMultibodyDynamicsAnalysis):
    """WormGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5253.WormGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gears_compound_multibody_dynamics_analysis(self) -> 'List[_5386.WormGearCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_meshes_compound_multibody_dynamics_analysis(self) -> 'List[_5387.WormGearMeshCompoundMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5253.WormGearSetMultibodyDynamicsAnalysis]':
