...
class AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis(_5212.ComponentCompoundMultibodyDynamicsAnalysis):
    '''AbstractShaftOrHousingCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5037.AbstractShaftOrHousingMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5037.AbstractShaftOrHousingMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5037.AbstractShaftOrHousingMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5037.AbstractShaftOrHousingMultibodyDynamicsAnalysis))
        return value
