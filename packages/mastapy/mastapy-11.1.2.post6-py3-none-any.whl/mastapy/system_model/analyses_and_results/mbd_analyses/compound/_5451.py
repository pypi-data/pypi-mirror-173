...
class MountableComponentCompoundMultibodyDynamicsAnalysis(_5399.ComponentCompoundMultibodyDynamicsAnalysis):
    '''MountableComponentCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5310.MountableComponentMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5310.MountableComponentMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5310.MountableComponentMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5310.MountableComponentMultibodyDynamicsAnalysis))
        return value
