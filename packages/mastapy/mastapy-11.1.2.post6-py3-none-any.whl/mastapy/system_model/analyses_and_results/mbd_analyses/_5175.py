...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5174, _5172, _5223
...
class GearSetMultibodyDynamicsAnalysis(_5223.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    """GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5174.GearMultibodyDynamicsAnalysis]':
    ...
    @property
    def meshes(self) -> 'List[_5172.GearMeshMultibodyDynamicsAnalysis]':
