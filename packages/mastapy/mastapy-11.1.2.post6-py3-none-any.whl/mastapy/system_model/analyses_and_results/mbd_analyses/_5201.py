...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2388
from mastapy.math_utility.convergence import _1380, _1379
from mastapy.utility_gui import _1624
from mastapy.system_model.drawing import _2000
from mastapy.system_model.analyses_and_results.analysis_cases import _7275
...
class PartMultibodyDynamicsAnalysis(_7275.PartTimeSeriesLoadAnalysisCase):
    """PartMultibodyDynamicsAnalysis
    ...
    @property
    def data_logger(self) -> '_1380.DataLogger':
        ...
        if _1380.DataLogger.TYPE not in temp.__class__.__mro__:
            raise CastException('Failed to cast data_logger to DataLogger. Expected: {}.'.format(temp.__class__.__qualname__))

        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)(temp) if temp is not None else None

    def create_viewable(self) -> '_2000.MBDAnalysisViewable':
