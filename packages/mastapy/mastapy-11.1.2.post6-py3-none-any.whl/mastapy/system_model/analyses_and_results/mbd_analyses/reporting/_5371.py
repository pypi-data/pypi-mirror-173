...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5368
...
class DynamicTorqueResultAtTime(_5368.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
