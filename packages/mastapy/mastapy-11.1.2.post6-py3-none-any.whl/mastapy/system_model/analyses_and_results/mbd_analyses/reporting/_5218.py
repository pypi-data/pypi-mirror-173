...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5215
...
class DynamicTorqueResultAtTime(_5215.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
