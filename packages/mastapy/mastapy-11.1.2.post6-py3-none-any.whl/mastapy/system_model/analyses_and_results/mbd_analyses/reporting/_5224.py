...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5221
...
class DynamicTorqueResultAtTime(_5221.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
