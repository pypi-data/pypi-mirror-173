...
class DynamicForceVector3DResult(_0.APIBase):
    ...
    @property
    def x(self) -> '_5182.DynamicForceResultAtTime':
        ...
        return constructor.new(_5182.DynamicForceResultAtTime)(self.wrapped.X) if self.wrapped.X else None

    @property
    def y(self) -> '_5182.DynamicForceResultAtTime':
        ...
        return constructor.new(_5182.DynamicForceResultAtTime)(self.wrapped.Y) if self.wrapped.Y else None

    @property
    def z(self) -> '_5182.DynamicForceResultAtTime':
        ...
        return constructor.new(_5182.DynamicForceResultAtTime)(self.wrapped.Z) if self.wrapped.Z else None

    @property
    def magnitude(self) -> '_5182.DynamicForceResultAtTime':
        ...
        return constructor.new(_5182.DynamicForceResultAtTime)(self.wrapped.Magnitude) if self.wrapped.Magnitude else None

    @property
    def magnitude_xy(self) -> '_5182.DynamicForceResultAtTime':
        ...
        return constructor.new(_5182.DynamicForceResultAtTime)(self.wrapped.MagnitudeXY) if self.wrapped.MagnitudeXY else None
