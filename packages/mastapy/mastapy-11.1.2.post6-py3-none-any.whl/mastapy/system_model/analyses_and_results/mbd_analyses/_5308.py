...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5294, _5333, _5328
from mastapy._internal.implicit import list_with_selected_item
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.system_model.analyses_and_results.analysis_cases import _7367
...
class MBDRunUpAnalysisOptions(_7367.AbstractAnalysisOptions['_6640.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5294.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5294.InputVelocityForRunUpProcessingType)(value) if value is not None else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5294.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5333.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5333.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value is not None else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5333.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5328.RunUpDrivingMode':
        ...
        return constructor.new(_5328.RunUpDrivingMode)(value) if value is not None else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5328.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
