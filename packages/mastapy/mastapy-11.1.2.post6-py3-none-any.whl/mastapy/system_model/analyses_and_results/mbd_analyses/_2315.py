...
from mastapy.system_model.analyses_and_results.analysis_cases import _7196
...
class MultibodyDynamicsAnalysis(_7196.TimeSeriesLoadAnalysisCase):
    '''MultibodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5120.MBDAnalysisOptions':
        ...
        return constructor.new(_5120.MBDAnalysisOptions)(self.wrapped.MBDOptions) if self.wrapped.MBDOptions else None

    @property
    def transient_solver(self) -> '_111.TransientSolver':
        ...
        if _111.TransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_backward_euler_acceleration_step_halving_transient_solver(self) -> '_93.BackwardEulerAccelerationStepHalvingTransientSolver':
        ...
        if _93.BackwardEulerAccelerationStepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_backward_euler_transient_solver(self) -> '_94.BackwardEulerTransientSolver':
        ...
        if _94.BackwardEulerTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_internal_transient_solver(self) -> '_97.InternalTransientSolver':
        ...
        if _97.InternalTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_lobatto_iiia_transient_solver(self) -> '_98.LobattoIIIATransientSolver':
        ...
        if _98.LobattoIIIATransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_lobatto_iiic_transient_solver(self) -> '_99.LobattoIIICTransientSolver':
        ...
        if _99.LobattoIIICTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_newmark_acceleration_transient_solver(self) -> '_100.NewmarkAccelerationTransientSolver':
        ...
        if _100.NewmarkAccelerationTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_newmark_transient_solver(self) -> '_101.NewmarkTransientSolver':
        ...
        if _101.NewmarkTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_semi_implicit_transient_solver(self) -> '_102.SemiImplicitTransientSolver':
        ...
        if _102.SemiImplicitTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_simple_acceleration_based_step_halving_transient_solver(self) -> '_103.SimpleAccelerationBasedStepHalvingTransientSolver':
        ...
        if _103.SimpleAccelerationBasedStepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_simple_velocity_based_step_halving_transient_solver(self) -> '_104.SimpleVelocityBasedStepHalvingTransientSolver':
        ...
        if _104.SimpleVelocityBasedStepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_step_halving_transient_solver(self) -> '_109.StepHalvingTransientSolver':
        ...
        if _109.StepHalvingTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
    ...
    @property
    def transient_solver_of_type_wilson_theta_transient_solver(self) -> '_112.WilsonThetaTransientSolver':
        ...
        if _112.WilsonThetaTransientSolver.TYPE not in self.wrapped.TransientSolver.__class__.__mro__:
