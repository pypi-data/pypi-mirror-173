...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5293
...
class DynamicExternalInterfaceOptions(_0.APIBase):
    ...
    @property
    def input_signal_filter_level(self) -> '_5293.InputSignalFilterLevel':
        ...
        return constructor.new(_5293.InputSignalFilterLevel)(value) if value is not None else None

    @input_signal_filter_level.setter
    def input_signal_filter_level(self, value: '_5293.InputSignalFilterLevel'):
