...
class DynamicExternalInterfaceOptions(_0.APIBase):
    ...
    @property
    def input_signal_filter_level(self) -> '_5106.InputSignalFilterLevel':
        ...
        return constructor.new(_5106.InputSignalFilterLevel)(value) if value else None

    @input_signal_filter_level.setter
    def input_signal_filter_level(self, value: '_5106.InputSignalFilterLevel'):
