...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5357, _5262
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5262.CouplingConnectionMultibodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5357.TorqueConverterStatus':
        ...
        return constructor.new(_5357.TorqueConverterStatus)(value) if value is not None else None
