...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5098, _5096, _5147
...
class GearSetMultibodyDynamicsAnalysis(_5147.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5098.GearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5098.GearMultibodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5096.GearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5096.GearMeshMultibodyDynamicsAnalysis))
        return value
