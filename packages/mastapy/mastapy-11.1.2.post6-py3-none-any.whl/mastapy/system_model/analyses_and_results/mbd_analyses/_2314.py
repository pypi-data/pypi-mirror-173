...
from mastapy.system_model.analyses_and_results.analysis_cases import _7199
...
class MultibodyDynamicsAnalysis(_7199.TimeSeriesLoadAnalysisCase):
    '''MultibodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5119.MBDAnalysisOptions':
        ...
        return constructor.new(_5119.MBDAnalysisOptions)(self.wrapped.MBDOptions) if self.wrapped.MBDOptions else None
