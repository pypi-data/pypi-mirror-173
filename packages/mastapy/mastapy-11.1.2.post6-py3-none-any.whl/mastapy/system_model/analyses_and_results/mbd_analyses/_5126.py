...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5125, _5124, _5131
...
class BevelDifferentialGearSetMultibodyDynamicsAnalysis(_5131.BevelGearSetMultibodyDynamicsAnalysis):
    """BevelDifferentialGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5125.BevelDifferentialGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gears_multibody_dynamics_analysis(self) -> 'List[_5125.BevelDifferentialGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_meshes_multibody_dynamics_analysis(self) -> 'List[_5124.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]':
