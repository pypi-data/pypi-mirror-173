...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5285, _5283, _5334
...
class GearSetMultibodyDynamicsAnalysis(_5334.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5285.GearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5285.GearMultibodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5283.GearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5283.GearMeshMultibodyDynamicsAnalysis))
        return value
