...
from mastapy.system_model.analyses_and_results.power_flows import _3906, _4002
...
class SynchroniserHalfPowerFlow(_4002.SynchroniserPartPowerFlow):
    '''SynchroniserHalfPowerFlow
    ...
    @property
    def clutch_connection(self) -> '_3906.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_3906.ClutchConnectionPowerFlow)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection is not None else None
