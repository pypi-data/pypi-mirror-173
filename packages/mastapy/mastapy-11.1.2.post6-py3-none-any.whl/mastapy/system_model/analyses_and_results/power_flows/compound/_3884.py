...
class FaceGearCompoundPowerFlow(_3889.GearCompoundPowerFlow):
    '''FaceGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3753.FaceGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3753.FaceGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3753.FaceGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3753.FaceGearPowerFlow))
        return value
