...
class ConceptGearCompoundPowerFlow(_3889.GearCompoundPowerFlow):
    '''ConceptGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3728.ConceptGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3728.ConceptGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3728.ConceptGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3728.ConceptGearPowerFlow))
        return value
