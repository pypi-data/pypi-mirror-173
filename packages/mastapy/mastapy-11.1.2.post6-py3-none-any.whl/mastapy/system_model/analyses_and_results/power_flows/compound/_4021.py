...
class SynchroniserHalfCompoundPowerFlow(_4022.SynchroniserPartCompoundPowerFlow):
    """SynchroniserHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3890.SynchroniserHalfPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3890.SynchroniserHalfPowerFlow]':
