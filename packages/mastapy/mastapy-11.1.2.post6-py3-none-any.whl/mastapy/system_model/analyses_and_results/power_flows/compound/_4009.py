...
class SpringDamperCompoundPowerFlow(_3944.CouplingCompoundPowerFlow):
    """SpringDamperCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3881.SpringDamperPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3881.SpringDamperPowerFlow]':
