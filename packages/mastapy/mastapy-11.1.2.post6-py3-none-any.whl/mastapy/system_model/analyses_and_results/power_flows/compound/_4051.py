...
from mastapy.system_model.analyses_and_results.power_flows import _3917
...
class ConicalGearMeshCompoundPowerFlow(_4077.GearMeshCompoundPowerFlow):
    '''ConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3917.ConicalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3917.ConicalGearMeshPowerFlow))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3917.ConicalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3917.ConicalGearMeshPowerFlow))
        return value
