...
class ShaftCompoundPowerFlow(_4019.AbstractShaftCompoundPowerFlow):
    '''ShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3984.ShaftPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3984.ShaftPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3984.ShaftPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3984.ShaftPowerFlow))
        return value
