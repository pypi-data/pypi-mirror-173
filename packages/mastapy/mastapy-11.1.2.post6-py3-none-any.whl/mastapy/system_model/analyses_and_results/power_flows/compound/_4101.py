...
class PlanetaryConnectionCompoundPowerFlow(_4115.ShaftToMountableComponentConnectionCompoundPowerFlow):
    '''PlanetaryConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3969.PlanetaryConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3969.PlanetaryConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3969.PlanetaryConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3969.PlanetaryConnectionPowerFlow))
        return value
