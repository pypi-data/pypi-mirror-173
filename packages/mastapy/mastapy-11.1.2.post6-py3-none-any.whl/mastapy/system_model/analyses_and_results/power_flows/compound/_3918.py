...
class BevelDifferentialGearCompoundPowerFlow(_3923.BevelGearCompoundPowerFlow):
    """BevelDifferentialGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3786.BevelDifferentialGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3786.BevelDifferentialGearPowerFlow]':
