...
class TorqueConverterCompoundPowerFlow(_3944.CouplingCompoundPowerFlow):
    """TorqueConverterCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3896.TorqueConverterPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3896.TorqueConverterPowerFlow]':
