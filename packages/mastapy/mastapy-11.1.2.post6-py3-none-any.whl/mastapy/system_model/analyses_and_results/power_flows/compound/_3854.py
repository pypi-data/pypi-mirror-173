...
class ClutchHalfCompoundPowerFlow(_3870.CouplingHalfCompoundPowerFlow):
    '''ClutchHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3720.ClutchHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3720.ClutchHalfPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3720.ClutchHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3720.ClutchHalfPowerFlow))
        return value
