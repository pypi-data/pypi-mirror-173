...
class CylindricalGearCompoundPowerFlow(_3889.GearCompoundPowerFlow):
    '''CylindricalGearCompoundPowerFlow
    ...
    @property
    def cylindrical_gear_duty_cycle_rating(self) -> '_414.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_414.CylindricalGearDutyCycleRating)(self.wrapped.CylindricalGearDutyCycleRating) if self.wrapped.CylindricalGearDutyCycleRating else None
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3747.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3747.CylindricalGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3747.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3747.CylindricalGearPowerFlow))
        return value
