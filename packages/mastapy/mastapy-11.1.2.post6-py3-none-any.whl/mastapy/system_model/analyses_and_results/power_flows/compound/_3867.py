...
class ConnectorCompoundPowerFlow(_3908.MountableComponentCompoundPowerFlow):
    '''ConnectorCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3734.ConnectorPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3734.ConnectorPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3734.ConnectorPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3734.ConnectorPowerFlow))
        return value
