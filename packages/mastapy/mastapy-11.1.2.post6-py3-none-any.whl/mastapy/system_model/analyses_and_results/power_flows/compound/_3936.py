...
class ConceptGearCompoundPowerFlow(_3965.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3804.ConceptGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3804.ConceptGearPowerFlow]':
