...
from mastapy.system_model.analyses_and_results.power_flows import _3907
...
class ClutchHalfCompoundPowerFlow(_4057.CouplingHalfCompoundPowerFlow):
    '''ClutchHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3907.ClutchHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3907.ClutchHalfPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3907.ClutchHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3907.ClutchHalfPowerFlow))
        return value
