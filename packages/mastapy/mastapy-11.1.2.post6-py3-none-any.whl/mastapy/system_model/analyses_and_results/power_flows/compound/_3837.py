...
class AGMAGleasonConicalGearSetCompoundPowerFlow(_3865.ConicalGearSetCompoundPowerFlow):
    '''AGMAGleasonConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3704.AGMAGleasonConicalGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3704.AGMAGleasonConicalGearSetPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3704.AGMAGleasonConicalGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3704.AGMAGleasonConicalGearSetPowerFlow))
        return value
