...
from mastapy.system_model.analyses_and_results.power_flows import _3920
...
class ConnectionCompoundPowerFlow(_7370.ConnectionCompoundAnalysis):
    '''ConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3920.ConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3920.ConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3920.ConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3920.ConnectionPowerFlow))
        return value
