...
class ConceptCouplingHalfCompoundPowerFlow(_3870.CouplingHalfCompoundPowerFlow):
    '''ConceptCouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3725.ConceptCouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3725.ConceptCouplingHalfPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3725.ConceptCouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3725.ConceptCouplingHalfPowerFlow))
        return value
