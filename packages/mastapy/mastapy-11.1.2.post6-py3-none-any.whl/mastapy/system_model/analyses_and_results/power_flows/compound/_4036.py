...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4024
...
class BevelGearSetCompoundPowerFlow(_4024.AGMAGleasonConicalGearSetCompoundPowerFlow):
    '''BevelGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3903.BevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3903.BevelGearSetPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3903.BevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3903.BevelGearSetPowerFlow))
        return value
