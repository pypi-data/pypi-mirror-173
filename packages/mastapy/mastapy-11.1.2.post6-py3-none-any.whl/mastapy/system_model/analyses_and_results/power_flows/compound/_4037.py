...
class BoltCompoundPowerFlow(_4043.ComponentCompoundPowerFlow):
    '''BoltCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3905.BoltPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3905.BoltPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3905.BoltPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3905.BoltPowerFlow))
        return value
