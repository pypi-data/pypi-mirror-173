...
class AbstractShaftOrHousingCompoundPowerFlow(_3856.ComponentCompoundPowerFlow):
    '''AbstractShaftOrHousingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3699.AbstractShaftOrHousingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3699.AbstractShaftOrHousingPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3699.AbstractShaftOrHousingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3699.AbstractShaftOrHousingPowerFlow))
        return value
