...
from mastapy.system_model.analyses_and_results.power_flows import _3914
...
class ConceptGearMeshCompoundPowerFlow(_4077.GearMeshCompoundPowerFlow):
    '''ConceptGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3914.ConceptGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3914.ConceptGearMeshPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3914.ConceptGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3914.ConceptGearMeshPowerFlow))
        return value
