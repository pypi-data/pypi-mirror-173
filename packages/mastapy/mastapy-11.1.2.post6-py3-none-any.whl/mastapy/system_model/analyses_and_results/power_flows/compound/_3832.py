...
class AbstractShaftCompoundPowerFlow(_3833.AbstractShaftOrHousingCompoundPowerFlow):
    '''AbstractShaftCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3700.AbstractShaftPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3700.AbstractShaftPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3700.AbstractShaftPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3700.AbstractShaftPowerFlow))
        return value
