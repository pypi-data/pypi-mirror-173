...
class PartToPartShearCouplingCompoundPowerFlow(_4055.CouplingCompoundPowerFlow):
    '''PartToPartShearCouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3968.PartToPartShearCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3968.PartToPartShearCouplingPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3968.PartToPartShearCouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3968.PartToPartShearCouplingPowerFlow))
        return value
