...
class KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow(_3865.ConicalGearSetCompoundPowerFlow):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3767.KlingelnbergCycloPalloidConicalGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3767.KlingelnbergCycloPalloidConicalGearSetPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3767.KlingelnbergCycloPalloidConicalGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3767.KlingelnbergCycloPalloidConicalGearSetPowerFlow))
        return value
