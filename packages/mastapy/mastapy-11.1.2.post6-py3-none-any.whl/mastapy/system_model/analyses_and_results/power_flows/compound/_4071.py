...
from mastapy.system_model.analyses_and_results.power_flows import _3940
...
class FaceGearCompoundPowerFlow(_4076.GearCompoundPowerFlow):
    '''FaceGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3940.FaceGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3940.FaceGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3940.FaceGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3940.FaceGearPowerFlow))
        return value
