...
class SynchroniserSleeveCompoundPowerFlow(_4133.SynchroniserPartCompoundPowerFlow):
    '''SynchroniserSleeveCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4004.SynchroniserSleevePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4004.SynchroniserSleevePowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4004.SynchroniserSleevePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4004.SynchroniserSleevePowerFlow))
        return value
