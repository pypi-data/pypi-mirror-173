...
class DatumCompoundPowerFlow(_3856.ComponentCompoundPowerFlow):
    '''DatumCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3750.DatumPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3750.DatumPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3750.DatumPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3750.DatumPowerFlow))
        return value
