...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4022
...
class HypoidGearCompoundPowerFlow(_4022.AGMAGleasonConicalGearCompoundPowerFlow):
    '''HypoidGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3949.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3949.HypoidGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3949.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3949.HypoidGearPowerFlow))
        return value
