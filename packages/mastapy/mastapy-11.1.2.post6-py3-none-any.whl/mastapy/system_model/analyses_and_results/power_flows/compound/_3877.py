...
class CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow(_3834.AbstractShaftToMountableComponentConnectionCompoundPowerFlow):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3743.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3743.CycloidalDiscPlanetaryBearingConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3743.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3743.CycloidalDiscPlanetaryBearingConnectionPowerFlow))
        return value
