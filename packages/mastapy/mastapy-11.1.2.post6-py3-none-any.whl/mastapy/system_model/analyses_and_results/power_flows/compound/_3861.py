...
class ConceptGearMeshCompoundPowerFlow(_3890.GearMeshCompoundPowerFlow):
    '''ConceptGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3727.ConceptGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3727.ConceptGearMeshPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3727.ConceptGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3727.ConceptGearMeshPowerFlow))
        return value
