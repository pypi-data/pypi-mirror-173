...
class StraightBevelDiffGearCompoundPowerFlow(_4034.BevelGearCompoundPowerFlow):
    '''StraightBevelDiffGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3994.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3994.StraightBevelDiffGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3994.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3994.StraightBevelDiffGearPowerFlow))
        return value
