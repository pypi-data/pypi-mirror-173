...
class RingPinsCompoundPowerFlow(_4095.MountableComponentCompoundPowerFlow):
    '''RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3977.RingPinsPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3977.RingPinsPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3977.RingPinsPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3977.RingPinsPowerFlow))
        return value
