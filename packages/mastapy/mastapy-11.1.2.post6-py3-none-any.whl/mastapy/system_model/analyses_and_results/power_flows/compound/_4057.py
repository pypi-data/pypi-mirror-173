...
class CouplingHalfCompoundPowerFlow(_4095.MountableComponentCompoundPowerFlow):
    '''CouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3923.CouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3923.CouplingHalfPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3923.CouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3923.CouplingHalfPowerFlow))
        return value
