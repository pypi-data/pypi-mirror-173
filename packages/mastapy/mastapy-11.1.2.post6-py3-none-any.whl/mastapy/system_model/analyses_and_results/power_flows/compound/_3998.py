...
class RollingRingAssemblyCompoundPowerFlow(_4005.SpecialisedAssemblyCompoundPowerFlow):
    """RollingRingAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3868.RollingRingAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3868.RollingRingAssemblyPowerFlow]':
