...
class InterMountableComponentConnectionCompoundPowerFlow(_3866.ConnectionCompoundPowerFlow):
    '''InterMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3764.InterMountableComponentConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3764.InterMountableComponentConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3764.InterMountableComponentConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3764.InterMountableComponentConnectionPowerFlow))
        return value
