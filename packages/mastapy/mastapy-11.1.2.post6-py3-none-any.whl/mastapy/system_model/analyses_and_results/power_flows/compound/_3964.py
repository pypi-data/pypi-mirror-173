...
class FlexiblePinAssemblyCompoundPowerFlow(_4005.SpecialisedAssemblyCompoundPowerFlow):
    """FlexiblePinAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3832.FlexiblePinAssemblyPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3832.FlexiblePinAssemblyPowerFlow]':
