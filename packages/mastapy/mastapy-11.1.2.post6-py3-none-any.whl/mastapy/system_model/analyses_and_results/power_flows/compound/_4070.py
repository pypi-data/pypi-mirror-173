...
from mastapy.system_model.analyses_and_results.power_flows import _3938
...
class ExternalCADModelCompoundPowerFlow(_4043.ComponentCompoundPowerFlow):
    '''ExternalCADModelCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3938.ExternalCADModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3938.ExternalCADModelPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3938.ExternalCADModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3938.ExternalCADModelPowerFlow))
        return value
