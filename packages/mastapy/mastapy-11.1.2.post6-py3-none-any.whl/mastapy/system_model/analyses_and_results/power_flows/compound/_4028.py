...
class UnbalancedMassCompoundPowerFlow(_4029.VirtualComponentCompoundPowerFlow):
    """UnbalancedMassCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3899.UnbalancedMassPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3899.UnbalancedMassPowerFlow]':
