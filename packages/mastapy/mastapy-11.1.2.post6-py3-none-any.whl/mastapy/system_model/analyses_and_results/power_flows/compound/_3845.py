...
class BevelDifferentialPlanetGearCompoundPowerFlow(_3842.BevelDifferentialGearCompoundPowerFlow):
    '''BevelDifferentialPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3712.BevelDifferentialPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3712.BevelDifferentialPlanetGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3712.BevelDifferentialPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3712.BevelDifferentialPlanetGearPowerFlow))
        return value
