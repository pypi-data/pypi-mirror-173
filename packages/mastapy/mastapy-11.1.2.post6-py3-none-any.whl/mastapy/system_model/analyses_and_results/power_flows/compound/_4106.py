...
class PulleyCompoundPowerFlow(_4057.CouplingHalfCompoundPowerFlow):
    '''PulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3976.PulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3976.PulleyPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3976.PulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3976.PulleyPowerFlow))
        return value
