...
class ShaftToMountableComponentConnectionCompoundPowerFlow(_4021.AbstractShaftToMountableComponentConnectionCompoundPowerFlow):
    '''ShaftToMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3985.ShaftToMountableComponentConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3985.ShaftToMountableComponentConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3985.ShaftToMountableComponentConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3985.ShaftToMountableComponentConnectionPowerFlow))
        return value
