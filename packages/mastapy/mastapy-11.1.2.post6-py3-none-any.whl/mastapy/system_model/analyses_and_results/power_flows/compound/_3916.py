...
class BeltConnectionCompoundPowerFlow(_3972.InterMountableComponentConnectionCompoundPowerFlow):
    """BeltConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3783.BeltConnectionPowerFlow]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3783.BeltConnectionPowerFlow]':
