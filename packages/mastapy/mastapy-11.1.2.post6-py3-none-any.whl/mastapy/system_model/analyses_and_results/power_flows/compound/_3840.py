...
class BeltConnectionCompoundPowerFlow(_3896.InterMountableComponentConnectionCompoundPowerFlow):
    '''BeltConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3707.BeltConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3707.BeltConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3707.BeltConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3707.BeltConnectionPowerFlow))
        return value
