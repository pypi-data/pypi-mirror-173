...
class OilSealCompoundPowerFlow(_4054.ConnectorCompoundPowerFlow):
    '''OilSealCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3964.OilSealPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3964.OilSealPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3964.OilSealPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3964.OilSealPowerFlow))
        return value
