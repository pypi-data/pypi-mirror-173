...
class SpringDamperHalfCompoundPowerFlow(_4057.CouplingHalfCompoundPowerFlow):
    '''SpringDamperHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3991.SpringDamperHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3991.SpringDamperHalfPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3991.SpringDamperHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3991.SpringDamperHalfPowerFlow))
        return value
