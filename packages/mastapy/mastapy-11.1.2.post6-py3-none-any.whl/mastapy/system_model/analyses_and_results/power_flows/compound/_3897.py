...
class KlingelnbergCycloPalloidConicalGearCompoundPowerFlow(_3863.ConicalGearCompoundPowerFlow):
    '''KlingelnbergCycloPalloidConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3766.KlingelnbergCycloPalloidConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3766.KlingelnbergCycloPalloidConicalGearPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3766.KlingelnbergCycloPalloidConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3766.KlingelnbergCycloPalloidConicalGearPowerFlow))
        return value
