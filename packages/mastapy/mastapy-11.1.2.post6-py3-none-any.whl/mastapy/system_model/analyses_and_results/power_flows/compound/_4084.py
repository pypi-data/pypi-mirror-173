...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4050
...
class KlingelnbergCycloPalloidConicalGearCompoundPowerFlow(_4050.ConicalGearCompoundPowerFlow):
    '''KlingelnbergCycloPalloidConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3953.KlingelnbergCycloPalloidConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3953.KlingelnbergCycloPalloidConicalGearPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3953.KlingelnbergCycloPalloidConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3953.KlingelnbergCycloPalloidConicalGearPowerFlow))
        return value
