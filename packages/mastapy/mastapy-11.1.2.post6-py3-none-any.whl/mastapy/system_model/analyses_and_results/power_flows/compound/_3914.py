...
from mastapy.system_model.analyses_and_results.power_flows.compound import (
    _3915, _3917, _3920, _3927,
    _3926, _3948, _3928, _3933,
    _3938, _3950, _3952, _3956,
    _3963, _3962, _3964, _3971,
    _3978, _3981, _3982, _3983,
    _3985, _3987, _3992, _3993,
    _3994, _3996, _3998, _4003,
    _4002, _4008, _4009, _4014,
    _4017, _4020, _4024, _4028,
    _4032, _4035, _3907
)
...
class AssemblyCompoundPowerFlow(_3907.AbstractAssemblyCompoundPowerFlow):
    """AssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3781.AssemblyPowerFlow]':
    ...
    @property
    def bearings(self) -> 'List[_3915.BearingCompoundPowerFlow]':
    ...
    @property
    def belt_drives(self) -> 'List[_3917.BeltDriveCompoundPowerFlow]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_3920.BevelDifferentialGearSetCompoundPowerFlow]':
    ...
    @property
    def bolted_joints(self) -> 'List[_3927.BoltedJointCompoundPowerFlow]':
    ...
    @property
    def bolts(self) -> 'List[_3926.BoltCompoundPowerFlow]':
    ...
    @property
    def cv_ts(self) -> 'List[_3948.CVTCompoundPowerFlow]':
    ...
    @property
    def clutches(self) -> 'List[_3928.ClutchCompoundPowerFlow]':
    ...
    @property
    def concept_couplings(self) -> 'List[_3933.ConceptCouplingCompoundPowerFlow]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_3938.ConceptGearSetCompoundPowerFlow]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_3950.CycloidalAssemblyCompoundPowerFlow]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_3952.CycloidalDiscCompoundPowerFlow]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_3956.CylindricalGearSetCompoundPowerFlow]':
    ...
    @property
    def fe_parts(self) -> 'List[_3963.FEPartCompoundPowerFlow]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_3962.FaceGearSetCompoundPowerFlow]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_3964.FlexiblePinAssemblyCompoundPowerFlow]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_3971.HypoidGearSetCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_3978.KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_3981.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def mass_discs(self) -> 'List[_3982.MassDiscCompoundPowerFlow]':
    ...
    @property
    def measurement_components(self) -> 'List[_3983.MeasurementComponentCompoundPowerFlow]':
    ...
    @property
    def oil_seals(self) -> 'List[_3985.OilSealCompoundPowerFlow]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_3987.PartToPartShearCouplingCompoundPowerFlow]':
    ...
    @property
    def planet_carriers(self) -> 'List[_3992.PlanetCarrierCompoundPowerFlow]':
    ...
    @property
    def point_loads(self) -> 'List[_3993.PointLoadCompoundPowerFlow]':
    ...
    @property
    def power_loads(self) -> 'List[_3994.PowerLoadCompoundPowerFlow]':
    ...
    @property
    def ring_pins(self) -> 'List[_3996.RingPinsCompoundPowerFlow]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_3998.RollingRingAssemblyCompoundPowerFlow]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4003.ShaftHubConnectionCompoundPowerFlow]':
    ...
    @property
    def shafts(self) -> 'List[_4002.ShaftCompoundPowerFlow]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4008.SpiralBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4009.SpringDamperCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4014.StraightBevelDiffGearSetCompoundPowerFlow]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4017.StraightBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def synchronisers(self) -> 'List[_4020.SynchroniserCompoundPowerFlow]':
    ...
    @property
    def torque_converters(self) -> 'List[_4024.TorqueConverterCompoundPowerFlow]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4028.UnbalancedMassCompoundPowerFlow]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4032.WormGearSetCompoundPowerFlow]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4035.ZerolBevelGearSetCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3781.AssemblyPowerFlow]':
