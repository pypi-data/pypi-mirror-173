...
class CycloidalAssemblyCompoundPowerFlow(_3929.SpecialisedAssemblyCompoundPowerFlow):
    '''CycloidalAssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3741.CycloidalAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3741.CycloidalAssemblyPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3741.CycloidalAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3741.CycloidalAssemblyPowerFlow))
        return value
