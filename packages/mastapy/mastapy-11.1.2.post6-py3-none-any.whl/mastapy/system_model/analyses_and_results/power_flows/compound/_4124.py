...
class StraightBevelDiffGearMeshCompoundPowerFlow(_4035.BevelGearMeshCompoundPowerFlow):
    '''StraightBevelDiffGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3993.StraightBevelDiffGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3993.StraightBevelDiffGearMeshPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3993.StraightBevelDiffGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3993.StraightBevelDiffGearMeshPowerFlow))
        return value
