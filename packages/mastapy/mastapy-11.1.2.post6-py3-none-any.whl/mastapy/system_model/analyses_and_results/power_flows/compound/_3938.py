...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3936, _3937, _3967
...
class ConceptGearSetCompoundPowerFlow(_3967.GearSetCompoundPowerFlow):
    """ConceptGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3805.ConceptGearSetPowerFlow]':
    ...
    @property
    def concept_gears_compound_power_flow(self) -> 'List[_3936.ConceptGearCompoundPowerFlow]':
    ...
    @property
    def concept_meshes_compound_power_flow(self) -> 'List[_3937.ConceptGearMeshCompoundPowerFlow]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3805.ConceptGearSetPowerFlow]':
