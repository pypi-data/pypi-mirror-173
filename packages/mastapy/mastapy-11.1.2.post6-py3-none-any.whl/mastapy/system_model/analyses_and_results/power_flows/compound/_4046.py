...
from mastapy.system_model.analyses_and_results.power_flows import _3912
...
class ConceptCouplingHalfCompoundPowerFlow(_4057.CouplingHalfCompoundPowerFlow):
    '''ConceptCouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3912.ConceptCouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3912.ConceptCouplingHalfPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3912.ConceptCouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3912.ConceptCouplingHalfPowerFlow))
        return value
