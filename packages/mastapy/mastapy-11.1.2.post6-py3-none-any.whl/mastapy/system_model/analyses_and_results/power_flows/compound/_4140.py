...
class VirtualComponentCompoundPowerFlow(_4095.MountableComponentCompoundPowerFlow):
    '''VirtualComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4011.VirtualComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4011.VirtualComponentPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4011.VirtualComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4011.VirtualComponentPowerFlow))
        return value
