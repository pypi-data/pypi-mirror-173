...
from mastapy.system_model.analyses_and_results.power_flows import _3908
...
class ClutchCompoundPowerFlow(_4055.CouplingCompoundPowerFlow):
    '''ClutchCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3908.ClutchPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3908.ClutchPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3908.ClutchPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3908.ClutchPowerFlow))
        return value
