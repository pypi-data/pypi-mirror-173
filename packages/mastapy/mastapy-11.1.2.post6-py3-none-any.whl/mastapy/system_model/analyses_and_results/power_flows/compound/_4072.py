...
class FaceGearMeshCompoundPowerFlow(_4077.GearMeshCompoundPowerFlow):
    '''FaceGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3939.FaceGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3939.FaceGearMeshPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3939.FaceGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3939.FaceGearMeshPowerFlow))
        return value
