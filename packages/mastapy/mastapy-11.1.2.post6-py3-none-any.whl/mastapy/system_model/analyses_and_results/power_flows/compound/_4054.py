...
from mastapy.system_model.analyses_and_results.power_flows import _3921
...
class ConnectorCompoundPowerFlow(_4095.MountableComponentCompoundPowerFlow):
    '''ConnectorCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3921.ConnectorPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3921.ConnectorPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3921.ConnectorPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3921.ConnectorPowerFlow))
        return value
