...
class KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow(_3864.ConicalGearMeshCompoundPowerFlow):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3765.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3765.KlingelnbergCycloPalloidConicalGearMeshPowerFlow))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3765.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3765.KlingelnbergCycloPalloidConicalGearMeshPowerFlow))
        return value
