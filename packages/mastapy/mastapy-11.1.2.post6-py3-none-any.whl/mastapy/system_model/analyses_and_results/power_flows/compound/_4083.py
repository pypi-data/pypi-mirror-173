...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4053
...
class InterMountableComponentConnectionCompoundPowerFlow(_4053.ConnectionCompoundPowerFlow):
    '''InterMountableComponentConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3951.InterMountableComponentConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3951.InterMountableComponentConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3951.InterMountableComponentConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3951.InterMountableComponentConnectionPowerFlow))
        return value
