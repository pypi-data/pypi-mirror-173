...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3855
...
class CycloidalDiscCentralBearingConnectionCompoundPowerFlow(_3855.CoaxialConnectionCompoundPowerFlow):
    '''CycloidalDiscCentralBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3742.CycloidalDiscCentralBearingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3742.CycloidalDiscCentralBearingConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3742.CycloidalDiscCentralBearingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3742.CycloidalDiscCentralBearingConnectionPowerFlow))
        return value
