...
class CycloidalDiscCompoundPowerFlow(_3832.AbstractShaftCompoundPowerFlow):
    '''CycloidalDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3744.CycloidalDiscPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3744.CycloidalDiscPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3744.CycloidalDiscPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3744.CycloidalDiscPowerFlow))
        return value
