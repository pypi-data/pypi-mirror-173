...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3841
...
class CVTCompoundPowerFlow(_3841.BeltDriveCompoundPowerFlow):
    '''CVTCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3739.CVTPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3739.CVTPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3739.CVTPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3739.CVTPowerFlow))
        return value
