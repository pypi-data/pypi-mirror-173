...
from mastapy.system_model.analyses_and_results.power_flows import _3934
...
class CylindricalGearCompoundPowerFlow(_4076.GearCompoundPowerFlow):
    '''CylindricalGearCompoundPowerFlow
    ...
    @property
    def cylindrical_gear_duty_cycle_rating(self) -> '_423.CylindricalGearDutyCycleRating':
        ...
        return constructor.new(_423.CylindricalGearDutyCycleRating)(self.wrapped.CylindricalGearDutyCycleRating) if self.wrapped.CylindricalGearDutyCycleRating is not None else None
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3934.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3934.CylindricalGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3934.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3934.CylindricalGearPowerFlow))
        return value
