...
class ComponentCompoundPowerFlow(_3910.PartCompoundPowerFlow):
    '''ComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3723.ComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3723.ComponentPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3723.ComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3723.ComponentPowerFlow))
        return value
