...
class CVTPulleyCompoundPowerFlow(_3919.PulleyCompoundPowerFlow):
    '''CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3740.CVTPulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3740.CVTPulleyPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3740.CVTPulleyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3740.CVTPulleyPowerFlow))
        return value
