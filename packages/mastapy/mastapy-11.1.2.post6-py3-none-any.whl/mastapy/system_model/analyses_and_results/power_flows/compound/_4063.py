...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4019
...
class CycloidalDiscCompoundPowerFlow(_4019.AbstractShaftCompoundPowerFlow):
    '''CycloidalDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3931.CycloidalDiscPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3931.CycloidalDiscPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3931.CycloidalDiscPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3931.CycloidalDiscPowerFlow))
        return value
