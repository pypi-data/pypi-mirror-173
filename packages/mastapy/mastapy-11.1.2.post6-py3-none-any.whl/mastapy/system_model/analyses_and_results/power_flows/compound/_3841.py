...
class BeltDriveCompoundPowerFlow(_3929.SpecialisedAssemblyCompoundPowerFlow):
    '''BeltDriveCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3708.BeltDrivePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3708.BeltDrivePowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3708.BeltDrivePowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3708.BeltDrivePowerFlow))
        return value
