...
class FEPartCompoundPowerFlow(_3833.AbstractShaftOrHousingCompoundPowerFlow):
    '''FEPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3755.FEPartPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3755.FEPartPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3755.FEPartPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3755.FEPartPowerFlow))
        return value
