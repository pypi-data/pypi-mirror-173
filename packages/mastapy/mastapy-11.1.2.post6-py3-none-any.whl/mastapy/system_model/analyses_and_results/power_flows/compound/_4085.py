...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4051
...
class KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow(_4051.ConicalGearMeshCompoundPowerFlow):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3952.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3952.KlingelnbergCycloPalloidConicalGearMeshPowerFlow))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3952.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3952.KlingelnbergCycloPalloidConicalGearMeshPowerFlow))
        return value
