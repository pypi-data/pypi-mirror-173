...
class CouplingCompoundPowerFlow(_3929.SpecialisedAssemblyCompoundPowerFlow):
    '''CouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3737.CouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3737.CouplingPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3737.CouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3737.CouplingPowerFlow))
        return value
