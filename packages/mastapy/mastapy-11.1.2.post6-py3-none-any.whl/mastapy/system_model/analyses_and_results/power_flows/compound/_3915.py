...
class BearingCompoundPowerFlow(_3943.ConnectorCompoundPowerFlow):
    """BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3782.BearingPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3782.BearingPowerFlow]':
