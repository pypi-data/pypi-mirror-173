...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4021
...
class CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow(_4021.AbstractShaftToMountableComponentConnectionCompoundPowerFlow):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3930.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3930.CycloidalDiscPlanetaryBearingConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3930.CycloidalDiscPlanetaryBearingConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3930.CycloidalDiscPlanetaryBearingConnectionPowerFlow))
        return value
