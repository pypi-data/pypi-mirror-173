...
class StraightBevelDiffGearCompoundPowerFlow(_3923.BevelGearCompoundPowerFlow):
    """StraightBevelDiffGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3883.StraightBevelDiffGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3883.StraightBevelDiffGearPowerFlow]':
