...
class TorqueConverterConnectionCompoundPowerFlow(_4056.CouplingConnectionCompoundPowerFlow):
    '''TorqueConverterConnectionCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4006.TorqueConverterConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4006.TorqueConverterConnectionPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4006.TorqueConverterConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4006.TorqueConverterConnectionPowerFlow))
        return value
