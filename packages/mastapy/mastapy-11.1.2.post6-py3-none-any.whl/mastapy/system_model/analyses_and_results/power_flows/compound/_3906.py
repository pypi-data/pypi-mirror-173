...
class MassDiscCompoundPowerFlow(_3953.VirtualComponentCompoundPowerFlow):
    '''MassDiscCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3774.MassDiscPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3774.MassDiscPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3774.MassDiscPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3774.MassDiscPowerFlow))
        return value
