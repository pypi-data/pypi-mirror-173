...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3911
...
class HypoidGearCompoundPowerFlow(_3911.AGMAGleasonConicalGearCompoundPowerFlow):
    """HypoidGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3838.HypoidGearPowerFlow]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3838.HypoidGearPowerFlow]':
