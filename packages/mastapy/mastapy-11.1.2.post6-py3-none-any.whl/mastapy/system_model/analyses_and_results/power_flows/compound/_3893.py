...
class HypoidGearCompoundPowerFlow(_3835.AGMAGleasonConicalGearCompoundPowerFlow):
    '''HypoidGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3762.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3762.HypoidGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3762.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3762.HypoidGearPowerFlow))
        return value
