...
class SynchroniserPartCompoundPowerFlow(_4057.CouplingHalfCompoundPowerFlow):
    '''SynchroniserPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4002.SynchroniserPartPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4002.SynchroniserPartPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4002.SynchroniserPartPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4002.SynchroniserPartPowerFlow))
        return value
