...
from mastapy.system_model.analyses_and_results.power_flows.compound import _4047, _4048, _4078
from mastapy.system_model.analyses_and_results.power_flows import _3916
...
class ConceptGearSetCompoundPowerFlow(_4078.GearSetCompoundPowerFlow):
    '''ConceptGearSetCompoundPowerFlow
    ...
    @property
    def concept_gears_compound_power_flow(self) -> 'List[_4047.ConceptGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCompoundPowerFlow, constructor.new(_4047.ConceptGearCompoundPowerFlow))
        return value

    @property
    def concept_meshes_compound_power_flow(self) -> 'List[_4048.ConceptGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCompoundPowerFlow, constructor.new(_4048.ConceptGearMeshCompoundPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3916.ConceptGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3916.ConceptGearSetPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3916.ConceptGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3916.ConceptGearSetPowerFlow))
        return value
