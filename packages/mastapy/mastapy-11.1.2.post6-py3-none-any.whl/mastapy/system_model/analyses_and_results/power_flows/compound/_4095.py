...
from mastapy.system_model.analyses_and_results.power_flows import _3963
...
class MountableComponentCompoundPowerFlow(_4043.ComponentCompoundPowerFlow):
    '''MountableComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3963.MountableComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3963.MountableComponentPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3963.MountableComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3963.MountableComponentPowerFlow))
        return value
