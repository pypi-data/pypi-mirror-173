...
from mastapy.system_model.analyses_and_results.power_flows import _3994, _3993, _3903
...
class StraightBevelDiffGearSetPowerFlow(_3903.BevelGearSetPowerFlow):
    '''StraightBevelDiffGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3994.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3994.StraightBevelDiffGearPowerFlow))
        return value

    @property
    def straight_bevel_diff_gears_power_flow(self) -> 'List[_3994.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsPowerFlow, constructor.new(_3994.StraightBevelDiffGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3993.StraightBevelDiffGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3993.StraightBevelDiffGearMeshPowerFlow))
        return value

    @property
    def straight_bevel_diff_meshes_power_flow(self) -> 'List[_3993.StraightBevelDiffGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesPowerFlow, constructor.new(_3993.StraightBevelDiffGearMeshPowerFlow))
        return value
