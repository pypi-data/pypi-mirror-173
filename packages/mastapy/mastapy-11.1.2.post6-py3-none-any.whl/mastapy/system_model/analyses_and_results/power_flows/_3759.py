...
from mastapy.system_model.analyses_and_results.power_flows import _3757, _3758, _3799
...
class GearSetPowerFlow(_3799.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3757.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3757.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3758.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3758.GearPowerFlow))
        return value
