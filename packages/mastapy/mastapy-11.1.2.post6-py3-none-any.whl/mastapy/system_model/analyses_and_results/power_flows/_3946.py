...
from mastapy.system_model.analyses_and_results.power_flows import _3944, _3945, _3986
...
class GearSetPowerFlow(_3986.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def rating(self) -> '_334.GearSetRating':
        ...
        if _334.GearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_zerol_bevel_gear_set_rating(self) -> '_342.ZerolBevelGearSetRating':
        ...
        if _342.ZerolBevelGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_worm_gear_set_rating(self) -> '_347.WormGearSetRating':
        ...
        if _347.WormGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_straight_bevel_diff_gear_set_rating(self) -> '_368.StraightBevelDiffGearSetRating':
        ...
        if _368.StraightBevelDiffGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_straight_bevel_gear_set_rating(self) -> '_372.StraightBevelGearSetRating':
        ...
        if _372.StraightBevelGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_spiral_bevel_gear_set_rating(self) -> '_375.SpiralBevelGearSetRating':
        ...
        if _375.SpiralBevelGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_rating(self) -> '_378.KlingelnbergCycloPalloidSpiralBevelGearSetRating':
        ...
        if _378.KlingelnbergCycloPalloidSpiralBevelGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_rating(self) -> '_381.KlingelnbergCycloPalloidHypoidGearSetRating':
        ...
        if _381.KlingelnbergCycloPalloidHypoidGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_klingelnberg_cyclo_palloid_conical_gear_set_rating(self) -> '_384.KlingelnbergCycloPalloidConicalGearSetRating':
        ...
        if _384.KlingelnbergCycloPalloidConicalGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_hypoid_gear_set_rating(self) -> '_411.HypoidGearSetRating':
        ...
        if _411.HypoidGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_face_gear_set_rating(self) -> '_421.FaceGearSetRating':
        ...
        if _421.FaceGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_cylindrical_gear_set_rating(self) -> '_433.CylindricalGearSetRating':
        ...
        if _433.CylindricalGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_conical_gear_set_rating(self) -> '_507.ConicalGearSetRating':
        ...
        if _507.ConicalGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_concept_gear_set_rating(self) -> '_518.ConceptGearSetRating':
        ...
        if _518.ConceptGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_bevel_gear_set_rating(self) -> '_521.BevelGearSetRating':
        ...
        if _521.BevelGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_agma_gleason_conical_gear_set_rating(self) -> '_532.AGMAGleasonConicalGearSetRating':
        ...
        if _532.AGMAGleasonConicalGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3944.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3944.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3945.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3945.GearPowerFlow))
        return value
