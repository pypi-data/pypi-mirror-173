...
from mastapy.system_model.analyses_and_results.power_flows import _3890, _3875
...
class SynchroniserPowerFlow(_3875.SpecialisedAssemblyPowerFlow):
    """SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3890.SynchroniserHalfPowerFlow]':
