...
from mastapy.system_model.analyses_and_results.power_flows import _4001, _3986
...
class SynchroniserPowerFlow(_3986.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_4001.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_4001.SynchroniserHalfPowerFlow))
        return value
