...
from mastapy.system_model.analyses_and_results.power_flows import _3934, _3933, _3946
...
class CylindricalGearSetPowerFlow(_3946.GearSetPowerFlow):
    '''CylindricalGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3934.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3934.CylindricalGearPowerFlow))
        return value

    @property
    def cylindrical_gears_power_flow(self) -> 'List[_3934.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsPowerFlow, constructor.new(_3934.CylindricalGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3933.CylindricalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3933.CylindricalGearMeshPowerFlow))
        return value

    @property
    def cylindrical_meshes_power_flow(self) -> 'List[_3933.CylindricalGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesPowerFlow, constructor.new(_3933.CylindricalGearMeshPowerFlow))
        return value

    @property
    def ratings_for_all_designs(self) -> 'List[_433.CylindricalGearSetRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RatingsForAllDesigns, constructor.new(_433.CylindricalGearSetRating))
        return value
