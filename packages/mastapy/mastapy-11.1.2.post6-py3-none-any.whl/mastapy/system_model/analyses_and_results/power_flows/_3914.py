...
class ConceptGearMeshPowerFlow(_3944.GearMeshPowerFlow):
    '''ConceptGearMeshPowerFlow
    ...
    @property
    def rating(self) -> '_515.ConceptGearMeshRating':
        ...
        return constructor.new(_515.ConceptGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating is not None else None
