...
from mastapy.system_model.analyses_and_results.power_flows import _3838, _3837, _3780
...
class HypoidGearSetPowerFlow(_3780.AGMAGleasonConicalGearSetPowerFlow):
    """HypoidGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3838.HypoidGearPowerFlow]':
    ...
    @property
    def hypoid_gears_power_flow(self) -> 'List[_3838.HypoidGearPowerFlow]':
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3837.HypoidGearMeshPowerFlow]':
    ...
    @property
    def hypoid_meshes_power_flow(self) -> 'List[_3837.HypoidGearMeshPowerFlow]':
