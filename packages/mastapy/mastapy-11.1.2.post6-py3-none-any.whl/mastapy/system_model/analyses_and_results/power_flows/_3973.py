...
class PowerFlow(_7381.StaticLoadAnalysisCase):
    '''PowerFlow
    ...
    @property
    def torsional_system_deflection(self) -> '_2687.TorsionalSystemDeflection':
        ...
        return constructor.new(_2687.TorsionalSystemDeflection)(self.wrapped.TorsionalSystemDeflection) if self.wrapped.TorsionalSystemDeflection is not None else None
