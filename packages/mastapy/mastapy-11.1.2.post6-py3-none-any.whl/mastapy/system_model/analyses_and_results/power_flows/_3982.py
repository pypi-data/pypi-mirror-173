...
from mastapy.system_model.analyses_and_results.power_flows import _3973, _3892
...
class RootAssemblyPowerFlow(_3892.AssemblyPowerFlow):
    '''RootAssemblyPowerFlow
    ...
    @property
    def power_flow_inputs(self) -> '_3973.PowerFlow':
        ...
        return constructor.new(_3973.PowerFlow)(self.wrapped.PowerFlowInputs) if self.wrapped.PowerFlowInputs is not None else None
