...
from mastapy.system_model.analyses_and_results.power_flows import _3728, _3727, _3759
...
class ConceptGearSetPowerFlow(_3759.GearSetPowerFlow):
    '''ConceptGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3728.ConceptGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3728.ConceptGearPowerFlow))
        return value

    @property
    def concept_gears_power_flow(self) -> 'List[_3728.ConceptGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsPowerFlow, constructor.new(_3728.ConceptGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3727.ConceptGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3727.ConceptGearMeshPowerFlow))
        return value

    @property
    def concept_meshes_power_flow(self) -> 'List[_3727.ConceptGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesPowerFlow, constructor.new(_3727.ConceptGearMeshPowerFlow))
        return value
