...
class KlingelnbergCycloPalloidHypoidGearMeshPowerFlow(_3765.KlingelnbergCycloPalloidConicalGearMeshPowerFlow):
    '''KlingelnbergCycloPalloidHypoidGearMeshPowerFlow
    ...
    @property
    def rating(self) -> '_370.KlingelnbergCycloPalloidHypoidGearMeshRating':
        ...
        return constructor.new(_370.KlingelnbergCycloPalloidHypoidGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None
