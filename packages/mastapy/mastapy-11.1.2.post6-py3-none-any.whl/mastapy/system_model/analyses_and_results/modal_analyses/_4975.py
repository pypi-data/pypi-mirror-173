...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _2498
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _5091
...
class ConnectionModalAnalysis(_7372.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysis
    ...
    @property
    def modal_analysis(self) -> '_2495.ModalAnalysis':
        ...
        if _2495.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysis.__class__.__mro__:
    ...
    @property
    def excited_modes_summary(self) -> 'List[_5091.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_5091.SingleExcitationResultsModalAnalysis))
        return value

    @property
    def system_deflection_results(self) -> '_2582.ConnectionSystemDeflection':
        ...
        if _2582.ConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_abstract_shaft_to_mountable_component_connection_system_deflection(self) -> '_2548.AbstractShaftToMountableComponentConnectionSystemDeflection':
    ...
    @property
    def system_deflection_results_of_type_inter_mountable_component_connection_system_deflection(self) -> '_2622.InterMountableComponentConnectionSystemDeflection':
