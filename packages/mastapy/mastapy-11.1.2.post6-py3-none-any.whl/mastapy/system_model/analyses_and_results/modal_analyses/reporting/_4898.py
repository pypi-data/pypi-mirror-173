...
class ModalCMSResultsForModeAndFE(_0.APIBase):
    ...
    @property
    def modal_full_fe_results(self) -> '_202.ModalCMSResults':
        ...
        return constructor.new(_202.ModalCMSResults)(self.wrapped.ModalFullFEResults) if self.wrapped.ModalFullFEResults else None
