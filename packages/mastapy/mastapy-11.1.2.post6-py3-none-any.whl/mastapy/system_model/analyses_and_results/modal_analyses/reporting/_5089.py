...
from mastapy.utility.modal_analysis import _1686
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2512.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1686.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1686.DesignEntityExcitationDescription))
        return value
