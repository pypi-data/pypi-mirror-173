...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _5085
...
class CalculateFullFEResultsForMode(_0.APIBase):
    ...
    @property
    def fe_results(self) -> 'List[_5085.ModalCMSResultsForModeAndFE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEResults, constructor.new(_5085.ModalCMSResultsForModeAndFE))
        return value
