...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4936
...
class RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis(_0.APIBase):
    ...
    @property
    def component_results(self) -> 'List[_4936.ComponentPerModeResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentResults, constructor.new(_4936.ComponentPerModeResult))
        return value
