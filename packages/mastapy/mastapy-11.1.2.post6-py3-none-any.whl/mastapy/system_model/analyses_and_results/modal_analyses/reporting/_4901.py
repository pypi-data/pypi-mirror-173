...
class RigidlyConnectedDesignEntityGroupForSingleModeModalAnalysis(_0.APIBase):
    ...
    @property
    def component_results(self) -> 'List[_4896.ComponentPerModeResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentResults, constructor.new(_4896.ComponentPerModeResult))
        return value
