...
class CalculateFullFEResultsForMode(_0.APIBase):
    ...
    @property
    def fe_results(self) -> 'List[_4898.ModalCMSResultsForModeAndFE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FEResults, constructor.new(_4898.ModalCMSResultsForModeAndFE))
        return value
