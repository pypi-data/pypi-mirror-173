...
from mastapy.utility.modal_analysis import _1529
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2328.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1529.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1529.DesignEntityExcitationDescription))
        return value
