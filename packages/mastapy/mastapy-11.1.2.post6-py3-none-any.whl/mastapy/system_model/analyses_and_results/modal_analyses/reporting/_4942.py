...
from mastapy.utility.modal_analysis import _1549
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2365.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1549.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1549.DesignEntityExcitationDescription))
        return value
