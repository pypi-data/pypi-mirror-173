...
class ModalCMSResultsForModeAndFE(_0.APIBase):
    ...
    @property
    def modal_full_fe_results(self) -> '_207.ModalCMSResults':
        ...
        return constructor.new(_207.ModalCMSResults)(self.wrapped.ModalFullFEResults) if self.wrapped.ModalFullFEResults is not None else None
