...
class PerModeResultsReport(_1510.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1569.TableAndChartOptions':
    ...
    def display_option(self, value: '_1569.TableAndChartOptions'):
