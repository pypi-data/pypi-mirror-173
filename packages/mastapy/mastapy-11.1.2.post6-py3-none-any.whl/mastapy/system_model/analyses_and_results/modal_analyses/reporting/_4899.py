...
class PerModeResultsReport(_1492.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1550.TableAndChartOptions':
    ...
    def display_option(self, value: '_1550.TableAndChartOptions'):
