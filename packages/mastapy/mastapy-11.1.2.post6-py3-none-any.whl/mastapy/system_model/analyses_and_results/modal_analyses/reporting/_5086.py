...
class PerModeResultsReport(_1648.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1708.TableAndChartOptions':
    ...
    def display_option(self, value: '_1708.TableAndChartOptions'):
