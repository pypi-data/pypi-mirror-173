...
from mastapy.system_model.analyses_and_results.modal_analyses import _4450
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4482
...
class ZerolBevelGearMeshCompoundModalAnalysis(_4482.BevelGearMeshCompoundModalAnalysis):
    """ZerolBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4450.ZerolBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4450.ZerolBevelGearMeshModalAnalysis]':
