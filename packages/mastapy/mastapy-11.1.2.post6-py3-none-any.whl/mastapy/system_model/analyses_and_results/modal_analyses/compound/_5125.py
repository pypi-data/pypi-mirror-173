...
from mastapy.system_model.analyses_and_results.modal_analyses import _4973
...
class ConicalGearCompoundModalAnalysis(_5151.GearCompoundModalAnalysis):
    '''ConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4973.ConicalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4973.ConicalGearModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4973.ConicalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4973.ConicalGearModalAnalysis))
        return value
