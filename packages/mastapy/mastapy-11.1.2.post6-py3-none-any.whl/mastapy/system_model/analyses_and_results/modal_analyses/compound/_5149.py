...
class FEPartCompoundModalAnalysis(_5095.AbstractShaftOrHousingCompoundModalAnalysis):
    '''FEPartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4997.FEPartModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4997.FEPartModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4997.FEPartModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4997.FEPartModalAnalysis))
        return value
