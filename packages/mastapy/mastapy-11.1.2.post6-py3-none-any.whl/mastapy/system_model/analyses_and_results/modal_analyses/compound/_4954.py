...
class CylindricalGearMeshCompoundModalAnalysis(_4965.GearMeshCompoundModalAnalysis):
    '''CylindricalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4801.CylindricalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4801.CylindricalGearMeshModalAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4801.CylindricalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4801.CylindricalGearMeshModalAnalysis))
        return value
