...
class ClutchCompoundModalAnalysis(_4943.CouplingCompoundModalAnalysis):
    '''ClutchCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4776.ClutchModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4776.ClutchModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4776.ClutchModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4776.ClutchModalAnalysis))
        return value
