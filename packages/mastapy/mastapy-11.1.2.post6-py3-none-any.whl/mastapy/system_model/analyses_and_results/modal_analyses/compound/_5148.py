...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5146, _5147, _5153
from mastapy.system_model.analyses_and_results.modal_analyses import _4996
...
class FaceGearSetCompoundModalAnalysis(_5153.GearSetCompoundModalAnalysis):
    '''FaceGearSetCompoundModalAnalysis
    ...
    @property
    def face_gears_compound_modal_analysis(self) -> 'List[_5146.FaceGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundModalAnalysis, constructor.new(_5146.FaceGearCompoundModalAnalysis))
        return value

    @property
    def face_meshes_compound_modal_analysis(self) -> 'List[_5147.FaceGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundModalAnalysis, constructor.new(_5147.FaceGearMeshCompoundModalAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4996.FaceGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4996.FaceGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4996.FaceGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4996.FaceGearSetModalAnalysis))
        return value
