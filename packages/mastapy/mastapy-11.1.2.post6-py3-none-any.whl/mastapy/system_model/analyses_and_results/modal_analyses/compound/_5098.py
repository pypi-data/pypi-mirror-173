...
class AGMAGleasonConicalGearMeshCompoundModalAnalysis(_5126.ConicalGearMeshCompoundModalAnalysis):
    '''AGMAGleasonConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4944.AGMAGleasonConicalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4944.AGMAGleasonConicalGearMeshModalAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4944.AGMAGleasonConicalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4944.AGMAGleasonConicalGearMeshModalAnalysis))
        return value
