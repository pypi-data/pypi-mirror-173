...
class GuideDxfModelCompoundModalAnalysis(_4931.ComponentCompoundModalAnalysis):
    '''GuideDxfModelCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4816.GuideDxfModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4816.GuideDxfModelModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4816.GuideDxfModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4816.GuideDxfModelModalAnalysis))
        return value
