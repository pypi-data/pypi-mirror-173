...
from mastapy.system_model.analyses_and_results.modal_analyses import _4377
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4469
...
class HypoidGearCompoundModalAnalysis(_4469.AGMAGleasonConicalGearCompoundModalAnalysis):
    """HypoidGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4377.HypoidGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4377.HypoidGearModalAnalysis]':
