...
class StraightBevelSunGearCompoundModalAnalysis(_5051.StraightBevelDiffGearCompoundModalAnalysis):
    '''StraightBevelSunGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4912.StraightBevelSunGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4912.StraightBevelSunGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4912.StraightBevelSunGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4912.StraightBevelSunGearModalAnalysis))
        return value
