...
class VirtualComponentCompoundModalAnalysis(_5023.MountableComponentCompoundModalAnalysis):
    '''VirtualComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4922.VirtualComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4922.VirtualComponentModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4922.VirtualComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4922.VirtualComponentModalAnalysis))
        return value
