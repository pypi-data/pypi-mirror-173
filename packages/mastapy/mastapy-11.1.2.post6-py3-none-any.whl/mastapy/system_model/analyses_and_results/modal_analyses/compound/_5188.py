...
class ShaftCompoundModalAnalysis(_5094.AbstractShaftCompoundModalAnalysis):
    '''ShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5042.ShaftModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5042.ShaftModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5042.ShaftModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5042.ShaftModalAnalysis))
        return value
