...
class KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis(_4972.KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4825.KlingelnbergCycloPalloidHypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4825.KlingelnbergCycloPalloidHypoidGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4825.KlingelnbergCycloPalloidHypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4825.KlingelnbergCycloPalloidHypoidGearModalAnalysis))
        return value
