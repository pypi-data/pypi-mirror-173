...
from mastapy.system_model.analyses_and_results.modal_analyses import _5011
...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis(_5160.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5011.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5011.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5011.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5011.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis))
        return value
