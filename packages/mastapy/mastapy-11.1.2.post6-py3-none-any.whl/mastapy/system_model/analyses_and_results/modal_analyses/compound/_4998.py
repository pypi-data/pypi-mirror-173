...
class RollingRingCompoundModalAnalysis(_4945.CouplingHalfCompoundModalAnalysis):
    '''RollingRingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4852.RollingRingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4852.RollingRingModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4852.RollingRingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4852.RollingRingModalAnalysis))
        return value
