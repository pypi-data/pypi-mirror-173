...
from mastapy.system_model.analyses_and_results.modal_analyses import _5033
...
class PowerLoadCompoundModalAnalysis(_5215.VirtualComponentCompoundModalAnalysis):
    '''PowerLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5033.PowerLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5033.PowerLoadModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5033.PowerLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5033.PowerLoadModalAnalysis))
        return value
