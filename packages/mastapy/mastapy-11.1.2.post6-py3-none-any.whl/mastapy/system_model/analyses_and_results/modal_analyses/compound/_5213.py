...
from mastapy.system_model.analyses_and_results.modal_analyses import _5067
...
class TorqueConverterTurbineCompoundModalAnalysis(_5132.CouplingHalfCompoundModalAnalysis):
    '''TorqueConverterTurbineCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5067.TorqueConverterTurbineModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5067.TorqueConverterTurbineModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5067.TorqueConverterTurbineModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5067.TorqueConverterTurbineModalAnalysis))
        return value
