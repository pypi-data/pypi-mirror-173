...
class UnbalancedMassCompoundModalAnalysis(_5028.VirtualComponentCompoundModalAnalysis):
    '''UnbalancedMassCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4881.UnbalancedMassModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4881.UnbalancedMassModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4881.UnbalancedMassModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4881.UnbalancedMassModalAnalysis))
        return value
