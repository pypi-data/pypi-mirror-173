...
class BevelDifferentialPlanetGearCompoundModalAnalysis(_4917.BevelDifferentialGearCompoundModalAnalysis):
    '''BevelDifferentialPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4767.BevelDifferentialPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4767.BevelDifferentialPlanetGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4767.BevelDifferentialPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4767.BevelDifferentialPlanetGearModalAnalysis))
        return value
