...
class CouplingHalfCompoundModalAnalysis(_4983.MountableComponentCompoundModalAnalysis):
    '''CouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4792.CouplingHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4792.CouplingHalfModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4792.CouplingHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4792.CouplingHalfModalAnalysis))
        return value
