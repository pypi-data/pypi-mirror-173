...
class CoaxialConnectionCompoundModalAnalysis(_5003.ShaftToMountableComponentConnectionCompoundModalAnalysis):
    '''CoaxialConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4777.CoaxialConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4777.CoaxialConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4777.CoaxialConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4777.CoaxialConnectionModalAnalysis))
        return value
