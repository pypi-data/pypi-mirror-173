...
class TorqueConverterCompoundModalAnalysis(_4943.CouplingCompoundModalAnalysis):
    '''TorqueConverterCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4878.TorqueConverterModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4878.TorqueConverterModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4878.TorqueConverterModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4878.TorqueConverterModalAnalysis))
        return value
