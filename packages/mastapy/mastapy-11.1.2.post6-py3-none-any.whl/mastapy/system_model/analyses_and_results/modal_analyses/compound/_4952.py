...
class CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis(_4909.AbstractShaftToMountableComponentConnectionCompoundModalAnalysis):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4800.CycloidalDiscPlanetaryBearingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4800.CycloidalDiscPlanetaryBearingConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4800.CycloidalDiscPlanetaryBearingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4800.CycloidalDiscPlanetaryBearingConnectionModalAnalysis))
        return value
