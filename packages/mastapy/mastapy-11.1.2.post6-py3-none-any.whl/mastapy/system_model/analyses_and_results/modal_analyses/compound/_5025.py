...
class TorqueConverterPumpCompoundModalAnalysis(_4945.CouplingHalfCompoundModalAnalysis):
    '''TorqueConverterPumpCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4879.TorqueConverterPumpModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4879.TorqueConverterPumpModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4879.TorqueConverterPumpModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4879.TorqueConverterPumpModalAnalysis))
        return value
