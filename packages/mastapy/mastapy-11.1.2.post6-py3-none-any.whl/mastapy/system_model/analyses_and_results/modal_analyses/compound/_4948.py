...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4994
...
class CVTPulleyCompoundModalAnalysis(_4994.PulleyCompoundModalAnalysis):
    '''CVTPulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4796.CVTPulleyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4796.CVTPulleyModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4796.CVTPulleyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4796.CVTPulleyModalAnalysis))
        return value
