...
class ComponentCompoundModalAnalysis(_4985.PartCompoundModalAnalysis):
    '''ComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4778.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4778.ComponentModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4778.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4778.ComponentModalAnalysis))
        return value
