...
from mastapy.system_model.analyses_and_results.modal_analyses import _4452
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4591, _4592, _4483
...
class ZerolBevelGearSetCompoundModalAnalysis(_4483.BevelGearSetCompoundModalAnalysis):
    """ZerolBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4452.ZerolBevelGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis(self) -> 'List[_4591.ZerolBevelGearCompoundModalAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis(self) -> 'List[_4592.ZerolBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4452.ZerolBevelGearSetModalAnalysis]':
