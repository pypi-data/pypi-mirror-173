...
from mastapy.system_model.analyses_and_results.modal_analyses import _5034
...
class PulleyCompoundModalAnalysis(_5132.CouplingHalfCompoundModalAnalysis):
    '''PulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5034.PulleyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5034.PulleyModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5034.PulleyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5034.PulleyModalAnalysis))
        return value
