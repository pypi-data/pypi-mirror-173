...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis(_4532.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4386.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4386.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
