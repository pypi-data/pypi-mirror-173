...
class BearingCompoundModalAnalysis(_4942.ConnectorCompoundModalAnalysis):
    '''BearingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4761.BearingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4761.BearingModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4761.BearingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4761.BearingModalAnalysis))
        return value
