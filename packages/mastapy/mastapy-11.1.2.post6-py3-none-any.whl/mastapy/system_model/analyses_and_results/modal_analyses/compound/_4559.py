...
from mastapy.system_model.analyses_and_results.modal_analyses import _4412
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4472
...
class RootAssemblyCompoundModalAnalysis(_4472.AssemblyCompoundModalAnalysis):
    """RootAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4412.RootAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4412.RootAssemblyModalAnalysis]':
