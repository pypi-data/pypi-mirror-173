...
class CVTCompoundModalAnalysis(_4916.BeltDriveCompoundModalAnalysis):
    '''CVTCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4795.CVTModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4795.CVTModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4795.CVTModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4795.CVTModalAnalysis))
        return value
