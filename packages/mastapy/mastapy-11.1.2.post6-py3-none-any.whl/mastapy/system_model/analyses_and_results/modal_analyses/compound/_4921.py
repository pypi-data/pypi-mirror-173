...
class BevelDifferentialSunGearCompoundModalAnalysis(_4917.BevelDifferentialGearCompoundModalAnalysis):
    '''BevelDifferentialSunGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4768.BevelDifferentialSunGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4768.BevelDifferentialSunGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4768.BevelDifferentialSunGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4768.BevelDifferentialSunGearModalAnalysis))
        return value
