...
from mastapy.system_model.analyses_and_results.modal_analyses import _4382
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4499
...
class KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis(_4499.ConicalGearSetCompoundModalAnalysis):
    """KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4382.KlingelnbergCycloPalloidConicalGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4382.KlingelnbergCycloPalloidConicalGearSetModalAnalysis]':
