...
class FEPartCompoundModalAnalysis(_4908.AbstractShaftOrHousingCompoundModalAnalysis):
    '''FEPartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4810.FEPartModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4810.FEPartModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4810.FEPartModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4810.FEPartModalAnalysis))
        return value
