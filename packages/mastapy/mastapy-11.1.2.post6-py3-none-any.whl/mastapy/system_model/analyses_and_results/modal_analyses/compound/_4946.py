...
class CVTBeltConnectionCompoundModalAnalysis(_4915.BeltConnectionCompoundModalAnalysis):
    '''CVTBeltConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4794.CVTBeltConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4794.CVTBeltConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4794.CVTBeltConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4794.CVTBeltConnectionModalAnalysis))
        return value
