...
class CouplingCompoundModalAnalysis(_5004.SpecialisedAssemblyCompoundModalAnalysis):
    '''CouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4793.CouplingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4793.CouplingModalAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4793.CouplingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4793.CouplingModalAnalysis))
        return value
