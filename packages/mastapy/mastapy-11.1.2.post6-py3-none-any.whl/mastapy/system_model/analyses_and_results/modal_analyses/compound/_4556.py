...
from mastapy.system_model.analyses_and_results.modal_analyses import _4409
...
class RollingRingAssemblyCompoundModalAnalysis(_4563.SpecialisedAssemblyCompoundModalAnalysis):
    """RollingRingAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4409.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4409.RollingRingAssemblyModalAnalysis]':
