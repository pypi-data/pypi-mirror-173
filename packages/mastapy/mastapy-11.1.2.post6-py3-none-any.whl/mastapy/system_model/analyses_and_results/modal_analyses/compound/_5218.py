...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5216, _5217, _5153
from mastapy.system_model.analyses_and_results.modal_analyses import _5077
...
class WormGearSetCompoundModalAnalysis(_5153.GearSetCompoundModalAnalysis):
    '''WormGearSetCompoundModalAnalysis
    ...
    @property
    def worm_gears_compound_modal_analysis(self) -> 'List[_5216.WormGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCompoundModalAnalysis, constructor.new(_5216.WormGearCompoundModalAnalysis))
        return value

    @property
    def worm_meshes_compound_modal_analysis(self) -> 'List[_5217.WormGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCompoundModalAnalysis, constructor.new(_5217.WormGearMeshCompoundModalAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5077.WormGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5077.WormGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5077.WormGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5077.WormGearSetModalAnalysis))
        return value
