...
from mastapy.system_model.analyses_and_results.modal_analyses import _4431
...
class StraightBevelSunGearCompoundModalAnalysis(_4570.StraightBevelDiffGearCompoundModalAnalysis):
    """StraightBevelSunGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4431.StraightBevelSunGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4431.StraightBevelSunGearModalAnalysis]':
