...
from mastapy.system_model.analyses_and_results.modal_analyses import _4966
...
class ConceptCouplingConnectionCompoundModalAnalysis(_5131.CouplingConnectionCompoundModalAnalysis):
    '''ConceptCouplingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4966.ConceptCouplingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4966.ConceptCouplingConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4966.ConceptCouplingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4966.ConceptCouplingConnectionModalAnalysis))
        return value
