...
from mastapy.system_model.analyses_and_results.modal_analyses import _5012
...
class KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis(_5159.KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5012.KlingelnbergCycloPalloidHypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5012.KlingelnbergCycloPalloidHypoidGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5012.KlingelnbergCycloPalloidHypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5012.KlingelnbergCycloPalloidHypoidGearModalAnalysis))
        return value
