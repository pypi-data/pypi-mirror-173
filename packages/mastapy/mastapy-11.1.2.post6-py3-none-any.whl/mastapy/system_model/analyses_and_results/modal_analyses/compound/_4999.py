...
class RollingRingConnectionCompoundModalAnalysis(_4971.InterMountableComponentConnectionCompoundModalAnalysis):
    '''RollingRingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4851.RollingRingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4851.RollingRingConnectionModalAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4851.RollingRingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4851.RollingRingConnectionModalAnalysis))
        return value
