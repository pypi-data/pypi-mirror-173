...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4525
...
class ConicalGearSetCompoundModalAnalysis(_4525.GearSetCompoundModalAnalysis):
    """ConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4346.ConicalGearSetModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4346.ConicalGearSetModalAnalysis]':
