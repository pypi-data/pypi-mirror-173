...
class MountableComponentCompoundModalAnalysis(_4931.ComponentCompoundModalAnalysis):
    '''MountableComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4835.MountableComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4835.MountableComponentModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4835.MountableComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4835.MountableComponentModalAnalysis))
        return value
