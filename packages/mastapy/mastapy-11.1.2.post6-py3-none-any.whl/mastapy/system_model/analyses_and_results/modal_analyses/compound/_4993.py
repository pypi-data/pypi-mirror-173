...
class PowerLoadCompoundModalAnalysis(_5028.VirtualComponentCompoundModalAnalysis):
    '''PowerLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4846.PowerLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4846.PowerLoadModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4846.PowerLoadModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4846.PowerLoadModalAnalysis))
        return value
