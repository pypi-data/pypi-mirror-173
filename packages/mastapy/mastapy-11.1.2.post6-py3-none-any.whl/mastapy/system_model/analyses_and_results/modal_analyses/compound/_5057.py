...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5051
...
class StraightBevelPlanetGearCompoundModalAnalysis(_5051.StraightBevelDiffGearCompoundModalAnalysis):
    '''StraightBevelPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4911.StraightBevelPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4911.StraightBevelPlanetGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4911.StraightBevelPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4911.StraightBevelPlanetGearModalAnalysis))
        return value
