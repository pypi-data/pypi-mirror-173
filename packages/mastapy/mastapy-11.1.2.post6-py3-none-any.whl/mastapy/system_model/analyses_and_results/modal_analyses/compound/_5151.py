...
class GearCompoundModalAnalysis(_5170.MountableComponentCompoundModalAnalysis):
    '''GearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5001.GearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5001.GearModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5001.GearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5001.GearModalAnalysis))
        return value
