...
class ShaftCompoundModalAnalysis(_4907.AbstractShaftCompoundModalAnalysis):
    '''ShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4855.ShaftModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4855.ShaftModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4855.ShaftModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4855.ShaftModalAnalysis))
        return value
