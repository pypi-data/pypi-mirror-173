...
from mastapy.system_model.analyses_and_results.modal_analyses import _5005
...
class HypoidGearCompoundModalAnalysis(_5097.AGMAGleasonConicalGearCompoundModalAnalysis):
    '''HypoidGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5005.HypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5005.HypoidGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5005.HypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5005.HypoidGearModalAnalysis))
        return value
