...
from mastapy.system_model.analyses_and_results.modal_analyses import _5010
...
class KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis(_5127.ConicalGearSetCompoundModalAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5010.KlingelnbergCycloPalloidConicalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5010.KlingelnbergCycloPalloidConicalGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5010.KlingelnbergCycloPalloidConicalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5010.KlingelnbergCycloPalloidConicalGearSetModalAnalysis))
        return value
