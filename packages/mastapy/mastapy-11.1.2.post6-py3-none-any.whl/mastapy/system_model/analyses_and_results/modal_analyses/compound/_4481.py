...
class BevelGearCompoundModalAnalysis(_4469.AGMAGleasonConicalGearCompoundModalAnalysis):
    """BevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4329.BevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4329.BevelGearModalAnalysis]':
