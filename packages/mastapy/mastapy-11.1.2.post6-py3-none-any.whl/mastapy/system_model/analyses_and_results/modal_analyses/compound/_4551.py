...
from mastapy.system_model.analyses_and_results.modal_analyses import _4404
...
class PointLoadCompoundModalAnalysis(_4587.VirtualComponentCompoundModalAnalysis):
    """PointLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4404.PointLoadModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4404.PointLoadModalAnalysis]':
