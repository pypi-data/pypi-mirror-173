...
from mastapy.system_model.analyses_and_results.modal_analyses import _4988
...
class CylindricalGearMeshCompoundModalAnalysis(_5152.GearMeshCompoundModalAnalysis):
    '''CylindricalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4988.CylindricalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4988.CylindricalGearMeshModalAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4988.CylindricalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4988.CylindricalGearMeshModalAnalysis))
        return value
