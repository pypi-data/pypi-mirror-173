...
from mastapy.system_model.analyses_and_results.modal_analyses import _4385
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4534, _4535, _4533
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis(_4533.KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4385.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_modal_analysis(self) -> 'List[_4534.KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_modal_analysis(self) -> 'List[_4535.KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4385.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]':
