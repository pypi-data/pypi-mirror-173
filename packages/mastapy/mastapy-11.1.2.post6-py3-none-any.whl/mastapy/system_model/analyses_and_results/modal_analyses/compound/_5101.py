...
class BearingCompoundModalAnalysis(_5129.ConnectorCompoundModalAnalysis):
    '''BearingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4948.BearingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4948.BearingModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4948.BearingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4948.BearingModalAnalysis))
        return value
