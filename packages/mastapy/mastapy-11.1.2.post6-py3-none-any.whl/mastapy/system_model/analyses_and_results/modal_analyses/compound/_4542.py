...
from mastapy.system_model.analyses_and_results.modal_analyses import _4394
...
class MountableComponentCompoundModalAnalysis(_4490.ComponentCompoundModalAnalysis):
    """MountableComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4394.MountableComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4394.MountableComponentModalAnalysis]':
