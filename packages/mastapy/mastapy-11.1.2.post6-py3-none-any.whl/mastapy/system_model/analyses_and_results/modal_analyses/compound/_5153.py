...
from mastapy.system_model.analyses_and_results.modal_analyses import _5002
...
class GearSetCompoundModalAnalysis(_5191.SpecialisedAssemblyCompoundModalAnalysis):
    '''GearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5002.GearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5002.GearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5002.GearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5002.GearSetModalAnalysis))
        return value
