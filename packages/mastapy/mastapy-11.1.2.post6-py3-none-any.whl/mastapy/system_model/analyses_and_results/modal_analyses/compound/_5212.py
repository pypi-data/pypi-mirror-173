...
from mastapy.system_model.analyses_and_results.modal_analyses import _5066
...
class TorqueConverterPumpCompoundModalAnalysis(_5132.CouplingHalfCompoundModalAnalysis):
    '''TorqueConverterPumpCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5066.TorqueConverterPumpModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5066.TorqueConverterPumpModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5066.TorqueConverterPumpModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5066.TorqueConverterPumpModalAnalysis))
        return value
