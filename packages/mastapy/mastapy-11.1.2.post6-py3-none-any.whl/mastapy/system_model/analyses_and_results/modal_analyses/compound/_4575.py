...
from mastapy.system_model.analyses_and_results.modal_analyses import _4429
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4573, _4574, _4483
...
class StraightBevelGearSetCompoundModalAnalysis(_4483.BevelGearSetCompoundModalAnalysis):
    """StraightBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4429.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_modal_analysis(self) -> 'List[_4573.StraightBevelGearCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_modal_analysis(self) -> 'List[_4574.StraightBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4429.StraightBevelGearSetModalAnalysis]':
