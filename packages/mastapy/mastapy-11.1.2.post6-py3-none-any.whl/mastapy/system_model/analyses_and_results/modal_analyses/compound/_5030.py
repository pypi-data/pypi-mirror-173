...
class WormGearMeshCompoundModalAnalysis(_4965.GearMeshCompoundModalAnalysis):
    '''WormGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4888.WormGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4888.WormGearMeshModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4888.WormGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4888.WormGearMeshModalAnalysis))
        return value
