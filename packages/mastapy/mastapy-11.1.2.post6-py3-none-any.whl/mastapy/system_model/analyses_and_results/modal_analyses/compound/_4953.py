...
class CylindricalGearCompoundModalAnalysis(_4964.GearCompoundModalAnalysis):
    '''CylindricalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4802.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4802.CylindricalGearModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4802.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4802.CylindricalGearModalAnalysis))
        return value
