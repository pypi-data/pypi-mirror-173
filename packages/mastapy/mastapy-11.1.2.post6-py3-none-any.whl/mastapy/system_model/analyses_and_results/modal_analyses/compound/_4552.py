...
from mastapy.system_model.analyses_and_results.modal_analyses import _4405
...
class PowerLoadCompoundModalAnalysis(_4587.VirtualComponentCompoundModalAnalysis):
    """PowerLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4405.PowerLoadModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4405.PowerLoadModalAnalysis]':
