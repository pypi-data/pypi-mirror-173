...
class RingPinsCompoundModalAnalysis(_4983.MountableComponentCompoundModalAnalysis):
    '''RingPinsCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4848.RingPinsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4848.RingPinsModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4848.RingPinsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4848.RingPinsModalAnalysis))
        return value
