...
class InterMountableComponentConnectionCompoundModalAnalysis(_4941.ConnectionCompoundModalAnalysis):
    '''InterMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4820.InterMountableComponentConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4820.InterMountableComponentConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4820.InterMountableComponentConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4820.InterMountableComponentConnectionModalAnalysis))
        return value
