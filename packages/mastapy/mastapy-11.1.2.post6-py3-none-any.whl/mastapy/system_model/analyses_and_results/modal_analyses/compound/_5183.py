...
from mastapy.system_model.analyses_and_results.modal_analyses import _5036
...
class RingPinsToDiscConnectionCompoundModalAnalysis(_5158.InterMountableComponentConnectionCompoundModalAnalysis):
    '''RingPinsToDiscConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5036.RingPinsToDiscConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5036.RingPinsToDiscConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5036.RingPinsToDiscConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5036.RingPinsToDiscConnectionModalAnalysis))
        return value
