...
from mastapy.system_model.analyses_and_results.modal_analyses import _5039
...
class RollingRingCompoundModalAnalysis(_5132.CouplingHalfCompoundModalAnalysis):
    '''RollingRingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5039.RollingRingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5039.RollingRingModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5039.RollingRingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5039.RollingRingModalAnalysis))
        return value
