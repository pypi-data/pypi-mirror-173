...
class StraightBevelDiffGearCompoundModalAnalysis(_4922.BevelGearCompoundModalAnalysis):
    '''StraightBevelDiffGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4866.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4866.StraightBevelDiffGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4866.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4866.StraightBevelDiffGearModalAnalysis))
        return value
