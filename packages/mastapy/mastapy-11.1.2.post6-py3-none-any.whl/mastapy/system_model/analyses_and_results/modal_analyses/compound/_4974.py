...
class KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis(_4940.ConicalGearSetCompoundModalAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4823.KlingelnbergCycloPalloidConicalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4823.KlingelnbergCycloPalloidConicalGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4823.KlingelnbergCycloPalloidConicalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4823.KlingelnbergCycloPalloidConicalGearSetModalAnalysis))
        return value
