...
class VirtualComponentCompoundModalAnalysis(_4983.MountableComponentCompoundModalAnalysis):
    '''VirtualComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4882.VirtualComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4882.VirtualComponentModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4882.VirtualComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4882.VirtualComponentModalAnalysis))
        return value
