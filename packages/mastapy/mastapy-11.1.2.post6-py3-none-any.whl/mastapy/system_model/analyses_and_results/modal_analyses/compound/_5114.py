...
from mastapy.system_model.analyses_and_results.modal_analyses import _4963
...
class ClutchCompoundModalAnalysis(_5130.CouplingCompoundModalAnalysis):
    '''ClutchCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4963.ClutchModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4963.ClutchModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4963.ClutchModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4963.ClutchModalAnalysis))
        return value
