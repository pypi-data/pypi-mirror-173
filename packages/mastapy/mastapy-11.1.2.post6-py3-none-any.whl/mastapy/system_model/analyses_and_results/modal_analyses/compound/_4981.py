...
class MassDiscCompoundModalAnalysis(_5028.VirtualComponentCompoundModalAnalysis):
    '''MassDiscCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4830.MassDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4830.MassDiscModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4830.MassDiscModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4830.MassDiscModalAnalysis))
        return value
