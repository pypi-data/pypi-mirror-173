...
from mastapy.system_model.analyses_and_results.modal_analyses import _5027
...
class PartToPartShearCouplingHalfCompoundModalAnalysis(_5132.CouplingHalfCompoundModalAnalysis):
    '''PartToPartShearCouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5027.PartToPartShearCouplingHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5027.PartToPartShearCouplingHalfModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5027.PartToPartShearCouplingHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5027.PartToPartShearCouplingHalfModalAnalysis))
        return value
