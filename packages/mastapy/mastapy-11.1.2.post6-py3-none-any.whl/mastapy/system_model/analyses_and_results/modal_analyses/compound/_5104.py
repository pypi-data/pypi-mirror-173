...
class BevelDifferentialGearCompoundModalAnalysis(_5109.BevelGearCompoundModalAnalysis):
    '''BevelDifferentialGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4952.BevelDifferentialGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4952.BevelDifferentialGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4952.BevelDifferentialGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4952.BevelDifferentialGearModalAnalysis))
        return value
