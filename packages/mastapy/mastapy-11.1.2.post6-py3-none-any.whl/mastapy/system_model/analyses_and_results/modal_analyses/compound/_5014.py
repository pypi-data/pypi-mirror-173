...
class StraightBevelGearCompoundModalAnalysis(_4922.BevelGearCompoundModalAnalysis):
    '''StraightBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4869.StraightBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4869.StraightBevelGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4869.StraightBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4869.StraightBevelGearModalAnalysis))
        return value
