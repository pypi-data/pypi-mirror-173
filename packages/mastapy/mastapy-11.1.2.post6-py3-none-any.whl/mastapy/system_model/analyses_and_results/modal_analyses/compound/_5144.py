...
from mastapy.system_model.analyses_and_results.modal_analyses import _4992
...
class DatumCompoundModalAnalysis(_5118.ComponentCompoundModalAnalysis):
    '''DatumCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4992.DatumModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4992.DatumModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4992.DatumModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4992.DatumModalAnalysis))
        return value
