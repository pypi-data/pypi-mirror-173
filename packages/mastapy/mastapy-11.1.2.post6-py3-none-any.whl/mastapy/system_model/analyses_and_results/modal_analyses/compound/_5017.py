...
class StraightBevelPlanetGearCompoundModalAnalysis(_5011.StraightBevelDiffGearCompoundModalAnalysis):
    '''StraightBevelPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4871.StraightBevelPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4871.StraightBevelPlanetGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4871.StraightBevelPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4871.StraightBevelPlanetGearModalAnalysis))
        return value
