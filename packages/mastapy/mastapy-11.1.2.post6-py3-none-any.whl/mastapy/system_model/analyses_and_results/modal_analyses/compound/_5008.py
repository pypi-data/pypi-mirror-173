...
class SpringDamperCompoundModalAnalysis(_4943.CouplingCompoundModalAnalysis):
    '''SpringDamperCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4864.SpringDamperModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4864.SpringDamperModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4864.SpringDamperModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4864.SpringDamperModalAnalysis))
        return value
