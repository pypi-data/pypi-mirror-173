...
from mastapy.system_model.analyses_and_results.modal_analyses import _4451
...
class ZerolBevelGearCompoundModalAnalysis(_4481.BevelGearCompoundModalAnalysis):
    """ZerolBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4451.ZerolBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4451.ZerolBevelGearModalAnalysis]':
