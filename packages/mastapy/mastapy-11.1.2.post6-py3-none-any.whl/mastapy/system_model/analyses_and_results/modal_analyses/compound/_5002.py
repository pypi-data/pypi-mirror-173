...
class ShaftHubConnectionCompoundModalAnalysis(_4942.ConnectorCompoundModalAnalysis):
    '''ShaftHubConnectionCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4854.ShaftHubConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4854.ShaftHubConnectionModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4854.ShaftHubConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4854.ShaftHubConnectionModalAnalysis))
        return value
