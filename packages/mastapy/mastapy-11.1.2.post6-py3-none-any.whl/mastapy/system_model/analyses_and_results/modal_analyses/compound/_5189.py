...
from mastapy.system_model.analyses_and_results.modal_analyses import _5041
...
class ShaftHubConnectionCompoundModalAnalysis(_5129.ConnectorCompoundModalAnalysis):
    '''ShaftHubConnectionCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5041.ShaftHubConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5041.ShaftHubConnectionModalAnalysis))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5041.ShaftHubConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5041.ShaftHubConnectionModalAnalysis))
        return value
