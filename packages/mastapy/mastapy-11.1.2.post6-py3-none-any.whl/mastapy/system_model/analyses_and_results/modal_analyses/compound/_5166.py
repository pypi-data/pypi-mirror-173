...
from mastapy.system_model.analyses_and_results.modal_analyses import _5014
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5160
...
class KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis(_5160.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5014.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5014.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5014.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5014.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis))
        return value
