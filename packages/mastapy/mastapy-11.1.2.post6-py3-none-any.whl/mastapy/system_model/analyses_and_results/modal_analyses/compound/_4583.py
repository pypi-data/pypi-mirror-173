...
from mastapy.system_model.analyses_and_results.modal_analyses import _4436
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4503
...
class TorqueConverterConnectionCompoundModalAnalysis(_4503.CouplingConnectionCompoundModalAnalysis):
    """TorqueConverterConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4436.TorqueConverterConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4436.TorqueConverterConnectionModalAnalysis]':
