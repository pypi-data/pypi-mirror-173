...
from mastapy.system_model.analyses_and_results.modal_analyses import _5053
...
class StraightBevelDiffGearCompoundModalAnalysis(_5109.BevelGearCompoundModalAnalysis):
    '''StraightBevelDiffGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5053.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5053.StraightBevelDiffGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5053.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5053.StraightBevelDiffGearModalAnalysis))
        return value
