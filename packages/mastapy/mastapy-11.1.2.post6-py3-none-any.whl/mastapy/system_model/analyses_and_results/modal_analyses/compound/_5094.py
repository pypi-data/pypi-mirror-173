...
class AbstractShaftCompoundModalAnalysis(_5095.AbstractShaftOrHousingCompoundModalAnalysis):
    '''AbstractShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4941.AbstractShaftModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4941.AbstractShaftModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4941.AbstractShaftModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4941.AbstractShaftModalAnalysis))
        return value
