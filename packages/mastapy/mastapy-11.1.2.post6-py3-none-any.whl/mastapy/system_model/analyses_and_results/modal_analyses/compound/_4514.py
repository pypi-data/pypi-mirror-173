...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4512, _4513, _4525
...
class CylindricalGearSetCompoundModalAnalysis(_4525.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4362.CylindricalGearSetModalAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_modal_analysis(self) -> 'List[_4512.CylindricalGearCompoundModalAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_modal_analysis(self) -> 'List[_4513.CylindricalGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4362.CylindricalGearSetModalAnalysis]':
