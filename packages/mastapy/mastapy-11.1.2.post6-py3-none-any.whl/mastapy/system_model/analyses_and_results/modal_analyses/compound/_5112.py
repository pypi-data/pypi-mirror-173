...
from mastapy.system_model.analyses_and_results.modal_analyses import _4960
...
class BoltCompoundModalAnalysis(_5118.ComponentCompoundModalAnalysis):
    '''BoltCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4960.BoltModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4960.BoltModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4960.BoltModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4960.BoltModalAnalysis))
        return value
