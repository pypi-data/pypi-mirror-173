...
class ConnectorCompoundModalAnalysis(_4983.MountableComponentCompoundModalAnalysis):
    '''ConnectorCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4789.ConnectorModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4789.ConnectorModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4789.ConnectorModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4789.ConnectorModalAnalysis))
        return value
