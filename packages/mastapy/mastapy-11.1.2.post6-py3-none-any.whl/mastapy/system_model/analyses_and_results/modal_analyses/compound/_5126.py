...
from mastapy.system_model.analyses_and_results.modal_analyses import _4972
...
class ConicalGearMeshCompoundModalAnalysis(_5152.GearMeshCompoundModalAnalysis):
    '''ConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4972.ConicalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4972.ConicalGearMeshModalAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4972.ConicalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4972.ConicalGearMeshModalAnalysis))
        return value
