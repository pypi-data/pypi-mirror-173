...
from mastapy.system_model.analyses_and_results.modal_analyses import _4994
...
class FaceGearMeshCompoundModalAnalysis(_5152.GearMeshCompoundModalAnalysis):
    '''FaceGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4994.FaceGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4994.FaceGearMeshModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4994.FaceGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4994.FaceGearMeshModalAnalysis))
        return value
