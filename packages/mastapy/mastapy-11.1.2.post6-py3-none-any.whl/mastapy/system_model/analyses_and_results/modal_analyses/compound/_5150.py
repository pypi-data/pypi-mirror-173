...
from mastapy.system_model.analyses_and_results.modal_analyses import _4998
...
class FlexiblePinAssemblyCompoundModalAnalysis(_5191.SpecialisedAssemblyCompoundModalAnalysis):
    '''FlexiblePinAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4998.FlexiblePinAssemblyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4998.FlexiblePinAssemblyModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4998.FlexiblePinAssemblyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4998.FlexiblePinAssemblyModalAnalysis))
        return value
