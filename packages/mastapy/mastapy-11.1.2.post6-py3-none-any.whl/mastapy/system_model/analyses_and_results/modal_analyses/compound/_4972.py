...
class KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis(_4938.ConicalGearCompoundModalAnalysis):
    '''KlingelnbergCycloPalloidConicalGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4822.KlingelnbergCycloPalloidConicalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4822.KlingelnbergCycloPalloidConicalGearModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4822.KlingelnbergCycloPalloidConicalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4822.KlingelnbergCycloPalloidConicalGearModalAnalysis))
        return value
