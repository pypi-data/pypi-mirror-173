...
from mastapy.system_model.analyses_and_results.modal_analyses import _5038
...
class RollingRingConnectionCompoundModalAnalysis(_5158.InterMountableComponentConnectionCompoundModalAnalysis):
    '''RollingRingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5038.RollingRingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5038.RollingRingConnectionModalAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5038.RollingRingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5038.RollingRingConnectionModalAnalysis))
        return value
