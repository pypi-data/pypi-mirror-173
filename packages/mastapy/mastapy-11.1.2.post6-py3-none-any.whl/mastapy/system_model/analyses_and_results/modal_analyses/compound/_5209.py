...
from mastapy.system_model.analyses_and_results.modal_analyses import _5063
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5208
...
class SynchroniserSleeveCompoundModalAnalysis(_5208.SynchroniserPartCompoundModalAnalysis):
    '''SynchroniserSleeveCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5063.SynchroniserSleeveModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5063.SynchroniserSleeveModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5063.SynchroniserSleeveModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5063.SynchroniserSleeveModalAnalysis))
        return value
