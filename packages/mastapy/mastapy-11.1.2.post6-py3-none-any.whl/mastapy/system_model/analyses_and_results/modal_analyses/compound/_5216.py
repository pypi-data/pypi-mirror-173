...
from mastapy.system_model.analyses_and_results.modal_analyses import _5076
...
class WormGearCompoundModalAnalysis(_5151.GearCompoundModalAnalysis):
    '''WormGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5076.WormGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5076.WormGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5076.WormGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5076.WormGearModalAnalysis))
        return value
