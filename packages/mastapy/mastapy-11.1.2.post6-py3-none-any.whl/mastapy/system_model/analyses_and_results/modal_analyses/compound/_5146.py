...
from mastapy.system_model.analyses_and_results.modal_analyses import _4995
...
class FaceGearCompoundModalAnalysis(_5151.GearCompoundModalAnalysis):
    '''FaceGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4995.FaceGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4995.FaceGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4995.FaceGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4995.FaceGearModalAnalysis))
        return value
