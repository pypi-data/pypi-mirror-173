...
class InterMountableComponentConnectionCompoundModalAnalysis(_4500.ConnectionCompoundModalAnalysis):
    """InterMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4379.InterMountableComponentConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4379.InterMountableComponentConnectionModalAnalysis]':
