...
class AbstractShaftOrHousingCompoundModalAnalysis(_4931.ComponentCompoundModalAnalysis):
    '''AbstractShaftOrHousingCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4755.AbstractShaftOrHousingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4755.AbstractShaftOrHousingModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4755.AbstractShaftOrHousingModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4755.AbstractShaftOrHousingModalAnalysis))
        return value
