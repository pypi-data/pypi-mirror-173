...
from mastapy.system_model.analyses_and_results.modal_analyses import _4390
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4587
...
class MeasurementComponentCompoundModalAnalysis(_4587.VirtualComponentCompoundModalAnalysis):
    """MeasurementComponentCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4390.MeasurementComponentModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4390.MeasurementComponentModalAnalysis]':
