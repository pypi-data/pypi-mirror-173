...
from mastapy.system_model.analyses_and_results.modal_analyses import _5079
...
class ZerolBevelGearCompoundModalAnalysis(_5109.BevelGearCompoundModalAnalysis):
    '''ZerolBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5079.ZerolBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5079.ZerolBevelGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5079.ZerolBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5079.ZerolBevelGearModalAnalysis))
        return value
