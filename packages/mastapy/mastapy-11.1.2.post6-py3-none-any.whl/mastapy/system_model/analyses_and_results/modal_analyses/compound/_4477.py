...
class BevelDifferentialGearMeshCompoundModalAnalysis(_4482.BevelGearMeshCompoundModalAnalysis):
    """BevelDifferentialGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4323.BevelDifferentialGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4323.BevelDifferentialGearMeshModalAnalysis]':
