...
from mastapy.system_model.analyses_and_results.modal_analyses import _4432
...
class SynchroniserHalfCompoundModalAnalysis(_4580.SynchroniserPartCompoundModalAnalysis):
    """SynchroniserHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4432.SynchroniserHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4432.SynchroniserHalfModalAnalysis]':
