...
from mastapy.system_model.analyses_and_results.modal_analyses import _4406
...
class PulleyCompoundModalAnalysis(_4504.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4406.PulleyModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4406.PulleyModalAnalysis]':
