...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5128
...
class AbstractShaftToMountableComponentConnectionCompoundModalAnalysis(_5128.ConnectionCompoundModalAnalysis):
    '''AbstractShaftToMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4943.AbstractShaftToMountableComponentConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4943.AbstractShaftToMountableComponentConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4943.AbstractShaftToMountableComponentConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4943.AbstractShaftToMountableComponentConnectionModalAnalysis))
        return value
