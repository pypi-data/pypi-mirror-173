...
class ShaftToMountableComponentConnectionCompoundModalAnalysis(_4949.AbstractShaftToMountableComponentConnectionCompoundModalAnalysis):
    '''ShaftToMountableComponentConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4897.ShaftToMountableComponentConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4897.ShaftToMountableComponentConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4897.ShaftToMountableComponentConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4897.ShaftToMountableComponentConnectionModalAnalysis))
        return value
