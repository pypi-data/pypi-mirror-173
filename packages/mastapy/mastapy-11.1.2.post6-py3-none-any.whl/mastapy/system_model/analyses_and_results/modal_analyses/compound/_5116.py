...
from mastapy.system_model.analyses_and_results.modal_analyses import _4962
...
class ClutchHalfCompoundModalAnalysis(_5132.CouplingHalfCompoundModalAnalysis):
    '''ClutchHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4962.ClutchHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4962.ClutchHalfModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4962.ClutchHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4962.ClutchHalfModalAnalysis))
        return value
