...
class CylindricalPlanetGearCompoundModalAnalysis(_4953.CylindricalGearCompoundModalAnalysis):
    '''CylindricalPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4804.CylindricalPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4804.CylindricalPlanetGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4804.CylindricalPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4804.CylindricalPlanetGearModalAnalysis))
        return value
