...
class SynchroniserCompoundModalAnalysis(_5004.SpecialisedAssemblyCompoundModalAnalysis):
    '''SynchroniserCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4874.SynchroniserModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4874.SynchroniserModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4874.SynchroniserModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4874.SynchroniserModalAnalysis))
        return value
