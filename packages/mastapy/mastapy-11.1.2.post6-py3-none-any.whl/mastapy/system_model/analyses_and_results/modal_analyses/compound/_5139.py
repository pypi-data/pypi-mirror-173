...
from mastapy.system_model.analyses_and_results.modal_analyses import _4987
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5096
...
class CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis(_5096.AbstractShaftToMountableComponentConnectionCompoundModalAnalysis):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4987.CycloidalDiscPlanetaryBearingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4987.CycloidalDiscPlanetaryBearingConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4987.CycloidalDiscPlanetaryBearingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4987.CycloidalDiscPlanetaryBearingConnectionModalAnalysis))
        return value
