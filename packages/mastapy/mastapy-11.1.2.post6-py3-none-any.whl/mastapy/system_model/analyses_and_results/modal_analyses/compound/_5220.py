...
from mastapy.system_model.analyses_and_results.modal_analyses import _5078
...
class ZerolBevelGearMeshCompoundModalAnalysis(_5110.BevelGearMeshCompoundModalAnalysis):
    '''ZerolBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5078.ZerolBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5078.ZerolBevelGearMeshModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5078.ZerolBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5078.ZerolBevelGearMeshModalAnalysis))
        return value
