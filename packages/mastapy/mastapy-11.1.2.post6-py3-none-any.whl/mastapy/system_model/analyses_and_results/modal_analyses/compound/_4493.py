...
from mastapy.system_model.analyses_and_results.modal_analyses import _4339
...
class ConceptCouplingHalfCompoundModalAnalysis(_4504.CouplingHalfCompoundModalAnalysis):
    """ConceptCouplingHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4339.ConceptCouplingHalfModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4339.ConceptCouplingHalfModalAnalysis]':
