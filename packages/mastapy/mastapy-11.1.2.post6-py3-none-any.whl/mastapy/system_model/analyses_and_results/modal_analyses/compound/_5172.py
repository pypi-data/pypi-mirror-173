...
class PartCompoundModalAnalysis(_7377.PartCompoundAnalysis):
    '''PartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5025.PartModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5025.PartModalAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5025.PartModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5025.PartModalAnalysis))
        return value
