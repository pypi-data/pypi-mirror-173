...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    @property
    def mode_options(self) -> '_157.EigenvalueOptions':
        ...
        return constructor.new(_157.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions is not None else None
