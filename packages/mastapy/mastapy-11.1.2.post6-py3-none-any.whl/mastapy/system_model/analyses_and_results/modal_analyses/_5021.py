...
class ModalAnalysisOptions(_0.APIBase):
    ...
    @property
    def frequency_response_options_for_reports(self) -> '_4999.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4999.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptionsForReports) if self.wrapped.FrequencyResponseOptionsForReports is not None else None
