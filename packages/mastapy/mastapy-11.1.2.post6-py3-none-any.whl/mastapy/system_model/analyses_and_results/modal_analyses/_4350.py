...
class CouplingConnectionModalAnalysis(_4379.InterMountableComponentConnectionModalAnalysis):
    """CouplingConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2473.CouplingConnectionSystemDeflection':
