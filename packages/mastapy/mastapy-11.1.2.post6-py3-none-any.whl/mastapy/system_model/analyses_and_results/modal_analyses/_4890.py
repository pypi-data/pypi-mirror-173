...
from mastapy.system_model.analyses_and_results.modal_analyses import _4889, _4888, _4815
...
class WormGearSetModalAnalysis(_4815.GearSetModalAnalysis):
    '''WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self) -> 'List[_4889.WormGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysis, constructor.new(_4889.WormGearModalAnalysis))
        return value

    @property
    def worm_meshes_modal_analysis(self) -> 'List[_4888.WormGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysis, constructor.new(_4888.WormGearMeshModalAnalysis))
        return value
