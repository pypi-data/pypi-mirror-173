...
from mastapy.system_model.analyses_and_results.modal_analyses import _2495, _4947
...
class RootAssemblyModalAnalysis(_4947.AssemblyModalAnalysis):
    '''RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_2495.ModalAnalysis':
        ...
        if _2495.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysisInputs.__class__.__mro__:
