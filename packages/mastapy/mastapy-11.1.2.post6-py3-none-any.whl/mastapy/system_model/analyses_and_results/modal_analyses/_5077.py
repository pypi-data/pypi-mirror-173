...
from mastapy.system_model.analyses_and_results.modal_analyses import _5076, _5075, _5002
...
class WormGearSetModalAnalysis(_5002.GearSetModalAnalysis):
    '''WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self) -> 'List[_5076.WormGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysis, constructor.new(_5076.WormGearModalAnalysis))
        return value

    @property
    def worm_meshes_modal_analysis(self) -> 'List[_5075.WormGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysis, constructor.new(_5075.WormGearMeshModalAnalysis))
        return value
