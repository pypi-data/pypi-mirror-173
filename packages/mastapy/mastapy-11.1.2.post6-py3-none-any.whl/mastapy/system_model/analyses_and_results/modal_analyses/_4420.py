...
from mastapy.system_model.analyses_and_results.modal_analyses import _4419, _4418, _4330
...
class SpiralBevelGearSetModalAnalysis(_4330.BevelGearSetModalAnalysis):
    """SpiralBevelGearSetModalAnalysis
    ...
    @property
    def spiral_bevel_gears_modal_analysis(self) -> 'List[_4419.SpiralBevelGearModalAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_modal_analysis(self) -> 'List[_4418.SpiralBevelGearMeshModalAnalysis]':
