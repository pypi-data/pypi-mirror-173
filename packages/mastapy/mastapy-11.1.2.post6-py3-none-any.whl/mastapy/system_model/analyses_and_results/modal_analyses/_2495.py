...
from mastapy.system_model.analyses_and_results.modal_analyses import _2489, _5021, _5019
...
class ModalAnalysis(_7381.StaticLoadAnalysisCase):
    '''ModalAnalysis
    ...
    @property
    def modal_analysis_results(self) -> '_2486.DynamicAnalysis':
        ...
        if _2486.DynamicAnalysis.TYPE not in self.wrapped.ModalAnalysisResults.__class__.__mro__:
    ...
    @property
    def analysis_settings(self) -> '_5021.ModalAnalysisOptions':
        ...
        return constructor.new(_5021.ModalAnalysisOptions)(self.wrapped.AnalysisSettings) if self.wrapped.AnalysisSettings is not None else None

    @property
    def bar_model_export(self) -> '_5019.ModalAnalysisBarModelFEExportOptions':
        ...
        return constructor.new(_5019.ModalAnalysisBarModelFEExportOptions)(self.wrapped.BarModelExport) if self.wrapped.BarModelExport is not None else None
