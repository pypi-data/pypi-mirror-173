...
from mastapy.system_model.analyses_and_results.modal_analyses import _2311, _4760
...
class RootAssemblyModalAnalysis(_4760.AssemblyModalAnalysis):
    '''RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_2311.ModalAnalysis':
        ...
        if _2311.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysisInputs.__class__.__mro__:
