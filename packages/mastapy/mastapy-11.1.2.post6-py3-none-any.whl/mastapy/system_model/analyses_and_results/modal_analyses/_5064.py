...
class TorqueConverterConnectionModalAnalysis(_4978.CouplingConnectionModalAnalysis):
    '''TorqueConverterConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2683.TorqueConverterConnectionSystemDeflection':
        ...
        return constructor.new(_2683.TorqueConverterConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
