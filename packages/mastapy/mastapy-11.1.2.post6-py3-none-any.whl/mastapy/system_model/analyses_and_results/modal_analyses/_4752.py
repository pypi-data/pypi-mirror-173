...
from mastapy.system_model.analyses_and_results.modal_analyses import _4777, _4812, _4837
...
class AbstractAssemblyModalAnalysis(_4837.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4777.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4777.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4812.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4812.GearMeshModalAnalysis))
        return value
