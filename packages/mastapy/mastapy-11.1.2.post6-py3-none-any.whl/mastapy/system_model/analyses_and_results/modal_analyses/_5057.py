...
from mastapy.system_model.analyses_and_results.modal_analyses import _5056, _5055, _4958
...
class StraightBevelGearSetModalAnalysis(_4958.BevelGearSetModalAnalysis):
    '''StraightBevelGearSetModalAnalysis
    ...
    @property
    def straight_bevel_gears_modal_analysis(self) -> 'List[_5056.StraightBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysis, constructor.new(_5056.StraightBevelGearModalAnalysis))
        return value

    @property
    def straight_bevel_meshes_modal_analysis(self) -> 'List[_5055.StraightBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysis, constructor.new(_5055.StraightBevelGearMeshModalAnalysis))
        return value
