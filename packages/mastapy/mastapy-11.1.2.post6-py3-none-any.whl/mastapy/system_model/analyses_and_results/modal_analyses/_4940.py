...
from mastapy.system_model.analyses_and_results.modal_analyses import _4965, _5000, _5025
...
class AbstractAssemblyModalAnalysis(_5025.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4965.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4965.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_5000.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_5000.GearMeshModalAnalysis))
        return value
