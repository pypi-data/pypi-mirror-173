...
from mastapy.system_model.analyses_and_results.modal_analyses import _4869, _4868, _4771
...
class StraightBevelGearSetModalAnalysis(_4771.BevelGearSetModalAnalysis):
    '''StraightBevelGearSetModalAnalysis
    ...
    @property
    def straight_bevel_gears_modal_analysis(self) -> 'List[_4869.StraightBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysis, constructor.new(_4869.StraightBevelGearModalAnalysis))
        return value

    @property
    def straight_bevel_meshes_modal_analysis(self) -> 'List[_4868.StraightBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysis, constructor.new(_4868.StraightBevelGearMeshModalAnalysis))
        return value
