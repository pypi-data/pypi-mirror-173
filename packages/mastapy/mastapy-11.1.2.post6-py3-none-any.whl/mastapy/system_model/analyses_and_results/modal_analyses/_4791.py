...
class CouplingConnectionModalAnalysis(_4820.InterMountableComponentConnectionModalAnalysis):
    '''CouplingConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2399.CouplingConnectionSystemDeflection':
