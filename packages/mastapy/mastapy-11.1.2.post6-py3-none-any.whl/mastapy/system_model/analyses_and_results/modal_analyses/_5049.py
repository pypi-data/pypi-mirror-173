...
class SpringDamperConnectionModalAnalysis(_4978.CouplingConnectionModalAnalysis):
    '''SpringDamperConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2665.SpringDamperConnectionSystemDeflection':
        ...
        return constructor.new(_2665.SpringDamperConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
