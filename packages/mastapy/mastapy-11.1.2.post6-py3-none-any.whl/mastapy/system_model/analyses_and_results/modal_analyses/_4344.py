...
class ConicalGearMeshModalAnalysis(_4372.GearMeshModalAnalysis):
    """ConicalGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2468.ConicalGearMeshSystemDeflection':
