...
from mastapy.system_model.analyses_and_results.modal_analyses import _4818, _4817, _4759
...
class HypoidGearSetModalAnalysis(_4759.AGMAGleasonConicalGearSetModalAnalysis):
    '''HypoidGearSetModalAnalysis
    ...
    @property
    def hypoid_gears_modal_analysis(self) -> 'List[_4818.HypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysis, constructor.new(_4818.HypoidGearModalAnalysis))
        return value

    @property
    def hypoid_meshes_modal_analysis(self) -> 'List[_4817.HypoidGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysis, constructor.new(_4817.HypoidGearMeshModalAnalysis))
        return value
