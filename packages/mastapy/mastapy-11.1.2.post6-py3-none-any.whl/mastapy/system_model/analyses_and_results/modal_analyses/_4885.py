...
TMeasurement = TypeVar('TMeasurement', bound='_1362.MeasurementBase')


class WhineWaterfallReferenceValues(_4886.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    '''WhineWaterfallReferenceValues
