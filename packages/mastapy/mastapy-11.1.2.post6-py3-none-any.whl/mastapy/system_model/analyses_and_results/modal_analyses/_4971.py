...
from mastapy.system_model.analyses_and_results.modal_analyses import _4970, _4969, _5002
...
class ConceptGearSetModalAnalysis(_5002.GearSetModalAnalysis):
    '''ConceptGearSetModalAnalysis
    ...
    @property
    def concept_gears_modal_analysis(self) -> 'List[_4970.ConceptGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysis, constructor.new(_4970.ConceptGearModalAnalysis))
        return value

    @property
    def concept_meshes_modal_analysis(self) -> 'List[_4969.ConceptGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysis, constructor.new(_4969.ConceptGearMeshModalAnalysis))
        return value
