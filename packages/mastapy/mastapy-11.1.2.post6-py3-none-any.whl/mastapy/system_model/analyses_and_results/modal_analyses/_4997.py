...
class FEPartModalAnalysis(_4942.AbstractShaftOrHousingModalAnalysis):
    '''FEPartModalAnalysis
    ...
    @property
    def modal_full_fe_results(self) -> 'List[_207.ModalCMSResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ModalFullFEResults, constructor.new(_207.ModalCMSResults))
        return value
