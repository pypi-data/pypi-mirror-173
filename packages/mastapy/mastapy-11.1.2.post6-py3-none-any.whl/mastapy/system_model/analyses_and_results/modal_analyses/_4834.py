...
class ModalAnalysisOptions(_0.APIBase):
    ...
    @property
    def frequency_response_options_for_reports(self) -> '_4812.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4812.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptionsForReports) if self.wrapped.FrequencyResponseOptionsForReports else None
