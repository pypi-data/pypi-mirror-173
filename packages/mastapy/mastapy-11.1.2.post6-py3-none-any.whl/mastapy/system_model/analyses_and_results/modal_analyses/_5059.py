...
class StraightBevelSunGearModalAnalysis(_5053.StraightBevelDiffGearModalAnalysis):
    '''StraightBevelSunGearModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2675.StraightBevelSunGearSystemDeflection':
        ...
        return constructor.new(_2675.StraightBevelSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
