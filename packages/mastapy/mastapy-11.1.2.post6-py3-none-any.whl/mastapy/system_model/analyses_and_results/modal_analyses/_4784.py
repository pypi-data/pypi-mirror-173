...
from mastapy.system_model.analyses_and_results.modal_analyses import _4783, _4782, _4815
...
class ConceptGearSetModalAnalysis(_4815.GearSetModalAnalysis):
    '''ConceptGearSetModalAnalysis
    ...
    @property
    def concept_gears_modal_analysis(self) -> 'List[_4783.ConceptGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsModalAnalysis, constructor.new(_4783.ConceptGearModalAnalysis))
        return value

    @property
    def concept_meshes_modal_analysis(self) -> 'List[_4782.ConceptGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesModalAnalysis, constructor.new(_4782.ConceptGearMeshModalAnalysis))
        return value
