...
from mastapy.system_model.analyses_and_results.modal_analyses import _5073
...
TMeasurement = TypeVar('TMeasurement', bound='_1500.MeasurementBase')


class WhineWaterfallReferenceValues(_5073.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    '''WhineWaterfallReferenceValues
