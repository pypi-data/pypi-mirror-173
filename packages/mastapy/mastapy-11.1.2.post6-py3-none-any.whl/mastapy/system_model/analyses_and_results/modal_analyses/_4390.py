...
from mastapy.system_model.analyses_and_results.modal_analyses import _4441
...
class MeasurementComponentModalAnalysis(_4441.VirtualComponentModalAnalysis):
    """MeasurementComponentModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2524.MeasurementComponentSystemDeflection':
