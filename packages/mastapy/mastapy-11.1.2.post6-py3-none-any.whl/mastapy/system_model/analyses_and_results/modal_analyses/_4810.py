...
class FEPartModalAnalysis(_4755.AbstractShaftOrHousingModalAnalysis):
    '''FEPartModalAnalysis
    ...
    @property
    def modal_full_fe_results(self) -> 'List[_202.ModalCMSResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ModalFullFEResults, constructor.new(_202.ModalCMSResults))
        return value
