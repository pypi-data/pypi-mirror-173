...
from mastapy.math_utility import (
    _1406, _1434, _1394, _1420,
    _1405, _1389, _1404, _1427
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4977, _5071, _5070, _5024,
    _5072
)
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import (
    _5940, _5943, _5948, _5949
)
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5866, _5854, _5908
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6904
from mastapy._internal.cast_exception import CastException
from mastapy.system_model.drawing.options import _2125, _2123
from mastapy.utility.units_and_measurements.measurements import (
    _1564, _1510, _1625, _1516,
    _1507, _1512, _1536, _1618,
    _1530, _1586, _1587, _1592
)
from mastapy.utility.property import _1729
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def translation_or_rotation(self) -> '_1434.TranslationRotation':
        ...
        return constructor.new(_1434.TranslationRotation)(value) if value is not None else None

    @translation_or_rotation.setter
    def translation_or_rotation(self, value: '_1434.TranslationRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TranslationOrRotation = value

    @property
    def coordinate_system(self) -> '_4977.CoordinateSystemForWhine':
        ...
        return constructor.new(_4977.CoordinateSystemForWhine)(value) if value is not None else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4977.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def vector_magnitude_method(self) -> '_1420.ComplexMagnitudeMethod':
        ...
        return constructor.new(_1420.ComplexMagnitudeMethod)(value) if value is not None else None

    @vector_magnitude_method.setter
    def vector_magnitude_method(self, value: '_1420.ComplexMagnitudeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def weighting(self) -> '_1389.AcousticWeighting':
        '''AcousticWeighting: 'Weighting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Weighting)
        return constructor.new(_1389.AcousticWeighting)(value) if value is not None else None

    @weighting.setter
    def weighting(self, value: '_1389.AcousticWeighting'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def chart_type(self) -> '_1404.DynamicsResponse3DChartType':
        ...
        return constructor.new(_1404.DynamicsResponse3DChartType)(value) if value is not None else None

    @chart_type.setter
    def chart_type(self, value: '_1404.DynamicsResponse3DChartType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def connected_component_type(self) -> '_5940.ConnectedComponentType':
        ...
        return constructor.new(_5940.ConnectedComponentType)(value) if value is not None else None

    @connected_component_type.setter
    def connected_component_type(self, value: '_5940.ConnectedComponentType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ConnectedComponentType = value

    @property
    def whine_waterfall_export_option(self) -> '_5071.WhineWaterfallExportOption':
        ...
        return constructor.new(_5071.WhineWaterfallExportOption)(value) if value is not None else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_5071.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def selected_excitations(self) -> '_5943.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5943.ExcitationSourceSelectionGroup)(self.wrapped.SelectedExcitations) if self.wrapped.SelectedExcitations is not None else None

    @property
    def waterfall_chart_settings(self) -> '_5070.WaterfallChartSettings':
        ...
        return constructor.new(_5070.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings is not None else None

    @property
    def order_cuts_chart_settings(self) -> '_5024.OrderCutsChartSettings':
        ...
        return constructor.new(_5024.OrderCutsChartSettings)(self.wrapped.OrderCutsChartSettings) if self.wrapped.OrderCutsChartSettings is not None else None

    @property
    def modal_contribution_view_options(self) -> '_2125.ModalContributionViewOptions':
        ...
        return constructor.new(_2125.ModalContributionViewOptions)(self.wrapped.ModalContributionViewOptions) if self.wrapped.ModalContributionViewOptions is not None else None

    @property
    def mode_view_options(self) -> '_2123.AdvancedTimeSteppingAnalysisForModulationModeViewOptions':
        ...
        return constructor.new(_2123.AdvancedTimeSteppingAnalysisForModulationModeViewOptions)(self.wrapped.ModeViewOptions) if self.wrapped.ModeViewOptions is not None else None
    ...
    @property
    def very_short_length_reference_values(self) -> '_5072.WhineWaterfallReferenceValues[_1564.LengthVeryShort]':
        ...
        return constructor.new(_5072.WhineWaterfallReferenceValues)[_1564.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues is not None else None

    @property
    def small_angle_reference_values(self) -> '_5072.WhineWaterfallReferenceValues[_1510.AngleSmall]':
        ...
        return constructor.new(_5072.WhineWaterfallReferenceValues)[_1510.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues is not None else None

    @property
    def small_velocity_reference_values(self) -> '_5072.WhineWaterfallReferenceValues[_1625.VelocitySmall]':
        ...
        return constructor.new(_5072.WhineWaterfallReferenceValues)[_1625.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues is not None else None

    @property
    def angular_velocity_reference_values(self) -> '_5072.WhineWaterfallReferenceValues[_1516.AngularVelocity]':
        ...
        return constructor.new(_5072.WhineWaterfallReferenceValues)[_1516.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues is not None else None

    @property
    def acceleration_reference_values(self) -> '_5072.WhineWaterfallReferenceValues[_1507.Acceleration]':
        ...
        return constructor.new(_5072.WhineWaterfallReferenceValues)[_1507.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues is not None else None

    @property
    def angular_acceleration_reference_values(self) -> '_5072.WhineWaterfallReferenceValues[_1512.AngularAcceleration]':
        ...
        return constructor.new(_5072.WhineWaterfallReferenceValues)[_1512.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues is not None else None

    @property
    def force_reference_values(self) -> '_5072.WhineWaterfallReferenceValues[_1536.Force]':
        ...
        return constructor.new(_5072.WhineWaterfallReferenceValues)[_1536.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues is not None else None

    @property
    def torque_reference_values(self) -> '_5072.WhineWaterfallReferenceValues[_1618.Torque]':
        ...
        return constructor.new(_5072.WhineWaterfallReferenceValues)[_1618.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues is not None else None

    @property
    def energy_reference_values(self) -> '_5072.WhineWaterfallReferenceValues[_1530.Energy]':
        ...
        return constructor.new(_5072.WhineWaterfallReferenceValues)[_1530.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues is not None else None

    @property
    def power_small_reference_values(self) -> '_5072.WhineWaterfallReferenceValues[_1586.PowerSmall]':
        ...
        return constructor.new(_5072.WhineWaterfallReferenceValues)[_1586.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues is not None else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_5072.WhineWaterfallReferenceValues[_1587.PowerSmallPerArea]':
        ...
        return constructor.new(_5072.WhineWaterfallReferenceValues)[_1587.PowerSmallPerArea](self.wrapped.PowerSmallPerUnitAreaReferenceValues) if self.wrapped.PowerSmallPerUnitAreaReferenceValues is not None else None

    @property
    def pressure_reference_values(self) -> '_5072.WhineWaterfallReferenceValues[_1592.Pressure]':
        ...
        return constructor.new(_5072.WhineWaterfallReferenceValues)[_1592.Pressure](self.wrapped.PressureReferenceValues) if self.wrapped.PressureReferenceValues is not None else None

    @property
    def result_location_selection_groups(self) -> '_5948.ResultLocationSelectionGroups':
        ...
        return constructor.new(_5948.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups is not None else None

    @property
    def active_result_locations(self) -> 'List[_5949.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_5949.ResultNodeSelection))
        return value

    @property
    def degrees_of_freedom(self) -> 'List[_1729.EnumWithBool[_1427.ResultOptionsFor3DVector]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedom, constructor.new(_1729.EnumWithBool)[_1427.ResultOptionsFor3DVector])
        return value
