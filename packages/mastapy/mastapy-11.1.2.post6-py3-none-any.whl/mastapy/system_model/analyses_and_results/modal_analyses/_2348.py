...
class ModalAnalysis(_7240.StaticLoadAnalysisCase):
    ...
    def analysis_settings(self) -> '_4874.ModalAnalysisOptions':
        ...
        return constructor.new(_4874.ModalAnalysisOptions)(self.wrapped.AnalysisSettings) if self.wrapped.AnalysisSettings is not None else None
    ...
    def bar_model_export(self) -> '_4872.ModalAnalysisBarModelFEExportOptions':
        ...
        return constructor.new(_4872.ModalAnalysisBarModelFEExportOptions)(self.wrapped.BarModelExport) if self.wrapped.BarModelExport is not None else None
