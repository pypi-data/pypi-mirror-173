...
from mastapy.system_model.analyses_and_results.modal_analyses import _4387, _4386, _4382
...
class KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis(_4382.KlingelnbergCycloPalloidConicalGearSetModalAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears_modal_analysis(self) -> 'List[_4387.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes_modal_analysis(self) -> 'List[_4386.KlingelnbergCycloPalloidSpiralBevelGearMeshModalAnalysis]':
