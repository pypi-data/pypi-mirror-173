...
from mastapy.system_model.analyses_and_results.modal_analyses import _5047, _5046, _4958
...
class SpiralBevelGearSetModalAnalysis(_4958.BevelGearSetModalAnalysis):
    '''SpiralBevelGearSetModalAnalysis
    ...
    @property
    def spiral_bevel_gears_modal_analysis(self) -> 'List[_5047.SpiralBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysis, constructor.new(_5047.SpiralBevelGearModalAnalysis))
        return value

    @property
    def spiral_bevel_meshes_modal_analysis(self) -> 'List[_5046.SpiralBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysis, constructor.new(_5046.SpiralBevelGearMeshModalAnalysis))
        return value
