...
from mastapy.system_model.analyses_and_results.modal_analyses import _4448, _4447, _4374
...
class WormGearSetModalAnalysis(_4374.GearSetModalAnalysis):
    """WormGearSetModalAnalysis
    ...
    @property
    def worm_gears_modal_analysis(self) -> 'List[_4448.WormGearModalAnalysis]':
    ...
    @property
    def worm_meshes_modal_analysis(self) -> 'List[_4447.WormGearMeshModalAnalysis]':
