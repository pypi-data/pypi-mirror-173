...
class ClutchConnectionModalAnalysis(_4978.CouplingConnectionModalAnalysis):
    '''ClutchConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2566.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2566.ClutchConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults is not None else None
