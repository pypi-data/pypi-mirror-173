...
class AbstractShaftOrHousingModalAnalysis(_4965.ComponentModalAnalysis):
    '''AbstractShaftOrHousingModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2546.AbstractShaftOrHousingSystemDeflection':
