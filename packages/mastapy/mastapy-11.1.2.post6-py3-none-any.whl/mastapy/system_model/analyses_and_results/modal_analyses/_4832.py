...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    @property
    def mode_options(self) -> '_152.EigenvalueOptions':
        ...
        return constructor.new(_152.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions else None
    ...
    def set_fe_file_to_include(self, file_path: 'str', format_: '_150.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0):
