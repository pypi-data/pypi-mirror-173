...
from mastapy.bearings.bearing_results import _1837, _1836
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    @property
    def mounting_sleeve_material(self) -> '_220.BearingMaterial':
        ...
        return constructor.new(_220.BearingMaterial)(self.wrapped.MountingSleeveMaterial) if self.wrapped.MountingSleeveMaterial is not None else None
