...
from mastapy.bearings.bearing_results import _1668, _1667
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    @property
    def mounting_sleeve_material(self) -> '_214.BearingMaterial':
        ...
        return constructor.new(_214.BearingMaterial)(self.wrapped.MountingSleeveMaterial) if self.wrapped.MountingSleeveMaterial else None
