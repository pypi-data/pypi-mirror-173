...
class WindTurbineSingleBladeDetails(_0.APIBase):
    ...
    @property
    def edgewise_modes(self) -> '_2158.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_2158.WindTurbineBladeModeDetails)(self.wrapped.EdgewiseModes) if self.wrapped.EdgewiseModes else None

    @property
    def flapwise_modes(self) -> '_2158.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_2158.WindTurbineBladeModeDetails)(self.wrapped.FlapwiseModes) if self.wrapped.FlapwiseModes else None
