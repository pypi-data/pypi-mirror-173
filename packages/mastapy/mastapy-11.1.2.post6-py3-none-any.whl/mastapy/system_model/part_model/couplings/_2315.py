...
class Synchroniser(_2190.SpecialisedAssembly):
    ...
    def hub_and_sleeve(self) -> '_2319.SynchroniserSleeve':
        ...
        return constructor.new(_2319.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve is not None else None
    ...
    def left_cone(self) -> '_2317.SynchroniserHalf':
        ...
        return constructor.new(_2317.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone is not None else None
    ...
    def right_cone(self) -> '_2317.SynchroniserHalf':
        ...
        return constructor.new(_2317.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone is not None else None
    ...
    def clutch_connection_left(self) -> '_2057.ClutchConnection':
        ...
        return constructor.new(_2057.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft is not None else None
    ...
    def clutch_connection_right(self) -> '_2057.ClutchConnection':
        ...
        return constructor.new(_2057.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight is not None else None
