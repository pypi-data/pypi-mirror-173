...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def crowning(self) -> '_2262.CrowningSpecification':
        ...
        return constructor.new(_2262.CrowningSpecification)(self.wrapped.Crowning) if self.wrapped.Crowning else None
