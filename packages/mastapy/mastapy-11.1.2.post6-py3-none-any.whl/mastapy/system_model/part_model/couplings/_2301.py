...
class PartToPartShearCoupling(_2296.Coupling):
    ...
    def part_to_part_shear_coupling_connection(self) -> '_2063.PartToPartShearCouplingConnection':
        ...
        return constructor.new(_2063.PartToPartShearCouplingConnection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection is not None else None
