...
from mastapy.system_model.part_model.couplings import _2468, _2470, _2443
...
class TorqueConverter(_2443.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2468.TorqueConverterPump':
        ...
        return constructor.new(_2468.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump is not None else None

    @property
    def turbine(self) -> '_2470.TorqueConverterTurbine':
        ...
        return constructor.new(_2470.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine is not None else None
