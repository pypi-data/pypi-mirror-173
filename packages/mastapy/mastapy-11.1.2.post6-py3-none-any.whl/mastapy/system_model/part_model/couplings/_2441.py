...
class ConceptCoupling(_2443.Coupling):
    '''ConceptCoupling
    ...
    @property
    def efficiency_vs_speed_ratio(self) -> '_1435.Vector2DListAccessor':
        '''Vector2DListAccessor: 'EfficiencyVsSpeedRatio' is the original name of this property.'''

        return constructor.new(_1435.Vector2DListAccessor)(self.wrapped.EfficiencyVsSpeedRatio) if self.wrapped.EfficiencyVsSpeedRatio is not None else None

    @efficiency_vs_speed_ratio.setter
    def efficiency_vs_speed_ratio(self, value: '_1435.Vector2DListAccessor'):
