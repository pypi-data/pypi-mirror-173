...
from mastapy.system_model.part_model.couplings import _2253, _2266
...
class BeltDrive(_2154.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2253.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2253.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2253.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2266.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2266.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1949.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1949.BeltConnection))
        return value
