...
class TorqueConverter(_2296.Coupling):
    ...
    def pump(self) -> '_2321.TorqueConverterPump':
        ...
        return constructor.new(_2321.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump is not None else None
    ...
    def turbine(self) -> '_2323.TorqueConverterTurbine':
        ...
        return constructor.new(_2323.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine is not None else None
