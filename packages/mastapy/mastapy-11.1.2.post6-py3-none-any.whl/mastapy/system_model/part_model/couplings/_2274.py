...
class RollingRingAssembly(_2155.SpecialisedAssembly):
    '''RollingRingAssembly
    ...
    @property
    def rolling_rings(self) -> 'List[_2273.RollingRing]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RollingRings, constructor.new(_2273.RollingRing))
        return value
