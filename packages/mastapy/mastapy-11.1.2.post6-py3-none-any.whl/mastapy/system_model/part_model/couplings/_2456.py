...
from mastapy.system_model.part_model.couplings import _2444
...
class RollingRing(_2444.CouplingHalf):
    '''RollingRing
    ...
    @property
    def largest_end(self) -> '_304.Hand':
    ...
    @largest_end.setter
    def largest_end(self, value: '_304.Hand'):
