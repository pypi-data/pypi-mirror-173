...
from mastapy.system_model.part_model.couplings import _2437, _2450
from mastapy.system_model.connections_and_sockets import _2130
...
class BeltDrive(_2337.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2437.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2437.BeltDriveType)(value) if value is not None else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2437.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2450.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2450.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_2130.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_2130.BeltConnection))
        return value
