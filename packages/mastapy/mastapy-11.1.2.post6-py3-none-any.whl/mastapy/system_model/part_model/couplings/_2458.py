...
from mastapy.system_model.part_model.couplings import (
    _2452, _2455, _2451, _2454,
    _2459, _2453
)
from mastapy.detailed_rigid_connectors.splines import (
    _1311, _1296, _1316, _1291,
    _1294, _1298, _1301, _1302,
    _1309, _1321
)
...
class ShaftHubConnection(_2309.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2452.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2452.RigidConnectorTiltStiffnessTypes)(value) if value is not None else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2452.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def spline_type(self) -> '_1311.SplineDesignTypes':
        '''SplineDesignTypes: 'SplineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SplineType)
        return constructor.new(_1311.SplineDesignTypes)(value) if value is not None else None

    @spline_type.setter
    def spline_type(self, value: '_1311.SplineDesignTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def spline_joint_design(self) -> '_1316.SplineJointDesign':
        ...
        if _1316.SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_custom_spline_joint_design(self) -> '_1291.CustomSplineJointDesign':
        ...
        if _1291.CustomSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_din5480_spline_joint_design(self) -> '_1294.DIN5480SplineJointDesign':
        ...
        if _1294.DIN5480SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_gbt3478_spline_joint_design(self) -> '_1298.GBT3478SplineJointDesign':
        ...
        if _1298.GBT3478SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_iso4156_spline_joint_design(self) -> '_1301.ISO4156SplineJointDesign':
        ...
        if _1301.ISO4156SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_jisb1603_spline_joint_design(self) -> '_1302.JISB1603SplineJointDesign':
        ...
        if _1302.JISB1603SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_sae_spline_joint_design(self) -> '_1309.SAESplineJointDesign':
        ...
        if _1309.SAESplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_standard_spline_joint_design(self) -> '_1321.StandardSplineJointDesign':
        ...
        if _1321.StandardSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def interference_fit_design(self) -> '_1346.InterferenceFitDesign':
        ...
        if _1346.InterferenceFitDesign.TYPE not in self.wrapped.InterferenceFitDesign.__class__.__mro__:
    ...
    @property
    def left_flank_lead_relief(self) -> '_2459.SplineLeadRelief':
        ...
        return constructor.new(_2459.SplineLeadRelief)(self.wrapped.LeftFlankLeadRelief) if self.wrapped.LeftFlankLeadRelief is not None else None

    @property
    def right_flank_lead_relief(self) -> '_2459.SplineLeadRelief':
        ...
        return constructor.new(_2459.SplineLeadRelief)(self.wrapped.RightFlankLeadRelief) if self.wrapped.RightFlankLeadRelief is not None else None

    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2453.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2453.RigidConnectorToothLocation))
        return value

    @property
    def lead_reliefs(self) -> 'List[_2459.SplineLeadRelief]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeadReliefs, constructor.new(_2459.SplineLeadRelief))
        return value
