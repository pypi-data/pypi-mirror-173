...
from mastapy.system_model.part_model.couplings import _2254, _2267
...
class BeltDrive(_2155.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2254.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2254.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2254.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2267.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2267.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1950.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1950.BeltConnection))
        return value
