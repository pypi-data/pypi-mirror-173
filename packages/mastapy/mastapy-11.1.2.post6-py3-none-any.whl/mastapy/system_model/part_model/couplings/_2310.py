...
class RollingRingAssembly(_2190.SpecialisedAssembly):
    '''RollingRingAssembly
    ...
    @property
    def rolling_rings(self) -> 'List[_2309.RollingRing]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RollingRings, constructor.new(_2309.RollingRing))
        return value
