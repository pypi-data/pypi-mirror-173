...
from mastapy.system_model.part_model.couplings import _2463, _2465
...
class SynchroniserHalf(_2465.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2463.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2463.SynchroniserCone))
        return value
