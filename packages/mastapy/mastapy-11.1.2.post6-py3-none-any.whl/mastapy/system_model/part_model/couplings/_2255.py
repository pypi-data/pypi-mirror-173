...
from mastapy.system_model.part_model.couplings import _2257, _2260
...
class Clutch(_2260.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2257.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2257.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2257.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_5061.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_5061.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_5061.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_2024.ClutchConnection':
        ...
        return constructor.new(_2024.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
