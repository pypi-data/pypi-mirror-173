...
from mastapy.system_model.part_model.couplings import _2285, _2287, _2260
...
class TorqueConverter(_2260.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2285.TorqueConverterPump':
        ...
        return constructor.new(_2285.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2287.TorqueConverterTurbine':
        ...
        return constructor.new(_2287.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
