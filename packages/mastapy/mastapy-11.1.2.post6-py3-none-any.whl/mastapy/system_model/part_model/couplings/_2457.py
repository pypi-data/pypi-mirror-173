...
class RollingRingAssembly(_2337.SpecialisedAssembly):
    '''RollingRingAssembly
    ...
    @property
    def rolling_rings(self) -> 'List[_2456.RollingRing]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RollingRings, constructor.new(_2456.RollingRing))
        return value
