...
class SpringDamper(_2260.Coupling):
    '''SpringDamper
    ...
    @property
    def connection(self) -> '_2032.SpringDamperConnection':
        ...
        return constructor.new(_2032.SpringDamperConnection)(self.wrapped.Connection) if self.wrapped.Connection else None
