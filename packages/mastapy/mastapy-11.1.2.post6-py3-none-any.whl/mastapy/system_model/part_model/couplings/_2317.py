...
from mastapy.system_model.part_model.couplings import _2316, _2318
...
class SynchroniserHalf(_2318.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2316.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2316.SynchroniserCone))
        return value
