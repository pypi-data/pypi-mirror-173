...
from mastapy.system_model.part_model.couplings import _2283, _2281
...
class Synchroniser(_2155.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2283.SynchroniserSleeve':
        ...
        return constructor.new(_2283.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2281.SynchroniserHalf':
        ...
        return constructor.new(_2281.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2281.SynchroniserHalf':
        ...
        return constructor.new(_2281.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None

    @property
    def clutch_connection_left(self) -> '_2024.ClutchConnection':
        ...
        return constructor.new(_2024.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft else None

    @property
    def clutch_connection_right(self) -> '_2024.ClutchConnection':
        ...
        return constructor.new(_2024.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight else None
