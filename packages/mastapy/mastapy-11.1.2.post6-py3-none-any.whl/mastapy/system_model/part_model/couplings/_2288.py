...
class ConceptCoupling(_2290.Coupling):
    '''ConceptCoupling
    ...
    @property
    def efficiency_vs_speed_ratio(self) -> '_1315.Vector2DListAccessor':
        '''Vector2DListAccessor: 'EfficiencyVsSpeedRatio' is the original name of this property.'''

        return constructor.new(_1315.Vector2DListAccessor)(self.wrapped.EfficiencyVsSpeedRatio) if self.wrapped.EfficiencyVsSpeedRatio else None

    @efficiency_vs_speed_ratio.setter
    def efficiency_vs_speed_ratio(self, value: '_1315.Vector2DListAccessor'):
