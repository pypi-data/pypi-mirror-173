...
class PartToPartShearCoupling(_2260.Coupling):
    '''PartToPartShearCoupling
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_2030.PartToPartShearCouplingConnection':
        ...
        return constructor.new(_2030.PartToPartShearCouplingConnection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection else None
