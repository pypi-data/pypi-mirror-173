...
from mastapy.cycloidal import _1242, _1243
...
class RingPins(_2172.MountableComponent):
    '''RingPins
    ...
    @property
    def ring_pins_design(self) -> '_1242.RingPinsDesign':
        ...
        return constructor.new(_1242.RingPinsDesign)(self.wrapped.RingPinsDesign) if self.wrapped.RingPinsDesign else None

    @property
    def ring_pins_material(self) -> '_1243.RingPinsMaterial':
        ...
        return constructor.new(_1243.RingPinsMaterial)(self.wrapped.RingPinsMaterial) if self.wrapped.RingPinsMaterial else None
