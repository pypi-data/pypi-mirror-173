...
from mastapy.cycloidal import _1355, _1356, _1362
from mastapy.system_model.part_model import _2322, _2298
from mastapy.materials import _242, _220
...
from mastapy.electric_machines import _1232, _1250, _1261
from mastapy.detailed_rigid_connectors.splines import _1317
from mastapy.bolts import _1365, _1369
from mastapy.system_model.connections_and_sockets.cycloidal import _2201
...
class CycloidalDisc(_2298.AbstractShaft):
    '''CycloidalDisc
    ...
    @property
    def cycloidal_disc_design(self) -> '_1355.CycloidalDiscDesign':
        ...
        return constructor.new(_1355.CycloidalDiscDesign)(self.wrapped.CycloidalDiscDesign) if self.wrapped.CycloidalDiscDesign is not None else None
    ...
    @property
    def disc_material(self) -> '_242.Material':
        ...
        if _242.Material.TYPE not in self.wrapped.DiscMaterial.__class__.__mro__:
    ...
    @property
    def planetary_bearing_sockets(self) -> 'List[_2201.CycloidalDiscPlanetaryBearingSocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetaryBearingSockets, constructor.new(_2201.CycloidalDiscPlanetaryBearingSocket))
        return value
