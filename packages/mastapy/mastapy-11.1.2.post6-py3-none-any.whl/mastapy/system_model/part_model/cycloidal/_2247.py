...
from mastapy.cycloidal import _1226, _1227
...
class RingPins(_2143.MountableComponent):
    '''RingPins
    ...
    @property
    def ring_pins_design(self) -> '_1226.RingPinsDesign':
        ...
        return constructor.new(_1226.RingPinsDesign)(self.wrapped.RingPinsDesign) if self.wrapped.RingPinsDesign else None

    @property
    def ring_pins_material(self) -> '_1227.RingPinsMaterial':
        ...
        return constructor.new(_1227.RingPinsMaterial)(self.wrapped.RingPinsMaterial) if self.wrapped.RingPinsMaterial else None
