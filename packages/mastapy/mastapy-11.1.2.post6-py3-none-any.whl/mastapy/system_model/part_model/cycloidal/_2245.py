...
class CycloidalAssembly(_2155.SpecialisedAssembly):
    '''CycloidalAssembly
    ...
    @property
    def cycloidal_assembly_design(self) -> '_1219.CycloidalAssemblyDesign':
        ...
        return constructor.new(_1219.CycloidalAssemblyDesign)(self.wrapped.CycloidalAssemblyDesign) if self.wrapped.CycloidalAssemblyDesign else None
