...
from mastapy.cycloidal import _1236, _1237, _1243
from mastapy.system_model.part_model import _2169, _2145
...
from mastapy.system_model.connections_and_sockets.cycloidal import _2048
...
class CycloidalDisc(_2145.AbstractShaft):
    '''CycloidalDisc
    ...
    @property
    def cycloidal_disc_design(self) -> '_1236.CycloidalDiscDesign':
        ...
        return constructor.new(_1236.CycloidalDiscDesign)(self.wrapped.CycloidalDiscDesign) if self.wrapped.CycloidalDiscDesign else None
    ...
    @property
    def planetary_bearing_sockets(self) -> 'List[_2048.CycloidalDiscPlanetaryBearingSocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetaryBearingSockets, constructor.new(_2048.CycloidalDiscPlanetaryBearingSocket))
        return value
