...
from mastapy.cycloidal import _1220, _1221, _1227
from mastapy.system_model.part_model import _2140, _2116
from mastapy.materials import _236, _214
...
from mastapy.bolts import _1230, _1234
...
class CycloidalDisc(_2116.AbstractShaft):
    '''CycloidalDisc
    ...
    @property
    def cycloidal_disc_design(self) -> '_1220.CycloidalDiscDesign':
        ...
        return constructor.new(_1220.CycloidalDiscDesign)(self.wrapped.CycloidalDiscDesign) if self.wrapped.CycloidalDiscDesign else None

    @property
    def load_sharing_settings(self) -> '_2140.LoadSharingSettings':
        ...
        return constructor.new(_2140.LoadSharingSettings)(self.wrapped.LoadSharingSettings) if self.wrapped.LoadSharingSettings else None

    @property
    def disc_material(self) -> '_236.Material':
        ...
        if _236.Material.TYPE not in self.wrapped.DiscMaterial.__class__.__mro__:
    ...
    @property
    def planetary_bearing_sockets(self) -> 'List[_2021.CycloidalDiscPlanetaryBearingSocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetaryBearingSockets, constructor.new(_2021.CycloidalDiscPlanetaryBearingSocket))
        return value
