...
class FlexiblePinAssembly(_2155.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2202.CylindricalGear':
        ...
        if _2202.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
