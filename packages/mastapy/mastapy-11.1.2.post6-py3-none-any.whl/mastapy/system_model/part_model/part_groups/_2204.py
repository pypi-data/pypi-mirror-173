...
from mastapy.system_model.part_model.part_groups import _2201, _2203, _2200
...
class ParallelPartGroup(_2200.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2201.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2201.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2203.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2203.DesignMeasurements))
        return value
