...
from mastapy.system_model.part_model.part_groups import _2349, _2347
...
class ConcentricPartGroup(_2347.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2349.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2349.ConcentricPartGroupParallelToThis))
        return value
