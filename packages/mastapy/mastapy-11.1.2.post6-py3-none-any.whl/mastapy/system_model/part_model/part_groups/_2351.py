...
from mastapy.system_model.part_model.part_groups import _2348, _2350, _2347
...
class ParallelPartGroup(_2347.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2348.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2348.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2350.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2350.DesignMeasurements))
        return value
