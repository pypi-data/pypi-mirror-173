...
class DesignMeasurements(_0.APIBase):
    ...
    @property
    def component_connections(self) -> 'List[_2133.ComponentMeasurer]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_2133.ComponentMeasurer))
        return value
