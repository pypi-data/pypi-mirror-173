...
from mastapy.system_model.part_model.part_groups import _2347, _2348, _2351
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2347.ConcentricOrParallelPartGroup':
        ...
        if _2347.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2348.ConcentricPartGroup':
        ...
        if _2348.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2351.ParallelPartGroup':
        ...
        if _2351.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
