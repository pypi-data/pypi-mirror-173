...
from mastapy.system_model.part_model.part_groups import _2166, _2164
...
class ConcentricPartGroup(_2164.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2166.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2166.ConcentricPartGroupParallelToThis))
        return value
