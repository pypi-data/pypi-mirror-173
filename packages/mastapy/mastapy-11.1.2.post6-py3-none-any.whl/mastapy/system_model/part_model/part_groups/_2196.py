...
from mastapy.system_model.part_model.part_groups import _2194, _2195, _2198
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2194.ConcentricOrParallelPartGroup':
        ...
        if _2194.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2195.ConcentricPartGroup':
        ...
        if _2195.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2198.ParallelPartGroup':
        ...
        if _2198.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
