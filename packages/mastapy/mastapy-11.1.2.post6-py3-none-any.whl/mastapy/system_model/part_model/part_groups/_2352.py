...
from mastapy.system_model.part_model import _2329
...
class PartGroup(_0.APIBase):
    ...
    @property
    def parts(self) -> 'List[_2329.Part]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Parts, constructor.new(_2329.Part))
        return value
