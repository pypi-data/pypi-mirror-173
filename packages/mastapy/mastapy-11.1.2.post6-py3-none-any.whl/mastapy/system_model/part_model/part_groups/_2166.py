...
from mastapy.system_model.part_model.part_groups import _2164, _2165, _2168
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2164.ConcentricOrParallelPartGroup':
        ...
        if _2164.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2165.ConcentricPartGroup':
        ...
        if _2165.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2168.ParallelPartGroup':
        ...
        if _2168.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
