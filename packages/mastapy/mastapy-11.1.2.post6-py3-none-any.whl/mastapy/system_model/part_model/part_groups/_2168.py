...
from mastapy.system_model.part_model.part_groups import _2165, _2167, _2164
...
class ParallelPartGroup(_2164.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2165.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2165.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2167.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2167.DesignMeasurements))
        return value
