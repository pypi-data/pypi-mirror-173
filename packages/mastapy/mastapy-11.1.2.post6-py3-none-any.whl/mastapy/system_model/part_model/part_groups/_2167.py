...
class DesignMeasurements(_0.APIBase):
    ...
    @property
    def component_connections(self) -> 'List[_1953.ComponentMeasurer]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1953.ComponentMeasurer))
        return value
