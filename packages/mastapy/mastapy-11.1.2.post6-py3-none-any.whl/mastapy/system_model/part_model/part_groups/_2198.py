...
from mastapy.system_model.part_model.part_groups import _2195, _2197, _2194
...
class ParallelPartGroup(_2194.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2195.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2195.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2197.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2197.DesignMeasurements))
        return value
