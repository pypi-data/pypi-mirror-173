...
from mastapy.system_model.part_model.part_groups import _2196, _2194
...
class ConcentricPartGroup(_2194.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2196.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2196.ConcentricPartGroupParallelToThis))
        return value
