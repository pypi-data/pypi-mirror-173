...
from mastapy.system_model.part_model.part_groups import _2202, _2200
...
class ConcentricPartGroup(_2200.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2202.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2202.ConcentricPartGroupParallelToThis))
        return value
