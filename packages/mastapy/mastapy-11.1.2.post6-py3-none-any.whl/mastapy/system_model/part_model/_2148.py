...
from mastapy.system_model.part_model import _2140, _2143
...
class PlanetCarrier(_2143.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def planetary_sockets(self) -> 'List[_1970.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_1970.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_2160.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2160.Shaft', offset: Optional['float'] = float('nan')):
