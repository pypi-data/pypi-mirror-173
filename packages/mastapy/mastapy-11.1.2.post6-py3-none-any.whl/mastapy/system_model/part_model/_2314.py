...
from mastapy.system_model.part_model import _2299
...
class FEPart(_2299.AbstractShaftOrHousing):
    '''FEPart
    ...
    def create_fe_substructure(self) -> '_2244.FESubstructure':
    ...
    def create_fe_substructure_with_name(self, name: 'str') -> '_2244.FESubstructure':
        ''' 'CreateFESubstructure' is the original name of this method.
    ...
    def select_fe_substructure(self, fe_substructure: '_2244.FESubstructure'):
    ...
    def remove_fe_substructure(self, fe_substructure: '_2244.FESubstructure') -> 'bool':
