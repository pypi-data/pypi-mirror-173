...
from mastapy.math_utility import _1398, _1399
from mastapy.system_model.connections_and_sockets import (
    _2132, _2153, _2134, _2158
)
from mastapy.system_model.part_model import _2307, _2329
...
class Component(_2329.Part):
    ...
    @property
    def component_connections(self) -> 'List[_2132.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_2132.ComponentConnection))
        return value
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_2153.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1398.CoordinateSystem3D') -> '_2153.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_2153.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1399.CoordinateSystemEditor':
    ...
    def diameter_at_middle_of_connection(self, connection: '_2134.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_2134.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_2158.Socket') -> 'List[_2158.Socket]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_SOCKET](socket.wrapped if socket else None), constructor.new(_2158.Socket))

    def connect_to_socket(self, socket: '_2158.Socket') -> '_2307.ComponentsConnectedResult':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_2158.Socket]':
        ''' 'PossibleSocketsToConnectWith' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_COMPONENT](component.wrapped if component else None), constructor.new(_2158.Socket))

    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2307.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2307.ComponentsConnectedResult':
        ''' 'ConnectTo' is the original name of this method.
    ...
    def can_delete_connection(self, connection: '_2134.Connection') -> 'bool':
    ...
    def socket_named(self, socket_name: 'str') -> '_2158.Socket':
