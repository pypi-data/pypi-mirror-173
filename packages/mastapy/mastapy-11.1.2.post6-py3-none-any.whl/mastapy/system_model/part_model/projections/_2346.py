...
from mastapy.system_model.part_model.projections import _2345
...
class SpecifiedParallelPartGroupDrawingOrder(_0.APIBase):
    ...
    @property
    def specified_groups(self) -> 'List[_2345.SpecifiedConcentricPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpecifiedGroups, constructor.new(_2345.SpecifiedConcentricPartGroupDrawingOrder))
        return value
