...
from mastapy.system_model.part_model.projections import _2198
...
class SpecifiedParallelPartGroupDrawingOrder(_0.APIBase):
    ...
    @property
    def specified_groups(self) -> 'List[_2198.SpecifiedConcentricPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpecifiedGroups, constructor.new(_2198.SpecifiedConcentricPartGroupDrawingOrder))
        return value
