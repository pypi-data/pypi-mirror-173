...
from mastapy.system_model.part_model.projections import _2192
...
class SpecifiedParallelPartGroupDrawingOrder(_0.APIBase):
    ...
    @property
    def specified_groups(self) -> 'List[_2192.SpecifiedConcentricPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpecifiedGroups, constructor.new(_2192.SpecifiedConcentricPartGroupDrawingOrder))
        return value
