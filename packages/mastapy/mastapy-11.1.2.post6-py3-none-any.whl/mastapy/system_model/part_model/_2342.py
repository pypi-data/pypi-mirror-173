...
from mastapy.system_model.part_model import _2341
...
class WindTurbineSingleBladeDetails(_0.APIBase):
    ...
    @property
    def edgewise_modes(self) -> '_2341.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_2341.WindTurbineBladeModeDetails)(self.wrapped.EdgewiseModes) if self.wrapped.EdgewiseModes is not None else None

    @property
    def flapwise_modes(self) -> '_2341.WindTurbineBladeModeDetails':
        ...
        return constructor.new(_2341.WindTurbineBladeModeDetails)(self.wrapped.FlapwiseModes) if self.wrapped.FlapwiseModes is not None else None
