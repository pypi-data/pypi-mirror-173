...
from mastapy.system_model.part_model import _2300, _2321
...
class LoadSharingSettings(_0.APIBase):
    ...
    @property
    def planetary_load_sharing_agma_application_level(self) -> '_2300.AGMALoadSharingTableApplicationLevel':
        ...
        return constructor.new(_2300.AGMALoadSharingTableApplicationLevel)(value) if value is not None else None

    @planetary_load_sharing_agma_application_level.setter
    def planetary_load_sharing_agma_application_level(self, value: '_2300.AGMALoadSharingTableApplicationLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PlanetaryLoadSharingAGMAApplicationLevel = value

    @property
    def planetary_load_sharing(self) -> '_2321.LoadSharingModes':
        ...
        return constructor.new(_2321.LoadSharingModes)(value) if value is not None else None

    @planetary_load_sharing.setter
    def planetary_load_sharing(self, value: '_2321.LoadSharingModes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
