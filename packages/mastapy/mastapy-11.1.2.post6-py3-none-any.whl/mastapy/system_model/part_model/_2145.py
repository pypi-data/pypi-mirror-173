...
class OilSeal(_2127.Connector):
    ...
    @property
    def oil_seal_material(self) -> '_265.OilSealMaterialType':
        ...
        return constructor.new(_265.OilSealMaterialType)(value) if value else None

    @oil_seal_material.setter
    def oil_seal_material(self, value: '_265.OilSealMaterialType'):
    ...
    @property
    def oil_seal_orientation(self) -> '_1664.Orientations':
    ...
    def oil_seal_orientation(self, value: '_1664.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
