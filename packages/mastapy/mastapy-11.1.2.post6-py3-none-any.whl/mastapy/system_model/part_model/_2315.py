...
class FlexiblePinAssembly(_2337.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2385.CylindricalGear':
        ...
        if _2385.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
