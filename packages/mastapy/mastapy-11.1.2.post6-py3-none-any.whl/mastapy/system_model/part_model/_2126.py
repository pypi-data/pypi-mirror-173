...
from mastapy.system_model.connections_and_sockets import (
    ...
    _1975, _1976, _1954, _1947,
    _1950, _1951, _1955, _1963,
    _1969, _1974, _1977
)
...
class ConnectedSockets(_0.APIBase):
    ...
    @property
    def connection(self) -> '_1954.Connection':
        ...
        if _1954.Connection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_abstract_shaft_to_mountable_component_connection(self) -> '_1947.AbstractShaftToMountableComponentConnection':
        ...
        if _1947.AbstractShaftToMountableComponentConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_belt_connection(self) -> '_1950.BeltConnection':
        ...
        if _1950.BeltConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_coaxial_connection(self) -> '_1951.CoaxialConnection':
        ...
        if _1951.CoaxialConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_cvt_belt_connection(self) -> '_1955.CVTBeltConnection':
        ...
        if _1955.CVTBeltConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_inter_mountable_component_connection(self) -> '_1963.InterMountableComponentConnection':
        ...
        if _1963.InterMountableComponentConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_planetary_connection(self) -> '_1969.PlanetaryConnection':
        ...
        if _1969.PlanetaryConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_rolling_ring_connection(self) -> '_1974.RollingRingConnection':
        ...
        if _1974.RollingRingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_shaft_to_mountable_component_connection(self) -> '_1977.ShaftToMountableComponentConnection':
        ...
        if _1977.ShaftToMountableComponentConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_agma_gleason_conical_gear_mesh(self) -> '_1981.AGMAGleasonConicalGearMesh':
        ...
        if _1981.AGMAGleasonConicalGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_bevel_differential_gear_mesh(self) -> '_1983.BevelDifferentialGearMesh':
        ...
        if _1983.BevelDifferentialGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_bevel_gear_mesh(self) -> '_1985.BevelGearMesh':
        ...
        if _1985.BevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_concept_gear_mesh(self) -> '_1987.ConceptGearMesh':
        ...
        if _1987.ConceptGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_conical_gear_mesh(self) -> '_1989.ConicalGearMesh':
        ...
        if _1989.ConicalGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_cylindrical_gear_mesh(self) -> '_1991.CylindricalGearMesh':
        ...
        if _1991.CylindricalGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_face_gear_mesh(self) -> '_1993.FaceGearMesh':
        ...
        if _1993.FaceGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_gear_mesh(self) -> '_1995.GearMesh':
        ...
        if _1995.GearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
            raise CastException('Failed to cast connection to GearMesh. Expected: {}.'.format(self.wrapped.Connection.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Connection.__class__)(self.wrapped.Connection) if self.wrapped.Connection else None

    @property
    def connection_of_type_hypoid_gear_mesh(self) -> '_1997.HypoidGearMesh':
        ...
        if _1997.HypoidGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_klingelnberg_cyclo_palloid_conical_gear_mesh(self) -> '_2000.KlingelnbergCycloPalloidConicalGearMesh':
        ...
        if _2000.KlingelnbergCycloPalloidConicalGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_klingelnberg_cyclo_palloid_hypoid_gear_mesh(self) -> '_2001.KlingelnbergCycloPalloidHypoidGearMesh':
        ...
        if _2001.KlingelnbergCycloPalloidHypoidGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh(self) -> '_2002.KlingelnbergCycloPalloidSpiralBevelGearMesh':
        ...
        if _2002.KlingelnbergCycloPalloidSpiralBevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_spiral_bevel_gear_mesh(self) -> '_2005.SpiralBevelGearMesh':
        ...
        if _2005.SpiralBevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_straight_bevel_diff_gear_mesh(self) -> '_2007.StraightBevelDiffGearMesh':
        ...
        if _2007.StraightBevelDiffGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_straight_bevel_gear_mesh(self) -> '_2009.StraightBevelGearMesh':
        ...
        if _2009.StraightBevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_worm_gear_mesh(self) -> '_2011.WormGearMesh':
        ...
        if _2011.WormGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_zerol_bevel_gear_mesh(self) -> '_2013.ZerolBevelGearMesh':
        ...
        if _2013.ZerolBevelGearMesh.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_cycloidal_disc_central_bearing_connection(self) -> '_2017.CycloidalDiscCentralBearingConnection':
        ...
        if _2017.CycloidalDiscCentralBearingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_cycloidal_disc_planetary_bearing_connection(self) -> '_2020.CycloidalDiscPlanetaryBearingConnection':
        ...
        if _2020.CycloidalDiscPlanetaryBearingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_ring_pins_to_disc_connection(self) -> '_2023.RingPinsToDiscConnection':
        ...
        if _2023.RingPinsToDiscConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_clutch_connection(self) -> '_2024.ClutchConnection':
        ...
        if _2024.ClutchConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_concept_coupling_connection(self) -> '_2026.ConceptCouplingConnection':
        ...
        if _2026.ConceptCouplingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_coupling_connection(self) -> '_2028.CouplingConnection':
        ...
        if _2028.CouplingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_part_to_part_shear_coupling_connection(self) -> '_2030.PartToPartShearCouplingConnection':
        ...
        if _2030.PartToPartShearCouplingConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_spring_damper_connection(self) -> '_2032.SpringDamperConnection':
        ...
        if _2032.SpringDamperConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
    ...
    @property
    def connection_of_type_torque_converter_connection(self) -> '_2034.TorqueConverterConnection':
        ...
        if _2034.TorqueConverterConnection.TYPE not in self.wrapped.Connection.__class__.__mro__:
