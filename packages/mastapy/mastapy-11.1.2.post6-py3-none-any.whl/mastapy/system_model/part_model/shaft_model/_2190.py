...
class Shaft(_2145.AbstractShaft):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2164.GuideImage':
        ...
        return constructor.new(_2164.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    @property
    def fe_substructure_replacing_this(self) -> '_2091.FESubstructure':
        ...
        return constructor.new(_2091.FESubstructure)(self.wrapped.FESubstructureReplacingThis) if self.wrapped.FESubstructureReplacingThis else None
    ...
    def mount_component(self, component: '_2172.MountableComponent', offset: 'float'):
