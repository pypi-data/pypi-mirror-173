...
class Shaft(_2298.AbstractShaft):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2317.GuideImage':
        ...
        return constructor.new(_2317.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage is not None else None
    ...
    @property
    def fe_substructure_replacing_this(self) -> '_2244.FESubstructure':
        ...
        return constructor.new(_2244.FESubstructure)(self.wrapped.FESubstructureReplacingThis) if self.wrapped.FESubstructureReplacingThis is not None else None
    ...
    def mount_component(self, component: '_2325.MountableComponent', offset: 'float'):
