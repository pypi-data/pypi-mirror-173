...
class Shaft(_2116.AbstractShaft):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2135.GuideImage':
        ...
        return constructor.new(_2135.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    @property
    def fe_substructure_replacing_this(self) -> '_2064.FESubstructure':
        ...
        return constructor.new(_2064.FESubstructure)(self.wrapped.FESubstructureReplacingThis) if self.wrapped.FESubstructureReplacingThis else None
    ...
    def mount_component(self, component: '_2143.MountableComponent', offset: 'float'):
