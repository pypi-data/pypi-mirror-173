...
class Shaft(_2115.AbstractShaft):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2134.GuideImage':
        ...
        return constructor.new(_2134.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2142.MountableComponent', offset: 'float'):
