...
from mastapy.geometry import _273
from mastapy.system_model.part_model.projections import _2163
from mastapy.system_model.part_model.part_groups import _2168
...
class RootAssembly(_2114.Assembly):
    '''RootAssembly
    ...
    @property
    def packaging_limits(self) -> '_273.PackagingLimits':
        ...
        return constructor.new(_273.PackagingLimits)(self.wrapped.PackagingLimits) if self.wrapped.PackagingLimits else None

    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2163.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_2163.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_2168.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_2168.ParallelPartGroup))
        return value
