...
class Part(_1893.DesignEntity):
    ...
    @property
    def mass_properties_from_design(self) -> '_1283.MassProperties':
        ...
        return constructor.new(_1283.MassProperties)(self.wrapped.MassPropertiesFromDesign) if self.wrapped.MassPropertiesFromDesign else None

    @property
    def mass_properties_from_design_including_planetary_duplicates(self) -> '_1283.MassProperties':
        ...
        return constructor.new(_1283.MassProperties)(self.wrapped.MassPropertiesFromDesignIncludingPlanetaryDuplicates) if self.wrapped.MassPropertiesFromDesignIncludingPlanetaryDuplicates else None
    ...
    @property
    def local_connections(self) -> 'List[_1954.Connection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LocalConnections, constructor.new(_1954.Connection))
        return value

    def connections_to(self, part: 'Part') -> 'List[_1954.Connection]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionsTo(part.wrapped if part else None), constructor.new(_1954.Connection))
    ...
    def copy_to(self, container: '_2114.Assembly') -> 'Part':
