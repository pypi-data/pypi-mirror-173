...
from mastapy.bearings.tolerances import (
    _1610, _1611, _1613, _1624,
    _1619, _1627, _1614, _1628,
    _1620, _1630
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_results import _1664, _1665
from mastapy.bearings import (
    _1588, _1595, _1584, _1580
)
from mastapy._internal.python_net import python_net_import
from mastapy.materials.efficiency import _257
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_designs import (
    _1826, _1827, _1828, _1829,
    _1830
)
from mastapy.bearings.bearing_designs.rolling import (
    _1831, _1832, _1833, _1834,
    _1835, _1836, _1838, _1843,
    _1844, _1845, _1847, _1849,
    _1850, _1851, _1852, _1855,
    _1856, _1858, _1859, _1860,
    _1861, _1862, _1863
)
...
from mastapy.bearings.bearing_designs.concept import _1886, _1887, _1888
from mastapy.system_model.part_model import (
    _2119, _2152, _2121, _2125,
    _2127
)
...
class Bearing(_2127.Connector):
    ...
    @property
    def bearing_tolerance_definition(self) -> '_1611.BearingToleranceDefinitionOptions':
        ...
        return constructor.new(_1611.BearingToleranceDefinitionOptions)(value) if value else None

    @bearing_tolerance_definition.setter
    def bearing_tolerance_definition(self, value: '_1611.BearingToleranceDefinitionOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingToleranceDefinition = value

    @property
    def orientation(self) -> '_1664.Orientations':
        '''Orientations: 'Orientation' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Orientation)
        return constructor.new(_1664.Orientations)(value) if value else None

    @orientation.setter
    def orientation(self, value: '_1664.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def journal_bearing_type(self) -> '_1595.JournalBearingType':
        ...
        return constructor.new(_1595.JournalBearingType)(value) if value else None

    @journal_bearing_type.setter
    def journal_bearing_type(self, value: '_1595.JournalBearingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def damping_options(self) -> '_1584.BearingDampingMatrixOption':
        ...
        return constructor.new(_1584.BearingDampingMatrixOption)(value) if value else None

    @damping_options.setter
    def damping_options(self, value: '_1584.BearingDampingMatrixOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def ring_tolerance_inner(self) -> '_1613.InnerRingTolerance':
        ...
        return constructor.new(_1613.InnerRingTolerance)(self.wrapped.RingToleranceInner) if self.wrapped.RingToleranceInner else None

    @property
    def ring_tolerance_left(self) -> '_1624.RingTolerance':
        ...
        if _1624.RingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_inner_ring_tolerance(self) -> '_1613.InnerRingTolerance':
        ...
        if _1613.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_outer_ring_tolerance(self) -> '_1619.OuterRingTolerance':
        ...
        if _1619.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_outer(self) -> '_1619.OuterRingTolerance':
        ...
        return constructor.new(_1619.OuterRingTolerance)(self.wrapped.RingToleranceOuter) if self.wrapped.RingToleranceOuter else None

    @property
    def ring_tolerance_right(self) -> '_1624.RingTolerance':
        ...
        if _1624.RingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def ring_tolerance_right_of_type_inner_ring_tolerance(self) -> '_1613.InnerRingTolerance':
        ...
        if _1613.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def ring_tolerance_right_of_type_outer_ring_tolerance(self) -> '_1619.OuterRingTolerance':
        ...
        if _1619.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def inner_support_detail(self) -> '_1627.SupportDetail':
        ...
        return constructor.new(_1627.SupportDetail)(self.wrapped.InnerSupportDetail) if self.wrapped.InnerSupportDetail else None

    @property
    def left_support_detail(self) -> '_1627.SupportDetail':
        ...
        return constructor.new(_1627.SupportDetail)(self.wrapped.LeftSupportDetail) if self.wrapped.LeftSupportDetail else None

    @property
    def outer_support_detail(self) -> '_1627.SupportDetail':
        ...
        return constructor.new(_1627.SupportDetail)(self.wrapped.OuterSupportDetail) if self.wrapped.OuterSupportDetail else None

    @property
    def right_support_detail(self) -> '_1627.SupportDetail':
        ...
        return constructor.new(_1627.SupportDetail)(self.wrapped.RightSupportDetail) if self.wrapped.RightSupportDetail else None

    @property
    def support_tolerance_inner(self) -> '_1614.InnerSupportTolerance':
        ...
        return constructor.new(_1614.InnerSupportTolerance)(self.wrapped.SupportToleranceInner) if self.wrapped.SupportToleranceInner else None

    @property
    def support_tolerance_left(self) -> '_1628.SupportTolerance':
        ...
        if _1628.SupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_inner_support_tolerance(self) -> '_1614.InnerSupportTolerance':
        ...
        if _1614.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_outer_support_tolerance(self) -> '_1620.OuterSupportTolerance':
        ...
        if _1620.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_outer(self) -> '_1620.OuterSupportTolerance':
        ...
        return constructor.new(_1620.OuterSupportTolerance)(self.wrapped.SupportToleranceOuter) if self.wrapped.SupportToleranceOuter else None

    @property
    def support_tolerance_right(self) -> '_1628.SupportTolerance':
        ...
        if _1628.SupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def support_tolerance_right_of_type_inner_support_tolerance(self) -> '_1614.InnerSupportTolerance':
        ...
        if _1614.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def support_tolerance_right_of_type_outer_support_tolerance(self) -> '_1620.OuterSupportTolerance':
        ...
        if _1620.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def inner_mounting_sleeve_bore_tolerance(self) -> '_1620.OuterSupportTolerance':
        ...
        return constructor.new(_1620.OuterSupportTolerance)(self.wrapped.InnerMountingSleeveBoreTolerance) if self.wrapped.InnerMountingSleeveBoreTolerance else None

    @property
    def inner_mounting_sleeve_outer_diameter_tolerance(self) -> '_1614.InnerSupportTolerance':
        ...
        return constructor.new(_1614.InnerSupportTolerance)(self.wrapped.InnerMountingSleeveOuterDiameterTolerance) if self.wrapped.InnerMountingSleeveOuterDiameterTolerance else None

    @property
    def outer_mounting_sleeve_bore_tolerance(self) -> '_1620.OuterSupportTolerance':
        ...
        return constructor.new(_1620.OuterSupportTolerance)(self.wrapped.OuterMountingSleeveBoreTolerance) if self.wrapped.OuterMountingSleeveBoreTolerance else None

    @property
    def outer_mounting_sleeve_outer_diameter_tolerance(self) -> '_1614.InnerSupportTolerance':
        ...
        return constructor.new(_1614.InnerSupportTolerance)(self.wrapped.OuterMountingSleeveOuterDiameterTolerance) if self.wrapped.OuterMountingSleeveOuterDiameterTolerance else None

    @property
    def simple_bearing_detail_property(self) -> '_1826.BearingDesign':
        ...
        if _1826.BearingDesign.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_detailed_bearing(self) -> '_1827.DetailedBearing':
        ...
        if _1827.DetailedBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_dummy_rolling_bearing(self) -> '_1828.DummyRollingBearing':
        ...
        if _1828.DummyRollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_linear_bearing(self) -> '_1829.LinearBearing':
        ...
        if _1829.LinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_non_linear_bearing(self) -> '_1830.NonLinearBearing':
        ...
        if _1830.NonLinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_ball_bearing(self) -> '_1831.AngularContactBallBearing':
        ...
        if _1831.AngularContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_thrust_ball_bearing(self) -> '_1832.AngularContactThrustBallBearing':
        ...
        if _1832.AngularContactThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_asymmetric_spherical_roller_bearing(self) -> '_1833.AsymmetricSphericalRollerBearing':
        ...
        if _1833.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1834.AxialThrustCylindricalRollerBearing':
        ...
        if _1834.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_needle_roller_bearing(self) -> '_1835.AxialThrustNeedleRollerBearing':
        ...
        if _1835.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_ball_bearing(self) -> '_1836.BallBearing':
        ...
        if _1836.BallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_barrel_roller_bearing(self) -> '_1838.BarrelRollerBearing':
        ...
        if _1838.BarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_crossed_roller_bearing(self) -> '_1843.CrossedRollerBearing':
        ...
        if _1843.CrossedRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_cylindrical_roller_bearing(self) -> '_1844.CylindricalRollerBearing':
        ...
        if _1844.CylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_deep_groove_ball_bearing(self) -> '_1845.DeepGrooveBallBearing':
        ...
        if _1845.DeepGrooveBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_four_point_contact_ball_bearing(self) -> '_1847.FourPointContactBallBearing':
        ...
        if _1847.FourPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_multi_point_contact_ball_bearing(self) -> '_1849.MultiPointContactBallBearing':
        ...
        if _1849.MultiPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_needle_roller_bearing(self) -> '_1850.NeedleRollerBearing':
        ...
        if _1850.NeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_non_barrel_roller_bearing(self) -> '_1851.NonBarrelRollerBearing':
        ...
        if _1851.NonBarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_roller_bearing(self) -> '_1852.RollerBearing':
        ...
        if _1852.RollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_rolling_bearing(self) -> '_1855.RollingBearing':
        ...
        if _1855.RollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_self_aligning_ball_bearing(self) -> '_1856.SelfAligningBallBearing':
        ...
        if _1856.SelfAligningBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_bearing(self) -> '_1858.SphericalRollerBearing':
        ...
        if _1858.SphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_thrust_bearing(self) -> '_1859.SphericalRollerThrustBearing':
        ...
        if _1859.SphericalRollerThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_taper_roller_bearing(self) -> '_1860.TaperRollerBearing':
        ...
        if _1860.TaperRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_three_point_contact_ball_bearing(self) -> '_1861.ThreePointContactBallBearing':
        ...
        if _1861.ThreePointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_thrust_ball_bearing(self) -> '_1862.ThrustBallBearing':
        ...
        if _1862.ThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_toroidal_roller_bearing(self) -> '_1863.ToroidalRollerBearing':
        ...
        if _1863.ToroidalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_pad_fluid_film_bearing(self) -> '_1876.PadFluidFilmBearing':
        ...
        if _1876.PadFluidFilmBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_grease_filled_journal_bearing(self) -> '_1878.PlainGreaseFilledJournalBearing':
        ...
        if _1878.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_journal_bearing(self) -> '_1880.PlainJournalBearing':
        ...
        if _1880.PlainJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_oil_fed_journal_bearing(self) -> '_1882.PlainOilFedJournalBearing':
        ...
        if _1882.PlainOilFedJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_journal_bearing(self) -> '_1883.TiltingPadJournalBearing':
        ...
        if _1883.TiltingPadJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_thrust_bearing(self) -> '_1884.TiltingPadThrustBearing':
        ...
        if _1884.TiltingPadThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_axial_clearance_bearing(self) -> '_1886.ConceptAxialClearanceBearing':
        ...
        if _1886.ConceptAxialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_clearance_bearing(self) -> '_1887.ConceptClearanceBearing':
        ...
        if _1887.ConceptClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_radial_clearance_bearing(self) -> '_1888.ConceptRadialClearanceBearing':
        ...
        if _1888.ConceptRadialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def detail(self) -> '_1826.BearingDesign':
        ...
        if _1826.BearingDesign.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_detailed_bearing(self) -> '_1827.DetailedBearing':
        ...
        if _1827.DetailedBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to DetailedBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_dummy_rolling_bearing(self) -> '_1828.DummyRollingBearing':
        ...
        if _1828.DummyRollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_linear_bearing(self) -> '_1829.LinearBearing':
        ...
        if _1829.LinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to LinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_non_linear_bearing(self) -> '_1830.NonLinearBearing':
        ...
        if _1830.NonLinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to NonLinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_angular_contact_ball_bearing(self) -> '_1831.AngularContactBallBearing':
        ...
        if _1831.AngularContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_angular_contact_thrust_ball_bearing(self) -> '_1832.AngularContactThrustBallBearing':
        ...
        if _1832.AngularContactThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_asymmetric_spherical_roller_bearing(self) -> '_1833.AsymmetricSphericalRollerBearing':
        ...
        if _1833.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1834.AxialThrustCylindricalRollerBearing':
        ...
        if _1834.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_needle_roller_bearing(self) -> '_1835.AxialThrustNeedleRollerBearing':
        ...
        if _1835.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_ball_bearing(self) -> '_1836.BallBearing':
        ...
        if _1836.BallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to BallBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_barrel_roller_bearing(self) -> '_1838.BarrelRollerBearing':
        ...
        if _1838.BarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_crossed_roller_bearing(self) -> '_1843.CrossedRollerBearing':
        ...
        if _1843.CrossedRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_cylindrical_roller_bearing(self) -> '_1844.CylindricalRollerBearing':
        ...
        if _1844.CylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_deep_groove_ball_bearing(self) -> '_1845.DeepGrooveBallBearing':
        ...
        if _1845.DeepGrooveBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_four_point_contact_ball_bearing(self) -> '_1847.FourPointContactBallBearing':
        ...
        if _1847.FourPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_multi_point_contact_ball_bearing(self) -> '_1849.MultiPointContactBallBearing':
        ...
        if _1849.MultiPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_needle_roller_bearing(self) -> '_1850.NeedleRollerBearing':
        ...
        if _1850.NeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_non_barrel_roller_bearing(self) -> '_1851.NonBarrelRollerBearing':
        ...
        if _1851.NonBarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_roller_bearing(self) -> '_1852.RollerBearing':
        ...
        if _1852.RollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollerBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_rolling_bearing(self) -> '_1855.RollingBearing':
        ...
        if _1855.RollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollingBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_self_aligning_ball_bearing(self) -> '_1856.SelfAligningBallBearing':
        ...
        if _1856.SelfAligningBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_bearing(self) -> '_1858.SphericalRollerBearing':
        ...
        if _1858.SphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_thrust_bearing(self) -> '_1859.SphericalRollerThrustBearing':
        ...
        if _1859.SphericalRollerThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_taper_roller_bearing(self) -> '_1860.TaperRollerBearing':
        ...
        if _1860.TaperRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_three_point_contact_ball_bearing(self) -> '_1861.ThreePointContactBallBearing':
        ...
        if _1861.ThreePointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_thrust_ball_bearing(self) -> '_1862.ThrustBallBearing':
        ...
        if _1862.ThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_toroidal_roller_bearing(self) -> '_1863.ToroidalRollerBearing':
        ...
        if _1863.ToroidalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_pad_fluid_film_bearing(self) -> '_1876.PadFluidFilmBearing':
        ...
        if _1876.PadFluidFilmBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_grease_filled_journal_bearing(self) -> '_1878.PlainGreaseFilledJournalBearing':
        ...
        if _1878.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_journal_bearing(self) -> '_1880.PlainJournalBearing':
        ...
        if _1880.PlainJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_oil_fed_journal_bearing(self) -> '_1882.PlainOilFedJournalBearing':
        ...
        if _1882.PlainOilFedJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_journal_bearing(self) -> '_1883.TiltingPadJournalBearing':
        ...
        if _1883.TiltingPadJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_thrust_bearing(self) -> '_1884.TiltingPadThrustBearing':
        ...
        if _1884.TiltingPadThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_axial_clearance_bearing(self) -> '_1886.ConceptAxialClearanceBearing':
        ...
        if _1886.ConceptAxialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_clearance_bearing(self) -> '_1887.ConceptClearanceBearing':
        ...
        if _1887.ConceptClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_radial_clearance_bearing(self) -> '_1888.ConceptRadialClearanceBearing':
        ...
        if _1888.ConceptRadialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def axial_internal_clearance_tolerance(self) -> '_2119.AxialInternalClearanceTolerance':
        ...
        return constructor.new(_2119.AxialInternalClearanceTolerance)(self.wrapped.AxialInternalClearanceTolerance) if self.wrapped.AxialInternalClearanceTolerance else None

    @property
    def radial_internal_clearance_tolerance(self) -> '_2152.RadialInternalClearanceTolerance':
        ...
        return constructor.new(_2152.RadialInternalClearanceTolerance)(self.wrapped.RadialInternalClearanceTolerance) if self.wrapped.RadialInternalClearanceTolerance else None

    @property
    def overridden_lubrication_detail(self) -> '_234.LubricationDetail':
        ...
        return constructor.new(_234.LubricationDetail)(self.wrapped.OverriddenLubricationDetail) if self.wrapped.OverriddenLubricationDetail else None

    @property
    def friction_coefficients(self) -> '_1767.RollingBearingFrictionCoefficients':
        ...
        return constructor.new(_1767.RollingBearingFrictionCoefficients)(self.wrapped.FrictionCoefficients) if self.wrapped.FrictionCoefficients else None
    ...
    @property
    def tolerance_combinations(self) -> 'List[_1630.ToleranceCombination]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToleranceCombinations, constructor.new(_1630.ToleranceCombination))
        return value

    @property
    def mounting(self) -> 'List[_2121.BearingRaceMountingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mounting, constructor.new(_2121.BearingRaceMountingOptions))
        return value
    ...
    def set_detail_from_catalogue(self, catalogue: '_1580.BearingCatalog', designation: 'str'):
    ...
    def try_attach_left_side_to(self, shaft: '_2160.Shaft', offset: Optional['float'] = float('nan')) -> '_2125.ComponentsConnectedResult':
    ...
    def try_attach_right_side_to(self, shaft: '_2160.Shaft', offset: Optional['float'] = float('nan')) -> '_2125.ComponentsConnectedResult':
