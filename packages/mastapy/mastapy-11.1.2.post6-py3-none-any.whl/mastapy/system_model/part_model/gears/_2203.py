...
from mastapy.system_model.part_model.gears import _2202, _2209
...
class CylindricalGearSet(_2209.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_957.CylindricalGearSetDesign':
    ...
    @property
    def cylindrical_gear_set_design(self) -> '_957.CylindricalGearSetDesign':
        ...
        if _957.CylindricalGearSetDesign.TYPE not in self.wrapped.CylindricalGearSetDesign.__class__.__mro__:
    ...
    @property
    def supercharger_rotor_set(self) -> '_2240.SuperchargerRotorSet':
        ...
        return constructor.new(_2240.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2202.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2202.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1991.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1991.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_957.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_957.CylindricalGearSetDesign))
        return value
