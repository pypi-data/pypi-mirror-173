...
class GearSet(_2337.SpecialisedAssembly):
    '''GearSet
    ...
    @property
    def active_gear_set_design(self) -> '_912.GearSetDesign':
        ...
        if _912.GearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_worm_gear_set_design(self) -> '_921.WormGearSetDesign':
        ...
        if _921.WormGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_face_gear_set_design(self) -> '_957.FaceGearSetDesign':
        ...
        if _957.FaceGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_cylindrical_gear_set_design(self) -> '_989.CylindricalGearSetDesign':
        ...
        if _989.CylindricalGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_cylindrical_planetary_gear_set_design(self) -> '_1000.CylindricalPlanetaryGearSetDesign':
        ...
        if _1000.CylindricalPlanetaryGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def active_gear_set_design_of_type_conical_gear_set_design(self) -> '_1108.ConicalGearSetDesign':
    ...
    @property
    def active_gear_set_design_of_type_concept_gear_set_design(self) -> '_1130.ConceptGearSetDesign':
        ...
        if _1130.ConceptGearSetDesign.TYPE not in self.wrapped.ActiveGearSetDesign.__class__.__mro__:
    ...
    @property
    def gear_set_designs(self) -> 'List[_912.GearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_912.GearSetDesign))
        return value

    def set_active_gear_set_design(self, gear_set_design: '_912.GearSetDesign'):
    ...
    def add_gear_set_design(self, design: '_912.GearSetDesign'):
