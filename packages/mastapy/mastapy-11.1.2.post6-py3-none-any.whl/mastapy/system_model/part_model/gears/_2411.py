...
from mastapy.gears.gear_designs.worm import _919, _918, _922
...
class WormGear(_2390.Gear):
    ...
    @property
    def active_gear_design(self) -> '_919.WormGearDesign':
    ...
    @property
    def worm_gear_design(self) -> '_919.WormGearDesign':
        ...
        if _919.WormGearDesign.TYPE not in self.wrapped.WormGearDesign.__class__.__mro__:
