...
from mastapy.system_model.part_model.gears import _2202, _2204, _2203
...
class PlanetaryGearSet(_2203.CylindricalGearSet):
    '''PlanetaryGearSet
    ...
    @property
    def suns(self) -> 'List[_2202.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Suns, constructor.new(_2202.CylindricalGear))
        return value

    @property
    def planets(self) -> 'List[_2204.CylindricalPlanetGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planets, constructor.new(_2204.CylindricalPlanetGear))
        return value

    @property
    def annuluses(self) -> 'List[_2202.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Annuluses, constructor.new(_2202.CylindricalGear))
        return value

    def add_sun(self) -> '_2202.CylindricalGear':
    ...
    def add_planet(self) -> '_2202.CylindricalGear':
    ...
    def add_annulus(self) -> '_2202.CylindricalGear':
