...
class SuperchargerRotorSet(_1579.NamedDatabaseItem):
    ...
    def y_variable_for_imported_data(self) -> '_2278.YVariableForImportedData':
        ...
        return constructor.new(_2278.YVariableForImportedData)(value) if value is not None else None
    ...
    def file(self) -> '_2271.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2271.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File is not None else None
    ...
    def rotor_speed(self) -> '_2273.RotorSpeedInputOptions':
        ...
        return constructor.new(_2273.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed is not None else None
    ...
    def boost_pressure(self) -> '_2268.BoostPressureInputOptions':
        ...
        return constructor.new(_2268.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure is not None else None
    ...
    def pressure_ratio(self) -> '_2270.PressureRatioInputOptions':
        ...
        return constructor.new(_2270.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio is not None else None
    ...
    def input_power(self) -> '_2269.InputPowerInputOptions':
        ...
        return constructor.new(_2269.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower is not None else None
