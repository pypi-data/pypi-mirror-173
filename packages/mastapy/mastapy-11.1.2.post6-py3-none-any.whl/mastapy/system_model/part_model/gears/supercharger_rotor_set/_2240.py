...
class SuperchargerRotorSet(_1558.NamedDatabaseItem):
    '''SuperchargerRotorSet
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2242.YVariableForImportedData':
        ...
        return constructor.new(_2242.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2242.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2235.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2235.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2237.RotorSpeedInputOptions':
        ...
        return constructor.new(_2237.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2232.BoostPressureInputOptions':
        ...
        return constructor.new(_2232.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2234.PressureRatioInputOptions':
        ...
        return constructor.new(_2234.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2233.InputPowerInputOptions':
        ...
        return constructor.new(_2233.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2236.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2236.RotorSetMeasuredPoint))
        return value
