...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2423
from mastapy.system_model.part_model.gears import _2385, _2392
...
class CylindricalGearSet(_2392.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_989.CylindricalGearSetDesign':
    ...
    @property
    def cylindrical_gear_set_design(self) -> '_989.CylindricalGearSetDesign':
        ...
        if _989.CylindricalGearSetDesign.TYPE not in self.wrapped.CylindricalGearSetDesign.__class__.__mro__:
    ...
    @property
    def supercharger_rotor_set(self) -> '_2423.SuperchargerRotorSet':
        ...
        return constructor.new(_2423.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet is not None else None
    ...
    @property
    def cylindrical_meshes(self) -> 'List[_2171.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_2171.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_989.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_989.CylindricalGearSetDesign))
        return value
