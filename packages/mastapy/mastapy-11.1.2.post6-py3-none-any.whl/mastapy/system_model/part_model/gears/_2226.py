...
class StraightBevelPlanetGear(_2222.StraightBevelDiffGear):
    '''StraightBevelPlanetGear
    ...
    @property
    def planetary_details(self) -> '_302.PlanetaryDetail':
        ...
        return constructor.new(_302.PlanetaryDetail)(self.wrapped.PlanetaryDetails) if self.wrapped.PlanetaryDetails else None
