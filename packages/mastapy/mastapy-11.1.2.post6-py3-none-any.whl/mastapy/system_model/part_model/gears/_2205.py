...
class FaceGear(_2207.Gear):
    ...
    @property
    def active_gear_design(self) -> '_920.FaceGearDesign':
    ...
    @property
    def face_gear_design(self) -> '_920.FaceGearDesign':
        ...
        if _920.FaceGearDesign.TYPE not in self.wrapped.FaceGearDesign.__class__.__mro__:
