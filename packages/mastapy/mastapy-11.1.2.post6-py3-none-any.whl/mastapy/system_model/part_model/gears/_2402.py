...
from mastapy.system_model.part_model.gears import _2385, _2387, _2386
...
class PlanetaryGearSet(_2386.CylindricalGearSet):
    '''PlanetaryGearSet
    ...
    @property
    def suns(self) -> 'List[_2385.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Suns, constructor.new(_2385.CylindricalGear))
        return value

    @property
    def planets(self) -> 'List[_2387.CylindricalPlanetGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planets, constructor.new(_2387.CylindricalPlanetGear))
        return value

    @property
    def annuluses(self) -> 'List[_2385.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Annuluses, constructor.new(_2385.CylindricalGear))
        return value

    def add_sun(self) -> '_2385.CylindricalGear':
    ...
    def add_planet(self) -> '_2385.CylindricalGear':
    ...
    def add_annulus(self) -> '_2385.CylindricalGear':
