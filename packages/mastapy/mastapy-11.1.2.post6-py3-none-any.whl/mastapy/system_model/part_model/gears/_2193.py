...
from mastapy.system_model.part_model.gears import _2196, _2197
...
class BevelDifferentialGearSet(_2197.BevelGearSet):
    '''BevelDifferentialGearSet
    ...
    @property
    def conical_gear_set_design(self) -> '_1095.BevelGearSetDesign':
        ...
        if _1095.BevelGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_zerol_bevel_gear_set_design(self) -> '_885.ZerolBevelGearSetDesign':
        ...
        if _885.ZerolBevelGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_straight_bevel_diff_gear_set_design(self) -> '_894.StraightBevelDiffGearSetDesign':
        ...
        if _894.StraightBevelDiffGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_straight_bevel_gear_set_design(self) -> '_898.StraightBevelGearSetDesign':
        ...
        if _898.StraightBevelGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def conical_gear_set_design_of_type_spiral_bevel_gear_set_design(self) -> '_902.SpiralBevelGearSetDesign':
        ...
        if _902.SpiralBevelGearSetDesign.TYPE not in self.wrapped.ConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_set_design(self) -> '_1095.BevelGearSetDesign':
        ...
        if _1095.BevelGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_set_design_of_type_zerol_bevel_gear_set_design(self) -> '_885.ZerolBevelGearSetDesign':
        ...
        if _885.ZerolBevelGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_set_design_of_type_straight_bevel_diff_gear_set_design(self) -> '_894.StraightBevelDiffGearSetDesign':
        ...
        if _894.StraightBevelDiffGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_set_design_of_type_straight_bevel_gear_set_design(self) -> '_898.StraightBevelGearSetDesign':
        ...
        if _898.StraightBevelGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gear_set_design_of_type_spiral_bevel_gear_set_design(self) -> '_902.SpiralBevelGearSetDesign':
        ...
        if _902.SpiralBevelGearSetDesign.TYPE not in self.wrapped.BevelGearSetDesign.__class__.__mro__:
    ...
    @property
    def bevel_gears(self) -> 'List[_2196.BevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelGears, constructor.new(_2196.BevelGear))
        return value

    @property
    def bevel_meshes(self) -> 'List[_1985.BevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelMeshes, constructor.new(_1985.BevelGearMesh))
        return value
