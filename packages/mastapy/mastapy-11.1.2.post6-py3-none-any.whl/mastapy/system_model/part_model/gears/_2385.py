...
from mastapy.system_model.part_model.gears import _2390
...
class CylindricalGear(_2390.Gear):
    '''CylindricalGear
    ...
    @property
    def active_gear_design(self) -> '_974.CylindricalGearDesign':
    ...
    @property
    def cylindrical_gear_design(self) -> '_974.CylindricalGearDesign':
        ...
        if _974.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGearDesign.__class__.__mro__:
