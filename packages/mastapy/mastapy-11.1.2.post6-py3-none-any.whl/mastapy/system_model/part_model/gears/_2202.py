...
class CylindricalGear(_2207.Gear):
    '''CylindricalGear
    ...
    @property
    def active_gear_design(self) -> '_943.CylindricalGearDesign':
    ...
    @property
    def cylindrical_gear_design(self) -> '_943.CylindricalGearDesign':
        ...
        if _943.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGearDesign.__class__.__mro__:
