...
from mastapy.gears.gear_designs.worm import _888, _887, _891
...
class WormGear(_2207.Gear):
    ...
    @property
    def active_gear_design(self) -> '_888.WormGearDesign':
    ...
    @property
    def worm_gear_design(self) -> '_888.WormGearDesign':
        ...
        if _888.WormGearDesign.TYPE not in self.wrapped.WormGearDesign.__class__.__mro__:
