...
from mastapy.system_model.part_model.gears import _2287, _2286
...
class KlingelnbergCycloPalloidHypoidGearSet(_2286.KlingelnbergCycloPalloidConicalGearSet):
    """KlingelnbergCycloPalloidHypoidGearSet
    ...
    @property
    def klingelnberg_conical_gear_set_design(self) -> '_942.KlingelnbergCycloPalloidHypoidGearSetDesign':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_set_design(self) -> '_942.KlingelnbergCycloPalloidHypoidGearSetDesign':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears(self) -> 'List[_2287.KlingelnbergCycloPalloidHypoidGear]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes(self) -> 'List[_2070.KlingelnbergCycloPalloidHypoidGearMesh]':
