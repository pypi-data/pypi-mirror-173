...
class FaceGear(_2390.Gear):
    ...
    @property
    def active_gear_design(self) -> '_951.FaceGearDesign':
    ...
    @property
    def face_gear_design(self) -> '_951.FaceGearDesign':
        ...
        if _951.FaceGearDesign.TYPE not in self.wrapped.FaceGearDesign.__class__.__mro__:
