...
from mastapy.system_model.part_model.import_from_cad import _2363, _2364
...
class ConnectorFromCAD(_2364.MountableComponentFromCAD):
    '''ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_2363.HousedOrMounted':
        '''HousedOrMounted: 'Mounting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Mounting)
        return constructor.new(_2363.HousedOrMounted)(value) if value is not None else None

    @mounting.setter
    def mounting(self, value: '_2363.HousedOrMounted'):
