...
from mastapy.system_model.part_model.import_from_cad import _2180, _2181
...
class ConnectorFromCAD(_2181.MountableComponentFromCAD):
    '''ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_2180.HousedOrMounted':
        '''HousedOrMounted: 'Mounting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Mounting)
        return constructor.new(_2180.HousedOrMounted)(value) if value else None

    @mounting.setter
    def mounting(self, value: '_2180.HousedOrMounted'):
