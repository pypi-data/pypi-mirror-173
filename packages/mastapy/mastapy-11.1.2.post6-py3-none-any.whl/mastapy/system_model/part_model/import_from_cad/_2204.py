...
from mastapy.system_model.part_model.import_from_cad import _2210, _2211
...
class ConnectorFromCAD(_2211.MountableComponentFromCAD):
    '''ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_2210.HousedOrMounted':
        '''HousedOrMounted: 'Mounting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Mounting)
        return constructor.new(_2210.HousedOrMounted)(value) if value else None

    @mounting.setter
    def mounting(self, value: '_2210.HousedOrMounted'):
