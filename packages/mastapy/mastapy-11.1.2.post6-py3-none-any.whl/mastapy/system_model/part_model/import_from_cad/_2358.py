...
from mastapy.geometry.two_d import _283
from mastapy.system_model.part_model.import_from_cad import _2364
...
class CylindricalGearFromCAD(_2364.MountableComponentFromCAD):
    '''CylindricalGearFromCAD
    ...
    @property
    def internal_external(self) -> '_283.InternalExternalType':
        ...
        return constructor.new(_283.InternalExternalType)(value) if value is not None else None

    @internal_external.setter
    def internal_external(self, value: '_283.InternalExternalType'):
