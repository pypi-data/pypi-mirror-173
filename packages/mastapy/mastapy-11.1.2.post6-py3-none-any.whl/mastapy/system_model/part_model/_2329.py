...
from mastapy.math_utility import _1418
from mastapy.system_model.connections_and_sockets import _2134
from mastapy.system_model.import_export import _2103
...
class Part(_2070.DesignEntity):
    ...
    @property
    def mass_properties_from_design(self) -> '_1418.MassProperties':
        ...
        return constructor.new(_1418.MassProperties)(self.wrapped.MassPropertiesFromDesign) if self.wrapped.MassPropertiesFromDesign is not None else None

    @property
    def mass_properties_from_design_including_planetary_duplicates(self) -> '_1418.MassProperties':
        ...
        return constructor.new(_1418.MassProperties)(self.wrapped.MassPropertiesFromDesignIncludingPlanetaryDuplicates) if self.wrapped.MassPropertiesFromDesignIncludingPlanetaryDuplicates is not None else None
    ...
    @property
    def local_connections(self) -> 'List[_2134.Connection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LocalConnections, constructor.new(_2134.Connection))
        return value

    def connections_to(self, part: 'Part') -> 'List[_2134.Connection]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionsTo(part.wrapped if part else None), constructor.new(_2134.Connection))
    ...
    def create_geometry_export_options(self) -> '_2103.GeometryExportOptions':
    ...
    def copy_to(self, container: '_2296.Assembly') -> 'Part':
