...
from mastapy.system_model.part_model import _2118, _2139
...
class LoadSharingSettings(_0.APIBase):
    ...
    @property
    def planetary_load_sharing_agma_application_level(self) -> '_2118.AGMALoadSharingTableApplicationLevel':
        ...
        return constructor.new(_2118.AGMALoadSharingTableApplicationLevel)(value) if value else None

    @planetary_load_sharing_agma_application_level.setter
    def planetary_load_sharing_agma_application_level(self, value: '_2118.AGMALoadSharingTableApplicationLevel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.PlanetaryLoadSharingAGMAApplicationLevel = value

    @property
    def planetary_load_sharing(self) -> '_2139.LoadSharingModes':
        ...
        return constructor.new(_2139.LoadSharingModes)(value) if value else None

    @planetary_load_sharing.setter
    def planetary_load_sharing(self, value: '_2139.LoadSharingModes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
