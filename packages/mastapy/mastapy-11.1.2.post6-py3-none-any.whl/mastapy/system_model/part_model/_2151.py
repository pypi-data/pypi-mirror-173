...
from mastapy.system_model.part_model import _2159, _2157
...
class PowerLoad(_2157.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def single_blade_details(self) -> '_2159.WindTurbineSingleBladeDetails':
        ...
        return constructor.new(_2159.WindTurbineSingleBladeDetails)(self.wrapped.SingleBladeDetails) if self.wrapped.SingleBladeDetails else None

    @property
    def electric_machine_detail(self) -> '_6512.ElectricMachineDetail':
        ...
        return constructor.new(_6512.ElectricMachineDetail)(self.wrapped.ElectricMachineDetail) if self.wrapped.ElectricMachineDetail else None

    @property
    def oil_pump_detail(self) -> '_263.OilPumpDetail':
        ...
        return constructor.new(_263.OilPumpDetail)(self.wrapped.OilPumpDetail) if self.wrapped.OilPumpDetail else None
