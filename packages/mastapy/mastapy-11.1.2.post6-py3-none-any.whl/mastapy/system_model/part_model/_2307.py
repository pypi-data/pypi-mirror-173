...
from mastapy.system_model.part_model import _2308
...
class ComponentsConnectedResult(_0.APIBase):
    ...
    @property
    def created_socket_connection(self) -> '_2308.ConnectedSockets':
        ...
        return constructor.new(_2308.ConnectedSockets)(self.wrapped.CreatedSocketConnection) if self.wrapped.CreatedSocketConnection is not None else None
