...
from mastapy.system_model_gui import _1592
...
from mastapy.system_model.fe import _2070
from mastapy.bearings.bearing_results.rolling import _1699
from mastapy.system_model.part_model.configurations import _2321, _2319, _2322
from mastapy.system_model.analyses_and_results.load_case_groups import _5355, _5363, _5356
...
from mastapy.system_model.database_access import _1973
...
from mastapy.system_model.part_model.creation_options import (
    _2278, _2281, _2282, _2280,
    _2279
)
from mastapy.gears.gear_designs.creation_options import _1075, _1078, _1077
from mastapy import _7242, _0
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2684
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1592.MASTAGUI':
        ...
        return constructor.new(_1592.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI else None
    ...
    @property
    def unbalanced_mass_inclusion(self) -> '_2186.UnbalancedMassInclusionOption':
        ...
        return constructor.new(_2186.UnbalancedMassInclusionOption)(value) if value else None

    @unbalanced_mass_inclusion.setter
    def unbalanced_mass_inclusion(self, value: '_2186.UnbalancedMassInclusionOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def thermal_expansion_for_grounded_nodes(self) -> '_1936.ThermalExpansionOptionForGroundedNodes':
        ...
        return constructor.new(_1936.ThermalExpansionOptionForGroundedNodes)(value) if value else None

    @thermal_expansion_for_grounded_nodes.setter
    def thermal_expansion_for_grounded_nodes(self, value: '_1936.ThermalExpansionOptionForGroundedNodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_external_external_meshes(self) -> '_550.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_550.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes else None

    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_internal_external_meshes(self) -> '_550.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_550.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes else None

    @property
    def file_save_details_most_recent(self) -> '_1362.FileHistoryItem':
        ...
        return constructor.new(_1362.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent else None

    @property
    def default_system_temperatures(self) -> '_1937.TransmissionTemperatureSet':
        ...
        return constructor.new(_1937.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None
    ...
    @property
    def detailed_spline_settings(self) -> '_1173.DetailedSplineJointSettings':
        ...
        return constructor.new(_1173.DetailedSplineJointSettings)(self.wrapped.DetailedSplineSettings) if self.wrapped.DetailedSplineSettings else None
    ...
    @property
    def file_save_details_all(self) -> '_1361.FileHistory':
        ...
        return constructor.new(_1361.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll else None
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2219.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2219.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None

    @property
    def system(self) -> '_1935.SystemReporting':
        ...
        return constructor.new(_1935.SystemReporting)(self.wrapped.System) if self.wrapped.System else None

    @property
    def fe_batch_operations(self) -> '_2070.BatchOperations':
        ...
        return constructor.new(_2070.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1699.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1699.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2219.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2219.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2321.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2321.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def fe_substructure_configurations(self) -> 'List[_2319.ActiveFESubstructureSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESubstructureConfigurations, constructor.new(_2319.ActiveFESubstructureSelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2322.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2322.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5355.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5355.DesignState))
        return value

    @property
    def time_series_load_case_groups(self) -> 'List[_5363.TimeSeriesLoadCaseGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TimeSeriesLoadCaseGroups, constructor.new(_5363.TimeSeriesLoadCaseGroup))
        return value
    ...
    @property
    def duty_cycles(self) -> 'List[_5356.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5356.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_2182.RootAssembly':
        ...
        return constructor.new(_2182.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_2240.GearSetConfiguration':
        '''GearSetConfiguration: 'GearSetConfig' is the original name of this property.'''

        return constructor.new(_2240.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @gear_set_config.setter
    def gear_set_config(self, value: '_2240.GearSetConfiguration'):
    ...
    @property
    def databases(self) -> '_1973.Databases':
        ...
        return constructor.new(_1973.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None

    @property
    def masta_settings(self) -> '_1916.MastaSettings':
        ...
        return constructor.new(_1916.MastaSettings)(self.wrapped.MastaSettings) if self.wrapped.MastaSettings else None
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1880.RollingBearing'):
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.08, pulley_b_diameter: Optional['float'] = 0.08, name: Optional['str'] = 'Belt Drive') -> '_2278.BeltCreationOptions':
    ...
    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.05) -> '_2281.PlanetCarrierCreationOptions':
    ...
    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.025, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2282.ShaftCreationOptions':
    ...
    def new_cylindrical_gear_pair_creation_options(self) -> '_1075.CylindricalGearPairCreationOptions':
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2280.CylindricalGearLinearTrainCreationOptions':
    ...
    def new_spiral_bevel_gear_set_creation_options(self) -> '_1078.SpiralBevelGearSetCreationOptions':
    ...
    def new_hypoid_gear_set_creation_options(self) -> '_1077.HypoidGearSetCreationOptions':
    ...
    def new_cycloidal_assembly_creation_options(self, number_of_discs: Optional['int'] = 1, number_of_pins: Optional['int'] = 10, name: Optional['str'] = 'Cycloidal Assembly') -> '_2279.CycloidalAssemblyCreationOptions':
    ...
    def design_state_load_case_group_named(self, name: 'str') -> '_5355.DesignState':
    ...
    def time_series_load_case_group_named(self, name: 'str') -> '_5363.TimeSeriesLoadCaseGroup':
    ...
    def design_state_named(self, name: 'str') -> '_5355.DesignState':
    ...
    def duty_cycle_named(self, name: 'str') -> '_5356.DutyCycle':
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1544.Status':
    ...
    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_7242.TaskProgress') -> '_1544.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2684.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2684.SynchroniserShift':
    ...
    def add_synchroniser_shift_empty(self) -> '_2684.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5355.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5356.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_2143.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2143.Assembly.TYPE](), constructor.new(_2143.Assembly))
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1360.ExternalFullFEFileOption'] = _1360.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
