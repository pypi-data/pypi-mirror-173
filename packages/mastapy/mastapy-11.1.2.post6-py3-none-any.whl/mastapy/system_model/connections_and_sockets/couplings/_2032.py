...
class SpringDamperConnection(_2028.CouplingConnection):
    '''SpringDamperConnection
    ...
    @property
    def damping_option(self) -> '_1891.ComponentDampingOption':
        ...
        return constructor.new(_1891.ComponentDampingOption)(value) if value else None

    @damping_option.setter
    def damping_option(self, value: '_1891.ComponentDampingOption'):
