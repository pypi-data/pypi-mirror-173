...
from mastapy.system_model.connections_and_sockets import _2127
...
class CycloidalDiscPlanetaryBearingConnection(_2127.AbstractShaftToMountableComponentConnection):
    '''CycloidalDiscPlanetaryBearingConnection
