...
class SocketConnectionOptions(_0.APIBase):
    ...
    @property
    def sockets(self) -> 'List[_1980.SocketConnectionSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Sockets, constructor.new(_1980.SocketConnectionSelection))
        return value
