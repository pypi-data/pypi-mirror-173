...
class ConceptGearMesh(_1995.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_1090.ConceptGearMeshDesign':
        ...
        return constructor.new(_1090.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
