...
from mastapy.gears.gear_designs.concept import _1129
...
class ConceptGearMesh(_2175.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_1129.ConceptGearMeshDesign':
        ...
        return constructor.new(_1129.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign is not None else None
