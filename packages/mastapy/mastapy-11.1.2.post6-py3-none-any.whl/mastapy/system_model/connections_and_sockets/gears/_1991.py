...
from mastapy.system_model.part_model.gears import _2203, _2219, _2202
...
class CylindricalGearMesh(_1995.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2203.CylindricalGearSet':
        ...
        if _2203.CylindricalGearSet.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_mesh_design(self) -> '_950.CylindricalGearMeshDesign':
        ...
        return constructor.new(_950.CylindricalGearMeshDesign)(self.wrapped.CylindricalGearMeshDesign) if self.wrapped.CylindricalGearMeshDesign else None
