...
class WormGearMesh(_1995.GearMesh):
    '''WormGearMesh
    ...
    @property
    def worm_gear_mesh_design(self) -> '_889.WormGearMeshDesign':
        ...
        return constructor.new(_889.WormGearMeshDesign)(self.wrapped.WormGearMeshDesign) if self.wrapped.WormGearMeshDesign else None
