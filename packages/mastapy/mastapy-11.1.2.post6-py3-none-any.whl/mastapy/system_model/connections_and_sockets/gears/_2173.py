...
class FaceGearMesh(_2175.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_953.FaceGearMeshDesign':
        ...
        return constructor.new(_953.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign is not None else None
