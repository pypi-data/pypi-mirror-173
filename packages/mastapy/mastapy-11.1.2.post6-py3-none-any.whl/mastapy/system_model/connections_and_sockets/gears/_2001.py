...
class KlingelnbergCycloPalloidHypoidGearMesh(_2000.KlingelnbergCycloPalloidConicalGearMesh):
    '''KlingelnbergCycloPalloidHypoidGearMesh
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_mesh_design(self) -> '_909.KlingelnbergCycloPalloidHypoidGearMeshDesign':
        ...
        return constructor.new(_909.KlingelnbergCycloPalloidHypoidGearMeshDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGearMeshDesign) if self.wrapped.KlingelnbergCycloPalloidHypoidGearMeshDesign else None
