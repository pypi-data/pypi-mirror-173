...
from mastapy.system_model.connections_and_sockets.gears import _2179
...
class KlingelnbergSpiralBevelGearTeethSocket(_2179.KlingelnbergConicalGearTeethSocket):
    '''KlingelnbergSpiralBevelGearTeethSocket
