...
class HypoidGearMesh(_1981.AGMAGleasonConicalGearMesh):
    '''HypoidGearMesh
    ...
    @property
    def hypoid_gear_mesh_design(self) -> '_917.HypoidGearMeshDesign':
        ...
        return constructor.new(_917.HypoidGearMeshDesign)(self.wrapped.HypoidGearMeshDesign) if self.wrapped.HypoidGearMeshDesign else None
