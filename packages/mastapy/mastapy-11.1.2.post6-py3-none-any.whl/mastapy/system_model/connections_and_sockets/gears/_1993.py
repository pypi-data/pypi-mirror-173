...
class FaceGearMesh(_1995.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_922.FaceGearMeshDesign':
        ...
        return constructor.new(_922.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign else None
