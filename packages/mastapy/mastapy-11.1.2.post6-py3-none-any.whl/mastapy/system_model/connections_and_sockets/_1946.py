...
from mastapy.system_model.part_model.cycloidal import _2246, _2245
...
class AbstractShaftToMountableComponentConnection(_1953.Connection):
    '''AbstractShaftToMountableComponentConnection
    ...
    @property
    def mountable_component(self) -> '_2142.MountableComponent':
        ...
        if _2142.MountableComponent.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_bearing(self) -> '_2119.Bearing':
        ...
        if _2119.Bearing.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_connector(self) -> '_2126.Connector':
        ...
        if _2126.Connector.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_mass_disc(self) -> '_2140.MassDisc':
        ...
        if _2140.MassDisc.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_measurement_component(self) -> '_2141.MeasurementComponent':
        ...
        if _2141.MeasurementComponent.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_oil_seal(self) -> '_2144.OilSeal':
        ...
        if _2144.OilSeal.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_planet_carrier(self) -> '_2147.PlanetCarrier':
        ...
        if _2147.PlanetCarrier.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_point_load(self) -> '_2149.PointLoad':
        ...
        if _2149.PointLoad.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_power_load(self) -> '_2150.PowerLoad':
        ...
        if _2150.PowerLoad.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_unbalanced_mass(self) -> '_2155.UnbalancedMass':
        ...
        if _2155.UnbalancedMass.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_virtual_component(self) -> '_2156.VirtualComponent':
        ...
        if _2156.VirtualComponent.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_agma_gleason_conical_gear(self) -> '_2189.AGMAGleasonConicalGear':
        ...
        if _2189.AGMAGleasonConicalGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_bevel_differential_gear(self) -> '_2191.BevelDifferentialGear':
        ...
        if _2191.BevelDifferentialGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_bevel_differential_planet_gear(self) -> '_2193.BevelDifferentialPlanetGear':
        ...
        if _2193.BevelDifferentialPlanetGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_bevel_differential_sun_gear(self) -> '_2194.BevelDifferentialSunGear':
        ...
        if _2194.BevelDifferentialSunGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_bevel_gear(self) -> '_2195.BevelGear':
        ...
        if _2195.BevelGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_concept_gear(self) -> '_2197.ConceptGear':
        ...
        if _2197.ConceptGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_conical_gear(self) -> '_2199.ConicalGear':
        ...
        if _2199.ConicalGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_cylindrical_gear(self) -> '_2201.CylindricalGear':
        ...
        if _2201.CylindricalGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_cylindrical_planet_gear(self) -> '_2203.CylindricalPlanetGear':
        ...
        if _2203.CylindricalPlanetGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_face_gear(self) -> '_2204.FaceGear':
        ...
        if _2204.FaceGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_gear(self) -> '_2206.Gear':
        ...
        if _2206.Gear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_hypoid_gear(self) -> '_2210.HypoidGear':
        ...
        if _2210.HypoidGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_klingelnberg_cyclo_palloid_conical_gear(self) -> '_2212.KlingelnbergCycloPalloidConicalGear':
        ...
        if _2212.KlingelnbergCycloPalloidConicalGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_klingelnberg_cyclo_palloid_hypoid_gear(self) -> '_2214.KlingelnbergCycloPalloidHypoidGear':
        ...
        if _2214.KlingelnbergCycloPalloidHypoidGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_2216.KlingelnbergCycloPalloidSpiralBevelGear':
        ...
        if _2216.KlingelnbergCycloPalloidSpiralBevelGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_spiral_bevel_gear(self) -> '_2219.SpiralBevelGear':
        ...
        if _2219.SpiralBevelGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_straight_bevel_diff_gear(self) -> '_2221.StraightBevelDiffGear':
        ...
        if _2221.StraightBevelDiffGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_straight_bevel_gear(self) -> '_2223.StraightBevelGear':
        ...
        if _2223.StraightBevelGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_straight_bevel_planet_gear(self) -> '_2225.StraightBevelPlanetGear':
        ...
        if _2225.StraightBevelPlanetGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_straight_bevel_sun_gear(self) -> '_2226.StraightBevelSunGear':
        ...
        if _2226.StraightBevelSunGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_worm_gear(self) -> '_2227.WormGear':
        ...
        if _2227.WormGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_zerol_bevel_gear(self) -> '_2229.ZerolBevelGear':
        ...
        if _2229.ZerolBevelGear.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_ring_pins(self) -> '_2246.RingPins':
        ...
        if _2246.RingPins.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_clutch_half(self) -> '_2255.ClutchHalf':
        ...
        if _2255.ClutchHalf.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_concept_coupling_half(self) -> '_2258.ConceptCouplingHalf':
        ...
        if _2258.ConceptCouplingHalf.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_coupling_half(self) -> '_2260.CouplingHalf':
        ...
        if _2260.CouplingHalf.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_cvt_pulley(self) -> '_2263.CVTPulley':
        ...
        if _2263.CVTPulley.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_part_to_part_shear_coupling_half(self) -> '_2265.PartToPartShearCouplingHalf':
        ...
        if _2265.PartToPartShearCouplingHalf.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_pulley(self) -> '_2266.Pulley':
        ...
        if _2266.Pulley.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_rolling_ring(self) -> '_2272.RollingRing':
        ...
        if _2272.RollingRing.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_shaft_hub_connection(self) -> '_2274.ShaftHubConnection':
        ...
        if _2274.ShaftHubConnection.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_spring_damper_half(self) -> '_2277.SpringDamperHalf':
        ...
        if _2277.SpringDamperHalf.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_synchroniser_half(self) -> '_2280.SynchroniserHalf':
        ...
        if _2280.SynchroniserHalf.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_synchroniser_part(self) -> '_2281.SynchroniserPart':
        ...
        if _2281.SynchroniserPart.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_synchroniser_sleeve(self) -> '_2282.SynchroniserSleeve':
        ...
        if _2282.SynchroniserSleeve.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_torque_converter_pump(self) -> '_2284.TorqueConverterPump':
        ...
        if _2284.TorqueConverterPump.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def mountable_component_of_type_torque_converter_turbine(self) -> '_2286.TorqueConverterTurbine':
        ...
        if _2286.TorqueConverterTurbine.TYPE not in self.wrapped.MountableComponent.__class__.__mro__:
    ...
    @property
    def shaft(self) -> '_2115.AbstractShaft':
        ...
        if _2115.AbstractShaft.TYPE not in self.wrapped.Shaft.__class__.__mro__:
    ...
    @property
    def shaft_of_type_shaft(self) -> '_2159.Shaft':
        ...
        if _2159.Shaft.TYPE not in self.wrapped.Shaft.__class__.__mro__:
            raise CastException('Failed to cast shaft to Shaft. Expected: {}.'.format(self.wrapped.Shaft.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Shaft.__class__)(self.wrapped.Shaft) if self.wrapped.Shaft else None

    @property
    def shaft_of_type_cycloidal_disc(self) -> '_2245.CycloidalDisc':
        ...
        if _2245.CycloidalDisc.TYPE not in self.wrapped.Shaft.__class__.__mro__:
