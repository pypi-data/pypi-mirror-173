...
from mastapy.system_model.connections_and_sockets import _2160
...
class SocketConnectionOptions(_0.APIBase):
    ...
    @property
    def sockets(self) -> 'List[_2160.SocketConnectionSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Sockets, constructor.new(_2160.SocketConnectionSelection))
        return value
