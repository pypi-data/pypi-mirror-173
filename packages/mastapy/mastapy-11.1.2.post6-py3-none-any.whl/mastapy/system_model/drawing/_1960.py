...
class ContourDrawStyle(_275.DrawStyleBase):
    ...
    def contour(self) -> '_1572.ThreeDViewContourOption':
        ...
        return constructor.new(_1572.ThreeDViewContourOption)(value) if value is not None else None
    ...
    def deflection_scaling(self) -> '_1970.ScalingDrawStyle':
        ...
        return constructor.new(_1970.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling is not None else None
    ...
    def model_view_options(self) -> '_1966.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1966.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions is not None else None
