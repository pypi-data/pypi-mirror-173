...
from mastapy.utility.enums import _1707
...
class ScalingDrawStyle(_0.APIBase):
    ...
    @property
    def bearing_force_arrows(self) -> '_1707.BearingForceArrowOption':
        ...
        return constructor.new(_1707.BearingForceArrowOption)(value) if value is not None else None

    @bearing_force_arrows.setter
    def bearing_force_arrows(self, value: '_1707.BearingForceArrowOption'):
