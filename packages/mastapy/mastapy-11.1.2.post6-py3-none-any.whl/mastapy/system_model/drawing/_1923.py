...
from mastapy.system_model.drawing import _1926, _1933
...
class AbstractSystemDeflectionViewable(_1933.PartAnalysisCaseWithContourViewable):
    '''AbstractSystemDeflectionViewable
    ...
    @property
    def contour_draw_style(self) -> '_1926.ContourDrawStyle':
        ...
        if _1926.ContourDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_system_deflection_draw_style(self) -> '_2493.SystemDeflectionDrawStyle':
        ...
        if _2493.SystemDeflectionDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_steady_state_synchronous_response_draw_style(self) -> '_3275.SteadyStateSynchronousResponseDrawStyle':
        ...
        if _3275.SteadyStateSynchronousResponseDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_stability_analysis_draw_style(self) -> '_3536.StabilityAnalysisDrawStyle':
        ...
        if _3536.StabilityAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_rotor_dynamics_draw_style(self) -> '_3691.RotorDynamicsDrawStyle':
        ...
        if _3691.RotorDynamicsDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_modal_analysis_draw_style(self) -> '_4832.ModalAnalysisDrawStyle':
        ...
        if _4832.ModalAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_mbd_analysis_draw_style(self) -> '_5118.MBDAnalysisDrawStyle':
        ...
        if _5118.MBDAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_harmonic_analysis_draw_style(self) -> '_5675.HarmonicAnalysisDrawStyle':
        ...
        if _5675.HarmonicAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_dynamic_analysis_draw_style(self) -> '_5977.DynamicAnalysisDrawStyle':
        ...
        if _5977.DynamicAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_critical_speed_analysis_draw_style(self) -> '_6230.CriticalSpeedAnalysisDrawStyle':
        ...
        if _6230.CriticalSpeedAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def system_deflection_draw_style(self) -> '_2493.SystemDeflectionDrawStyle':
        ...
        return constructor.new(_2493.SystemDeflectionDrawStyle)(self.wrapped.SystemDeflectionDrawStyle) if self.wrapped.SystemDeflectionDrawStyle else None
