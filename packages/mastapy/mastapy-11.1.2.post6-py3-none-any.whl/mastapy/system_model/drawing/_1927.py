...
from mastapy.system_model.drawing import _1937, _1933
...
class ContourDrawStyle(_272.DrawStyleBase):
    '''ContourDrawStyle
    ...
    @property
    def contour(self) -> '_1551.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1551.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1551.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1937.ScalingDrawStyle':
        ...
        return constructor.new(_1937.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1933.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1933.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
