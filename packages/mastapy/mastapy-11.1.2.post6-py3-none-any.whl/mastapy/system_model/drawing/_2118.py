...
from mastapy.math_utility.measured_vectors import _1461
...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    @property
    def node_detail(self) -> '_1461.ForceAndDisplacementResults':
        ...
        return constructor.new(_1461.ForceAndDisplacementResults)(self.wrapped.NodeDetail) if self.wrapped.NodeDetail is not None else None

    @property
    def section_to_the_left_side(self) -> '_2658.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2658.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheLeftSide) if self.wrapped.SectionToTheLeftSide is not None else None

    @property
    def section_to_the_right_side(self) -> '_2658.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2658.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheRightSide) if self.wrapped.SectionToTheRightSide is not None else None
