...
from mastapy.system_model.drawing import _1964, _1960
...
class ContourDrawStyle(_275.DrawStyleBase):
    ...
    @property
    def contour(self) -> '_1570.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1570.ThreeDViewContourOption)(value) if value else None

    @contour.setter
    def contour(self, value: '_1570.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_1964.ScalingDrawStyle':
        ...
        return constructor.new(_1964.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1960.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1960.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
