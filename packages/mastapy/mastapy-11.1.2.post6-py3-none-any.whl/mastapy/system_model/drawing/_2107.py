...
from mastapy.system_model.drawing import _2117, _2113
from mastapy.geometry import _279
...
class ContourDrawStyle(_279.DrawStyleBase):
    '''ContourDrawStyle
    ...
    @property
    def contour(self) -> '_1709.ThreeDViewContourOption':
        '''ThreeDViewContourOption: 'Contour' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Contour)
        return constructor.new(_1709.ThreeDViewContourOption)(value) if value is not None else None

    @contour.setter
    def contour(self, value: '_1709.ThreeDViewContourOption'):
    ...
    @property
    def deflection_scaling(self) -> '_2117.ScalingDrawStyle':
        ...
        return constructor.new(_2117.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling is not None else None

    @property
    def model_view_options(self) -> '_2113.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_2113.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions is not None else None
