...
from mastapy.system_model.drawing import _2118
...
class ConcentricPartGroupCombinationSystemDeflectionShaftResults(_0.APIBase):
    ...
    @property
    def shaft_system_deflection(self) -> '_2659.ShaftSystemDeflection':
        ...
        return constructor.new(_2659.ShaftSystemDeflection)(self.wrapped.ShaftSystemDeflection) if self.wrapped.ShaftSystemDeflection is not None else None

    @property
    def node_results(self) -> 'List[_2118.ShaftDeflectionDrawingNodeItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_2118.ShaftDeflectionDrawingNodeItem))
        return value
