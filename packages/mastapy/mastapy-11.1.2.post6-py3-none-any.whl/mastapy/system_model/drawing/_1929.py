...
from mastapy.system_model.drawing import _1927, _1934
...
class DynamicAnalysisViewable(_1934.PartAnalysisCaseWithContourViewable):
    '''DynamicAnalysisViewable
    ...
    @property
    def contour_draw_style(self) -> '_1927.ContourDrawStyle':
        ...
        if _1927.ContourDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_system_deflection_draw_style(self) -> '_2494.SystemDeflectionDrawStyle':
        ...
        if _2494.SystemDeflectionDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_steady_state_synchronous_response_draw_style(self) -> '_3276.SteadyStateSynchronousResponseDrawStyle':
        ...
        if _3276.SteadyStateSynchronousResponseDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_stability_analysis_draw_style(self) -> '_3537.StabilityAnalysisDrawStyle':
        ...
        if _3537.StabilityAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_rotor_dynamics_draw_style(self) -> '_3692.RotorDynamicsDrawStyle':
        ...
        if _3692.RotorDynamicsDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_modal_analysis_draw_style(self) -> '_4833.ModalAnalysisDrawStyle':
        ...
        if _4833.ModalAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_mbd_analysis_draw_style(self) -> '_5119.MBDAnalysisDrawStyle':
        ...
        if _5119.MBDAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_harmonic_analysis_draw_style(self) -> '_5676.HarmonicAnalysisDrawStyle':
        ...
        if _5676.HarmonicAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_dynamic_analysis_draw_style(self) -> '_5974.DynamicAnalysisDrawStyle':
        ...
        if _5974.DynamicAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_critical_speed_analysis_draw_style(self) -> '_6227.CriticalSpeedAnalysisDrawStyle':
        ...
        if _6227.CriticalSpeedAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def dynamic_analysis_draw_style(self) -> '_5974.DynamicAnalysisDrawStyle':
        ...
        if _5974.DynamicAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
    ...
    @property
    def dynamic_analysis_draw_style_of_type_modal_analysis_draw_style(self) -> '_4833.ModalAnalysisDrawStyle':
        ...
        if _4833.ModalAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
    ...
    @property
    def dynamic_analysis_draw_style_of_type_harmonic_analysis_draw_style(self) -> '_5676.HarmonicAnalysisDrawStyle':
        ...
        if _5676.HarmonicAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
