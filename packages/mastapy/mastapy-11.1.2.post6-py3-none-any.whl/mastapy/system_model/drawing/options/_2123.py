...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6842, _6843
from mastapy._internal.implicit import list_with_selected_item
from mastapy.system_model.part_model.gears import _2392
...
class AdvancedTimeSteppingAnalysisForModulationModeViewOptions(_0.APIBase):
    ...
    @property
    def excitations_type(self) -> '_6842.AtsamExcitationsOrOthers':
        ...
        return constructor.new(_6842.AtsamExcitationsOrOthers)(value) if value is not None else None

    @excitations_type.setter
    def excitations_type(self, value: '_6842.AtsamExcitationsOrOthers'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ExcitationsType = value

    @property
    def mode_view_options(self) -> '_6843.AtsamNaturalFrequencyViewOption':
        ...
        return constructor.new(_6843.AtsamNaturalFrequencyViewOption)(value) if value is not None else None

    @mode_view_options.setter
    def mode_view_options(self, value: '_6843.AtsamNaturalFrequencyViewOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
