...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def index_range(self) -> '_1348.IntegerRange':
        '''IntegerRange: 'IndexRange' is the original name of this property.'''

        return constructor.new(_1348.IntegerRange)(self.wrapped.IndexRange) if self.wrapped.IndexRange else None

    @index_range.setter
    def index_range(self, value: '_1348.IntegerRange'):
        value = value.wrapped if value else None
        self.wrapped.IndexRange = value

    @property
    def frequency_range(self) -> '_1253.Range':
        '''Range: 'FrequencyRange' is the original name of this property.'''

        if _1253.Range.TYPE not in self.wrapped.FrequencyRange.__class__.__mro__:
    ...
    def frequency_range(self, value: '_1253.Range'):
        value = value.wrapped if value else None
    ...
    @property
    def filtering_frequency_range(self) -> '_1253.Range':
        '''Range: 'FilteringFrequencyRange' is the original name of this property.'''

        if _1253.Range.TYPE not in self.wrapped.FilteringFrequencyRange.__class__.__mro__:
    ...
    def filtering_frequency_range(self, value: '_1253.Range'):
        value = value.wrapped if value else None
