...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5945, _5946
from mastapy.utility import _1486
...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def modes_to_display(self) -> '_5945.ModalContributionDisplayMethod':
        ...
        return constructor.new(_5945.ModalContributionDisplayMethod)(value) if value is not None else None

    @modes_to_display.setter
    def modes_to_display(self, value: '_5945.ModalContributionDisplayMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ModesToDisplay = value

    @property
    def filtering_method(self) -> '_5946.ModalContributionFilteringMethod':
        ...
        return constructor.new(_5946.ModalContributionFilteringMethod)(value) if value is not None else None

    @filtering_method.setter
    def filtering_method(self, value: '_5946.ModalContributionFilteringMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def index_range(self) -> '_1486.IntegerRange':
        '''IntegerRange: 'IndexRange' is the original name of this property.'''

        return constructor.new(_1486.IntegerRange)(self.wrapped.IndexRange) if self.wrapped.IndexRange is not None else None

    @index_range.setter
    def index_range(self, value: '_1486.IntegerRange'):
        value = value.wrapped if value else None
        self.wrapped.IndexRange = value

    @property
    def frequency_range(self) -> '_1388.Range':
        '''Range: 'FrequencyRange' is the original name of this property.'''

        if _1388.Range.TYPE not in self.wrapped.FrequencyRange.__class__.__mro__:
    ...
    def frequency_range(self, value: '_1388.Range'):
        value = value.wrapped if value else None
    ...
    @property
    def filtering_frequency_range(self) -> '_1388.Range':
        '''Range: 'FilteringFrequencyRange' is the original name of this property.'''

        if _1388.Range.TYPE not in self.wrapped.FilteringFrequencyRange.__class__.__mro__:
    ...
    def filtering_frequency_range(self, value: '_1388.Range'):
        value = value.wrapped if value else None
