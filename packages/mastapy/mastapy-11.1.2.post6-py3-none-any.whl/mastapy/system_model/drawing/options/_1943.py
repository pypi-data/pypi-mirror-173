...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6656, _6657
...
class AdvancedTimeSteppingAnalysisForModulationModeViewOptions(_0.APIBase):
    ...
    @property
    def excitations_type(self) -> '_6656.AtsamExcitationsOrOthers':
        ...
        return constructor.new(_6656.AtsamExcitationsOrOthers)(value) if value else None

    @excitations_type.setter
    def excitations_type(self, value: '_6656.AtsamExcitationsOrOthers'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ExcitationsType = value

    @property
    def mode_view_options(self) -> '_6657.AtsamNaturalFrequencyViewOption':
        ...
        return constructor.new(_6657.AtsamNaturalFrequencyViewOption)(value) if value else None

    @mode_view_options.setter
    def mode_view_options(self, value: '_6657.AtsamNaturalFrequencyViewOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
