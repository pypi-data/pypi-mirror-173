...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5792, _5793
...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def modes_to_display(self) -> '_5792.ModalContributionDisplayMethod':
        ...
        return constructor.new(_5792.ModalContributionDisplayMethod)(value) if value else None

    @modes_to_display.setter
    def modes_to_display(self, value: '_5792.ModalContributionDisplayMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ModesToDisplay = value

    @property
    def filtering_method(self) -> '_5793.ModalContributionFilteringMethod':
        ...
        return constructor.new(_5793.ModalContributionFilteringMethod)(value) if value else None

    @filtering_method.setter
    def filtering_method(self, value: '_5793.ModalContributionFilteringMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def index_range(self) -> '_1366.IntegerRange':
        '''IntegerRange: 'IndexRange' is the original name of this property.'''

        return constructor.new(_1366.IntegerRange)(self.wrapped.IndexRange) if self.wrapped.IndexRange else None

    @index_range.setter
    def index_range(self, value: '_1366.IntegerRange'):
        value = value.wrapped if value else None
        self.wrapped.IndexRange = value

    @property
    def frequency_range(self) -> '_1269.Range':
        '''Range: 'FrequencyRange' is the original name of this property.'''

        if _1269.Range.TYPE not in self.wrapped.FrequencyRange.__class__.__mro__:
    ...
    def frequency_range(self, value: '_1269.Range'):
        value = value.wrapped if value else None
    ...
    @property
    def filtering_frequency_range(self) -> '_1269.Range':
        '''Range: 'FilteringFrequencyRange' is the original name of this property.'''

        if _1269.Range.TYPE not in self.wrapped.FilteringFrequencyRange.__class__.__mro__:
    ...
    def filtering_frequency_range(self, value: '_1269.Range'):
        value = value.wrapped if value else None
