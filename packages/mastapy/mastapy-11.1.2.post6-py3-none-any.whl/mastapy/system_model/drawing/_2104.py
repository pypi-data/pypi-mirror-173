...
from mastapy.system_model.drawing import _2107, _2114
...
from mastapy.system_model.analyses_and_results.rotor_dynamics import _3879
...
class AbstractSystemDeflectionViewable(_2114.PartAnalysisCaseWithContourViewable):
    '''AbstractSystemDeflectionViewable
    ...
    @property
    def contour_draw_style(self) -> '_2107.ContourDrawStyle':
        ...
        if _2107.ContourDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_system_deflection_draw_style(self) -> '_2681.SystemDeflectionDrawStyle':
        ...
        if _2681.SystemDeflectionDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_steady_state_synchronous_response_draw_style(self) -> '_3463.SteadyStateSynchronousResponseDrawStyle':
        ...
        if _3463.SteadyStateSynchronousResponseDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_stability_analysis_draw_style(self) -> '_3724.StabilityAnalysisDrawStyle':
        ...
        if _3724.StabilityAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_rotor_dynamics_draw_style(self) -> '_3879.RotorDynamicsDrawStyle':
        ...
        if _3879.RotorDynamicsDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_modal_analysis_draw_style(self) -> '_5020.ModalAnalysisDrawStyle':
        ...
        if _5020.ModalAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_mbd_analysis_draw_style(self) -> '_5306.MBDAnalysisDrawStyle':
        ...
        if _5306.MBDAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_harmonic_analysis_draw_style(self) -> '_5863.HarmonicAnalysisDrawStyle':
        ...
        if _5863.HarmonicAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_dynamic_analysis_draw_style(self) -> '_6165.DynamicAnalysisDrawStyle':
        ...
        if _6165.DynamicAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
    ...
    @property
    def contour_draw_style_of_type_critical_speed_analysis_draw_style(self) -> '_6418.CriticalSpeedAnalysisDrawStyle':
        ...
        if _6418.CriticalSpeedAnalysisDrawStyle.TYPE not in self.wrapped.ContourDrawStyle.__class__.__mro__:
