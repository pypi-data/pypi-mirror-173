...
class RotorDynamicsViewable(_0.APIBase):
    ...
    @property
    def rotor_dynamics(self) -> '_3692.RotorDynamicsDrawStyle':
        ...
        if _3692.RotorDynamicsDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_steady_state_synchronous_response_draw_style(self) -> '_3276.SteadyStateSynchronousResponseDrawStyle':
        ...
        if _3276.SteadyStateSynchronousResponseDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_stability_analysis_draw_style(self) -> '_3537.StabilityAnalysisDrawStyle':
        ...
        if _3537.StabilityAnalysisDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_critical_speed_analysis_draw_style(self) -> '_6227.CriticalSpeedAnalysisDrawStyle':
        ...
        if _6227.CriticalSpeedAnalysisDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
