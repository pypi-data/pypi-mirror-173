...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    @property
    def section_to_the_left_side(self) -> '_2471.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2471.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheLeftSide) if self.wrapped.SectionToTheLeftSide else None

    @property
    def section_to_the_right_side(self) -> '_2471.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2471.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheRightSide) if self.wrapped.SectionToTheRightSide else None
