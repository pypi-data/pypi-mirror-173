...
from mastapy.utility import _1495
...
class SystemDirectoryPopulator(_0.APIBase):
    ...
    @property
    def version_to_copy(self) -> '_1495.SystemDirectory':
        ...
        return constructor.new(_1495.SystemDirectory)(self.wrapped.VersionToCopy) if self.wrapped.VersionToCopy is not None else None

    @property
    def current_version(self) -> '_1495.SystemDirectory':
        ...
        return constructor.new(_1495.SystemDirectory)(self.wrapped.CurrentVersion) if self.wrapped.CurrentVersion is not None else None
