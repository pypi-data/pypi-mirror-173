...
from mastapy.utility.units_and_measurements.measurements import _1582
...
class DutyCyclePropertySummaryPercentage(_1724.DutyCyclePropertySummary['_1582.Percentage', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryPercentage
