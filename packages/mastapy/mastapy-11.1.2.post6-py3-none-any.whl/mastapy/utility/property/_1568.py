...
from mastapy.utility.units_and_measurements.measurements import _1372
...
class DutyCyclePropertySummarySmallAngle(_1565.DutyCyclePropertySummary['_1372.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
