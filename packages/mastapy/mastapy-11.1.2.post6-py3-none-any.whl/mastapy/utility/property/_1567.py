...
from mastapy.utility.units_and_measurements.measurements import _1433
...
class DutyCyclePropertySummaryPercentage(_1565.DutyCyclePropertySummary['_1433.Percentage', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryPercentage
