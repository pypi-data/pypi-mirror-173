...
from mastapy.utility.units_and_measurements.measurements import _1413
...
class DutyCyclePropertySummaryForce(_1587.DutyCyclePropertySummary['_1413.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
