...
from mastapy.utility.units_and_measurements.measurements import _1455
...
class DutyCyclePropertySummaryStress(_1565.DutyCyclePropertySummary['_1455.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
