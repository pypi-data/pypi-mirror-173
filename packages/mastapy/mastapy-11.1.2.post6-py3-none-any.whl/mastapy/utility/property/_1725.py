...
from mastapy.utility.units_and_measurements.measurements import _1536
...
class DutyCyclePropertySummaryForce(_1724.DutyCyclePropertySummary['_1536.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
