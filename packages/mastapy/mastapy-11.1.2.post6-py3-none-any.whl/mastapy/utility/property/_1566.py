...
from mastapy.utility.units_and_measurements.measurements import _1393
...
class DutyCyclePropertySummaryForce(_1565.DutyCyclePropertySummary['_1393.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
