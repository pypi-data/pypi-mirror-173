...
from mastapy.utility.report import _1502, _1503
...
T = TypeVar('T', bound='_1503.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1502.CustomReportItemContainerCollectionBase, Generic[T]):
    '''CustomReportItemContainerCollection
