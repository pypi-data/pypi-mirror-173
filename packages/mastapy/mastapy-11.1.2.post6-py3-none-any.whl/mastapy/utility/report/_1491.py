...
from mastapy.utility.cad_export import _1562
...
class CustomReportCadDrawing(_1507.CustomReportNameableItem):
    '''CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self) -> '_1562.StockDrawings':
        '''StockDrawings: 'StockDrawing' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.StockDrawing)
        return constructor.new(_1562.StockDrawings)(value) if value else None

    @stock_drawing.setter
    def stock_drawing(self, value: '_1562.StockDrawings'):
