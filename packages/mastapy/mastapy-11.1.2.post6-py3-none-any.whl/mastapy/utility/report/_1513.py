...
from mastapy.html import _268
from mastapy._internal.implicit import overridable
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.utility.report import _1496
...
class CustomReportText(_1496.CustomReportDefinitionItem):
    '''CustomReportText
    ...
    @property
    def heading_type(self) -> '_268.HeadingType':
        '''HeadingType: 'HeadingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingType)
        return constructor.new(_268.HeadingType)(value) if value else None

    @heading_type.setter
    def heading_type(self, value: '_268.HeadingType'):
