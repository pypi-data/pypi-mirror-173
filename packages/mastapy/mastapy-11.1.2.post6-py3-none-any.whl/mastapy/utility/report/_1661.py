...
from mastapy.utility.report import _1662, _1665
...
TItem = TypeVar('TItem', bound='_1665.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1662.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
