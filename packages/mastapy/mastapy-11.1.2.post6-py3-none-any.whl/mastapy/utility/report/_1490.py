...
class CustomReport(_1500.CustomReportItemContainer):
    '''CustomReport
    ...
    @property
    def cad_table_border_style(self) -> '_1486.CadTableBorderType':
        ...
        return constructor.new(_1486.CadTableBorderType)(value) if value else None

    @cad_table_border_style.setter
    def cad_table_border_style(self, value: '_1486.CadTableBorderType'):
    ...
    @property
    def page_size_for_cad_export(self) -> '_1485.CadPageSize':
        ...
        return constructor.new(_1485.CadPageSize)(value) if value else None

    @page_size_for_cad_export.setter
    def page_size_for_cad_export(self, value: '_1485.CadPageSize'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def include_report_check(self) -> '_1517.DefinitionBooleanCheckOptions':
        ...
        return constructor.new(_1517.DefinitionBooleanCheckOptions)(value) if value else None

    @include_report_check.setter
    def include_report_check(self, value: '_1517.DefinitionBooleanCheckOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
