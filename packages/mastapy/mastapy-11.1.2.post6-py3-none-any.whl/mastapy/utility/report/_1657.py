...
from mastapy.utility.report import _1658, _1659
...
T = TypeVar('T', bound='_1659.CustomReportItemContainerCollectionItem')


class CustomReportItemContainerCollection(_1658.CustomReportItemContainerCollectionBase, Generic[T]):
    '''CustomReportItemContainerCollection
