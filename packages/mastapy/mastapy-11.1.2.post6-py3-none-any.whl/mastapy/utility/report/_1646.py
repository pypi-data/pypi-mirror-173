...
class CustomReport(_1656.CustomReportItemContainer):
    '''CustomReport
    ...
    @property
    def cad_table_border_style(self) -> '_1641.CadTableBorderType':
        ...
        return constructor.new(_1641.CadTableBorderType)(value) if value is not None else None

    @cad_table_border_style.setter
    def cad_table_border_style(self, value: '_1641.CadTableBorderType'):
    ...
    @property
    def page_size_for_cad_export(self) -> '_1640.CadPageSize':
        ...
        return constructor.new(_1640.CadPageSize)(value) if value is not None else None

    @page_size_for_cad_export.setter
    def page_size_for_cad_export(self, value: '_1640.CadPageSize'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def include_report_check(self) -> '_1673.DefinitionBooleanCheckOptions':
        ...
        return constructor.new(_1673.DefinitionBooleanCheckOptions)(value) if value is not None else None

    @include_report_check.setter
    def include_report_check(self, value: '_1673.DefinitionBooleanCheckOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
