...
class CustomReportText(_1652.CustomReportDefinitionItem):
    '''CustomReportText
    ...
    @property
    def heading_type(self) -> '_275.HeadingType':
        '''HeadingType: 'HeadingType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingType)
        return constructor.new(_275.HeadingType)(value) if value is not None else None

    @heading_type.setter
    def heading_type(self, value: '_275.HeadingType'):
