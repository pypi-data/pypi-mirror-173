...
from mastapy.utility.report import _1520, _1519
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.utility.reporting_property_framework import _1480
...
class CustomReportPropertyItem(_0.APIBase):
    ...
    @property
    def font_weight(self) -> '_1520.FontWeight':
        '''FontWeight: 'FontWeight' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FontWeight)
        return constructor.new(_1520.FontWeight)(value) if value else None

    @font_weight.setter
    def font_weight(self, value: '_1520.FontWeight'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontWeight = value

    @property
    def font_style(self) -> '_1519.FontStyle':
        '''FontStyle: 'FontStyle' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FontStyle)
        return constructor.new(_1519.FontStyle)(value) if value else None

    @font_style.setter
    def font_style(self, value: '_1519.FontStyle'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FontStyle = value

    @property
    def horizontal_position(self) -> '_1480.CellValuePosition':
        ...
        return constructor.new(_1480.CellValuePosition)(value) if value else None

    @horizontal_position.setter
    def horizontal_position(self, value: '_1480.CellValuePosition'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
