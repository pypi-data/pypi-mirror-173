...
from mastapy.utility.report import _1506, _1509
...
TItem = TypeVar('TItem', bound='_1509.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1506.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
