...
class UserTextRow(_1514.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1521.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1521.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1521.HeadingSize'):
