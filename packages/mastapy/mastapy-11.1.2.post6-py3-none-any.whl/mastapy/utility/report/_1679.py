...
from mastapy.utility.report import _1677, _1670
...
class UserTextRow(_1670.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1677.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1677.HeadingSize)(value) if value is not None else None

    @heading_size.setter
    def heading_size(self, value: '_1677.HeadingSize'):
