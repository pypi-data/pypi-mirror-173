...
from mastapy.utility.model_validation import _1681
...
class StatusItem(_0.APIBase):
    ...
    def fixes(self) -> 'List[_1681.Fix]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Fixes, constructor.new(_1681.Fix))
        return value
