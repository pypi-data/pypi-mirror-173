...
from mastapy.utility.model_validation import _1527
...
class Status(_0.APIBase):
    ...
    @property
    def errors(self) -> 'List[_1527.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Errors, constructor.new(_1527.StatusItem))
        return value

    @property
    def warnings(self) -> 'List[_1527.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Warnings, constructor.new(_1527.StatusItem))
        return value
