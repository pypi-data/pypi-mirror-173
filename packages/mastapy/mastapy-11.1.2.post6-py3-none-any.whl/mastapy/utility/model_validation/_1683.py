...
from mastapy.utility.model_validation import _1684
...
class Status(_0.APIBase):
    ...
    @property
    def errors(self) -> 'List[_1684.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Errors, constructor.new(_1684.StatusItem))
        return value

    @property
    def warnings(self) -> 'List[_1684.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Warnings, constructor.new(_1684.StatusItem))
        return value
