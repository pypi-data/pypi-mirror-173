...
from mastapy.utility.databases import _1716, _1718, _1717
...
TValue = TypeVar('TValue', bound='_1716.NamedDatabaseItem')


class NamedDatabase(_1718.SQLDatabase['_1717.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1716.NamedDatabaseItem', new_name: 'str') -> 'bool':
    ...
    def duplicate(self, new_name: 'str', item: '_1716.NamedDatabaseItem') -> '_1716.NamedDatabaseItem':
