...
from mastapy.utility.databases import _1579, _1576, _1575
...
TKey = TypeVar('TKey', bound='_1576.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1575.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1579.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1576.DatabaseKey'):
