...
from mastapy.utility.databases import _1716, _1713, _1712
...
TKey = TypeVar('TKey', bound='_1713.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1712.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1716.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1713.DatabaseKey'):
