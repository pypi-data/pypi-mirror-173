...
from mastapy.utility.databases import _1717
...
class NamedDatabaseItem(_0.APIBase):
    ...
    @property
    def database_key(self) -> '_1717.NamedKey':
        '''NamedKey: 'DatabaseKey' is the original name of this property.'''

        return constructor.new(_1717.NamedKey)(self.wrapped.DatabaseKey) if self.wrapped.DatabaseKey is not None else None

    @database_key.setter
    def database_key(self, value: '_1717.NamedKey'):
