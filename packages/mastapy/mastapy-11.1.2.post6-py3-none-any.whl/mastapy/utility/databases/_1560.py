...
from mastapy.utility.databases import _1558, _1555, _1554
...
TKey = TypeVar('TKey', bound='_1555.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1554.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1558.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1555.DatabaseKey'):
