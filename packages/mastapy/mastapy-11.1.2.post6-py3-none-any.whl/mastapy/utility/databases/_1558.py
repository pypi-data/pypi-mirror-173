...
from mastapy.utility.databases import _1559
...
class NamedDatabaseItem(_0.APIBase):
    ...
    @property
    def database_key(self) -> '_1559.NamedKey':
        '''NamedKey: 'DatabaseKey' is the original name of this property.'''

        return constructor.new(_1559.NamedKey)(self.wrapped.DatabaseKey) if self.wrapped.DatabaseKey else None

    @database_key.setter
    def database_key(self, value: '_1559.NamedKey'):
