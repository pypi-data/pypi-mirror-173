...
from mastapy.utility.modal_analysis.gears import _1530, _1534
...
class GearMeshForTE(_1534.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1530.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1530.GearOrderForTE))
        return value
