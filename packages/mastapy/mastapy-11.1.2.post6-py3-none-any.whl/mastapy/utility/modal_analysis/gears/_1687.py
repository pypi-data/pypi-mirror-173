...
from mastapy.utility.modal_analysis.gears import _1688, _1692
...
class GearMeshForTE(_1692.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1688.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1688.GearOrderForTE))
        return value
