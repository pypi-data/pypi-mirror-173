...
from mastapy.utility.modal_analysis.gears import _1689, _1692, _1694
...
class GearOrderForTE(_1694.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1689.GearPositions':
        ...
        return constructor.new(_1689.GearPositions)(value) if value is not None else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1692.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1692.OrderForTE))
        return value
