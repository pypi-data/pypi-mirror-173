...
from mastapy.utility.modal_analysis.gears import _1531, _1535
...
class GearMeshForTE(_1535.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1531.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1531.GearOrderForTE))
        return value
