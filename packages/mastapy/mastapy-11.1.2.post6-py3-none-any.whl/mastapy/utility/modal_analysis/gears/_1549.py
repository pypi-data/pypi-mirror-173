...
from mastapy.utility.modal_analysis.gears import _1550, _1553, _1555
...
class GearOrderForTE(_1555.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1550.GearPositions':
        ...
        return constructor.new(_1550.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1553.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1553.OrderForTE))
        return value
