...
from mastapy.utility.modal_analysis.gears import _1549, _1553
...
class GearMeshForTE(_1553.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1549.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1549.GearOrderForTE))
        return value
