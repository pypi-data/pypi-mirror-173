...
from mastapy.utility.modal_analysis.gears import _1532, _1535, _1537
...
class GearOrderForTE(_1537.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1532.GearPositions':
        ...
        return constructor.new(_1532.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1535.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1535.OrderForTE))
        return value
