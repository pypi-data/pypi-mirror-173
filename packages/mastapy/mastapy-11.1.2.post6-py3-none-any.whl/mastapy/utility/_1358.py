...
class SystemDirectoryPopulator(_0.APIBase):
    ...
    @property
    def version_to_copy(self) -> '_1357.SystemDirectory':
        ...
        return constructor.new(_1357.SystemDirectory)(self.wrapped.VersionToCopy) if self.wrapped.VersionToCopy else None

    @property
    def current_version(self) -> '_1357.SystemDirectory':
        ...
        return constructor.new(_1357.SystemDirectory)(self.wrapped.CurrentVersion) if self.wrapped.CurrentVersion else None
