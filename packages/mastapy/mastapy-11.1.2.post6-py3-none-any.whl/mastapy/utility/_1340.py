...
from mastapy.utility import _1350, _1339
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self) -> '_1350.NumberFormatInfoSummary':
        ...
        return constructor.new(_1350.NumberFormatInfoSummary)(self.wrapped.CurrentCulture) if self.wrapped.CurrentCulture else None

    @property
    def dispatchers(self) -> 'List[_1339.DispatcherHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Dispatchers, constructor.new(_1339.DispatcherHelper))
        return value
