...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1355.RoundingMethods':
        ...
        return constructor.new(_1355.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1355.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1367.Unit':
        ...
        if _1367.Unit.TYPE not in self.wrapped.CurrentUnit.__class__.__mro__:
