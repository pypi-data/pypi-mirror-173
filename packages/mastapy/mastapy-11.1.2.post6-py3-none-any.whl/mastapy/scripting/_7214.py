...
from mastapy.scripting import _7206
...
class ApiVersioning:
    ...
    @staticmethod
    def get_available_api_versions(folder: 'str') -> 'Iterable[_7206.ApiVersion]':
        ...
        folder = str(folder)
        return conversion.pn_to_mp_objects_in_iterable(ApiVersioning.TYPE.GetAvailableApiVersions(folder if folder else None), constructor.new(_7206.ApiVersion))

    @staticmethod
    def get_available_api_utility_versions(folder: 'str') -> 'Iterable[_7206.ApiVersion]':
        ...
        folder = str(folder)
        return conversion.pn_to_mp_objects_in_iterable(ApiVersioning.TYPE.GetAvailableApiUtilityVersions(folder if folder else None), constructor.new(_7206.ApiVersion))

    @staticmethod
    def get_api_version_for_assembly(api_library_search_folder: 'str', assembly_path: 'str') -> '_7206.ApiVersion':
