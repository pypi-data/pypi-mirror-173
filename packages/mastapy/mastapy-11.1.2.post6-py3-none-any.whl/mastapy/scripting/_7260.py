...
class ApiVersioning:
    ...
    def get_available_api_versions(folder: 'str') -> 'Iterable[_7252.ApiVersion]':
        ...
        folder = str(folder)
        return conversion.pn_to_mp_objects_in_iterable(ApiVersioning.TYPE.GetAvailableApiVersions(folder if folder else ''), constructor.new(_7252.ApiVersion))
    ...
    def get_available_api_utility_versions(folder: 'str') -> 'Iterable[_7252.ApiVersion]':
        ...
        folder = str(folder)
        return conversion.pn_to_mp_objects_in_iterable(ApiVersioning.TYPE.GetAvailableApiUtilityVersions(folder if folder else ''), constructor.new(_7252.ApiVersion))
