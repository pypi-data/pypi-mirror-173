...
from mastapy.scripting import _7393
...
class ApiVersioning:
    ...
    @staticmethod
    def get_available_api_versions(folder: 'str') -> 'Iterable[_7393.ApiVersion]':
        ...
        folder = str(folder)
        return conversion.pn_to_mp_objects_in_iterable(ApiVersioning.TYPE.GetAvailableApiVersions(folder if folder else ''), constructor.new(_7393.ApiVersion))

    @staticmethod
    def get_available_api_utility_versions(folder: 'str') -> 'Iterable[_7393.ApiVersion]':
        ...
        folder = str(folder)
        return conversion.pn_to_mp_objects_in_iterable(ApiVersioning.TYPE.GetAvailableApiUtilityVersions(folder if folder else ''), constructor.new(_7393.ApiVersion))

    @staticmethod
    def get_api_version_for_assembly(api_library_search_folder: 'str', assembly_path: 'str') -> '_7393.ApiVersion':
