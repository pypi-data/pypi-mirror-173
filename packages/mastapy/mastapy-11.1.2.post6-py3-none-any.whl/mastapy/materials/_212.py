...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def radiation_efficiency_curve(self) -> '_1435.Vector2DListAccessor':
        '''Vector2DListAccessor: 'RadiationEfficiencyCurve' is the original name of this property.'''

        return constructor.new(_1435.Vector2DListAccessor)(self.wrapped.RadiationEfficiencyCurve) if self.wrapped.RadiationEfficiencyCurve is not None else None

    @radiation_efficiency_curve.setter
    def radiation_efficiency_curve(self, value: '_1435.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.RadiationEfficiencyCurve = value

    @property
    def input_type(self) -> '_213.AcousticRadiationEfficiencyInputType':
        ...
        return constructor.new(_213.AcousticRadiationEfficiencyInputType)(value) if value is not None else None

    @input_type.setter
    def input_type(self, value: '_213.AcousticRadiationEfficiencyInputType'):
