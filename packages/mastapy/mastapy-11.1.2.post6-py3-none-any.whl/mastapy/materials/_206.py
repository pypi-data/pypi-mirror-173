...
from mastapy.materials import _207
...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def input_type(self) -> '_207.AcousticRadiationEfficiencyInputType':
        ...
        return constructor.new(_207.AcousticRadiationEfficiencyInputType)(value) if value else None

    @input_type.setter
    def input_type(self, value: '_207.AcousticRadiationEfficiencyInputType'):
