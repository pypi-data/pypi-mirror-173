...
class SoundPressureEnclosure(_0.APIBase):
    ...
    @property
    def enclosure_type(self) -> '_258.SoundPressureEnclosureType':
        ...
        return constructor.new_from_mastapy_type(_258.SoundPressureEnclosureType)(value) if value is not None else None

    @enclosure_type.setter
    def enclosure_type(self, value: '_258.SoundPressureEnclosureType'):
