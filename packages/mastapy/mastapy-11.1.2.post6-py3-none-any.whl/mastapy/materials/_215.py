...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def input_type(self) -> '_216.AcousticRadiationEfficiencyInputType':
        ...
        return constructor.new_from_mastapy_type(_216.AcousticRadiationEfficiencyInputType)(value) if value is not None else None

    @input_type.setter
    def input_type(self, value: '_216.AcousticRadiationEfficiencyInputType'):
    ...
    @property
    def radiation_efficiency_curve(self) -> '_1341.Vector2DListAccessor':
    ...
    def radiation_efficiency_curve(self, value: '_1341.Vector2DListAccessor'):
