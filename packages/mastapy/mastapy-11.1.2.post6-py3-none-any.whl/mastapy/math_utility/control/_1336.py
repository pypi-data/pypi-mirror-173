...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def update_method(self) -> '_1286.PIDControlUpdateMethod':
        ...
        return constructor.new(_1286.PIDControlUpdateMethod)(value) if value else None

    @update_method.setter
    def update_method(self, value: '_1286.PIDControlUpdateMethod'):
