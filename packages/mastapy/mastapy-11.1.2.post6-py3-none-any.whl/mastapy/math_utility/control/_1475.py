...
from mastapy.math_utility import _1423
...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def proportional_gain_vs_time_and_error(self) -> '_1467.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'ProportionalGainVsTimeAndError' is the original name of this property.'''

        return constructor.new(_1467.GriddedSurfaceAccessor)(self.wrapped.ProportionalGainVsTimeAndError) if self.wrapped.ProportionalGainVsTimeAndError is not None else None

    @proportional_gain_vs_time_and_error.setter
    def proportional_gain_vs_time_and_error(self, value: '_1467.GriddedSurfaceAccessor'):
    ...
    @property
    def integral_gain_vs_time_and_error(self) -> '_1467.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'IntegralGainVsTimeAndError' is the original name of this property.'''

        return constructor.new(_1467.GriddedSurfaceAccessor)(self.wrapped.IntegralGainVsTimeAndError) if self.wrapped.IntegralGainVsTimeAndError is not None else None

    @integral_gain_vs_time_and_error.setter
    def integral_gain_vs_time_and_error(self, value: '_1467.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def differential_gain_vs_time_and_error(self) -> '_1467.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'DifferentialGainVsTimeAndError' is the original name of this property.'''

        return constructor.new(_1467.GriddedSurfaceAccessor)(self.wrapped.DifferentialGainVsTimeAndError) if self.wrapped.DifferentialGainVsTimeAndError is not None else None

    @differential_gain_vs_time_and_error.setter
    def differential_gain_vs_time_and_error(self, value: '_1467.GriddedSurfaceAccessor'):
        value = value.wrapped if value else None
    ...
    @property
    def update_method(self) -> '_1423.PIDControlUpdateMethod':
        ...
        return constructor.new(_1423.PIDControlUpdateMethod)(value) if value is not None else None

    @update_method.setter
    def update_method(self, value: '_1423.PIDControlUpdateMethod'):
