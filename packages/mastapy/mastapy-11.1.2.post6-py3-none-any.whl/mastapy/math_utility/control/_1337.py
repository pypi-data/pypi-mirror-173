...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def update_method(self) -> '_1287.PIDControlUpdateMethod':
        ...
        return constructor.new(_1287.PIDControlUpdateMethod)(value) if value else None

    @update_method.setter
    def update_method(self, value: '_1287.PIDControlUpdateMethod'):
