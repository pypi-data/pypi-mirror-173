...
class MassProperties(_0.APIBase):
    ...
    @property
    def inertia_tensor_about_origin(self) -> '_1282.InertiaTensor':
        ...
        return constructor.new(_1282.InertiaTensor)(self.wrapped.InertiaTensorAboutOrigin) if self.wrapped.InertiaTensorAboutOrigin else None

    @property
    def inertia_tensor_about_centre_of_mass(self) -> '_1282.InertiaTensor':
        ...
        return constructor.new(_1282.InertiaTensor)(self.wrapped.InertiaTensorAboutCentreOfMass) if self.wrapped.InertiaTensorAboutCentreOfMass else None
