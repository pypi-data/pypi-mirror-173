...
from mastapy.math_utility import _1407
...
class Eigenmodes(_0.APIBase):
    ...
    @property
    def items(self) -> 'List[_1407.Eigenmode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Items, constructor.new(_1407.Eigenmode))
        return value
