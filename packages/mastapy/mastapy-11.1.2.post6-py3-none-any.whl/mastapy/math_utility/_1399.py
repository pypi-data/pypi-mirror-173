...
class CoordinateSystemEditor(_0.APIBase):
    ...
    @property
    def coordinate_system_for_rotation_origin(self) -> '_1401.CoordinateSystemForRotationOrigin':
        ...
        return constructor.new(_1401.CoordinateSystemForRotationOrigin)(value) if value is not None else None

    @coordinate_system_for_rotation_origin.setter
    def coordinate_system_for_rotation_origin(self, value: '_1401.CoordinateSystemForRotationOrigin'):
    ...
    @property
    def rotation_axis(self) -> '_1428.RotationAxis':
        '''RotationAxis: 'RotationAxis' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RotationAxis)
        return constructor.new(_1428.RotationAxis)(value) if value is not None else None

    @rotation_axis.setter
    def rotation_axis(self, value: '_1428.RotationAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RotationAxis = value

    @property
    def coordinate_system_for_rotation_axes(self) -> '_1400.CoordinateSystemForRotation':
        ...
        return constructor.new(_1400.CoordinateSystemForRotation)(value) if value is not None else None

    @coordinate_system_for_rotation_axes.setter
    def coordinate_system_for_rotation_axes(self, value: '_1400.CoordinateSystemForRotation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def modified_coordinate_system_for_rotation(self) -> '_1398.CoordinateSystem3D':
        ...
        return constructor.new(_1398.CoordinateSystem3D)(self.wrapped.ModifiedCoordinateSystemForRotation) if self.wrapped.ModifiedCoordinateSystemForRotation is not None else None

    @property
    def modified_coordinate_system_for_translation(self) -> '_1398.CoordinateSystem3D':
        ...
        return constructor.new(_1398.CoordinateSystem3D)(self.wrapped.ModifiedCoordinateSystemForTranslation) if self.wrapped.ModifiedCoordinateSystemForTranslation is not None else None
