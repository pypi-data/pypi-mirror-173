...
from mastapy.math_utility import _1412
...
class FacetedBody(_0.APIBase):
    ...
    @property
    def surfaces(self) -> 'List[_1412.FacetedSurface]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Surfaces, constructor.new(_1412.FacetedSurface))
        return value
