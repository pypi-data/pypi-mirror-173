...
class GriddedSurface(_0.APIBase):
    ...
    def data_value_interpolated_at(self, row_value: 'float', column_value: 'float', row_extrapolation_option: '_1317.ExtrapolationOptions', column_extrapolation_option: '_1317.ExtrapolationOptions') -> 'float':
