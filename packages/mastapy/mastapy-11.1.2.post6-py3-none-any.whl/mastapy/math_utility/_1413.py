...
from mastapy.math_utility import _1416
...
class FourierSeries(_0.APIBase):
    ...
    @property
    def first_harmonic(self) -> '_1416.HarmonicValue':
        ...
        return constructor.new(_1416.HarmonicValue)(self.wrapped.FirstHarmonic) if self.wrapped.FirstHarmonic is not None else None

    @property
    def second_harmonic(self) -> '_1416.HarmonicValue':
        ...
        return constructor.new(_1416.HarmonicValue)(self.wrapped.SecondHarmonic) if self.wrapped.SecondHarmonic is not None else None

    @property
    def third_harmonic(self) -> '_1416.HarmonicValue':
        ...
        return constructor.new(_1416.HarmonicValue)(self.wrapped.ThirdHarmonic) if self.wrapped.ThirdHarmonic is not None else None

    @property
    def fourth_harmonic(self) -> '_1416.HarmonicValue':
        ...
        return constructor.new(_1416.HarmonicValue)(self.wrapped.FourthHarmonic) if self.wrapped.FourthHarmonic is not None else None

    @property
    def fifth_harmonic(self) -> '_1416.HarmonicValue':
        ...
        return constructor.new(_1416.HarmonicValue)(self.wrapped.FifthHarmonic) if self.wrapped.FifthHarmonic is not None else None

    @property
    def harmonics(self) -> 'List[_1416.HarmonicValue]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Harmonics, constructor.new(_1416.HarmonicValue))
        return value

    @property
    def harmonics_with_zeros_truncated(self) -> 'List[_1416.HarmonicValue]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicsWithZerosTruncated, constructor.new(_1416.HarmonicValue))
        return value
