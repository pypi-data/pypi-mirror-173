...
from mastapy.math_utility.measured_data import _1468
...
class OnedimensionalFunctionLookupTable(_1468.LookupTableBase['OnedimensionalFunctionLookupTable']):
    '''OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self) -> '_1435.Vector2DListAccessor':
        '''Vector2DListAccessor: 'LookupTable' is the original name of this property.'''

        return constructor.new(_1435.Vector2DListAccessor)(self.wrapped.LookupTable) if self.wrapped.LookupTable is not None else None

    @lookup_table.setter
    def lookup_table(self, value: '_1435.Vector2DListAccessor'):
