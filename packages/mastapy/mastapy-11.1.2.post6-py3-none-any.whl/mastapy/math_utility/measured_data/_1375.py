...
from mastapy.math_utility.measured_data import _1374
...
class OnedimensionalFunctionLookupTable(_1374.LookupTableBase['OnedimensionalFunctionLookupTable']):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self) -> '_1341.Vector2DListAccessor':
    ...
    @lookup_table.setter
    def lookup_table(self, value: '_1341.Vector2DListAccessor'):
