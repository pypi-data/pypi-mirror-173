...
from mastapy.math_utility import _1415
...
class GriddedSurfaceAccessor(_0.APIBase):
    ...
    def get_gridded_surface(self) -> '_1415.GriddedSurface':
    ...
    def create_new_from_gridded_surface(self, grid: '_1415.GriddedSurface') -> 'GriddedSurfaceAccessor':
