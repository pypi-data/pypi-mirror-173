...
class FourierSeries(_0.APIBase):
    ...
    @property
    def first_harmonic(self) -> '_1281.HarmonicValue':
        ...
        return constructor.new(_1281.HarmonicValue)(self.wrapped.FirstHarmonic) if self.wrapped.FirstHarmonic else None

    @property
    def second_harmonic(self) -> '_1281.HarmonicValue':
        ...
        return constructor.new(_1281.HarmonicValue)(self.wrapped.SecondHarmonic) if self.wrapped.SecondHarmonic else None

    @property
    def third_harmonic(self) -> '_1281.HarmonicValue':
        ...
        return constructor.new(_1281.HarmonicValue)(self.wrapped.ThirdHarmonic) if self.wrapped.ThirdHarmonic else None

    @property
    def fourth_harmonic(self) -> '_1281.HarmonicValue':
        ...
        return constructor.new(_1281.HarmonicValue)(self.wrapped.FourthHarmonic) if self.wrapped.FourthHarmonic else None

    @property
    def fifth_harmonic(self) -> '_1281.HarmonicValue':
        ...
        return constructor.new(_1281.HarmonicValue)(self.wrapped.FifthHarmonic) if self.wrapped.FifthHarmonic else None

    @property
    def harmonics(self) -> 'List[_1281.HarmonicValue]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Harmonics, constructor.new(_1281.HarmonicValue))
        return value

    @property
    def harmonics_with_zeros_truncated(self) -> 'List[_1281.HarmonicValue]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicsWithZerosTruncated, constructor.new(_1281.HarmonicValue))
        return value
