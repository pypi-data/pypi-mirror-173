...
from mastapy.math_utility.optimisation import _1459, _1458
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def range(self) -> '_1388.Range':
        '''Range: 'Range' is the original name of this property.'''

        if _1388.Range.TYPE not in self.wrapped.Range.__class__.__mro__:
    ...
    @range.setter
    def range(self, value: '_1388.Range'):
        value = value.wrapped if value else None
        self.wrapped.Range = value

    @property
    def integer_range(self) -> '_1486.IntegerRange':
        '''IntegerRange: 'IntegerRange' is the original name of this property.'''

        return constructor.new(_1486.IntegerRange)(self.wrapped.IntegerRange) if self.wrapped.IntegerRange is not None else None

    @integer_range.setter
    def integer_range(self, value: '_1486.IntegerRange'):
        value = value.wrapped if value else None
    ...
    @property
    def specification_type(self) -> '_1459.TargetingPropertyTo':
        ...
        return constructor.new(_1459.TargetingPropertyTo)(value) if value is not None else None

    @specification_type.setter
    def specification_type(self, value: '_1459.TargetingPropertyTo'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def specify_input_range_as(self) -> '_1458.SpecifyOptimisationInputAs':
        ...
        return constructor.new(_1458.SpecifyOptimisationInputAs)(value) if value is not None else None

    @specify_input_range_as.setter
    def specify_input_range_as(self, value: '_1458.SpecifyOptimisationInputAs'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
