...
class ParetoOptimisationStrategyChartInformation(_0.APIBase):
    ...
    @property
    def bars(self) -> 'List[_1451.ParetoOptimisationStrategyBars]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_1451.ParetoOptimisationStrategyBars))
        return value
