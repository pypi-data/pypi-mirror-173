...
class OptimisationHistory(_0.APIBase):
    ...
    @property
    def input_history(self) -> 'List[_1328.OptimizationVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputHistory, constructor.new(_1328.OptimizationVariable))
        return value

    @property
    def target_history(self) -> 'List[_1328.OptimizationVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TargetHistory, constructor.new(_1328.OptimizationVariable))
        return value
    ...
    def add_input_history(self, value: '_1328.OptimizationVariable'):
    ...
    def add_target_history(self, value: '_1328.OptimizationVariable'):
