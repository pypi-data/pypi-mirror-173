...
from mastapy.math_utility.optimisation import _1446
...
class OptimisationHistory(_0.APIBase):
    ...
    @property
    def input_history(self) -> 'List[_1446.OptimizationVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputHistory, constructor.new(_1446.OptimizationVariable))
        return value

    @property
    def target_history(self) -> 'List[_1446.OptimizationVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TargetHistory, constructor.new(_1446.OptimizationVariable))
        return value
    ...
    def add_input_history(self, value: '_1446.OptimizationVariable'):
    ...
    def add_target_history(self, value: '_1446.OptimizationVariable'):
