...
from mastapy.math_utility.optimisation import _1448
...
class InputSetter(_0.APIBase, Generic[T]):
    ...
    @property
    def optimiser_input(self) -> '_1448.ParetoOptimisationInput':
        ...
        return constructor.new(_1448.ParetoOptimisationInput)(self.wrapped.OptimiserInput) if self.wrapped.OptimiserInput is not None else None
