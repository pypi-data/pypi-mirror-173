...
from mastapy.math_utility.optimisation import _1456, _1454
...
class ParetoOptimistaionVariable(_1454.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1456.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1456.PropertyTargetForDominantCandidateSearch)(value) if value is not None else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1456.PropertyTargetForDominantCandidateSearch'):
