...
from mastapy.math_utility import _1417
...
class MassProperties(_0.APIBase):
    ...
    @property
    def inertia_tensor_about_origin(self) -> '_1417.InertiaTensor':
        ...
        return constructor.new(_1417.InertiaTensor)(self.wrapped.InertiaTensorAboutOrigin) if self.wrapped.InertiaTensorAboutOrigin is not None else None

    @property
    def inertia_tensor_about_centre_of_mass(self) -> '_1417.InertiaTensor':
        ...
        return constructor.new(_1417.InertiaTensor)(self.wrapped.InertiaTensorAboutCentreOfMass) if self.wrapped.InertiaTensorAboutCentreOfMass is not None else None
