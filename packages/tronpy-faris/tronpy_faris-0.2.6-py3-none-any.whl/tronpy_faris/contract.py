...
import tronpy_faris
from tronpy_faris.exceptions import DoubleSpending
from tronpy_faris.abi import trx_abi
from tronpy_faris.keys import to_hex_address
...
class Contract(object):
    ...
    def update_user_resource_percent(self, percent: int) -> "tronpy_faris.tron.TransactionBuilder":
    ...
    def update_origin_energy_limit(self, limit: int) -> "tronpy_faris.tron.TransactionBuilder":
    ...
    def clear_abi(self) -> "tronpy_faris.tron.TransactionBuilder":
        """Clear contract ABI."""
        if self.origin_address != self.owner_address:
            raise RuntimeError("origin address and owner address mismatch")
...
class ContractMethod(object):
    ...
    def with_owner(self, addr: str) -> "ContractMethod":
        ...
        Can also be changed through :meth:`TransactionBuilder.with_owner() <tronpy_faris.tron.TransactionBuilder.with_owner>`.
        """
    ...
    def call(self, *args, **kwargs) -> "tronpy_faris.tron.TransactionBuilder":
    ...
    def __call__(self, *args, **kwargs) -> "tronpy_faris.tron.TransactionBuilder":
        """Call the contract method."""
        parameter = self._prepare_parameter(*args, **kwargs)
        return self._trigger_contract(parameter)

    def _prepare_parameter(self, *args, **kwargs) -> "tronpy_faris.tron.TransactionBuilder":
        """Prepare parameter."""
        parameter = ""
...
class ShieldedTRC20(object):
    ...
    def mint(self, taddr: str, zaddr: str, amount: int, memo: str = "") -> "tronpy_faris.tron.TransactionBuilder":
    ...
    ) -> "tronpy_faris.tron.TransactionBuilder":
