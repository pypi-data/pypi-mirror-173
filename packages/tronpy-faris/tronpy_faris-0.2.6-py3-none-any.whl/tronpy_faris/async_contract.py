...
from tronpy_faris.contract import Contract, ContractMethod, ContractFunctions, ShieldedTRC20
...
class AsyncContractMethod(ContractMethod):
    async def call(self, *args, **kwargs) -> "tronpy_faris.async_tron.AsyncTransactionBuilder":
        """Call the contract method."""
        return await self.__call__(*args, **kwargs)

    async def __call__(self, *args, **kwargs) -> "tronpy_faris.async_tron.AsyncTransactionBuilder":
        """Call the contract method."""
...
class AsyncShieldedTRC20(ShieldedTRC20):
    ...
    ) -> "tronpy_faris.async_tron.AsyncTransactionBuilder":
