...
from tronpy_faris import keys
from tronpy_faris.contract import Contract, ShieldedTRC20, ContractMethod
from tronpy_faris.keys import PrivateKey
from tronpy_faris.providers import HTTPProvider
from tronpy_faris.abi import tron_abi
from tronpy_faris.defaults import conf_for_name
from tronpy_faris.exceptions import (
    BadSignature,
    BadKey,
    BadHash,
    BlockNotFound,
...
class Trx(object):
    ...
    def account_permission_update(self, owner: TAddress, perm: dict) -> "TransactionBuilder":
        ...
        :param owner:
        :param perm: Permission dict from :meth:`~tronpy_faris.Tron.get_account_permission`
        """
...
class Tron(object):
    ...
    :param provider: An :class:`~tronpy_faris.providers.HTTPProvider` object, can be configured to use private node
