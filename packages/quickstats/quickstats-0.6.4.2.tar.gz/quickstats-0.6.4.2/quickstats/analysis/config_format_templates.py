...
DEFAULT_ANALYSIS_CONFIG_FORMAT = {
        ...
        "training": {
            "datasets":{
                "specification": {
                    "*": {
                        "selection": ConfigComponent(dtypes="STR", default="csv",
                        ...
                        "variables": ConfigComponent(dtypes="LIST[STR]", default=[],
                        ...
                        "effective_weight": ConfigComponent(dtypes="FLOAT", default=1,
                                                            description="scale factor that must be applied to the weight "
                                                                        "to represent to full statistics")
                    }
                },
            ...
            "dataset_transformation":{
                ...
                "negative_weight_mode": ConfigComponent(dtypes="INT", default=0,
                                                        ...
                                                        choice=[0, 1, 2]),
                "shuffle": ConfigComponent(dtypes="BOOL", default=False,
                                           description="whether to shuffle the data in a dataset"),
                "random_state": ConfigComponent(dtypes=["INT","NONE"], default=None,
                                                description="random state for shuffling data; if None,  no "
                                                            "specific random state will be set (so every "
                                                            "shuffle will be different)")
            }
        },
        "categorization":{
            "boundary_scan":{
                "selection": ConfigComponent(dtypes="DICT[STR]", default={},
                                             description="(per-sample) selection applied when performing boundary scan"),
                "dataset": ConfigComponent(dtypes="LIST[STR]", default=[],
            ...
            "save_variables": ConfigComponent(dtypes="LIST[STR]",
