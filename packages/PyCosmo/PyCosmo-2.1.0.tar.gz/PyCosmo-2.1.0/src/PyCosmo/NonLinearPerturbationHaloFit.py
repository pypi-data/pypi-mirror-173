...
class NonLinearPerturbationHaloFit(NonLinearPerturbationBase):
    ...
    def _D_nonlin_halofit(self, Dlin, k, ksig, np3, C, a=1.0, model="halofit"):
        ...
        if model == "halofit":
            ...
            b = np.power(10, 0.9463 + 0.9466 * n + 0.3084 * n2 - 0.9400 * C)
            c = np.power(10, -0.2807 + 0.6669 * n + 0.3214 * n2 - 0.0793 * C)
            ...
            DQ_plus_DH = ne.evaluate(
                ...
                ** (
                ...
                / (1 + abs(6.0835 + 1.3373 * n - 0.1959 * n2 - 5.5274 * C) * Dlin)
            )"""
            )
            ...
            DQ_plus_DH += ne.evaluate(
                ...
                * y ** (2 + 3 * f1)
                ...
                / (
                    ...
                    * y ** f2
                    + (
                        10 ** (0.3698 + 2.0404 * n + 0.8161 * n2 + 0.5869 * C)
                        * f3
                        * y
                    )
                    ** (3 - gamma)
