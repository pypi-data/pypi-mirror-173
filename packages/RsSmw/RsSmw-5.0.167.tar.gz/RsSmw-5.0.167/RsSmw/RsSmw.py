...
class RsSmw:
	...
	_driver_options = "SupportedInstrModels = SMW/SMBV/SMM/SMA/SMCV, SupportedIdnPatterns = SMW/SMBV/SMM/SMA/SMCV, SimulationIdnString = 'Rohde&Schwarz,SMW200A,100001,5.0.167.0061'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '5.0.167.0061'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '5.0.167.0061'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsSmw version failed. Current version: '5.0.167.0061', minimum required version: '{min_version}'")
