        ...
        if message._type=="text":
           return message.text
            ...
            if message.interactive["type"] == "button_reply":
                print("Interactive Message Text: {}".format(message.interactive["button_reply"]["title"]))
                return message.interactive["button_reply"]["title"]
            if message.interactive["type"] == "list_reply":
                print("Interactive Message Text: {}{}".format(message.interactive["list_reply"]["title"], message.interactive["list_reply"]["description"]))
