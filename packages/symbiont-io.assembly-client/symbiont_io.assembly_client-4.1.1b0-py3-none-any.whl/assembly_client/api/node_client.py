...
class NodeSession:
    ...
    def __init__(
        self, hostname, node_fqdn, admin_certs=None, client_certs=None, tracer=None,
    ):
...
def query_node(
    node_session, method, path, params, role="client", key_alias=None, retries=5,
):
    """
    ...
    request_arguments = {
        **{"headers": headers, params_key: params, "verify": False,},
    }
