...
from bambooapi_client.openapi.model.availability_event_create import AvailabilityEventCreate
...
class EventsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_availability_endpoint = _Endpoint(
            settings={
                'response_type': (EventCreateResponse,),
                'auth': [
                    'BearerAuth'
                ],
                'endpoint_path': '/events/availability',
            ...
            root_map={
                ...
                'location_map': {
                    'availability_event_create': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.create_unavailability_endpoint = _Endpoint(
            settings={
                'response_type': (EventCreateResponse,),
                'auth': [
                    'BearerAuth'
                ...
                'operation_id': 'create_unavailability',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def create_availability(
        ...
        **kwargs
        ...
        """Create an Availability event for a site  # noqa: E501

        Create an Availability event with the following fields:  - **time**: datetime of the out-of-bounds measurement - **site_id**: ID of the site - **description** (optional): additional info  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_availability(availability_event_create, async_req=True)
        >>> result = thread.get()

        Args:
            availability_event_create (AvailabilityEventCreate):
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['availability_event_create'] = \
            availability_event_create
        return self.create_availability_endpoint.call_with_http_info(**kwargs)
    ...
    def create_out_of_bounds(
        ...
        **kwargs
        ...
        Create an OutOfBounds event with the following fields:  - **time**: datetime of the out-of-bounds measurement - **site_id**: ID of the site - **device_name**: name of the device - **description** (optional): additional info  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def create_unavailability(
        ...
        **kwargs
        ...
        """Create an Unavailability event for a site  # noqa: E501

        Create an Unavailability event with the following fields:  - **time**: datetime of the out-of-bounds measurement - **site_id**: ID of the site - **description** (optional): additional info  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_unavailability(unavailability_event_create, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['unavailability_event_create'] = \
            unavailability_event_create
        return self.create_unavailability_endpoint.call_with_http_info(**kwargs)
