...
from vectorspace.spacy import Analyzer, Sentencizer
from vectorspace.store import Store
...
def iter_texts(
    ...
    **kwargs
    ...
    docs = store.scan(_source=source_fields, query=query) if isinstance(store, Store) else store.items()
