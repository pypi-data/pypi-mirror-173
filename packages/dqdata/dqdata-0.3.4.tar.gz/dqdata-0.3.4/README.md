...
```buildoutcfg
SimTrader(self, token: str, account_id: int, host='http://sim.shducheng.net', port=8087, log_level=logging.DEBUG, api_urls=None)
...
```
from dqtrade import SimTrader, Order

sim = SimTrader(token='xxxx-xxxx-xxxx')
```
