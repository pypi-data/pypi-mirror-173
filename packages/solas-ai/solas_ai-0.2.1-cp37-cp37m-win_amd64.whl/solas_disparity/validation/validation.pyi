...
def validate_air_input_types(group_data: pd.DataFrame, protected_groups: List[str], reference_groups: List[str], group_categories: List[str], outcome: pd.Series, label: Union[None, pd.Series], sample_weight: pd.Series, air_threshold: float, percent_difference_threshold: float, max_for_fishers: int, alternative_hypothesis: StatSigHypothesis) -> None: ...
...
def validate_smd_input_types(group_data: pd.DataFrame, protected_groups: List[str], reference_groups: List[str], group_categories: List[str], outcome: pd.Series, lower_score_favorable: bool, label: Union[None, pd.Series], sample_weight: pd.Series, smd_threshold: Union[float, int], smd_denominator: SMDDenominator) -> None: ...
def validate_smd_denominator(smd_denominator: SMDDenominator) -> None: ...
def validate_lower_score_favorable_corresponds_to_smd_threshold(lower_score_favorable: bool, smd_threshold: Union[float, int]) -> None: ...
def validate_fishers_or_chi_squared_input_types(group_data: pd.DataFrame, protected_groups: List[str], reference_groups: List[str], group_categories: List[str], outcome: pd.Series, sample_weight: pd.Series, max_for_fishers: int, alternative_hypothesis: StatSigHypothesis) -> None: ...
