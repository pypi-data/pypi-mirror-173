...
from click import Group, version_option, style
...
def click_cli(  # noqa: C901
    callback: Callable = None, config: RichConfig = None, files: str = None, loader: str = None,
        show_version: bool = False, *args, **kwargs
):
    ...
    def cli_wrapper(w_callback: Callable) -> Callable[..., Group]:
        ...
        if show_version:
            ...
            version_args = {
                "prog_name": name,
                "version": __version,
                "message": style(f"\033[95m{module}\033" 
                                 f"[0m \033[95m" f"Version\033[0m: \033[1m" f"{__version}\033[0m"),
            }
    ...
    if callback:
        return cli_wrapper(callback, show_version)
    return cli_wrapper
