...
if TYPE_CHECKING:
    from click import Group, Command, Argument, Choice, Path, params  # noqa: F401
...
def _global_option_wrapper(
        click_func, *wrap_args, **wrap_kwargs
) -> Callable[..., Union[Command, Group, Argument]]:
