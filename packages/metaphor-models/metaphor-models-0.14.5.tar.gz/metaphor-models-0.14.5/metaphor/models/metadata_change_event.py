...
class QueryLog:
    ...
    def from_dict(obj: Any) -> 'QueryLog':
        ...
        return QueryLog(id, account, bytes_read, bytes_written, cost, duration, email, metadata, platform, query_id, rows_read, rows_written, sources, sql, sql_hash, start_time, targets, type, user_id)
