...
def do_test_generated_classes(  # pylint: disable=R0914
    ...
    value_serializer = classes_module.TypedAvroSerializer(
        schema_registry_client,
        is_key=False,
        subject_strategy=TopicRecordNameStrategy
    )

    value_deserializer = classes_module.TypedAvroDeserializer(
        schema_registry_client,
        is_key=False
    )

    for test_class_item in test_module.testing_classes.test_classes:
