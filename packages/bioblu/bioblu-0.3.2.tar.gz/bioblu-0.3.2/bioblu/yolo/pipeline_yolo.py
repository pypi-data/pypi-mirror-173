...
def main(fdir_src_images, focal_length, altitude, sensor_width, fpath_yolo_weights, fdir_yolov5, fdir_output,
    ...
    for annotations_fpath in txt_fpaths:
        img = ds_annotations.get_corresponding_file(base_file=annotations_fpath,
...
if __name__ == "__main__":
    ...
    img_dir = "/media/findux/DATA/Next/Catania_workshop/drone_tests/DJI_0502_selection/"
    target_dir = "/home/findux/Desktop/yolo_pipeline_results_catania_test_7050"
