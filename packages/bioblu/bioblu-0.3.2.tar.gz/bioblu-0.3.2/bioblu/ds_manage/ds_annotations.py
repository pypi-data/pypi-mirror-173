...
from bioblu.ds_manage import bbox_conversions, ds_convert
...
def images_are_identical(fpath_img_1, fpath_img_2):
...
def get_file_pairs(fdir, ext_1, ext_2, recursive=False):
...
def add_file_prefix(fdir, prefix):
