...
class SimAdapter():
    ...
    #     actor_state_clone = protobuf.morai_actor_pb2.ActorState()
    #     actor_state_clone.actor_info.actor_id = 'Unknown'
    #     self.__actor_states_lock.acquire()
    #     for actor_state in self.__actor_states.states:
    #         if actor_state.actor_info.actor_id == actor_id:
    #             actor_state_clone.CopyFrom(actor_state)
    #             break
    #     self.__actor_states_lock.release()

    #     return actor_state_clone


    def get_actor_states(self):
        actor_states_clone = protobuf.morai_actor_pb2.ActorStates()
        self.__actor_states_lock.acquire()
        actor_states_clone.CopyFrom(self.__actor_states)
        self.__actor_states_lock.release()

        return actor_states_clone
