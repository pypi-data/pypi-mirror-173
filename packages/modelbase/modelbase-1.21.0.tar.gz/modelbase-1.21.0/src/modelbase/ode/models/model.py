...
class Model(_AbstractRateModel, BaseModel):
    ...
    def __init__(
        ...
        self.derived_stoichiometries: Dict[str, DerivedStoichiometry] = {}
    ...
    # def add_derived_stoichiometry(
    #     self, name: str, function: Callable, args: list[str]
    # ) -> None:
    #     raise NotImplementedError

    # def _update_derived_stoichiometries(self) -> None:
    #     for name, stoichiometry in self.derived_stoichiometries.items():
    #         factor = stoichiometry.function(
    #             *(self.parameters[i] for i in stoichiometry.args)
    #         )
    #         self.update_stoichiometry(name, factor)
