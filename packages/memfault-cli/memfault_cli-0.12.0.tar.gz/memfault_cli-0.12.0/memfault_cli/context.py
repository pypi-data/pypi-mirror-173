...
class DeviceTraitsInfo:  # noqa: B903 - no data classes in Python 3.6
    def __init__(
...
class DebugDataRecordingInfo:  # noqa: B903 - no data classes in Python 3.6
    def __init__(
...
class MemfaultCliClickContext(object):
    ...
    @property
    def debug_data_recording_info(self) -> DebugDataRecordingInfo:
