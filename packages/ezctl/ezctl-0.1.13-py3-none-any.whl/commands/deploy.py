...
class Deploy:
    ...
    def start_ec2_instance(self):
        ...
        create_ec2_instance_cmd = f'aws ec2 run-instances --image-id ami-0bb5df38b95952e1a --count 1 --instance-type {instance_type} --key-name ezctl --security-group-ids sg-0bfb8b5daee5dc0af  --iam-instance-profile Name=EnablesEC2SSMAndECRRole \
