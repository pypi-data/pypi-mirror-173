...
c-----------------------------------------------------------------------
 ...
 350  continue
c     write(*, 351), 'h = ', h
c     write(*, 351), 'savf = ', savf(1)
c     write(*, 351), 'yhi2 = ', yh(1, 2)
c     write(*, 351), 'acor = ', acor(1)
c351  format(A10, e20.13)
      do 360 i = 1,n
...
c     this is new:
      ...
      h = hsave
      el0 = el0save
c     write (6, 364), y(1), y(2), y(3)
c364  format('solver: sol = ', 3e13.6)
...
c-----------------------------------------------------------------------
 400  continue
c     call econ (neq, tn, y, econ_value)
c     if (dabs(econ_value) .gt. 1e-5) go to 408
...
c     SCIPY error check:
 ...
 408  write(*, *), 'econ crit failed at t=', tn, 'for h=', h, 'econ is',
     1             econ_value
c-----------------------------------------------------------------------
