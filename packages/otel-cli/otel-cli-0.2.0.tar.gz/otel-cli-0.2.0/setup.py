...
install_requires = \
['Click>=7.0,<8.0',
 'opentelemetry-exporter-otlp>=1.12.0,<2.0.0',
 'opentelemetry-proto>=1.12.0,<2.0.0',
 'opentelemetry-sdk>=1.12.0,<2.0.0']

extras_require = \
{':python_version < "3.8"': ['typing-extensions>=4.1.1,<4.2.0']}
