...
from hcai_models.utils.bbox_utils import overlap_similarity


class _BlazeBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1):
        super(_BlazeBlock, self).__init__()
...
class _BlazeFace(nn.Module):
    ...
    def __init__(self):
        super(_BlazeFace, self).__init__()
        ...
        self.min_suppression_thresh = 0.3
    ...
    def _define_layers(self):
        self.backbone1 = nn.Sequential(
            ...
            _BlazeBlock(24, 24),
            _BlazeBlock(24, 28),
            _BlazeBlock(28, 32, stride=2),
            _BlazeBlock(32, 36),
            _BlazeBlock(36, 42),
            _BlazeBlock(42, 48, stride=2),
            _BlazeBlock(48, 56),
            _BlazeBlock(56, 64),
            _BlazeBlock(64, 72),
            _BlazeBlock(72, 80),
    ...
    def _weighted_non_max_suppression(self, detections):
        ...
        while len(remaining) > 0:
            ...
            mask = ious > self.min_suppression_thresh
