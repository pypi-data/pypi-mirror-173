...
class UserBase(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["username", "type", "displayName", "description", "email", "ownerId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["username", "type", "displayName", "description", "email", "ownerId", ], str]):
