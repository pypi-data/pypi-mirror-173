...
# body param
SchemaForRequestBodyApplicationJson = UserPartialUpdate


request_body_user_partial_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _partial_update_user_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_user_partial_update.serialize(body, content_type)
...
class PartialUpdateUser(BaseApi):
    ...
    def partial_update_user(
        ...
        return self._partial_update_user_oapg(
            body=body,
