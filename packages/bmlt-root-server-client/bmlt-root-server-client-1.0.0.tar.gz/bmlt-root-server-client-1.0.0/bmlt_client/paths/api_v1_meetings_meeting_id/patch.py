...
# body param
SchemaForRequestBodyApplicationJson = MeetingPartialUpdate


request_body_meeting_partial_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_meeting_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_meeting_partial_update.serialize(body, content_type)
...
class PatchMeeting(BaseApi):
    ...
    def patch_meeting(
        ...
        return self._patch_meeting_oapg(
            body=body,
