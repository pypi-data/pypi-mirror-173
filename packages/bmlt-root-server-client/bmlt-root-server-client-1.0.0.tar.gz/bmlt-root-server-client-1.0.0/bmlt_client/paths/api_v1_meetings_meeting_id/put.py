...
# body param
SchemaForRequestBodyApplicationJson = MeetingUpdate


request_body_meeting_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_meeting_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_meeting_update.serialize(body, content_type)
...
class UpdateMeeting(BaseApi):
    ...
    def update_meeting(
        ...
        return self._update_meeting_oapg(
            body=body,
