...
request_body_meeting_create = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Meeting
...
class BaseApi(api_client.Api):
    ...
    def _create_meeting_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_meeting_create.serialize(body, content_type)
