...
# Path params
FormatIdSchema = schemas.Int64Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'formatId': typing.Union[FormatIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_format_id = api_client.PathParameter(
    name="formatId",
...
# body param
SchemaForRequestBodyApplicationJson = FormatPartialUpdate


request_body_format_partial_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_format_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_format_partial_update.serialize(body, content_type)
...
class PatchFormat(BaseApi):
    ...
    def patch_format(
        ...
        return self._patch_format_oapg(
            body=body,
