...
# body param
SchemaForRequestBodyApplicationJson = FormatUpdate


request_body_format_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_format_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_format_update.serialize(body, content_type)
...
class UpdateFormat(BaseApi):
    ...
    def update_format(
        ...
        return self._update_format_oapg(
            body=body,
