...
# body param
SchemaForRequestBodyApplicationJson = TokenCredentials


request_body_token_credentials = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Token
...
class BaseApi(api_client.Api):
    ...
    def _auth_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_token_credentials.serialize(body, content_type)
