...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'serviceBodyId': typing.Union[ServiceBodyIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_service_body_id = api_client.PathParameter(
    name="serviceBodyId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ServiceBodyIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = ServiceBodyPartialUpdate


request_body_service_body_partial_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_service_body_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_service_body_partial_update.serialize(body, content_type)
...
class PatchServiceBody(BaseApi):
    ...
    def patch_service_body(
        ...
        return self._patch_service_body_oapg(
            body=body,
