...
# body param
SchemaForRequestBodyApplicationJson = ServiceBodyUpdate


request_body_service_body_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_service_body_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_service_body_update.serialize(body, content_type)
...
class UpdateServiceBody(BaseApi):
    ...
    def update_service_body(
        ...
        return self._update_service_body_oapg(
            body=body,
