...
# body param
SchemaForRequestBodyApplicationJson = FormatCreate


request_body_format_create = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Format
...
class BaseApi(api_client.Api):
    ...
    def _create_format_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_format_create.serialize(body, content_type)
...
class CreateFormat(BaseApi):
    ...
    def create_format(
        ...
        return self._create_format_oapg(
            body=body,
