...
SchemaFor200ResponseBodyApplicationJson = ServiceBodyCollection
...
class GetServiceBodies(BaseApi):
    ...
    def get_service_bodies(
        ...
        return self._get_service_bodies_oapg(
