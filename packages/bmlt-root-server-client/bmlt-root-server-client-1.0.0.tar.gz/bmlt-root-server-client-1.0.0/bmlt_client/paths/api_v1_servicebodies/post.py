...
# body param
SchemaForRequestBodyApplicationJson = ServiceBodyCreate


request_body_service_body_create = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ServiceBody
...
class BaseApi(api_client.Api):
    ...
    def _create_service_body_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_service_body_create.serialize(body, content_type)
...
class CreateServiceBody(BaseApi):
    ...
    def create_service_body(
        ...
        return self._create_service_body_oapg(
            body=body,
