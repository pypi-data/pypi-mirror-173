...
def get_rechtspraak_metadata(save_file='n', dataframe=None, filename=None):
    ...
    # Check if dataframe or file or nothing is provided
    ...
    if csv_files > 0 and save_file == 'y':
        for f in csv_files:
    ...
    if rs_data is not None and save_file == 'n':
        ...
        print("Getting metadata of " + str(no_of_rows) + " ECLIs from " + rs_data)
        print("Working. Please wait...")
        # Get all ECLIs in a list
