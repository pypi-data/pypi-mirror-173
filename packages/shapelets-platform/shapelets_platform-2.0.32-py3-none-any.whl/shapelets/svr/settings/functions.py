...
def _find_configuration_file(directory: str, namePattern: str = 'settings') -> SettingsSourceCallable:
    """
...
def package_settings() -> SettingsSourceCallable:
    """
...
def home_settings() -> SettingsSourceCallable:
    """
...
def current_settings() -> SettingsSourceCallable:
    """
