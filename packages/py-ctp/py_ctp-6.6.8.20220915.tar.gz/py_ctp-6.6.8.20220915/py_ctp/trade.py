...
class CtpTrade():
    ...
    def _OnRtnOrder(self, pOrder: CThostFtdcOrderField):
        ...
        if not of:
            ...
            of.Offset = OffsetType.Open if pOrder.getCombOffsetFlag() == TThostFtdcOffsetFlagType.THOST_FTDC_OF_Open else OffsetType.CloseToday if pOrder.getCombOffsetFlag() == TThostFtdcOffsetFlagType.THOST_FTDC_OF_CloseToday else OffsetType.Close
    ...
    def _OnRspOrder(self, pInputOrder: CThostFtdcInputOrderField, pRspInfo: CThostFtdcRspInfoField, nRequestID: int, bIsLast: bool):
        ...
        if not of:
            ...
            of.Offset = OffsetType.Open if pInputOrder.getCombOffsetFlag() == TThostFtdcOffsetFlagType.THOST_FTDC_OF_Open else OffsetType.CloseToday if pInputOrder.getCombOffsetFlag() == TThostFtdcOffsetFlagType.THOST_FTDC_OF_CloseToday else OffsetType.Close
            # of.Status = OrderStatus.Normal
    ...
    def ReqOrderInsert(self, pInstrument: str, pDirection: DirectType, pOffset: OffsetType, pPrice: float = 0.0, pVolume: int = 1, pType: OrderType = OrderType.Limit, pCustom: int = 0):
        ...
        f.Direction=TThostFtdcDirectionType.THOST_FTDC_D_Buy.value if pDirection == DirectType.Buy else TThostFtdcDirectionType.THOST_FTDC_D_Sell.value
        f.CombOffsetFlag=self.enumToBytes(TThostFtdcOffsetFlagType.THOST_FTDC_OF_Open if pOffset == OffsetType.Open else TThostFtdcOffsetFlagType.THOST_FTDC_OF_CloseToday if pOffset == OffsetType.CloseToday else TThostFtdcOffsetFlagType.THOST_FTDC_OF_Close)
