...
class Job():
    ...
    def importa_tabela_por_sql(self, conn_entrada, conn_saida, sql_entrada,
        ...
        que são poucas linhas). Qualquer erro dispara uma exceção.
    ...
    def importa_planilha(self, 
        ...
        engine:         o padrão é openpyxl. Existem outras para formatos
                        antigos ex .odf
        cols_entrada:   lista com o índice (zero-based) das colunas que serão
                        utilizadas da planilha. Se None, utiliza todas as
                        colunas, na ordem da planilha.  Esse parâmetro é
    ...
    def importa_tabela_url(self, 
        ...
        (considera-se que são poucas linhas). Qualquer erro dispara uma
        exceção.
