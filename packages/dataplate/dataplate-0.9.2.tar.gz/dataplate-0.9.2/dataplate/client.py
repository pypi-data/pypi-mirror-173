...
class DataPlate:
    ...
    def run_batch_step(self,
        ...
        jars: URLs of jars to be used in this session.
        py_files: URLs of Python files to be used in this session.
        files: URLs of files to be used in this session.
