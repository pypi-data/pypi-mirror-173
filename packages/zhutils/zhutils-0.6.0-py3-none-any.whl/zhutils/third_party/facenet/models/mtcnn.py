...
class PNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = 'weights/pnet.pt'
            web_url = 'https://github.com/forget2save/zhutils/releases/download/Models/pnet.pt'
            if not os.path.exists(os.path.split(state_dict_path)[0]):
                os.makedirs(os.path.split(state_dict_path)[0])
            if not os.path.exists(state_dict_path):
                torch.hub.download_url_to_file(web_url, state_dict_path)
...
class RNet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = 'weights/rnet.pt'
            web_url = 'https://github.com/forget2save/zhutils/releases/download/Models/rnet.pt'
            if not os.path.exists(os.path.split(state_dict_path)[0]):
                os.makedirs(os.path.split(state_dict_path)[0])
            if not os.path.exists(state_dict_path):
                torch.hub.download_url_to_file(web_url, state_dict_path)
...
class ONet(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        if pretrained:
            state_dict_path = 'weights/onet.pt'
            web_url = 'https://github.com/forget2save/zhutils/releases/download/Models/onet.pt'
            if not os.path.exists(os.path.split(state_dict_path)[0]):
                os.makedirs(os.path.split(state_dict_path)[0])
            if not os.path.exists(state_dict_path):
                torch.hub.download_url_to_file(web_url, state_dict_path)
