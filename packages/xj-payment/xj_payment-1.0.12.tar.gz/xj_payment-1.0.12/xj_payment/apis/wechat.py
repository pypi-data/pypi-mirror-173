...
# 商户证书序列号
CERT_SERIAL_NO = "548FB2EFC2CBBA142124DB82AED2B539977B062E"

# API v3密钥， https://pay.weixin.qq.com/wiki/doc/apiv3/wechatpay/wechatpay3_2.shtml
APIV3_KEY = "81528152815281528152815281528152"
...
class WeChatPayment(APIView):
    def pay(self):
        ...
        code, message = wxpay.pay(
            ...
            payer={'openid': 'osXiW5f-nAKPn5tP2BXkiOPZBgg0'},
        ...
        data = {
            'appId': APPID,
            'timeStamp': "1665815665",
            'nonceStr': "d3a7sOmPMkVDrKlTvijoECh4GNwbzIeF",
            'signType': 'RSA',
            'package': 'prepay_id={0}'.format("wx1514570045960042b04433c236fad10000"),
        }
        a = wxpay.sign(data)
        print(a)
