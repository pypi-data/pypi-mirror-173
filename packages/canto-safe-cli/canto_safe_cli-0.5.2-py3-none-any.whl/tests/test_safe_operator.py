...
from canto_safe_cli.operators.safe_operator import (
...
from canto_safe_cli.utils import get_erc_20_list
from tests.utils import generate_transfers_erc20

from .canto_safe_cli_test_case_mixin import SafeCliTestCaseMixin
...
class SafeCliTestCase(SafeCliTestCaseMixin, unittest.TestCase):
    ...
    def test_change_fallback_handler(self):
        ...
        with mock.patch.object(
            ...
            self.assertTrue(safe_operator.change_fallback_handler(new_fallback_handler))
        self.assertEqual(
            safe_operator.canto_safe_cli_info.fallback_handler, new_fallback_handler
        )
    ...
    def test_change_guard(self):
        ...
        with mock.patch.object(
            ...
            self.assertTrue(safe_operator.change_guard(new_guard))
        self.assertEqual(safe_operator.canto_safe_cli_info.guard, new_guard)
    ...
    def test_change_master_copy(self):
        ...
        self.assertEqual(
            safe_operator.canto_safe_cli_info.master_copy, self.safe_old_contract_address
        )
        self.assertEqual(
