...
class BaseApiWrapper:
    ...
    def get_page(self, page_url: str = None, select=None, request_filter=None, order_by=None, annotations=None, query_dict=None):
        """
        ...
        :param page_url: autogenerated url for next page, returned with api response
