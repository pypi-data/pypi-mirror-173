...
; <label>:173:                                    ; preds = %167
  ...
  %177 = lshr i32 %176, 28
  %178 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str, i32 0, i32 0), i32 %177)
  %179 = sext i32 %178 to i64
  store i64 %179, i64* @order_gurantee, align 8
  br label %180

; <label>:180:                                    ; preds = %180, %173
...
; <label>:277:                                    ; preds = %271, %265
  ...
  %281 = lshr i32 %280, 28
  %282 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.1, i32 0, i32 0), i32 %281)
  %283 = sext i32 %282 to i64
  store i64 %283, i64* @order_gurantee, align 8
  br label %284

; <label>:284:                                    ; preds = %284, %277
...
; <label>:372:                                    ; preds = %362, %358
  br label %373

; <label>:373:                                    ; preds = %372, %348
  br label %374

; <label>:374:                                    ; preds = %373, %338
...
; <label>:598:                                    ; preds = %560, %561
  br label %1109

; <label>:599:                                    ; preds = %105, %105, %105
...
; <label>:647:                                    ; preds = %646, %622
  br label %648

; <label>:648:                                    ; preds = %647, %612
...
; <label>:746:                                    ; preds = %717, %718
  br label %1109

; <label>:747:                                    ; preds = %105, %105, %105
...
; <label>:1047:                                   ; preds = %1034, %1021
  br label %1109

; <label>:1048:                                   ; preds = %105
...
; <label>:1104:                                   ; preds = %1088, %1070
  br label %1105

; <label>:1105:                                   ; preds = %1104, %1048
  br label %1109

; <label>:1106:                                   ; preds = %105
  %1107 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.2, i32 0, i32 0))
  %1108 = sext i32 %1107 to i64
  store i64 %1108, i64* @order_gurantee, align 8
  br label %1109

; <label>:1109:                                   ; preds = %1106, %1105, %1047, %923, %898, %873, %872, %746, %598, %472, %324, %209
