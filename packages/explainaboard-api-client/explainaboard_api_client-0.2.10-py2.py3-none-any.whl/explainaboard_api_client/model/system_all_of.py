...
class SystemAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, system_id, system_name, is_private, source_language, target_language, task, system_info, metric_stats, creator, preferred_username, results, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, system_id, system_name, is_private, source_language, target_language, task, system_info, metric_stats, creator, preferred_username, results, *args, **kwargs):  # noqa: E501
        """SystemAllOf - a model defined in OpenAPI
