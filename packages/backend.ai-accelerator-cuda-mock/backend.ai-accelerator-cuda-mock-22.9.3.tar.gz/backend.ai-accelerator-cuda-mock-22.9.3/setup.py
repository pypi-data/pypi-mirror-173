...
setup(**{
    ...
    'install_requires': (
        'aiodocker~=0.21.0',
        'attrs>=20.3',
        """backend.ai-agent==22.09.3
""",
        """backend.ai-cli==22.09.3
""",
        """backend.ai-common==22.09.3
""",
        """backend.ai-kernel-binary==22.09.3
""",
        """backend.ai-kernel-helper==22.09.3
""",
        """backend.ai-kernel==22.09.3
""",
        """backend.ai-plugin==22.09.3
""",
        'trafaret~=2.1',
    ),
    'license': 'LGPLv3',
