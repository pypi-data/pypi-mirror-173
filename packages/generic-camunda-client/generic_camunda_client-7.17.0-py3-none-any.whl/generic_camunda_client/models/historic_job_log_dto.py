...
class HistoricJobLogDto(object):
    ...
    def removal_time(self):
        ...
        The time after which the log entry should be removed by the History Cleanup job. Default format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`. For further info see the [docs](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/)  # noqa: E501
    ...
    def job_definition_type(self):
        ...
        The job definition type of the associated job. See the [User Guide](https://docs.camunda.org/manual/7.17/user-guide/process-engine/the-job-executor/#job-creation) for more information about job definition types.  # noqa: E501
