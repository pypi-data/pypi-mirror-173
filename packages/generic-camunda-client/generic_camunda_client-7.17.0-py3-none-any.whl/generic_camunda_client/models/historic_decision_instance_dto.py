...
class HistoricDecisionInstanceDto(object):
    ...
    def evaluation_time(self):
        ...
        The time the instance was evaluated.  [Default format](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.  # noqa: E501
