...
class AuthorizationExceptionDto(object):
    ...
    def __init__(self, user_id=None, missing_authorizations=None, type=None, message=None, code=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def code(self):
        """Gets the code of this AuthorizationExceptionDto.  # noqa: E501

        The code allows your client application to identify the error in an automated fashion. You can look up the meaning of all built-in codes and learn how to add custom codes in the [User Guide](https://docs.camunda.org/manual/7.18/user-guide/process-engine/error-handling/#exception-codes).  # noqa: E501

        :return: The code of this AuthorizationExceptionDto.  # noqa: E501
        :rtype: float
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this AuthorizationExceptionDto.

        The code allows your client application to identify the error in an automated fashion. You can look up the meaning of all built-in codes and learn how to add custom codes in the [User Guide](https://docs.camunda.org/manual/7.18/user-guide/process-engine/error-handling/#exception-codes).  # noqa: E501

        :param code: The code of this AuthorizationExceptionDto.  # noqa: E501
        :type: float
        """
