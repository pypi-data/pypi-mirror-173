...
class TaskDto(object):
    ...
    def created(self):
        ...
        The date the task was created on. [Default format](https://docs.camunda.org/manual/7.18/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.  # noqa: E501
    ...
    def last_updated(self, last_updated):
        """Sets the last_updated of this TaskDto.

        The date the task was last updated. Every action that fires a [task update event](https://docs.camunda.org/manual/7.18/user-guide/process-engine/delegation-code/#task-listener-event-lifecycle) will update this property. [Default format](https://docs.camunda.org/manual/7.18/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.  # noqa: E501

        :param last_updated: The last_updated of this TaskDto.  # noqa: E501
        :type: datetime
        """
