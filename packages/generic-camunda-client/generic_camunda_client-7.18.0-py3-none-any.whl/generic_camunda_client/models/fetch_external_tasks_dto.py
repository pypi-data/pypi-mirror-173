...
class FetchExternalTasksDto(object):
    ...
    def async_response_timeout(self):
        ...
        The [Long Polling](https://docs.camunda.org/manual/7.18/user-guide/process-engine/external-tasks/#long-polling-to-fetch-and-lock-external-tasks) timeout in milliseconds.  **Note:** The value cannot be set larger than 1.800.000 milliseconds (corresponds to 30 minutes).  # noqa: E501
