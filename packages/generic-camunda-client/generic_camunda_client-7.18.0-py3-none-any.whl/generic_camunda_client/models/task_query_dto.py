...
class TaskQueryDto(object):
    ...
    def __init__(self, task_id=None, task_id_in=None, process_instance_id=None, process_instance_id_in=None, process_instance_business_key=None, process_instance_business_key_expression=None, process_instance_business_key_in=None, process_instance_business_key_like=None, process_instance_business_key_like_expression=None, process_definition_id=None, process_definition_key=None, process_definition_key_in=None, process_definition_name=None, process_definition_name_like=None, execution_id=None, case_instance_id=None, case_instance_business_key=None, case_instance_business_key_like=None, case_definition_id=None, case_definition_key=None, case_definition_name=None, case_definition_name_like=None, case_execution_id=None, activity_instance_id_in=None, tenant_id_in=None, without_tenant_id=False, assignee=None, assignee_expression=None, assignee_like=None, assignee_like_expression=None, assignee_in=None, assignee_not_in=None, owner=None, owner_expression=None, candidate_group=None, candidate_group_expression=None, candidate_user=None, candidate_user_expression=None, include_assigned_tasks=False, involved_user=None, involved_user_expression=None, assigned=False, unassigned=False, task_definition_key=None, task_definition_key_in=None, task_definition_key_like=None, name=None, name_not_equal=None, name_like=None, name_not_like=None, description=None, description_like=None, priority=None, max_priority=None, min_priority=None, due_date=None, due_date_expression=None, due_after=None, due_after_expression=None, due_before=None, due_before_expression=None, without_due_date=False, follow_up_date=None, follow_up_date_expression=None, follow_up_after=None, follow_up_after_expression=None, follow_up_before=None, follow_up_before_expression=None, follow_up_before_or_not_existent=None, follow_up_before_or_not_existent_expression=None, created_on=None, created_on_expression=None, created_after=None, created_after_expression=None, created_before=None, created_before_expression=None, updated_after=None, updated_after_expression=None, delegation_state=None, candidate_groups=None, candidate_groups_expression=None, with_candidate_groups=False, without_candidate_groups=False, with_candidate_users=False, without_candidate_users=False, active=False, suspended=False, task_variables=None, process_variables=None, case_instance_variables=None, variable_names_ignore_case=False, variable_values_ignore_case=False, parent_task_id=None, or_queries=None, sorting=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._updated_after_expression = None
        ...
        self.updated_after_expression = updated_after_expression
    ...
    @property
    def task_id(self):
        """Gets the task_id of this TaskQueryDto.  # noqa: E501

        Restrict to task with the given id.  # noqa: E501

        :return: The task_id of this TaskQueryDto.  # noqa: E501
        :rtype: str
        """
    ...
    def task_id(self, task_id):
        """Sets the task_id of this TaskQueryDto.

        Restrict to task with the given id.  # noqa: E501

        :param task_id: The task_id of this TaskQueryDto.  # noqa: E501
        :type: str
        """
    ...
    @property
    def task_id_in(self):
        """Gets the task_id_in of this TaskQueryDto.  # noqa: E501

        Restrict to tasks with any of the given ids.  # noqa: E501

        :return: The task_id_in of this TaskQueryDto.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def task_id_in(self, task_id_in):
        """Sets the task_id_in of this TaskQueryDto.

        Restrict to tasks with any of the given ids.  # noqa: E501

        :param task_id_in: The task_id_in of this TaskQueryDto.  # noqa: E501
        :type: list[str]
        """
    ...
    def process_instance_business_key_expression(self):
        ...
        Restrict to tasks that belong to process instances with the given business key which  is described by an expression. See the  [user guide](https://docs.camunda.org/manual/7.18/user-guide/process-engine/expression-language/#internal-context-functions) for more information on available functions.  # noqa: E501
    ...
    def assignee_expression(self):
        ...
        Restrict to tasks that the user described by the given expression is assigned to. See the [user guide](https://docs.camunda.org/manual/7.18/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.  # noqa: E501
    ...
    def assignee_like_expression(self):
        ...
        Restrict to tasks that have an assignee that has the parameter value described by the  given expression as a substring. See the  [user guide](https://docs.camunda.org/manual/7.18/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.  # noqa: E501
    ...
    def owner_expression(self):
        ...
        Restrict to tasks that the user described by the given expression owns. See the  [user guide](https://docs.camunda.org/manual/7.18/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.  # noqa: E501
    ...
    def candidate_group_expression(self):
        ...
        Only include tasks that are offered to the group described by the given expression.  See the  [user guide](https://docs.camunda.org/manual/7.18/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.  # noqa: E501
    ...
    def candidate_user_expression(self):
        ...
        Only include tasks that are offered to the user described by the given expression.  See the  [user guide](https://docs.camunda.org/manual/7.18/user-guide/process-engine/expression-language/#internal-context-functions)  for more information on available functions.  # noqa: E501
    ...
    def due_date(self):
        ...
        Restrict to tasks that are due on the given date. By [default](https://docs.camunda.org/manual/7.18/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.546+0200`.  # noqa: E501
    ...
    def due_after(self):
        ...
        Restrict to tasks that are due after the given date. By [default](https://docs.camunda.org/manual/7.18/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.435+0200`.  # noqa: E501
    ...
    def due_before(self):
        ...
        Restrict to tasks that are due before the given date. By [default](https://docs.camunda.org/manual/7.18/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.243+0200`.  # noqa: E501
    ...
    def follow_up_date(self):
        ...
        Restrict to tasks that have a followUp date on the given date. By [default](https://docs.camunda.org/manual/7.18/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.342+0200`.  # noqa: E501
    ...
    def follow_up_after(self):
        ...
        Restrict to tasks that have a followUp date after the given date. By [default](https://docs.camunda.org/manual/7.18/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.542+0200`.  # noqa: E501
    ...
    def follow_up_before(self):
        ...
        Restrict to tasks that have a followUp date before the given date. By [default](https://docs.camunda.org/manual/7.18/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.234+0200`.  # noqa: E501
    ...
    def created_on(self):
        ...
        Restrict to tasks that were created on the given date. By [default](https://docs.camunda.org/manual/7.18/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.324+0200`.  # noqa: E501
    ...
    def created_after(self):
        ...
        Restrict to tasks that were created after the given date. By [default](https://docs.camunda.org/manual/7.18/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.342+0200`.  # noqa: E501
    ...
    def created_before(self):
        ...
        Restrict to tasks that were created before the given date. By [default](https://docs.camunda.org/manual/7.18/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.332+0200`.  # noqa: E501
    ...
    def updated_after(self, updated_after):
        """Sets the updated_after of this TaskQueryDto.

        Restrict to tasks that were updated after the given date. Every action that fires  a [task update event](https://docs.camunda.org/manual/7.18/user-guide/process-engine/delegation-code/#task-listener-event-lifecycle) is considered as updating the task. By [default](https://docs.camunda.org/manual/7.18/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.332+0200`.  # noqa: E501

        :param updated_after: The updated_after of this TaskQueryDto.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def updated_after_expression(self):
        """Gets the updated_after_expression of this TaskQueryDto.  # noqa: E501
        ...
        :return: The updated_after_expression of this TaskQueryDto.  # noqa: E501
        :rtype: str
        """
        return self._updated_after_expression

    @updated_after_expression.setter
    def updated_after_expression(self, updated_after_expression):
        """Sets the updated_after_expression of this TaskQueryDto.

        Restrict to tasks that were updated after the date described by the given expression. Every action that fires  a [task update event](https://docs.camunda.org/manual/7.18/user-guide/process-engine/delegation-code/#task-listener-event-lifecycle) is considered as updating the task. See the [user guide](https://docs.camunda.org/manual/7.18/user-guide/process-engine/expression-language/#internal-context-functions) for more information on available functions. The expression must evaluate to a `java.util.Date` or `org.joda.time.DateTime` object.  # noqa: E501

        :param updated_after_expression: The updated_after_expression of this TaskQueryDto.  # noqa: E501
        :type: str
        """

        self._updated_after_expression = updated_after_expression
    ...
    def candidate_groups_expression(self):
        ...
        Restrict to tasks that are offered to any of the candidate groups described by the given expression. See the [user guide](https://docs.camunda.org/manual/7.18/user-guide/process-engine/expression-language/#internal-context-functions) for more information on available functions. The expression must evaluate to `java.util.List` of Strings.  # noqa: E501
