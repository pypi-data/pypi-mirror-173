...
class TaskQueryDtoSorting(object):
    ...
    def sort_by(self, sort_by):
        ...
        :type: str
        """
        allowed_values = [None,"instanceId", "caseInstanceId", "dueDate", "executionId", "caseExecutionId", "assignee", "created", "lastUpdated", "followUpDate", "description", "id", "name", "nameCaseInsensitive", "priority", "processVariable", "executionVariable", "taskVariable", "caseExecutionVariable", "caseInstanceVariable"]  # noqa: E501
