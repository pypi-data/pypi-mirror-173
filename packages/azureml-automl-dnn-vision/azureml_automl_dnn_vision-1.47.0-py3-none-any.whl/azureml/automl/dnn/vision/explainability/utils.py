...
def save_captum_visualizations(
    xai_model_name, attributions, sample_image,
    pred_label_name, prediction_score
):
    ...
    title_1_1 = "Top " + str(XAIVisualizationDefaults.top_x_percent_attributions) + "%"
    ...
    with tempfile.NamedTemporaryFile(delete=True) as img_path_to_store:
        fig.savefig(
            ...
            quality=XAIVisualizationDefaults.savefig_quality,
            optimize=True,
            progressive=True,
        )
