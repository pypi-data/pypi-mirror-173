...
class LGApi:
    ...
    def switch_on_off_slc(self, turn_on: bool,
                          slc_id_list: List[int]) -> models.SwitchOnOffResponse:
        ...
        return models.SwitchOnOffResponse(**data)

    def getLatitudeLongitudeSLC(self, slc_id_list: List[int]) -> dict:
    ...
    def get_all_slc(self, slc_id: Union[List[int], None] = None,
        ...
        # Obtaining lists
        slc_list = slc_response.data.allslcslist  # slc_number
        slc_data_list = slc_data_response.data.slcDataList  # slcNo
        # Generate new list of ID to make relationship
        slc_data_id_list = [slc_data.slcNo for slc_data in slc_data_list]
