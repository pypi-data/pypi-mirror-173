...
if [ -d /opt/intel/openvino_2021 ]; then
        ...
        ln -s /opt/intel/openvino_2021/data_processing/dl_streamer/samples/gst_launch/ .
        echo -e "\e[1;31mFace Detection Classification Sample Symbolic link created\e[0m"
