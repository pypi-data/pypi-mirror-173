...
#    cfg.setup_logger(filename=cfg.logfile_name)
    ...
    if not os.path.exists(file):
        cfg.contur_log.critical("{} does not exist!\n\n".format(file))
        sys.exit(1)
    ...
    try:
        ...
        contur_depot.add_points_from_db(args['file'][0])
        cfg.contur_log.info("Read DB file")
        ...
        try:
            cfg.contur_log.info("Reading as map file")
