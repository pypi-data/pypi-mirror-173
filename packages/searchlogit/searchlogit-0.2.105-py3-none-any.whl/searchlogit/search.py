...
class Search():
    ...
    def fit_mnl(self, sol):
        ...
        return (bic, val, as_vars, is_vars, rand_vars, bc_vars, corvars,
    ...
    def fit_lccm(self, sol):
        ...
        return (bic, val, as_vars, is_vars, rand_vars, transvars, corvars,
                            ...
                            for ii, class_params in enumerate(class_params_spec):
                                ...
                                for jj, class_param in enumerate(class_params):
                                    ...
                                    if class_param == '_inter':
                                        if self.intercept_opts and self.intercept_opts['class_intercept_alts']:
                                            num_coefs = 0
