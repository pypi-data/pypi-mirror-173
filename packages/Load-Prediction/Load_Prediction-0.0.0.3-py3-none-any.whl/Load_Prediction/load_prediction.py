...
c = Common('NTACP064')  # KBHMU042 KACLP002
sitecode = c.site_code()

print("sitecode:", sitecode)

# 조건1 (냉난반 예측 기간 판단)
# air_condition = c.determine_air_condition('20180728')
# print("air_condition:", air_condition)
# loadprediction_method(2, '20180813', '0530')
# loadprediction_method(3, '20180908', '0530')
