...
_HEASERVER_REGISTRY_IMAGE = 'registry.gitlab.com/huntsman-cancer-institute/risr/hea/heaserver-registry:1.0.0a24'
_HEASERVER_VOLUMES_IMAGE = 'registry.gitlab.com/huntsman-cancer-institute/risr/hea/heaserver-volumes:1.0.0a10'
_HEASERVER_KEYCHAIN_IMAGE = 'registry.gitlab.com/huntsman-cancer-institute/risr/hea/heaserver-keychain:1.0.0a4'
...
get_test_case_cls_default.__doc__ = """
    ...
    S3-based HEA microservice. The test environment will launch containers for the HEA Registry Microservice (1.0.0a24),
    the HEA Volumes Microservice (1.0.0a10), and the HEA Keychain Microservice (1.0.0a4) on port 8080 using
...
def with_docker_images(get_test_case_cls_default_: partial,
    ...
    """
    Creates a partial of a partial with DockerContainerConfig objects appended to the original partial's "frozen"
    other_docker_images keyword parameter.
    """
...
get_test_case_cls_default_with_message_broker = with_docker_images(get_test_case_cls_default, _rabbitmq)
get_test_case_cls_default_with_message_broker.__doc__ = """
    The same as get_test_case_cls_default except it also starts a RabbitMQ message broker container.
"""
