...
class ImagePipeline(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ImagePipeline.__init__)
    ...
    def image_recipe_components(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ImagePipeline, "image_recipe_components").fset)
...
class ImagePipelineProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ImagePipelineProps.__init__)
