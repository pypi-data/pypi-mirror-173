...
if __name__ == '__main__':
    ...
    try:
        ...
        wh_inventory.to_csv("D:\warehouse_purchase_m_1\wms_oct.csv")
        ...
        df['number-of-orders'] = np.round(28/df['max-review-period'])+1
        ...
        df_pref=pd.read_csv(r"D:\Warehouse_new_1\warehouse_oct\preferred_distributors.csv")
        ...
        df_new_1.to_csv(r"D:\acsv_files\warehouse_m_1\purchase_m+1_new_1_oct.csv")
