    ...
    def calculate_metrics(
        ...
        with MDC(trace_id=trace_id):
            try:
                ...
                X_sorted, y_sorted = self._sort_by_date_for_kfold(X_sampled, y_sampled)
                enriched_X_sorted, enriched_y_sorted = self._sort_by_date_for_kfold(self.enriched_X, y_sampled)
