...
def print_chapter(name: str | None) -> None:
    global _docked_widget, _is_first_line, _chapter
...
def unescape(text: str) -> str:
    ...
    _rich_abstract_console.print(text, end="")
...
@typing.overload
def print(*values: Tprint, dock: bool = True, markup: bool = True) -> Tprint:
    ...


@typing.overload
def print(*values: Any, dock: bool = True, markup: bool = True) -> TextLine:
    ...


def print(*values: Any, dock: bool = True, markup: bool = True) -> Widget:
    ...
    if not dock and _docked_widget is not None:
        stdout.write("\n")
        stdout.write(term.move_x(0 if _chapter is None else 3))
