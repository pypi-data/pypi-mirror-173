...
class _podping_reason_ReflectionData(_ReflectionData):
    request = _CodeGeneratorRequest.from_buffer(_Segment(b'\x00\x00\x00\x00\x00\x00\x02\x00\x05\x00\x00\x00\xb7\x00\x00\x00!\x01\x00\x00\x1f\x00\x00\x00\x08\x00\x00\x00\x05\x00\x06\x00\x89\xbc\xec\xac\xdf\x1f\x9a\xd9[\x00\x00\x00\x02\x00\x00\x00\xebdQ\xa4\xe4\xdf\xcc\x9a\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00A\x00\x00\x00J\x03\x00\x00u\x00\x00\x00\x07\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00q\x00\x00\x00g\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xebdQ\xa4\xe4\xdf\xcc\x9aU/github/workspace/podping_schemas/org/podcastindex/podping/hivewriter/podping_reason.capnp:PodpingReason\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x01\x00\x10\x00\x00\x00\x01\x00\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00)\x00\x00\x00:\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00!\x00\x00\x00*\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00\x19\x00\x00\x00B\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x00\x00\x00\x00\x11\x00\x00\x00:\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00update\x00\x00live\x00\x00\x00\x00liveEnd\x00newIRI\x00\x00/github/workspace/podping_schemas/org/podcastindex/podping/hivewriter/podping_reason.capnp\x00\x00\x00\x00\x00\x00\x04\x00\x00\x00\x01\x00\x01\x00\x89\xbc\xec\xac\xdf\x1f\x9a\xd9\x01\x00\x00\x00r\x00\x00\x00PodpingReason\x00\x00\x00\x04\x00\x00\x00\x01\x00\x02\x00\xebdQ\xa4\xe4\xdf\xcc\x9a\x05\x00\x00\x00\xda\x02\x00\x001\x00\x00\x00\x07\x00\x00\x00/github/workspace/podping_schemas/org/podcastindex/podping/hivewriter/podping_reason.capnp\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x01\x00'), 8, 0, 2)
...
cdef class PodpingReason(_BaseEnum):
    ...
    __members__ = ('update', 'live', 'liveEnd', 'newIRI',)
    @staticmethod
    cdef _new(long x, __prebuilt=(PodpingReason(0), PodpingReason(1), PodpingReason(2), PodpingReason(3),)):
        try:
            return __prebuilt[x]
        except IndexError:
            return PodpingReason(x)
    @staticmethod
    def _new_hack(long x, __prebuilt=(PodpingReason(0), PodpingReason(1), PodpingReason(2), PodpingReason(3),)):
        try:
            return __prebuilt[x]
        except IndexError:
            return PodpingReason(x)
