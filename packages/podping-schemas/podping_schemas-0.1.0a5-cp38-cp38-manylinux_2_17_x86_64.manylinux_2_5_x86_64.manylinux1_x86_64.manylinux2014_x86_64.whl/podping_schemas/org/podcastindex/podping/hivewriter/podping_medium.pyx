...
class _podping_medium_ReflectionData(_ReflectionData):
    request = _CodeGeneratorRequest.from_buffer(_Segment(b'\x00\x00\x00\x00\x00\x00\x02\x00\x05\x00\x00\x00\xb7\x00\x00\x00Y\x01\x00\x00\x1f\x00\x00\x00\x08\x00\x00\x00\x05\x00\x06\x00\x80\xa2v\xa5u\x16\xe8\xaa_\x00\x00\x00\x02\x00\x00\x00\xfe&\xb6\xc8\x1f\x8f\xda\xed\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00A\x00\x00\x00j\x03\x00\x00u\x00\x00\x00\x07\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00q\x00\x00\x00\xaf\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xfe&\xb6\xc8\x1f\x8f\xda\xedY/github/workspace/src/podping_schemas/org/podcastindex/podping/hivewriter/podping_medium.capnp:PodpingMedium\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x01\x00\x1c\x00\x00\x00\x01\x00\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00M\x00\x00\x00B\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00E\x00\x00\x002\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\x00\x00\x00\x00\x00\x00\x00=\x00\x00\x002\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03\x00\x00\x00\x00\x00\x00\x005\x00\x00\x00*\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00\x00-\x00\x00\x00R\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x05\x00\x00\x00\x00\x00\x00\x00)\x00\x00\x00Z\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x06\x00\x00\x00\x00\x00\x00\x00%\x00\x00\x00*\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00podcast\x00music\x00\x00\x00video\x00\x00\x00film\x00\x00\x00\x00audiobook\x00\x00\x00\x00\x00\x00\x00newsletter\x00\x00\x00\x00\x00\x00blog\x00\x00\x00\x00/github/workspace/src/podping_schemas/org/podcastindex/podping/hivewriter/podping_medium.capnp\x00\x00\x04\x00\x00\x00\x01\x00\x01\x00\x80\xa2v\xa5u\x16\xe8\xaa\x01\x00\x00\x00r\x00\x00\x00PodpingMedium\x00\x00\x00\x04\x00\x00\x00\x01\x00\x02\x00\xfe&\xb6\xc8\x1f\x8f\xda\xed\x05\x00\x00\x00\xfa\x02\x00\x001\x00\x00\x00\x07\x00\x00\x00/github/workspace/src/podping_schemas/org/podcastindex/podping/hivewriter/podping_medium.capnp\x00\x00\x00\x00\x00\x00\x01\x00\x01\x00'), 8, 0, 2)
...
cdef class PodpingMedium(_BaseEnum):
    ...
    @staticmethod
    cdef _new(long x, __prebuilt=(PodpingMedium(0), PodpingMedium(1), PodpingMedium(2), PodpingMedium(3), PodpingMedium(4), PodpingMedium(5), PodpingMedium(6),)):
        try:
            return __prebuilt[x]
        except IndexError:
            return PodpingMedium(x)
    @staticmethod
    def _new_hack(long x, __prebuilt=(PodpingMedium(0), PodpingMedium(1), PodpingMedium(2), PodpingMedium(3), PodpingMedium(4), PodpingMedium(5), PodpingMedium(6),)):
        try:
            return __prebuilt[x]
        except IndexError:
            return PodpingMedium(x)
