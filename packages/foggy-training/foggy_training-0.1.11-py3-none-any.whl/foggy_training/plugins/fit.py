...
class FitPlugin:
    ...
    def __call__(self, dataset: Dataset, epochs: int = 20):
        dataset = prepare_for_model(dataset, self.model.task)

        self.max_epochs = epochs
        self.data_config.shuffle = True

        dataloader = DataLoader(dataset, **self.data_config.as_dict)
