...
def fis_tool_stats_cont(df_cont):
    #Calculamos describe
...
def fis_tools_strong_corr(df, lim_inf = 0.3, lim_sup = 1,drop_dupli=True):
...
def fis_tools_ranking_mi(mutual_selector, predictors_df, modo = 'tabla'):
    #Maqueta el ranking
