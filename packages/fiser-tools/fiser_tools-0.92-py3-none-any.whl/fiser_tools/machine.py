...
def fis_machine_date_lags(df, num_lags = 7):
    """
...
def fis_machine_date_rolling_mean(df, num_periodos = 7):
    """
...
def fis_machine_metric_compute(real, scoring, umbral=0.5,graf_recall=False,graf_umbral=False,model=None,x=None,y=None):
    """
...
def fis_machine_metric_max_roi(real,scoring, salida = 'grafico',itn=0,ifp=-15,ifn=-85,itp=85):
    """
