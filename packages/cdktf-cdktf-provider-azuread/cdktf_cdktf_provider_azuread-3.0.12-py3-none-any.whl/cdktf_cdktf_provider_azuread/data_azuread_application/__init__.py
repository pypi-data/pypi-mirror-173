...
class DataAzureadApplication(
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["DataAzureadApplicationTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["DataAzureadApplicationTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class DataAzureadApplicationApiOutputReference(
    ...
    def internal_value(self, value: typing.Optional[DataAzureadApplicationApi]) -> None:
        if __debug__:
            def stub(value: typing.Optional[DataAzureadApplicationApi]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class DataAzureadApplicationAppRolesOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[DataAzureadApplicationAppRoles]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class DataAzureadApplicationFeatureTagsOutputReference(
    ...
    def internal_value(
        ...
        if __debug__:
            def stub(value: typing.Optional[DataAzureadApplicationFeatureTags]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
...
class DataAzureadApplicationTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[DataAzureadApplicationTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataAzureadApplicationTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataAzureadApplicationTimeouts, cdktf.IResolvable]],
...
class DataAzureadApplicationWebOutputReference(
    ...
    def internal_value(self, value: typing.Optional[DataAzureadApplicationWeb]) -> None:
        if __debug__:
            def stub(value: typing.Optional[DataAzureadApplicationWeb]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "internalValue", value)
