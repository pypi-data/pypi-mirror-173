...
class DirectoryRole(
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["DirectoryRoleTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["DirectoryRoleTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class DirectoryRoleTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[DirectoryRoleTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DirectoryRoleTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DirectoryRoleTimeouts, cdktf.IResolvable]],
