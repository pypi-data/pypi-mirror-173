...
Refer to the Terraform Registory for docs: [`data_azuread_administrative_unit`](https://www.terraform.io/docs/providers/azuread/d/administrative_unit).
'''
import abc
import builtins
import datetime
...
class DataAzureadAdministrativeUnit(
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["DataAzureadAdministrativeUnitTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["DataAzureadAdministrativeUnitTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class DataAzureadAdministrativeUnitTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[DataAzureadAdministrativeUnitTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataAzureadAdministrativeUnitTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[DataAzureadAdministrativeUnitTimeouts, cdktf.IResolvable]],
