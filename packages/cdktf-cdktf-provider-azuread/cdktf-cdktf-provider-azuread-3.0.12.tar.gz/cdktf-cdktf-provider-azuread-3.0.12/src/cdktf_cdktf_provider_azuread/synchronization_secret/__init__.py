...
class SynchronizationSecret(
    ...
    def __init__(
        ...
        *,
        ...
        credential: typing.Optional[typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["SynchronizationSecretCredential", typing.Dict[str, typing.Any]]]]] = None,
        id: typing.Optional[builtins.str] = None,
        timeouts: typing.Optional[typing.Union["SynchronizationSecretTimeouts", typing.Dict[str, typing.Any]]] = None,
        ...
        :param service_principal_id: The object ID of the service principal for which this synchronization secret should be created. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/synchronization_secret#service_principal_id SynchronizationSecret#service_principal_id}
        :param credential: credential block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/synchronization_secret#credential SynchronizationSecret#credential}
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/synchronization_secret#id SynchronizationSecret#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/synchronization_secret#timeouts SynchronizationSecret#timeouts}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def put_credential(
        self,
        value: typing.Union[cdktf.IResolvable, typing.Sequence[typing.Union["SynchronizationSecretCredential", typing.Dict[str, typing.Any]]]],
    ) -> None:
        '''
        :param value: -
        '''
    ...
    def put_timeouts(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/synchronization_secret#create SynchronizationSecret#create}.
        :param delete: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/synchronization_secret#delete SynchronizationSecret#delete}.
        :param read: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/synchronization_secret#read SynchronizationSecret#read}.
        :param update: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/synchronization_secret#update SynchronizationSecret#update}.
        '''
    ...
    def credential_input(
        self,
    ) -> typing.Optional[typing.Union[cdktf.IResolvable, typing.List["SynchronizationSecretCredential"]]]:
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["SynchronizationSecretCredential"]]], jsii.get(self, "credentialInput"))
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["SynchronizationSecretTimeouts", cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["SynchronizationSecretTimeouts", cdktf.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class SynchronizationSecretConfig(cdktf.TerraformMetaArguments):
    def __init__(
        self,
        *,
        connection: typing.Optional[typing.Union[typing.Union[cdktf.SSHProvisionerConnection, typing.Dict[str, typing.Any]], typing.Union[cdktf.WinrmProvisionerConnection, typing.Dict[str, typing.Any]]]] = None,
    ...
    def credential(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List["SynchronizationSecretCredential"]]], result)
...
class SynchronizationSecretCredential:
    def __init__(self, *, key: builtins.str, value: builtins.str) -> None:
        '''
        :param key: Name for this key-value pair. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/synchronization_secret#key SynchronizationSecret#key}
        :param value: Value for this key-value pair. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azuread/r/synchronization_secret#value SynchronizationSecret#value}
        '''
        if __debug__:
...
class SynchronizationSecretCredentialList(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[cdktf.IResolvable, typing.List[SynchronizationSecretCredential]]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[SynchronizationSecretCredential]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[cdktf.IResolvable, typing.List[SynchronizationSecretCredential]]],
...
class SynchronizationSecretCredentialOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[SynchronizationSecretCredential, cdktf.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[SynchronizationSecretCredential, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[SynchronizationSecretCredential, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[SynchronizationSecretCredential, cdktf.IResolvable]],
...
class SynchronizationSecretTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[SynchronizationSecretTimeouts, cdktf.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[SynchronizationSecretTimeouts, cdktf.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[SynchronizationSecretTimeouts, cdktf.IResolvable]],
