...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'aserto.authorizer.v2.api.policy_context_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _POLICYCONTEXT._serialized_start=75
  _POLICYCONTEXT._serialized_end=140
