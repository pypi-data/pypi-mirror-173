...
from mlm.math import DType
from mlm.math.backend import Backend, NUMPY, ComputeDevice, PHI_LOGGER
from mlm.math.backend._backend import combined_dim, SolveResult, get_functional_derivative_order, TensorType
...
class JITFunction:
    ...
    def __call__(self, *args, **kwargs):
        ...
        from mlm.math.backend import choose_backend
