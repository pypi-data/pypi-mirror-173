...
def simplify_wrt(f, wrt: str or int or tuple or list):
    ...
    if wrt is None:  # Old default
        ...
        warnings.warn("Specifying wrt by position is deprecated in mlm.math.funcitonal_gradient() and mlm.math.jacobian(). Please pass a list or comma-separated string of parameter names.",
...
class Solve(Generic[X, Y]):  # TODO move to mlm.math._functional, put Tensors there
    """
