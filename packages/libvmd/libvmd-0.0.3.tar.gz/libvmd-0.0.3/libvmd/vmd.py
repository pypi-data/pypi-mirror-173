...
def vmd(signal, K = 5,alpha = 1000, tau = 0.01, DC=True, init=1, tol=10**-6, N = 500):
    """
        -----------------------------------------------
...
def vmd2(signal, K = 5 , alpha = 1000, tau = 0.01,  DC=1, init=1, tol=10**-6, N = 3000, history_return = False, mirror_extension = False):
    """
        -----------------------------------------------
        -----------------------------------------------
    Original MATLAB code of D. Zosso was translated by Hyoseob Noh
