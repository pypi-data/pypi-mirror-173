...
class SDK:
    def __init__(self, merchant: dict, merchant_cadena: dict, processor: str = None, marketplace: bool = False, _test = None):
        self._sdk = None
        ...
        if processor == 'mercadopago':
            ...
            self._sdk = DecidirSDK(merchant, merchant_cadena, marketplace=marketplace, test=test_sdk)
