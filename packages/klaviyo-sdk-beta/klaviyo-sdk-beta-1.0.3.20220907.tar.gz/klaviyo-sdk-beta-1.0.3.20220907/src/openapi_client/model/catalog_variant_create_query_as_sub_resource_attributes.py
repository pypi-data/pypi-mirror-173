...
class CatalogVariantCreateQueryAsSubResourceAttributes(ModelNormal):
    ...
    def _from_openapi_data(cls, external_id, title, description, sku, inventory_policy, inventory_quantity, price, url, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            description (str):
            sku (str):
            inventory_policy (int): 0 = UNKNOWN, 1 = DENY, 2 = CONTINUE
        ...
        Keyword Args:
            ...
            catalog_type (str): [optional]  # noqa: E501
            integration_type (str): [optional] if omitted the server will use the default value of "$custom"  # noqa: E501
