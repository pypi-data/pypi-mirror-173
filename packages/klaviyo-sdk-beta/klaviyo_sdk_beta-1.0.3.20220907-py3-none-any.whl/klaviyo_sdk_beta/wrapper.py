...
import klaviyo_sdk_beta.custom_retry as custom_retry
...
class Client:
    ...
    def __post_init__(self):
        ...
        self.Metrics.get_metric_aggregate=self._page_cursor_update(self.retry_logic(self.Metrics.get_metric_aggregate))
