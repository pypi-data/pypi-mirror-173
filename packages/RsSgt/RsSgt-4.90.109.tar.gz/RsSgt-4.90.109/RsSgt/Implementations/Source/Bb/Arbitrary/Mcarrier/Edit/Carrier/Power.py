...
class PowerCls:
	...
	def get_start(self) -> float:
		...
		The command sets the power for the individual carriers in the defined carrier range.
		If the command BB:ARB:MCAR:EDIT:CARR:POW:STEP is used to define a step width, the power entered here applies only to the
		starting carrier. The power of the remaining carriers is stepped up or down by the power specified in the
		BB:ARB:MCAR:EDIT:CARR:POW:STEP command. \n
