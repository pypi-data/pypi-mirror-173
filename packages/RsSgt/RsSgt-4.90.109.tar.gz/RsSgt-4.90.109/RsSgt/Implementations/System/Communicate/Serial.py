...
class SerialCls:
	...
	# noinspection PyTypeChecker
	def get_sbits(self) -> enums.NumbersA:
		"""SCPI: SYSTem:COMMunicate:SERial:SBITs \n
		Snippet: value: enums.NumbersA = driver.system.communicate.serial.get_sbits() \n
		...
		return Conversions.str_to_scalar_enum(response, enums.NumbersA)

	def set_sbits(self, sbits: enums.NumbersA) -> None:
		"""SCPI: SYSTem:COMMunicate:SERial:SBITs \n
		Snippet: driver.system.communicate.serial.set_sbits(sbits = enums.NumbersA._1) \n
		Sets the number of stop bits for the serial remote control interface. \n
			:param sbits: 1| 2
		"""
		param = Conversions.enum_scalar_to_str(sbits, enums.NumbersA)
