...
class AsettingCls:
	...
	def get_state(self) -> bool:
		...
		Activates automatic adjustment of the baseband input signal. The R&S SGT receives peak level, level and crest factor
		values directly from the connected transmitter and recognizes changes automatically. \n
