...
class CloadCls:
	...
	def set(self) -> None:
		...
		Creates and loads a multi carrier waveform using the current entries of the carrier table. This multi carrier waveform is
		saved with the file name specified with command SOUR:BB:ARB:MCAR:OFIL. The file extension is *.wv. \n
		"""
