...
class LengthCls:
	...
	def get(self, path: str = None) -> int:
		...
		Returns the number of files in the current or in the specified directory. \n
			:param path: string String parameter to specify the directory. If the directory is omitted, the command queries the content of the current directory, queried with method RsSgt.MassMemory.currentDirectory command.
