...
setup(**{
    ...
    'install_requires': (
        ...
        'aiohttp~=3.8.1',
        'attrs>=20.3',
        """backend.ai-agent==22.09.4
""",
        """backend.ai-cli==22.09.4
""",
        """backend.ai-common==22.09.4
""",
        """backend.ai-kernel-binary==22.09.4
""",
        """backend.ai-kernel-helper==22.09.4
""",
        """backend.ai-kernel==22.09.4
""",
        """backend.ai-plugin==22.09.4
""",
    ),
    'license': 'LGPLv3',
