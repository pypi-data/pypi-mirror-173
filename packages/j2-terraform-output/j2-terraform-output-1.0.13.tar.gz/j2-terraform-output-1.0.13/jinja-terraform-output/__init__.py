...
class TerraformQueryExtension(Extension):
    ...
    def _get_outputs(self, name, org_name, workspace_name, value_name):
        ...
        print(BASE_URL)
        WORKSPACE_PATH = posixpath.join("organizations", org_name, "workspaces",workspace_name )
        ...
        state_output_path = posixpath.join("workspaces", ws_id, "current-state-version-outputs")
