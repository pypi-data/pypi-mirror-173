...
from identitylib.lookup_client.exceptions import ApiTypeError, ApiValueError, ApiException
from identitylib.lookup_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = GroupApi()
        api_instance.group_all_groups  # this is an instance of the class Endpoint
        api_instance.group_all_groups()  # this invokes api_instance.group_all_groups.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.group_all_groups.callable or self.callable in this class
