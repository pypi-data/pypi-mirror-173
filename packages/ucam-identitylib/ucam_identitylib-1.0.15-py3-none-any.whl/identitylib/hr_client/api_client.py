...
from identitylib.hr_client.exceptions import ApiTypeError, ApiValueError, ApiException
from identitylib.hr_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = StaffMembersApi()
        api_instance.get_v1alpha2_staff_member_staff_identifier_get  # this is an instance of the class Endpoint
        api_instance.get_v1alpha2_staff_member_staff_identifier_get()  # this invokes api_instance.get_v1alpha2_staff_member_staff_identifier_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_v1alpha2_staff_member_staff_identifier_get.callable or self.callable in this class
