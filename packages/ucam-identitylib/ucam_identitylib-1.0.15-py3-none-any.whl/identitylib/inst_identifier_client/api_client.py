...
from identitylib.inst_identifier_client.exceptions import ApiTypeError, ApiValueError, ApiException
from identitylib.inst_identifier_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_mapping  # this is an instance of the class Endpoint
        api_instance.get_mapping()  # this invokes api_instance.get_mapping.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_mapping.callable or self.callable in this class
