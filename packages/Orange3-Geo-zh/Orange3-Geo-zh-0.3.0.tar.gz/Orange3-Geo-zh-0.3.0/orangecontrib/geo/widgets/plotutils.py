...
# https://blog.csdn.net/qq_38181949/article/details/103423766
TILE_PROVIDERS = {
    "高德街道": _TileProvider(
    ...
    "地形图": _TileProvider(
        ...
        attribution='&copy; <a href="http://map.geoq.cn/arcgis/rest/services/ChinaOnlineCommunity/MapServer">高德地图</a>',
        size=256,
        max_zoom=18
    ),
