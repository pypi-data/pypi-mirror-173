...
CHOROPLETH_TILE_PROVIDER = _TileProvider(
    ...
    attribution='&copy; <a href="http://cache1.arcgisonline.cn/arcgis/rest/services/ChinaOnlineStreetGray/MapServer">北京捷泰天域</a>',
    size=256,
    max_zoom=19
)
...
class OWChoropleth(OWWidget):
    ...
    name = '分区着色地图(Choropleth Map)'
    description = '按照测量值为地图区域着色。'
    ...
    class Outputs:
        selected_data = Output("选中的数据(Selected Data)", Table, default=True, replaces=['Selected Data'])
