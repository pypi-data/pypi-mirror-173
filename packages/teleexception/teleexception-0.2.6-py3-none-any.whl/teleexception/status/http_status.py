...
class HTTPStatus(Enum):
    ...
    DB_CREATE_PERSON_ENTITY_ERR = (450001, "数据库操作失败", "创建人员实体失败")
    ...
    BODY_FEATURE_NUM_ONE_ERR = (601001, "人体特征提取错误", "人体数量大于1，请重试")
    ...
    FACE_FEATURE_NUM_ONE_ERR = (601001, "人脸特征提取错误", "人脸数量大于1，请重试")
