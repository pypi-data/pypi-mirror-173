...
class HTTPStatus(Enum):
    ...
    IMAGE_DATA_OR_IMAGE_URL_MUST_PRAM_ERR = (400006, "必传的参数未传", "必须的参数（ImageData 或 ImageURL")
    ...
    LABEL_MUST_PRAM_ERR = (400006, "必传的参数未传", "必须的参数（Labels）未传")
    ...
    SUBTASK_MUST_PRAM_ERR = (400006, "必传的参数未传", "必须的参数（SubTask）未传")
    ...
    LABEL_STRING_TYPE_ERR = (400008, "请求体的参数字段类型错误", "Labels 字段应该是 string 类型")
    ...
    DBNAME_EMPTY_ERR = (400009, "请求体的参数字段值为空", "DbName 字段值为空字符")
    ENTITY_ID_EMPTY_ERR = (400009, "请求体的参数字段值为空", "EntityId 字段值为空字符")
    LABEL_EMPTY_ERR = (400009, "请求体的参数字段值为空", "Labels 字段值为空字符")
    FACE_ID_EMPTY_ERR = (400009, "请求体的参数字段值为空", "FaceId 字段值为空字符")
    ...
    LABEL_VALUE_ERR = (400010, "请求体的参数字段值设置错误", "Labels 字段不符合规范，请参考接口文档说明")
    ...
    IMAGE_DATA_AND_IMAGE_URL_DUPLI_PRAM_ERR = (
        400016, "必传的参数重复", "必须的参数（ImageData 或 ImageURL）只能二选一")
    ...
    DB_DELETE_PERSON_ENTITY_ERR = (450001, "数据库操作失败", "删除人员实体失败，请重试")
    ...
    DB_NOT_EXIST_NOT_CREATE_ENTITYID_ERR = (450002, "请求的数据库不存在", "请求的数据库不存在，无法创建实体")
    DB_NOT_EXIST_NOT_UPDATE_ENTITYID_ERR = (450002, "请求的数据库不存在", "请求的数据库不存在，无法创建实体")
    DB_NOT_EXIST_NOT_QUERY_ENTITYID_ERR = (450002, "请求的数据库不存在", "请求的数据库不存在，无法查询实体")
    ...
    DB_NOT_ENTITY_EXIST_PERSON_ERR = (450004, "请求的数据库实体不存在", "请求的人员库不存在")

    # 450005 请求的数据库实体已存在
    DB_ENTITY_EXIST_ERR = (450005, "请求的数据库实体已存在", "请求的数据库实体已存在")
    DB_ENTITY_EXIST_PERSON_ERR = (450005, "请求的数据库实体已存在", "请求的人员库已存在")
