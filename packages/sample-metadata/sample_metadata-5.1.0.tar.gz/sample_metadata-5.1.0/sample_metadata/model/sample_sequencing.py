...
class SampleSequencing(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, sample_id, type, status, *args, **kwargs):  # noqa: E501
        """SampleSequencing - a model defined in OpenAPI

        Args:
            sample_id (bool, date, datetime, dict, float, int, list, str, none_type):
            type (SequenceType):
    ...
    @convert_js_args_to_python_args
    def __init__(self, sample_id, type, status, *args, **kwargs):  # noqa: E501
        """SampleSequencing - a model defined in OpenAPI
