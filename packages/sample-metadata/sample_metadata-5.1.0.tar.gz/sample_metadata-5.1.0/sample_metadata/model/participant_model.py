...
class ParticipantModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, meta, *args, **kwargs):  # noqa: E501
        """ParticipantModel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, meta, *args, **kwargs):  # noqa: E501
        """ParticipantModel - a model defined in OpenAPI
