...
from truera.client.public.communicator.http_communicator import \
    AlreadyExistsError
from truera.protobuf.configuration.project_pb2 import ProjectDocumentation
...
class LabelIngestionFailedException(Exception):
...
class ArtifactRepoClient:
    ...
    def create_model_metadata(
        ...
        *,
        ...
        locator: str,
        rnn_attribution_config: Optional[RNNAttributionConfig] = None,
        ...
        req = self._build_create_model_metadata_request(
            ...
            locator=locator,
            rnn_attribution_config=rnn_attribution_config,
    ...
    def delete_metadata(
        ...
        try:
            ...
            RemainingItem = namedtuple("RemainingItem", ("type", "name", "id"))
    ...
    def _build_create_model_metadata_request(
        ...
        locator: str, rnn_attribution_config: RNNAttributionConfig,
    ...
    def _build_create_cache_request(
        ...
        cache_type: md_pb.CacheType,
        explanation_algorithm_type: md_pb.ExplanationAlgorithmType, client_name,
        client_version
    ):
