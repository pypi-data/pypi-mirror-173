...
from truera.protobuf.public.error_details_pb2 import ErrorDetails
...
class AuthenticationFailedError(Exception):
    ...
    def __init__(self, details):
        self.message = "The provided authentication details were invalid or expired. Details: " + str(
            details
        )
    ...
    def _parse_grpc_error_from_response(self, response):
        ...
        if grpc_status != grpc.StatusCode.UNKNOWN:
            raise _get_error_from_grpc_status(
                grpc_status, error_message, error_details
            )
