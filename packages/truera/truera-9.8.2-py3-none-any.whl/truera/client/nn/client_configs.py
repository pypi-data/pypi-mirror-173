...
from truera.protobuf.public.aiq.rnn_config_pb2 import RNNAttributionConfig
from truera.protobuf.public.aiq.rnn_config_pb2 import RNNUIConfig
...
class NLPAttributionConfiguration(AttributionConfiguration):
    ...
    embedding_anchor: Optional[LayerAnchor] = None
    output_anchor: Optional[LayerAnchor] = None

    input_layer: Optional[Union[str, Layer]] = None
    input_anchor: Optional[LayerAnchor] = None
    ...
    def from_dict(
        ...
        if (attr_config_dict.get("embedding_anchor") == 'None'):
            ...
            parsed_attr_config["embedding_anchor"] = LayerAnchor.from_string(
                attr_config_dict.get("embedding_anchor")
            )

        if (attr_config_dict.get("input_dimension_order") == 'None'):
            parsed_attr_config["input_dimension_order"] = None
        else:
            parsed_attr_config["input_dimension_order"] = list(
                attr_config_dict.get("input_dimension_order")
            )
        parsed_attr_config["output_layer"] = attr_config_dict.get(
            "output_layer"
        )
        ...
        if (attr_config_dict.get("output_anchor") == "None"):
            ...
            parsed_attr_config["output_anchor"] = LayerAnchor.from_string(
                attr_config_dict.get("output_anchor")
            )

        if (attr_config_dict.get("output_dimension_order") == 'None'):
            parsed_attr_config["output_dimension_order"] = None
        else:
            parsed_attr_config["output_dimension_order"] = list(
                attr_config_dict.get("output_dimension_order")
            )
