...
@inject_tokens()
async def enable_multiple_currencies(data: dict, client: AsyncClient, api: ZohoApi) -> Response:
...
@inject_tokens()
async def get_currencies(client: AsyncClient, api: ZohoApi, currency_id: str | None = None) -> Response:
