...
@inject_tokens()
async def assign_territories(module: str, data: dict, client: AsyncClient, api: ZohoApi, record_id: str | None = None) -> Response:
...
@inject_tokens()
async def remove_territories(module: str, data: dict, client: AsyncClient, api: ZohoApi, record_id: str | None = None) -> Response:
    if record_id is None:
...
@inject_tokens()
async def get_record_territories(module: str, record_id: str, client: AsyncClient, api: ZohoApi) -> Response:
