...
@inject_tokens()
async def get_pipelines(client: AsyncClient, api: ZohoApi, params: dict, pipeline_id: str | None = None) -> Response:
...
@inject_tokens()
async def create_pipeline(data: dict, params: dict, client: AsyncClient, api: ZohoApi) -> Response:
    url = f"{api.domain}/crm/{api.version}/settings/pipeline"
