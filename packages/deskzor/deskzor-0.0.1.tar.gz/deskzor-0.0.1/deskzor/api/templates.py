...
@inject_tokens()
async def get_email_templates(client: AsyncClient, api: ZohoApi, id: str | None = None, params: dict | None = None) -> Response:
    if id is None:
...
@inject_tokens()
async def get_inventory_templates(client: AsyncClient, api: ZohoApi, id: str | None = None, params: dict | None = None) -> Response:
    if id is None:
