...
class downloadLandsat(cmr):
    ...
    def download(self, Landsat_name, output_dir,
    ...
    def downloadByCMR(self, output_dir, url, timeout=5*60, skip=False):
        '''
        根据输入url下载相应的文件
        ...
        filename = self.cmr_download(output_dir, url, token=self.token,
