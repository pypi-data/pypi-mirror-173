...
_MULTISENDREQUEST = _descriptor.Descriptor(
  name='MultiSendRequest',
  full_name='MultiSendRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='messages', full_name='MultiSendRequest.messages', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='parent_event_id', full_name='MultiSendRequest.parent_event_id', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='description', full_name='MultiSendRequest.description', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='skip_order', full_name='MultiSendRequest.skip_order', index=3,
...
_MULTISENDREQUEST.fields_by_name['messages'].message_type = th2__grpc__common_dot_common__pb2._MESSAGE
_MULTISENDREQUEST.fields_by_name['parent_event_id'].message_type = th2__grpc__common_dot_common__pb2._EVENTID
...
DESCRIPTOR.message_types_by_name['MultiSendRequest'] = _MULTISENDREQUEST
...
MultiSendRequest = _reflection.GeneratedProtocolMessageType('MultiSendRequest', (_message.Message,), {
  'DESCRIPTOR' : _MULTISENDREQUEST,
  '__module__' : 'th2_grpc_act_template.act_template_pb2'
  # @@protoc_insertion_point(class_scope:MultiSendRequest)
  })
_sym_db.RegisterMessage(MultiSendRequest)
...
_ACT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='multiSendMessage',
    full_name='Act.multiSendMessage',
    index=9,
    containing_service=None,
    input_type=_MULTISENDREQUEST,
    output_type=_SENDMESSAGERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
