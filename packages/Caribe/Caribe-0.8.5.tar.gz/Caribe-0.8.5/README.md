...
## Decoding a File
```python
from Caribe import filedecode

filedecode.file_decode("test.txt", "text")
# Generates a decoded  text file
filedecode.file_decode("test.json", "json")
# Generates a decoded  json file
filedecode.file_decode("test.csv", "csv")
# Generates a decoded csv file
