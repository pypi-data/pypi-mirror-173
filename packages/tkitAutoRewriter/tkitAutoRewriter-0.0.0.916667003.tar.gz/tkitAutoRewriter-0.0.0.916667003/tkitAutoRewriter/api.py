...
def rewriter_by_paraphrase( text, simlimit=0.8, num_beams=5, num_return_sequences=5, max_length=128, simlimitmax=1.0,auto_sample=False,temperature=1.1125, pre_text="",api='http://192.168.1.18:3011',api_sbert_host="http://192.168.1.18:3016", **kwargs):
    """
    """
