...
class Offline(Mind):
    ...
    def getValue(plantName, signalNames, startDate, endDate, aggregation, interval, pageNumber=1,
        ...
        try:
            ...
            if len(set_signal_class) == 2:
                ...
                df1 = Offline.send_request(plantName, gas_signal,[2],startDate, endDate, aggregation, interval, pageNumber=1,
             pageSize=100000000)
                df2 = Offline.send_request(plantName, steam_signal,[9],startDate, endDate, aggregation, interval, pageNumber=1,
             pageSize=100000000)
            ...
            if len(set_signal_class) == 1:
                df1 = Offline.send_request(plantName, signalNames, signalClasses,startDate, endDate, aggregation, interval,
                                           pageNumber=1,
                                           pageSize=100000000)
                return df1
            else:
    ...
    @staticmethod
    def send_request(plantName, signalNames, signalClasses, startDate, endDate, aggregation, interval, pageNumber=1,pageSize=100000000):
