...
class CmdCore():
    ...
    def get_client_context(self, exper_name, run_name, app_info, box_info, job_id, node_index, run_specs, resume_name=None, 
        ...
        mirror_files = args["mirror_files"]
        mirror_file_list = [mirror_files] if mirror_files else []

        if args["mirror_files"]:
            ...
            mirror_file_list.append(log_files_wc)

        context.mirror_dest = args["mirror_dest"]
        context.mirror_files = mirror_file_list
