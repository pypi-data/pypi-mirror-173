...
def input_convert(params_dict=None, enroll_id=None):
    ...
    if not category_id:
        return format_params_handle(
            ...
            filter_filed_list=["enroll_id", "name", "price", "count", "unit", "amount", "description", "remark", ]
        )
    ...
    return format_params_handle(
        param_dict=params_dict,
        filter_filed_list=["enroll_id", "name", "price", "count", "unit", "amount", "description", "remark", ] + list(extend_field_map.keys()),
