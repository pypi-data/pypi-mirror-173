...
class ValuationService:
    ...
    def valuate(category_id=None, variables_dict=None):
        ...
        if not category_id or not variables_dict:
            return None, "参数错误"
        expression_list = EnrollRuleValuate.objects.annotate(category_id=F("enroll_rule_group__category_id")).filter(category_id=category_id).values("field", "expression_string")
