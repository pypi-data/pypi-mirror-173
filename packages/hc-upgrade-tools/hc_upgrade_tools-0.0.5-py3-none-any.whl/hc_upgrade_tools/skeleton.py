...
from hc_upgrade_tools import donwload_artifacts
...
def parse_args(args):
    ...
    parser.add_argument("--number", help="n-th Fibonacci number", type=int, metavar="INT")
    parser.add_argument(
        "-v",
        "--verbose",
        dest="loglevel",
    ...
    donwload_artifacts.init_subparser(subparsers)
