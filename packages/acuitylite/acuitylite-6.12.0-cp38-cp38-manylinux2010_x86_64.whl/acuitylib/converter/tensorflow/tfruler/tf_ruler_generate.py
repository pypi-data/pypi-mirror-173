...
"blob_map": {
    "lstm": {
        'rnn/multi_rnn_cell/cell_0/lstm_cell/kernel': ['CODE', "self.tensor_to_numpy(tensor['C_14:out0'])"],
        'rnn/multi_rnn_cell/cell_0/lstm_cell/bias': ['CODE', "self.tensor_to_numpy(tensor['C_11:out0'])"],
    }},
"priority_tip": 0,
"pre_condition": None
}
