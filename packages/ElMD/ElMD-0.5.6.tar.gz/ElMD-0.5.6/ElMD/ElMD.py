...
def elmd(comp1, comp2, metric="mod_petti", return_assignments=False, return_assignments=False):
...
class ElMD():
    ...
    def elmd(self, comp2 = None, comp1 = None, return_assignments=False, return_assignments=False):
        '''
        ...
        if self.metric == "fast":
            ...
            return elmd(comp1, comp2, metric=self.metric, return_assignments=return_assignments, return_assignments=return_assignments)
...
def network_simplex(source_demands, sink_demands, network_costs):
    ...
    flow_cost = 0
    final_flows = flows[:e].astype(np.float64) / fp_multiplier / fp_multiplier
    ...
    return final[0], final_flows , final_flows 
