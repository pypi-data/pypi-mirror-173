...
class ExecuteTimeWidget extends widgets_1.Widget {
    ...
    _updateSettings(settings) {
        ...
        if (this._settings.enabled) {
            ...
            this._settingRegistry.load(`@jupyterlab/notebook-extension:tracker`).then((settings) => settings.set('recordTiming', true), (err) => {
...
//# sourceMappingURL=lib_index_js.17e47a7eb457f4ed99c7.js.map