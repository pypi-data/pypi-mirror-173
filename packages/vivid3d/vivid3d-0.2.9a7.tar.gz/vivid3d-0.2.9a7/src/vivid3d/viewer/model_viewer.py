...
def view_glb(glb, height=500):
    ...
    if in_notebook():  # Display in notebook
        ...
        display.HTML('<div><iframe srcdoc="{srcdoc}" width="100%" height="{height}px" style="border:none;"></iframe></div>'.format(srcdoc=srcdoc, height=height))
