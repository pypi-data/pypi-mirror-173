...
class Project(object):
    """An object representing a solar site (project). This should never be initialized\
        outside of a :class:`~DashboardSession` instance, which coordinates the processing of :attr:`~proj_init_dict`.
    ...
    def _find_neighbor_sensors(self):
        ...
        `Project` to :attr:`~neighbor_sensors`"""
    ...
    def __get_project_parameters(self):
        """Checks that base parameters are present in :attr:`~df_keys` & pulls the parameters from the config file if not"""
    ...
    def load_production_data(self):
        ...
        If file has already been loaded, it will check :attr:`~last_update_powertrack` against the
    ...
    def find_nearby_projects(self, dist=10, print_data=True, include_retired=False, df=None):
        ...
        Args:
            ...
            df (Dataframe, optional): Dataframe containing sitenames & lat/longs.
                Defaults to :attr:`~df_keys` if no `df` supplied.

        Returns:
            DataFrame: Information about all sites within the specified
