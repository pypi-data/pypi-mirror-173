...
class TriggerCls:
	...
	def get_source(self) -> enums.TriggerSourceB:
		...
		Snippet: value: enums.TriggerSourceB = driver.source.bb.sirius.terrestrial.trigger.get_source() \n
		No command help available \n
	...
	def set_source(self, source: enums.TriggerSourceB) -> None:
		"""SCPI: [SOURce<HW>]:BB:SIRius:TERRestrial:TRIGger:SOURce \n
		Snippet: driver.source.bb.sirius.terrestrial.trigger.set_source(source = enums.TriggerSourceB.BEXTernal) \n
		No command help available \n
