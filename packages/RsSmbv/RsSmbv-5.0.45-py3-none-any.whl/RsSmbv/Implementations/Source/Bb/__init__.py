...
class BbCls:
	"""Bb commands group definition. 8177 total commands, 35 Subgroups, 6 group commands"""
	...
	@property
	def eutra(self):
		"""eutra commands group. 19 Sub-classes, 7 commands."""
	...
	@property
	def gnss(self):
		"""gnss commands group. 26 Sub-classes, 7 commands."""
	...
	def sirius(self):
		...
		if not hasattr(self, '_sirius'):
			from .Sirius import SiriusCls
			self._sirius = SiriusCls(self._core, self._cmd_group)
		return self._sirius
