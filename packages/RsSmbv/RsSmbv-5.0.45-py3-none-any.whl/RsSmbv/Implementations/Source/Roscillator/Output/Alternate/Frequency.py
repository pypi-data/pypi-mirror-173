...
class FrequencyCls:
	...
	def get_mode(self) -> enums.Rosc1GoUtpFreqMode:
		...
		Sets the output reference frequency. \n
			:return: outp_freq_mode: LOOPthrough| DER1G| OFF OFF Disables the output. DER1G Sets the output reference frequency to 1 GHz. The reference frequency is derived from the internal reference frequency. LOOPthrough If [:SOURce]:ROSCillator:EXTernal:FREQuency1GHZ, forwards the input reference frequency to the reference frequency output.
		"""
