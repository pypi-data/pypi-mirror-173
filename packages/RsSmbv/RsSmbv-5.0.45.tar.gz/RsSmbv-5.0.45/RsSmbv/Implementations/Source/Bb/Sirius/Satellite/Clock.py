...
class ClockCls:
	...
	def get_source(self) -> enums.ClockSourceB:
		...
		Snippet: value: enums.ClockSourceB = driver.source.bb.sirius.satellite.clock.get_source() \n
		No command help available \n
	...
	def set_source(self, source: enums.ClockSourceB) -> None:
		"""SCPI: [SOURce<HW>]:BB:SIRius:SATellite:CLOCk:SOURce \n
		Snippet: driver.source.bb.sirius.satellite.clock.set_source(source = enums.ClockSourceB.AINTernal) \n
		No command help available \n
