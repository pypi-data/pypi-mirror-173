...
class RdistanceCls:
	...
	def get_unit(self) -> enums.UnitNmAvionic:
		...
		given in nautic miles (NM) or µs. 1 nm is 1852.01 meters and corresponds to a run time of 12.359 µs. \n
			:return: unit: US| NM
		"""
	...
	def get_value(self) -> float:
		...
		The distance can be given in nautic miles (NM) or µs with the command [:SOURce<hw>][:BB]:DME:RDIStance:UNIT. If the unit
		...
		359 μs/nm (X mode delay = 50 μs, Y mode delay is 56 μs) Changing one value automatically changes the other value. \n
