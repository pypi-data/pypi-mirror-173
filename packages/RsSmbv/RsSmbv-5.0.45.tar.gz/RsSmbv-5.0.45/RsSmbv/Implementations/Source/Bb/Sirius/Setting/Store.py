...
class StoreCls:
	...
	def get_fast(self) -> bool:
		"""SCPI: [SOURce<HW>]:BB:SIRius:SETTing:STORe:FAST \n
		Snippet: value: bool = driver.source.bb.sirius.setting.store.get_fast() \n
		No command help available \n
			:return: fast: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:SIRius:SETTing:STORe:FAST?')
		return Conversions.str_to_bool(response)

	def set_fast(self, fast: bool) -> None:
		"""SCPI: [SOURce<HW>]:BB:SIRius:SETTing:STORe:FAST \n
		Snippet: driver.source.bb.sirius.setting.store.set_fast(fast = False) \n
		No command help available \n
			:param fast: No help available
		"""
		param = Conversions.bool_to_str(fast)
		self._core.io.write(f'SOURce<HwInstance>:BB:SIRius:SETTing:STORe:FAST {param}')

	def set_value(self, filename: str) -> None:
		"""SCPI: [SOURce<HW>]:BB:SIRius:SETTing:STORe \n
		Snippet: driver.source.bb.sirius.setting.store.set_value(filename = '1') \n
		No command help available \n
