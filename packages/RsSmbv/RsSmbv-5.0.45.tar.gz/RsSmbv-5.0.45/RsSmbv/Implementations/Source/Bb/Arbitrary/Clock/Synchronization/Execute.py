...
class ExecuteCls:
	...
	def set(self) -> None:
		"""SCPI: [SOURce]:BB:ARBitrary:CLOCk:SYNChronization:EXECute \n
		Snippet: driver.source.bb.arbitrary.clock.synchronization.execute.set() \n
		No command help available \n
		"""
		self._core.io.write(f'SOURce:BB:ARBitrary:CLOCk:SYNChronization:EXECute')
	...
	def set_with_opc(self, opc_timeout_ms: int = -1) -> None:
		...
		self._core.io.write_with_opc(f'SOURce:BB:ARBitrary:CLOCk:SYNChronization:EXECute', opc_timeout_ms)
