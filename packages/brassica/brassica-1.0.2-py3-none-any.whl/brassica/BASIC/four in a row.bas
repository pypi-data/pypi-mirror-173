...
# It is strong against three adjacent Xs in a row (XXX-), but weak against a
# pair of Xs separated from a colinear third by single gap (XX-X).
...
1610 FOR Z1=1 TO 4:S(Z1)=0:F(Z1)=0:NEXT Z1
1620 GOTO 280
1630 END
