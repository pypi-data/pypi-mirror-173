...
class QGCNDataSet:
    ...
    def __init__(self, dataset_name: str,
                 ...
                 params_file: str = None, logger=False):
        ...
        self.dataset = GraphsDataset(self.params, external_data=ext_train, logger=logger)
...
class QGCNModel:
    ...
    def __init__(self, dataset_name: str,
                 ...
                 device="cpu", params_file: str = None, logger=False):
        ...
        self.ds = GraphsDataset(self.params, external_data=self.ext_train, logger=logger)
