...
class RsSmcv:
	...
	_driver_options = "SupportedInstrModels = SMCV/SMW/SMBV/SMA, SupportedIdnPatterns = SMCV/SMBV/SMW/SMA, SimulationIdnString = 'Rohde&Schwarz,SMCV100B,100001,5.0.124.0016'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '5.0.124.0016'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '5.0.124.0016'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsSmcv version failed. Current version: '5.0.124.0016', minimum required version: '{min_version}'")
