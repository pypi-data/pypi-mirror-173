...
@fetcher('amsterdam', download_from_mega, AMSTERDAM_FILENAME, AMSTERDAM_URL,\
         AMSTERDAM_CLEANED_FILENAME, AMSTERDAM_CLEANED_URL)
def fetch_amsterdam(keep_original=False, cache=True, load_cleaned=False,
    ...
    data = Data(activities=df_act, devices=df_dev, activity_list=lst_act, device_list=lst_dev)
