...
@fetcher('aras', download_from_mega, ARAS_FILENAME, ARAS_URL)
...
def fetch_aras(keep_original=True, cache=True, retain_corrections=False,
    ...
    data = Data(devices=df_dev, device_list=lst_dev)
    data.set_activity_df(df_res1_act, RES_1)
    data.set_activity_df(df_res2_act, RES_2)
    data.set_activity_list(df_res1_act[ACTIVITY].unique(), RES_1)
    data.set_activity_list(df_res2_act[ACTIVITY].unique(), RES_2)
