...
install_requires = ['numpy', 'pandas', 'joblib', 'mega.py', 'dask[complete]',
                    'matplotlib', 'scipy', 'sklearn', 'sqlalchemy']
extras_require = {}
...
setup_args = dict(
    name="pyadlml",
    version="0.0.7.0.1-alpha",
    url="https://github.com/tcsvn/pyadlml",
    author="Christian Meier",
    description="Sklearn like library supporting numerous Activity of Daily Livings datasets and preprocessing methods.",
