...
def find_channels(
    ...
    if verbose:
        ...
        try:
            ...
            print("\033[92m")
            print(
                "Displaying {num} channels that match {glob} on {hs}:{pn}".format(
                    num=len(buffers), glob=channel_glob, hs=host_server, pn=port_number
                )
            )
            print("\033[0m")
...
def decimate_data(data, starting_fs:int, final_fs:int, ftype="iir"):
    ...
    """
    decimation_ratio = starting_fs // final_fs
...
def calc_decimated_csd(
    ...
    if (
        ...
        calc_decimated_psd(data_dict, chan_a, decimated_fs, averages, bandwidth, overlap)
    ...
    if (
        ...
        calc_decimated_psd(data_dict, chan_b, decimated_fs, averages, bandwidth, overlap)
