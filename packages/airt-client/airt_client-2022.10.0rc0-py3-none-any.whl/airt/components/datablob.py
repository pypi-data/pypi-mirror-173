...
class DataBlob:
        ...
        *,
        ...
        Args:
            ...
            region: The destination cloud provider's region to store the datablob. If **None** (default value) then the default region will be assigned based on the cloud
                provider. In the case of **aws**, the datablob's source bucket region will be used and in the case of **azure**, **westeurope** will be used. For the list
                of available Azure Blob Storage regions, please click [here](https://docs.microsoft.com/en-us/azure/availability-zones/az-overview) and for
                the list of available S3 regions, please click [here](https://docs.aws.amazon.com/general/latest/gr/s3.html).
    ...
    def from_azure_blob_storage(
        ...
        Args:
            ...
            region: The destination cloud provider's region to store the datablob. If **None** (default value) then the default region will be assigned based on the cloud
                provider. In the case of **aws**, **eu-west-1** will be used and in the case of **azure**, **westeurope** will be used. For the list
                of available Azure Blob Storage regions, please click [here](https://docs.microsoft.com/en-us/azure/availability-zones/az-overview) and for
                the list of available S3 regions, please click [here](https://docs.aws.amazon.com/general/latest/gr/s3.html).
            tag: A string to tag the datablob. If not passed, then the tag **latest** will be assigned to the datablob.
        ...
        Example:
            ...
            # datablobs created here be stored in S3 and will have regions
            # set to eu-west-1 (default)
...
def to_datasource(
    ...
    **kwargs,
    ...
    ```python
        data_source = datablob_csv.to_datasource(
            file_type="csv",
            index_column="index_column_name",
            sort_by="sort_by_column_name"
        )
