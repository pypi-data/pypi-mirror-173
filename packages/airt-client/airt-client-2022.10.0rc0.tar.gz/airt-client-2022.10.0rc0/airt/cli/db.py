...
def from_s3(
    ...
    region: Optional[str] = typer.Option(
        ...
        "For the list of available Azure Blob Storage regions, please click [here](https://docs.microsoft.com/en-us/azure/availability-zones/az-overview) "
        "and for the list of available S3 regions, please click [here](https://docs.aws.amazon.com/general/latest/gr/s3.html)",
    ),
