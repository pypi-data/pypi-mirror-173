...
_SCALAR_PRIVACYPARAMETERS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='epsilon', full_name='sarus_data_spec.Scalar.PrivacyParameters.epsilon', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='delta', full_name='sarus_data_spec.Scalar.PrivacyParameters.delta', index=1,
...
_SCALAR = _descriptor.Descriptor(
  ...
  nested_types=[_SCALAR_PROPERTIESENTRY, _SCALAR_SPEC, _SCALAR_TRANSFORMED, _SCALAR_MODEL, _SCALAR_PRIVACYPARAMETERS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
