...
class Scalar(google.protobuf.message.Message):
    ...
    class Spec(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal[u"model",b"model",u"privacy_params",b"privacy_params",u"spec",b"spec",u"transformed",b"transformed"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"model",b"model",u"privacy_params",b"privacy_params",u"spec",b"spec",u"transformed",b"transformed"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal[u"spec",b"spec"]) -> typing.Optional[typing_extensions.Literal["transformed","model","privacy_params"]]: ...
