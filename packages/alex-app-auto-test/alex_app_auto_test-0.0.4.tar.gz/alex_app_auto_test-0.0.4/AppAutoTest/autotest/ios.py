...
caps["appium:platformVersion"] = "16.0"
caps["appium:deviceName"] = "iPhone X"
caps["appium:app"] = "com.aax.exchange.beta"
caps["appium:udid"] = "a92ff1b6ab64d7dad5fe74efdc978db1e351ddff"
caps["appium:noReset"] = True
caps["appium:newCommandTimeout"] = "6000"
...
##头像登陆
ele_iv_avatar = driver.find_element(AppiumBy.ID, "home account")
ele_iv_avatar.click()
##登陆/注册
wait_element(driver, 10, AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name='登錄 / 註冊']", "登陆/注册页面，没出现")
ele_tv_login = driver.find_element(AppiumBy.XPATH, "//XCUIElementTypeStaticText[@name='登錄 / 註冊']")
ele_tv_login.click()
##邮箱页面
time.sleep(2)
wait_element(driver, 10, AppiumBy.XPATH, '//XCUIElementTypeButton[@name="郵箱"]', "不在邮件页面")
ele_yx = driver.find_element(AppiumBy.XPATH,'//XCUIElementTypeButton[@name="郵箱"]')
ele_yx.click()
##请登陆账户
wait_element(driver, 10, AppiumBy.XPATH, "//XCUIElementTypeApplication[@name='AAX测试版']/XCUIElementTypeWindow/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeScrollView/XCUIElementTypeOther/XCUIElementTypeScrollView/XCUIElementTypeOther[1]/XCUIElementTypeOther/XCUIElementTypeTextField", "请登陆页账户页面，邮箱控件没有显示完全")
ele_et_email = driver.find_element(AppiumBy.XPATH, "//XCUIElementTypeApplication[@name='AAX测试版']/XCUIElementTypeWindow/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeScrollView/XCUIElementTypeOther/XCUIElementTypeScrollView/XCUIElementTypeOther[1]/XCUIElementTypeOther/XCUIElementTypeTextField")
# ele_et_pwd = driver.find_element(AppiumBy.ID, '//XCUIElementTypeStaticText[@name="密碼"]/../XCUIElementTypeOther')
ele_et_pwd = driver.find_element(AppiumBy.ID, '//XCUIElementTypeStaticText[@name="密碼"]')
tv_next = driver.find_element(AppiumBy.XPATH, "//XCUIElementTypeButton[@name='提交']")
