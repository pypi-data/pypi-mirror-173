...
class Element(ABC, BaseModel, extra=Extra.allow):
...
def create_element(element, attrs):
    ...
    class HTML(Element, extra=Extra.allow):
        ...
        def check_field_names(cls, values):
            ...
            for field, value in values.items():
                ...
                if (field == "children") and isinstance(value, (str, Element)):
                    continue
                ...
                if (
                    ...
                    and all(isinstance(v, (str, Element)) for v in values)
                ):
                    continue
