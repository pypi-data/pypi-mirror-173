...
def main() -> None:
    output_data_dir = os.path.join("oss://pre-vvp-mq-test/feathub", "nyc_output.json")
    ...
    client.materialize_features(
        features,
        FileSystemSink(output_data_dir, "json"),
...
def build_features(client: FeathubClient) -> FeatureView:
    ...
    source_file_path = "oss://pre-vvp-mq-test/feathub/data/sample_data.csv"
