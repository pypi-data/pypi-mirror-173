...
setup(
    ...
    install_requires=['switch-guides', 'click', 'click-help-colors', 'click_spinner', 'pydantic==1.9.0'],
    python_requires=">=3.8.*",
    entry_points={
        'console_scripts': [
            'swag=switch_guides_scaffold.scaffolder:cli_init',
            'switchguides=switch_guides_scaffold.scaffolder:cli_init'
        ]
    },
    classifiers=[
