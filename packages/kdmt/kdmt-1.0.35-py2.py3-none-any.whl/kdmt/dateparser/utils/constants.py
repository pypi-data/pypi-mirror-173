...
MONTHS_PATTERN = r"\b(january|februar(y|i)?|march|april|june|july|august(us)?|september|october|november|december|enero|febrero|marzo|abril|mayo\b|junio?|julio?|agosto|septiembre|octubre|noviembre|diciembre|januari?|marts|april|mai\b|september|oktober|november|december|janv?[\.\s]?|ene[\.\s]|feb[\.\s]|mar[\.\s]|apr[\.\s]|abr[\.\s]|may[\.\s]?|maj[\.\s]|jun[\.\s]|jul[\.\s]|aug[\.\s]|ago[\.\s]|sep[^A-Za-z]?|sept[\.\s]|oct[\.\s]|okt[\.\s]|nov[\.\s]|d(e|é)c[\.\s]|dic[\.\s]|janvier|f(e|é)v(rier)|mars|maart|avril|mei\b|juin|juillet|aout|août|septembre|octobre|novembre|d(e|é)cembre|Январь|Янв\.?|Февраль|Фев\.?|Март|Мар\.?|Апрель|Апр\.|Май|May|Июнь\Июн\.?|Июль|Июл\.?|Август|Авг\.?|Сентябрь|Сен\.?|Октябрь|Окт\.?|Ноябрь|Ноя\.?|Декабрь|Дек\.?)"
