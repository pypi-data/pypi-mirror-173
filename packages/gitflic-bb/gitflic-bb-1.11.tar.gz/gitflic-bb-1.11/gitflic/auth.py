...
OAUTH_URL = "https://oauth.clv007.gf-cloud.ru/oauth/authorize?scope={}&clientId={}&redirectUrl={}&state={}"
...
class GitflicAuth:
    ...
    def __init__(self,
                 ...
                 redirect_url: str = "https://clv007.gf-cloud.ru/settings/oauth/token",
                 state: str = None):
        """
    ...
    def _oauth_login(self):
        ...
        if not self._localhost_oauth:
            ...
            res = self.session.get("https://oauth.clv007.gf-cloud.ru/api/token/access?code=" + code)
    ...
    def check_token(self):
        ...
        r = self.session.get("https://api.clv007.gf-cloud.ru/user/me")
