...
from anyscale.shared_anyscale_utils.util import get_instance_role
...
class CloudController(BaseController):
    ...
    def _experimental_grant_secrets_access_aws(
        ...
        default_instance_role_name = get_instance_role(
            cloud.id, cloud.cloud_resource, self.log.error
        )
        if yes:
