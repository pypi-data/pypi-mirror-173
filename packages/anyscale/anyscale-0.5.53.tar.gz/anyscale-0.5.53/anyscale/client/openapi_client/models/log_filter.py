...
class LogFilter(object):
    ...
    def __init__(self, cluster_id=None, job_id=None, job_run=None, glob=None, node_ip=None, instance_id=None, node_type=None, actor_id=None, process_id=None, task_id=None, session_id=None, file_name=None, local_vars_configuration=None):  # noqa: E501
