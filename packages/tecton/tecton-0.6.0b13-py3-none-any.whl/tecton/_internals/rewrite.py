...
from tecton_core.query.nodes import InternalDataNode
...
class SpineEntityPushdown(Rewrite):
    ...
    def pushdown_entities(self, tree: NodeRef, spine: pyspark.sql.DataFrame, join_cols: List[str]):
        ...
        elif isinstance(node, (OfflineStoreScanNode, FeatureViewPipelineNode, PartialAggNode, InternalDataNode)):
            # We include InternalDataNode since tests will frequently represent data with an InternalDataNode, instead
            # of an e.g. PartialAggNode.
