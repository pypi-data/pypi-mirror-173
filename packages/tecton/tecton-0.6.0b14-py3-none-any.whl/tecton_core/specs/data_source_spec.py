...
class BatchSourceSpec:
    ...
    post_processor: Optional[user_defined_function_pb2.UserDefinedFunction]
...
class StreamSourceSpec:
    ...
    post_processor: Optional[user_defined_function_pb2.UserDefinedFunction]
    options: Tuple[stream_data_source__data_pb2.StreamDataSource.Option, ...]
...
class DataSourceSpec:
    ...
    @classmethod
    @typechecked
    def from_args_proto(cls, proto: virtual_data_source__args_pb2.VirtualDataSourceArgs) -> "DataSourceSpec":
        return cls(
...
class HiveSourceSpec(BatchSourceSpec):
    ...
    @classmethod
    @typechecked
    def from_args_proto(cls, proto: data_source__args_pb2.HiveDataSourceArgs) -> "HiveSourceSpec":
        return cls(
...
class FileSourceSpec(BatchSourceSpec):
    ...
    @classmethod
    @typechecked
    def from_args_proto(cls, proto: data_source__args_pb2.FileDataSourceArgs) -> "FileSourceSpec":
        return cls(
            timestamp_field=utils.get_field_or_none(proto.common_args, "timestamp_field"),
            timestamp_format=utils.get_field_or_none(proto, "timestamp_format"),
            post_processor=utils.get_field_or_none(proto.common_args, "post_processor"),
...
class SparkBatchSourceSpec(BatchSourceSpec):
    function: user_defined_function_pb2.UserDefinedFunction
    ...
    @classmethod
    @typechecked
    def from_args_proto(cls, proto: data_source__args_pb2.SparkBatchConfigArgs) -> "SparkBatchSourceSpec":
        return cls(
            timestamp_field=None,
            timestamp_format=None,
            post_processor=None,
...
class RedshiftSourceSpec(BatchSourceSpec):
    ...
    @classmethod
    @typechecked
    def from_args_proto(cls, proto: data_source__args_pb2.RedshiftDataSourceArgs) -> "RedshiftSourceSpec":
        return cls(
            timestamp_field=utils.get_field_or_none(proto.common_args, "timestamp_field"),
            timestamp_format=None,
            post_processor=utils.get_field_or_none(proto.common_args, "post_processor"),
...
class SnowflakeSourceSpec(BatchSourceSpec):
    ...
    @classmethod
    @typechecked
    def from_args_proto(cls, proto: data_source__args_pb2.SnowflakeDataSourceArgs) -> "SnowflakeSourceSpec":
        return cls(
            timestamp_field=utils.get_field_or_none(proto.common_args, "timestamp_field"),
            timestamp_format=None,
            post_processor=utils.get_field_or_none(proto.common_args, "post_processor"),
...
class KinesisSourceSpec(StreamSourceSpec):
    ...
    @classmethod
    @typechecked
    def from_args_proto(cls, proto: data_source__args_pb2.KinesisDataSourceArgs) -> "KinesisSourceSpec":
        return cls(
...
class KafkaSourceSpec(StreamSourceSpec):
    ...
    @classmethod
    @typechecked
    def from_args_proto(cls, proto: data_source__args_pb2.KafkaDataSourceArgs) -> "KafkaSourceSpec":
        return cls(
            deduplication_column_names=utils.get_tuple_from_repeated_field(proto.common_args.deduplication_columns),
            post_processor=utils.get_field_or_none(proto.common_args, "post_processor"),
            options=utils.get_tuple_from_repeated_field(proto.options),
...
class SparkStreamSourceSpec(StreamSourceSpec):
    ...
    @classmethod
    @typechecked
    def from_args_proto(cls, proto: data_source__args_pb2.SparkStreamConfigArgs) -> "SparkStreamSourceSpec":
        return cls(
