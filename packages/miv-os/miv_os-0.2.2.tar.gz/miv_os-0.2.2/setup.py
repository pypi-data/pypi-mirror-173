...
{'docs': ['Sphinx[docs]>=4.5.0,<5.0.0',
          'pydata-sphinx-theme[docs]>=0.9.0,<0.10.0',
          'readthedocs-sphinx-search[docs]>=0.1.2,<0.2.0',
          'sphinx-autodoc-typehints[docs]>=1.19.1,<2.0.0',
          'myst-parser[docs]>=0.17.2,<0.18.0',
          'numpydoc[docs]>=1.4.0,<2.0.0',
          'sphinx-togglebutton[docs]>=0.3.2,<0.4.0',
...
{'console_scripts': ['convert_open_ephys_to_miv = '
                     'scripts.convert_open_ephys_to_miv:main']}
