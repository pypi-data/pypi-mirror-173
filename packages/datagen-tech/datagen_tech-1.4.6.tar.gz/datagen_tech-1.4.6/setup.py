...
['datagen',
 ...
 'datagen.api.datapoint.assets',
 'datagen.api.datapoint.assets.accessories',
 'datagen.api.datapoint.assets.environment',
 'datagen.api.datapoint.assets.human',
 'datagen.api.datapoint.assets.orientation',
 'datagen.components',
...
package_data = \
{'': ['*'],
 'datagen.api.catalog': ['cache/*', 'human_templates/*'],
 'datagen.api.datapoint.assets': ['explanations/*']}
