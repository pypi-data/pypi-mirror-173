...
{'': ['*'],
 'doorstop': ['views/*'],
 'doorstop.core': ['files/*',
                   'files/templates/html/doorstop/*',
                   'files/templates/latex/*']}
