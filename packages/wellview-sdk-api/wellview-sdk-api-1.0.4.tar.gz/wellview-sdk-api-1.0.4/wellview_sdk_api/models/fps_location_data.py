...
class FPSLocationData(object):
    ...
    def __init__(self, eventseq=None, grid=None, idrec=None, idrecparent=None, idwell=None, latituderef=None, locexcept=None, longituderef=None, note=None, section=None, source=None, unit=None):  # noqa: E501
