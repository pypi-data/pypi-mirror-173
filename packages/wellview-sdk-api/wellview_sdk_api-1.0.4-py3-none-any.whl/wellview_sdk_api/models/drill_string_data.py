...
class DrillStringData(object):
    ...
    def __init__(self, bitno=None, bittfa=None, com=None, des=None, dircontrolmethod=None, dttmoutofhole=None, dttmpickup=None, idrec=None, idrecbit=None, idrecparent=None, idwell=None, proposed=None, stringno=None, stringobjective=None, stringresult=None, stringresultdetail=None, stringresultnote=None, travelequipwt=None, triphookloadmax=None, tripnote=None, tripoverpullmax=None, triprateinavg=None, triprateinmax=None, triprateoutavg=None, triprateoutmax=None, wearbearing=None, weardull=None, weargauge=None, wearinner=None, wearloc=None, wearother=None, wearouter=None, wearpulled=None):  # noqa: E501
