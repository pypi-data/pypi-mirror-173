...
class FluidAdditiveCompositionData(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "amount", "concmax", "des", "idrecparent", "note", "refno", "typ1", "typ2", "unitlabel", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "amount", "concmax", "des", "idrecparent", "note", "refno", "typ1", "typ2", "unitlabel", ], str]):
