...
class InspectionCheckListData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "actionrqd", "com", "des", "idrecparent", "refno", "typ1", "typ2", "value", "valueunit", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "actionrqd", "com", "des", "idrecparent", "refno", "typ1", "typ2", "value", "valueunit", ], str]):
