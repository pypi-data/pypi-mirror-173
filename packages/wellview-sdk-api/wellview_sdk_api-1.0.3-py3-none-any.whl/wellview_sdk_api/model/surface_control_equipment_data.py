...
class SurfaceControlEquipmentData(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "dttmend", "dttmstart", "make", "model", "refid", "sn", "szdes", "typ", "typdetail", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "dttmend", "dttmstart", "make", "model", "refid", "sn", "szdes", "typ", "typdetail", ], str]):
