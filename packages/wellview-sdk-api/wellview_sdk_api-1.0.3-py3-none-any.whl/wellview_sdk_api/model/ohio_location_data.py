...
class OhioLocationData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "idrecparent", "irregularsection", "lot", "meridian", "note", "quadranglemin", "quadranglename", "quarter1", "quarter2", "quarter3", "quarter4", "range", "rangedir", "section", "source", "township", "townshipdir", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "idrecparent", "irregularsection", "lot", "meridian", "note", "quadranglemin", "quadranglename", "quarter1", "quarter2", "quarter3", "quarter4", "range", "rangedir", "section", "source", "township", "townshipdir", ], str]):
