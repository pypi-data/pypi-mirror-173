...
class PhaseZoneCompletionAllocationData(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "allocation", "idrecparent", "idreczonecompletion", "note", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "allocation", "idrecparent", "idreczonecompletion", "note", ], str]):
