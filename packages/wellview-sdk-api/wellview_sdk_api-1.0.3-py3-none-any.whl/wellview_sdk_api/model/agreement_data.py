...
class AgreementData(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["contractno"]) -> MetaOapg.properties.contractno: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "contractno", "des", "dttmend", "dttmstart", "dttmstatus", "refno", "status", "typ1", "typ2", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["contractno"]) -> typing.Union[MetaOapg.properties.contractno, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "contractno", "des", "dttmend", "dttmstart", "dttmstatus", "refno", "status", "typ1", "typ2", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        contractno: typing.Union[MetaOapg.properties.contractno, str, schemas.Unset] = schemas.unset,
