...
class WellboreStatusData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "dttm", "idrecparent", "status", "usertxt1", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "dttm", "idrecparent", "status", "usertxt1", ], str]):
