...
class ShakerData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "des", "dttmmanufacture", "idrecparent", "make", "model", "refid", "sn", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "des", "dttmmanufacture", "idrecparent", "make", "model", "refid", "sn", ], str]):
