...
class PhaseRiskData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "costmax", "costmin", "costml", "depthend", "depthstart", "des", "durationmax", "durationmin", "durationml", "idrecparent", "typ", "typdetail", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "costmax", "costmin", "costml", "depthend", "depthstart", "des", "durationmax", "durationmin", "durationml", "idrecparent", "typ", "typdetail", ], str]):
