...
class WellAliasHistoryData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "changetyp", "com", "dttmend", "dttmstart", "source", "typ1", "typ2", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "changetyp", "com", "dttmend", "dttmstart", "source", "typ1", "typ2", "value", ], str]):
