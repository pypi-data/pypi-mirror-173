...
class PhaseRiskImpactData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "idrecparent", "score", "scoremax", "typ1", "typ2", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "idrecparent", "score", "scoremax", "typ1", "typ2", ], str]):
