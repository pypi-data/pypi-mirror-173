...
class WellReviewContactData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "contactname", "idrecparent", "note", "title", "typ", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "contactname", "idrecparent", "note", "title", "typ", ], str]):
