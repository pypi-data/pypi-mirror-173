...
class MudAdditiveData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "code1", "code2", "code3", "code4", "code5", "code6", "codedes", "cost", "des", "idrecparent", "note", "typ", "unitlabel", "unitsz", "vendor", "vendorcode", "vendorsubcode", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "code1", "code2", "code3", "code4", "code5", "code6", "codedes", "cost", "des", "idrecparent", "note", "typ", "unitlabel", "unitsz", "vendor", "vendorcode", "vendorsubcode", ], str]):
