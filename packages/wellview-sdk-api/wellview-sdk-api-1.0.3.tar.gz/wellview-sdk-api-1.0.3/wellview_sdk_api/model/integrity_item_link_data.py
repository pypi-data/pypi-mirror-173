...
class IntegrityItemLinkData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "idrecitem", "idrecparent", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "idrecitem", "idrecparent", ], str]):
