...
class PlugBackTotalDepthData(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["measmeth"]) -> MetaOapg.properties.measmeth: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "depth", "dttm", "idrecparent", "measmeth", "typ", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["measmeth"]) -> typing.Union[MetaOapg.properties.measmeth, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "depth", "dttm", "idrecparent", "measmeth", "typ", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        measmeth: typing.Union[MetaOapg.properties.measmeth, str, schemas.Unset] = schemas.unset,
