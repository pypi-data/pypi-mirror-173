...
class ServiceTubingStringsData(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "contractor", "depthbtm", "des", "dttmonbottom", "dttmoutofhole", "dttmpickup", "dttmpull", "dttmrun", "idrecjobpull", "idrecjobrun", "idrectub", "idrecwellbore", "latposition", "proposedpull", "proposedrun", "pullreason", "pullreasondetail", "stringwtdown", "stringwtrotating", "stringwtup", "tension", "usertxt1", "usertxt2", "usertxt3", ], str]):
