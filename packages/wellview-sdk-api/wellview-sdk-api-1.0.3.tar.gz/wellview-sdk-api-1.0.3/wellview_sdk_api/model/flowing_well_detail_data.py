...
class FlowingWellDetailData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "chokesz", "idrecparent", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "chokesz", "idrecparent", ], str]):
