...
class OtherStringComponentData(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "coatinginner", "coatingouter", "com", "conditionpull", "conditionrun", "connszbtm", "connsztop", "connthrdbtm", "connthrdtop", "conntypbtm", "conntyptop", "cost", "costunitlabel", "currentstatus", "depthtopcorrected", "des", "dttmmanufacture", "fishnecklength", "fishneckod", "grade", "hoursstart", "iconname", "idrecparent", "joints", "length", "linetosurf", "make", "material", "model", "presaxialinner", "presaxialouter", "presburst", "prescollapse", "refid", "sn", "szdrift", "szidnom", "szodmax", "szodnom", "temprating", "tensilemax", "torquemax", "torquemin", "upsetbtm", "upsettop", "wtperlength", ], str]):
