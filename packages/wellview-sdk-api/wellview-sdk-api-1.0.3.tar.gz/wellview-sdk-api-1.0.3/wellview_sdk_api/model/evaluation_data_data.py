...
class EvaluationDataData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "des", "idrecparent", "score", "scoremax", "typ", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "com", "des", "idrecparent", "score", "scoremax", "typ", ], str]):
