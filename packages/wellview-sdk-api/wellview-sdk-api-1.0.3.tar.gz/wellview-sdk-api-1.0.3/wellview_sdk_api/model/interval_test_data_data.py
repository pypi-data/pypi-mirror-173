...
class IntervalTestDataData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "dttm", "idrecparent", "note", "pres", "temp", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "dttm", "idrecparent", "note", "pres", "temp", ], str]):
