...
class PumpingUnitCounterWeightData(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "dttmend", "dttmstart", "idrecparent", "location", "model", "pos", "refid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idrec", "idwell", "dttmend", "dttmstart", "idrecparent", "location", "model", "pos", "refid", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        pos: typing.Union[MetaOapg.properties.pos, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
