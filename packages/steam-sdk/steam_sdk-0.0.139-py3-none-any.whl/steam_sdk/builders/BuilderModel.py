...
class BuilderModel:
    ...
    def load_circuit_parameters_from_csv(self, input_file_name: str):
        '''
        ...
        circuit_param = find_by_position(input_file_name, 0, self.circuit_data.GeneralParameters.circuit_name)
