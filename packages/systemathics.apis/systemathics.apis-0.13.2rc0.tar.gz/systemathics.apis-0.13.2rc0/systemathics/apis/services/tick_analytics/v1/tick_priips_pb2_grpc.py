...
class TickPriipsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.TickPriips = channel.unary_stream(
...
def add_TickPriipsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TickPriips': grpc.unary_stream_rpc_method_handler(
                    servicer.TickPriips,
...
class TickPriipsService(object):
    ...
    def TickPriips(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/systemathics.apis.services.tick_analytics.v1.TickPriipsService/TickPriips',
