...
from lightning.app.storage.requests import ExistsRequest, GetRequest
...
def _find_matching_path(work, request: GetRequest) -> Optional["lightning.app.storage.Path"]:
