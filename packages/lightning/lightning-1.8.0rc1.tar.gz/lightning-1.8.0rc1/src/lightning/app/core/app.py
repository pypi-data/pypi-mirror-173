...
from lightning.app.api.request_types import APIRequest, CommandRequest, DeltaRequest
...
class LightningApp:
    def __init__(
        ...
        self._root = root
        self.flow_cloud_compute = flow_cloud_compute or lightning.app.CloudCompute()
