...
from lightning.app.api.request_types import APIRequest, CommandRequest, RequestResponse
...
def _upload_command(command_name: str, command: ClientCommand) -> Optional[str]:
    from lightning.app.storage.path import _is_s3fs_available, filesystem, shared_storage_path
